__int64 __fastcall main(int a1, char **a2, char **a3)
{
  bool v3; // bl@1
  int v4; // eax@2
  const char *v5; // rax@15
  const char *v6; // rax@17
  char *v7; // rbx@17
  __int64 v9; // rax@20
  __int64 v10; // rbx@20
  __int64 v11; // rax@20
...
LABEL_22:
  ...
  if ( dword_60A29C < a1 )
  {
    v14 = dcgettext(0LL, "ignoring non-option arguments", 5);
    error(0, 0, v14);
  }
  if ( v3 && (LODWORD(v5) = sub_401D10(), v5) )
  {
    puts(v5);
  }
  else
  {
    LODWORD(v6) = sub_404CB0();
    v7 = (char *)v6;
    if ( v6 )
    {
      puts(v6);
    ...
    {
      LODWORD(v9) = sub_404A20(24LL);
      *(_QWORD *)(v9 + 8) = 0x2000LL;
      v10 = v9;
      LODWORD(v11) = sub_404A20(0x2000LL);
      v12 = *(_QWORD *)(v10 + 8);
      *(_QWORD *)v10 = v11;
      v13 = (_BYTE *)(v11 + v12 - 1);
      *(_QWORD *)(v10 + 16) = v13;
...
int sub_401CB1()
{
  ...
  if ( !byte_60A2C8 )
  {
    while ( qword_60A2D0 < (unsigned __int64)(((&unk_609E48 - (_UNKNOWN *)&qword_609E40) >> 3) - 1) )
      (*(&qword_609E40 + ++qword_60A2D0))();
    result = sub_401C5B();
    byte_60A2C8 = 1;
  }
  return result;
...
const char *sub_401D10()
{
  ...
  char v4; // dl@6
  char v5; // dl@9
  __int64 v7; // [sp+0h] [bp-128h]@13
  __int64 v8; // [sp+8h] [bp-120h]@15
  struct stat stat_buf; // [sp+90h] [bp-98h]@14

  v0 = getenv("PWD");
  if ( !v0 )
    goto LABEL_11;
  v1 = v0;
  v2 = (signed __int64)v0;
  if ( *v0 != 47 )
    goto LABEL_11;
  while ( 1 )
  {
    LODWORD(v3) = sub_406480(v2, "/.");
    if ( !v3 )
      break;
    v4 = *(_BYTE *)(v3 + 2);
    if ( !v4 )
  ...
  if ( __xstat(1, v1, (struct stat *)&v7)
    || __xstat(1, ".", &stat_buf)
    || v8 != stat_buf.st_ino
    || v7 != stat_buf.st_dev )
  {
...
int __fastcall sub_401DD0(unsigned __int64 a1, __int64 a2)
{
  signed __int128 v2; // ax@1
  __int64 v3; // rax@3
  signed __int64 v4; // rdi@4
  __int64 v5; // rdx@4

  v2 = 3LL * a1;
  BYTE8(v2) = 3 * (unsigned __int128)a1 >> 64 != 0;
  if ( (signed __int64)v2 < 0 || (*((_QWORD *)&v2 + 1) = BYTE8(v2), BYTE8(v2)) )
    sub_404C70(a1, a2, *((_QWORD *)&v2 + 1));
  LODWORD(v3) = sub_404A20(3 * a1);
  if ( a1 )
  {
    v4 = v3 + 3 * a1;
    v5 = v3;
...
void *__fastcall sub_401E50(__int64 a1, const void *a2, size_t a3)
{
  const void *v3; // r14@1
  size_t v4; // r13@1
  __int64 v5; // rbx@1
  ...
  bool v9; // sf@2
  signed __int64 v10; // rdi@2
  signed __int64 v11; // rbp@2
  __int64 v12; // rax@4
  __int64 v13; // rdx@4
  __int64 v14; // r15@4
  const void *v15; // rsi@4
  void *ptr; // ST08_8@4
  void *v17; // rdi@4
  _BYTE *v18; // rax@5
  ...
  if ( a3 + 1 > v7 )
  {
    ...
    v10 = *(_QWORD *)(v5 + 8) + v8;
    v11 = 2 * v10;
    if ( v10 & 0x4000000000000000LL || v9 )
      sub_404C70(v10, a2, a3);
    LODWORD(v12) = sub_404A20(2 * v10);
    v13 = *(_QWORD *)(v5 + 8);
    v14 = v12;
    v15 = (const void *)(*(_QWORD *)v5 + v7);
    ptr = *(void **)v5;
    v17 = (void *)(v12 + v7 + v11 - v13);
    *(_QWORD *)(v5 + 16) = v17;
    memcpy(v17, v15, v13 - v7);
    free(ptr);
    *(_QWORD *)v5 = v14;
    v6 = *(_QWORD *)(v5 + 16);
    *(_QWORD *)(v5 + 8) = v11;
  ...
  *(_QWORD *)(v5 + 16) = v18;
  *v18 = 47;
  return memcpy((void *)(*(_QWORD *)(v5 + 16) + 1LL), v3, v4);
}
...
_BYTE *__fastcall sub_401F10(__int64 a1)
{
  __int64 v1; // rax@1
  char *v2; // rsi@2
  unsigned __int64 v3; // r15@3
  DIR *v4; // rax@6
  DIR *v5; // rbx@6
  int v6; // eax@7
  int v7; // ebp@7
  unsigned int i; // ebp@9
  int *v9; // r14@10
  __dev_t v10; // r13@11
  __dev_t v11; // r12@11
  struct dirent *v12; // rax@13
  const char *v13; // rbp@14
  __ino_t v14; // rax@15
  size_t v15; // rax@18
  __m128i v16; // xmm1@19
  __m128i v17; // xmm2@19
  ...
  char *v53; // rbx@42
  int *v54; // rax@42
  bool v55; // [sp+7h] [bp-211h]@11
  __int64 v56; // [sp+10h] [bp-208h]@1
  char v57; // [sp+20h] [bp-1F8h]@1
  struct stat stat_buf; // [sp+30h] [bp-1E8h]@2
  struct stat v59; // [sp+C0h] [bp-158h]@9
  struct stat v60; // [sp+150h] [bp-C8h]@20

  LODWORD(v1) = sub_404430(&v57);
  v56 = v1;
  if ( !v1 )
    goto LABEL_42;
  v2 = ".";
  ...
  v3 = 1LL;
LABEL_4:
  if ( stat_buf.st_ino != *(_QWORD *)v56 || stat_buf.st_dev != *(_QWORD *)(v56 + 8) )
  {
    v4 = opendir("..");
    v5 = v4;
    if ( !v4 )
    ...
    if ( fchdir(v6) < 0 )
      goto LABEL_39;
    v2 = (char *)(unsigned int)v7;
    for ( i = (unsigned int)__fxstat(1, v7, &v59) >> 31; ; i = (unsigned int)__xstat(1, ".", &v59) >> 31 )
    {
      v9 = __errno_location();
      if ( (_BYTE)i )
        goto LABEL_38;
      v10 = v59.st_dev;
      v11 = stat_buf.st_dev;
      v55 = v59.st_dev != stat_buf.st_dev;
      while ( 1 )
      {
        *v9 = 0;
LABEL_13:
        ...
        while ( 1 )
        {
          ...
          if ( v12->d_name[0] != 46 )
            break;
          v24 = v12->d_name[(v12->d_name[1] == 46) + 1];
          if ( !v24 )
            goto LABEL_13;
          if ( v24 != 47 )
            break;
        ...
        {
          v2 = (char *)v13;
          if ( __lxstat(1, v13, &v60) >= 0
            && v60.st_ino == stat_buf.st_ino
            && (v10 == v11 || v60.st_dev == stat_buf.st_dev) )
          {
LABEL_18:
            v15 = strlen(v13);
            v2 = (char *)v13;
            sub_401E50(a1, v13, v15);
            if ( !closedir(v5) )
            {
              ++v3;
              v16 = _mm_load_si128((const __m128i *)&v59.st_nlink);
              v17 = _mm_load_si128((const __m128i *)&v59.st_gid);
              v18 = _mm_load_si128((const __m128i *)&v59.st_size);
              *(__m128i *)&stat_buf.st_dev = _mm_load_si128((const __m128i *)&v59);
              v19 = _mm_load_si128((const __m128i *)&v59.st_blocks);
              v20 = _mm_load_si128((const __m128i *)&v59.st_atim.tv_nsec);
              *(__m128i *)&stat_buf.st_nlink = v16;
              v21 = _mm_load_si128((const __m128i *)&v59.st_mtim.tv_nsec);
              v22 = _mm_load_si128((const __m128i *)&v59.st_ctim.tv_nsec);
              *(__m128i *)&stat_buf.st_gid = v17;
              v23 = _mm_load_si128((const __m128i *)&v59.__unused[1]);
              *(__m128i *)&stat_buf.st_size = v18;
              *(__m128i *)&stat_buf.st_blocks = v19;
              *(__m128i *)&stat_buf.st_atim.tv_nsec = v20;
              *(__m128i *)&stat_buf.st_mtim.tv_nsec = v21;
              *(__m128i *)&stat_buf.st_ctim.tv_nsec = v22;
              *(__m128i *)&stat_buf.__unused[1] = v23;
              goto LABEL_4;
            }
LABEL_37:
            LODWORD(v30) = sub_401DD0(v3, (__int64)v2);
            LODWORD(v31) = sub_404410(v30);
            v32 = v31;
            v33 = dcgettext(0LL, "reading directory %s", 5);
            v2 = (char *)(unsigned int)*v9;
            error(1, (int)v2, v33, v32);
LABEL_38:
            LODWORD(v34) = sub_401DD0(v3, (__int64)v2);
            LODWORD(v35) = sub_404410(v34);
            v36 = v35;
            v37 = dcgettext(0LL, "failed to stat %s", 5);
            v2 = (char *)(unsigned int)*v9;
            error(1, (int)v2, v37, v36);
LABEL_39:
            LODWORD(v38) = sub_401DD0(v3, (__int64)v2);
            LODWORD(v39) = sub_404410(v38);
            v40 = v39;
            v41 = dcgettext(0LL, "failed to chdir to %s", 5);
            v2 = (char *)(unsigned int)*__errno_location();
            error(1, (int)v2, v41, v40);
LABEL_40:
            LODWORD(v42) = sub_401DD0(v3, (__int64)v2);
            LODWORD(v43) = sub_404410(v42);
            v44 = v43;
            v45 = dcgettext(0LL, "cannot open directory %s", 5);
            v46 = __errno_location();
            error(1, *v46, v45, v44);
LABEL_41:
            LODWORD(v47) = sub_4041C0(4LL, ".");
            v48 = v47;
            v49 = dcgettext(0LL, "failed to stat %s", 5);
            v50 = __errno_location();
            error(1, *v50, v49, v48);
LABEL_42:
            LODWORD(v51) = sub_4041C0(4LL, "/");
            v52 = v51;
            v53 = dcgettext(0LL, "failed to get attributes of %s", 5);
            v54 = __errno_location();
            error(1, *v54, v53, v52);
            sub_4023D0(1);
          }
        }
        else if ( v14 == stat_buf.st_ino )
        {
          goto LABEL_18;
        }
      }
LABEL_28:
      ...
      if ( closedir(v5) )
        goto LABEL_37;
      LODWORD(v26) = sub_401DD0(v3, (__int64)v2);
      LODWORD(v27) = sub_404410(v26);
      v5 = v27;
      v28 = dcgettext(0LL, "couldn't find directory entry in %s with matching i-node", 5);
      v2 = 0LL;
      error(1, 0, v28, v5);
LABEL_31:
      if ( chdir("..") < 0 )
  ...
  result = *(_BYTE **)(a1 + 16);
  if ( !*result )
    result = sub_401E50(a1, "", 0LL);
  return result;
}

void __fastcall __noreturn sub_4023D0(int status)
{
  int v1; // ebx@1
  __int64 v2; // rbp@1
  char *v3; // rax@2
  ...
  char *v29; // rax@17
  char *v30; // rax@19
  const char *v31; // [sp+0h] [bp-88h]@4
  const char *v32; // [sp+8h] [bp-80h]@4
  const char *v33; // [sp+10h] [bp-78h]@4
  const char *v34; // [sp+18h] [bp-70h]@4
  const char *v35; // [sp+20h] [bp-68h]@4
  const char *v36; // [sp+28h] [bp-60h]@4
  const char *v37; // [sp+30h] [bp-58h]@4
  const char *v38; // [sp+38h] [bp-50h]@4
  const char *v39; // [sp+40h] [bp-48h]@4
  const char *v40; // [sp+48h] [bp-40h]@4
  const char *v41; // [sp+50h] [bp-38h]@4
  const char *v42; // [sp+58h] [bp-30h]@4
  __int64 v43; // [sp+60h] [bp-28h]@4
  __int64 v44; // [sp+68h] [bp-20h]@4
  ...
  v4 = dcgettext(0LL, "Usage: %s [OPTION]...\n", 5);
  __printf_chk(1LL, v4, v2);
  v5 = stdout;
  v6 = dcgettext(0LL, "Print the full filename of the current working directory.\n\n", 5);
  ...
  while ( (!v18 && !v19) != v18 );
  v22 = (const char *)v16[1];
  if ( v22 )
  {
    v23 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v23, &unk_407235);
    v24 = setlocale(5, 0LL);
  ...
  {
    v27 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v27, &unk_407235);
    v28 = setlocale(5, 0LL);
...
__int64 sub_402750()
{
  ...
  if ( (unsigned int)sub_406820(stdout) )
  {
    ...
    if ( !byte_60A2D8 || *v0 != 32 )
    {
      ...
      if ( qword_60A2E0 )
      {
        LODWORD(v5) = sub_404260(qword_60A2E0, "write error");
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_405F80((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_403BC0(__int64 a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( (signed int)a1 < 0 )
    abort();
  if ( dword_60A290 <= (signed int)a1 )
  {
    if ( (_DWORD)a1 == 0x7FFFFFFF )
      sub_404C70(a1, a2, v7);
    v10 = 16LL * ((signed int)a1 + 1);
    if ( off_60A278 == &xmmword_60A280 )
    {
      LODWORD(v21) = sub_404A80(0LL, v10);
      v8 = v21;
      off_60A278 = v21;
      *v21 = (__int128)_mm_load_si128((const __m128i *)&xmmword_60A280);
    }
    else
    {
      LODWORD(v11) = sub_404A80(off_60A278, v10);
      off_60A278 = v11;
      v8 = v11;
    }
    memset(&v8[dword_60A290], 0, 16LL * ((signed int)a1 + 1 - dword_60A290));
    dword_60A290 = a1 + 1;
  }
  ...
  v24 = *(_DWORD *)(v5 + 4) | 1;
  v14 = *(_QWORD *)v12;
  v15 = sub_402990(v13, *(_QWORD *)v12, v22, v4, *(_DWORD *)v5, v24, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v14 <= v15 )
  {
    v16 = v15 + 1;
    *(_QWORD *)v12 = v15 + 1;
    if ( (_UNKNOWN *)v13 != &unk_60A300 )
    {
      v17 = v15 + 1;
      free(v13);
      v16 = v17;
    }
    LODWORD(v18) = sub_404A20(v16);
    v19 = *(_DWORD *)v5;
    *(_QWORD *)(v12 + 8) = v18;
    v13 = v18;
    sub_402990(v18, v16, v22, v4, v19, v24, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v9 = v23;
  return v13;
}
...
_BYTE *__fastcall sub_4041C0(int a1, char *a2)
{
...
_BYTE *__fastcall sub_4041E0(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  v7 = qword_60A430;
  v4 = _mm_load_si128((const __m128i *)&xmmword_60A400);
  v5 = _mm_load_si128((const __m128i *)&xmmword_60A410);
...
__int64 __fastcall sub_404430(__int64 a1)
{
...
int __fastcall sub_404480(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12@1
  __int64 v7; // rbx@1
  char *v8; // rax@3
...
int __fastcall sub_4048E0(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  char *v7; // r10@1
  signed int v8; // er8@1
  __int64 v9; // r9@1
  ...
  do
  {
    if ( (unsigned int)v8 <= 0x2F )
    {
      ...
      v15[v9] = v11;
      if ( !v11 )
        return sub_404480(a1, a2, a3, a4, (__int64)v15, v9);
      goto LABEL_3;
    }
    v12 = (__int64 *)v7;
    v7 += 8;
...
void *__fastcall sub_404C20(const void *a1, size_t a2)
{
  void *v2; // rax@1
...
char *__fastcall sub_404CE0(char *a1, unsigned __int64 a2)
{
  char *v3; // rbx@7
  __dev_t v4; // r15@8
  __ino_t v5; // r14@8
...
__int64 __fastcall sub_4051B0(__int64 a1, __int64 a2)
{
...
signed __int64 __fastcall sub_405290(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8, __int64 a9)
{
  const char *v9; // r14@1
  char *v10; // rbp@1
  size_t v11; // r13@5
...
__int64 __fastcall sub_4058B0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8)
{
  int v8; // er13@1
  signed int v9; // eax@2
  int v10; // ebp@2
    ...
    if ( *(_BYTE *)v21 == 45 )
    {
      ...
      if ( v36 )
      {
        if ( v53 )
        {
          ...
          {
            *(_QWORD *)(a7 + 32) = v21 + 2;
            v40 = sub_405290(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"--");
            goto LABEL_72;
          }
          if ( a6 )
          {
            ...
            {
              *(_QWORD *)(a7 + 32) = v21 + 1;
              v26 = sub_405290(v10, v11, v12, v53, v54, a6, a7, v8, 4229466LL);
              if ( v26 != -1 )
...
LABEL_71:
        *(_QWORD *)(a7 + 32) = v28;
        *(_QWORD *)(a7 + 16) = 0LL;
        v40 = sub_405290(v10, v11, v12, v53, v54, 0, a7, v8, (__int64)"-W ");
LABEL_72:
        return v40;
      }
      v39 = *(_DWORD *)a7;
...
__int64 __fastcall sub_405E80(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax@1

  dword_60A440 = dword_60A29C;
  dword_60A444 = dword_60A298;
  result = sub_4058B0(a1, a2, a3, a4, a5, a6, (__int64)&dword_60A440, a7);
...
__int64 __fastcall sub_405F00(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5)
{
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_406880(0LL, v6) )
  {
    v4 = 1LL;
...
unsigned __int64 __fastcall sub_406000(__int64 a1, unsigned __int64 a2, signed __int64 *a3)
{
...
signed __int64 __fastcall sub_406130(__int64 a1, unsigned __int64 a2, __int64 a3, unsigned __int64 a4)
{
  char *v4; // r12@1
  ...
  __int64 v26; // rax@39
  unsigned __int64 v27; // rax@42
  unsigned __int64 v28; // rax@49
  unsigned __int64 v29; // [sp+8h] [bp-880h]@14
  unsigned __int64 v30; // [sp+8h] [bp-880h]@39
  signed __int64 v31; // [sp+10h] [bp-878h]@14
  unsigned __int64 v32; // [sp+10h] [bp-878h]@39
  unsigned __int64 v33; // [sp+18h] [bp-870h]@39
  unsigned __int64 v34; // [sp+20h] [bp-868h]@2
  signed __int64 v35; // [sp+20h] [bp-868h]@11
  unsigned __int64 v36; // [sp+48h] [bp-840h]@2
  __int64 v37[256]; // [sp+50h] [bp-838h]@3
  char v38; // [sp+850h] [bp-38h]@4
  ...
  {
    v7 = sub_406000(a3, a4, (signed __int64 *)&v36);
    v34 = v36;
  }
  v8 = (char *)v37;
  do
  ...
  if ( v6 )
  {
    ...
    while ( 1 )
    {
      ...
      v32 = v23;
      v30 = v24 + v6;
      LODWORD(v26) = sub_406F70(a1 + v5, 0LL, v24 + v6 - v5);
      if ( v26 )
        break;
      v22 = v33;
      if ( !v30 )
        break;
      v25 = v37[(unsigned __int64)*(_BYTE *)(a1 + v30 - 1)];
      if ( v25 )
      {
        if ( v25 < v34 && v32 )
          v25 = v6 - v34;
...
LABEL_49:
          v28 = v7 - 1;
          if ( v32 < v7 && *(_BYTE *)(a1 + v24 + v7 - 1) == v4[v7 - 1] )
          {
            while ( v32 != v28 && v4[v28 - 1] == *(_BYTE *)(v28 + a1 + v24 - 1) )
              --v28;
          }
          else
          {
...
LABEL_9:
    ...
    while ( 1 )
    {
      v31 = v15;
      v29 = v15 + v6;
      LODWORD(v16) = sub_406F70(a1 + v5, 0LL, v15 + v6 - v5);
      if ( !v29 )
        return 0LL;
      v17 = v31;
      if ( v16 )
        return 0LL;
      v18 = v37[(unsigned __int64)*(_BYTE *)(a1 + v29 - 1)];
      if ( v18 )
        goto LABEL_12;
      v19 = a1 + v31;
      if ( v7 < v13 )
...
signed __int64 __fastcall sub_406480(__int64 a1, char *a2)
{
  char v2; // al@1
  char v3; // r9@1
  char *v4; // rbx@3
...
LABEL_7:
  ...
  if ( a1 + v10 < (unsigned __int64)v11 )
    v13 = 1LL;
  if ( v10 > 0x1F )
    return sub_406130((__int64)v11, v13, (__int64)v12, v10);
  if ( v10 <= 2 )
  {
    v36 = 1LL;
    v17 = v10 - 1;
  ...
  {
    v15 = v13;
    v16 = sub_406000((__int64)v12, v10, &v36);
    v13 = v15;
    v17 = v16;
    v34 = v36;
  }
  ...
  if ( !v19 )
  {
    ...
    {
      v33 = v10 + v22;
      LODWORD(v23) = sub_406F70(&v9[v20], 0LL, v10 + v22 - v20);
      if ( !(v10 + v22) || v23 )
        return 0LL;
      v24 = v21;
      if ( v17 >= v21 )
...
LABEL_36:
  ...
  {
    v28 = v10 + v27;
    LODWORD(v29) = sub_406F70(&v9[v20], 0LL, v10 + v27 - v20);
    if ( !(v10 + v27) || v29 )
      return 0LL;
    v30 = &v9[v27];
    if ( v10 > v17 )
...
int __fastcall sub_406E50(FILE *stream)
{
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_406ED0(stream) )
  {
...
int __fastcall sub_406ED0(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_406F10(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
int __fastcall sub_4070F0(__int64 a1)
{
  __int64 v1; // rdx@1
