__int64 __fastcall main(unsigned int a1, char **a2, char **a3)
{
  ...
  __int64 v17; // r14@22
  __int64 v18; // rax@12
  const char *v19; // rsi@26
  __int64 v20; // rax@27
  __int64 v21; // rdx@27
  __int64 v22; // rax@28
  int v23; // eax@30
  const char **v24; // rcx@31
  signed int v25; // er10@33
  const char **v26; // r15@35
  const char **j; // r9@35
  signed int v28; // ST38_4@38
  int v29; // eax@38
  int v30; // eax@41
  int v31; // edi@42
  const char *v32; // rsi@44
  const char **v33; // rax@44
  __int64 v34; // rax@45
  int v35; // esi@46
  const char *v36; // rsi@54
  __int64 v37; // rdi@61
  char v38; // bp@63
  __int64 v39; // rdi@65
  __int64 v40; // rdx@66
  ...
  char *v65; // rax@96
  char *v66; // rax@97
  char *s1; // [sp+8h] [bp-70h]@10
  const char **v68; // [sp+18h] [bp-60h]@38
  char *v69; // [sp+20h] [bp-58h]@4
  int v70; // [sp+2Ch] [bp-4Ch]@4
  char v71; // [sp+30h] [bp-48h]@6
  char *v72; // [sp+38h] [bp-40h]@10
  ...
  sub_406700(
    ...
    "/home/dongkwan/data/scripts/gnu_packages/coreutils/coreutils-8.29_gcc-8.2.0_x86_64_O2_debug/gogo/share/locale");
  sub_402760(a1);
  if ( sub_405F60(a1, a2, &::s1, &unk_406B40, 0LL) != -1 )
LABEL_92:
    sub_402150(1);
  if ( (signed int)(a1 - dword_60A25C) > 1 )
  {
    LODWORD(v58) = sub_404490(a2[dword_60A25C + 1], 0LL);
    v59 = v58;
    v60 = dcgettext(0LL, "extra operand %s", 5);
    error(0, 0, v60, v59);
    goto LABEL_92;
  }
  if ( dword_60A25C == a1 )
  {
    LODWORD(v54) = sub_401F80(0LL, 0LL);
    v70 = 0;
    v69 = "-";
    v5 = v54;
  }
  else
  {
    v3 = a2[dword_60A25C];
    v69 = a2[dword_60A25C];
    v70 = strcmp(a2[dword_60A25C], "-");
    LODWORD(v4) = sub_401F80(0LL, "-");
    v5 = v4;
    if ( v70 )
    {
      LODWORD(v6) = sub_4025B0(v3, "r", stdin);
      if ( !v6 )
      {
        LODWORD(v55) = sub_404310(0LL, 3LL, v69);
        v56 = v55;
...
LABEL_7:
  for ( i = 0LL; ; i = v17 )
  {
    ...
    if ( v9 )
    {
      ...
      LODWORD(v22) = sub_401F80(s1, v15);
      v17 = v22;
      if ( (signed int)v15 < 0 )
        *(_QWORD *)(v9 + 8) = v22;
      else
        *(_QWORD *)(v9 + 16) = v22;
      v23 = strcmp(s1, *(const char **)v11);
      if ( !v23 )
        __assert_fail("!STREQ (str, s->str)", "src/tsort.c", 0xAEu, "search_item");
      v24 = *(const char ***)(v11 + 16);
      if ( v23 < 0 )
        v24 = *(const char ***)(v11 + 8);
      v25 = 1;
      if ( v23 < 0 )
        v25 = -1;
      v26 = v24;
      for ( j = v24; (const char **)v17 != j; j = (const char **)v68[1] )
      {
        while ( 1 )
        {
          v28 = v25;
...
LABEL_41:
      ...
      if ( v30 && (v31 = -v25, v30 != -v25) )
      {
        if ( v25 == *((_DWORD *)v26 + 6) )
        {
          ...
          {
            *(_QWORD *)(v11 + 8) = v26[2];
            v26[2] = (const char *)v11;
          }
          else
          {
            *(_QWORD *)(v11 + 16) = v26[1];
            v26[1] = (const char *)v11;
          }
          *((_DWORD *)v26 + 6) = 0;
          v33 = v26;
          *(_DWORD *)(v11 + 24) = 0;
        ...
        {
          v32 = v26[1];
          v33 = (const char **)v26[2];
          if ( v25 < 0 )
          {
            v26[2] = v33[1];
            v36 = v33[2];
            v33[1] = (const char *)v26;
            *(_QWORD *)(v11 + 8) = v36;
            v33[2] = (const char *)v11;
          }
          else
          {
            v26[1] = (const char *)*((_QWORD *)v32 + 2);
            v34 = *((_QWORD *)v32 + 1);
            *((_QWORD *)v32 + 2) = v26;
            *(_QWORD *)(v11 + 16) = v34;
            v33 = (const char **)v32;
...
LABEL_26:
        v19 = *(const char **)v17;
        if ( strcmp(*(const char **)i, *(const char **)v17) )
        {
          ++*(_QWORD *)(v17 + 32);
          LODWORD(v20) = sub_404DC0(16LL, v19);
          v21 = *(_QWORD *)(i + 48);
          *(_QWORD *)v20 = v17;
          *(_QWORD *)(v20 + 8) = v21;
          *(_QWORD *)(i + 48) = v20;
    ...
    {
      LODWORD(v18) = sub_401F80(v72, &unk_406811);
      v17 = v18;
      *(_QWORD *)(v5 + 16) = v18;
      if ( i )
        goto LABEL_26;
    ...
    do
    {
      ...
      *(_QWORD *)qword_60A2B0 = 0LL;
      ...
      if ( v41 )
      {
        ...
        {
          v46 = *(_QWORD *)v41;
          v47 = *(_QWORD *)(*(_QWORD *)v41 + 32LL) == 1LL;
          --*(_QWORD *)(v46 + 32);
          if ( v47 )
          {
            *(_QWORD *)(v44 + 40) = v46;
...
LABEL_74:
    if ( !v45 )
      break;
LABEL_78:
    LODWORD(v49) = sub_404310(0LL, 3LL, v69);
    v50 = v49;
    v51 = dcgettext(0LL, "%s: input contains a loop:", 5);
    v52 = v50;
    v38 = 0;
    error(0, 0, v51, v52);
    do
  ...
  if ( (unsigned int)sub_405050(stdin) )
  {
    if ( v70 )
      goto LABEL_97;
    for ( k = dcgettext(0LL, "standard input", 5); ; k = v66 )
    {
      v62 = __errno_location();
      error(1, *v62, "%s", k);
LABEL_96:
      LODWORD(v63) = sub_404310(0LL, 3LL, v69);
      v64 = v63;
      v65 = dcgettext(0LL, "%s: input contains an odd number of tokens", 5);
      error(1, 0, v65, v64);
LABEL_97:
      LODWORD(v66) = sub_404310(0LL, 3LL, v69);
    }
  }
  return (unsigned __int8)(v38 ^ 1);
}
...
int __fastcall sub_401F10(__int64 a1, int (__fastcall *a2)(_QWORD))
{
  int (__fastcall *v2)(_QWORD); // rbp@1
  __int64 v3; // rbx@1
  __int64 v4; // rdi@2
  int result; // eax@4
  ...
  while ( 1 )
  {
    ...
    if ( !v4 )
      break;
    a2 = v2;
    if ( (unsigned __int8)sub_401F10(v4, v2) )
      return 1;
LABEL_4:
    result = ((int (__fastcall *)(__int64, int (__fastcall *)(_QWORD)))v2)(v3, a2);
    if ( (_BYTE)result )
      return 1;
    v3 = *(_QWORD *)(v3 + 16);
    if ( !v3 )
...
__int64 __fastcall sub_401F80(__int64 a1, __int64 a2)
{
  __int64 v2; // rbp@1
  __int64 v3; // rax@1
  __int64 v4; // rbx@1
  ...
  v2 = a1;
  LODWORD(v3) = sub_404DC0(56LL, a2);
  v4 = v3;
  if ( a1 )
  {
    LODWORD(v5) = sub_404FF0(a1);
    v2 = v5;
  }
  *(_QWORD *)v4 = v2;
  result = v4;
...
__int64 __fastcall sub_401FF0(__int64 a1)
{
...
void __fastcall __noreturn sub_402150(int status)
{
  int v1; // ebx@1
  __int64 v2; // rbp@1
  char *v3; // rax@2
  ...
  {
    v20 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v20, &unk_4067E0);
    v21 = setlocale(5, 0LL);
  ...
  {
    v24 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v24, &unk_4067E0);
    v25 = setlocale(5, 0LL);
...
__int64 sub_402480()
{
  ...
  if ( (unsigned int)sub_406060(stdout) )
  {
    ...
    if ( !byte_60A2B8 || *v0 != 32 )
    {
      ...
      if ( qword_60A2C0 )
      {
        LODWORD(v5) = sub_4042E0(qword_60A2C0, "write error");
...
void __fastcall sub_402530(FILE *a1, int a2)
{
  int v2; // eax@2
...
__int64 __fastcall sub_402560(int a1)
{
  signed int v1; // ebx@1
  int v2; // eax@1
  __int64 result; // rax@3
...
__int64 __fastcall sub_4025B0(__int64 a1, __int64 a2, FILE *a3)
{
  FILE *v3; // r12@1
  int v4; // ebx@1
  int *v5; // r14@1
  ...
  else
  {
    ...
    else
    {
      if ( !v4 )
      {
        ...
        v8 = 0;
LABEL_11:
        LODWORD(v9) = sub_405110(a1, a2, v3);
        v10 = v9;
        goto LABEL_12;
      }
      v6 = dup2(2, 2) != 2;
...
void sub_402760(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, void (__fastcall *a6)(_QWORD), ...)
{
  int v6; // ebx@1
  __int64 v7; // r13@3
  __int64 v8; // r12@3
...
char *__fastcall sub_402870(const char *a1)
{
...
char *__fastcall sub_402910(char *msgid, int a2)
{
  const char *v2; // rbx@1
  __int64 v4; // rax@3
  bool v5; // zf@9
...
unsigned __int64 __fastcall sub_402A10(_BYTE *a1, unsigned __int64 a2, char *a3, unsigned __int64 a4, int a5, char a6, __int64 a7, char *a8, char *a9)
{
  _BYTE *v9; // r15@1
...
LABEL_4:
        ...
        if ( !(_BYTE)v11 )
        {
          ...
          v44 = v43 == 2;
          if ( !v16 && v44 && v82 )
            return sub_402A10((__int64)v9, v10, s);
          v45 = !v82 && v44;
          if ( v45 )
          {
            if ( v83 )
            {
              if ( v70 )
                return sub_402A10((__int64)v9, v79, s);
              v46 = v79 != 0 && v10 == 0;
              if ( v46 )
              {
                v10 = v79;
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_405FE0((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_403C40(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_60A250 <= a1 )
  {
    ...
    {
      LODWORD(v10) = sub_404E20(off_60A238, v9);
      off_60A238 = v10;
      v7 = v10;
    }
  ...
  v23 = *(_DWORD *)(v5 + 4) | 1;
  v13 = *(_QWORD *)v11;
  v14 = sub_402A10(v12, *(_QWORD *)v11, v21, v4, *(_DWORD *)v5, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v13 <= v14 )
  {
    v15 = v14 + 1;
    *(_QWORD *)v11 = v14 + 1;
    if ( (_UNKNOWN *)v12 != &unk_60A2E0 )
    {
      v16 = v14 + 1;
      free(v12);
      v15 = v16;
    }
    LODWORD(v17) = sub_404DC0(v15, v15);
    v18 = *(_DWORD *)v5;
    *(_QWORD *)(v11 + 8) = v17;
    v12 = v17;
    sub_402A10(v17, v15, v21, v4, v18, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v22;
  return v12;
}
...
_BYTE *__fastcall sub_404260(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  v7 = qword_60A410;
  v4 = _mm_load_si128((const __m128i *)&xmmword_60A3E0);
  v5 = _mm_load_si128((const __m128i *)&xmmword_60A3F0);
  ...
  return sub_403C40(0, a1, a2, (__int64)&v4);
}

_BYTE *__fastcall sub_4042E0(char *a1)
{
  return sub_404260(a1, 0xFFFFFFFFFFFFFFFFLL, 0x3Au);
}

_BYTE *__fastcall sub_404310(int a1, int a2, char *a3)
{
...
void __fastcall sub_4044B0(__int64 a1)
{
  *(_QWORD *)a1 = 0LL;
  *(_QWORD *)(a1 + 8) = 0LL;
}

unsigned __int64 __fastcall sub_4044C0(_IO_FILE *a1, _BYTE *a2, __int64 a3, __int64 a4)
{
  __int64 v4; // r13@1
  _IO_FILE *v5; // rbp@1
  _BYTE *v6; // rdx@2
...
LABEL_27:
      ...
      a1 = v12;
      LODWORD(v18) = sub_404E20(v12, v13);
      v12 = v18;
      v15 = (char *)v18 + v14;
...
int __fastcall sub_404C20(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v5; // r9@1
  __int64 *v6; // r10@2
  __int64 v7; // rax@2
  ...
  do
  {
    ...
    if ( *(_DWORD *)a5 <= 0x2Fu )
    {
      ...
      *(_DWORD *)a5 = v8 + 8;
      ...
      v12[v5] = *v6;
      if ( !v7 )
        return sub_404820(a1, a2, a3, a4, (__int64)v12, v5);
      goto LABEL_3;
    }
    v9 = *(__int64 **)(a5 + 8);
    *(_QWORD *)(a5 + 8) = v9 + 1;
...
void *__fastcall sub_404FF0(const char *a1)
{
  size_t v1; // rax@1

  v1 = strlen(a1);
  return sub_404FC0(a1, v1 + 1);
}
...
int __fastcall sub_405050(FILE *stream)
{
  int *v1; // rax@4
  int v2; // er12@4
  int *v3; // rbp@4
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_4050D0(stream) )
  {
...
int __fastcall sub_4050D0(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_4051B0(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
FILE *__fastcall sub_405110(const char *a1, const char *a2, FILE *a3)
{
  FILE *v3; // rax@1
  FILE *v4; // rbx@1
  int v5; // er13@3
...
int __fastcall sub_4051B0(FILE *a1, __off_t a2, int a3)
{
  __off_t v3; // rax@2
  int v4; // er12@5
  int v5; // eax@5
...
__int64 __fastcall sub_405210(__int64 a1, __int64 a2)
{
...
signed __int64 __fastcall sub_4052F0(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8, __int64 a9)
{
  const char *v9; // r14@1
  char *v10; // rbp@1
  size_t v11; // r13@5
...
__int64 __fastcall sub_405910(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8)
{
  int v8; // er13@1
  signed int v9; // eax@2
  int v10; // ebp@2
    ...
    if ( *(_BYTE *)v21 == 45 )
    {
      ...
      if ( v36 )
      {
        if ( v53 )
        {
          ...
          {
            *(_QWORD *)(a7 + 32) = v21 + 2;
            v40 = sub_4052F0(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"--");
            goto LABEL_72;
          }
          if ( a6 )
          {
            ...
            {
              *(_QWORD *)(a7 + 32) = v21 + 1;
              v26 = sub_4052F0(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"-");
              if ( v26 != -1 )
...
LABEL_71:
        *(_QWORD *)(a7 + 32) = v28;
        *(_QWORD *)(a7 + 16) = 0LL;
        v40 = sub_4052F0(v10, v11, v12, v53, v54, 0, a7, v8, (__int64)"-W ");
LABEL_72:
        return v40;
      }
      v39 = *(_DWORD *)a7;
...
__int64 __fastcall sub_405EE0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax@1

  dword_60A420 = dword_60A25C;
  dword_60A424 = dword_60A258;
  result = sub_405910(a1, a2, a3, a4, a5, a6, (__int64)&dword_60A420, a7);
...
__int64 __fastcall sub_405F60(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5)
{
  return sub_405EE0(a1, a2, a3, a4, a5, 0, 0);
}

size_t __fastcall sub_405FE0(wchar_t *pwc, char *s, size_t a3, mbstate_t *a4)
{
  size_t v4; // rbx@2
  wchar_t *v5; // r12@3
  char *v6; // rbp@3
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_4060C0(0LL, v6) )
  {
    v4 = 1LL;
...
bool __fastcall sub_4060C0(int a1)
{
  char *v1; // rdx@1
  bool result; // al@1
  bool v3; // cf@1
...
int __fastcall sub_406700(__int64 a1)
{
  __int64 v1; // rdx@1
...
__int64 __fastcall sub_406718(__int64 a1, __int64 a2, __int64 a3)
{
  void (**v3)(void); // rbx@1
