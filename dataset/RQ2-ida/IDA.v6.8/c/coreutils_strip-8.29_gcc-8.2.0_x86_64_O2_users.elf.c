__int64 __fastcall main(unsigned int a1, char **a2, char **a3)
{
  ...
  sub_405CF0(
    ...
    "/home/dongkwan/data/scripts/gnu_packages/coreutils/coreutils-8.29_gcc-8.2.0_x86_64_O2_debug/gogo/share/locale");
  sub_401F50(a1);
  if ( sub_405220(a1, a2, "", &unk_406080, 0LL) != -1 )
LABEL_8:
    sub_401B90(1);
  if ( a1 == dword_60925C )
  {
  ...
  {
    LODWORD(v4) = sub_403C80(a2[dword_60925C + 1]);
    v5 = v4;
...
void __fastcall sub_4019D0(__int64 a1, unsigned int a2)
{
  ...
  __int64 v4; // rdi@2
  _QWORD *v5; // rax@4
  signed __int64 v6; // r14@4
  _QWORD *v7; // r12@4
  size_t v8; // rbp@5
  unsigned __int64 v9; // r15@11
  unsigned __int64 v10; // rbx@11
  char *v11; // rax@12
  void **v12; // rbp@15
  ...
  __int64 v17; // rbx@20
  int *v18; // rax@20
  unsigned __int64 v19; // [sp+0h] [bp-48h]@1
  void *ptr; // [sp+8h] [bp-40h]@1

  if ( sub_405380(a1, &v19, &ptr, a2) )
  {
    LODWORD(v16) = sub_403B00(0LL, 3LL, a1);
    v17 = v16;
  ...
  v3 = ptr;
  v4 = 8 * v19;
  if ( v19 & 0x1000000000000000LL || v19 >> 61 != 0 )
LABEL_21:
    sub_404490(v4);
  LODWORD(v5) = sub_404240(v4);
  v6 = v2 - 1;
  v7 = v5;
  if ( v2 )
  {
    ...
    do
    {
      if ( *((_BYTE *)v3 + 44) && *(_WORD *)v3 == 7 )
      {
        LODWORD(v15) = sub_405320(v3);
        v7[v8++] = v15;
      }
      --v6;
      v3 = (char *)v3 + 384;
    ...
    if ( v8 )
    {
      ...
      do
      {
        fputs_unlocked((const char *)v7[v10], stdout);
        v11 = stdout->_IO_write_ptr;
        if ( v11 >= stdout->_IO_write_end )
        {
          __overflow(stdout, v10 < v9 ? 32 : 10);
        }
        else
        {
...
void __fastcall __noreturn sub_401B90(int status)
{
  ...
  char *v23; // rax@17
  char *v24; // rax@19
  const char *v25; // [sp+0h] [bp-88h]@4
  const char *v26; // [sp+8h] [bp-80h]@4
  const char *v27; // [sp+10h] [bp-78h]@4
  const char *v28; // [sp+18h] [bp-70h]@4
  const char *v29; // [sp+20h] [bp-68h]@4
  const char *v30; // [sp+28h] [bp-60h]@4
  const char *v31; // [sp+30h] [bp-58h]@4
  const char *v32; // [sp+38h] [bp-50h]@4
  const char *v33; // [sp+40h] [bp-48h]@4
  const char *v34; // [sp+48h] [bp-40h]@4
  const char *v35; // [sp+50h] [bp-38h]@4
  const char *v36; // [sp+58h] [bp-30h]@4
  __int64 v37; // [sp+60h] [bp-28h]@4
  __int64 v38; // [sp+68h] [bp-20h]@4
  ...
  v5 = dcgettext(
         ...
         "\n",
         5);
  __printf_chk(1LL, v5, "/var/run/utmp");
  v6 = stdout;
  ...
  do
  {
    ...
    do
    {
      if ( !v15 )
        break;
      v12 = (const unsigned __int8)*v14 < *v11;
      v13 = *v14++ == *v11++;
      --v15;
    }
    while ( v13 );
  ...
  while ( (!v12 && !v13) != v12 );
  v16 = (const char *)v10[1];
  if ( v16 )
  {
    v17 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v17, &unk_405DFA);
    v18 = setlocale(5, 0LL);
  ...
  {
    v21 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v21, &unk_405DFA);
    v22 = setlocale(5, 0LL);
...
int sub_401EB0()
{
  ...
  if ( ((int (__fastcall *)(FILE *))loc_405530)(stdout) )
  {
    v0 = __errno_location();
    v1 = v0;
    if ( !byte_609298 || *v0 != 32 )
    {
      ...
      if ( qword_6092A0 )
      {
        LODWORD(v5) = sub_403AD0(qword_6092A0, "write error");
...
LABEL_8:
  ...
  result = ((int (__fastcall *)(FILE *))loc_405530)(stderr);
  if ( result )
    goto LABEL_8;
  return result;
}
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_4052A0((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_403430(__int64 a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_609250 <= (signed int)a1 )
  {
    ...
    {
      LODWORD(v10) = sub_4042A0(off_609238, v9);
      off_609238 = v10;
      v7 = v10;
    }
    memset(&v7[dword_609250], 0, 16LL * ((signed int)a1 + 1 - dword_609250));
    dword_609250 = a1 + 1;
  }
  ...
  v23 = *(_DWORD *)(v5 + 4) | 1;
  v13 = *(_QWORD *)v11;
  v14 = sub_402200(v12, *(_QWORD *)v11, v21, v4, *(_DWORD *)v5, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v13 <= v14 )
  {
    v15 = v14 + 1;
    *(_QWORD *)v11 = v14 + 1;
    ...
    LODWORD(v17) = sub_404240(v15);
    v18 = *(_DWORD *)v5;
    *(_QWORD *)(v11 + 8) = v17;
    v12 = v17;
    sub_402200(v17, v15, v21, v4, v18, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v22;
  return v12;
}
...
_BYTE *__fastcall sub_403A50(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  return sub_403430(0LL, a1, a2, (__int64)&v4);
}
...
int __fastcall sub_403CA0(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12@1
  __int64 v7; // rbx@1
  char *v8; // rax@3
...
int __fastcall sub_4040A0(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v5; // r9@1
  __int64 *v6; // r10@2
  __int64 v7; // rax@2
  ...
  do
  {
    ...
    if ( *(_DWORD *)a5 <= 0x2Fu )
    {
      ...
      *(_DWORD *)a5 = v8 + 8;
      ...
      v12[v5] = *v6;
      if ( !v7 )
        return sub_403CA0(a1, a2, a3, a4, (__int64)v12, v5);
      goto LABEL_3;
    }
    v9 = *(__int64 **)(a5 + 8);
    *(_QWORD *)(a5 + 8) = v9 + 1;
...
__int64 __fastcall sub_4044D0(__int64 a1, __int64 a2)
{
...
signed __int64 __fastcall sub_4045B0(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8, __int64 a9)
{
  const char *v9; // r14@1
  char *v10; // rbp@1
  size_t v11; // r13@5
...
__int64 __fastcall sub_404BD0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8)
{
  int v8; // er13@1
  signed int v9; // eax@2
  int v10; // ebp@2
    ...
    if ( *(_BYTE *)v21 == 45 )
    {
      ...
      if ( v36 )
      {
        if ( v53 )
        {
          ...
          {
            *(_QWORD *)(a7 + 32) = v21 + 2;
            v40 = sub_4045B0(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"--");
            goto LABEL_72;
          }
          if ( a6 )
          {
            ...
            {
              *(_QWORD *)(a7 + 32) = v21 + 1;
              v26 = sub_4045B0(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"-");
              if ( v26 != -1 )
...
LABEL_71:
        *(_QWORD *)(a7 + 32) = v28;
        *(_QWORD *)(a7 + 16) = 0LL;
        v40 = sub_4045B0(v10, v11, v12, v53, v54, 0, a7, v8, (__int64)"-W ");
LABEL_72:
        return v40;
      }
      v39 = *(_DWORD *)a7;
...
__int64 __fastcall sub_4051A0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax@1

  dword_609400 = dword_60925C;
  dword_609404 = dword_609258;
  result = sub_404BD0(a1, a2, a3, a4, a5, a6, (__int64)&dword_609400, a7);
...
__int64 __fastcall sub_405220(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5)
{
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_405590(0LL, v6) )
  {
    v4 = 1LL;
...
int __fastcall sub_405B60(FILE *stream)
{
  ...
  if ( fileno(stream) < 0
    ...
    || !(unsigned int)sub_405BE0(stream) )
  {
...
int __fastcall sub_405CF0(__int64 a1)
{
  __int64 v1; // rdx@1
