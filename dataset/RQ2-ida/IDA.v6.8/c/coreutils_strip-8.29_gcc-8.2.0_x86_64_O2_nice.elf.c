__int64 __fastcall main(signed int a1, char **a2, char **a3)
{
  ...
  int v19; // edi@29
  int v20; // ebx@31
  const char **v21; // rsi@32
  int v22; // ebx@32
  __int64 v23; // rax@32
  signed int v25; // edx@35
  char *v26; // rax@40
  __int64 v27; // rax@42
  char *v28; // rax@42
  signed __int64 v29; // [sp+8h] [bp-30h]@0
...
LABEL_41:
      ...
      if ( !setpriority(0, 0, v12 + (_DWORD)v10) )
        goto LABEL_46;
LABEL_27:
      ...
      {
LABEL_46:
        v21 = (const char **)&v3[(signed int)v5];
        execvp(*v21, (char *const *__attribute__((__org_arrdim(0,0))) )v21);
        v22 = *v4 == 2;
        LODWORD(v23) = sub_403BA0(*v21, v21);
        v20 = v22 + 126;
        error(0, *v4, "%s", v23);
      }
      return (unsigned int)v20;
    }
    LODWORD(v27) = sub_403BA0(v6, 0LL);
    v5 = v27;
...
void __fastcall __noreturn sub_401B60(int status)
{
  ...
  v4 = dcgettext(0LL, "Usage: %s [OPTION] [COMMAND [ARG]...]\n", 5);
  ...
  v5 = dcgettext(
         ...
         5);
  __printf_chk(1LL, v5, 4294967276LL);
  v6 = stdout;
  v7 = dcgettext(0LL, "\nMandatory arguments to long options are mandatory for short options too.\n", 5);
  fputs_unlocked(v7, v6);
  v8 = stdout;
  v9 = dcgettext(0LL, "  -n, --adjustment=N   add integer N to the niceness (default 10)\n", 5);
  ...
  {
    v22 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v22, &unk_40621F);
    v23 = setlocale(5, 0LL);
  ...
  {
    v26 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v26, &unk_40621F);
    v27 = setlocale(5, 0LL);
...
__int64 sub_401EE0()
{
  ...
  if ( (unsigned int)sub_405990(stdout) )
  {
    ...
    if ( !byte_609298 || *v0 != 32 )
    {
      ...
      if ( qword_6092A0 )
      {
        LODWORD(v5) = sub_4039F0(qword_6092A0, "write error");
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_405910((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_403350(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_609250 <= a1 )
  {
    ...
    {
      LODWORD(v10) = sub_4041C0(off_609238, v9);
      off_609238 = v10;
      v7 = v10;
    }
  ...
  v23 = *(_DWORD *)(v5 + 4) | 1;
  v13 = *(_QWORD *)v11;
  v14 = sub_402120(v12, *(_QWORD *)v11, v21, v4, *(_DWORD *)v5, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v13 <= v14 )
  {
    v15 = v14 + 1;
    *(_QWORD *)v11 = v14 + 1;
    ...
    LODWORD(v17) = sub_404160(v15);
    v18 = *(_DWORD *)v5;
    *(_QWORD *)(v11 + 8) = v17;
    v12 = v17;
    sub_402120(v17, v15, v21, v4, v18, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v22;
  return v12;
}
...
_BYTE *__fastcall sub_403970(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  return sub_403350(0, a1, a2, (__int64)&v4);
}
...
int __fastcall sub_403BC0(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12@1
  __int64 v7; // rbx@1
  char *v8; // rax@3
...
int __fastcall sub_404020(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  char *v7; // r10@1
  signed int v8; // er8@1
  __int64 v9; // r9@1
  ...
  do
  {
    if ( (unsigned int)v8 <= 0x2F )
    {
      ...
      v15[v9] = v11;
      if ( !v11 )
        return sub_403BC0(a1, a2, a3, a4, (__int64)v15, v9);
      goto LABEL_3;
    }
    v12 = (__int64 *)v7;
    v7 += 8;
...
void *__fastcall sub_404360(const void *a1, size_t a2)
{
  void *v2; // rax@1
...
__int64 __fastcall sub_4043F0(char *nptr, char **a2, unsigned int a3, signed __int64 *a4, const char *a5)
{
  char **v5; // rbx@2
  int v6; // ebp@2
  const char *v7; // r14@4
...
__int64 __fastcall sub_404B40(__int64 a1, __int64 a2)
{
...
signed __int64 __fastcall sub_404C20(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8, __int64 a9)
{
  const char *v9; // r14@1
  char *v10; // rbp@1
  size_t v11; // r13@5
...
__int64 __fastcall sub_405240(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8)
{
  int v8; // er13@1
  signed int v9; // eax@2
  int v10; // ebp@2
    ...
    if ( *(_BYTE *)v21 == 45 )
    {
      ...
      if ( v36 )
      {
        if ( v53 )
        {
          ...
          {
            *(_QWORD *)(a7 + 32) = v21 + 2;
            v40 = sub_404C20(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"--");
            goto LABEL_72;
          }
          if ( a6 )
          {
            ...
            {
              *(_QWORD *)(a7 + 32) = v21 + 1;
              v26 = sub_404C20(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"-");
              if ( v26 != -1 )
...
LABEL_71:
        *(_QWORD *)(a7 + 32) = v28;
        *(_QWORD *)(a7 + 16) = 0LL;
        v40 = sub_404C20(v10, v11, v12, v53, v54, 0, a7, v8, (__int64)"-W ");
LABEL_72:
        return v40;
      }
      v39 = *(_DWORD *)a7;
...
__int64 __fastcall sub_405810(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax@1

  dword_609400 = dword_60925C;
  dword_609404 = dword_609258;
  result = sub_405240(a1, a2, a3, a4, a5, a6, (__int64)&dword_609400, a7);
...
__int64 __fastcall sub_405890(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5)
{
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_4059F0(0LL, v6) )
  {
    v4 = 1LL;
...
int __fastcall sub_405FC0(FILE *stream)
{
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_406040(stream) )
  {
...
int __fastcall sub_406040(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_406080(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
int __fastcall sub_406150(__int64 a1)
{
  __int64 v1; // rdx@1
