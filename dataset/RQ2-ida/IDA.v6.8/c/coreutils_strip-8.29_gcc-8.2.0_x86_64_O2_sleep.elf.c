__int64 __fastcall main(int a1, char **a2, char **a3)
{
  ...
  char *v14; // rbx@26
  int *v15; // rax@26
  double v16; // [sp+8h] [bp-30h]@4
  double v17; // [sp+10h] [bp-28h]@6
  __int64 v18; // [sp+18h] [bp-20h]@8
  ...
  sub_405B70(
    ...
    "/home/dongkwan/data/scripts/gnu_packages/coreutils/coreutils-8.29_gcc-8.2.0_x86_64_O2_debug/gogo/share/locale");
  sub_401D70(a1);
  if ( sub_405140((unsigned int)a1, a2, "", &unk_406000, 0LL) != -1 )
    goto LABEL_25;
  if ( a1 == 1 )
  {
  ...
  if ( a1 > dword_60923C )
  {
    ...
    v3 = &a2[dword_60923C];
    v4 = 1;
    v5 = &(&a2[dword_60923C + 1])[8 * (unsigned __int64)(unsigned int)(a1 + ~dword_60923C)];
    while ( 1 )
    {
      if ( (unsigned __int8)sub_404350(*v3, &v18, &v17, sub_401C40) || *__errno_location() == 34 )
      {
        v10 = v17;
        v11 = *(_BYTE *)v18;
        if ( !*(_BYTE *)v18 )
      ...
      LODWORD(v6) = sub_403AA0(*v3);
      v7 = v6;
      v8 = dcgettext(0LL, "invalid time interval %s", 5);
      v9 = v7;
      v4 = 0;
      error(0, 0, v8, v9);
      v10 = v17;
...
LABEL_20:
  if ( sub_4042F0() )
  {
    v14 = dcgettext(0LL, "cannot read realtime clock", 5);
...
void __fastcall __noreturn sub_401970(int status)
{
  ...
  bool v11; // cf@5
  bool v12; // zf@5
  const char *v13; // rsi@6
  signed __int64 v14; // rcx@6
  char *v15; // rbp@10
  char *v16; // rax@11
  char *v17; // rax@11
  char *v18; // r12@13
  ...
  do
  {
    ...
    do
    {
      if ( !v14 )
        break;
      v11 = (const unsigned __int8)*v13 < *v10;
      v12 = *v13++ == *v10++;
      --v14;
    }
    while ( v12 );
  ...
  {
    v16 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v16, &unk_405C40, "https://www.gnu.org/software/coreutils/");
    v17 = setlocale(5, 0LL);
  ...
  {
    v21 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v21, &unk_405C40, "https://www.gnu.org/software/coreutils/");
    v22 = setlocale(5, 0LL);
    if ( !v22 || !strncmp(v22, "en_", 3uLL) )
    {
      ...
      __printf_chk(1LL, v23, "https://www.gnu.org/software/coreutils/", "sleep");
LABEL_15:
...
LABEL_3:
  ...
  __printf_chk(1LL, v24, "sleep", v25);
LABEL_13:
  v18 = "Multi-call invocation" + 10;
  v19 = dcgettext(0LL, "Full documentation at: <%s%s>\n", 5);
  __printf_chk(1LL, v19, "https://www.gnu.org/software/coreutils/", "sleep");
  if ( v15 != "sleep" )
    v18 = "";
  goto LABEL_15;
}

void __fastcall sub_401C40(const char *a1, char **a2)
{
  if ( !qword_609278 )
    qword_609278 = (__int64)newlocale(8127, "C", 0LL);
  if ( qword_609278 )
  {
    strtod_l(a1, a2, (__locale_t)qword_609278);
  }
  else if ( a2 )
  {
    *a2 = (char *)a1;
...
__int64 sub_401CD0()
{
  ...
  if ( (unsigned int)sub_4052F0(stdout) )
  {
    ...
    if ( !byte_609280 || *v0 != 32 )
    {
      ...
      if ( qword_609288 )
      {
        LODWORD(v5) = sub_4038F0(qword_609288, "write error");
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_4051C0((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_403250(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_609230 <= a1 )
  {
    ...
    {
      LODWORD(v10) = sub_4040C0(off_609218, v9);
      off_609218 = v10;
      v7 = v10;
    }
  ...
  v23 = *(_DWORD *)(v5 + 4) | 1;
  v13 = *(_QWORD *)v11;
  v14 = sub_402020(v12, *(_QWORD *)v11, v21, v4, *(_DWORD *)v5, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v13 <= v14 )
  {
    v15 = v14 + 1;
    *(_QWORD *)v11 = v14 + 1;
    ...
    LODWORD(v17) = sub_404060(v15);
    v18 = *(_DWORD *)v5;
    *(_QWORD *)(v11 + 8) = v17;
    v12 = v17;
    sub_402020(v17, v15, v21, v4, v18, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v22;
  return v12;
}
...
_BYTE *__fastcall sub_403870(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  return sub_403250(0, a1, a2, (__int64)&v4);
}
...
int __fastcall sub_403AC0(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12@1
  __int64 v7; // rbx@1
  char *v8; // rax@3
...
int __fastcall sub_403EC0(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v5; // r9@1
  __int64 *v6; // r10@2
  __int64 v7; // rax@2
  ...
  do
  {
    ...
    if ( *(_DWORD *)a5 <= 0x2Fu )
    {
      ...
      *(_DWORD *)a5 = v8 + 8;
      ...
      v12[v5] = *v6;
      if ( !v7 )
        return sub_403AC0(a1, a2, a3, a4, (__int64)v12, v5);
      goto LABEL_3;
    }
    v9 = *(__int64 **)(a5 + 8);
    *(_QWORD *)(a5 + 8) = v9 + 1;
...
void *__fastcall sub_404260(const void *a1, size_t a2)
{
  void *v2; // rax@1
...
bool __fastcall sub_404350(_BYTE *a1, _QWORD *a2, double *a3, void (__fastcall *a4)(_QWORD, _QWORD), double a5)
{
...
__int64 __fastcall sub_4043F0(__int64 a1, __int64 a2)
{
...
signed __int64 __fastcall sub_4044D0(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8, __int64 a9)
{
  const char *v9; // r14@1
  char *v10; // rbp@1
  size_t v11; // r13@5
...
__int64 __fastcall sub_404AF0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8)
{
  int v8; // er13@1
  signed int v9; // eax@2
  int v10; // ebp@2
    ...
    if ( *(_BYTE *)v21 == 45 )
    {
      ...
      if ( v36 )
      {
        if ( v53 )
        {
          ...
          {
            *(_QWORD *)(a7 + 32) = v21 + 2;
            v40 = sub_4044D0(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"--");
            goto LABEL_72;
          }
          if ( a6 )
          {
            ...
            {
              *(_QWORD *)(a7 + 32) = v21 + 1;
              v26 = sub_4044D0(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"-");
              if ( v26 != -1 )
...
LABEL_71:
        *(_QWORD *)(a7 + 32) = v28;
        *(_QWORD *)(a7 + 16) = 0LL;
        v40 = sub_4044D0(v10, v11, v12, v53, v54, 0, a7, v8, (__int64)"-W ");
LABEL_72:
        return v40;
      }
      v39 = *(_DWORD *)a7;
...
__int64 __fastcall sub_4050C0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax@1

  dword_6093E0 = dword_60923C;
  dword_6093E4 = dword_609238;
  result = sub_404AF0(a1, a2, a3, a4, a5, a6, (__int64)&dword_6093E0, a7);
...
__int64 __fastcall sub_405140(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5)
{
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_405410(0LL, v6) )
  {
    v4 = 1LL;
...
signed __int64 __fastcall sub_405350(double a1)
{
...
int __fastcall sub_4059E0(FILE *stream)
{
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_405A60(stream) )
  {
...
int __fastcall sub_405A60(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_405AA0(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
int __fastcall sub_405B70(__int64 a1)
{
  __int64 v1; // rdx@1
