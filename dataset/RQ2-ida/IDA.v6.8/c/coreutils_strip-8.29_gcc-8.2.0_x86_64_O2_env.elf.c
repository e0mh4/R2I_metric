__int64 __fastcall main(int a1, char **a2, char **a3)
{
  ...
  int v8; // ebp@23
  __int64 v9; // r15@24
  const char *v10; // rsi@28
  char *v11; // rax@29
  const char *v12; // r15@35
  char *v13; // r14@35
  int v14; // ebp@41
  __int64 v15; // rax@41
  __int64 v17; // rax@44
...
LABEL_8:
  ...
  while ( 1 )
  {
    ...
    {
      LODWORD(v17) = sub_403C40(name);
      v18 = v17;
      v19 = dcgettext(0LL, "cannot unset %s", 5);
      v20 = __errno_location();
      error(125, *v20, v19, v18);
      goto LABEL_45;
    }
  }
  v8 = dword_60923C;
...
LABEL_45:
    ...
    while ( 1 )
    {
      ...
      if ( !*v21 )
        break;
      ++v21;
      __printf_chk(1LL, "%s%c", v22, (unsigned __int8)v30 < 1u ? 0xA : 0);
    }
    v14 = 0;
  }
  else
  {
    while ( 1 )
    {
      ...
      {
        *v13 = 0;
        LODWORD(v23) = sub_403C40(a2[dword_60923C]);
        v24 = v23;
        v25 = dcgettext(0LL, "cannot set %s", 5);
        v26 = __errno_location();
        error(125, *v26, v25, v24);
        goto LABEL_50;
      }
      v8 = dword_60923C + 1;
      dword_60923C = v8;
    ...
    {
LABEL_50:
      LODWORD(v27) = sub_4039F0(4LL, v3);
      v28 = v27;
      v29 = dcgettext(0LL, "cannot change directory to %s", 5);
      error(125, *v4, v29, v28);
      start();
    }
    execvp(a2[dword_60923C], &a2[dword_60923C]);
    v14 = (*v4 == 2) + 126;
    LODWORD(v15) = sub_403C40(a2[dword_60923C]);
    error(0, *v4, "%s", v15);
  }
...
void __fastcall __noreturn sub_401BE0(int status)
{
  ...
  v4 = dcgettext(0LL, "Usage: %s [OPTION]... [-] [NAME=VALUE]... [COMMAND [ARG]...]\n", 5);
  __printf_chk(1LL, v4, v2, v5);
  v6 = stdout;
  v7 = dcgettext(0LL, "Set each NAME to VALUE in the environment and run COMMAND.\n", 5);
  ...
  v12 = stdout;
  v13 = dcgettext(0LL, "  -C, --chdir=DIR      change working directory to DIR\n", 5);
  ...
  {
    v27 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v27, &unk_405B7E, "https://www.gnu.org/software/coreutils/");
    v28 = setlocale(5, 0LL);
  ...
  {
    v32 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v32, &unk_405B7E, "https://www.gnu.org/software/coreutils/");
    v33 = setlocale(5, 0LL);
    if ( !v33 || !strncmp(v33, "en_", 3uLL) )
    {
      ...
      __printf_chk(1LL, v34, "https://www.gnu.org/software/coreutils/", &unk_405B04);
LABEL_15:
...
LABEL_3:
  ...
  __printf_chk(1LL, v35, &unk_405B04, v36);
LABEL_13:
  v29 = "Multi-call invocation" + 10;
  v30 = dcgettext(0LL, "Full documentation at: <%s%s>\n", 5);
  __printf_chk(1LL, v30, "https://www.gnu.org/software/coreutils/", &unk_405B04);
  if ( v26 != &unk_405B04 )
    v29 = "";
  goto LABEL_15;
}
...
__int64 sub_401F80()
{
  ...
  if ( (unsigned int)sub_4052E0(stdout) )
  {
    ...
    if ( !byte_6092A0 || *v0 != 32 )
    {
      ...
      if ( qword_6092A8 )
      {
        LODWORD(v5) = sub_403A90(qword_6092A8, "write error");
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_405260((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_4033F0(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_609230 <= a1 )
  {
    ...
    {
      LODWORD(v10) = sub_404260(off_609218, v9);
      off_609218 = v10;
      v7 = v10;
    }
  ...
  v23 = *(_DWORD *)(v5 + 4) | 1;
  v13 = *(_QWORD *)v11;
  v14 = sub_4021C0(v12, *(_QWORD *)v11, v21, v4, *(_DWORD *)v5, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v13 <= v14 )
  {
    v15 = v14 + 1;
    *(_QWORD *)v11 = v14 + 1;
    ...
    LODWORD(v17) = sub_404200(v15);
    v18 = *(_DWORD *)v5;
    *(_QWORD *)(v11 + 8) = v17;
    v12 = v17;
    sub_4021C0(v17, v15, v21, v4, v18, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v22;
  return v12;
}
...
_BYTE *__fastcall sub_403A10(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  return sub_4033F0(0, a1, a2, (__int64)&v4);
}
...
int __fastcall sub_403C60(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12@1
  __int64 v7; // rbx@1
  char *v8; // rax@3
...
int __fastcall sub_4040C0(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  char *v7; // r10@1
  signed int v8; // er8@1
  __int64 v9; // r9@1
  ...
  do
  {
    if ( (unsigned int)v8 <= 0x2F )
    {
      ...
      v15[v9] = v11;
      if ( !v11 )
        return sub_403C60(a1, a2, a3, a4, (__int64)v15, v9);
      goto LABEL_3;
    }
    v12 = (__int64 *)v7;
    v7 += 8;
...
void *__fastcall sub_404400(const void *a1, size_t a2)
{
  void *v2; // rax@1
...
__int64 __fastcall sub_404490(__int64 a1, __int64 a2)
{
...
signed __int64 __fastcall sub_404570(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8, __int64 a9)
{
  const char *v9; // r14@1
  char *v10; // rbp@1
  size_t v11; // r13@5
...
__int64 __fastcall sub_404B90(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8)
{
  int v8; // er13@1
  signed int v9; // eax@2
  int v10; // ebp@2
    ...
    if ( *(_BYTE *)v21 == 45 )
    {
      ...
      if ( v36 )
      {
        if ( v53 )
        {
          ...
          {
            *(_QWORD *)(a7 + 32) = v21 + 2;
            v40 = sub_404570(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"--");
            goto LABEL_72;
          }
          if ( a6 )
          {
            ...
            {
              *(_QWORD *)(a7 + 32) = v21 + 1;
              v26 = sub_404570(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"-");
              if ( v26 != -1 )
...
LABEL_71:
        *(_QWORD *)(a7 + 32) = v28;
        *(_QWORD *)(a7 + 16) = 0LL;
        v40 = sub_404570(v10, v11, v12, v53, v54, 0, a7, v8, (__int64)"-W ");
LABEL_72:
        return v40;
      }
      v39 = *(_DWORD *)a7;
...
__int64 __fastcall sub_405160(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax@1

  dword_609400 = dword_60923C;
  dword_609404 = dword_609238;
  result = sub_404B90(a1, a2, a3, a4, a5, a6, (__int64)&dword_609400, a7);
...
__int64 __fastcall sub_4051E0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5)
{
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_405340(0LL, v6) )
  {
    v4 = 1LL;
...
int __fastcall sub_405910(FILE *stream)
{
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_405990(stream) )
  {
...
int __fastcall sub_405990(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_4059D0(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
int __fastcall sub_405AA0(__int64 a1)
{
  __int64 v1; // rdx@1
