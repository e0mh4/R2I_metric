...
{
  __int64 (__fastcall *v3)(char *); // rbx@1
  int v4; // eax@2
  int v5; // er14@12
  int v7; // eax@16
  __int64 v8; // rax@20
...
signed int sub_401BD1()
{
  signed int result; // eax@4

  if ( !byte_60B2C8 )
  {
    while ( qword_60B2D0 < (unsigned __int64)(((&unk_60AE48 - (_UNKNOWN *)&qword_60AE40) >> 3) - 1) )
      (*(&qword_60AE40 + ++qword_60B2D0))();
    result = sub_401B7B();
    byte_60B2C8 = 1;
  }
  return result;
...
__int64 __fastcall sub_401C30(char *file, int a2)
{
  ...
  int *v27; // rax@22
  __int64 v28; // rcx@22
  __int64 v29; // [sp+0h] [bp-22C8h]@14
  char buf[8248]; // [sp+290h] [bp-2038h]@7
  ...
  do
  {
    if ( !v2 )
      break;
    v7 = (const unsigned __int8)*v6 < *v5;
    v8 = *v6++ == *v5++;
    --v2;
  }
  while ( v8 );
  ...
  else
  {
    ...
    {
LABEL_22:
      LODWORD(v25) = sub_404B50(0LL, 3LL, v4);
      v26 = v25;
  ...
  for ( i = 0LL; ; i += v13 )
  {
    v13 = sub_404CF0(v10, buf, 0x2000uLL);
    if ( !v13 )
      break;
    if ( v13 == -1 )
    {
      LODWORD(v21) = sub_404B50(0LL, 3LL, v4);
      v22 = v21;
  ...
  if ( v9 && close(v10) )
    goto LABEL_22;
  LODWORD(v16) = sub_402520(i, &v29, 0LL, 1LL, 512LL);
  __printf_chk(
    1LL,
    "%d %s",
    (unsigned int)(unsigned __int16)(v11 + HIWORD(v11)) + ((signed int)((unsigned __int16)v11 + (v11 >> 16)) >> 16),
    v16);
  if ( v3 )
    __printf_chk(1LL, &unk_408EEA, v4, v17);
...
__int64 __fastcall sub_401E10(char *filename, signed int a2)
{
  signed __int64 v2; // rcx@1
  ...
  while ( 1 )
  {
    if ( v13 > v14 )
    {
      ...
      LOWORD(v14) = (unsigned __int8)*v14;
      goto LABEL_8;
    }
    LODWORD(v14) = __uflow(v10);
    if ( (_DWORD)v14 == -1 )
      break;
    v13 = v10->_IO_read_end;
    v15 = (signed __int64)v10->_IO_read_ptr;
LABEL_8:
    ++v11;
    LOWORD(v12) = (_WORD)v14 + (v12 >> 1) + ((_WORD)v12 << 15);
    v14 = (char *)v15;
    v12 = (unsigned __int16)v12;
  }
  if ( !(v10->_flags & 0x20) )
  {
    if ( !v9 || !(unsigned int)sub_4059C0(v10) )
    {
      LODWORD(v16) = sub_402520(v11, &v29, 0LL, 1LL, 1024LL);
      __printf_chk(1LL, "%05d %5s", (unsigned int)v12, v16);
      if ( v3 > 1 )
        __printf_chk(1LL, &unk_408EEA, v4, v17);
      v18 = stdout->_IO_write_ptr;
      if ( v18 >= stdout->_IO_write_end )
...
void __fastcall __noreturn sub_402020(int status)
{
  ...
  {
    v28 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v28, &unk_407449, "https://www.gnu.org/software/coreutils/");
    v29 = setlocale(5, 0LL);
    if ( !v29 || !strncmp(v29, "en_", 3uLL) )
    {
      ...
      __printf_chk(1LL, v30, "https://www.gnu.org/software/coreutils/", 4224046LL);
LABEL_15:
...
LABEL_3:
  ...
  __printf_chk(1LL, v31, 4224046LL, v32);
LABEL_13:
  v25 = "Multi-call invocation" + 10;
  v26 = dcgettext(0LL, "Full documentation at: <%s%s>\n", 5);
  __printf_chk(1LL, v26, "https://www.gnu.org/software/coreutils/", 4224046LL);
  if ( v22 != 4224046 )
    v25 = "";
  goto LABEL_15;
}
...
__int64 sub_402380()
{
  ...
  if ( (unsigned int)sub_406CC0(stdout) )
  {
    ...
    if ( !byte_60B2E0 || *v0 != 32 )
    {
      ...
      if ( qword_60B2E8 )
      {
        LODWORD(v5) = sub_404B20(qword_60B2E8, "write error");
...
long double __usercall sub_402460@<st0>(int a1@<edi>, __int128 a2)
{
  __int128 v2; // fst7@2
...
signed __int64 __fastcall sub_402520(unsigned __int64 a1, char *a2, __int16 a3, unsigned __int64 a4, unsigned __int64 a5)
{
...
LABEL_72:
      ...
      {
        v56 = (_BYTE *)(v73 + 1);
        *(_BYTE *)v73 = byte_407898[(signed __int64)v23];
        if ( v39 )
        {
          if ( v81 )
          {
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_4068B0((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_404480(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_60B270 <= a1 )
  {
    ...
    {
      LODWORD(v10) = sub_405350(off_60B258, v9);
      off_60B258 = v10;
      v7 = v10;
    }
  ...
  v23 = *(_DWORD *)(v5 + 4) | 1;
  v13 = *(_QWORD *)v11;
  v14 = sub_403250(v12, *(_QWORD *)v11, v21, v4, *(_DWORD *)v5, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v13 <= v14 )
  {
    v15 = v14 + 1;
    *(_QWORD *)v11 = v14 + 1;
    if ( (_UNKNOWN *)v12 != &unk_60B300 )
    {
      v16 = v14 + 1;
      free(v12);
      v15 = v16;
    ...
    *(_QWORD *)(v11 + 8) = v17;
    v12 = v17;
    sub_403250(v17, v15, v21, v4, v18, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v22;
  return v12;
}
...
_BYTE *__fastcall sub_404AA0(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  v7 = qword_60B430;
  v4 = _mm_load_si128((const __m128i *)&xmmword_60B400);
  v5 = _mm_load_si128((const __m128i *)&xmmword_60B410);
  ...
  return sub_404480(0, a1, a2, (__int64)&v4);
}
...
__int64 __fastcall sub_404CF0(int fd, void *buf, size_t nbytes)
{
...
int __fastcall sub_4059C0(FILE *stream)
{
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_405A40(stream) )
  {
...
int __fastcall sub_405A40(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_405A80(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
__int64 __fastcall sub_405AE0(__int64 a1, __int64 a2)
{
...
signed __int64 __fastcall sub_405BC0(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8, __int64 a9)
{
  const char *v9; // r14@1
  char *v10; // rbp@1
  size_t v11; // r13@5
...
__int64 __fastcall sub_4061E0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8)
{
  int v8; // er13@1
  signed int v9; // eax@2
  int v10; // ebp@2
    ...
    if ( *(_BYTE *)v21 == 45 )
    {
      ...
      if ( v36 )
      {
        if ( v53 )
        {
          ...
          {
            *(_QWORD *)(a7 + 32) = v21 + 2;
            v40 = sub_405BC0(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"--");
            goto LABEL_72;
          }
          if ( a6 )
          {
            ...
            {
              *(_QWORD *)(a7 + 32) = v21 + 1;
              v26 = sub_405BC0(v10, v11, v12, v53, v54, a6, a7, v8, 4230770LL);
              if ( v26 != -1 )
...
LABEL_71:
        *(_QWORD *)(a7 + 32) = v28;
        *(_QWORD *)(a7 + 16) = 0LL;
        v40 = sub_405BC0(v10, v11, v12, v53, v54, 0, a7, v8, (__int64)"-W ");
LABEL_72:
        return v40;
      }
      v39 = *(_DWORD *)a7;
...
__int64 __fastcall sub_4067B0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax@1

  dword_60B440 = dword_60B27C;
  dword_60B444 = dword_60B278;
  result = sub_4061E0(a1, a2, a3, a4, a5, a6, (__int64)&dword_60B440, a7);
...
__int64 __fastcall sub_406830(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5)
{
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_406D20(0LL, v6) )
  {
    v4 = 1LL;
...
signed __int64 __fastcall sub_406940(const char *a1, const char **a2, char *a3, size_t a4)
{
  size_t v4; // r13@1
  char *v5; // rbp@1
  size_t v6; // rax@1
...
int __fastcall sub_406AE0(char **a1, char *a2, size_t a3)
{
  ...
  for ( i = *a1; i; i = a1[v9] )
  {
    ...
    v5 += v4;
    v12 = sub_404CD0(i);
    __fprintf_chk(stderr, 1LL, &unk_408EE9, v12);
  }
LABEL_7:
...
int __fastcall sub_407360(__int64 a1)
{
  __int64 v1; // rdx@1
