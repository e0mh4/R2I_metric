__int64 __usercall main@<rax>(char **a1@<rsi>, char **a2@<rdx>, unsigned int a3@<edi>, __int64 a4@<r12>)
{
...
void __fastcall __noreturn sub_405DD0(__int64 a1, char *a2, __int64 a3, __int64 a4, __int64 a5)
{
  char *v5; // rdx@1
  __int64 v6; // rax@2
  __int64 v7; // rbp@2
