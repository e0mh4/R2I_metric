__int64 __fastcall main(int a1, char **a2, char **a3)
{
  ...
  sub_405730(
    ...
    "/home/dongkwan/data/scripts/gnu_packages/coreutils/coreutils-8.29_gcc-8.2.0_x86_64_O2_debug/gogo/share/locale");
  sub_401BA0(a1);
  if ( sub_404E70((unsigned int)a1, a2, "", &unk_405A60, 0LL) != -1 )
LABEL_6:
    sub_4017F0(1);
  if ( dword_60823C < a1 )
  {
    LODWORD(v5) = sub_4038D0(a2[dword_60823C], a2, "FIXME: unknown");
    v6 = v5;
  ...
  if ( !v3 )
  {
    v8 = dcgettext(0LL, "no login name", 5);
    error(1, 0, v8);
    start();
  }
  puts(v3);
...
void __fastcall __noreturn sub_4017F0(int status)
{
  ...
  v5 = stdout;
  v6 = dcgettext(0LL, "Print the name of the current user.\n\n", 5);
  ...
  {
    v18 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v18, &unk_405816);
    v19 = setlocale(5, 0LL);
  ...
  {
    v22 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v22, &unk_405816);
    v23 = setlocale(5, 0LL);
...
__int64 sub_401B00()
{
  ...
  if ( (unsigned int)sub_404F70(stdout) )
  {
    ...
    if ( !byte_608278 || *v0 != 32 )
    {
      ...
      if ( qword_608280 )
      {
        LODWORD(v5) = sub_403720(qword_608280, "write error");
...
_BYTE *__fastcall sub_403080(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_608230 <= a1 )
  {
    ...
    {
      LODWORD(v10) = sub_403EF0(off_608218, v9);
      off_608218 = v10;
      v7 = v10;
    }
...
__int64 __fastcall sub_404DF0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  ...
  result = sub_404820(a1, a2, a3, a4, a5, a6, (__int64)&dword_6083E0, a7);
