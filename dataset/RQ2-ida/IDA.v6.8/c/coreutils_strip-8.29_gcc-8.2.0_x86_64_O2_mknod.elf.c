__int64 __fastcall main(int a1, char **a2, char **a3)
{
  ...
  void *v8; // rax@14
  void *v9; // r14@14
  __mode_t v10; // er13@15
  __mode_t v11; // er13@15
  unsigned __int64 v12; // rdx@16
  __int64 v13; // rax@18
  signed __int64 v14; // rax@22
  char *v15; // rdi@22
  unsigned __int64 v16; // rdx@22
  char v17; // al@22
  signed int v19; // er15@31
  char *v20; // r14@32
  char **v21; // rax@38
  int *v22; // rax@38
  __int64 v23; // rax@40
  const char *v24; // rsi@40
  __int64 v25; // rbx@40
  char *v26; // rax@41
  char *v27; // rdi@45
  __int64 v28; // rax@46
  ...
  int *v51; // rax@63
  __int64 v52; // rax@64
  __int64 v53; // [sp+8h] [bp-50h]@0
  __int64 v54; // [sp+10h] [bp-48h]@0
  __dev_t dev; // [sp+18h] [bp-40h]@37
...
LABEL_42:
  ...
  if ( v3 )
  {
    LODWORD(v8) = sub_402310(v3);
    v9 = v8;
    if ( v8 )
    {
      v10 = umask(0);
      umask(v10);
      v11 = sub_4026E0(438LL, 0LL, v10, v9, 0LL);
      free(v9);
      if ( !(v11 & 0xFFFFFE00) )
        goto LABEL_16;
      v33 = dcgettext(0LL, "mode must specify only file permission bits", 5);
      error(1, 0, v33);
    }
    v34 = dcgettext(0LL, "invalid mode", 5);
    error(1, 0, v34);
LABEL_55:
    LODWORD(v35) = sub_404230(4LL, v5[dword_60A25C]);
    v36 = v35;
    v37 = dcgettext(0LL, "cannot set permissions of %s", 5);
...
LABEL_16:
  ...
  if ( dword_60A25C >= a1 )
  {
    ...
    {
LABEL_56:
      v39 = dcgettext(0LL, "missing operand", 5);
      error(0, 0, v39);
      goto LABEL_42;
    }
    if ( v12 == 2 )
...
LABEL_21:
    ...
    v27 = a2[dword_60A25C + 2];
    goto LABEL_46;
  }
  if ( dword_60A25C + 1 >= a1 || (v13 = dword_60A25C, *a2[dword_60A25C + 1] != 112) )
  {
    if ( v12 > 3 )
    {
      if ( v12 > 4 )
      {
        LODWORD(v40) = sub_404480(a2[dword_60A25C + 4]);
        v24 = "extra operand %s";
        v25 = v40;
        goto LABEL_41;
      }
    ...
    LODWORD(v41) = sub_404480(a2[a1 - 1]);
    v42 = v41;
    v43 = dcgettext(0LL, "missing operand after %s", 5);
    error(0, 0, v43, v42);
    if ( a1 - dword_60A25C != 2 )
      goto LABEL_42;
    v31 = "Special files require major and minor device numbers.";
LABEL_48:
  ...
  {
LABEL_64:
    LODWORD(v52) = sub_404480(v5[(_QWORD)v4 - 1]);
    v24 = "missing operand after %s";
    v25 = v52;
    goto LABEL_41;
  }
  if ( v12 > 2 )
  {
    v27 = a2[dword_60A25C + 2];
LABEL_46:
    LODWORD(v28) = sub_404480(v27);
    v29 = v28;
    v30 = dcgettext(0LL, "extra operand %s", 5);
    error(0, 0, v30, v29);
    if ( (_DWORD)v4 - dword_60A25C != 4 )
      goto LABEL_42;
    v31 = "Fifos do not have major and minor device numbers.";
    goto LABEL_48;
  }
LABEL_22:
  v14 = v13 + 1;
...
LABEL_31:
      ...
      while ( 1 )
      {
        v4 = v5[v16 + 1];
        v20 = v5[v16 + 2];
        if ( (unsigned int)sub_404CD0(v5[v16 + 1]) || v53 != (unsigned int)v53 )
          goto LABEL_61;
        if ( (unsigned int)sub_404CD0(v20) || v54 != (unsigned int)v54 )
          break;
        if ( ((unsigned __int8)v54 | (v54 << 12) & 0xFFFFFF00000LL | ((_DWORD)v53 << 8) & 0xFFF00) == -1 )
          goto LABEL_62;
        dev = (unsigned __int8)v54 | (v54 << 12) & 0xFFFFFF00000LL | ((_DWORD)v53 << 8) & 0xFFF00;
        if ( !__xmknod(0, v5[dword_60A25C], v11 | v19, &dev) )
          goto LABEL_26;
        LODWORD(v21) = sub_404300(0LL, 3LL, v5[dword_60A25C]);
        v5 = v21;
...
LABEL_39:
      ...
      LODWORD(v44) = sub_404480(v20);
      v45 = v44;
      v46 = dcgettext(0LL, "invalid minor device number %s", 5);
      error(1, 0, v46, v45);
LABEL_61:
      LODWORD(v47) = sub_404480(v4);
      v5 = v47;
      v48 = dcgettext(0LL, "invalid major device number %s", 5);
      error(1, 0, v48, v5);
LABEL_62:
      v49 = dcgettext(0LL, "invalid device %s %s", 5);
      error(1, 0, v49, v4, v20);
      goto LABEL_63;
    }
LABEL_40:
    LODWORD(v23) = sub_404480(v15);
    v24 = "invalid device type %s";
    v25 = v23;
LABEL_41:
  ...
  if ( mkfifo(a2[v16 - 1], v11) )
  {
LABEL_63:
    LODWORD(v50) = sub_404300(0LL, 3LL, v5[dword_60A25C]);
    v5 = v50;
...
LABEL_26:
  if ( v3 && chmod(v5[dword_60A25C], v11) )
    goto LABEL_55;
  return 0LL;
}
...
void __fastcall __noreturn sub_401E80(int status)
{
  ...
  v4 = dcgettext(0LL, "Usage: %s [OPTION]... NAME TYPE [MAJOR MINOR]\n", 5);
  __printf_chk(1LL, v4, v2);
  v5 = stdout;
  v6 = dcgettext(0LL, "Create the special file NAME of the given TYPE.\n", 5);
  fputs_unlocked(v6, v5);
  v7 = stdout;
  v8 = dcgettext(0LL, "\nMandatory arguments to long options are mandatory for short options too.\n", 5);
  fputs_unlocked(v8, v7);
  v9 = stdout;
  v10 = dcgettext(0LL, "  -m, --mode=MODE    set file permission bits to MODE, not a=rw - umask\n", 5);
  ...
  {
    v29 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v29, &unk_406800);
    v30 = setlocale(5, 0LL);
  ...
  {
    v33 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v33, &unk_406800);
    v34 = setlocale(5, 0LL);
...
__int64 sub_402270()
{
  ...
  if ( (unsigned int)sub_405F60(stdout) )
  {
    ...
    if ( !byte_60A298 || *v0 != 32 )
    {
      ...
      if ( qword_60A2A0 )
      {
        LODWORD(v5) = sub_4042D0(qword_60A2A0, "write error");
...
int __fastcall sub_402310(_BYTE *a1)
{
  _BYTE *v1; // rcx@1
  _BYTE *v2; // rbx@1
  int v3; // edx@1
...
__int64 __fastcall sub_4026E0(__int16 a1, char a2, int a3, __int64 a4, _DWORD *a5)
{
  char v5; // r11@1
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_405EE0((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_403C30(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_60A250 <= a1 )
  {
    ...
    {
      LODWORD(v10) = sub_404AA0(off_60A238, v9);
      off_60A238 = v10;
      v7 = v10;
    }
  ...
  v23 = *(_DWORD *)(v5 + 4) | 1;
  v13 = *(_QWORD *)v11;
  v14 = sub_402A00(v12, *(_QWORD *)v11, v21, v4, *(_DWORD *)v5, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v13 <= v14 )
  {
    v15 = v14 + 1;
    *(_QWORD *)v11 = v14 + 1;
    ...
    LODWORD(v17) = sub_404A40(v15);
    v18 = *(_DWORD *)v5;
    *(_QWORD *)(v11 + 8) = v17;
    v12 = v17;
    sub_402A00(v17, v15, v21, v4, v18, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v22;
  return v12;
}
...
_BYTE *__fastcall sub_404250(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  return sub_403C30(0, a1, a2, (__int64)&v4);
}
...
__int64 __fastcall sub_405110(__int64 a1, __int64 a2)
{
...
signed __int64 __fastcall sub_4051F0(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8, __int64 a9)
{
  const char *v9; // r14@1
  char *v10; // rbp@1
  size_t v11; // r13@5
...
__int64 __fastcall sub_405810(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8)
{
  int v8; // er13@1
  signed int v9; // eax@2
  int v10; // ebp@2
    ...
    if ( *(_BYTE *)v21 == 45 )
    {
      ...
      if ( v36 )
      {
        if ( v53 )
        {
          ...
          {
            *(_QWORD *)(a7 + 32) = v21 + 2;
            v40 = sub_4051F0(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"--");
            goto LABEL_72;
          }
          if ( a6 )
          {
            ...
            {
              *(_QWORD *)(a7 + 32) = v21 + 1;
              v26 = sub_4051F0(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"-");
              if ( v26 != -1 )
...
LABEL_71:
        *(_QWORD *)(a7 + 32) = v28;
        *(_QWORD *)(a7 + 16) = 0LL;
        v40 = sub_4051F0(v10, v11, v12, v53, v54, 0, a7, v8, (__int64)"-W ");
LABEL_72:
        return v40;
      }
      v39 = *(_DWORD *)a7;
...
__int64 __fastcall sub_405DE0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax@1

  dword_60A400 = dword_60A25C;
  dword_60A404 = dword_60A258;
  result = sub_405810(a1, a2, a3, a4, a5, a6, (__int64)&dword_60A400, a7);
...
__int64 __fastcall sub_405E60(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5)
{
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_405FC0(0LL, v6) )
  {
    v4 = 1LL;
...
int __fastcall sub_406590(FILE *stream)
{
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_406610(stream) )
  {
...
int __fastcall sub_406610(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_406650(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
int __fastcall sub_406720(__int64 a1)
{
  __int64 v1; // rdx@1
