...
LABEL_31:
  ...
  if ( (signed int)v13 > 0 )
  {
    v15 = dcgettext(0LL, ",  load average: %.2f", 5);
...
unsigned __int64 __usercall sub_4025F0@<rax>(FILE *stream@<rdi>, __int64 a2@<rdx>, char a3@<cl>, _BYTE *a4@<rsi>, __int64 a5@<r9>, int a6)
{
  FILE *v6; // r14@1
