...
LABEL_31:
  ...
  {
LABEL_30:
    LODWORD(v19) = sub_404800(v4[v8], v5, v9);
    v20 = v19;
...
LABEL_20:
  ...
  if ( strcmp(v4[dword_60B25C], "-") )
  {
    ...
    if ( v11 )
      goto LABEL_22;
    LODWORD(v12) = sub_404680(0LL, 3LL, v10);
    v13 = v12;
...
LABEL_22:
  ...
  if ( (unsigned int)sub_405590(v11) == -1 )
  {
    ...
    LODWORD(v18) = sub_404680(0LL, 3LL, v10);
...
__int64 __usercall sub_401BB0@<rax>(FILE *stream@<rdi>, char a2@<dl>, FILE *a3@<rsi>, unsigned __int64 a4@<r14>, unsigned __int64 a5@<r15>)
{
  ...
  int *v16; // rax@28
  char *v17; // rax@29
  FILE *v18; // [sp+0h] [bp-1C58h]@1
  char v19; // [sp+Fh] [bp-1C49h]@1
  size_t n; // [sp+10h] [bp-1C48h]@6
  unsigned int v21; // [sp+18h] [bp-1C40h]@1
  char ptr; // [sp+20h] [bp-1C38h]@19
  char v23; // [sp+C20h] [bp-1038h]@6
  char src[4151]; // [sp+C21h] [bp-1037h]@15
...
LABEL_2:
  ...
  {
    v7 = (char *)1;
    v8 = (const char *)fread_unlocked(&v23 + v5, 1uLL, 4096 - v5, stream);
    n = (size_t)v8;
    if ( v19 )
    {
      a5 = 0LL;
...
LABEL_8:
      if ( v8 )
      {
        while ( a5 < (unsigned __int64)v8 )
        {
          a4 = v5 + a5;
          v9 = *(&v23 + v5 + a5);
          v10 = sub_4027A0((unsigned int)*(&v23 + v5 + a5), v7);
          if ( v9 != 61 && !v10 )
            goto LABEL_15;
          ++a5;
          if ( !v8 )
...
LABEL_18:
    ...
    v13 = 0LL;
LABEL_19:
    a5 = (unsigned int)sub_4027D0(&v21, &v23, v13, &ptr, &n);
...
__int64 __fastcall sub_401DD0(FILE *stream, _IO_FILE *a2, __int64 a3)
{
  ...
  char *v19; // rbx@35
  int *v20; // rax@35
  __int64 v21; // [sp+8h] [bp-11850h]@1
  size_t v22; // [sp+10h] [bp-11848h]@23
  size_t v23; // [sp+10h] [bp-11848h]@25
  size_t v24; // [sp+18h] [bp-11840h]@23
  char v25[30720]; // [sp+20h] [bp-11838h]@4
  char ptr[41016]; // [sp+7820h] [bp-A038h]@10
  ...
  do
  {
    ...
    if ( !v4 )
      break;
LABEL_10:
    v6 = 4 * ((unsigned __int64)(0x0AAAAAAAAAAAAAAABLL * (unsigned __int128)(v4 + 2) >> 64) >> 1);
    sub_402510(v25, v4, ptr, 4 * ((unsigned __int64)(0x0AAAAAAAAAAAAAAABLL * (unsigned __int128)(v4 + 2) >> 64) >> 1));
    if ( v21 )
    {
      v7 = 0LL;
      if ( v6 )
...
void __fastcall __noreturn sub_4020A0(int status)
{
  ...
  v15 = dcgettext(
          ...
          5);
  __printf_chk(1LL, v15, "base64", "base64");
  v33 = "[";
  v16 = (__int64 *)&v33;
  v34 = "test invocation";
  v35 = "coreutils";
  ...
  {
    v23 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v23, &unk_406DA6, "https://www.gnu.org/software/coreutils/");
    v24 = setlocale(5, 0LL);
  ...
  {
    v28 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v28, &unk_406DA6, "https://www.gnu.org/software/coreutils/");
    v29 = setlocale(5, 0LL);
    if ( !v29 || !strncmp(v29, "en_", 3uLL) )
    {
      ...
      __printf_chk(1LL, v30, "https://www.gnu.org/software/coreutils/", "base64");
LABEL_15:
...
LABEL_3:
  ...
  __printf_chk(1LL, v31, "base64", v32);
LABEL_13:
  v25 = "Multi-call invocation" + 10;
  v26 = dcgettext(0LL, "Full documentation at: <%s%s>\n", 5);
  __printf_chk(1LL, v26, "https://www.gnu.org/software/coreutils/", "base64");
  if ( v22 != "base64" )
    v25 = "";
  goto LABEL_15;
}
...
signed __int64 __fastcall sub_402400(__int64 a1, unsigned __int64 a2, __int64 *a3, _QWORD *a4)
{
  ...
  if ( a2 > 1 )
  {
    v5 = byte_4073E0[(unsigned __int64)*(_BYTE *)a1];
    if ( v5 >= 0 )
    {
      v6 = byte_4073E0[(unsigned __int64)*(_BYTE *)(a1 + 1)];
      if ( v6 >= 0 )
      {
        v7 = *a3;
        if ( *a4 )
...
void __fastcall sub_402510(__int64 a1, __int64 a2, __int64 a3, unsigned __int64 a4)
{
  ...
  if ( a4 & 3 || (v4 = 3 * (a4 >> 2), v4 != a2) )
  {
    ...
    while ( 1 )
    {
      ...
      v10 = *(_BYTE *)a1;
      *(_BYTE *)a3 = byte_4074E0[(unsigned __int64)((*(_BYTE *)a1 >> 2) & 0x3F)];
      if ( a4 == 1 )
        return;
      v11 = 16 * v10;
      if ( a2 == 1 )
        break;
      v7 = *(_BYTE *)(a1 + 1);
      *(_BYTE *)(a3 + 1) = byte_4074E0[(unsigned __int64)(((*(_BYTE *)(a1 + 1) >> 4) + v11) & 0x3F)];
      if ( a4 == 2 )
        return;
      v8 = 4 * v7;
      if ( a2 == 2 )
      {
        *(_BYTE *)(a3 + 2) = byte_4074E0[(unsigned __int64)(v8 & 0x3C)];
        if ( v6 - a3 == 3 )
          return;
LABEL_17:
        *(_BYTE *)(a3 + 3) = 61;
      ...
      v9 = *(_BYTE *)(a1 + 2);
      *(_BYTE *)(a3 + 2) = byte_4074E0[(unsigned __int64)(((*(_BYTE *)(a1 + 2) >> 6) + v8) & 0x3F)];
      if ( v6 - a3 == 3 )
        return;
      *(_BYTE *)(a3 + 3) = byte_4074E0[(unsigned __int64)(v9 & 0x3F)];
      if ( v5 == a3 )
        return;
      a2 -= 3LL;
      if ( a2 )
...
LABEL_10:
    ...
    *(_BYTE *)(a3 + 1) = byte_4074E0[(unsigned __int64)(v11 & 0x30)];
    if ( a4 == 2 )
      return;
    *(_BYTE *)(a3 + 2) = 61;
    if ( a4 == 3 )
  ...
  if ( v4 )
  {
    do
    {
      ...
      a3 += 4LL;
      a1 += 3LL;
      *(_BYTE *)(a3 - 4) = byte_4074E0[(unsigned __int64)(v13 >> 2)];
      v14 = *(_BYTE *)(a1 - 2);
      *(_BYTE *)(a3 - 3) = byte_4074E0[(unsigned __int64)(((*(_BYTE *)(a1 - 2) >> 4) + 16 * v13) & 0x3F)];
      v15 = byte_4074E0[(unsigned __int64)(*(_BYTE *)(a1 - 1) & 0x3F)];
      *(_BYTE *)(a3 - 2) = byte_4074E0[(unsigned __int64)(((*(_BYTE *)(a1 - 1) >> 6) + 4 * v14) & 0x3F)];
      *(_BYTE *)(a3 - 1) = v15;
    }
    while ( v12 != a1 );
  }
...
{
  return (unsigned __int8)~byte_4073E0[(unsigned __int64)a1] >> 7;
}
...
char __fastcall sub_4027D0(_DWORD *a1, _BYTE *a2, unsigned __int64 a3, __int64 a4, __int64 *a5)
{
  _DWORD *v5; // r14@1
  _BYTE *v6; // rbx@1
  ...
  __int64 v19; // r13@27
  _BYTE *v20; // rbx@27
  unsigned __int64 v21; // r11@29
  __int64 v22; // rax@33
  __int64 v23; // rdx@38
  signed __int64 v24; // [sp+0h] [bp-68h]@3
  bool v25; // [sp+Fh] [bp-59h]@1
  __int64 *v26; // [sp+10h] [bp-58h]@1
  __int64 v27; // [sp+18h] [bp-50h]@1
  __int64 v28; // [sp+28h] [bp-40h]@1
...
LABEL_9:
    ...
    if ( v10 )
    {
      v19 = (__int64)v6;
      v20 = &v6[v7];
      while ( (unsigned __int8)sub_402400(v19, (unsigned __int64)&v20[-v19], &v27, &v28) )
      {
        v8 = v28;
        v19 += 4LL;
      }
...
LABEL_14:
  ...
  if ( (_DWORD)v17 == 4 )
  {
    *v5 = 0;
LABEL_32:
    if ( (signed __int64)v7 > 3 )
    {
      LODWORD(v22) = sub_406500(v6, 10LL, 4LL);
      if ( !v22 )
      {
        v13 = (__int64)v6;
        v7 = 4LL;
...
LABEL_22:
    if ( v7 <= 3 && v9 && v25 )
      goto LABEL_25;
LABEL_7:
    result = sub_402400(v13, v7, &v27, &v28);
    if ( result )
    {
      v15 = v12;
      v8 = v28;
...
__int64 sub_402B00()
{
  ...
  if ( (unsigned int)sub_406610(stdout) )
  {
    ...
    if ( !byte_60B298 || *v0 != 32 )
    {
      ...
      if ( qword_60B2A0 )
      {
        LODWORD(v5) = sub_404650(qword_60B2A0, "write error");
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_406480((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_403FB0(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_60B250 <= a1 )
  {
    ...
    {
      LODWORD(v10) = sub_404E20(off_60B238, v9);
      off_60B238 = v10;
      v7 = v10;
    }
  ...
  v23 = *(_DWORD *)(v5 + 4) | 1;
  v13 = *(_QWORD *)v11;
  v14 = sub_402D80(v12, *(_QWORD *)v11, v21, v4, *(_DWORD *)v5, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v13 <= v14 )
  {
    v15 = v14 + 1;
    *(_QWORD *)v11 = v14 + 1;
    ...
    LODWORD(v17) = sub_404DC0(v15);
    v18 = *(_DWORD *)v5;
    *(_QWORD *)(v11 + 8) = v17;
    v12 = v17;
    sub_402D80(v17, v15, v21, v4, v18, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v22;
  return v12;
}
...
_BYTE *__fastcall sub_4045D0(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  return sub_403FB0(0, a1, a2, (__int64)&v4);
}
...
int __fastcall sub_404820(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12@1
  __int64 v7; // rbx@1
  char *v8; // rax@3
...
int __fastcall sub_404C80(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  char *v7; // r10@1
  signed int v8; // er8@1
  __int64 v9; // r9@1
  ...
  do
  {
    if ( (unsigned int)v8 <= 0x2F )
    {
      ...
      v15[v9] = v11;
      if ( !v11 )
        return sub_404820(a1, a2, a3, a4, (__int64)v15, v9);
      goto LABEL_3;
    }
    v12 = (__int64 *)v7;
    v7 += 8;
...
void *__fastcall sub_404FC0(const void *a1, size_t a2)
{
  void *v2; // rax@1
...
int __fastcall sub_405590(FILE *stream)
{
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_405610(stream) )
  {
...
int __fastcall sub_405610(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_405650(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
__int64 __fastcall sub_4056B0(__int64 a1, __int64 a2)
{
...
signed __int64 __fastcall sub_405790(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8, __int64 a9)
{
  const char *v9; // r14@1
  char *v10; // rbp@1
  size_t v11; // r13@5
...
__int64 __fastcall sub_405DB0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8)
{
  int v8; // er13@1
  signed int v9; // eax@2
  int v10; // ebp@2
    ...
    if ( *(_BYTE *)v21 == 45 )
    {
      ...
      if ( v36 )
      {
        if ( v53 )
        {
          ...
          {
            *(_QWORD *)(a7 + 32) = v21 + 2;
            v40 = sub_405790(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"--");
            goto LABEL_72;
          }
          if ( a6 )
          {
            ...
            {
              *(_QWORD *)(a7 + 32) = v21 + 1;
              v26 = sub_405790(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"-");
              if ( v26 != -1 )
...
LABEL_71:
        *(_QWORD *)(a7 + 32) = v28;
        *(_QWORD *)(a7 + 16) = 0LL;
        v40 = sub_405790(v10, v11, v12, v53, v54, 0, a7, v8, (__int64)"-W ");
LABEL_72:
        return v40;
      }
      v39 = *(_DWORD *)a7;
...
__int64 __fastcall sub_406380(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax@1

  dword_60B400 = dword_60B25C;
  dword_60B404 = dword_60B258;
  result = sub_405DB0(a1, a2, a3, a4, a5, a6, (__int64)&dword_60B400, a7);
...
__int64 __fastcall sub_406400(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5)
{
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_406670(0LL, v6) )
  {
    v4 = 1LL;
...
int __fastcall sub_406CB0(__int64 a1)
{
  __int64 v1; // rdx@1
