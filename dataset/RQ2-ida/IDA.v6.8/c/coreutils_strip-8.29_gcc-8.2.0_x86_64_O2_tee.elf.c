...
LABEL_23:
      ...
      else
      {
        ...
        if ( qword_60A480 )
        {
          LODWORD(v4) = sub_402560("--output-error", qword_60A480, off_406AA0, dword_406A80, 4LL, off_60A218);
          dword_60A2D8 = dword_406A80[v4];
        }
        else
        {
          dword_60A2D8 = 2;
  ...
  v5 = sub_401BB0(a1 - dword_60A29C, &a2[dword_60A29C]);
  if ( close(0) )
  {
...
__int64 __fastcall sub_401BB0(int a1, _QWORD *a2)
{
  ...
  char *v32; // rbx@15
  int *v33; // rax@15
  __int64 v34; // [sp+0h] [bp-2058h]@0
  FILE **ptr; // [sp+8h] [bp-2050h]@5
  char buf; // [sp+20h] [bp-2038h]@12
  ...
  if ( (a1 + 1) & 0x1000000000000000LL || (unsigned __int64)(a1 + 1) >> 61 != 0 )
    sub_404C00();
  LODWORD(v4) = sub_4049B0();
  v5 = v4;
  ptr = (FILE **)v4;
  *v4 = stdout;
  v6 = dcgettext(0LL, "standard output", 5);
  v7 = stdout;
  *(a2 - 1) = v6;
  setvbuf(v7, 0LL, 2, 0LL);
  if ( SHIDWORD(v34) <= 0 )
  {
    LOBYTE(v34) = 1;
    v10 = 1LL;
  ...
  else
  {
    ...
    LOBYTE(v34) = 1;
    v10 = 1LL;
    v11 = (signed __int64)&a2[(unsigned int)(HIDWORD(v34) - 1) + 1];
    do
    {
      while ( 1 )
      {
        LODWORD(v12) = sub_402720(*v8, v3);
        *v9 = v12;
        if ( !v12 )
          break;
        ++v8;
        ++v10;
        ++v9;
        setvbuf(v12, 0LL, 2, 0LL);
        if ( (_QWORD *)v11 == v8 )
          goto LABEL_10;
      }
      LODWORD(v13) = sub_404260(0LL, 3LL, *v8);
      v14 = v13;
      v15 = __errno_location();
      ++v8;
      ++v9;
      error((unsigned int)(dword_60A2D8 - 3) <= 1, *v15, "%s", v14, v34);
      LOBYTE(v34) = 0;
    }
    while ( (_QWORD *)v11 != v8 );
LABEL_10:
  ...
  v16 = (signed __int64)&a2[HIDWORD(v34)];
  do
  {
    v17 = read(0, &buf, 0x2000uLL);
    v18 = v17;
    if ( v17 >= 0 )
    {
      if ( !v17 )
      ...
      if ( SHIDWORD(v34) >= 0 )
      {
        ...
        {
          v31 = *v26;
          if ( *v26 && fwrite_unlocked(&buf, v18, 1uLL, *v26) != 1 )
          {
            v29 = *__errno_location();
            if ( v29 != 32 || (dword_60A2D8 & 0xFFFFFFFD) == 1 )
            {
              if ( v31 == stdout )
              {
                v28 = v29;
                clearerr_unlocked(v31);
                v29 = v28;
              }
              LODWORD(v34) = v29;
              LODWORD(v30) = sub_404260(0LL, 3LL, *v27);
              error((unsigned int)(dword_60A2D8 - 3) <= 1, v34, "%s", v30, v34);
              *v26 = 0LL;
              LOBYTE(v34) = 0;
            }
            else
  ...
  if ( v18 == -1LL )
  {
    v32 = dcgettext(0LL, "read error", 5);
...
LABEL_17:
    ...
    do
    {
      while ( 1 )
      {
        ...
        if ( v20 )
        {
          if ( (unsigned int)sub_404C40(v20) )
            break;
        }
        if ( SHIDWORD(v34) < (signed int)++v19 )
          goto LABEL_22;
      }
      v21 = a2[v19++ - 1];
      LODWORD(v22) = sub_404260(0LL, 3LL, v21);
      v23 = v22;
      v24 = __errno_location();
      error(0, *v24, "%s", v23, v34);
      LOBYTE(v34) = 0;
    }
    while ( SHIDWORD(v34) >= (signed int)v19 );
  }
LABEL_22:
  free(ptr);
...
void __fastcall __noreturn sub_401F50(int status)
{
  ...
  {
    v22 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v22, &unk_40647D);
    v23 = setlocale(5, 0LL);
  ...
  {
    v26 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v26, &unk_40647D);
    v27 = setlocale(5, 0LL);
...
signed __int64 __fastcall sub_4022A0(const char *a1, const char **a2, char *a3, size_t a4)
{
  size_t v4; // r13@1
  char *v5; // rbp@1
  size_t v6; // rax@1
...
void __fastcall sub_4023C0(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  LODWORD(v4) = sub_4043C0(1LL, a1);
  v5 = v4;
  LODWORD(v6) = sub_4040B0(0LL, 8LL, a2);
  error(0, 0, v3, v6, v5);
}
...
__int64 __fastcall sub_402560(__int64 a1, const char *a2, const char **a3, char *a4, size_t a5, void (__fastcall *a6)(__int64 *, char *))
{
  size_t v6; // r15@1
...
__int64 sub_402640()
{
  ...
  if ( (unsigned int)sub_405CF0(stdout) )
  {
    ...
    if ( !byte_60A2E0 || *v0 != 32 )
    {
      ...
      if ( qword_60A2E8 )
      {
        LODWORD(v5) = sub_404230(qword_60A2E8, "write error");
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_405C70((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_403B90(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_60A290 <= a1 )
  {
    ...
    {
      LODWORD(v10) = sub_404A10(off_60A278, v9);
      off_60A278 = v10;
      v7 = v10;
    }
  ...
  v23 = *(_DWORD *)(v5 + 4) | 1;
  v13 = *(_QWORD *)v11;
  v14 = sub_402960(v12, *(_QWORD *)v11, v21, v4, *(_DWORD *)v5, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v13 <= v14 )
  {
    v15 = v14 + 1;
    *(_QWORD *)v11 = v14 + 1;
    ...
    LODWORD(v17) = sub_4049B0(v15);
    v18 = *(_DWORD *)v5;
    *(_QWORD *)(v11 + 8) = v17;
    v12 = v17;
    sub_402960(v17, v15, v21, v4, v18, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v22;
  return v12;
}
...
_BYTE *__fastcall sub_4041B0(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  return sub_403B90(0, a1, a2, (__int64)&v4);
}
...
int __fastcall sub_404410(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12@1
  __int64 v7; // rbx@1
  char *v8; // rax@3
...
int __fastcall sub_404870(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  char *v7; // r10@1
  signed int v8; // er8@1
  __int64 v9; // r9@1
  ...
  do
  {
    if ( (unsigned int)v8 <= 0x2F )
    {
      ...
      v15[v9] = v11;
      if ( !v11 )
        return sub_404410(a1, a2, a3, a4, (__int64)v15, v9);
      goto LABEL_3;
    }
    v12 = (__int64 *)v7;
    v7 += 8;
...
int __fastcall sub_404C40(FILE *stream)
{
  ...
  if ( fileno(stream) < 0
    ...
    || !(unsigned int)sub_404E00(stream) )
  {
...
__int64 __fastcall sub_404CC0(char a1, int a2, __int64 a3, __int64 a4)
{
  int v4; // ebx@3
  int v6; // eax@8
  int *v7; // rax@10
...
signed __int64 __fastcall sub_404F80(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8, __int64 a9)
{
  const char *v9; // r14@1
  char *v10; // rbp@1
  size_t v11; // r13@5
...
__int64 __fastcall sub_4055A0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8)
{
  int v8; // er13@1
  signed int v9; // eax@2
  int v10; // ebp@2
    ...
    if ( *(_BYTE *)v21 == 45 )
    {
      ...
      if ( v36 )
      {
        if ( v53 )
        {
          ...
          {
            *(_QWORD *)(a7 + 32) = v21 + 2;
            v40 = sub_404F80(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"--");
            goto LABEL_72;
          }
          if ( a6 )
          {
            ...
            {
              *(_QWORD *)(a7 + 32) = v21 + 1;
              v26 = sub_404F80(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"-");
              if ( v26 != -1 )
...
LABEL_71:
        *(_QWORD *)(a7 + 32) = v28;
        *(_QWORD *)(a7 + 16) = 0LL;
        v40 = sub_404F80(v10, v11, v12, v53, v54, 0, a7, v8, (__int64)"-W ");
LABEL_72:
        return v40;
      }
      v39 = *(_DWORD *)a7;
...
__int64 __fastcall sub_405B70(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax@1

  dword_60A440 = dword_60A29C;
  dword_60A444 = dword_60A298;
  result = sub_4055A0(a1, a2, a3, a4, a5, a6, (__int64)&dword_60A440, a7);
...
__int64 __fastcall sub_405BF0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5)
{
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_405D50(0LL, v6) )
  {
    v4 = 1LL;
...
int __fastcall sub_406390(__int64 a1)
{
  __int64 v1; // rdx@1
