...
long double __usercall sub_405CB0@<st0>(int a1@<edi>, __int128 a2)
{
  __int128 v2; // fst7@2
...
void __usercall sub_408710(int status@<edi>, int errnum@<esi>, __int64 a3@<rdx>, __int64 a4@<rcx>, __int64 a5@<rbx>, __int64 a6@<rbp>, __int64 a7@<r12>, __int64 a8@<r13>, __int64 a9@<r14>)
{
  void *v9; // rax@1
  void *v10; // rbx@2
  char *v20; // rbx@5
