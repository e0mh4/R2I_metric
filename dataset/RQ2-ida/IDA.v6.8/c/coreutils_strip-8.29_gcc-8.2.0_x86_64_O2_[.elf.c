...
bool __usercall sub_401980@<al>(char *s1@<rdi>, unsigned __int8 a2@<cf>, bool a3@<zf>)
{
  char *v3; // rbx@1
...
char __usercall sub_4026F0@<al>(bool a1@<cf>, bool a2@<zf>)
{
  const char *v2; // rdi@1
...
void __usercall sub_405240(int status@<edi>, int errnum@<esi>, __int64 a3@<rdx>, __int64 a4@<rcx>, __int64 a5@<rbx>, __int64 a6@<rbp>, __int64 a7@<r12>, __int64 a8@<r13>, __int64 a9@<r14>)
{
  void *v9; // rax@1
  void *v10; // rbx@2
  char *v20; // rbx@5
