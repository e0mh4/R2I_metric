__int64 __fastcall main(int a1, char **a2, char **a3)
{
  ...
  signed __int64 v11; // rcx@2
  __int64 v12; // r8@2
  __int64 v13; // rax@15
  signed __int64 v14; // rcx@16
  const char *v15; // rdx@16
  char *v16; // rdi@19
  const char *v17; // rsi@35
  const char **v18; // r14@37
  signed int v19; // er13@37
  int *v20; // rax@37
  const char *v21; // r12@37
  int *v22; // r15@37
  unsigned __int64 v23; // kr08_8@17
  __int64 v24; // rax@41
  __int64 v25; // r12@41
  char *v26; // rax@41
  __int64 v27; // rax@43
  char **v29; // rbp@49
  unsigned int v30; // er12@52
  signed int v31; // er13@52
  char **v32; // rdx@54
  int v33; // ecx@55
  unsigned int v34; // eax@55
  bool v35; // zf@56
  int v36; // eax@68
  unsigned int v37; // eax@76
  __int64 v38; // rax@79
  int v39; // ebp@64
  char *v40; // rax@83
  char *v41; // ST00_8@85
  signed int v42; // ebp@71
  __int64 v43; // rax@89
  __int64 v44; // rbx@89
  char *v45; // rax@89
  char *v46; // rax@92
  unsigned int v47; // ST1C_4@93
  char *v48; // rax@93
  char *endptr; // [sp+30h] [bp-58h]@39
...
LABEL_20:
      if ( v6 != -1 )
      {
        LODWORD(v43) = sub_4040E0(v16, v8);
        v44 = v43;
        v45 = dcgettext(0LL, "%s: multiple signals specified", 5);
        error(0, 0, v45, v44);
        sub_401EC0(1);
      }
      v6 = sub_402250(v16);
...
LABEL_16:
    v14 = qword_609620;
    v8 = (const char **)&v7[v13 - 1];
    v15 = *v8;
    if ( !qword_609620 )
    {
      v23 = strlen(*v8) + 1;
      v14 = (signed __int64)&v15[v23 - 1];
      qword_609620 = (__int64)&v15[v23 - 1];
      v15 = *v8;
    }
    if ( (const char *)v14 != v15 + 2 )
    {
      v47 = v12;
      v48 = dcgettext(0LL, "invalid option -- %c", 5);
      error(0, 0, v48, v47);
      sub_401EC0(1);
    }
    v16 = (char *)(v15 + 1);
...
LABEL_36:
    ...
    if ( dword_60927C < v5 )
    {
      ...
      {
        *v22 = 0;
        v27 = __strtol_internal(v21, &endptr, 10, 0);
        if ( *v22 == 34 || v27 != (signed int)v27 || v21 == endptr || *endptr )
        {
          v19 = 1;
          LODWORD(v24) = sub_4040E0(v21, &endptr);
          v25 = v24;
          v26 = dcgettext(0LL, "%s: invalid process id", 5);
          error(0, 0, v26, v25);
        }
        else if ( kill(v27, v6) )
        {
          v19 = 1;
          LODWORD(v38) = sub_4040E0(v21, (unsigned int)v6);
          error(0, *v22, "%s", v38);
        }
        ++v18;
        v21 = *v18;
...
LABEL_13:
  ...
  if ( v3 )
  {
    ...
    do
    {
      if ( !sub_4058E0((unsigned int)v31, &endptr, v10, v11, v12) )
      {
        v32 = &endptr;
        do
        {
        ...
        while ( !v34 );
        v35 = (~v33 & (v33 - 16843009) & 0x8080) == 0;
        if ( !(~v33 & (v33 - 16843009) & 0x8080) )
          LOBYTE(v34) = v34 >> 16;
        v11 = (signed __int64)v32 + 2;
        if ( v35 )
          v32 = (char **)((char *)v32 + 2);
        v10 = (char *)v32 + -__CFADD__((_BYTE)v34, (_BYTE)v34) - 3 - (char *)&endptr;
        if ( v10 > v30 )
          v30 = v10;
      }
      ++v31;
    ...
    if ( !v29 )
    {
      ...
      do
      {
        if ( !sub_4058E0((unsigned int)v39, &endptr, v10, v11, v12) )
        {
          v40 = strsignal(v39);
          if ( !v40 )
            v40 = "?";
  ...
  else
  {
    ...
    else
    {
      ...
      do
      {
        if ( !sub_4058E0((unsigned int)v42, &endptr, v10, v11, v12) )
          puts((const char *)&endptr);
        ++v42;
      }
      while ( v42 != 65 );
...
signed int sub_401E61()
{
  signed int result; // eax@4

  if ( !byte_609468 )
  {
    while ( qword_609470 < (unsigned __int64)(((&unk_608E48 - (_UNKNOWN *)&qword_608E40) >> 3) - 1) )
      (*(&qword_608E40 + ++qword_609470))();
    result = sub_401E0B();
    byte_609468 = 1;
  }
  return result;
...
void __fastcall __noreturn sub_401EC0(int status)
{
  ...
  bool v20; // cf@5
  bool v21; // zf@5
  const char *v22; // rsi@6
  signed __int64 v23; // rcx@6
  const char *v24; // rbp@10
  char *v25; // rax@11
  char *v26; // rax@11
  char *v27; // rax@13
  char *v28; // rax@14
  ...
  v4 = dcgettext(0LL, "Usage: %s [-s SIGNAL | -SIGNAL] PID...\n  or:  %s -l [SIGNAL]...\n  or:  %s -t [SIGNAL]...\n", 5);
  __printf_chk(1LL, v4, v2);
  v5 = stdout;
  v6 = dcgettext(0LL, "Send signals to processes, or list signals.\n", 5);
  ...
  do
  {
    ...
    do
    {
      if ( !v23 )
        break;
      v20 = (const unsigned __int8)*v22 < *v19;
      v21 = *v22++ == *v19++;
      --v23;
    }
    while ( v21 );
  ...
  while ( (!v20 && !v21) != v20 );
  v24 = (const char *)v18[1];
  if ( v24 )
  {
    v25 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v25, &unk_40623F);
    v26 = setlocale(5, 0LL);
  ...
  {
    v29 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v29, &unk_40623F);
    v30 = setlocale(5, 0LL);
...
__int64 __fastcall sub_402250(char *nptr, char **a2)
{
  char **v2; // r14@1
  int *v3; // rax@2
  char **v4; // rsi@2
  ...
  unsigned int v20; // [sp+4h] [bp-34h]@6
  char *endptr; // [sp+8h] [bp-30h]@2

  v2 = a2;
  if ( (unsigned int)(*nptr - 48) > 9 )
  {
    LODWORD(v14) = sub_4048D0();
    v15 = *v14;
    v16 = v14;
    for ( i = v14; *i; v15 = *i )
    {
      if ( strchr("abcdefghijklmnopqrstuvwxyz", v15) )
        *i = v15 - 32;
      ++i;
    }
    v4 = (char **)&v20;
    if ( (unsigned int)sub_405780(v16) )
    {
      if ( *v16 != 83 || v16[1] != 73 || v16[2] != 71 || (v4 = (char **)&v20, (unsigned int)sub_405780(v16 + 3)) )
      {
        v20 = -1;
        free(v16);
        goto LABEL_7;
    ...
    {
LABEL_7:
      LODWORD(v10) = sub_4040E0(nptr, v4);
      v11 = v10;
      v12 = dcgettext(0LL, "%s: invalid signal", 5);
      error(0, 0, v12, v11);
      return 0xFFFFFFFFLL;
    }
  }
  else
  {
    ...
    *v3 = 0;
    ...
    if ( endptr == nptr || *endptr || *v5 || (v9 = (signed int)v6, (signed int)v6 != v6) )
    {
      v20 = -1;
      goto LABEL_7;
    }
...
__int64 sub_402420()
{
  ...
  if ( (unsigned int)sub_4059B0(stdout) )
  {
    ...
    if ( !byte_609478 || *v0 != 32 )
    {
      ...
      if ( qword_609480 )
      {
        LODWORD(v5) = sub_403F30(qword_609480, "write error");
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_405700((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_403890(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_609270 <= a1 )
  {
    ...
    {
      LODWORD(v10) = sub_404700(off_609258, v9);
      off_609258 = v10;
      v7 = v10;
    }
  ...
  v23 = *(_DWORD *)(v5 + 4) | 1;
  v13 = *(_QWORD *)v11;
  v14 = sub_402660(v12, *(_QWORD *)v11, v21, v4, *(_DWORD *)v5, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v13 <= v14 )
  {
    v15 = v14 + 1;
    *(_QWORD *)v11 = v14 + 1;
    if ( (_UNKNOWN *)v12 != &unk_6094A0 )
    {
      v16 = v14 + 1;
      free(v12);
      v15 = v16;
    }
    LODWORD(v17) = sub_4046A0(v15);
    v18 = *(_DWORD *)v5;
    *(_QWORD *)(v11 + 8) = v17;
    v12 = v17;
    sub_402660(v17, v15, v21, v4, v18, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v22;
  return v12;
}
...
_BYTE *__fastcall sub_403EB0(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  v7 = qword_6095D0;
  v4 = _mm_load_si128((const __m128i *)&xmmword_6095A0);
  v5 = _mm_load_si128((const __m128i *)&xmmword_6095B0);
  v6 = _mm_load_si128((const __m128i *)&xmmword_6095C0);
  v4.m128i_i32[(a3 >> 5) + 2] ^= (~(unsigned __int8)((unsigned __int32)v4.m128i_i32[(a3 >> 5) + 2] >> (a3 & 0x1F)) & 1) << (a3 & 0x1F);
  return sub_403890(0, a1, a2, (__int64)&v4);
}
...
int __fastcall sub_404100(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12@1
  __int64 v7; // rbx@1
  char *v8; // rax@3
...
int __fastcall sub_404560(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  char *v7; // r10@1
  signed int v8; // er8@1
  __int64 v9; // r9@1
  ...
  do
  {
    if ( (unsigned int)v8 <= 0x2F )
    {
      ...
      v15[v9] = v11;
      if ( !v11 )
        return sub_404100(a1, a2, a3, a4, (__int64)v15, v9);
      goto LABEL_3;
    }
    v12 = (__int64 *)v7;
    v7 += 8;
...
void *__fastcall sub_4048A0(const void *a1, size_t a2)
{
  void *v2; // rax@1
...
void *__fastcall sub_4048D0(const char *a1)
{
  size_t v1; // rax@1

  v1 = strlen(a1);
  return sub_4048A0(a1, v1 + 1);
}
...
__int64 __fastcall sub_404930(__int64 a1, __int64 a2)
{
...
signed __int64 __fastcall sub_404A10(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8, __int64 a9)
{
  const char *v9; // r14@1
  char *v10; // rbp@1
  size_t v11; // r13@5
...
__int64 __fastcall sub_405030(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8)
{
  int v8; // er13@1
  signed int v9; // eax@2
  int v10; // ebp@2
    ...
    if ( *(_BYTE *)v21 == 45 )
    {
      ...
      if ( v36 )
      {
        if ( v53 )
        {
          ...
          {
            *(_QWORD *)(a7 + 32) = v21 + 2;
            v40 = sub_404A10(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"--");
            goto LABEL_72;
          }
          if ( a6 )
          {
            ...
            {
              *(_QWORD *)(a7 + 32) = v21 + 1;
              v26 = sub_404A10(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"-");
              if ( v26 != -1 )
...
LABEL_71:
        *(_QWORD *)(a7 + 32) = v28;
        *(_QWORD *)(a7 + 16) = 0LL;
        v40 = sub_404A10(v10, v11, v12, v53, v54, 0, a7, v8, (__int64)"-W ");
LABEL_72:
        return v40;
      }
      v39 = *(_DWORD *)a7;
...
__int64 __fastcall sub_405600(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax@1

  dword_6095E0 = dword_60927C;
  dword_6095E4 = dword_609278;
  result = sub_405030(a1, a2, a3, a4, a5, a6, (__int64)&dword_6095E0, a7);
...
__int64 __fastcall sub_405680(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5)
{
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_405A10(0LL, v6) )
  {
    v4 = 1LL;
...
signed __int64 __fastcall sub_4058E0(int a1, __int64 a2)
{
  int *v2; // rcx@1
  __int64 v3; // rdx@1
...
int __fastcall sub_405FE0(FILE *stream)
{
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_406060(stream) )
  {
...
int __fastcall sub_406060(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_4060A0(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
int __fastcall sub_406170(__int64 a1)
{
  __int64 v1; // rdx@1
