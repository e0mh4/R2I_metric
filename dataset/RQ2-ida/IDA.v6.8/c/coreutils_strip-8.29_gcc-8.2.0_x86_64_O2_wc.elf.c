__int64 __usercall main@<rax>(char **a1@<rsi>, char **a2@<rdx>, unsigned int a3@<edi>, FILE *a4@<r14>, double a5@<xmm0>)
{
  char **v5; // r12@1
  const char *v6; // rbp@1
  char *v7; // rbx@1
...
void __fastcall __noreturn sub_403350(int status)
{
  int v1; // ebx@1
  __int64 v2; // rbp@1
  char *v3; // rax@2
