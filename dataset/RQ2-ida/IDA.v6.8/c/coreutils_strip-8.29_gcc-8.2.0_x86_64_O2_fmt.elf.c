__int64 __fastcall main(signed int a1, char **a2, char **a3)
{
  ...
  bool v18; // zf@38
  char v19; // r12@39
  signed __int64 v20; // rcx@43
  char *v21; // rdi@43
  const char *v22; // r14@43
  char *v23; // rsi@43
  FILE *v24; // rax@47
  FILE *v25; // r15@47
  __int64 v26; // rax@49
...
LABEL_55:
  ...
  v35 = dcgettext(0LL, "invalid width", 5);
  dword_6162D0 = sub_405780(v7, 0LL, 75LL, "", v35, 0LL);
  dword_6162E0 = dword_6162D0 + 10;
LABEL_38:
  v16 = dword_60B25C;
  v17 = dword_60B25C < (unsigned int)v4;
  v18 = dword_60B25C == v4;
  if ( dword_60B25C != v4 )
  {
    v19 = 1;
    if ( dword_60B25C >= v4 )
      return (unsigned __int8)(v19 ^ 1);
    while ( 1 )
    {
      v20 = 2LL;
      v21 = "-";
      ...
      do
      {
        if ( !v20 )
          break;
        v17 = (unsigned __int8)*v23 < (unsigned __int8)*v21;
        v18 = *v23++ == *v21++;
        --v20;
      }
      while ( v18 );
      ...
      else
      {
        ...
        if ( !v24 )
        {
          LODWORD(v32) = sub_404C10(4LL, v22);
          v33 = v32;
          v34 = dcgettext(0LL, "cannot open %s for reading", 5);
        ...
        sub_402850(v24);
        if ( (unsigned int)sub_405BF0(v25) == -1 )
        {
          LODWORD(v26) = sub_404CE0(0LL, 3LL, v22);
          v27 = v26;
          v28 = __errno_location();
          v29 = v27;
          v30 = "%s";
...
__int64 sub_401D70()
{
  ...
  signed __int64 v10; // rdi@3
  int v11; // er11@5
  int v12; // er15@5
  signed __int64 v13; // rax@11
  __int64 v14; // r14@12
  signed __int64 v15; // rax@13
  signed __int64 v16; // r14@17
  char v17; // al@18
  char v18; // al@20
  __int64 result; // rax@23
  unsigned int v20; // [sp+0h] [bp-34h]@1
  ...
  if ( v2 >= (unsigned __int64)&unk_60B2E0 )
  {
    ...
    do
    {
      ...
      do
      {
        ...
        {
          v13 = 10 * (v6 - v12) * (signed __int64)(10 * (v6 - v12));
          if ( v0 != *(_QWORD *)(v9 + 32) )
          {
        ...
        if ( (_UNKNOWN *)v2 == &unk_60B2E0 && v7 > 0 )
          v15 += 10 * (v12 - v7) * (signed __int64)(10 * (v12 - v7)) >> 1;
        if ( v15 < v10 )
        {
          *(_QWORD *)(v2 + 32) = v9;
          v10 = v15;
...
__int64 __fastcall sub_402260(__int64 a1, _DWORD *a2)
{
  __int64 result; // rax@1
  _DWORD *v3; // r12@2
  signed __int64 v4; // rbp@2
  __int64 v5; // rbx@2
  int v6; // esi@3
  char *v7; // rax@3
...
int __fastcall sub_4022E0(__int64 a1, int a2)
{
  ...
  if ( a1 != v4 - 40 )
  {
    ...
    while ( (__int64 *)v5 != v6 );
    v5 = v2 + 8 * ((unsigned __int64)(v4 - v2 - 80) >> 3) + 40;
  }
  sub_402260(*(_QWORD *)v5, (_DWORD *)(v5 + 8));
...
int sub_402420()
{
  ...
  else
  {
    ...
    v8 = *v3;
    v9 = -(signed __int64)(signed int)(*(_DWORD *)v3 - (unsigned __int64)&unk_614F40);
    qword_614F20 = v7 - (signed int)(*(_DWORD *)v3 - (unsigned __int64)&unk_614F40);
    v10 = qword_60B2C0;
    ...
    result = __memmove_chk(&unk_60B2E0, v3, 8 * ((signed __int64)(v10 - (_QWORD)v3) >> 3) + 40, 40000LL);
...
int __fastcall sub_4025A0(_IO_FILE *a1, char a2)
{
  int v2; // er14@1
  _IO_FILE *v3; // rbx@1
  const unsigned __int16 **v4; // rax@1
  _QWORD *v5; // rcx@1
  const unsigned __int16 **v6; // r12@1
  int *v7; // rax@2
  signed __int64 v8; // rcx@3
  char *v9; // rax@3
  const unsigned __int16 *v10; // r8@5
  int v11; // edi@10
  _BYTE *v12; // rbp@10
  int v13; // eax@10
  int v14; // esi@10
  ...
  char v21; // cl@19
  int v23; // er15@11
  __int64 v24; // [sp+8h] [bp-50h]@10
  int v25; // [sp+10h] [bp-48h]@10
...
void __fastcall __noreturn sub_402DC0(int status)
{
  ...
  while ( (!v21 && !v22) != v21 );
  v25 = (const char *)v19[1];
  if ( v25 )
  {
    v26 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v26, &unk_407309);
    v27 = setlocale(5, 0LL);
  ...
  {
    v30 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v30, &unk_407309);
    v31 = setlocale(5, 0LL);
...
__int64 sub_403160()
{
  ...
  if ( (unsigned int)sub_406B60(stdout) )
  {
    ...
    if ( !byte_6162F8 || *v0 != 32 )
    {
      ...
      if ( qword_616300 )
      {
        LODWORD(v5) = sub_404CB0(qword_616300, "write error");
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_406AE0((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_404610(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_60B250 <= a1 )
  {
    ...
    {
      LODWORD(v10) = sub_405480(off_60B238, v9);
      off_60B238 = v10;
      v7 = v10;
    }
  ...
  v23 = *(_DWORD *)(v5 + 4) | 1;
  v13 = *(_QWORD *)v11;
  v14 = sub_4033E0(v12, *(_QWORD *)v11, v21, v4, *(_DWORD *)v5, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v13 <= v14 )
  {
    v15 = v14 + 1;
    *(_QWORD *)v11 = v14 + 1;
    if ( (_UNKNOWN *)v12 != &unk_616320 )
    {
      v16 = v14 + 1;
      free(v12);
      v15 = v16;
    }
    LODWORD(v17) = sub_405420(v15);
    v18 = *(_DWORD *)v5;
    *(_QWORD *)(v11 + 8) = v17;
    v12 = v17;
    sub_4033E0(v17, v15, v21, v4, v18, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v22;
  return v12;
}
...
_BYTE *__fastcall sub_404C30(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  v7 = qword_616450;
  v4 = _mm_load_si128((const __m128i *)&xmmword_616420);
  v5 = _mm_load_si128((const __m128i *)&xmmword_616430);
  v6 = _mm_load_si128((const __m128i *)&xmmword_616440);
  v4.m128i_i32[(a3 >> 5) + 2] ^= (~(unsigned __int8)((unsigned __int32)v4.m128i_i32[(a3 >> 5) + 2] >> (a3 & 0x1F)) & 1) << (a3 & 0x1F);
  return sub_404610(0, a1, a2, (__int64)&v4);
}
...
int __fastcall sub_404E80(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12@1
  __int64 v7; // rbx@1
  char *v8; // rax@3
...
int __fastcall sub_4052E0(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  char *v7; // r10@1
  signed int v8; // er8@1
  __int64 v9; // r9@1
  ...
  do
  {
    if ( (unsigned int)v8 <= 0x2F )
    {
      ...
      v15[v9] = v11;
      if ( !v11 )
        return sub_404E80(a1, a2, a3, a4, (__int64)v15, v9);
      goto LABEL_3;
    }
    v12 = (__int64 *)v7;
    v7 += 8;
...
void *__fastcall sub_405620(const void *a1, size_t a2)
{
  void *v2; // rax@1
...
int __fastcall sub_405BF0(FILE *stream)
{
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_405C70(stream) )
  {
...
int __fastcall sub_405C70(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_405CB0(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
__int64 __fastcall sub_405D10(__int64 a1, __int64 a2)
{
...
signed __int64 __fastcall sub_405DF0(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8, __int64 a9)
{
  const char *v9; // r14@1
  char *v10; // rbp@1
  size_t v11; // r13@5
...
__int64 __fastcall sub_406410(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8)
{
  int v8; // er13@1
  signed int v9; // eax@2
  int v10; // ebp@2
    ...
    if ( *(_BYTE *)v21 == 45 )
    {
      ...
      if ( v36 )
      {
        if ( v53 )
        {
          ...
          {
            *(_QWORD *)(a7 + 32) = v21 + 2;
            v40 = sub_405DF0(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"--");
            goto LABEL_72;
          }
          if ( a6 )
          {
            ...
            {
              *(_QWORD *)(a7 + 32) = v21 + 1;
              v26 = sub_405DF0(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"-");
              if ( v26 != -1 )
...
LABEL_71:
        *(_QWORD *)(a7 + 32) = v28;
        *(_QWORD *)(a7 + 16) = 0LL;
        v40 = sub_405DF0(v10, v11, v12, v53, v54, 0, a7, v8, (__int64)"-W ");
LABEL_72:
        return v40;
      }
      v39 = *(_DWORD *)a7;
...
__int64 __fastcall sub_4069E0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax@1

  dword_616460 = dword_60B25C;
  dword_616464 = dword_60B258;
  result = sub_406410(a1, a2, a3, a4, a5, a6, (__int64)&dword_616460, a7);
...
__int64 __fastcall sub_406A60(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5)
{
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_406BC0(0LL, v6) )
  {
    v4 = 1LL;
...
int __fastcall sub_407200(__int64 a1)
{
  __int64 v1; // rdx@1
