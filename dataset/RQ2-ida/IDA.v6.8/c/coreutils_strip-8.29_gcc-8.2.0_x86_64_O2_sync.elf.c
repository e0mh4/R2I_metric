__int64 __fastcall main(int a1, char **a2, char **a3)
{
  ...
  char *v18; // rax@31
  __int64 v19; // rax@32
  const char *v20; // rsi@32
  char *v21; // r14@33
  int *v22; // rax@33
  const char *v23; // rdx@33
  __int64 v24; // rax@27
  __int64 v25; // r15@27
  char *v26; // r13@27
  int *v27; // rax@27
  __int64 v29; // rax@36
  char *v30; // rax@41
  __int64 v31; // [sp+0h] [bp-48h]@32
  signed int v32; // [sp+Ch] [bp-3Ch]@17
...
LABEL_39:
  ...
  if ( (unsigned __int8)v3 & (v7 >= a1) )
  {
    v30 = dcgettext(0LL, "--data needs at least one argument", 5);
    error(1, 0, v30);
    start();
  }
  if ( v7 < a1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( open(v12, 2049) < 0 )
      {
        LODWORD(v16) = sub_403900(4LL, v12);
        v17 = v16;
        v18 = dcgettext(0LL, "error opening %s", 5);
        error(0, v15, v18, v17);
      }
LABEL_28:
      v9 &= v11;
    ...
    if ( (unsigned int)sub_4043A0(v13) == -1 || (signed int)sub_4043A0(v14) < 0 )
    {
      LODWORD(v19) = sub_403900(4LL, v12);
      v20 = "couldn't reset non-blocking mode %s";
      v31 = v19;
    }
    else
    {
...
LABEL_26:
        ...
        {
          v11 = 0;
          LODWORD(v24) = sub_403900(4LL, v12);
          v25 = v24;
          v26 = dcgettext(0LL, "failed to close %s", 5);
          v27 = __errno_location();
          error(0, *v27, v26, v25);
        }
        goto LABEL_28;
      }
      LODWORD(v29) = sub_403900(4LL, v12);
      v20 = "error syncing %s";
      v31 = v29;
    }
...
void __fastcall __noreturn sub_401B30(int status)
{
  ...
  v7 = stdout;
  v8 = dcgettext(0LL, "  -d, --data             sync only file data, no unneeded metadata\n", 5);
  fputs_unlocked(v8, v7);
  v9 = stdout;
  v10 = dcgettext(0LL, "  -f, --file-system      sync the file systems that contain the files\n", 5);
  ...
  {
    v22 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v22, &unk_405BDD);
    v23 = setlocale(5, 0LL);
  ...
  {
    v26 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v26, &unk_405BDD);
    v27 = setlocale(5, 0LL);
...
__int64 sub_401E90()
{
  ...
  if ( (unsigned int)sub_405330(stdout) )
  {
    ...
    if ( !byte_609298 || *v0 != 32 )
    {
      ...
      if ( qword_6092A0 )
      {
        LODWORD(v5) = sub_4039A0(qword_6092A0, "write error");
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_4052B0((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_403300(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_609250 <= a1 )
  {
    ...
    {
      LODWORD(v10) = sub_404170(off_609238, v9);
      off_609238 = v10;
      v7 = v10;
    }
  ...
  v23 = *(_DWORD *)(v5 + 4) | 1;
  v13 = *(_QWORD *)v11;
  v14 = sub_4020D0(v12, *(_QWORD *)v11, v21, v4, *(_DWORD *)v5, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v13 <= v14 )
  {
    v15 = v14 + 1;
    *(_QWORD *)v11 = v14 + 1;
    ...
    LODWORD(v17) = sub_404110(v15);
    v18 = *(_DWORD *)v5;
    *(_QWORD *)(v11 + 8) = v17;
    v12 = v17;
    sub_4020D0(v17, v15, v21, v4, v18, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v22;
  return v12;
}
...
_BYTE *__fastcall sub_403920(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  return sub_403300(0, a1, a2, (__int64)&v4);
}
...
int __fastcall sub_403B70(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12@1
  __int64 v7; // rbx@1
  char *v8; // rax@3
...
int __fastcall sub_403FD0(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  char *v7; // r10@1
  signed int v8; // er8@1
  __int64 v9; // r9@1
  ...
  do
  {
    if ( (unsigned int)v8 <= 0x2F )
    {
      ...
      v15[v9] = v11;
      if ( !v11 )
        return sub_403B70(a1, a2, a3, a4, (__int64)v15, v9);
      goto LABEL_3;
    }
    v12 = (__int64 *)v7;
    v7 += 8;
...
void *__fastcall sub_404310(const void *a1, size_t a2)
{
  void *v2; // rax@1
...
__int64 __fastcall sub_4043A0(char a1, int a2, __int64 a3, __int64 a4)
{
  int v4; // ebx@3
  int v6; // eax@8
  int *v7; // rax@10
...
__int64 __fastcall sub_4044E0(__int64 a1, __int64 a2)
{
...
signed __int64 __fastcall sub_4045C0(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8, __int64 a9)
{
  const char *v9; // r14@1
  char *v10; // rbp@1
  size_t v11; // r13@5
...
__int64 __fastcall sub_404BE0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8)
{
  int v8; // er13@1
  signed int v9; // eax@2
  int v10; // ebp@2
    ...
    if ( *(_BYTE *)v21 == 45 )
    {
      ...
      if ( v36 )
      {
        if ( v53 )
        {
          ...
          {
            *(_QWORD *)(a7 + 32) = v21 + 2;
            v40 = sub_4045C0(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"--");
            goto LABEL_72;
          }
          if ( a6 )
          {
            ...
            {
              *(_QWORD *)(a7 + 32) = v21 + 1;
              v26 = sub_4045C0(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"-");
              if ( v26 != -1 )
...
LABEL_71:
        *(_QWORD *)(a7 + 32) = v28;
        *(_QWORD *)(a7 + 16) = 0LL;
        v40 = sub_4045C0(v10, v11, v12, v53, v54, 0, a7, v8, (__int64)"-W ");
LABEL_72:
        return v40;
      }
      v39 = *(_DWORD *)a7;
...
__int64 __fastcall sub_4051B0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax@1

  dword_609400 = dword_60925C;
  dword_609404 = dword_609258;
  result = sub_404BE0(a1, a2, a3, a4, a5, a6, (__int64)&dword_609400, a7);
...
__int64 __fastcall sub_405230(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5)
{
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_405390(0LL, v6) )
  {
    v4 = 1LL;
...
int __fastcall sub_405960(FILE *stream)
{
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_4059E0(stream) )
  {
...
int __fastcall sub_4059E0(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_405A20(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
int __fastcall sub_405AF0(__int64 a1)
{
  __int64 v1; // rdx@1
