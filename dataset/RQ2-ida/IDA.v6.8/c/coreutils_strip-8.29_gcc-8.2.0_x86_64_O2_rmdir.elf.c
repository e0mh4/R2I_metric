...
LABEL_41:
  ...
  if ( dword_60C25C == a1 )
  {
    v20 = dcgettext(0LL, "missing operand", 5);
    error(0, 0, v20);
    goto LABEL_41;
  }
  v5 = 1;
  if ( dword_60C25C < a1 )
  {
    do
    {
      ...
      if ( rmdir(v7) )
      {
        ...
        {
          v5 = 0;
          LODWORD(v9) = sub_403BF0(4LL, v7);
          v10 = v9;
          v11 = dcgettext(0LL, "failed to remove %s", 5);
          error(0, *v8, v11, v10);
        }
      }
      else
...
LABEL_32:
          ...
          if ( (unsigned __int8)sub_401C30((unsigned int)*v14, v7) )
          {
LABEL_34:
            v15 = v6;
            goto LABEL_35;
          }
          LODWORD(v17) = sub_403BF0(4LL, v7);
          v18 = v17;
          v19 = dcgettext(0LL, "failed to remove directory %s", 5);
          error(0, *v14, v19, v18);
          v15 = 0;
LABEL_35:
          v5 &= v15;
...
int sub_401BD1()
{
  ...
  if ( !byte_60C288 )
  {
    while ( qword_60C290 < (unsigned __int64)(((&unk_60BE48 - (_UNKNOWN *)&qword_60BE40) >> 3) - 1) )
      (*(&qword_60BE40 + ++qword_60C290))();
    result = sub_401B7B();
    byte_60C288 = 1;
  }
  return result;
...
__int64 __usercall sub_401C30@<rax>(int a1@<ebx>, unsigned int a2@<edi>, const char *a3@<rsi>)
{
  int v4; // eax@7
  int v5; // ebp@7
  DIR *v6; // r12@8
...
void __fastcall __noreturn sub_401D20(int status)
{
  ...
  {
    v20 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v20, &unk_408920);
    v21 = setlocale(5, 0LL);
  ...
  {
    v24 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v24, &unk_408920);
    v25 = setlocale(5, 0LL);
...
__int64 sub_402140()
{
  ...
  if ( (unsigned int)sub_4055A0(stdout) )
  {
    ...
    if ( !byte_60C2A0 || *v0 != 32 )
    {
      ...
      if ( qword_60C2A8 )
      {
        LODWORD(v5) = sub_403C90(qword_60C2A8, "write error");
...
bool __fastcall sub_4021E0(_BYTE *a1)
{
  ...
  LODWORD(v1) = sub_405600();
  v2 = v1;
  if ( !*v1 )
    v2 = a1;
  LODWORD(v3) = sub_405660(v2);
  v4 = &v2[v3];
  v5 = *v4 == 0;
  *v4 = 0;
  return !v5;
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_405460((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_4035F0(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_60C250 <= a1 )
  {
    ...
    {
      LODWORD(v20) = sub_404460(0LL, v9);
      v7 = v20;
      off_60C238 = v20;
      *v20 = (__int128)_mm_load_si128((const __m128i *)&xmmword_60C240);
    }
    else
    {
      LODWORD(v10) = sub_404460(off_60C238, v9);
      off_60C238 = v10;
      v7 = v10;
    }
  ...
  v23 = *(_DWORD *)(v5 + 4) | 1;
  v13 = *(_QWORD *)v11;
  v14 = sub_4023C0(v12, *(_QWORD *)v11, v21, v4, *(_DWORD *)v5, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v13 <= v14 )
  {
    v15 = v14 + 1;
    *(_QWORD *)v11 = v14 + 1;
    if ( (_UNKNOWN *)v12 != &unk_60C2C0 )
    {
      v16 = v14 + 1;
      free(v12);
      v15 = v16;
    }
    LODWORD(v17) = sub_404400(v15);
    v18 = *(_DWORD *)v5;
    *(_QWORD *)(v11 + 8) = v17;
    v12 = v17;
    sub_4023C0(v17, v15, v21, v4, v18, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v22;
  return v12;
}
...
_BYTE *__fastcall sub_403C10(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  v7 = qword_60C3F0;
  v4 = _mm_load_si128((const __m128i *)&xmmword_60C3C0);
  v5 = _mm_load_si128((const __m128i *)&xmmword_60C3D0);
  v6 = _mm_load_si128((const __m128i *)&xmmword_60C3E0);
  v4.m128i_i32[(a3 >> 5) + 2] ^= (~(unsigned __int8)((unsigned __int32)v4.m128i_i32[(a3 >> 5) + 2] >> (a3 & 0x1F)) & 1) << (a3 & 0x1F);
  return sub_4035F0(0, a1, a2, (__int64)&v4);
}
...
int __fastcall sub_403E60(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12@1
  __int64 v7; // rbx@1
  char *v8; // rax@3
...
int __fastcall sub_4042C0(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  char *v7; // r10@1
  signed int v8; // er8@1
  __int64 v9; // r9@1
  ...
  do
  {
    if ( (unsigned int)v8 <= 0x2F )
    {
      ...
      v15[v9] = v11;
      if ( !v11 )
        return sub_403E60(a1, a2, a3, a4, (__int64)v15, v9);
      goto LABEL_3;
    }
    v12 = (__int64 *)v7;
    v7 += 8;
...
void *__fastcall sub_404600(const void *a1, size_t a2)
{
  void *v2; // rax@1
...
__int64 __fastcall sub_404690(__int64 a1, __int64 a2)
{
...
signed __int64 __fastcall sub_404770(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8, __int64 a9)
{
  const char *v9; // r14@1
  char *v10; // rbp@1
  size_t v11; // r13@5
...
__int64 __fastcall sub_404D90(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8)
{
  int v8; // er13@1
  signed int v9; // eax@2
  int v10; // ebp@2
    ...
    if ( *(_BYTE *)v21 == 45 )
    {
      ...
      if ( v36 )
      {
        if ( v53 )
        {
          ...
          {
            *(_QWORD *)(a7 + 32) = v21 + 2;
            v40 = sub_404770(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"--");
            goto LABEL_72;
          }
          if ( a6 )
          {
            ...
            {
              *(_QWORD *)(a7 + 32) = v21 + 1;
              v26 = sub_404770(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"-");
              if ( v26 != -1 )
...
LABEL_71:
        *(_QWORD *)(a7 + 32) = v28;
        *(_QWORD *)(a7 + 16) = 0LL;
        v40 = sub_404770(v10, v11, v12, v53, v54, 0, a7, v8, (__int64)"-W ");
LABEL_72:
        return v40;
      }
      v39 = *(_DWORD *)a7;
...
__int64 __fastcall sub_405360(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax@1

  dword_60C400 = dword_60C25C;
  dword_60C404 = dword_60C258;
  result = sub_404D90(a1, a2, a3, a4, a5, a6, (__int64)&dword_60C400, a7);
...
__int64 __fastcall sub_4053E0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5)
{
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_405690(0LL, v6) )
  {
    v4 = 1LL;
...
__int64 __fastcall sub_4054E0(FILE *s, __int64 a2, __int64 a3)
{
  ...
  n = 2000LL;
  LODWORD(v3) = sub_405D90(&v11, &n, a2, a3);
  v4 = n;
  if ( !v3 )
    goto LABEL_10;
  v5 = v3;
...
int __fastcall sub_405C60(FILE *stream)
{
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_405CE0(stream) )
  {
...
int __fastcall sub_405CE0(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_405D20(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
char *__fastcall sub_405D90(void *a1, size_t *a2, _BYTE *a3, __int64 a4)
{
  _BYTE *v4; // r15@1
  __int64 v5; // rbx@1
  __int64 v6; // rax@3
  ...
  src = a1;
  v153 = a2;
  if ( sub_407AD0(a3, &v167, &v164) < 0 )
    return 0LL;
  if ( sub_4078B0(v5, &v164) < 0 )
  {
    if ( v168 != &v171 )
      free(v168);
    if ( v165 != &v166 )
...
signed __int64 __fastcall sub_4078B0(__int64 a1, __int64 a2)
{
  __int64 v2; // rax@1
...
signed __int64 __fastcall sub_407AD0(signed __int64 a1, __int64 a2, __int64 a3)
{
  _QWORD *v3; // rcx@1
...
int __fastcall sub_408850(__int64 a1)
{
  __int64 v1; // rdx@1
