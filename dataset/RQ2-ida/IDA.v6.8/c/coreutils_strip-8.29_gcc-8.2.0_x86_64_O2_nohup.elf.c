__int64 __fastcall main(int a1, char **a2, char **a3)
{
  ...
  int v8; // er14@4
  bool v9; // r9@4
  signed int v10; // er15@5
  bool v11; // ST18_1@6
  signed int v12; // er14@6
  const char *v13; // rsi@8
  __int64 v14; // rax@9
  const char *v15; // rsi@9
  char *v16; // rax@11
  const char **v17; // rbp@14
  int v18; // er12@14
  const char *v20; // rsi@23
  char *v21; // rax@25
  int v22; // eax@31
  int *v23; // rax@37
  char *v24; // rax@37
  ...
  __int64 v47; // r12@50
  char *v48; // rax@50
  char *ptr; // [sp+8h] [bp-60h]@8
  int ptra; // [sp+8h] [bp-60h]@12
  char ptrb; // [sp+8h] [bp-60h]@18
  char format; // [sp+10h] [bp-58h]@6
  bool formata; // [sp+10h] [bp-58h]@31
  __mode_t mask; // [sp+18h] [bp-50h]@6
  __int64 maska; // [sp+18h] [bp-50h]@9
  int errnum; // [sp+20h] [bp-48h]@37
  int *v57; // [sp+28h] [bp-40h]@37
  ...
  sub_406140(
    ...
    "/home/dongkwan/data/scripts/gnu_packages/coreutils/coreutils-8.29_gcc-8.2.0_x86_64_O2_debug/gogo/share/locale");
  sub_4023E0(a1);
  if ( sub_4057F0((unsigned int)a1, a2, "+", &unk_4067C0, 0LL) != -1 )
LABEL_49:
    sub_401E70(v5);
  if ( dword_60925C >= a1 )
  {
...
LABEL_6:
  ...
  formata = v9;
  v22 = sub_402270(0, "/dev/null", 1);
  v9 = formata;
  if ( v22 < 0 )
  {
    v37 = formata;
    v38 = dcgettext(0LL, "failed to render standard input unusable", 5);
...
LABEL_7:
    ...
    if ( !v24 )
    {
      LODWORD(v42) = sub_403EC0(4LL, "nohup.out");
      v43 = v42;
      v44 = dcgettext(0LL, "failed to open %s", 5);
      error(0, errnum, v44, v43);
      return (unsigned int)v5;
    }
    LODWORD(v25) = sub_4022E0(v24, "nohup.out", 0LL);
    ptr = v25;
    if ( v7 )
    {
      v12 = sub_402270(1, v25, 1089);
      if ( v12 >= 0 )
        goto LABEL_40;
      v26 = *v57;
      LODWORD(v27) = sub_403EC0(4LL, "nohup.out");
      v28 = v27;
      v29 = dcgettext(0LL, "failed to open %s", 5);
      error(0, errnum, v29, v28);
      if ( !ptr )
        return (unsigned int)v5;
    }
    else
    {
      v12 = open(v25, 1089, 384LL);
      if ( v12 >= 0 )
      {
LABEL_40:
        v13 = ptr;
LABEL_9:
        umask(mask);
        LODWORD(v14) = sub_403EC0(4LL, v13);
...
LABEL_26:
          if ( dup2(v12, 2) < 0 )
          {
            v40 = dcgettext(0LL, "failed to redirect standard error", 5);
...
LABEL_23:
        v20 = "ignoring input and redirecting stderr to stdout";
        if ( !v6 )
          v20 = "redirecting stderr to stdout";
        v21 = dcgettext(0LL, v20, 5);
        error(0, 0, v21);
        goto LABEL_26;
      }
      v26 = *v57;
      LODWORD(v46) = sub_403EC0(4LL, "nohup.out");
      v47 = v46;
      v48 = dcgettext(0LL, "failed to open %s", 5);
      error(0, errnum, v48, v47);
    }
    LODWORD(v30) = sub_403EC0(4LL, ptr);
    v31 = v30;
...
LABEL_13:
  if ( !(stderr->_flags & 0x20) )
  {
    ...
    v17 = (const char **)&v3[dword_60925C];
    execvp(*v17, (char *const *__attribute__((__org_arrdim(0,0))) )v17);
    v18 = *__errno_location();
    v5 = (v18 == 2) + 126;
    if ( dup2(ptra, 2) == 2 )
    {
      LODWORD(v34) = sub_403EC0(4LL, *v17);
      v35 = v34;
      v36 = dcgettext(0LL, "failed to run command %s", 5);
      error(0, v18, v36, v35);
    }
  }
  return (unsigned int)v5;
...
int sub_401E11()
{
  ...
  if ( !byte_609288 )
  {
    while ( qword_609290 < (unsigned __int64)(((&unk_608E48 - (_UNKNOWN *)&qword_608E40) >> 3) - 1) )
      (*(&qword_608E40 + ++qword_609290))();
    result = sub_401DBB();
    byte_609288 = 1;
  }
  return result;
...
void __fastcall __noreturn sub_401E70(int status)
{
  ...
  v4 = dcgettext(0LL, "Usage: %s COMMAND [ARG]...\n  or:  %s OPTION\n", 5);
  __printf_chk(1LL, v4, v2, v2);
  v5 = stdout;
  v6 = dcgettext(0LL, "Run COMMAND, ignoring hangup signals.\n\n", 5);
  ...
  v14 = dcgettext(
          ...
          5);
  __printf_chk(1LL, v14, "nohup", v15);
  v33 = "[";
  v16 = (__int64 *)&v33;
  v34 = "test invocation";
  v35 = "coreutils";
  ...
  {
    v23 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v23, &unk_406220, "https://www.gnu.org/software/coreutils/");
    v24 = setlocale(5, 0LL);
  ...
  {
    v28 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v28, &unk_406220, "https://www.gnu.org/software/coreutils/");
    v29 = setlocale(5, 0LL);
    if ( !v29 || !strncmp(v29, "en_", 3uLL) )
    {
      ...
      __printf_chk(1LL, v30, "https://www.gnu.org/software/coreutils/", "nohup");
LABEL_15:
...
LABEL_3:
  ...
  __printf_chk(1LL, v31, "nohup", v32);
LABEL_13:
  v25 = "Multi-call invocation" + 10;
  v26 = dcgettext(0LL, "Full documentation at: <%s%s>\n", 5);
  __printf_chk(1LL, v26, "https://www.gnu.org/software/coreutils/", "nohup");
  if ( v22 != "nohup" )
    v25 = "";
  goto LABEL_15;
}
...
__int64 sub_4021D0()
{
  ...
  if ( (unsigned int)sub_4058F0(stdout) )
  {
    ...
    if ( !byte_609298 || *v0 != 32 )
    {
      ...
      if ( qword_6092A0 )
      {
        LODWORD(v5) = sub_403F60(qword_6092A0, "write error");
...
void *__fastcall sub_402300(void *src, void *a2, _QWORD *a3)
{
  ...
  v3 = (const char *)a2;
  v16 = a3;
  LODWORD(v4) = sub_405950(src);
  v5 = v4;
  LODWORD(v6) = sub_4059B0(v4);
  v7 = v6;
  v8 = v6 + v5 - (_QWORD)src;
  if ( v6 )
    v7 = *(_BYTE *)(v5 + v6 - 1) != 47;
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_405870((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_4038C0(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_609250 <= a1 )
  {
    ...
    {
      LODWORD(v20) = sub_404730(0LL, v9);
      v7 = v20;
      off_609238 = v20;
      *v20 = (__int128)_mm_load_si128((const __m128i *)&xmmword_609240);
    }
    else
    {
      LODWORD(v10) = sub_404730(off_609238, v9);
      off_609238 = v10;
      v7 = v10;
    }
  ...
  v23 = *(_DWORD *)(v5 + 4) | 1;
  v13 = *(_QWORD *)v11;
  v14 = sub_402690(v12, *(_QWORD *)v11, v21, v4, *(_DWORD *)v5, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v13 <= v14 )
  {
    v15 = v14 + 1;
    *(_QWORD *)v11 = v14 + 1;
    if ( (_UNKNOWN *)v12 != &unk_6092C0 )
    {
      v16 = v14 + 1;
      free(v12);
      v15 = v16;
    }
    LODWORD(v17) = sub_4046D0(v15);
    v18 = *(_DWORD *)v5;
    *(_QWORD *)(v11 + 8) = v17;
    v12 = v17;
    sub_402690(v17, v15, v21, v4, v18, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v22;
  return v12;
}
...
_BYTE *__fastcall sub_403EE0(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  v7 = qword_6093F0;
  v4 = _mm_load_si128((const __m128i *)&xmmword_6093C0);
  v5 = _mm_load_si128((const __m128i *)&xmmword_6093D0);
  v6 = _mm_load_si128((const __m128i *)&xmmword_6093E0);
  v4.m128i_i32[(a3 >> 5) + 2] ^= (~(unsigned __int8)((unsigned __int32)v4.m128i_i32[(a3 >> 5) + 2] >> (a3 & 0x1F)) & 1) << (a3 & 0x1F);
  return sub_4038C0(0, a1, a2, (__int64)&v4);
}
...
int __fastcall sub_404130(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12@1
  __int64 v7; // rbx@1
  char *v8; // rax@3
...
int __fastcall sub_404530(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v5; // r9@1
  __int64 *v6; // r10@2
  __int64 v7; // rax@2
  ...
  do
  {
    ...
    if ( *(_DWORD *)a5 <= 0x2Fu )
    {
      ...
      *(_DWORD *)a5 = v8 + 8;
      ...
      v12[v5] = *v6;
      if ( !v7 )
        return sub_404130(a1, a2, a3, a4, (__int64)v12, v5);
      goto LABEL_3;
    }
    v9 = *(__int64 **)(a5 + 8);
    *(_QWORD *)(a5 + 8) = v9 + 1;
...
void *__fastcall sub_4048D0(const void *a1, size_t a2)
{
  void *v2; // rax@1
...
__int64 __fastcall sub_404960(char a1, int a2, __int64 a3, __int64 a4)
{
  int v4; // ebx@3
  int v6; // eax@8
  int *v7; // rax@10
...
__int64 __fastcall sub_404AA0(__int64 a1, __int64 a2)
{
...
signed __int64 __fastcall sub_404B80(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8, __int64 a9)
{
  const char *v9; // r14@1
  char *v10; // rbp@1
  size_t v11; // r13@5
...
__int64 __fastcall sub_4051A0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8)
{
  int v8; // er13@1
  signed int v9; // eax@2
  int v10; // ebp@2
    ...
    if ( *(_BYTE *)v21 == 45 )
    {
      ...
      if ( v36 )
      {
        if ( v53 )
        {
          ...
          {
            *(_QWORD *)(a7 + 32) = v21 + 2;
            v40 = sub_404B80(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"--");
            goto LABEL_72;
          }
          if ( a6 )
          {
            ...
            {
              *(_QWORD *)(a7 + 32) = v21 + 1;
              v26 = sub_404B80(v10, v11, v12, v53, v54, a6, a7, v8, 4225722LL);
              if ( v26 != -1 )
...
LABEL_71:
        *(_QWORD *)(a7 + 32) = v28;
        *(_QWORD *)(a7 + 16) = 0LL;
        v40 = sub_404B80(v10, v11, v12, v53, v54, 0, a7, v8, (__int64)"-W ");
LABEL_72:
        return v40;
      }
      v39 = *(_DWORD *)a7;
...
__int64 __fastcall sub_405770(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax@1

  dword_609400 = dword_60925C;
  dword_609404 = dword_609258;
  result = sub_4051A0(a1, a2, a3, a4, a5, a6, (__int64)&dword_609400, a7);
...
__int64 __fastcall sub_4057F0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5)
{
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_4059E0(0LL, v6) )
  {
    v4 = 1LL;
...
int __fastcall sub_405FB0(FILE *stream)
{
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_406030(stream) )
  {
...
int __fastcall sub_406030(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_406070(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
int __fastcall sub_406140(__int64 a1)
{
  __int64 v1; // rdx@1
