__int64 __fastcall main(signed int a1, char **a2, char **a3)
{
  ...
  char *v7; // rax@7
  const char *v8; // rbx@11
  char v9; // r10@14
  signed __int64 v10; // rsi@14
  const char *v11; // rax@16
  char v12; // dl@17
  char *v13; // r9@17
  _BYTE *v14; // rax@20
  unsigned __int8 v15; // cl@21
  char *v16; // rax@32
  signed __int64 v18; // rbp@38
  const char *i; // rbx@39
  int v20; // ebx@40
  char *v21; // rax@41
  int v22; // edx@44
  const char *v23; // r13@44
  char v24; // r15@46
  int v25; // ecx@47
  int v26; // eax@50
  __int64 v27; // rdi@50
...
LABEL_5:
  ...
  v18 = (signed __int64)&v4[(unsigned int)(v5 - 1) + 1];
  while ( 2 )
  {
    for ( i = *v4; ; i = v23 )
    {
      ...
      if ( v24 )
      {
        ...
        switch ( v24 )
        {
          ...
          case 120:
            v34 = i[2];
            if ( !(HIBYTE((*__ctype_b_loc())[(unsigned __int8)v34]) & 0x10) )
              goto LABEL_67;
            v26 = sub_401AA0((unsigned __int8)v34, v10);
            v27 = i[3];
            v22 = v26;
...
signed __int64 __fastcall sub_401AA0(unsigned __int8 a1)
{
...
void __fastcall __noreturn sub_401B20(int status)
{
  ...
  v4 = dcgettext(0LL, "Usage: %s [SHORT-OPTION]... [STRING]...\n  or:  %s LONG-OPTION\n", 5);
  ...
  {
    v28 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v28, &unk_40509B, "https://www.gnu.org/software/coreutils/");
    v29 = setlocale(5, 0LL);
  ...
  {
    v33 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v33, &unk_40509B, "https://www.gnu.org/software/coreutils/");
    v34 = setlocale(5, 0LL);
    if ( !v34 || !strncmp(v34, "en_", 3uLL) )
    {
      ...
      __printf_chk(1LL, v35, "https://www.gnu.org/software/coreutils/", "echo");
LABEL_15:
...
LABEL_3:
  ...
  __printf_chk(1LL, v36, "echo", v37);
LABEL_13:
  v30 = "Multi-call invocation" + 10;
  v31 = dcgettext(0LL, "Full documentation at: <%s%s>\n", 5);
  __printf_chk(1LL, v31, "https://www.gnu.org/software/coreutils/", "echo");
  if ( v27 != "echo" )
    v30 = "";
  goto LABEL_15;
}
...
__int64 sub_401EF0()
{
  ...
  if ( (unsigned int)sub_404480(stdout) )
  {
    ...
    if ( !byte_608258 || *v0 != 32 )
    {
      ...
      if ( qword_608260 )
      {
        LODWORD(v5) = sub_403A00(qword_608260, "write error");
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_404400((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_403360(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_608210 <= a1 )
  {
    ...
    {
      LODWORD(v20) = sub_4041D0(0LL, v9);
      v7 = v20;
      off_6081F8 = v20;
      *v20 = (__int128)_mm_load_si128((const __m128i *)&xmmword_608200);
    }
    else
    {
      LODWORD(v10) = sub_4041D0(off_6081F8, v9);
      off_6081F8 = v10;
      v7 = v10;
    }
  ...
  if ( v13 <= v14 )
  {
    v15 = v14 + 1;
    *(_QWORD *)v11 = v14 + 1;
    if ( (_UNKNOWN *)v12 != &unk_608280 )
    {
      v16 = v14 + 1;
      free(v12);
      v15 = v16;
    }
    LODWORD(v17) = sub_404170(v15);
    v18 = *(_DWORD *)v5;
    *(_QWORD *)(v11 + 8) = v17;
    v12 = v17;
    sub_402130(v17, v15, v21, v4, v18, v23, v5 + 8, *(const char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v22;
  return v12;
}
...
_BYTE *__fastcall sub_403980(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  return sub_403360(0, a1, a2, (__int64)&v4);
}
...
int __fastcall sub_403BD0(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12@1
  __int64 v7; // rbx@1
  char *v8; // rax@3
...
int __fastcall sub_404030(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  char *v7; // r10@1
  signed int v8; // er8@1
  __int64 v9; // r9@1
  ...
  do
  {
    if ( (unsigned int)v8 <= 0x2F )
    {
      ...
      v15[v9] = v11;
      if ( !v11 )
        return sub_403BD0(a1, a2, a3, a4, (__int64)v15, v9);
      goto LABEL_3;
    }
    v12 = (__int64 *)v7;
    v7 += 8;
...
void *__fastcall sub_404370(const void *a1, size_t a2)
{
  void *v2; // rax@1
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_4044E0(0LL, v6) )
  {
    v4 = 1LL;
...
int __fastcall sub_404AB0(FILE *stream)
{
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_404B30(stream) )
  {
...
int __fastcall sub_404B30(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_404B70(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
int __fastcall sub_404C40(__int64 a1)
{
  __int64 v1; // rdx@1
