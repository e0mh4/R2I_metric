signed __int64 __fastcall main(unsigned int a1, char **a2, char **a3)
{
  ...
  const char **v6; // rbx@5
  char v7; // r15@5
  unsigned __int64 v8; // r12@5
  const char *v9; // rcx@5
  size_t v10; // rax@6
  unsigned __int64 v11; // rbx@9
  unsigned __int64 v12; // rax@10
  char *v13; // rax@10
  const char *v14; // ST18_8@11
  size_t v15; // rax@11
  const char *v16; // rsi@11
  char *v17; // rcx@11
  char *v18; // ST18_8@12
  const char *v19; // rax@14
  unsigned __int64 v20; // r12@18
  signed __int64 v21; // rbp@18
  char *v22; // rcx@19
  char *v23; // rbx@23
  int *v24; // rax@23
  __int64 v26; // rax@25
  char *src; // [sp+8h] [bp-40h]@6
  ...
  sub_4058E0(
    ...
    "/home/dongkwan/data/scripts/gnu_packages/coreutils/coreutils-8.29_gcc-8.2.0_x86_64_O2_debug/gogo/share/locale");
  sub_401CF0(a1);
  if ( sub_405020(a1, a2, "+", &unk_405C40, 0LL) != -1 )
    sub_4018C0(1);
  ...
  if ( v4 <= (char **)v3 )
  {
    LODWORD(v26) = sub_404040(0x2000LL);
    *(_BYTE *)(v26 - 1) = 10;
    BUG();
  }
  v5 = *v3;
...
LABEL_14:
  ...
  do
  {
    ...
    {
      v18 = (char *)v15;
      memcpy((void *)&v5[v11], v16, v15);
      v17 = v18;
    }
    v12 = (unsigned __int64)&v17[v11];
    ++v3;
  ...
  *v13 = 10;
  ...
  if ( v20 != 1 )
  {
    ...
    do
    {
      v22 = (char *)memcpy(v22, v5, v11) + v11;
      --v21;
    }
    while ( v21 );
    v11 *= v20;
  }
  while ( sub_401C70(1, (void *)v5, v11) == v11 )
    ;
  v23 = dcgettext(0LL, "standard output", 5);
...
void __fastcall __noreturn sub_4018C0(int status)
{
  ...
  v4 = dcgettext(0LL, "Usage: %s [STRING]...\n  or:  %s OPTION\n", 5);
  __printf_chk(1LL, v4, v2, v2);
  v5 = stdout;
  v6 = dcgettext(0LL, "Repeatedly output a line with all specified STRING(s), or 'y'.\n\n", 5);
  ...
  {
    v18 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v18, &unk_4059BE, "https://www.gnu.org/software/coreutils/");
    v19 = setlocale(5, 0LL);
  ...
  {
    v23 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v23, &unk_4059BE, "https://www.gnu.org/software/coreutils/");
    v24 = setlocale(5, 0LL);
    if ( !v24 || !strncmp(v24, "en_", 3uLL) )
    {
      ...
      __printf_chk(1LL, v25, "https://www.gnu.org/software/coreutils/", &unk_405944);
LABEL_15:
...
LABEL_3:
  ...
  __printf_chk(1LL, v26, &unk_405944, v27);
LABEL_13:
  v20 = "Multi-call invocation" + 10;
  v21 = dcgettext(0LL, "Full documentation at: <%s%s>\n", 5);
  __printf_chk(1LL, v21, "https://www.gnu.org/software/coreutils/", &unk_405944);
  if ( v17 != &unk_405944 )
    v20 = "";
  goto LABEL_15;
}
...
__int64 sub_401BD0()
{
  ...
  if ( (unsigned int)sub_405120(stdout) )
  {
    ...
    if ( !byte_609278 || *v0 != 32 )
    {
      ...
      if ( qword_609280 )
      {
        LODWORD(v5) = sub_403870(qword_609280, "write error");
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_4050A0((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_4031D0(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_609230 <= a1 )
  {
    ...
    {
      LODWORD(v10) = sub_4040A0(off_609218, v9);
      off_609218 = v10;
      v7 = v10;
    }
  ...
  v23 = *(_DWORD *)(v5 + 4) | 1;
  v13 = *(_QWORD *)v11;
  v14 = sub_401FA0(v12, *(_QWORD *)v11, v21, v4, *(_DWORD *)v5, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v13 <= v14 )
  {
    v15 = v14 + 1;
    *(_QWORD *)v11 = v14 + 1;
    ...
    LODWORD(v17) = sub_404040(v15);
    v18 = *(_DWORD *)v5;
    *(_QWORD *)(v11 + 8) = v17;
    v12 = v17;
    sub_401FA0(v17, v15, v21, v4, v18, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v22;
  return v12;
}
...
_BYTE *__fastcall sub_4037F0(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  return sub_4031D0(0, a1, a2, (__int64)&v4);
}
...
__int64 __fastcall sub_403A40(int fd, void *buf, size_t n)
{
...
int __fastcall sub_403AA0(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12@1
  __int64 v7; // rbx@1
  char *v8; // rax@3
...
int __fastcall sub_403EA0(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v5; // r9@1
  __int64 *v6; // r10@2
  __int64 v7; // rax@2
  ...
  do
  {
    ...
    if ( *(_DWORD *)a5 <= 0x2Fu )
    {
      ...
      *(_DWORD *)a5 = v8 + 8;
      ...
      v12[v5] = *v6;
      if ( !v7 )
        return sub_403AA0(a1, a2, a3, a4, (__int64)v12, v5);
      goto LABEL_3;
    }
    v9 = *(__int64 **)(a5 + 8);
    *(_QWORD *)(a5 + 8) = v9 + 1;
...
void *__fastcall sub_404240(const void *a1, size_t a2)
{
  void *v2; // rax@1
...
__int64 __fastcall sub_4042D0(__int64 a1, __int64 a2)
{
...
signed __int64 __fastcall sub_4043B0(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8, __int64 a9)
{
  const char *v9; // r14@1
  char *v10; // rbp@1
  size_t v11; // r13@5
...
__int64 __fastcall sub_4049D0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8)
{
  int v8; // er13@1
  signed int v9; // eax@2
  int v10; // ebp@2
    ...
    if ( *(_BYTE *)v21 == 45 )
    {
      ...
      if ( v36 )
      {
        if ( v53 )
        {
          ...
          {
            *(_QWORD *)(a7 + 32) = v21 + 2;
            v40 = sub_4043B0(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"--");
            goto LABEL_72;
          }
          if ( a6 )
          {
            ...
            {
              *(_QWORD *)(a7 + 32) = v21 + 1;
              v26 = sub_4043B0(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"-");
              if ( v26 != -1 )
...
LABEL_71:
        *(_QWORD *)(a7 + 32) = v28;
        *(_QWORD *)(a7 + 16) = 0LL;
        v40 = sub_4043B0(v10, v11, v12, v53, v54, 0, a7, v8, (__int64)"-W ");
LABEL_72:
        return v40;
      }
      v39 = *(_DWORD *)a7;
...
__int64 __fastcall sub_404FA0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax@1

  dword_6093E0 = dword_60923C;
  dword_6093E4 = dword_609238;
  result = sub_4049D0(a1, a2, a3, a4, a5, a6, (__int64)&dword_6093E0, a7);
...
__int64 __fastcall sub_405020(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5)
{
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_405180(0LL, v6) )
  {
    v4 = 1LL;
...
int __fastcall sub_405750(FILE *stream)
{
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_4057D0(stream) )
  {
...
int __fastcall sub_4057D0(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_405810(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
int __fastcall sub_4058E0(__int64 a1)
{
  __int64 v1; // rdx@1
