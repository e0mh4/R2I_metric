__int64 __fastcall main(int a1, char **a2, char **a3)
{
  ...
  char *v10; // rdi@23
  int *v12; // rax@27
  char v13; // [sp+Eh] [bp-2Ah]@19
  char v14; // [sp+Fh] [bp-29h]@19
...
LABEL_12:
      ...
      else
      {
        v13 = v4;
        v14 = 0;
        qword_60A460 = (__int64)&v13;
      }
LABEL_6:
      v5 = dcgettext(0LL, "invalid number of columns", 5);
      LODWORD(v6) = sub_404870(qword_60A460, 1LL, -10LL, "", v5, 0LL);
      v3 = v6;
    }
    else if ( v4 == 115 )
    {
  ...
  {
    v7 = &a2[dword_60A25C];
    v8 = &(&a2[dword_60A25C + 1])[8 * (unsigned __int64)(unsigned int)(a1 + ~dword_60A25C)];
    v9 = 1;
    do
    {
      v10 = *v7;
      ++v7;
      v9 &= sub_401B40(v10, v3);
    }
    while ( v7 != v8 );
  }
...
__int64 __fastcall sub_401B40(char *a1, unsigned __int64 a2)
{
  ...
  _BYTE *v23; // rax@11
  size_t v24; // r14@29
  const unsigned __int16 *v25; // rcx@29
  signed __int64 v26; // rdx@31
  char *v27; // rax@32
  char *v28; // rdx@35
  unsigned __int64 v29; // rax@36
  __int64 v30; // rdx@36
  char *v31; // r8@36
  __int64 v32; // rax@39
  bool v33; // cf@39
  bool v34; // zf@39
  signed __int64 v35; // rcx@39
  char *v36; // rsi@39
  char *v37; // rdi@39
  __int64 v38; // rax@45
  unsigned __int64 v39; // [sp+8h] [bp-50h]@1
  char *filename; // [sp+10h] [bp-48h]@1
  int *v41; // [sp+18h] [bp-40h]@6
  ...
  do
  {
    if ( !v2 )
      break;
    v3 = (unsigned __int8)*v5 < (unsigned __int8)*v6;
    v4 = *v5++ == *v6++;
    --v2;
  }
  while ( v4 );
...
LABEL_8:
  v10 = v7->_IO_read_ptr;
  if ( v10 < v7->_IO_read_end )
  {
LABEL_9:
    v7->_IO_read_ptr = v10 + 1;
...
LABEL_10:
    v12 = ptr;
    if ( v8 + 1 >= qword_60A2A0 )
    {
      LODWORD(v23) = sub_404670(ptr, &qword_60A2A0);
      v12 = v23;
      ptr = v23;
    }
    if ( v11 == 10 )
    {
      ...
      v8 = 0LL;
      v9 = 0LL;
      fwrite_unlocked(v12, 1uLL, v22, stdout);
      goto LABEL_8;
    }
    while ( 1 )
    {
...
LABEL_26:
        ...
        v8 = 0LL;
        v9 = 0LL;
        fwrite_unlocked(v12, 1uLL, v21, stdout);
        v12 = ptr;
      }
      if ( !v8 )
        break;
      ...
      fwrite_unlocked(v12, 1uLL, v24, stdout);
...
LABEL_16:
  ...
  {
    v14 = 0;
    v15 = (v7->_flags & 0x20) == 0;
    if ( !(v7->_flags & 0x20) )
      goto LABEL_20;
LABEL_39:
    LODWORD(v32) = sub_403DD0(0LL, 3LL, filename);
    error(0, v13, "%s", v32);
    v35 = 2LL;
    v36 = filename;
    v37 = "-";
    do
    {
      if ( !v35 )
        break;
      v33 = (unsigned __int8)*v36 < (unsigned __int8)*v37;
      v34 = *v36++ == *v37++;
      --v35;
    }
    while ( v34 );
  ...
  fwrite_unlocked(ptr, 1uLL, v8, stdout);
  v14 = 0;
  v15 = (v7->_flags & 0x20) == 0;
  if ( v7->_flags & 0x20 )
    goto LABEL_39;
LABEL_20:
  ...
  do
  {
    if ( !v17 )
      break;
    v14 = (unsigned __int8)*v16 < (unsigned __int8)*v18;
    v15 = *v16++ == *v18++;
    --v17;
  }
  while ( v15 );
  if ( (!v14 && !v15) != v14 && (unsigned int)sub_404CE0(v7) == -1 )
  {
LABEL_45:
    v19 = 0;
    LODWORD(v38) = sub_403DD0(0LL, 3LL, filename);
    error(0, *v41, "%s", v38);
    return v19;
  }
  return 1;
...
void __fastcall __noreturn sub_401ED0(int status)
{
  ...
  v5 = stdout;
  v6 = dcgettext(0LL, "Wrap input lines in each FILE, writing to standard output.\n", 5);
  ...
  {
    v24 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v24, &unk_4063BF);
    v25 = setlocale(5, 0LL);
  ...
  {
    v28 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v28, &unk_4063BF);
    v29 = setlocale(5, 0LL);
...
__int64 sub_402250()
{
  ...
  if ( (unsigned int)sub_405C50(stdout) )
  {
    ...
    if ( !byte_60A2B0 || *v0 != 32 )
    {
      ...
      if ( qword_60A2B8 )
      {
        LODWORD(v5) = sub_403DA0(qword_60A2B8, "write error");
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_405BD0((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_403700(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_60A250 <= a1 )
  {
    ...
    {
      LODWORD(v10) = sub_404570(off_60A238, v9);
      off_60A238 = v10;
      v7 = v10;
    }
  ...
  v23 = *(_DWORD *)(v5 + 4) | 1;
  v13 = *(_QWORD *)v11;
  v14 = sub_4024D0(v12, *(_QWORD *)v11, v21, v4, *(_DWORD *)v5, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v13 <= v14 )
  {
    v15 = v14 + 1;
    *(_QWORD *)v11 = v14 + 1;
    ...
    LODWORD(v17) = sub_404510(v15);
    v18 = *(_DWORD *)v5;
    *(_QWORD *)(v11 + 8) = v17;
    v12 = v17;
    sub_4024D0(v17, v15, v21, v4, v18, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v22;
  return v12;
}
...
_BYTE *__fastcall sub_403D20(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  return sub_403700(0, a1, a2, (__int64)&v4);
}
...
int __fastcall sub_403F70(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12@1
  __int64 v7; // rbx@1
  char *v8; // rax@3
...
int __fastcall sub_4043D0(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  char *v7; // r10@1
  signed int v8; // er8@1
  __int64 v9; // r9@1
  ...
  do
  {
    if ( (unsigned int)v8 <= 0x2F )
    {
      ...
      v15[v9] = v11;
      if ( !v11 )
        return sub_403F70(a1, a2, a3, a4, (__int64)v15, v9);
      goto LABEL_3;
    }
    v12 = (__int64 *)v7;
    v7 += 8;
...
void *__fastcall sub_404670(void *a1, unsigned __int64 *a2)
{
...
void *__fastcall sub_404710(const void *a1, size_t a2)
{
  void *v2; // rax@1
...
int __fastcall sub_404CE0(FILE *stream)
{
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_404D60(stream) )
  {
...
int __fastcall sub_404D60(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_404DA0(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
__int64 __fastcall sub_404E00(__int64 a1, __int64 a2)
{
...
signed __int64 __fastcall sub_404EE0(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8, __int64 a9)
{
  const char *v9; // r14@1
  char *v10; // rbp@1
  size_t v11; // r13@5
...
__int64 __fastcall sub_405500(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8)
{
  int v8; // er13@1
  signed int v9; // eax@2
  int v10; // ebp@2
    ...
    if ( *(_BYTE *)v21 == 45 )
    {
      ...
      if ( v36 )
      {
        if ( v53 )
        {
          ...
          {
            *(_QWORD *)(a7 + 32) = v21 + 2;
            v40 = sub_404EE0(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"--");
            goto LABEL_72;
          }
          if ( a6 )
          {
            ...
            {
              *(_QWORD *)(a7 + 32) = v21 + 1;
              v26 = sub_404EE0(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"-");
              if ( v26 != -1 )
...
LABEL_71:
        *(_QWORD *)(a7 + 32) = v28;
        *(_QWORD *)(a7 + 16) = 0LL;
        v40 = sub_404EE0(v10, v11, v12, v53, v54, 0, a7, v8, (__int64)"-W ");
LABEL_72:
        return v40;
      }
      v39 = *(_DWORD *)a7;
...
__int64 __fastcall sub_405AD0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax@1

  dword_60A420 = dword_60A25C;
  dword_60A424 = dword_60A258;
  result = sub_405500(a1, a2, a3, a4, a5, a6, (__int64)&dword_60A420, a7);
...
__int64 __fastcall sub_405B50(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5)
{
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_405CB0(0LL, v6) )
  {
    v4 = 1LL;
...
int __fastcall sub_4062F0(__int64 a1)
{
  __int64 v1; // rdx@1
