__int64 __fastcall main(int a1, char **a2, char **a3)
{
  ...
  sub_405770(
    ...
    "/home/dongkwan/data/scripts/gnu_packages/coreutils/coreutils-8.29_gcc-8.2.0_x86_64_O2_debug/gogo/share/locale");
  sub_401BE0(a1);
  if ( sub_404EB0((unsigned int)a1, a2, "", &unk_405B00, 0LL) != -1 )
LABEL_8:
    sub_401830(1);
  v5 = dword_60923C;
  if ( dword_60923C + 1 >= a1 )
    goto LABEL_10;
  if ( (signed int)v5 + 2 < a1 )
  {
    LODWORD(v7) = sub_403910(a2[(signed int)v5 + 2]);
    v8 = "extra operand %s";
    v9 = v7;
    goto LABEL_7;
  }
  if ( link(a2[(signed int)v5], a2[(signed int)v5 + 1LL]) )
  {
    LODWORD(v11) = sub_4035E0(1LL, 4LL, a2[dword_60923C]);
    v12 = v11;
    LODWORD(v13) = sub_4035E0(0LL, 4LL, a2[dword_60923C + 1]);
    v3 = v13;
    v4 = dcgettext(0LL, "cannot create link %s to %s", 5);
    v14 = __errno_location();
    error(1, *v14, v4, v3, v12);
LABEL_10:
    if ( (signed int)v5 >= (signed int)v3 )
    {
      v15 = dcgettext(0LL, "missing operand", 5);
      error(0, 0, v15);
      goto LABEL_8;
    }
    LODWORD(v16) = sub_403910(*(_QWORD *)&v4[8 * v5]);
    v8 = "missing operand after %s";
    v9 = v16;
LABEL_7:
    v10 = dcgettext(0LL, v8, 5);
    error(0, 0, v10, v9);
    goto LABEL_8;
  }
  return 0LL;
...
void __fastcall __noreturn sub_401830(int status)
{
  ...
  v4 = dcgettext(0LL, "Usage: %s FILE1 FILE2\n  or:  %s OPTION\n", 5);
  __printf_chk(1LL, v4, v2, v2);
  v5 = stdout;
  v6 = dcgettext(0LL, "Call the link function to create a link named FILE2 to an existing FILE1.\n\n", 5);
  ...
  {
    v18 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v18, &unk_40583F, "https://www.gnu.org/software/coreutils/");
    v19 = setlocale(5, 0LL);
  ...
  {
    v23 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v23, &unk_40583F, "https://www.gnu.org/software/coreutils/");
    v24 = setlocale(5, 0LL);
    if ( !v24 || !strncmp(v24, "en_", 3uLL) )
    {
      ...
      __printf_chk(1LL, v25, "https://www.gnu.org/software/coreutils/", "link");
LABEL_15:
...
LABEL_3:
  ...
  __printf_chk(1LL, v26, "link", v27);
LABEL_13:
  v20 = "Multi-call invocation" + 10;
  v21 = dcgettext(0LL, "Full documentation at: <%s%s>\n", 5);
  __printf_chk(1LL, v21, "https://www.gnu.org/software/coreutils/", "link");
  if ( v17 != "link" )
    v20 = "";
  goto LABEL_15;
}
...
__int64 sub_401B40()
{
  ...
  if ( (unsigned int)sub_404FB0(stdout) )
  {
    ...
    if ( !byte_609278 || *v0 != 32 )
    {
      ...
      if ( qword_609280 )
      {
        LODWORD(v5) = sub_403760(qword_609280, "write error");
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_404F30((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_4030C0(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_609230 <= a1 )
  {
    ...
    {
      LODWORD(v10) = sub_403F30(off_609218, v9);
      off_609218 = v10;
      v7 = v10;
    }
  ...
  v23 = *(_DWORD *)(v5 + 4) | 1;
  v13 = *(_QWORD *)v11;
  v14 = sub_401E90(v12, *(_QWORD *)v11, v21, v4, *(_DWORD *)v5, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v13 <= v14 )
  {
    v15 = v14 + 1;
    *(_QWORD *)v11 = v14 + 1;
    ...
    LODWORD(v17) = sub_403ED0(v15);
    v18 = *(_DWORD *)v5;
    *(_QWORD *)(v11 + 8) = v17;
    v12 = v17;
    sub_401E90(v17, v15, v21, v4, v18, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v22;
  return v12;
}
...
_BYTE *__fastcall sub_4036E0(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  return sub_4030C0(0, a1, a2, (__int64)&v4);
}
...
int __fastcall sub_403930(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12@1
  __int64 v7; // rbx@1
  char *v8; // rax@3
...
int __fastcall sub_403D30(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v5; // r9@1
  __int64 *v6; // r10@2
  __int64 v7; // rax@2
  ...
  do
  {
    ...
    if ( *(_DWORD *)a5 <= 0x2Fu )
    {
      ...
      *(_DWORD *)a5 = v8 + 8;
      ...
      v12[v5] = *v6;
      if ( !v7 )
        return sub_403930(a1, a2, a3, a4, (__int64)v12, v5);
      goto LABEL_3;
    }
    v9 = *(__int64 **)(a5 + 8);
    *(_QWORD *)(a5 + 8) = v9 + 1;
...
void *__fastcall sub_4040D0(const void *a1, size_t a2)
{
  void *v2; // rax@1
...
__int64 __fastcall sub_404160(__int64 a1, __int64 a2)
{
...
signed __int64 __fastcall sub_404240(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8, __int64 a9)
{
  const char *v9; // r14@1
  char *v10; // rbp@1
  size_t v11; // r13@5
...
__int64 __fastcall sub_404860(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8)
{
  int v8; // er13@1
  signed int v9; // eax@2
  int v10; // ebp@2
    ...
    if ( *(_BYTE *)v21 == 45 )
    {
      ...
      if ( v36 )
      {
        if ( v53 )
        {
          ...
          {
            *(_QWORD *)(a7 + 32) = v21 + 2;
            v40 = sub_404240(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"--");
            goto LABEL_72;
          }
          if ( a6 )
          {
            ...
            {
              *(_QWORD *)(a7 + 32) = v21 + 1;
              v26 = sub_404240(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"-");
              if ( v26 != -1 )
...
LABEL_71:
        *(_QWORD *)(a7 + 32) = v28;
        *(_QWORD *)(a7 + 16) = 0LL;
        v40 = sub_404240(v10, v11, v12, v53, v54, 0, a7, v8, (__int64)"-W ");
LABEL_72:
        return v40;
      }
      v39 = *(_DWORD *)a7;
...
__int64 __fastcall sub_404E30(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax@1

  dword_6093E0 = dword_60923C;
  dword_6093E4 = dword_609238;
  result = sub_404860(a1, a2, a3, a4, a5, a6, (__int64)&dword_6093E0, a7);
...
__int64 __fastcall sub_404EB0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5)
{
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_405010(0LL, v6) )
  {
    v4 = 1LL;
...
int __fastcall sub_4055E0(FILE *stream)
{
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_405660(stream) )
  {
...
int __fastcall sub_405660(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_4056A0(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
int __fastcall sub_405770(__int64 a1)
{
  __int64 v1; // rdx@1
