...
LABEL_42:
  v8 = (_DWORD)v3 != -1;
  if ( (unsigned __int8)v3 & 0x20 && v8 )
    sub_401A80("unknown");
  if ( (unsigned __int8)v3 & 0x40 && v8 )
    sub_401A80("unknown");
...
int __fastcall sub_401A80(const char *a1)
{
  char *v1; // rax@2
...
void __fastcall __noreturn sub_401AD0(int status)
{
  ...
  char *v23; // rax@18
  char *v24; // rax@20
  const char *v25; // [sp+0h] [bp-88h]@6
  const char *v26; // [sp+8h] [bp-80h]@8
  const char *v27; // [sp+10h] [bp-78h]@8
  const char *v28; // [sp+18h] [bp-70h]@8
  const char *v29; // [sp+20h] [bp-68h]@8
  const char *v30; // [sp+28h] [bp-60h]@8
  const char *v31; // [sp+30h] [bp-58h]@8
  const char *v32; // [sp+38h] [bp-50h]@8
  const char *v33; // [sp+40h] [bp-48h]@8
  const char *v34; // [sp+48h] [bp-40h]@8
  const char *v35; // [sp+50h] [bp-38h]@8
  const char *v36; // [sp+58h] [bp-30h]@8
  __int64 v37; // [sp+60h] [bp-28h]@8
  __int64 v38; // [sp+68h] [bp-20h]@8
...
__int64 sub_401E20()
{
  ...
  if ( (unsigned int)sub_405180(stdout) )
  {
    ...
    if ( !byte_6092A0 || *v0 != 32 )
    {
      ...
      if ( qword_6092A8 )
      {
        LODWORD(v5) = sub_403930(qword_6092A8, "write error");
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_405100((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_403290(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_609250 <= a1 )
  {
    ...
    {
      LODWORD(v10) = sub_404100(off_609238, v9);
      off_609238 = v10;
      v7 = v10;
    }
  ...
  v23 = *(_DWORD *)(v5 + 4) | 1;
  v13 = *(_QWORD *)v11;
  v14 = sub_402060(v12, *(_QWORD *)v11, v21, v4, *(_DWORD *)v5, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v13 <= v14 )
  {
    v15 = v14 + 1;
    *(_QWORD *)v11 = v14 + 1;
    ...
    LODWORD(v17) = sub_4040A0(v15);
    v18 = *(_DWORD *)v5;
    *(_QWORD *)(v11 + 8) = v17;
    v12 = v17;
    sub_402060(v17, v15, v21, v4, v18, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v22;
  return v12;
}
...
_BYTE *__fastcall sub_4038B0(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  return sub_403290(0, a1, a2, (__int64)&v4);
}
...
int __fastcall sub_403B00(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12@1
  __int64 v7; // rbx@1
  char *v8; // rax@3
...
int __fastcall sub_403F60(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  char *v7; // r10@1
  signed int v8; // er8@1
  __int64 v9; // r9@1
  ...
  do
  {
    if ( (unsigned int)v8 <= 0x2F )
    {
      ...
      v15[v9] = v11;
      if ( !v11 )
        return sub_403B00(a1, a2, a3, a4, (__int64)v15, v9);
      goto LABEL_3;
    }
    v12 = (__int64 *)v7;
    v7 += 8;
...
void *__fastcall sub_4042A0(const void *a1, size_t a2)
{
  void *v2; // rax@1
...
__int64 __fastcall sub_404330(__int64 a1, __int64 a2)
{
...
signed __int64 __fastcall sub_404410(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8, __int64 a9)
{
  const char *v9; // r14@1
  char *v10; // rbp@1
  size_t v11; // r13@5
...
__int64 __fastcall sub_404A30(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8)
{
  int v8; // er13@1
  signed int v9; // eax@2
  int v10; // ebp@2
    ...
    if ( *(_BYTE *)v21 == 45 )
    {
      ...
      if ( v36 )
      {
        if ( v53 )
        {
          ...
          {
            *(_QWORD *)(a7 + 32) = v21 + 2;
            v40 = sub_404410(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"--");
            goto LABEL_72;
          }
          if ( a6 )
          {
            ...
            {
              *(_QWORD *)(a7 + 32) = v21 + 1;
              v26 = sub_404410(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"-");
              if ( v26 != -1 )
...
LABEL_71:
        *(_QWORD *)(a7 + 32) = v28;
        *(_QWORD *)(a7 + 16) = 0LL;
        v40 = sub_404410(v10, v11, v12, v53, v54, 0, a7, v8, (__int64)"-W ");
LABEL_72:
        return v40;
      }
      v39 = *(_DWORD *)a7;
...
__int64 __fastcall sub_405000(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax@1

  dword_609400 = dword_60925C;
  dword_609404 = dword_609258;
  result = sub_404A30(a1, a2, a3, a4, a5, a6, (__int64)&dword_609400, a7);
...
__int64 __fastcall sub_405080(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5)
{
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_4051E0(0LL, v6) )
  {
    v4 = 1LL;
...
int __fastcall sub_4057B0(FILE *stream)
{
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_405830(stream) )
  {
...
int __fastcall sub_405830(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_405870(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
int __fastcall sub_405940(__int64 a1)
{
  __int64 v1; // rdx@1
