signed __int64 __usercall main@<rax>(char **a1@<rsi>, char **a2@<rdx>, int a3@<edi>, signed __int64 a4@<r13>)
{
  int v4; // ebp@1
  char *v5; // rdi@4
  int v6; // eax@6
...
char *__usercall sub_4047E0@<rax>(bool a1@<cf>, bool a2@<zf>, char *a3@<rdi>)
{
  char *result; // rax@1
...
signed __int64 __usercall sub_405090@<rax>(signed int a1@<ebx>, int a2@<edi>, __int64 a3@<rsi>)
{
  __int64 v3; // rdx@2
  __int64 v4; // rcx@2
  int *v5; // rbp@2
