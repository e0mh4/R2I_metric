__int64 __fastcall main(int a1, char **a2, char **a3)
{
  ...
  sub_4056B0(
    ...
    "/home/dongkwan/data/scripts/gnu_packages/coreutils/coreutils-8.29_gcc-8.2.0_x86_64_O2_debug/gogo/share/locale");
  sub_401B20(a1);
  if ( sub_404DF0((unsigned int)a1, a2, "", &unk_4059E0, 0LL) != -1 )
LABEL_5:
    sub_401790(1);
  if ( dword_60823C < a1 )
  {
    LODWORD(v5) = sub_403850(a2[dword_60823C], a2, "Jim Meyering");
    v6 = v5;
...
int sub_401731()
{
  ...
  if ( !byte_608268 )
  {
    while ( qword_608270 < (unsigned __int64)(((&unk_607E48 - (_UNKNOWN *)&qword_607E40) >> 3) - 1) )
      (*(&qword_607E40 + ++qword_608270))();
    result = sub_4016DB();
    byte_608268 = 1;
  }
  return result;
...
void __fastcall __noreturn sub_401790(int status)
{
  ...
  char *v22; // rax@17
  char *v23; // rax@19
  const char *v24; // [sp+0h] [bp-88h]@4
  const char *v25; // [sp+8h] [bp-80h]@4
  const char *v26; // [sp+10h] [bp-78h]@4
  const char *v27; // [sp+18h] [bp-70h]@4
  const char *v28; // [sp+20h] [bp-68h]@4
  const char *v29; // [sp+28h] [bp-60h]@4
  const char *v30; // [sp+30h] [bp-58h]@4
  const char *v31; // [sp+38h] [bp-50h]@4
  const char *v32; // [sp+40h] [bp-48h]@4
  const char *v33; // [sp+48h] [bp-40h]@4
  const char *v34; // [sp+50h] [bp-38h]@4
  const char *v35; // [sp+58h] [bp-30h]@4
  __int64 v36; // [sp+60h] [bp-28h]@4
  __int64 v37; // [sp+68h] [bp-20h]@4
  ...
  {
    v16 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v16, &unk_405781);
    v17 = setlocale(5, 0LL);
  ...
  {
    v20 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v20, &unk_405781);
    v21 = setlocale(5, 0LL);
...
__int64 sub_401A80()
{
  ...
  if ( (unsigned int)sub_404EF0(stdout) )
  {
    ...
    if ( !byte_608278 || *v0 != 32 )
    {
      ...
      if ( qword_608280 )
      {
        LODWORD(v5) = sub_4036A0(qword_608280, "write error");
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_404E70((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_403000(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_608230 <= a1 )
  {
    ...
    {
      LODWORD(v20) = sub_403E70(0LL, v9);
      v7 = v20;
      off_608218 = v20;
      *v20 = (__int128)_mm_load_si128((const __m128i *)&xmmword_608220);
    }
    else
    {
      LODWORD(v10) = sub_403E70(off_608218, v9);
      off_608218 = v10;
      v7 = v10;
    }
  ...
  v23 = *(_DWORD *)(v5 + 4) | 1;
  v13 = *(_QWORD *)v11;
  v14 = sub_401DD0(v12, *(_QWORD *)v11, v21, v4, *(_DWORD *)v5, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v13 <= v14 )
  {
    v15 = v14 + 1;
    *(_QWORD *)v11 = v14 + 1;
    if ( (_UNKNOWN *)v12 != &unk_6082A0 )
    {
      v16 = v14 + 1;
      free(v12);
      v15 = v16;
    }
    LODWORD(v17) = sub_403E10(v15);
    v18 = *(_DWORD *)v5;
    *(_QWORD *)(v11 + 8) = v17;
    v12 = v17;
    sub_401DD0(v17, v15, v21, v4, v18, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v22;
  return v12;
}
...
_BYTE *__fastcall sub_403620(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  v7 = qword_6083D0;
  v4 = _mm_load_si128((const __m128i *)&xmmword_6083A0);
  v5 = _mm_load_si128((const __m128i *)&xmmword_6083B0);
  v6 = _mm_load_si128((const __m128i *)&xmmword_6083C0);
  v4.m128i_i32[(a3 >> 5) + 2] ^= (~(unsigned __int8)((unsigned __int32)v4.m128i_i32[(a3 >> 5) + 2] >> (a3 & 0x1F)) & 1) << (a3 & 0x1F);
  return sub_403000(0, a1, a2, (__int64)&v4);
}
...
int __fastcall sub_403870(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12@1
  __int64 v7; // rbx@1
  char *v8; // rax@3
...
int __fastcall sub_403C70(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v5; // r9@1
  __int64 *v6; // r10@2
  __int64 v7; // rax@2
  ...
  do
  {
    ...
    if ( *(_DWORD *)a5 <= 0x2Fu )
    {
      ...
      *(_DWORD *)a5 = v8 + 8;
      ...
      v12[v5] = *v6;
      if ( !v7 )
        return sub_403870(a1, a2, a3, a4, (__int64)v12, v5);
      goto LABEL_3;
    }
    v9 = *(__int64 **)(a5 + 8);
    *(_QWORD *)(a5 + 8) = v9 + 1;
...
__int64 __fastcall sub_4040A0(__int64 a1, __int64 a2)
{
...
signed __int64 __fastcall sub_404180(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8, __int64 a9)
{
  const char *v9; // r14@1
  char *v10; // rbp@1
  size_t v11; // r13@5
...
__int64 __fastcall sub_4047A0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8)
{
  int v8; // er13@1
  signed int v9; // eax@2
  int v10; // ebp@2
    ...
    if ( *(_BYTE *)v21 == 45 )
    {
      ...
      if ( v36 )
      {
        if ( v53 )
        {
          ...
          {
            *(_QWORD *)(a7 + 32) = v21 + 2;
            v40 = sub_404180(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"--");
            goto LABEL_72;
          }
          if ( a6 )
          {
            ...
            {
              *(_QWORD *)(a7 + 32) = v21 + 1;
              v26 = sub_404180(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"-");
              if ( v26 != -1 )
...
LABEL_71:
        *(_QWORD *)(a7 + 32) = v28;
        *(_QWORD *)(a7 + 16) = 0LL;
        v40 = sub_404180(v10, v11, v12, v53, v54, 0, a7, v8, (__int64)"-W ");
LABEL_72:
        return v40;
      }
      v39 = *(_DWORD *)a7;
...
__int64 __fastcall sub_404D70(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax@1

  dword_6083E0 = dword_60823C;
  dword_6083E4 = dword_608238;
  result = sub_4047A0(a1, a2, a3, a4, a5, a6, (__int64)&dword_6083E0, a7);
...
__int64 __fastcall sub_404DF0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5)
{
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_404F50(0LL, v6) )
  {
    v4 = 1LL;
...
int __fastcall sub_405520(FILE *stream)
{
  ...
  if ( fileno(stream) < 0
    ...
    || !(unsigned int)sub_4055A0(stream) )
  {
...
int __fastcall sub_4056B0(__int64 a1)
{
  __int64 v1; // rdx@1
