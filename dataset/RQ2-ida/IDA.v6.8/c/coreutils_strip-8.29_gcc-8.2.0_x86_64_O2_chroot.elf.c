__int64 __fastcall main(int a1, char **a2, char **a3)
{
  ...
  __int64 v35; // rbx@56
  char *v36; // rax@56
  char *ptr; // [sp+8h] [bp-60h]@19
  __gid_t *groups; // [sp+18h] [bp-50h]@1
  size_t n; // [sp+20h] [bp-48h]@1
  void *v40; // [sp+28h] [bp-40h]@39
...
LABEL_38:
  if ( setgroups(n, v25) )
  {
    v31 = dcgettext(0LL, "failed to set supplemental groups", 5);
    v32 = __errno_location();
    error(125, *v32, v31);
    v33 = dcgettext(0LL, "failed to set user-ID", 5);
    error(125, *v5, v33);
LABEL_56:
    LODWORD(v34) = sub_4043A0(4LL, "/");
    v35 = v34;
    v36 = dcgettext(0LL, "option --skip-chdir only permitted if NEWROOT is old %s", 5);
    error(0, 0, v36, v35);
    sub_402580(125);
  }
LABEL_39:
  ...
  execvp(*(const char **)v7, (char *const *__attribute__((__org_arrdim(0,0))) )v7);
  v19 = *v18 == 2;
  LODWORD(v20) = sub_4045F0(*(_QWORD *)v7, v7);
  v21 = v19 + 126;
  v22 = v20;
  v23 = dcgettext(0LL, "failed to run command %s", 5);
  error(0, *v18, v23, v22);
...
__int64 __fastcall sub_402360(__int64 a1, _QWORD *a2, _QWORD *a3, char a4)
{
  char *v4; // rax@1
  const char *v5; // rsi@1
  char *v6; // r14@1
  char *v7; // rax@1
  char *v8; // r15@2
  signed int v9; // er13@2
  __int64 v10; // rbx@2
  __int64 v11; // rbp@2
  struct group *v12; // rax@5
  const unsigned __int16 *v14; // rcx@17
  __int64 v15; // rdx@19
  __int64 v16; // rax@8
  __int64 v17; // rax@25
  __int64 v18; // r15@25
  char *v19; // r13@25
  int *v20; // rax@25
  const char *v21; // rdx@25
  __int64 v22; // rax@28
  __int64 v23; // rbx@28
  char *v24; // rax@28
  _QWORD *v25; // [sp+0h] [bp-68h]@1
  _QWORD *v26; // [sp+8h] [bp-60h]@1
  char v27; // [sp+1Bh] [bp-4Dh]@1
  char v28; // [sp+1Ch] [bp-4Ch]@1
  __int64 v29; // [sp+20h] [bp-48h]@1
  unsigned __int64 v30; // [sp+28h] [bp-40h]@4
  ...
  do
  {
    if ( !(unsigned int)sub_405250(v8) && v30 <= 0xFFFFFFFF )
    {
      v14 = *__ctype_b_loc();
      while ( 1 )
      {
        v15 = (unsigned __int8)*v8;
        if ( !(HIBYTE(v14[v15]) & 0x20) )
          break;
        ++v8;
      }
      if ( (_BYTE)v15 != 43 )
...
LABEL_6:
      ...
      if ( v29 == v10 )
      {
        LODWORD(v16) = sub_405060(v11, &v29, 4LL);
        v11 = v16;
      }
      *(_DWORD *)(v11 + 4 * v10++) = v30;
      goto LABEL_10;
    }
    v12 = getgrnam(v8);
    if ( v12 )
    ...
    if ( !v27 )
      goto LABEL_15;
    LODWORD(v17) = sub_4045F0(v8, 0LL);
    v18 = v17;
    v19 = dcgettext(0LL, "invalid group %s", 5);
    v20 = __errno_location();
    v21 = v19;
    v9 = -1;
    error(0, *v20, v21, v18, v25);
LABEL_10:
    v5 = ",";
    v8 = strtok(0LL, ",");
  }
...
LABEL_27:
    if ( v28 )
    {
      LODWORD(v22) = sub_4045F0(a1, v5);
      v23 = v22;
      v24 = dcgettext(0LL, "invalid group list %s", 5);
      error(0, 0, v24, v23, v25);
    }
LABEL_15:
    v9 = -1;
    *v25 = v11;
...
void __fastcall __noreturn sub_402580(int status)
{
  ...
  v4 = dcgettext(0LL, "Usage: %s [OPTION] NEWROOT [COMMAND [ARG]...]\n  or:  %s OPTION\n", 5);
  __printf_chk(1LL, v4, v2, v2);
  v5 = stdout;
  v6 = dcgettext(0LL, "Run COMMAND with root directory set to NEWROOT.\n\n", 5);
  fputs_unlocked(v6, v5);
  v7 = stdout;
  v8 = dcgettext(0LL, "  --groups=G_LIST        specify supplementary groups as g1,g2,..,gN\n", 5);
  fputs_unlocked(v8, v7);
  v9 = stdout;
  v10 = dcgettext(0LL, "  --userspec=USER:GROUP  specify user and group (ID or name) to use\n", 5);
  fputs_unlocked(v10, v9);
  LODWORD(v11) = sub_4043A0(4LL, "/");
  v12 = v11;
  v13 = dcgettext(0LL, "  --skip-chdir           do not change working directory to %s\n", 5);
  __printf_chk(1LL, v13, v12, v14);
  v15 = stdout;
  ...
  {
    v28 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v28, &unk_40702A, "https://www.gnu.org/software/coreutils/");
    v29 = setlocale(5, 0LL);
  ...
  {
    v33 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v33, &unk_40702A, "https://www.gnu.org/software/coreutils/");
    v34 = setlocale(5, 0LL);
    if ( !v34 || !strncmp(v34, "en_", 3uLL) )
    {
      ...
      __printf_chk(1LL, v35, "https://www.gnu.org/software/coreutils/", "chroot");
LABEL_15:
...
LABEL_3:
  ...
  __printf_chk(1LL, v36, "chroot", v37);
LABEL_13:
  v30 = "Multi-call invocation" + 10;
  v31 = dcgettext(0LL, "Full documentation at: <%s%s>\n", 5);
  __printf_chk(1LL, v31, "https://www.gnu.org/software/coreutils/", "chroot");
  if ( v27 != "chroot" )
    v30 = "";
  goto LABEL_15;
}
...
__int64 sub_402930()
{
  ...
  if ( (unsigned int)sub_4064D0(stdout) )
  {
    ...
    if ( !byte_60B2F8 || *v0 != 32 )
    {
      ...
      if ( qword_60B300 )
      {
        LODWORD(v5) = sub_404440(qword_60B300, "write error");
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_406450((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_403DA0(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_60B2B0 <= a1 )
  {
    ...
    {
      LODWORD(v10) = sub_404FF0(off_60B298, v9);
      off_60B298 = v10;
      v7 = v10;
    }
  ...
  v23 = *(_DWORD *)(v5 + 4) | 1;
  v13 = *(_QWORD *)v11;
  v14 = sub_402B70(v12, *(_QWORD *)v11, v21, v4, *(_DWORD *)v5, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v13 <= v14 )
  {
    v15 = v14 + 1;
    *(_QWORD *)v11 = v14 + 1;
    ...
    LODWORD(v17) = sub_404F90(v15);
    v18 = *(_DWORD *)v5;
    *(_QWORD *)(v11 + 8) = v17;
    v12 = v17;
    sub_402B70(v17, v15, v21, v4, v18, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v22;
  return v12;
}
...
_BYTE *__fastcall sub_4043C0(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  return sub_403DA0(0, a1, a2, (__int64)&v4);
}
...
char *__fastcall sub_404610(__int64 *a1, __int64 *a2, _DWORD *a3, signed int *a4, char **a5, const char **a6)
{
  __int64 *v6; // r10@1
  ...
  char *v29; // rax@49
  int v30; // [sp+Ch] [bp-6Ch]@1
  _DWORD *v31; // [sp+10h] [bp-68h]@1
  __int64 *v32; // [sp+18h] [bp-60h]@22
  unsigned __int64 v33; // [sp+20h] [bp-58h]@30
...
LABEL_40:
  ...
  a2 = (__int64 *)(v11 + 1);
  v32 = v6;
  LODWORD(v17) = sub_405190(a1, v11 + 1);
  v18 = v32;
  v17[v11] = 0;
  v13 = v17;
  if ( !*((_BYTE *)v32 + 1) )
...
LABEL_36:
      ...
      a2 = 0LL;
      if ( (unsigned int)sub_405250(v13) || (v30 = v33, v33 > 0xFFFFFFFE) )
      {
        endpwent();
        v22 = "invalid user";
        v24 = 0LL;
...
LABEL_25:
    ...
    if ( v21 )
    {
      ...
      if ( v19 )
      {
        ...
        {
          a2 = (__int64 *)&v33;
          LODWORD(v29) = sub_406590((unsigned int)v7, &v33);
          v27 = v29;
        }
        LODWORD(v28) = sub_4051C0(v27, a2);
        v12 = v28;
        endgrent();
        endpwent();
        goto LABEL_15;
...
LABEL_29:
        a2 = 0LL;
        if ( !(unsigned int)sub_405250((char *)v12) )
        {
          v7 = v33;
          if ( v33 <= 0xFFFFFFFE )
            goto LABEL_14;
        ...
        endgrent();
        v22 = "invalid group";
        LODWORD(v23) = sub_4051C0(v12, 0LL);
        v24 = v23;
LABEL_38:
        free(v13);
        free(v24);
...
char *__fastcall sub_404920(char *s, _DWORD *a2, signed int *a3, char **a4, const char **a5)
{
  const char **v5; // r13@2
  char **v6; // r12@2
  signed int *v7; // rbp@2
  ...
  if ( a3 )
  {
    ...
    v9 = v8;
    v10 = sub_404610((__int64 *)s, v8, a2, v7, v6, v5);
    v11 = v10;
    if ( !v9 )
    {
      v15 = v10;
      if ( !v10
        ...
        && (v13 = sub_404610((__int64 *)s, v12, a2, v7, v6, v5), v11 = v15, !v13) )
      {
        v11 = 0LL;
      }
    }
  ...
  {
    result = sub_404610((__int64 *)s, 0LL, a2, 0LL, a4, a5);
  }
  return result;
}

int __fastcall sub_4049F0(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12@1
  __int64 v7; // rbx@1
  char *v8; // rax@3
...
int __fastcall sub_404E50(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  char *v7; // r10@1
  signed int v8; // er8@1
  __int64 v9; // r9@1
  ...
  do
  {
    if ( (unsigned int)v8 <= 0x2F )
    {
      ...
      v15[v9] = v11;
      if ( !v11 )
        return sub_4049F0(a1, a2, a3, a4, (__int64)v15, v9);
      goto LABEL_3;
    }
    v12 = (__int64 *)v7;
    v7 += 8;
...
void *__fastcall sub_405190(const void *a1, size_t a2)
{
  void *v2; // rax@1
...
void *__fastcall sub_4051C0(const char *a1)
{
  size_t v1; // rax@1

  v1 = strlen(a1);
  return sub_405190(a1, v1 + 1);
}
...
__int64 __fastcall sub_405680(__int64 a1, __int64 a2)
{
...
signed __int64 __fastcall sub_405760(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8, __int64 a9)
{
  const char *v9; // r14@1
  char *v10; // rbp@1
  size_t v11; // r13@5
...
__int64 __fastcall sub_405D80(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8)
{
  int v8; // er13@1
  signed int v9; // eax@2
  int v10; // ebp@2
    ...
    if ( *(_BYTE *)v21 == 45 )
    {
      ...
      if ( v36 )
      {
        if ( v53 )
        {
          ...
          {
            *(_QWORD *)(a7 + 32) = v21 + 2;
            v40 = sub_405760(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"--");
            goto LABEL_72;
          }
          if ( a6 )
          {
            ...
            {
              *(_QWORD *)(a7 + 32) = v21 + 1;
              v26 = sub_405760(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"-");
              if ( v26 != -1 )
...
LABEL_71:
        *(_QWORD *)(a7 + 32) = v28;
        *(_QWORD *)(a7 + 16) = 0LL;
        v40 = sub_405760(v10, v11, v12, v53, v54, 0, a7, v8, (__int64)"-W ");
LABEL_72:
        return v40;
      }
      v39 = *(_DWORD *)a7;
...
__int64 __fastcall sub_406350(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax@1

  dword_60B460 = dword_60B2BC;
  dword_60B464 = dword_60B2B8;
  result = sub_405D80(a1, a2, a3, a4, a5, a6, (__int64)&dword_60B460, a7);
...
__int64 __fastcall sub_4063D0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5)
{
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_406530(0LL, v6) )
  {
    v4 = 1LL;
...
signed __int64 __fastcall sub_406590(unsigned __int64 a1, __int64 a2)
{
...
int __fastcall sub_406B90(char *user, __gid_t group, _QWORD *a3)
{
  _QWORD *v3; // r13@1
  __gid_t v4; // er12@1
  void *v5; // rbx@2
  ...
  if ( user )
  {
    ...
    while ( 1 )
    {
      ...
      v13 = sub_406B50(v5, v12);
      if ( !v13 )
        goto LABEL_5;
      v5 = v13;
    }
    v7 = sub_406B50(v5, ngroups);
    if ( v7 )
    {
      *v3 = v7;
      return ngroups;
...
int __fastcall sub_406DA0(FILE *stream)
{
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_406E20(stream) )
  {
...
int __fastcall sub_406E20(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_406E60(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
int __fastcall sub_406F30(__int64 a1)
{
  __int64 v1; // rdx@1
