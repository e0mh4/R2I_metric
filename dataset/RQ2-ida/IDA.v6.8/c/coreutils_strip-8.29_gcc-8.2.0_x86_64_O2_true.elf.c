...
void __fastcall __noreturn sub_4015A0(int status)
{
  int v1; // ebp@1
  __int64 v2; // rbx@1
  char *v3; // rax@1
  ...
  {
    v19 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v19, &unk_4046E4, "https://www.gnu.org/software/coreutils/");
    v20 = setlocale(5, 0LL);
...
LABEL_11:
      ...
      __printf_chk(1LL, v22, "https://www.gnu.org/software/coreutils/", "true");
      if ( v18 != "true" )
        v21 = 4212333LL;
LABEL_13:
  ...
  {
    v24 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v24, &unk_4046E4, "https://www.gnu.org/software/coreutils/");
    v25 = setlocale(5, 0LL);
    if ( !v25 || !strncmp(v25, "en_", 3uLL) )
    {
      ...
      v21 = 4212362LL;
      __printf_chk(1LL, v28, "https://www.gnu.org/software/coreutils/", "true");
      goto LABEL_13;
    }
    v18 = "true";
  }
  v26 = dcgettext(0LL, "Report %s translation bugs to <https://translationproject.org/team/>\n", 5);
  __printf_chk(1LL, v26, "true", v27);
  goto LABEL_11;
}
...
__int64 sub_4018B0()
{
  ...
  if ( (unsigned int)sub_403E40(stdout) )
  {
    ...
    if ( !byte_607238 || *v0 != 32 )
    {
      ...
      if ( qword_607240 )
      {
        LODWORD(v5) = sub_4033C0(qword_607240, "write error");
...
unsigned __int64 __fastcall sub_401AF0(_BYTE *a1, unsigned __int64 a2, char *a3, unsigned __int64 a4, int a5, char a6, __int64 a7, const char *a8, char *a9)
{
  _BYTE *v9; // r15@1
...
LABEL_4:
        ...
        if ( !(_BYTE)v11 )
        {
          ...
          v44 = v43 == 2;
          if ( !v16 && v44 && v82 )
            return sub_401AF0((__int64)v9, v10, s);
          v45 = !v82 && v44;
          if ( v45 )
          {
            if ( v83 )
            {
              if ( v70 )
                return sub_401AF0((__int64)v9, v79, s);
              v46 = v79 != 0 && v10 == 0;
              if ( v46 )
              {
                v10 = v79;
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_403DC0((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_402D20(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_6071F0 <= a1 )
  {
    ...
    {
      LODWORD(v10) = sub_403B90(off_6071D8, v9);
      off_6071D8 = v10;
      v7 = v10;
    }
  ...
  if ( v13 <= v14 )
  {
    ...
    *(_QWORD *)v11 = v14 + 1;
    ...
    LODWORD(v17) = sub_403B30(v15);
    v18 = *(_DWORD *)v5;
    *(_QWORD *)(v11 + 8) = v17;
    v12 = v17;
    sub_401AF0(v17, v15, v21, v4, v18, v23, v5 + 8, *(const char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v22;
  return v12;
}
...
_BYTE *__fastcall sub_403340(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  return sub_402D20(0, a1, a2, (__int64)&v4);
}

_BYTE *__fastcall sub_4033C0(char *a1)
{
  return sub_403340(a1, 0xFFFFFFFFFFFFFFFFLL, 0x3Au);
}

int __fastcall sub_403590(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12@1
  __int64 v7; // rbx@1
  char *v8; // rax@3
...
int __fastcall sub_4039F0(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  char *v7; // r10@1
  signed int v8; // er8@1
  __int64 v9; // r9@1
  ...
  do
  {
    if ( (unsigned int)v8 <= 0x2F )
    {
      ...
      v15[v9] = v11;
      if ( !v11 )
        return sub_403590(a1, a2, a3, a4, (__int64)v15, v9);
      goto LABEL_3;
    }
    v12 = (__int64 *)v7;
    v7 += 8;
...
void *__fastcall sub_403D30(const void *a1, size_t a2)
{
  void *v2; // rax@1
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_403EA0(0LL, v6) )
  {
    v4 = 1LL;
...
int __fastcall sub_404470(FILE *stream)
{
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_4044F0(stream) )
  {
...
int __fastcall sub_4044F0(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_404530(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
int __fastcall sub_404600(__int64 a1)
{
  __int64 v1; // rdx@1
