...
signed int sub_401551()
{
  signed int result; // eax@4

  if ( !byte_607228 )
  {
    while ( qword_607230 < (unsigned __int64)(((&unk_606E48 - (_UNKNOWN *)&qword_606E40) >> 3) - 1) )
      (*(&qword_606E40 + ++qword_607230))();
    result = sub_4014FB();
    byte_607228 = 1;
  }
  return result;
...
void __fastcall __noreturn sub_4015B0(int status)
{
  ...
  char *v10; // rax@1
  __int64 v11; // rcx@1
  const char *v12; // rdi@1
  __int64 *v13; // rax@1
  bool v14; // cf@3
  bool v15; // zf@3
  const char *v16; // rsi@4
  signed __int64 v17; // rcx@4
  char *v18; // rbx@8
  char *v19; // rax@9
  char *v20; // rax@9
  signed __int64 v21; // r12@11
  char *v22; // rax@11
  char *v23; // rax@13
  char *v24; // rax@15
  char *v25; // rax@15
  ...
  __int64 v27; // rcx@18
  char *v28; // rax@19
  const char *v29; // [sp+0h] [bp-88h]@1
  const char *v30; // [sp+8h] [bp-80h]@1
  const char *v31; // [sp+10h] [bp-78h]@1
  const char *v32; // [sp+18h] [bp-70h]@1
  const char *v33; // [sp+20h] [bp-68h]@1
  const char *v34; // [sp+28h] [bp-60h]@1
  const char *v35; // [sp+30h] [bp-58h]@1
  const char *v36; // [sp+38h] [bp-50h]@1
  const char *v37; // [sp+40h] [bp-48h]@1
  const char *v38; // [sp+48h] [bp-40h]@1
  const char *v39; // [sp+50h] [bp-38h]@1
  const char *v40; // [sp+58h] [bp-30h]@1
  __int64 v41; // [sp+60h] [bp-28h]@1
  __int64 v42; // [sp+68h] [bp-20h]@1
  ...
  while ( 1 )
  {
    ...
    do
    {
      if ( !v17 )
        break;
      v14 = (const unsigned __int8)*v16 < *v12;
      v15 = *v16++ == *v12++;
      --v17;
    }
    while ( v15 );
    if ( (!v14 && !v15) == v14 )
      break;
    v12 = (const char *)v13[2];
  }
  v18 = (char *)v13[1];
  if ( v18 )
  {
    v19 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v19, &unk_4046E5, "https://www.gnu.org/software/coreutils/");
    v20 = setlocale(5, 0LL);
...
LABEL_11:
      ...
      __printf_chk(1LL, v22, "https://www.gnu.org/software/coreutils/", "false");
      if ( v18 != "false" )
        v21 = 4212334LL;
LABEL_13:
  ...
  {
    v24 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v24, &unk_4046E5, "https://www.gnu.org/software/coreutils/");
    v25 = setlocale(5, 0LL);
    if ( !v25 || !strncmp(v25, "en_", 3uLL) )
    {
      ...
      v21 = 4212363LL;
      __printf_chk(1LL, v28, "https://www.gnu.org/software/coreutils/", "false");
      goto LABEL_13;
    }
    v18 = "false";
  }
  v26 = dcgettext(0LL, "Report %s translation bugs to <https://translationproject.org/team/>\n", 5);
  __printf_chk(1LL, v26, "false", v27);
  goto LABEL_11;
}
...
__int64 sub_4018C0()
{
  ...
  if ( (unsigned int)sub_403E50(stdout) )
  {
    ...
    if ( !byte_607238 || *v0 != 32 )
    {
      ...
      if ( qword_607240 )
      {
        LODWORD(v5) = sub_4033D0(qword_607240, "write error");
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_403DD0((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_402D30(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_6071F0 <= a1 )
  {
    ...
    {
      LODWORD(v20) = sub_403BA0(0LL, v9);
      v7 = v20;
      off_6071D8 = v20;
      *v20 = (__int128)_mm_load_si128((const __m128i *)&xmmword_6071E0);
    }
    else
    {
      LODWORD(v10) = sub_403BA0(off_6071D8, v9);
      off_6071D8 = v10;
      v7 = v10;
    }
  ...
  if ( v13 <= v14 )
  {
    v15 = v14 + 1;
    *(_QWORD *)v11 = v14 + 1;
    if ( (_UNKNOWN *)v12 != &unk_607260 )
    {
      v16 = v14 + 1;
      free(v12);
      v15 = v16;
    }
    LODWORD(v17) = sub_403B40(v15);
    v18 = *(_DWORD *)v5;
    *(_QWORD *)(v11 + 8) = v17;
    v12 = v17;
    sub_401B00(v17, v15, v21, v4, v18, v23, v5 + 8, *(const char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v22;
  return v12;
}
...
_BYTE *__fastcall sub_403350(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  v7 = qword_607390;
  v4 = _mm_load_si128((const __m128i *)&xmmword_607360);
  v5 = _mm_load_si128((const __m128i *)&xmmword_607370);
  v6 = _mm_load_si128((const __m128i *)&xmmword_607380);
  v4.m128i_i32[(a3 >> 5) + 2] ^= (~(unsigned __int8)((unsigned __int32)v4.m128i_i32[(a3 >> 5) + 2] >> (a3 & 0x1F)) & 1) << (a3 & 0x1F);
  return sub_402D30(0, a1, a2, (__int64)&v4);
}
...
int __fastcall sub_4035A0(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12@1
  __int64 v7; // rbx@1
  char *v8; // rax@3
...
int __fastcall sub_403A00(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  char *v7; // r10@1
  signed int v8; // er8@1
  __int64 v9; // r9@1
  ...
  do
  {
    if ( (unsigned int)v8 <= 0x2F )
    {
      ...
      v15[v9] = v11;
      if ( !v11 )
        return sub_4035A0(a1, a2, a3, a4, (__int64)v15, v9);
      goto LABEL_3;
    }
    v12 = (__int64 *)v7;
    v7 += 8;
...
void *__fastcall sub_403D40(const void *a1, size_t a2)
{
  void *v2; // rax@1
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_403EB0(0LL, v6) )
  {
    v4 = 1LL;
...
int __fastcall sub_404480(FILE *stream)
{
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_404500(stream) )
  {
...
int __fastcall sub_404500(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_404540(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
int __fastcall sub_404610(__int64 a1)
{
  __int64 v1; // rdx@1
