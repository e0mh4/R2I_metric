__int64 __fastcall main(unsigned int a1, char **a2, char **a3)
{
  ...
  __int64 v23; // rbx@62
  int *v24; // rax@62
  __int64 v25; // [sp+0h] [bp-48h]@35
  __int64 v26; // [sp+8h] [bp-40h]@35
...
LABEL_60:
  ...
  if ( byte_60A271 )
  {
    v26 = 0LL;
    v9 = dword_60A2FC;
    if ( sub_4065C0("/var/run/utmp", &v25, &v26, 0LL) )
    {
      LODWORD(v22) = sub_404C20(0LL, 3LL, "/var/run/utmp");
      v23 = v22;
...
LABEL_45:
  ...
  else
  {
    ...
    {
      v5 = &a2[dword_60A2FC];
      v6 = &(&a2[(unsigned int)(v4 - 1) + 1])[8 * (signed __int64)dword_60A2FC];
      do
      {
        v7 = *v5;
        ++v5;
...
int sub_4021B1()
{
  ...
  if ( !byte_60A328 )
  {
    while ( qword_60A330 < (unsigned __int64)(((&unk_609E48 - (_UNKNOWN *)&qword_609E40) >> 3) - 1) )
      (*(&qword_609E40 + ++qword_60A330))();
    result = sub_40215B();
    byte_60A328 = 1;
  }
  return result;
...
char *__fastcall sub_402210(const char *a1, const char *a2)
{
  const char *v2; // r13@1
  const char *v3; // rbp@1
  ...
  size_t v5; // rax@1
  const char *v6; // rdx@1
  signed __int64 v7; // r12@1
  char v8; // cl@2
  const char *v9; // rdi@5
  signed __int64 v10; // r12@5
  size_t v11; // rax@5
  signed __int64 v12; // rcx@5
  unsigned __int8 v13; // cf@5
  signed __int64 v14; // rax@5
  char *v15; // rax@9
  char *v16; // r12@9
  char v17; // al@9
  char *i; // rbx@9
  const unsigned __int16 **v19; // rax@14
  __int64 v20; // r14@14
  const char *v21; // rcx@14
  char v22; // dl@14
  const __int32_t **v23; // rax@15
  ...
  if ( v4 )
  {
    ...
    v11 = strlen(a2);
    v12 = v4 * v11;
    v13 = __CFADD__(v4 * v11, v10);
    v7 = v4 * v11 + v10;
    a2 = (const char *)v13;
    v6 = (const char *)1;
    v14 = v4 * (unsigned __int128)v11 >> 64 != 0;
    if ( v12 < 0 )
      v14 = 1LL;
    if ( v13 || v14 )
      sub_4055B0(v9);
  }
  LODWORD(v15) = sub_405360(v7, a2, v6);
  v16 = v15;
  v17 = *v2;
  for ( i = v16; *v2; v17 = *++v2 )
  {
...
int __fastcall sub_402340(const char *a1)
{
  ...
  {
    v36 = dcgettext(0LL, "???\n", 5);
    LODWORD(v11) = __printf_chk(1LL, " %s", v36);
...
LABEL_14:
    ...
    LODWORD(v20) = sub_405360(v18 + 10, v8, v19);
    v21 = v20;
    v22 = stpcpy(v20, v1->pw_dir);
    v8 = "r";
    *(_QWORD *)v22 = 7162247809296510511LL;
    *((_WORD *)v22 + 4) = 116;
    v23 = fopen(v21, "r");
    if ( v23 )
    {
      v24 = dcgettext(0LL, "Project: ", 5);
      __printf_chk(1LL, v24, v25);
      while ( 1 )
      {
        v8 = (char *)1;
        v26 = fread_unlocked(&v38, 1uLL, 0x400uLL, v23);
        if ( !v26 )
          break;
        fwrite_unlocked(&v38, 1uLL, v26, stdout);
      }
      sub_4055F0(v23);
    }
    free((void *)v21);
...
LABEL_8:
  ...
  {
LABEL_20:
    v27 = strlen(v1->pw_dir);
    LODWORD(v29) = sub_405360(v27 + 7, v8, v28);
    v30 = v29;
    v31 = stpcpy(v29, v1->pw_dir);
    *(_DWORD *)v31 = 1819291183;
    *((_WORD *)v31 + 2) = 28257;
    v31[6] = 0;
    v32 = fopen(v30, "r");
    if ( v32 )
    {
      v33 = dcgettext(0LL, "Plan:\n", 5);
      __printf_chk(1LL, v33, v34);
      while ( 1 )
      {
        v35 = fread_unlocked(&v38, 1uLL, 0x400uLL, v32);
        if ( !v35 )
          break;
        fwrite_unlocked(&v38, 1uLL, v35, stdout);
      }
      sub_4055F0(v32);
    }
    free((void *)v30);
...
int __fastcall sub_4026F0(__int64 a1)
{
  ...
  char v10; // dl@8
  char *v11; // rax@8
  struct passwd *v12; // rax@9
  struct passwd *v13; // rbx@9
  char *v14; // ST08_8@10
  char *v15; // rax@10
  const char *v16; // rdx@10
  char *v17; // rbx@12
  char *v18; // rdx@15
  struct tm *v19; // rax@17
  char *v20; // rdx@18
  char v21; // dl@20
  char *v22; // rax@21
  char *v23; // rcx@21
  unsigned __int64 v24; // rbp@21
  char *v25; // rax@24
  signed __int64 v26; // rbp@25
  char *v27; // rbx@26
  char *v28; // rax@31
  time_t v29; // rcx@38
  signed __int64 v30; // rcx@40
  char *v31; // rax@45
  char *v32; // rax@46
  char filename[4]; // [sp+10h] [bp-208h]@2
  __int16 v35; // [sp+14h] [bp-204h]@43
  struct stat stat_buf; // [sp+40h] [bp-1D8h]@5
  time_t name[41]; // [sp+D0h] [bp-148h]@8
...
LABEL_5:
  *v6 = 0;
  ...
  {
    v7 = stat_buf.st_atim.tv_sec;
    v8 = (stat_buf.st_mode & 0x10) < 1 ? 42 : 32;
  }
  v9 = (char *)(v1 + 44);
  ...
  if ( byte_60A275 )
  {
    ...
    *v11 = 0;
    ...
    if ( v12 )
    {
      ...
      v17 = sub_402210(v16, v13->pw_name);
      __printf_chk(1LL, " %-19.19s", v17);
      free(v17);
    }
    else
    {
      v32 = dcgettext(0LL, "        ???", 5);
      __printf_chk(1LL, " %19s", v32);
    }
  }
  __printf_chk(1LL, &unk_406E78, (unsigned int)v8);
  if ( byte_60A277 )
  {
    if ( v7 )
    {
      ...
      if ( v30 > 59 )
      {
        if ( v30 > 86399 )
        {
          __sprintf_chk(
            ...
            22LL,
            "%lud",
            ((signed __int64)((unsigned __int128)(1749024623285053783LL * v30) >> 64) >> 13) - (v30 >> 63));
          v18 = (char *)&unk_60A370;
        }
        else
        {
          __sprintf_chk(
            ...
            22LL,
            "%02d:%02d",
            ((signed __int64)((unsigned __int128)(5247073869855161349LL * v30) >> 64) >> 10) - (v30 >> 63));
          v18 = (char *)&unk_60A370;
        }
      }
    }
    ...
    __printf_chk(1LL, " %-6s", v18);
  }
  name[0] = *(_DWORD *)(v1 + 340);
  v19 = localtime(name);
  if ( v19 )
  {
    strftime(s, 0x21uLL, format, v19);
    v20 = s;
  }
  else
  {
    LODWORD(v31) = sub_4030E0(name[0], s);
    v20 = v31;
  }
  ...
  if ( byte_60A270 )
  {
    ...
    if ( v21 )
    {
      ...
      while ( *v22 );
      *v23 = 0;
      v25 = strchr((const char *)name, 58);
      if ( v25 )
      {
        *v25 = 0;
        v26 = (signed __int64)(v25 + 1);
        if ( !LOBYTE(name[0]) || (v27 = (char *)sub_402FA0((char *)name)) == 0LL )
          v27 = (char *)name;
        if ( v26 )
        {
          __printf_chk(1LL, " %s:%s", v27);
          goto LABEL_29;
        }
      }
      else if ( !LOBYTE(name[0]) || (v27 = (char *)sub_402FA0((char *)name)) == 0LL )
      {
        v27 = (char *)name;
      }
      __printf_chk(1LL, " %s", v27);
LABEL_29:
      if ( (time_t *)v27 != name )
        free(v27);
      goto LABEL_31;
...
LABEL_31:
  ...
  {
    LODWORD(v28) = __overflow(stdout, 10);
  }
  else
  {
...
void __fastcall __noreturn sub_402BD0(int status)
{
  ...
  bool v16; // cf@5
  bool v17; // zf@5
  const char *v18; // rsi@6
  signed __int64 v19; // rcx@6
  const char *v20; // rbp@10
  char *v21; // rax@11
  char *v22; // rax@11
  char *v23; // rax@13
  char *v24; // rax@14
  ...
  char *v27; // rax@17
  char *v28; // rax@19
  const char *v29; // [sp+0h] [bp-88h]@4
  const char *v30; // [sp+8h] [bp-80h]@4
  const char *v31; // [sp+10h] [bp-78h]@4
  const char *v32; // [sp+18h] [bp-70h]@4
  const char *v33; // [sp+20h] [bp-68h]@4
  const char *v34; // [sp+28h] [bp-60h]@4
  const char *v35; // [sp+30h] [bp-58h]@4
  const char *v36; // [sp+38h] [bp-50h]@4
  const char *v37; // [sp+40h] [bp-48h]@4
  const char *v38; // [sp+48h] [bp-40h]@4
  const char *v39; // [sp+50h] [bp-38h]@4
  const char *v40; // [sp+58h] [bp-30h]@4
  __int64 v41; // [sp+60h] [bp-28h]@4
  __int64 v42; // [sp+68h] [bp-20h]@4
  ...
  __printf_chk(1LL, v13, "/var/run/utmp");
  v29 = "[";
  v14 = (__int64 *)&v29;
  v30 = "test invocation";
  v31 = "coreutils";
  ...
  do
  {
    ...
    do
    {
      if ( !v19 )
        break;
      v16 = (const unsigned __int8)*v18 < *v15;
      v17 = *v18++ == *v15++;
      --v19;
    }
    while ( v17 );
  ...
  {
    v21 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v21, &unk_406F2E);
    v22 = setlocale(5, 0LL);
  ...
  {
    v25 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v25, &unk_406F2E);
    v26 = setlocale(5, 0LL);
...
int sub_402FE0()
{
  ...
  if ( ((int (__fastcall *)(_IO_FILE *))loc_406770)(stdout) )
  {
    v0 = __errno_location();
    v1 = v0;
    if ( !byte_60A3D8 || *v0 != 32 )
    {
      ...
      if ( qword_60A3E0 )
      {
        LODWORD(v5) = sub_404BF0(qword_60A3E0, "write error");
...
LABEL_8:
  ...
  result = ((int (__fastcall *)(FILE *))loc_406770)(stderr);
  if ( result )
    goto LABEL_8;
  return result;
}
...
signed __int64 __fastcall sub_4030E0(signed __int64 a1, __int64 a2)
{
  _BYTE *v2; // rcx@1
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_4064E0((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_404550(__int64 a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_60A2F0 <= (signed int)a1 )
  {
    ...
    {
      LODWORD(v21) = sub_4053C0(0LL, v9);
      v7 = v21;
      off_60A2D8 = v21;
      *v21 = (__int128)_mm_load_si128((const __m128i *)&xmmword_60A2E0);
    }
    else
    {
      LODWORD(v10) = sub_4053C0(off_60A2D8, v9);
      off_60A2D8 = v10;
      v7 = v10;
    }
    memset(&v7[dword_60A2F0], 0, 16LL * ((signed int)a1 + 1 - dword_60A2F0));
    dword_60A2F0 = a1 + 1;
  }
  ...
  v24 = *(_DWORD *)(v5 + 4) | 1;
  v13 = *(_QWORD *)v11;
  v14 = sub_403320(v12, *(_QWORD *)v11, v22, v4, *(_DWORD *)v5, v24, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v13 <= v14 )
  {
    v16 = v14 + 1;
    *(_QWORD *)v11 = v14 + 1;
    if ( (_UNKNOWN *)v12 != &unk_60A400 )
    {
      v17 = v14 + 1;
      free(v12);
      v16 = v17;
    }
    LODWORD(v18) = sub_405360(v16, v16, v15);
    v19 = *(_DWORD *)v5;
    *(_QWORD *)(v11 + 8) = v18;
    v12 = v18;
    sub_403320(v18, v16, v22, v4, v19, v24, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v23;
  return v12;
}
...
_BYTE *__fastcall sub_404B70(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  v7 = qword_60A530;
  v4 = _mm_load_si128((const __m128i *)&xmmword_60A500);
  v5 = _mm_load_si128((const __m128i *)&xmmword_60A510);
  v6 = _mm_load_si128((const __m128i *)&xmmword_60A520);
  v4.m128i_i32[(a3 >> 5) + 2] ^= (~(unsigned __int8)((unsigned __int32)v4.m128i_i32[(a3 >> 5) + 2] >> (a3 & 0x1F)) & 1) << (a3 & 0x1F);
  return sub_404550(0LL, a1, a2, (__int64)&v4);
}
...
_BYTE *__fastcall sub_404C20(__int64 a1, int a2, char *a3)
{
...
int __fastcall sub_404DC0(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12@1
  __int64 v7; // rbx@1
  char *v8; // rax@3
...
int __fastcall sub_405220(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  char *v7; // r10@1
  signed int v8; // er8@1
  __int64 v9; // r9@1
  ...
  do
  {
    if ( (unsigned int)v8 <= 0x2F )
    {
      ...
      v15[v9] = v11;
      if ( !v11 )
        return sub_404DC0(a1, a2, a3, a4, (__int64)v15, v9);
      goto LABEL_3;
    }
    v12 = (__int64 *)v7;
    v7 += 8;
...
void *__fastcall sub_405560(const void *a1, size_t a2)
{
  void *v2; // rax@1
...
int __fastcall sub_4055F0(FILE *stream)
{
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_405670(stream) )
  {
...
int __fastcall sub_405670(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_4056B0(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
__int64 __fastcall sub_405710(__int64 a1, __int64 a2)
{
...
signed __int64 __fastcall sub_4057F0(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8, __int64 a9)
{
  const char *v9; // r14@1
  char *v10; // rbp@1
  size_t v11; // r13@5
...
__int64 __fastcall sub_405E10(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8)
{
  int v8; // er13@1
  signed int v9; // eax@2
  int v10; // ebp@2
    ...
    if ( *(_BYTE *)v21 == 45 )
    {
      ...
      if ( v36 )
      {
        if ( v53 )
        {
          ...
          {
            *(_QWORD *)(a7 + 32) = v21 + 2;
            v40 = sub_4057F0(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"--");
            goto LABEL_72;
          }
          if ( a6 )
          {
            ...
            {
              *(_QWORD *)(a7 + 32) = v21 + 1;
              v26 = sub_4057F0(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"-");
              if ( v26 != -1 )
...
LABEL_71:
        *(_QWORD *)(a7 + 32) = v28;
        *(_QWORD *)(a7 + 16) = 0LL;
        v40 = sub_4057F0(v10, v11, v12, v53, v54, 0, a7, v8, (__int64)"-W ");
LABEL_72:
        return v40;
      }
      v39 = *(_DWORD *)a7;
...
__int64 __fastcall sub_4063E0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax@1

  dword_60A540 = dword_60A2FC;
  dword_60A544 = dword_60A2F8;
  result = sub_405E10(a1, a2, a3, a4, a5, a6, (__int64)&dword_60A540, a7);
...
__int64 __fastcall sub_406460(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5)
{
