...
__int64 __fastcall main(int a1, char **a2, char **a3)
{
  ...
  __int64 v8; // rax@20
  char v9; // r8@20
  const char *v10; // rbx@22
  size_t v11; // rax@22
  unsigned __int64 v12; // r13@22
  const char *v13; // rsi@25
  size_t v14; // rax@25
  const char *v15; // r15@25
  signed __int64 v16; // rbp@27
  const char *v17; // r15@28
  unsigned __int64 v18; // r12@28
  char v19; // r14@30
  const char *v20; // rax@33
  int *v21; // rax@35
  int *v22; // r13@35
  __int64 v23; // rax@35
  char v24; // r13@37
  unsigned __int64 v25; // r8@39
  char *v26; // r10@40
  __int64 v27; // rax@48
  const char *i; // rdi@49
  char *v29; // rax@53
  ...
  char *v32; // rax@58
  bool v33; // zf@61
  const char *v34; // r15@61
  __int64 v35; // rax@63
  signed __int64 v36; // r15@64
  const char *v37; // rax@65
  char v38; // dl@67
  unsigned __int64 v39; // rdx@72
  char v40; // cl@73
  char *v42; // rax@80
  char *v43; // rax@82
  unsigned __int64 v44; // r13@83
  __int64 v45; // rax@83
  __int64 v46; // rbx@83
  __int64 v47; // rax@85
  __int64 v48; // r13@85
  ...
  char *v52; // rax@87
  char *v53; // ST10_8@88
  unsigned __int64 v54; // ST28_8@88
  __int64 v55; // rax@88
  __int64 v56; // rbx@88
  char *v57; // rax@88
  char *v58; // rax@89
  const char *v59; // [sp+0h] [bp-E8h]@0
  char v60; // [sp+9h] [bp-DFh]@16
  char v61; // [sp+Ah] [bp-DEh]@17
  char v62; // [sp+Bh] [bp-DDh]@17
  int v63; // [sp+Ch] [bp-DCh]@17
  char **v64; // [sp+10h] [bp-D8h]@17
  struct stat stat_buf; // [sp+20h] [bp-C8h]@18
...
LABEL_90:
  ...
  if ( dword_60923C == a1 )
  {
    v58 = dcgettext(0LL, "missing operand", 5);
    error(0, 0, v58);
    goto LABEL_90;
  }
  v60 = 1;
    ...
    do
    {
      ...
      if ( v62 )
      {
        for ( i = v10; ; i = v29 + 1 )
        {
          ...
          if ( v10 == v29 || *(v29 - 1) == 47 )
          {
            LODWORD(v30) = sub_403AF0(4LL, v10);
            v31 = v30;
            v32 = dcgettext(0LL, "leading '-' in a component of file name %s", 5);
            error(0, 0, v32, v31, v59);
            v9 = 0;
            goto LABEL_21;
          }
        }
      ...
      else if ( v61 )
      {
        ...
        {
LABEL_80:
          v42 = dcgettext(0LL, "empty file name", 5);
          error(0, 0, v42, v59);
          v9 = 0;
          goto LABEL_21;
        }
LABEL_25:
        v13 = "/ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789._-";
        v14 = strspn(v10, "/ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789._-");
        v15 = &v10[v14];
        if ( v10[v14] )
        {
          stat_buf.st_dev = 0LL;
          v44 = sub_405360((char *)&v10[v14]);
          LODWORD(v45) = sub_403A10(0LL, 4LL, v10);
          v46 = v45;
          if ( v44 > 0x10 )
            v44 = 1LL;
          LODWORD(v47) = sub_403A80(1LL, 8LL, v15, v44);
          v48 = v47;
          v49 = dcgettext(0LL, "nonportable character %s in file name %s", 5);
          error(0, 0, v49, v48, v46, v59);
          v9 = 0;
          goto LABEL_21;
        }
        if ( v12 > 0xFF )
        {
          v36 = 256LL;
LABEL_87:
          LODWORD(v50) = sub_403AF0(4LL, v10);
          v51 = v50;
          v52 = dcgettext(0LL, "limit %lu exceeded by length %lu of file name %s", 5);
          error(0, 0, v52, v36 - 1, v12, v51, v59);
          v9 = 0;
          goto LABEL_21;
        }
        v16 = 14LL;
          ...
          while ( 1 )
          {
              ...
              *v17 = v19;
              if ( v23 < 0 )
              {
                if ( *v22 )
                {
                  ...
                  {
                    *v17 = 0;
                    LODWORD(v27) = sub_403BC0(0LL, 3LL, v59);
                    error(0, *v22, "%s", v27, v59);
                    *v17 = v19;
                    v9 = 0;
                    goto LABEL_21;
                  }
            ...
            if ( v18 < v25 )
            {
              *v26 = 0;
              v53 = v26;
              v54 = v25;
              LODWORD(v55) = sub_403D40(v17, v13);
              v56 = v55;
              v57 = dcgettext(0LL, "limit %lu exceeded by length %lu of file name component %s", 5);
              error(0, 0, v57, v18, v54, v56, v53);
              v9 = 0;
              *v59 = v24;
              goto LABEL_21;
            }
        ...
        if ( v12 > 0xFF )
        {
          ...
          *v7 = 0;
          ...
          if ( v35 < 0 )
          {
            if ( *v7 )
            {
              v43 = dcgettext(0LL, "%s: unable to determine maximum file name length", 5);
              error(0, *v7, v43, v34, v59);
              v9 = (char)v59;
              goto LABEL_21;
            }
          }
...
LABEL_67:
      ...
      LODWORD(v8) = sub_403BC0(0LL, 3LL, v10);
      error(0, *v7, "%s", v8, v59);
      v9 = 0;
LABEL_21:
      v60 &= v9;
...
noreturn void __fastcall  sub_401D70(int status)
{
  int v1; // ebx@1
  __int64 v2; // rbp@1
  char *v3; // rax@2
  ...
  {
    v18 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v18, &unk_405CA2);
    v19 = setlocale(5, 0LL);
  ...
  {
    v22 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v22, &unk_405CA2);
    v23 = setlocale(5, 0LL);
...
__int64 sub_402080()
{
  ...
  if ( (unsigned int)sub_405400(stdout) )
  {
    ...
    if ( !byte_609278 || *v0 != 32 )
    {
      ...
      if ( qword_609280 )
      {
        LODWORD(v5) = sub_403B90(qword_609280, "write error");
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_405380((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_403AF0(int a1, char *a2)
{
...
_BYTE *__fastcall sub_403D40(char *a1)
{
...
int __fastcall sub_4041C0(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  char *v7; // r10@1
  signed int v8; // er8@1
  __int64 v9; // r9@1
  ...
  do
  {
    if ( (unsigned int)v8 <= 0x2F )
    {
      ...
      v15[v9] = v11;
      if ( !v11 )
        return sub_403D60(a1, a2, a3, a4, (__int64)v15, v9);
      goto LABEL_3;
    }
    v12 = (__int64 *)v7;
    v7 += 8;
...
signed __int64 __fastcall sub_404670(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8, __int64 a9)
{
  const char *v9; // r14@1
  char *v10; // rbp@1
  size_t v11; // r13@5
...
__int64 __fastcall sub_404C90(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8)
{
  int v8; // er13@1
  signed int v9; // eax@2
  int v10; // ebp@2
    ...
    if ( *(_BYTE *)v21 == 45 )
    {
      ...
      if ( v36 )
      {
        if ( v53 )
        {
          ...
          {
            *(_QWORD *)(a7 + 32) = v21 + 2;
            v40 = sub_404670(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"--");
            goto LABEL_72;
          }
          if ( a6 )
          {
            ...
            {
              *(_QWORD *)(a7 + 32) = v21 + 1;
              v26 = sub_404670(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"-");
              if ( v26 != -1 )
...
LABEL_71:
        *(_QWORD *)(a7 + 32) = v28;
        *(_QWORD *)(a7 + 16) = 0LL;
        v40 = sub_404670(v10, v11, v12, v53, v54, 0, a7, v8, (__int64)"-W ");
LABEL_72:
        return v40;
      }
      v39 = *(_DWORD *)a7;
...
__int64 __fastcall sub_405260(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax@1

  dword_6093E0 = dword_60923C;
  dword_6093E4 = dword_609238;
  result = sub_404C90(a1, a2, a3, a4, a5, a6, (__int64)&dword_6093E0, a7);
...
__int64 __fastcall sub_4052E0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5)
{
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_405460(0LL, v6) )
  {
    v4 = 1LL;
...
int __fastcall sub_405A30(FILE *stream)
{
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_405AB0(stream) )
  {
...
int __fastcall sub_405AB0(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_405AF0(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
int __fastcall sub_405BC0(__int64 a1)
{
  __int64 v1; // rdx@1
