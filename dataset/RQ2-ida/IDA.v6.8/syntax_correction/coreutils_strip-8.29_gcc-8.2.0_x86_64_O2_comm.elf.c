...
signed __int64 __fastcall main(int a1, char **a2, char **a3)
{
  ...
  char *v4; // r13@16
  bool v5; // zf@18
  unsigned __int64 v6; // rax@18
  int v7; // eax@32
  signed __int64 result; // rax@35
  __int64 v9; // rax@39
  const char *v10; // rsi@39
  __int64 v11; // rbx@39
  char *v12; // rax@40
  char *v13; // rax@42
  char *v14; // rax@44
  ...
  while ( 1 )
  {
    v3 = sub_405FF0((unsigned int)a1, a2, "123z", &off_407120, 0LL);
    if ( v3 == -1 )
      break;
    if ( v3 == 51 )
    {
...
LABEL_43:
    ...
    LODWORD(v15) = sub_404660(a2[a1 - 1]);
...
LABEL_40:
  ...
  {
    LODWORD(v9) = sub_404660(a2[dword_60A27C + 2]);
    v10 = "extra operand %s";
    v11 = v9;
    goto LABEL_40;
  }
...
LABEL_13:
  ...
  if ( byte_60A2CA )
LABEL_4:
    result = fwrite_unlocked(*a2, 1uLL, *a1, v4);
  return result;
}
...
int __fastcall sub_401CA0(_QWORD *a1)
{
  _QWORD *v1; // r14@1
  ...
  __int64 v18; // rbp@14
  __int64 v19; // rbx@14
  unsigned __int64 v20; // r14@16
  unsigned __int64 v21; // r15@16
  const void *v22; // rdi@16
  __int64 v23; // rdx@17
  int v24; // eax@19
  FILE *v25; // rdx@22
  char v26; // al@24
  signed __int64 v27; // rbx@25
  char *v28; // rbp@25
  signed int v29; // er13@25
  __int64 v30; // r12@28
  int v31; // ecx@28
  _BYTE *v32; // r15@28
  __int64 v33; // rdx@28
  __int64 v34; // rax@28
  signed __int64 v35; // r8@28
  __int64 v36; // rcx@28
  __int64 v37; // rdi@32
  __int64 v38; // rdi@35
  __int64 v39; // rdx@39
  ...
  __int64 v58; // rbx@58
  int *v59; // rax@58
  signed __int64 v60; // [sp+0h] [bp-208h]@0
  __int64 v61; // [sp+8h] [bp-200h]@13
  __int64 v62; // [sp+10h] [bp-1F8h]@13
  __int64 v63; // [sp+18h] [bp-1F0h]@13
  int v64; // [sp+20h] [bp-1E8h]@28
  int v65; // [sp+24h] [bp-1E4h]@13
  _QWORD *v66; // [sp+28h] [bp-1E0h]@1
  __int64 v67; // [sp+30h] [bp-1D8h]@10
  __int64 v68; // [sp+38h] [bp-1D0h]@14
  FILE *stream; // [sp+40h] [bp-1C8h]@9
  FILE *v70; // [sp+48h] [bp-1C0h]@50
  char v71; // [sp+50h] [bp-1B8h]@52
  char v72; // [sp+70h] [bp-198h]@52
  __int16 v73; // [sp+90h] [bp-178h]@15
  char v74; // [sp+B0h] [bp-158h]@1
  __int64 v75[20]; // [sp+D0h] [bp-138h]@2
  char v76; // [sp+170h] [bp-98h]@1
  ...
  while ( 1 )
  {
    ...
    *(&stream + v2) = v13;
    if ( !v13 )
      goto LABEL_58;
    sub_402730(v13, 2LL);
    LODWORD(v15) = sub_4028C0(v75[4 * (signed int)v2], v13, (unsigned int)byte_60A1F8);
    *(&v67 + v2) = v15;
    if ( v13->_flags & 0x20 )
      goto LABEL_57;
    ++v1;
  ...
  while ( 1 )
  {
    ...
    v20 = *(_QWORD *)(v68 + 8);
    v21 = *(_QWORD *)(v67 + 8);
    v22 = *(const void **)(v67 + 16);
    if ( byte_60A2CB )
    {
      v24 = sub_404F80(v22, v21 - 1, *(_QWORD *)(v68 + 16), v20 - 1);
LABEL_22:
      v25 = stdout;
      if ( !v24 )
      {
        ++v63;
        sub_401B50((size_t *)(v19 + 8), (const void **)(v19 + 16), stdout, 3);
        HIBYTE(v73) = 1;
        goto LABEL_24;
      }
      goto LABEL_46;
    ...
    if ( v20 <= v21 )
      v23 = *(_QWORD *)(v68 + 8);
    v24 = memcmp(v22, *(const void **)(v68 + 16), v23 - 1);
    if ( !v24 )
    {
      if ( v20 > v21 )
      {
...
LABEL_44:
        ++v62;
        sub_401B50((size_t *)(v18 + 8), (const void **)(v18 + 16), v25, 1);
LABEL_24:
        LOBYTE(v73) = 1;
        v26 = 1;
        goto LABEL_25;
...
LABEL_42:
    ++v61;
    sub_401B50((size_t *)(v19 + 8), (const void **)(v19 + 16), v25, 2);
    HIBYTE(v73) = 1;
    v26 = 0;
LABEL_25:
    v27 = 0LL;
...
LABEL_28:
        ...
        v31 = *((_DWORD *)v28 + 1);
        v32 = *(&stream + v27);
        v33 = (unsigned int)byte_60A1F8;
        v60 = 4 * v27;
        *((_DWORD *)v28 + 2) = v31;
        *((_DWORD *)v28 + 1) = v30;
        *(_DWORD *)v28 = ((_BYTE)v30 + 1) & 3;
        v64 = v31;
        LODWORD(v34) = sub_4028C0(v75[4 * v27 + (((_BYTE)v30 + 1) & 3)], v32, v33);
        v35 = 4 * v27;
        v36 = v64;
        *(&v67 + v27) = v34;
        if ( v34 )
        ...
        else
        {
          v35 += v64;
          v38 = v75[v35];
          if ( *(_QWORD *)(v38 + 16) && dword_60A2C0 != 2 && (dword_60A2C0 == 1 || byte_60A2C7) )
          {
            v39 = v75[v30 + 4LL * (signed int)v1];
            sub_401C10(
              (__int64 *)(v38 + 8),
              (__int64 *)(v38 + 16),
              (__int64 *)(v39 + 8),
        ...
        if ( *v32 & 0x20 )
        {
          LODWORD(v48) = sub_4044E0(0LL, 3LL, v66[(signed int)v1], v36, v35);
          v49 = v48;
          v50 = __errno_location();
          error(1, *v50, "%s", v49, v60);
LABEL_55:
          v65 = 1;
LABEL_56:
          LODWORD(v51) = sub_4044E0(0LL, 3LL, v66[v65], v66, v40);
          v52 = v51;
          v53 = __errno_location();
          error(1, *v53, "%s", v52, v60);
LABEL_57:
          LODWORD(v54) = sub_4044E0(0LL, 3LL, (_BYTE *)*v1, v16, v17);
          v55 = v54;
          v56 = __errno_location();
          error(1, *v56, "%s", v55, v60);
LABEL_58:
          LODWORD(v57) = sub_4044E0(0LL, 3LL, *v1, v11, v7);
          v58 = v57;
          v59 = __errno_location();
          error(1, *v59, "%s", v58, v60);
          sub_402220(1);
        }
        *((_BYTE *)&v73 + v27) = 0;
      }
  ...
  if ( (unsigned int)sub_405040(stream) )
    goto LABEL_56;
  result = sub_405040(v70);
  if ( result )
    goto LABEL_55;
  if ( byte_60A2C4 )
  {
    dcgettext(0LL, "total", 5);
    sub_402860(v63, &v73);
    v43 = ptr;
    LODWORD(v44) = sub_402860(v61, &v72);
    v45 = ptr;
    v46 = v44;
    LODWORD(v47) = sub_402860(v62, &v71);
    result = __printf_chk(1LL, "%s%s%s%s%s%s%s%c", v47, v45, v46, v43);
  }
  return result;
}
...
noreturn void __fastcall  sub_402220(int status)
{
  ...
  bool v36; // cf@5
  bool v37; // zf@5
  const char *v38; // rsi@6
  signed __int64 v39; // rcx@6
  char *v40; // rbp@10
  char *v41; // rax@11
  __int64 v42; // r8@11
  __int64 v43; // r9@11
  ...
  __int64 v61; // r8@20
  __int64 v62; // r9@20
  const char *v63; // [sp+0h] [bp-88h]@4
  const char *v64; // [sp+8h] [bp-80h]@4
  const char *v65; // [sp+10h] [bp-78h]@4
  const char *v66; // [sp+18h] [bp-70h]@4
  const char *v67; // [sp+20h] [bp-68h]@4
  const char *v68; // [sp+28h] [bp-60h]@4
  const char *v69; // [sp+30h] [bp-58h]@4
  const char *v70; // [sp+38h] [bp-50h]@4
  const char *v71; // [sp+40h] [bp-48h]@4
  const char *v72; // [sp+48h] [bp-40h]@4
  const char *v73; // [sp+50h] [bp-38h]@4
  const char *v74; // [sp+58h] [bp-30h]@4
  __int64 v75; // [sp+60h] [bp-28h]@4
  __int64 v76; // [sp+68h] [bp-20h]@4
  ...
  __printf_chk(1LL, v4, v2, v5, v6, v7);
  v8 = stdout;
  v9 = dcgettext(0LL, "Compare sorted files FILE1 and FILE2 line by line.\n", 5);
  ...
  v18 = stdout;
  v19 = dcgettext(0LL, "  --output-delimiter=STR  separate columns with STR\n", 5);
  fputs_unlocked(v19, v18);
  v20 = stdout;
  v21 = dcgettext(0LL, "  --total           output a summary\n", 5);
  fputs_unlocked(v21, v20);
  v22 = stdout;
  v23 = dcgettext(0LL, "  -z, --zero-terminated    line delimiter is NUL, not newline\n", 5);
  ...
  v31 = dcgettext(
          ...
          5);
  __printf_chk(1LL, v31, v30, v30, v32, v33);
  v63 = "[";
  v34 = (__int64 *)&v63;
  v64 = "test invocation";
  v65 = "coreutils";
  ...
  do
  {
    ...
    do
    {
      if ( !v39 )
        break;
      v36 = (const unsigned __int8)*v38 < *v35;
      v37 = *v38++ == *v35++;
      --v39;
    }
    while ( v37 );
  ...
  {
    v41 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v41, &unk_407067, "https://www.gnu.org/software/coreutils/", v42, v43);
    v44 = setlocale(5, 0LL);
  ...
  {
    v52 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v52, &unk_407067, "https://www.gnu.org/software/coreutils/", v53, v54);
    v55 = setlocale(5, 0LL);
    if ( !v55 || !strncmp(v55, "en_", 3uLL) )
    {
      v40 = "comm";
      v56 = dcgettext(0LL, "Full documentation at: <%s%s>\n", 5);
      v45 = "Multi-call invocation" + 10;
      __printf_chk(1LL, v56, "https://www.gnu.org/software/coreutils/", "comm", v57, v58);
LABEL_15:
      v49 = dcgettext(0LL, "or available locally via: info '(coreutils) %s%s'\n", 5);
      __printf_chk(1LL, v49, v40, v45, v50, v51);
LABEL_3:
      exit(v1);
    }
    v40 = "comm";
  ...
  __printf_chk(1LL, v59, "comm", v60, v61, v62);
LABEL_13:
  v45 = "Multi-call invocation" + 10;
  v46 = dcgettext(0LL, "Full documentation at: <%s%s>\n", 5);
  __printf_chk(1LL, v46, "https://www.gnu.org/software/coreutils/", "comm", v47, v48);
  if ( v40 != "comm" )
    v45 = s1;
  goto LABEL_15;
}
...
__int64 sub_402680()
{
  ...
  if ( (unsigned int)sub_4060F0(stdout) )
  {
    ...
    if ( !byte_60A2D0 || *v0 != 32 )
    {
      ...
      if ( qword_60A2D8 )
      {
        LODWORD(v5) = sub_4044B0(qword_60A2D8, "write error");
...
signed __int64 __fastcall sub_402860(unsigned __int64 a1, __int64 a2)
{
...
signed int __fastcall sub_402A00(const void *a1, size_t a2, const void *a3, size_t a4)
{
  size_t v4; // rbp@1
  const void *v5; // rsi@1
  size_t v6; // rdx@1
...
_BYTE *__fastcall sub_403E10(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_60A270 <= a1 )
  {
    ...
    {
      LODWORD(v20) = sub_404C90(0LL, v9);
      v7 = v20;
      off_60A258 = v20;
      *v20 = (__int128)_mm_load_si128((const __m128i *)&xmmword_60A260);
    }
    else
    {
      LODWORD(v10) = sub_404C90(off_60A258, v9);
      off_60A258 = v10;
      v7 = v10;
    }
  ...
  v23 = *(_DWORD *)(v5 + 4) | 1;
  v13 = *(_QWORD *)v11;
  v14 = sub_402BE0(v12, *(_QWORD *)v11, v21, v4, *(_DWORD *)v5, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v13 <= v14 )
  {
    v15 = v14 + 1;
    *(_QWORD *)v11 = v14 + 1;
    ...
    LODWORD(v17) = sub_404C30(v15);
    v18 = *(_DWORD *)v5;
    *(_QWORD *)(v11 + 8) = v17;
    v12 = v17;
    sub_402BE0(v17, v15, v21, v4, v18, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v22;
  return v12;
}
...
_BYTE *__fastcall sub_404430(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  return sub_403E10(0, a1, a2, (__int64)&v4);
}
...
int __fastcall sub_404690(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12@1
  __int64 v7; // rbx@1
  char *v8; // rax@3
...
int __fastcall sub_404AF0(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  char *v7; // r10@1
  signed int v8; // er8@1
  __int64 v9; // r9@1
  ...
  do
  {
    if ( (unsigned int)v8 <= 0x2F )
    {
      ...
      v15[v9] = v11;
      if ( !v11 )
        return sub_404690(a1, a2, a3, a4, (__int64)v15, v9);
      goto LABEL_3;
    }
    v12 = (__int64 *)v7;
    v7 += 8;
...
void *__fastcall sub_404D90(void *a1, unsigned __int64 *a2)
{
...
void *__fastcall sub_404E30(const void *a1, size_t a2)
{
  void *v2; // rax@1
...
int __fastcall sub_405040(FILE *stream)
{
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_405200(stream) )
  {
...
__int64 __fastcall sub_4050C0(char a1, int a2, __int64 a3, __int64 a4)
{
  int v4; // ebx@3
  int v6; // eax@8
  int *v7; // rax@10
...
int __fastcall sub_405200(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_405240(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
__int64 __fastcall sub_405F70(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  ...
  result = sub_4059A0(a1, a2, a3, a4, a5, a6, (__int64)&dword_60A440, a7);
...
int __fastcall sub_406910(__int64 a1)
{
  __int64 v1; // rdx@1
