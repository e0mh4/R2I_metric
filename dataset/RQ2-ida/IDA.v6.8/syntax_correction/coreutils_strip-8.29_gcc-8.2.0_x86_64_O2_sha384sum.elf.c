...
__int64 __fastcall main(unsigned int a1, char **a2, char **a3)
{
  ...
  char *v92; // ST30_8@212
  const char **v93; // [sp+0h] [bp-128h]@44
  char *s; // [sp+8h] [bp-120h]@46
  char v95; // [sp+13h] [bp-115h]@45
  int v96; // [sp+14h] [bp-114h]@47
  unsigned __int64 v97; // [sp+18h] [bp-110h]@49
  signed __int64 v98; // [sp+20h] [bp-108h]@76
  char v99; // [sp+28h] [bp-100h]@76
  unsigned __int64 v100; // [sp+28h] [bp-100h]@117
  __int64 v101; // [sp+30h] [bp-F8h]@76
  const char **v102; // [sp+38h] [bp-F0h]@42
  unsigned __int64 v103; // [sp+40h] [bp-E8h]@49
  char v104; // [sp+48h] [bp-E0h]@45
  char v105; // [sp+49h] [bp-DFh]@49
  char v106; // [sp+4Ah] [bp-DEh]@45
  char v107; // [sp+4Bh] [bp-DDh]@45
  int v108; // [sp+4Ch] [bp-DCh]@45
  char v109; // [sp+5Fh] [bp-C9h]@90
  char *lineptr; // [sp+60h] [bp-C8h]@49
  size_t n; // [sp+68h] [bp-C0h]@49
  char v112[64]; // [sp+70h] [bp-B8h]@127
  char v113[120]; // [sp+B0h] [bp-78h]@90
...
LABEL_66:
            ...
            if ( byte_60F2DB )
            {
              ...
              error(0, 0, v48, v47, v13, "SHA384", v93);
            }
LABEL_68:
            if ( v6->_flags & 0x30 )
              break;
...
noreturn void __fastcall  sub_402C90(int status)
{
  ...
  __printf_chk(1LL, v35, "sha384sum");
LABEL_13:
