...
#define __asm__(x)
signed __int64 __usercall main(char **a1, char **a2, unsigned int a3, unsigned __int64 a4)
{
...
__int64 __usercall sub_4054D0(char *nptr, unsigned int a2, unsigned int a3, unsigned __int64 a4, __int128 a5)
{
