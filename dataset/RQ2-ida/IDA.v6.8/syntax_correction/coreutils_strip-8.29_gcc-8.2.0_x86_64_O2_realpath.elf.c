...
__int64 __fastcall main(int a1, char **a2, char **a3)
{
  ...
  char *v14; // rax@48
  char *v15; // r15@52
  const char *v16; // rax@52
  const char *v17; // r14@52
  __int64 v18; // rax@54
  __int64 v19; // r13@54
  int *v20; // rax@54
  __int64 v21; // rcx@54
...
LABEL_66:
  ...
  LODWORD(v8) = sub_402020(v3, v6);
  qword_60C300 = (__int64)v8;
  if ( !v8 )
    goto LABEL_68;
  if ( v6 & 3 || (unsigned __int8)sub_402080(v8) )
  {
LABEL_35:
    if ( (void *)v4 == v3 )
    {
    ...
    if ( !v4 )
      goto LABEL_41;
    LODWORD(v9) = sub_402020(v4, v6);
    v3 = v9;
    if ( v9 )
    {
      if ( v6 & 3 || (unsigned __int8)sub_402080(v9) )
      {
        v4 = qword_60C300;
      ...
      LODWORD(v24) = sub_405C60(0LL, 3LL, v4);
      error(1, 20, "%s", v24);
LABEL_65:
    ...
    LODWORD(v26) = sub_405C60(0LL, 3LL, v4);
    v27 = v26;
    v28 = __errno_location();
    error(1, *v28, "%s", v27);
LABEL_68:
    LODWORD(v29) = sub_405C60(0LL, 3LL, v3);
    v30 = v29;
    v31 = __errno_location();
    error(1, *v31, "%s", v30);
    start();
  }
  LODWORD(v23) = sub_405C60(0LL, 3LL, v3);
  error(1, 20, "%s", v23);
LABEL_62:
  free(v3);
  qword_60C2F8 = v4;
...
LABEL_41:
  ...
  {
    v15 = v5[v10];
    LODWORD(v16) = sub_402020(v5[v10], v6);
    v17 = v16;
    if ( v16 )
    {
      v12 = qword_60C300;
      ...
      v13 = (unsigned __int8)byte_60C308 < 1u ? 0xA : 0;
    ...
    else
    {
      ...
      if ( byte_60C230 )
      {
        LODWORD(v18) = sub_405C60(0LL, 3LL, v15);
        v19 = v18;
...
bool __fastcall sub_402080(char *filename)
{
  ...
  int v7; // [sp+18h] [bp-90h]@2

  if ( __xstat(1, filename, (struct stat *)&v6) )
  {
    LODWORD(v2) = sub_405B90(4LL, filename);
    v3 = v2;
    v4 = dcgettext(0LL, "cannot stat %s", 5);
    v5 = __errno_location();
    error(1, *v5, v4, v3);
    sub_402100(1);
  }
  return (unsigned __int16)(v7 & 0xF000) == 0x4000;
}
...
noreturn void __fastcall  sub_402100(int status)
{
  ...
  v5 = stdout;
  v6 = dcgettext(0LL, "Print the resolved absolute file name;\nall but the last component must exist\n\n", 5);
  ...
  {
    v20 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v20, &unk_4085F2);
    v21 = setlocale(5, 0LL);
  ...
  {
    v24 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v24, &unk_4085F2);
    v25 = setlocale(5, 0LL);
...
__int64 __fastcall sub_402410(void *src, void **a2, _QWORD *a3)
{
  void *v3; // r13@1
  _QWORD *v4; // r12@2
  size_t v5; // rbx@2
...
char __fastcall sub_402490(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  char v4; // r8@1
  char v5; // r9@1
  char result; // al@1
...
LABEL_14:
        ...
        if ( v14 )
        {
          v16 = sub_402410("..", (void **)&v21, &v20);
          for ( i = *v13; *v13; i = *v13 )
          {
            if ( i == 47 )
              v16 |= sub_402410(&unk_408D00, (void **)&v21, &v20);
            ++v13;
          }
          if ( *v15 )
          {
            v18 = sub_402410("/", (void **)&v21, &v20);
            v16 |= (unsigned __int64)sub_402410((void *)v15, (void **)&v21, &v20) | v18;
          }
        }
        else
        {
          if ( !*v15 )
            v15 = ".";
          v16 = sub_402410((void *)v15, (void **)&v21, &v20);
        }
        if ( (_BYTE)v16 )
        {
...
char *__fastcall sub_402690(void *src, char a2)
{
  char *v2; // r15@2
  const char *v3; // rax@5
  char *v4; // r12@5
  ...
  else
  {
    ...
    if ( v5 <= 0xFFF )
    {
      LODWORD(v53) = sub_406530(v4, 4096LL);
      v4 = v53;
      v7 = &v53[v6];
...
LABEL_32:
      ...
      else
      {
        ...
        else
        {
          ...
          if ( !v60 )
          {
            LODWORD(v47) = sub_403730(7LL, 0LL, sub_4040F0, sub_404160, sub_4041A0);
            v60 = v47;
            if ( !v47 )
              sub_406720();
          }
          if ( (unsigned __int8)sub_402E60(v60, v61, &stat_buf) )
          {
            if ( v59 != 2 )
            {
...
LABEL_69:
          ...
          {
            sub_402DD0(v60, v61, &stat_buf);
            v30 = (const char *)sub_407AB0(v4);
            v31 = v30;
            if ( v30 )
            {
              v32 = i + 1;
              ...
              if ( v63 )
              {
                if ( v36 > v63 )
                {
                  v54 = v33 + v34 + 1;
                  v55 = v34;
                  LODWORD(v56) = sub_406530(ptr, v54);
                  v35 = v55;
                  ptr = v56;
                  v63 = v54;
                }
...
LABEL_46:
  ...
  *v7 = 0;
  if ( v8 != v27 )
  {
    LODWORD(v28) = sub_406530(v4, v7 - v4 + 1);
    v4 = v28;
  }
  free(ptr);
  if ( v60 )
...
__int64 sub_402D30()
{
  ...
  if ( (unsigned int)sub_407BA0(stdout) )
  {
    ...
    if ( !byte_60C310 || *v0 != 32 )
    {
      ...
      if ( qword_60C318 )
      {
        LODWORD(v5) = sub_405C30(qword_60C318, "write error");
...
void __fastcall sub_402DD0(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v3; // rbp@2
  __int64 v4; // rax@2
  __int64 v5; // rbx@2
  ...
  {
    v3 = a3;
    LODWORD(v4) = sub_4064D0(24LL);
    v5 = v4;
    LODWORD(v6) = sub_406700(a2);
    *(_QWORD *)v5 = v6;
    *(_QWORD *)(v5 + 8) = *(_QWORD *)(v3 + 8);
    *(_QWORD *)(v5 + 16) = *(_QWORD *)v3;
    LODWORD(v7) = sub_403ED0(a1, v5);
    if ( !v7 )
      sub_406720();
    if ( v5 != v7 )
      sub_4041A0(v5);
...
signed __int64 __fastcall sub_402F60(__int64 a1, __int64 a2)
{
...
__int64 __fastcall sub_402F90(__int64 a1, __int64 a2, __int64 **a3, char a4)
{
  __int64 **v4; // r14@1
  char v5; // r13@1
  __int64 v6; // rbp@1
...
signed __int64 __fastcall sub_4030B0(void **a1)
{
  void *v1; // rax@1
  float v2; // xmm0_4@2
  float v3; // xmm1_4@5
...
signed __int64 __fastcall sub_403130(__int64 a1, __int64 a2, char a3)
{
  char v3; // r14@1
...
char **__fastcall sub_403730(unsigned __int64 a1, __int64 a2, __int64 (__fastcall *a3)(), __int64 (__fastcall *a4)(), char *a5)
{
  char *v5; // r14@1
...
void __fastcall sub_403970(__int64 a1)
{
  __int64 v1; // r12@1
  void *v2; // rbp@1
...
signed __int64 __fastcall sub_403A50(__int64 a1, unsigned __int64 a2)
{
  __int64 v2; // r12@1
  float v3; // xmm0_4@3
  float v4; // xmm0_4@4
  ...
  v24 = v13;
  v25 = *(_QWORD *)(a1 + 72);
  v14 = sub_403130((__int64)&v16, a1, 0);
  if ( (_BYTE)v14 )
  {
    free(*(void **)a1);
    *(_QWORD *)a1 = v16;
  ...
  *(_QWORD *)(a1 + 72) = v25;
  if ( !(unsigned __int8)sub_403130(a1, (__int64)&v16, 1) || !(unsigned __int8)sub_403130(a1, (__int64)&v16, 0) )
    abort();
  free(v16);
  return v14;
}
...
signed __int64 __fastcall sub_403C50(__int64 a1, __int64 a2, __int64 *a3)
{
  __int64 *v3; // r12@2
  __int64 v4; // rbp@2
  __int64 v5; // rdx@2
...
unsigned __int64 __fastcall sub_4040F0(__int64 a1, unsigned __int64 a2)
{
  unsigned __int64 v2; // rax@1

  LODWORD(v2) = sub_407DD0(*(_QWORD *)a1);
...
void __fastcall sub_4041A0(void **a1)
{
  free(*a1);
  free(a1);
}
...
unsigned __int64 __fastcall sub_404360(_BYTE *a1, unsigned __int64 a2, char *a3, unsigned __int64 a4, int a5, char a6, __int64 a7, char *a8, char *a9)
{
  _BYTE *v9; // r15@1
...
LABEL_4:
        ...
        if ( !(_BYTE)v11 )
        {
          ...
          v44 = v43 == 2;
          if ( !v16 && v44 && v82 )
            return sub_404360((__int64)v9, v10, s);
          v45 = !v82 && v44;
          if ( v45 )
          {
            if ( v83 )
            {
              if ( v70 )
                return sub_404360((__int64)v9, v79, s);
              v46 = v79 != 0 && v10 == 0;
              if ( v46 )
              {
                v10 = v79;
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_407A30((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_405590(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_60C2B0 <= a1 )
  {
    ...
    {
      LODWORD(v10) = sub_406530(off_60C298, v9);
      off_60C298 = v10;
      v7 = v10;
    }
  ...
  v23 = *(_DWORD *)(v5 + 4) | 1;
  v13 = *(_QWORD *)v11;
  v14 = sub_404360(v12, *(_QWORD *)v11, v21, v4, *(_DWORD *)v5, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v13 <= v14 )
  {
    v15 = v14 + 1;
    *(_QWORD *)v11 = v14 + 1;
    if ( (_UNKNOWN *)v12 != &unk_60C340 )
    {
      v16 = v14 + 1;
      free(v12);
      v15 = v16;
    }
    LODWORD(v17) = sub_4064D0(v15);
    v18 = *(_DWORD *)v5;
    *(_QWORD *)(v11 + 8) = v17;
    v12 = v17;
    sub_404360(v17, v15, v21, v4, v18, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v22;
  return v12;
}
...
_BYTE *__fastcall sub_405AB0(int a1, int a2, char *a3)
{
...
_BYTE *__fastcall sub_405B90(int a1, char *a2)
{
  return sub_405AB0(0, a1, a2);
}

_BYTE *__fastcall sub_405BB0(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  v7 = qword_60C470;
  v4 = _mm_load_si128((const __m128i *)&xmmword_60C440);
  v5 = _mm_load_si128((const __m128i *)&xmmword_60C450);
  v6 = _mm_load_si128((const __m128i *)&xmmword_60C460);
  v4.m128i_i32[(a3 >> 5) + 2] ^= (~(unsigned __int8)((unsigned __int32)v4.m128i_i32[(a3 >> 5) + 2] >> (a3 & 0x1F)) & 1) << (a3 & 0x1F);
  return sub_405590(0, a1, a2, (__int64)&v4);
}

_BYTE *__fastcall sub_405C30(char *a1)
{
  return sub_405BB0(a1, 0xFFFFFFFFFFFFFFFFLL, 0x3Au);
}

_BYTE *__fastcall sub_405C60(int a1, int a2, char *a3)
{
  int v4; // [sp+0h] [bp-48h]@2
  int v5; // [sp+4h] [bp-44h]@2
  __int64 v6; // [sp+8h] [bp-40h]@2
...
int __fastcall sub_405F30(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12@1
  __int64 v7; // rbx@1
  char *v8; // rax@3
...
int __fastcall sub_406390(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  char *v7; // r10@1
  signed int v8; // er8@1
  __int64 v9; // r9@1
  ...
  do
  {
    if ( (unsigned int)v8 <= 0x2F )
    {
      ...
      v15[v9] = v11;
      if ( !v11 )
        return sub_405F30(a1, a2, a3, a4, (__int64)v15, v9);
      goto LABEL_3;
    }
    v12 = (__int64 *)v7;
    v7 += 8;
...
void *__fastcall sub_4066D0(const void *a1, size_t a2)
{
  void *v2; // rax@1
...
void *__fastcall sub_406700(const char *a1)
{
  size_t v1; // rax@1

  v1 = strlen(a1);
  return sub_4066D0(a1, v1 + 1);
}

noreturn void  sub_406720()
{
  char *v0; // rax@1
...
char *__fastcall sub_406790(char *a1, unsigned __int64 a2)
{
  char *v3; // rbx@7
  __dev_t v4; // r15@8
  __ino_t v5; // r14@8
...
__int64 __fastcall sub_406C60(__int64 a1, __int64 a2)
{
...
signed __int64 __fastcall sub_406D40(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8, __int64 a9)
{
  const char *v9; // r14@1
  char *v10; // rbp@1
  size_t v11; // r13@5
...
__int64 __fastcall sub_407360(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8)
{
  int v8; // er13@1
  signed int v9; // eax@2
  int v10; // ebp@2
    ...
    if ( *(_BYTE *)v21 == 45 )
    {
      ...
      if ( v36 )
      {
        if ( v53 )
        {
          ...
          {
            *(_QWORD *)(a7 + 32) = v21 + 2;
            v40 = sub_406D40(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"--");
            goto LABEL_72;
          }
          if ( a6 )
          {
            ...
            {
              *(_QWORD *)(a7 + 32) = v21 + 1;
              v26 = sub_406D40(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"-");
              if ( v26 != -1 )
...
LABEL_71:
        *(_QWORD *)(a7 + 32) = v28;
        *(_QWORD *)(a7 + 16) = 0LL;
        v40 = sub_406D40(v10, v11, v12, v53, v54, 0, a7, v8, (__int64)"-W ");
LABEL_72:
        return v40;
      }
      v39 = *(_DWORD *)a7;
...
__int64 __fastcall sub_407930(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax@1

  dword_60C480 = dword_60C2BC;
  dword_60C484 = dword_60C2B8;
  result = sub_407360(a1, a2, a3, a4, a5, a6, (__int64)&dword_60C480, a7);
...
__int64 __fastcall sub_4079B0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5)
{
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_407D70(0LL, v6) )
  {
    v4 = 1LL;
...
signed __int64 __fastcall sub_407C20(_BYTE *a1)
{
...
_BYTE *__fastcall sub_407C80(void *src)
{
...
unsigned __int64 __fastcall sub_407DD0(_BYTE *a1, unsigned __int64 a2)
{
  __int64 v2; // rcx@1
...
int __fastcall sub_408380(FILE *stream)
{
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_408400(stream) )
  {
...
int __fastcall sub_408400(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_408440(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
int __fastcall sub_408510(__int64 a1)
{
  __int64 v1; // rdx@1
