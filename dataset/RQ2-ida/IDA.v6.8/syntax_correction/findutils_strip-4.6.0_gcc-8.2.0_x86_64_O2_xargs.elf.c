...
signed __int64 __usercall sub_404120(const char **a1, unsigned int a2, char a3, __int64 a4)
{
  const char **v4; // rbp@1
...
signed __int64 __usercall sub_405B80(unsigned __int64 a1, _QWORD *a2, __int64 a3, _BYTE *a4, __int64 a5)
{
  _BYTE *v5; // rbx@2
  void *v6; // rsp@3
...
LABEL_39:
        ...
        *(mbstate_t *)((char *)&ps + 4) = 0LL;
        ...
        if ( mbsinit((mbstate_t *)((char *)&ps + 4)) )
        {
          ...
          LODWORD(v68) = sub_40B170(&v107, v66, v67, &ps);
          v105 = v68;
          if ( v68 == (void *)-1 )
          {
            v105 = (void *)1;
...
LABEL_55:
              ...
              LODWORD(v43) = sub_40B170(&v107, v41, v42, &ps);
              v105 = v43;
              if ( v43 == (void *)-1 )
              {
                v105 = (void *)1;
...
LABEL_65:
              ...
              LODWORD(v48) = sub_40B170((char *)&v100.m128i_i64[0] + 4, v46, v47, &v98[0]);
              s1[1] = v48;
              if ( v48 == (void *)-1 )
              {
                s1[1] = (void *)1;
