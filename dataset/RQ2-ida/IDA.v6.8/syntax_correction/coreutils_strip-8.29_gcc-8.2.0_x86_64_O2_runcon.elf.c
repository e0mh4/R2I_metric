...
int sub_401891()
{
  ...
  if ( !byte_609248 )
  {
    while ( qword_609250 < (unsigned __int64)(((&unk_608E48 - (_UNKNOWN *)&qword_608E40) >> 3) - 1) )
      (*(&qword_608E40 + ++qword_609250))();
    result = sub_40183B();
    byte_609248 = 1;
  }
  return result;
...
noreturn void __fastcall  sub_4018F0(int status)
{
  ...
  {
    v22 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v22, &unk_405841, "https://www.gnu.org/software/coreutils/");
    v23 = setlocale(5, 0LL);
  ...
  {
    v27 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v27, &unk_405841, "https://www.gnu.org/software/coreutils/");
    v28 = setlocale(5, 0LL);
    if ( !v28 || !strncmp(v28, "en_", 3uLL) )
    {
      ...
      __printf_chk(1LL, v29, "https://www.gnu.org/software/coreutils/", "runcon");
LABEL_15:
...
LABEL_3:
  ...
  __printf_chk(1LL, v30, "runcon", v31);
LABEL_13:
  v24 = "Multi-call invocation" + 10;
  v25 = dcgettext(0LL, "Full documentation at: <%s%s>\n", 5);
  __printf_chk(1LL, v25, "https://www.gnu.org/software/coreutils/", "runcon");
  if ( v21 != "runcon" )
    v24 = "";
  goto LABEL_15;
}
...
__int64 sub_401C50()
{
  ...
  if ( (unsigned int)sub_404FB0(stdout) )
  {
    ...
    if ( !byte_609258 || *v0 != 32 )
    {
      ...
      if ( qword_609260 )
      {
        LODWORD(v5) = sub_403760(qword_609260, "write error");
...
_BYTE *__fastcall sub_4030C0(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_609210 <= a1 )
  {
    ...
    if ( off_6091F8 == &xmmword_609200 )
    {
      ...
      v7 = v20;
      off_6091F8 = v20;
      *v20 = (__int128)_mm_load_si128((const __m128i *)&xmmword_609200);
    }
    else
    {
      LODWORD(v10) = sub_403F30(off_6091F8, v9);
      off_6091F8 = v10;
      v7 = v10;
    }
...
_BYTE *__fastcall sub_4036E0(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  v7 = qword_6093B0;
  v4 = _mm_load_si128((const __m128i *)&xmmword_609380);
  v5 = _mm_load_si128((const __m128i *)&xmmword_609390);
...
int __fastcall sub_403D90(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  char *v7; // r10@1
  signed int v8; // er8@1
  __int64 v9; // r9@1
  ...
  do
  {
    if ( (unsigned int)v8 <= 0x2F )
    {
      ...
      v15[v9] = v11;
      if ( !v11 )
        return sub_403930(a1, a2, a3, a4, (__int64)v15, v9);
      goto LABEL_3;
    }
    v12 = (__int64 *)v7;
    v7 += 8;
...
__int64 __fastcall sub_404E30(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  ...
  result = sub_404860(a1, a2, a3, a4, a5, a6, (__int64)&dword_6093C0, a7);
