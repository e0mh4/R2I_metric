...
__int64 __fastcall main(unsigned int a1, char **a2, char **a3)
{
  ...
  int v6; // ebp@17
  __int64 v7; // rax@19
  const char *v8; // rcx@19
  char v9; // dl@22
  char v10; // dl@24
  char **v11; // rax@33
  char *v12; // rax@33
  __int64 (__fastcall *v13)(); // rax@41
  char v14; // bl@43
  int *v16; // rax@52

  v3 = (const char *)&unk_4063FA;
  v4 = a2;
  sub_402860(*a2, a2, a3);
  setlocale(6, &s1);
  bindtextdomain(
  ...
  while ( 1 )
  {
    ...
    if ( v10 <= 102 )
    {
      ...
      if ( v10 )
        goto LABEL_47;
      qword_6092B8 = v7;
      LODWORD(v11) = sub_404300(0LL, 6LL, v3);
      v4 = v11;
      v12 = dcgettext(0LL, "delimiter list ends with an unescaped backslash: %s", 5);
      error(1, 0, v12, v4);
    }
    if ( v10 == 114 )
    {
...
LABEL_21:
  ...
  qword_6092B8 = v7;
  v13 = (__int64 (__fastcall *)())&loc_401B20;
  if ( !byte_6092C8 )
    v13 = sub_401E70;
  v14 = ((int (__fastcall *)(_QWORD, char **))v13)(v6, &v4[dword_60927C]);
  free(ptr);
...
__int64 sub_401AF0()
{
  ...
  FILE *v28; // rax@37
  __int64 v29; // rsi@39
  unsigned int v30; // ST0C_4@39
  int v31; // eax@39
  __int64 v32; // rdx@39
  __int64 v33; // rcx@39
  __int64 v34; // r8@39
  unsigned int v35; // ST0C_4@41
  int v36; // eax@41
  unsigned int v37; // ST0C_4@43
  int v38; // eax@43
  int v39; // ST0C_4@45
  int v40; // eax@45
  int *v41; // [sp+0h] [bp-50h]@1
  char errnum; // [sp+8h] [bp-48h]@1

  v0 = dcgettext(0LL, "write error", 5);
  v1 = (const char **)(unsigned int)*__errno_location();
  error(1, (int)v1, v0);
  v2 = 1LL;
  v3 = v1;
  errnum = 1;
  ...
  do
  {
    ...
    do
    {
      if ( !v6 )
        break;
      v4 = (const unsigned __int8)*v8 < *v7;
      v5 = *v8++ == *v7++;
      --v6;
    }
    while ( v5 );
    ...
    v11 = v10->_IO_read_ptr;
    v12 = v10->_IO_read_end;
    v13 = (char *)ptr;
    if ( v11 < v12 )
    {
      v14 = v11 + 1;
      v10->_IO_read_ptr = v11 + 1;
...
LABEL_13:
      if ( v12 > v14 )
      {
        v10->_IO_read_ptr = v14 + 1;
        LODWORD(v17) = (unsigned __int8)*v14;
        goto LABEL_15;
      }
      LODWORD(v17) = __uflow(v10);
      if ( (_DWORD)v17 == -1 )
        break;
LABEL_15:
      if ( (unsigned __int8)byte_6091F0 == v15 )
      {
        v16 = *v13;
        if ( *v13 )
        {
...
LABEL_10:
      ...
      if ( v19 >= stdout->_IO_write_end )
      {
        ...
        v30 = v17;
        v31 = __overflow(stdout, (unsigned __int8)v15);
        v17 = v30;
        if ( v31 < 0 )
          goto LABEL_40;
      }
...
LABEL_12:
    ...
    v29 = (unsigned __int8)v15;
    v39 = *v41;
    v40 = __overflow(stdout, (unsigned __int8)v15);
    ...
    if ( v40 < 0 )
    {
      ...
      {
LABEL_40:
        v16 = sub_401AF0(v18, v29, v32, v33, v34, v17);
LABEL_41:
        v29 = v16;
        v35 = v17;
        v36 = __overflow(v18, v16);
        v17 = v35;
      }
      while ( v36 < 0 );
      goto LABEL_10;
...
LABEL_20:
    ...
    if ( v21 >= stdout->_IO_write_end )
    {
      ...
      v37 = v17;
      v38 = __overflow(stdout, (unsigned __int8)v20);
      v17 = v37;
      if ( v38 < 0 )
        goto LABEL_40;
    }
...
LABEL_36:
      v26 = v17;
      LODWORD(v27) = sub_404300(0LL, 3LL, *v3);
      error(0, v26, "%s", v27, v41);
      errnum = 0;
    }
LABEL_23:
    if ( !v9 )
    ...
    if ( (unsigned int)sub_404CD0(v10) == -1 )
    {
LABEL_30:
      LODWORD(v24) = sub_404300(0LL, 3LL, *v3);
      error(0, *v41, "%s", v24, v41);
      errnum = 0;
    }
LABEL_25:
    ++v3;
  ...
  while ( v2 );
  return (unsigned __int8)errnum;
}

__int64 __fastcall sub_401E70(unsigned __int64 a1, const char **a2)
{
  ...
  bool v9; // cf@4
  bool v10; // zf@4
  unsigned __int64 v11; // r14@4
  signed __int64 v12; // rcx@6
  _BYTE *v13; // rdi@6
  const char *v14; // rsi@6
  FILE *v15; // r15@10
  char v16; // al@11
  unsigned __int64 v17; // r15@16
  FILE **v18; // r13@17
  unsigned __int64 v19; // rbp@17
  size_t v20; // r12@17
  _BYTE *v21; // rbx@17
  _IO_FILE *v22; // r10@17
  char *v23; // rax@18
  ...
  __int64 v45; // rax@80
  __int64 v46; // rbx@80
  char v47; // [sp+4h] [bp-74h]@17
  FILE *ptr; // [sp+8h] [bp-70h]@1
  int v49; // [sp+10h] [bp-68h]@60
  char v50; // [sp+1Bh] [bp-5Dh]@4
  int errnum; // [sp+1Ch] [bp-5Ch]@60
  const char **v52; // [sp+20h] [bp-58h]@1
  FILE *stream; // [sp+28h] [bp-50h]@60
  FILE **v54; // [sp+30h] [bp-48h]@3
  int *v55; // [sp+38h] [bp-40h]@60

  v2 = a1;
  v3 = a1 + 2;
  v52 = a2;
  LODWORD(v4) = sub_404A40(v3);
  ptr = v4;
  v5 = (v2 + 1) >> 61;
  LOBYTE(v6) = v5 != 0;
    ...
    do
    {
      while ( 1 )
      {
        ...
        do
        {
          if ( !v12 )
            break;
          v9 = (const unsigned __int8)*v14 < *v13;
          v10 = *v14++ == *v13++;
          --v12;
        }
        while ( v10 );
...
LABEL_14:
    if ( v50 )
    {
      ...
      v44 = dcgettext(0LL, "standard input is closed", 5);
      error(1, 0, v44);
LABEL_80:
      LODWORD(v45) = sub_404300(0LL, 3LL, *v8);
      v46 = v45;
      v3 = 1LL;
      a2 = (const char **)(unsigned int)*__errno_location();
      error(1, (int)a2, "%s", v46);
LABEL_81:
      sub_404C90(v3, a2, v6, v5);
    }
    v17 = v11;
    v50 = 1;
    while ( 1 )
...
LABEL_17:
      ...
      v20 = 0LL;
      v47 = 0;
      v21 = ptr/*INVALID_COLON*/;
      v22 = *v54;
      if ( !*v54 )
        goto LABEL_39;
LABEL_18:
      v23 = v22->_IO_read_ptr;
      if ( v22->_IO_read_end > v23 )
      {
        v22->_IO_read_ptr = v23 + 1;
...
LABEL_20:
          v25 = ptr;
          v26 = v24;
          v27 = fwrite_unlocked(ptr, 1uLL, v20, stdout);
          v24 = v26;
          if ( v20 != v27 )
            goto LABEL_30;
          v20 = 0LL;
...
LABEL_22:
        LOBYTE(v28) = v24;
        if ( v24 == (unsigned __int8)byte_6091F0 )
        {
          if ( v11 == v19 )
            goto LABEL_46;
        }
        else
        {
          do
          {
            ...
            else if ( __overflow(stdout, (unsigned __int8)v28) < 0 )
            {
              goto LABEL_30;
            }
            v25 = *v18;
            v29 = (*v18)->_IO_read_ptr;
            if ( v29 >= (*v18)->_IO_read_end )
            {
              while ( 2 )
              {
                v28 = __uflow(v25);
...
LABEL_48:
                  ...
                  if ( __overflow(stdout, (unsigned __int8)v24) >= 0 )
                    goto LABEL_48;
LABEL_30:
                  sub_401AF0();
                  continue;
            ...
            {
              v25->_IO_read_ptr = v29 + 1;
              v28 = (unsigned __int8)*v29;
            }
          }
          while ( (unsigned __int8)byte_6091F0 != v28 );
          LOBYTE(v24) = v28;
          if ( v11 == v19 )
            goto LABEL_46;
        }
LABEL_33:
        ...
        if ( *v21 )
        {
          ...
          {
            if ( __overflow(stdout, (unsigned __int8)v31) < 0 )
              goto LABEL_30;
          }
          else
          {
        ...
        v47 = 1;
        v32 = v21 + 1;
        if ( (_BYTE *)qword_6092B8 == v21 + 1 )
          v32 = ptr/*INVALID_COLON*/;
        v21 = v32;
        goto LABEL_37;
      }
      stream = v22;
      ...
      {
        LODWORD(v42) = sub_404300(0LL, 3LL, v52[v19 - 1]);
        error(0, errnum, "%s", v42);
        v50 = 0;
        v41 = stream;
        if ( stream != stdin )
        {
LABEL_64:
          if ( (unsigned int)sub_404CD0(v41) == -1 )
          {
            LODWORD(v43) = sub_404300(0LL, 3LL, v52[v19 - 1]);
            error(0, *v55, "%s", v43);
            v50 = 0;
          }
          goto LABEL_66;
...
LABEL_39:
      ...
      {
        if ( *v21 )
          *((_BYTE *)&ptr->_flags + v20++) = *v21;
        if ( (_BYTE *)qword_6092B8 == ++v21 )
          v21 = ptr/*INVALID_COLON*/;
LABEL_37:
        v33 = v11 > v19;
        ++v18;
      ...
      if ( v47 )
      {
        ...
        {
          v25 = ptr;
          if ( v20 != fwrite_unlocked(ptr, 1uLL, v20, stdout) )
            goto LABEL_30;
          v35 = stdout;
        }
        v36 = byte_6091F0;
        v37 = v35->_IO_write_ptr;
        if ( v37 >= v35->_IO_write_end )
        {
          v25 = v35;
          if ( __overflow(v35, (unsigned __int8)byte_6091F0) < 0 )
            goto LABEL_30;
        }
        else
        {
          v35->_IO_write_ptr = v37 + 1;
          *v37 = v36;
        }
      }
LABEL_55:
...
noreturn void __fastcall  sub_4023E0(int status)
{
  ...
  {
    v26 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v26, &unk_4063E5);
    v27 = setlocale(5, 0LL);
  ...
  {
    v30 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v30, &unk_4063E5);
    v31 = setlocale(5, 0LL);
...
__int64 sub_402780()
{
  ...
  if ( (unsigned int)sub_405C40(stdout) )
  {
    ...
    if ( !byte_6092D0 || *v0 != 32 )
    {
      ...
      if ( qword_6092D8 )
      {
        LODWORD(v5) = sub_4042D0(qword_6092D8, "write error");
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_405BC0((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_403C30(__int64 a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_609270 <= (signed int)a1 )
  {
    ...
    {
      LODWORD(v22) = sub_404AA0(0LL, v11);
      v9 = v22;
      off_609258 = v22;
      *v22 = (__int128)_mm_load_si128((const __m128i *)&xmmword_609260);
    }
    else
    {
      LODWORD(v12) = sub_404AA0(off_609258, v11);
      off_609258 = v12;
      v9 = v12;
    }
    memset(&v9[dword_609270], 0, 16LL * ((signed int)a1 + 1 - dword_609270));
    dword_609270 = a1 + 1;
  }
  ...
  v25 = *(_DWORD *)(v5 + 4) | 1;
  v15 = *(_QWORD *)v13;
  v16 = sub_402A00(v14, *(_QWORD *)v13, v23, v4, *(_DWORD *)v5, v25, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v15 <= v16 )
  {
    v17 = v16 + 1;
    *(_QWORD *)v13 = v16 + 1;
    if ( (_UNKNOWN *)v14 != &unk_609300 )
    {
      v18 = v16 + 1;
      free(v14);
      v17 = v18;
    }
    LODWORD(v19) = sub_404A40(v17);
    v20 = *(_DWORD *)v5;
    *(_QWORD *)(v13 + 8) = v19;
    v14 = v19;
    sub_402A00(v19, v17, v23, v4, v20, v25, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v10 = v24;
  return v14;
}
...
_BYTE *__fastcall sub_404250(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  return sub_403C30(0LL, a1, a2, (__int64)&v4);
}
...
int __fastcall sub_4044A0(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12@1
  __int64 v7; // rbx@1
  char *v8; // rax@3
...
int __fastcall sub_404900(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  char *v7; // r10@1
  signed int v8; // er8@1
  __int64 v9; // r9@1
  ...
  do
  {
    if ( (unsigned int)v8 <= 0x2F )
    {
      ...
      v15[v9] = v11;
      if ( !v11 )
        return sub_4044A0(a1, a2, a3, a4, (__int64)v15, v9);
      goto LABEL_3;
    }
    v12 = (__int64 *)v7;
    v7 += 8;
...
void *__fastcall sub_404C40(const void *a1, size_t a2)
{
  void *v2; // rax@1
...
void *__fastcall sub_404C70(const char *a1)
{
  size_t v1; // rax@1

  v1 = strlen(a1);
  return sub_404C40(a1, v1 + 1);
}
...
int __fastcall sub_404CD0(FILE *stream)
{
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_404D50(stream) )
  {
...
int __fastcall sub_404D50(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_404D90(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
__int64 __fastcall sub_404DF0(__int64 a1, __int64 a2)
{
...
signed __int64 __fastcall sub_404ED0(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8, __int64 a9)
{
  const char *v9; // r14@1
  char *v10; // rbp@1
  size_t v11; // r13@5
...
__int64 __fastcall sub_4054F0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8)
{
  int v8; // er13@1
  signed int v9; // eax@2
  int v10; // ebp@2
    ...
    if ( *(_BYTE *)v21 == 45 )
    {
      ...
      if ( v36 )
      {
        if ( v53 )
        {
          ...
          {
            *(_QWORD *)(a7 + 32) = v21 + 2;
            v40 = sub_404ED0(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"--");
            goto LABEL_72;
          }
          if ( a6 )
          {
            ...
            {
              *(_QWORD *)(a7 + 32) = v21 + 1;
              v26 = sub_404ED0(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"-");
              if ( v26 != -1 )
...
LABEL_71:
        *(_QWORD *)(a7 + 32) = v28;
        *(_QWORD *)(a7 + 16) = 0LL;
        v40 = sub_404ED0(v10, v11, v12, v53, v54, 0, a7, v8, (__int64)"-W ");
LABEL_72:
        return v40;
      }
      v39 = *(_DWORD *)a7;
...
__int64 __fastcall sub_405AC0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax@1

  dword_609440 = dword_60927C;
  dword_609444 = dword_609278;
  result = sub_4054F0(a1, a2, a3, a4, a5, a6, (__int64)&dword_609440, a7);
...
__int64 __fastcall sub_405B40(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5)
{
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_405CA0(0LL, v6) )
  {
    v4 = 1LL;
...
int __fastcall sub_4062E0(__int64 a1)
{
  __int64 v1; // rdx@1
