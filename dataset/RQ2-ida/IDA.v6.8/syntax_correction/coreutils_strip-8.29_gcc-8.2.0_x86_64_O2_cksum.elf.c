...
__int64 __fastcall main(int a1, char **a2, char **a3)
{
  ...
  sub_402010(a1);
  if ( sub_405400((unsigned int)a1, a2, "", &unk_406700, 0LL) != -1 )
    sub_401BD0(1);
  byte_609278 = 0;
  if ( dword_60923C == a1 )
    goto LABEL_10;
  ...
  {
    v3 = &a2[dword_60923C];
    v4 = &(&a2[dword_60923C + 1])[8 * (unsigned __int64)(unsigned int)(a1 + ~dword_60923C)];
    v5 = 1;
    do
    {
      v6 = *v3;
...
int sub_4018C1()
{
  ...
  if ( !byte_609268 )
  {
    while ( qword_609270 < (unsigned __int64)(((&unk_608E48 - (_UNKNOWN *)&qword_608E40) >> 3) - 1) )
      (*(&qword_608E40 + ++qword_609270))();
    result = sub_40186B();
    byte_609268 = 1;
  }
  return result;
...
__int64 __fastcall sub_401920(char *filename, char a2)
{
  ...
  __int64 v22; // r8@17
  __int64 v23; // rdx@18
  unsigned __int64 v24; // rdx@19
  unsigned int v25; // ebx@22
  __int64 v27; // rax@25
  __int64 v28; // rbx@25
  int *v29; // rax@25
  __int64 v30; // rcx@25
  ...
  char *v42; // rbx@36
  int *v43; // rax@36
  __int64 v44; // [sp+0h] [bp-10058h]@17
  char ptr[65592]; // [sp+20h] [bp-10038h]@7
  ...
  do
  {
    if ( !v2 )
      break;
    v7 = (unsigned __int8)*v4 < (unsigned __int8)*v6;
    v8 = *v4++ == *v6++;
    --v2;
  }
  while ( v8 );
  ...
  do
  {
    v12 = fread_unlocked(ptr, 1uLL, 0x10000uLL, v9);
    if ( !v12 )
    {
      v16 = 0;
      v17 = (v9->_flags & 0x20) == 0;
      if ( !(v9->_flags & 0x20) )
        goto LABEL_13;
      goto LABEL_28;
    }
    v7 = __CFADD__(v12, v10);
    v10 += v12;
    if ( v7 )
    {
      LODWORD(v39) = sub_403BC0(0LL, 3LL, v5);
      v40 = v39;
      v41 = dcgettext(0LL, "%s: file too long", 5);
      error(1, 0, v41, v40);
      goto LABEL_36;
    }
    v13 = &ptr[v12];
    v14 = ptr;
    do
      v11 = qword_405F00[(unsigned __int64)(unsigned __int8)(*(++v14 - 1) ^ (v11 >> 24))] ^ (v11 << 8);
    while ( v14 != v13 );
    v15 = v9->_flags;
  }
  while ( !(v9->_flags & 0x10) );
  v16 = 0;
  v17 = (v15 & 0x20) == 0;
  if ( !(v15 & 0x20) )
  {
LABEL_13:
    ...
    do
    {
      if ( !v18 )
        break;
      v16 = (unsigned __int8)*v19 < (unsigned __int8)*v20;
      v17 = *v19++ == *v20++;
      --v18;
    }
    while ( v17 );
    if ( (!v16 && !v17) != v16 && (unsigned int)sub_404590(v9) == -1 )
    {
LABEL_25:
      LODWORD(v27) = sub_403BC0(0LL, 3LL, v5);
      v28 = v27;
    ...
    for ( LODWORD(v21) = sub_401FC0(v10, &v44); v10; v11 = qword_405F00[v23] ^ (v11 << 8) )
    {
      v23 = (unsigned __int8)(v10 ^ (v11 >> 24));
      v10 >>= 8;
    }
    v24 = ~v11;
    if ( v3 )
    ...
    if ( !(stdout->_flags & 0x20) )
      return 1;
LABEL_36:
    v42 = dcgettext(0LL, "write error", 5);
    v43 = __errno_location();
    error(1, *v43, "-: %s", v42);
    sub_401BD0(1);
  }
LABEL_28:
  LODWORD(v31) = sub_403BC0(0LL, 3LL, v5);
  v32 = v31;
  ...
  do
  {
    if ( !v36 )
      break;
    v34 = (unsigned __int8)*v37 < (unsigned __int8)*v38;
    v35 = *v37++ == *v38++;
    --v36;
  }
  while ( v35 );
...
noreturn void __fastcall  sub_401BD0(int status)
{
  ...
  __int64 v33; // rcx@20
  __int64 v34; // r8@20
  const char *v35; // [sp+0h] [bp-88h]@4
  const char *v36; // [sp+8h] [bp-80h]@4
  const char *v37; // [sp+10h] [bp-78h]@4
  const char *v38; // [sp+18h] [bp-70h]@4
  const char *v39; // [sp+20h] [bp-68h]@4
  const char *v40; // [sp+28h] [bp-60h]@4
  const char *v41; // [sp+30h] [bp-58h]@4
  const char *v42; // [sp+38h] [bp-50h]@4
  const char *v43; // [sp+40h] [bp-48h]@4
  const char *v44; // [sp+48h] [bp-40h]@4
  const char *v45; // [sp+50h] [bp-38h]@4
  const char *v46; // [sp+58h] [bp-30h]@4
  __int64 v47; // [sp+60h] [bp-28h]@4
  __int64 v48; // [sp+68h] [bp-20h]@4
  ...
  v4 = dcgettext(0LL, "Usage: %s [FILE]...\n  or:  %s [OPTION]\n", 5);
  __printf_chk(1LL, v4, v2, v2, v5);
  v6 = stdout;
  v7 = dcgettext(0LL, "Print CRC checksum and byte counts of each FILE.\n\n", 5);
  ...
  {
    v19 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v19, &unk_405CB5, "https://www.gnu.org/software/coreutils/", v20);
    v21 = setlocale(5, 0LL);
  ...
  {
    v27 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v27, &unk_405CB5, "https://www.gnu.org/software/coreutils/", v28);
    v29 = setlocale(5, 0LL);
    if ( !v29 || !strncmp(v29, "en_", 3uLL) )
    {
      ...
      __printf_chk(1LL, v30, "https://www.gnu.org/software/coreutils/", "cksum", v31);
LABEL_15:
      v25 = dcgettext(0LL, "or available locally via: info '(coreutils) %s%s'\n", 5);
      __printf_chk(1LL, v25, v18, v22, v26);
LABEL_3:
      exit(v1);
    }
    v18 = "cksum";
  ...
  __printf_chk(1LL, v32, "cksum", v33, v34);
LABEL_13:
  v22 = "Multi-call invocation" + 10;
  v23 = dcgettext(0LL, "Full documentation at: <%s%s>\n", 5);
  __printf_chk(1LL, v23, "https://www.gnu.org/software/coreutils/", "cksum", v24);
  if ( v18 != "cksum" )
    v22 = "";
  goto LABEL_15;
}
...
__int64 sub_401EE0()
{
  ...
  if ( (unsigned int)sub_405500(stdout) )
  {
    ...
    if ( !byte_609280 || *v0 != 32 )
    {
      ...
      if ( qword_609288 )
      {
        LODWORD(v5) = sub_403B90(qword_609288, "write error");
...
signed __int64 __fastcall sub_401FC0(unsigned __int64 a1, __int64 a2)
{
  signed __int64 v2; // rcx@1
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_405480((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_4034F0(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_609230 <= a1 )
  {
    ...
    {
      LODWORD(v20) = sub_404360(0LL, v9);
      v7 = v20;
      off_609218 = v20;
      *v20 = (__int128)_mm_load_si128((const __m128i *)&xmmword_609220);
    }
    else
    {
      LODWORD(v10) = sub_404360(off_609218, v9);
      off_609218 = v10;
      v7 = v10;
    }
  ...
  v23 = *(_DWORD *)(v5 + 4) | 1;
  v13 = *(_QWORD *)v11;
  v14 = sub_4022C0(v12, *(_QWORD *)v11, v21, v4, *(_DWORD *)v5, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v13 <= v14 )
  {
    v15 = v14 + 1;
    *(_QWORD *)v11 = v14 + 1;
    if ( (_UNKNOWN *)v12 != &unk_6092A0 )
    {
      v16 = v14 + 1;
      free(v12);
      v15 = v16;
    }
    LODWORD(v17) = sub_404300(v15);
    v18 = *(_DWORD *)v5;
    *(_QWORD *)(v11 + 8) = v17;
    v12 = v17;
    sub_4022C0(v17, v15, v21, v4, v18, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v22;
  return v12;
}
...
_BYTE *__fastcall sub_403B10(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  v7 = qword_6093D0;
  v4 = _mm_load_si128((const __m128i *)&xmmword_6093A0);
  v5 = _mm_load_si128((const __m128i *)&xmmword_6093B0);
  ...
  return sub_4034F0(0, a1, a2, (__int64)&v4);
}
...
int __fastcall sub_403D60(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12@1
  __int64 v7; // rbx@1
  char *v8; // rax@3
...
int __fastcall sub_404160(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v5; // r9@1
  __int64 *v6; // r10@2
  __int64 v7; // rax@2
  ...
  do
  {
    ...
    if ( *(_DWORD *)a5 <= 0x2Fu )
    {
      ...
      *(_DWORD *)a5 = v8 + 8;
      ...
      v12[v5] = *v6;
      if ( !v7 )
        return sub_403D60(a1, a2, a3, a4, (__int64)v12, v5);
      goto LABEL_3;
    }
    v9 = *(__int64 **)(a5 + 8);
    *(_QWORD *)(a5 + 8) = v9 + 1;
...
void *__fastcall sub_404500(const void *a1, size_t a2)
{
  void *v2; // rax@1
...
int __fastcall sub_404590(FILE *stream)
{
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_404610(stream) )
  {
...
int __fastcall sub_404610(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_404650(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
__int64 __fastcall sub_4046B0(__int64 a1, __int64 a2)
{
...
signed __int64 __fastcall sub_404790(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8, __int64 a9)
{
  const char *v9; // r14@1
  char *v10; // rbp@1
  size_t v11; // r13@5
...
__int64 __fastcall sub_404DB0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8)
{
  int v8; // er13@1
  signed int v9; // eax@2
  int v10; // ebp@2
    ...
    if ( *(_BYTE *)v21 == 45 )
    {
      ...
      if ( v36 )
      {
        if ( v53 )
        {
          ...
          {
            *(_QWORD *)(a7 + 32) = v21 + 2;
            v40 = sub_404790(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"--");
            goto LABEL_72;
          }
          if ( a6 )
          {
            ...
            {
              *(_QWORD *)(a7 + 32) = v21 + 1;
              v26 = sub_404790(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"-");
              if ( v26 != -1 )
...
LABEL_71:
        *(_QWORD *)(a7 + 32) = v28;
        *(_QWORD *)(a7 + 16) = 0LL;
        v40 = sub_404790(v10, v11, v12, v53, v54, 0, a7, v8, (__int64)"-W ");
LABEL_72:
        return v40;
      }
      v39 = *(_DWORD *)a7;
...
__int64 __fastcall sub_405380(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax@1

  dword_6093E0 = dword_60923C;
  dword_6093E4 = dword_609238;
  result = sub_404DB0(a1, a2, a3, a4, a5, a6, (__int64)&dword_6093E0, a7);
...
__int64 __fastcall sub_405400(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5)
{
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_405560(0LL, v6) )
  {
    v4 = 1LL;
...
int __fastcall sub_405BA0(__int64 a1)
{
  __int64 v1; // rdx@1
