...
#define __asm__(x)
__int64 __usercall main(char **a1, char **a2, int a3, signed __int64 a4)
{
  int v4; // er12@1
...
bool __usercall sub_405690(long double *a1, void (__fastcall *a2)(_QWORD, _QWORD), _BYTE *a3, _QWORD *a4, long double a5)
{
