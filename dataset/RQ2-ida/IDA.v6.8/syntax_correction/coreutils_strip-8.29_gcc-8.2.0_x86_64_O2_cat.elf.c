...
__int64 __fastcall main(unsigned int a1, char **a2, char **a3)
{
  int v3; // eax@2
  char *v4; // rbx@30
  unsigned __int64 v5; // r15@31
  bool v6; // cf@33
  bool v7; // zf@33
  const char *v8; // rax@34
  int v9; // ebp@35
  __int64 v10; // rax@35
  __int64 v11; // r12@35
  int *v12; // rax@35
  ...
  char *v20; // rdi@45
  signed __int64 v21; // rcx@45
  const char *v22; // rsi@45
  int v23; // ebp@48
  __blksize_t v24; // rax@51
  char *v25; // rsi@53
  signed __int64 v26; // r14@54
  char v27; // r13@55
  char *v28; // rax@56
  char *v29; // r12@56
  signed __int64 v30; // rdi@56
  void *v31; // rax@56
  char *v32; // r13@56
  unsigned __int64 v33; // r14@56
  char *v34; // rbp@56
  char *v35; // r14@56
  int v36; // ebp@61
  __int64 v37; // rax@62
  ...
  signed __int64 v42; // rax@79
  char *v43; // r12@90
  signed __int64 v44; // rdx@94
  char *v45; // rax@99
  signed __int64 v46; // rax@100
  signed __int64 v47; // rcx@101
  int *v48; // rax@111
  int v49; // er9@111
  __int64 v50; // rax@119
  __int64 v51; // rbp@119
  ...
  char *v83; // rbx@151
  int *v84; // rax@151
  char v85; // [sp+8h] [bp-160h]@1
  char v86; // [sp+9h] [bp-15Fh]@1
  __int16 v87; // [sp+Ah] [bp-15Eh]@1
  int v88; // [sp+Ch] [bp-15Ch]@0
  char *buf; // [sp+10h] [bp-158h]@56
  char *v90; // [sp+18h] [bp-150h]@56
  size_t nbytes; // [sp+28h] [bp-140h]@53
  char **v92; // [sp+30h] [bp-138h]@1
  signed __int64 v93; // [sp+38h] [bp-130h]@56
  char *v94; // [sp+40h] [bp-128h]@56
  signed int v95; // [sp+48h] [bp-120h]@1
  char v96; // [sp+4Ch] [bp-11Ch]@56
  char v97; // [sp+4Dh] [bp-11Bh]@1
  __int64 v98; // [sp+50h] [bp-118h]@33
  unsigned __int64 v99; // [sp+60h] [bp-108h]@33
  char *v100; // [sp+68h] [bp-100h]@0
  void *ptr; // [sp+70h] [bp-F8h]@0
  int v102; // [sp+78h] [bp-F0h]@33
  char v103; // [sp+7Ch] [bp-ECh]@1
  char v104; // [sp+7Dh] [bp-EBh]@33
  char v105; // [sp+7Fh] [bp-E9h]@33
  __dev_t v106; // [sp+80h] [bp-E8h]@33
  __ino_t v107; // [sp+88h] [bp-E0h]@33
  int v108; // [sp+9Ch] [bp-CCh]@59
  struct stat stat_buf; // [sp+A0h] [bp-C8h]@30
  ...
  while ( 1 )
  {
    v3 = sub_405CB0(a1, a2, "benstuvAET", &off_406C60, 0LL);
    if ( v3 == -1 )
      break;
    if ( v3 == 98 )
    {
...
LABEL_19:
  ...
  v106 = stat_buf.st_dev;
  v98 = dword_60A29C;
  v107 = stat_buf.st_ino;
  v102 = stat_buf.st_mode & 0xF000;
  v6 = a1 < dword_60A29C;
  v7 = a1 == dword_60A29C;
  if ( (signed int)a1 <= dword_60A29C )
  {
    v8 = "-";
    goto LABEL_45;
  }
...
LABEL_45:
  ...
  {
LABEL_50:
    if ( __fxstat(1, v23, &stat_buf) < 0 )
    {
      LODWORD(v59) = sub_4044D0(0LL, 3LL, qword_60A2E0);
      v60 = v59;
    ...
    v24 = 0x20000LL;
    if ( (unsigned __int64)(stat_buf.st_blksize - 0x20000) <= 0x1FFFFFFFFFFE0000LL )
      v24 = stat_buf.st_blksize;
    v25 = 0LL;
    nbytes = v24;
    j__posix_fadvise(v23, 0LL, 0LL, 2);
    if ( v102 == 0x8000 && stat_buf.st_dev == v106 && stat_buf.st_ino == v107 )
    {
      v25 = 0LL;
      v55 = lseek(fd, 0LL, 1);
      if ( v55 < stat_buf.st_size )
      {
        LODWORD(v56) = sub_4044D0(0LL, 3LL, qword_60A2E0);
        v57 = v56;
        v58 = dcgettext(0LL, "%s: input file is output file", 5);
        error(0, 0, v58, v57);
        v104 = 0;
        goto LABEL_39;
      }
    ...
    v26 = v99 - 1;
    if ( v87 || (v27 = v97 | v86 | v85, (unsigned __int8)v97 | (unsigned __int8)(v86 | v85)) )
    {
      LODWORD(v28) = sub_404CD0(nbytes + v99, 0LL);
      v29 = v28;
      v100 = v28;
      v30 = v99 + v5 + 18 + 4 * nbytes;
      LODWORD(v31) = sub_404CD0(v30, 0LL);
      v96 = 1;
      ptr = v31;
      v88 = (signed int)v4;
      v32 = (char *)v31 + v26 - ((unsigned __int64)v31 + v26) % v99;
      LODWORD(v4) = dword_60A2D8;
      v33 = (unsigned __int64)(&v29[v26] - (unsigned __int64)&v29[v26] % v99);
      v94 = &v32[v5];
      v90 = (char *)v33;
      v34 = (char *)(v33 + 1);
      v93 = v33 + 1;
...
LABEL_59:
        ...
        {
          v36 = fd;
          if ( ioctl(fd, 0x541BuLL, &v108) < 0 )
          {
            v48 = __errno_location();
            LOBYTE(v49) = *v48 == 95;
            if ( (unsigned int)*v48 <= 0x26 )
              v49 |= (0x4002480000uLL >> *v48) & 1;
            if ( !(_BYTE)v49 )
              goto LABEL_147;
            v96 = 0;
          }
...
LABEL_62:
            v25 = buf;
            v37 = sub_404670(v36, buf, nbytes);
            if ( v37 == -1 )
            {
              v9 = (signed int)v4;
              LODWORD(v4) = v88;
              LODWORD(v10) = sub_4044D0(0LL, 3LL, qword_60A2E0);
              v11 = v10;
              v12 = __errno_location();
              error(0, *v12, "%s", v11);
              v13 = v35 - v32;
              if ( !v13 || (v63 = v32, v13 == sub_4029B0(1, v32, v13)) )
              {
                dword_60A2D8 = v9;
                v14 = 0;
                goto LABEL_37;
            ...
            else
            {
              ...
              LODWORD(v4) = v88;
              v54 = v35 - v32;
              if ( !v54 || (v63 = v32, v54 == sub_4029B0(1, v32, v54)) )
              {
                dword_60A2D8 = v53;
                v14 = 1;
                goto LABEL_37;
        ...
        if ( v35 - v32 == sub_4029B0(1, v32, v35 - v32) )
        {
          v36 = fd;
          v35 = v32;
          goto LABEL_62;
        }
        v79 = dcgettext(0LL, "write error", 5);
        v80 = __errno_location();
        error(1, *v80, v79);
LABEL_150:
        v81 = dcgettext(0LL, "write error", 5);
        v82 = __errno_location();
        error(1, *v82, v81);
LABEL_151:
        v83 = dcgettext(0LL, "standard output", 5);
...
LABEL_90:
      v43 = v32;
      while ( v5 == sub_4029B0(1, v43, v5) )
      {
        v43 += v5;
        if ( v5 > v35 - v43 )
        {
          v25 = v43;
          v30 = (signed __int64)v32;
          memmove(v32, v43, v35 - v43);
          v35 = &v32[v35 - v43];
          if ( v34 > v90 )
            goto LABEL_59;
LABEL_94:
          LODWORD(v4) = (_DWORD)v4 + 1;
          v44 = (signed __int64)(v34 + 1);
          if ( (signed int)v4 <= 0 )
            goto LABEL_100;
          if ( (_DWORD)v4 != 1 && (LODWORD(v4) = 2, v97) )
          {
            v40 = *v34++;
          }
          else
          {
            if ( (unsigned __int8)v103 ^ 1 && (_BYTE)v87 )
            {
              sub_402480(v30, v25);
              v25 = src;
              v30 = (signed __int64)v35;
              v45 = stpcpy(v35, src);
              v44 = (signed __int64)(v34 + 1);
              v35 = v45;
            }
LABEL_100:
            v46 = (signed __int64)(v35 + 1);
            if ( HIBYTE(v87) )
            {
              v47 = (signed __int64)(v35 + 2);
              *v35++ = 36;
              v46 = v47;
            }
            *v35 = 10;
...
LABEL_65:
          ...
          if ( v85 )
          {
            while ( 1 )
            {
              ...
              {
                if ( (unsigned __int8)v40 > 0x7Eu )
                {
                  if ( v40 == 127 )
                  {
                    v30 = 16222LL;
                    v42 = (signed __int64)(v35 + 2);
                    *(_WORD *)v35 = 16222;
                  }
                  else
                  {
                ...
                {
                  *v35 = v40;
                  v42 = (signed __int64)(v35 + 1);
                }
              }
              else if ( v40 == 9 && (unsigned __int8)v86 ^ 1 )
              {
                v42 = (signed __int64)(v35 + 1);
                *v35 = 9;
              }
...
LABEL_144:
    ...
    else
    {
      ...
      if ( v5 >= nbytes )
        v64 = v5;
      LODWORD(v65) = sub_404CD0(v64 + v26, 0LL);
      v100 = v65;
      v66 = &v65[v26] - (unsigned __int64)&v65[v26] % v99;
      while ( 1 )
      {
        v67 = sub_404670(fd, v66, v64);
        if ( v67 == -1LL )
          break;
        if ( !v67 )
          goto LABEL_144;
        if ( v67 != sub_4029B0(1, v66, v67) )
          goto LABEL_150;
      }
      LODWORD(v68) = sub_4044D0(0LL, 3LL, qword_60A2E0);
      v69 = v68;
...
LABEL_119:
  LODWORD(v50) = sub_4044D0(0LL, 3LL, qword_60A2E0);
  v51 = v50;
  ...
  while ( 1 )
  {
    v6 = v95 < (unsigned int)++v98;
    v7 = v95 == (_DWORD)v98;
    if ( v95 > (signed int)v98 )
      goto LABEL_44;
    if ( !v105 || close(0) >= 0 )
...
LABEL_147:
    ...
    v75 = v48;
    LODWORD(v4) = v88;
    LODWORD(v76) = sub_404400(4LL, qword_60A2E0);
    v77 = v76;
    v78 = dcgettext(0LL, "cannot do ioctl on %s", 5);
    error(0, *v75, v78, v77);
    dword_60A2D8 = v74;
    v14 = v73;
LABEL_37:
...
LABEL_39:
    ...
    do
    {
      if ( !v19 )
        break;
      v15 = *v17 < (unsigned __int8)*v18;
      v16 = *v17++ == *v18++;
      --v19;
    }
    while ( v16 );
    if ( (!v15 && !v16) != v15 && close(fd) < 0 )
      goto LABEL_119;
  }
}
...
noreturn void __fastcall  sub_402520(int status)
{
  ...
  {
    v26 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v26, &unk_40664A);
    v27 = setlocale(5, 0LL);
  ...
  {
    v30 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v30, &unk_40664A);
    v31 = setlocale(5, 0LL);
...
__int64 sub_4028D0()
{
  ...
  if ( (unsigned int)sub_405DB0(stdout) )
  {
    ...
    if ( !byte_60A2E8 || *v0 != 32 )
    {
      ...
      if ( qword_60A2F0 )
      {
        LODWORD(v5) = sub_4044A0(qword_60A2F0, "write error");
...
__int64 __fastcall sub_4029B0(int fd, void *buf, size_t n)
{
  char *v3; // rbp@2
  size_t v4; // rbx@2
  __int64 v5; // r12@2
...
unsigned __int64 __fastcall sub_402BD0(_BYTE *a1, unsigned __int64 a2, char *a3, unsigned __int64 a4, int a5, char a6, __int64 a7, char *a8, char *a9)
{
  _BYTE *v9; // r15@1
...
LABEL_4:
        ...
        if ( !(_BYTE)v11 )
        {
          ...
          v44 = v43 == 2;
          if ( !v16 && v44 && v82 )
            return sub_402BD0((__int64)v9, v10, s);
          v45 = !v82 && v44;
          if ( v45 )
          {
            if ( v83 )
            {
              if ( v70 )
                return sub_402BD0((__int64)v9, v79, s);
              v46 = v79 != 0 && v10 == 0;
              if ( v46 )
              {
                v10 = v79;
...
LABEL_104:
      ...
      {
        v52 = (char *)v51 + v18;
        v33 = (const unsigned __int16 **)sub_405D30((wchar_t *)&wc, (char *)v51 + v18 + (_QWORD)s);
        v53 = v33;
        if ( !v33 )
        {
LABEL_240:
...
_BYTE *__fastcall sub_403E00(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_60A290 <= a1 )
  {
    ...
    {
      LODWORD(v20) = sub_404D30(0LL, v9);
      v7 = v20;
      off_60A278 = v20;
      *v20 = (__int128)_mm_load_si128((const __m128i *)&xmmword_60A280);
    }
    else
    {
      LODWORD(v10) = sub_404D30(off_60A278, v9);
      off_60A278 = v10;
      v7 = v10;
    }
  ...
  v23 = *(_DWORD *)(v5 + 4) | 1;
  v13 = *(_QWORD *)v11;
  v14 = sub_402BD0(v12, *(_QWORD *)v11, v21, v4, *(_DWORD *)v5, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v13 <= v14 )
  {
    v15 = v14 + 1;
    *(_QWORD *)v11 = v14 + 1;
    if ( (_UNKNOWN *)v12 != &unk_60A300 )
    {
      v16 = v14 + 1;
      free(v12);
      v15 = v16;
    }
    LODWORD(v17) = sub_404CD0(v15, v15);
    v18 = *(_DWORD *)v5;
    *(_QWORD *)(v11 + 8) = v17;
    v12 = v17;
    sub_402BD0(v17, v15, v21, v4, v18, v23, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v22;
  return v12;
}
...
_BYTE *__fastcall sub_404320(int a1, int a2, char *a3)
{
...
_BYTE *__fastcall sub_404400(int a1, char *a2)
{
  return sub_404320(0, a1, a2);
}

_BYTE *__fastcall sub_404420(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  return sub_403E00(0, a1, a2, (__int64)&v4);
}

_BYTE *__fastcall sub_4044A0(char *a1)
{
...
__int64 __fastcall sub_404670(int fd, void *buf, size_t nbytes)
{
...
__int64 __fastcall sub_4046D0(int fd, void *buf, size_t n)
{
  unsigned __int64 v3; // rbx@1
  ssize_t v4; // rbp@2
  int v5; // eax@3
...
int __fastcall sub_404730(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12@1
  __int64 v7; // rbx@1
  char *v8; // rax@3
...
int __fastcall sub_404B90(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  char *v7; // r10@1
  signed int v8; // er8@1
  __int64 v9; // r9@1
  ...
  do
  {
    if ( (unsigned int)v8 <= 0x2F )
    {
      ...
      v15[v9] = v11;
      if ( !v11 )
        return sub_404730(a1, a2, a3, a4, (__int64)v15, v9);
      goto LABEL_3;
    }
    v12 = (__int64 *)v7;
    v7 += 8;
...
void *__fastcall sub_404ED0(const void *a1, size_t a2)
{
  void *v2; // rax@1
...
signed __int64 __fastcall sub_405040(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8, __int64 a9)
{
  const char *v9; // r14@1
  char *v10; // rbp@1
  size_t v11; // r13@5
...
__int64 __fastcall sub_405660(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, __int64 a7, int a8)
{
  int v8; // er13@1
  signed int v9; // eax@2
  int v10; // ebp@2
    ...
    if ( *(_BYTE *)v21 == 45 )
    {
      ...
      if ( v36 )
      {
        if ( v53 )
        {
          ...
          {
            *(_QWORD *)(a7 + 32) = v21 + 2;
            v40 = sub_405040(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"--");
            goto LABEL_72;
          }
          if ( a6 )
          {
            ...
            {
              *(_QWORD *)(a7 + 32) = v21 + 1;
              v26 = sub_405040(v10, v11, v12, v53, v54, a6, a7, v8, (__int64)"-");
              if ( v26 != -1 )
...
LABEL_71:
        *(_QWORD *)(a7 + 32) = v28;
        *(_QWORD *)(a7 + 16) = 0LL;
        v40 = sub_405040(v10, v11, v12, v53, v54, 0, a7, v8, (__int64)"-W ");
LABEL_72:
        return v40;
      }
      v39 = *(_DWORD *)a7;
...
__int64 __fastcall sub_405C30(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax@1

  dword_60A440 = dword_60A29C;
  dword_60A444 = dword_60A298;
  result = sub_405660(a1, a2, a3, a4, a5, a6, (__int64)&dword_60A440, a7);
...
__int64 __fastcall sub_405CB0(signed int a1, __int64 a2, _BYTE *a3, char **a4, _DWORD *a5)
{
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_405E10(0LL, v6) )
  {
    v4 = 1LL;
...
int __fastcall sub_4063E0(FILE *stream)
{
  ...
  if ( fileno(stream) < 0 || __freading(stream) && (v5 = fileno(stream), lseek(v5, 0LL, 1) == -1) || !sub_406460(stream) )
  {
...
int __fastcall sub_406460(FILE *a1)
{
  int result; // eax@4

  if ( a1 && __freading(a1) && a1->_flags & 0x100 )
  {
    sub_4064A0(a1, 0LL, 1LL);
    result = fflush(a1);
  }
  else
  {
...
int __fastcall sub_406570(__int64 a1)
{
  __int64 v1; // rdx@1
