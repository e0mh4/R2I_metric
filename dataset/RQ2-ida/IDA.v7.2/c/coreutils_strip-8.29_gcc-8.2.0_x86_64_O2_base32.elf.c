...
__int64 __usercall sub_401BB0@<rax>(FILE *stream@<rdi>, char a2@<dl>, FILE *a3@<rsi>, unsigned __int64 a4@<r14>, size_t a5@<r15>)
{
  ...
  int *v15; // rax
  char *v16; // rax
  char v17; // [rsp+Fh] [rbp-3459h]
  size_t n; // [rsp+18h] [rbp-3450h]
  unsigned int v19; // [rsp+24h] [rbp-3444h]
  char ptr; // [rsp+30h] [rbp-3438h]
  char v21; // [rsp+1430h] [rbp-2038h]
  char src[8247]; // [rsp+1431h] [rbp-2037h]
...
LABEL_17:
    ...
    v12 = 0LL;
LABEL_18:
    a5 = (unsigned int)sub_402900(&v19, &v21, v12, &ptr, &n);
...
__int64 __fastcall sub_401DD0(FILE *stream, _IO_FILE *a2, __int64 a3)
{
  ...
  char *v19; // rbx
  int *v20; // rax
  __int64 v21; // [rsp+8h] [rbp-13850h]
  size_t v22; // [rsp+10h] [rbp-13848h]
  size_t v23; // [rsp+10h] [rbp-13848h]
  size_t v24; // [rsp+18h] [rbp-13840h]
  char v25[30720]; // [rsp+20h] [rbp-13838h]
  char ptr[49208]; // [rsp+7820h] [rbp-C038h]
...
LABEL_10:
    v6 = 8 * ((v4 + 4) / 5);
    sub_4025D0(v25, v4, ptr, 8 * ((v4 + 4) / 5));
    if ( v21 )
    {
      v7 = 0LL;
      while ( v6 > v7 )
    ...
    while ( 1 )
    {
      ...
      *a3 = byte_407520[((unsigned __int8)*a1 >> 3) & 0x1F];
      ...
      if ( a2 == 1 )
        break;
      v6 = a1[1];
      a3[1] = byte_407520[(((unsigned __int8)a1[1] >> 6) + v15) & 0x1F];
      if ( a4 == 2 )
        return;
      ...
      v8 = a1[2];
      v9 = v5 - a3;
      a3[3] = byte_407520[(((unsigned __int8)a1[2] >> 4) + v7) & 0x1F];
      if ( v5 - a3 == 4 )
        return;
      v10 = 2 * v8;
      if ( a2 == 3 )
      ...
      v11 = a1[3];
      a3[4] = byte_407520[(((unsigned __int8)a1[3] >> 7) + v10) & 0x1F];
      if ( v9 == 5 )
        return;
      ...
      {
        v13 = a1[4];
        a3[6] = byte_407520[(((unsigned __int8)a1[4] >> 5) + v12) & 0x1F];
        if ( v9 == 7 )
          return;
...
char __fastcall sub_402900(_DWORD *a1, unsigned __int8 *a2, unsigned __int64 a3, __int64 a4, __int64 *a5)
{
  _DWORD *v5; // r14
...
LABEL_9:
    ...
    {
      v19 = &v6[v7];
      while ( (unsigned __int8)sub_402400(v6, v19 - v6, &v24, &v25) )
      {
        v8 = v25;
        v6 += 8;
      }
...
LABEL_14:
  ...
  if ( (_DWORD)v17 == 8 )
  {
    *v5 = 0;
LABEL_32:
    if ( (__int64)v7 > 7 && !sub_406630(v6, 10LL, 8LL) )
    {
      v13 = v6;
      v7 = 8LL;
      v6 += 8;
...
LABEL_98:
      ...
      {
        v41 = v18 + v40;
        v28 = (const unsigned __int16 **)sub_4065B0((wchar_t *)&wc, &s[v18 + v40]);
        v42 = v28;
        if ( !v28 )
        {
LABEL_241:
...
_BYTE *__fastcall sub_4040E0(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_60B250 <= a1 )
  {
    ...
    {
      v7 = (__int128 *)sub_404F50(0LL, v9);
      off_60B238 = v7;
      *v7 = (__int128)_mm_load_si128((const __m128i *)&xmmword_60B240);
    }
    else
    {
      off_60B238 = (__int128 *)sub_404F50(off_60B238, v9);
      v7 = off_60B238;
    }
  ...
  v21 = *(_DWORD *)(v5 + 4) | 1;
  v18 = *v10;
  v12 = sub_402EB0(v11, *v10, v17, v4, *(_DWORD *)v5, v21, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v18 <= v12 )
  {
    v13 = v12 + 1;
    *v10 = v12 + 1;
    ...
    v11 = v14;
    sub_402EB0(v14, v13, v17, v4, v15, v21, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v20;
  return v11;
}
...
_BYTE *__fastcall sub_404600(int a1, int a2, char *a3)
{
...
_BYTE *__fastcall sub_404670(int a1, int a2, char *a3, unsigned __int64 a4)
{
...
_BYTE *__fastcall sub_404700(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  *v4 = v5 ^ ((~(unsigned __int8)(v5 >> v3) & 1) << v3);
  return sub_4040E0(0, a1, a2, (__int64)&v7);
}
...
_BYTE *__fastcall sub_404820(int a1, __int64 a2, __int64 a3, char *a4, unsigned __int64 a5)
{
...
__int64 __fastcall sub_4058C0(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, int *a7, int a8, __int64 a9)
{
  const char *v9; // r14
  char *v10; // rbp
  size_t v11; // r13
...
__int64 __fastcall sub_405EE0(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5, int a6, int *a7, int a8)
{
  int v8; // er13
  int v9; // eax
  int v10; // ebp
    ...
    if ( *v17 == 45 )
    {
      ...
      if ( v30 )
      {
        if ( v45 )
        {
          ...
          {
            *((_QWORD *)a7 + 4) = v17 + 2;
            return (unsigned int)sub_4058C0(a1, v11, v12, v45, v46, a6, a7, v8, (__int64)"--");
          }
          if ( a6 )
          {
            ...
            {
              *((_QWORD *)a7 + 4) = v17 + 1;
              v21 = sub_4058C0(a1, v11, v12, v45, v46, a6, a7, v8, (__int64)"-");
              if ( v21 != -1 )
                return v21;
              v17 = (_BYTE *)v11[*a7];
            }
...
LABEL_68:
        *((_QWORD *)a7 + 4) = v23;
        *((_QWORD *)a7 + 2) = 0LL;
        return (unsigned int)sub_4058C0(a1, v11, v12, v45, v46, 0, a7, v8, (__int64)"-W ");
      }
      v32 = *a7;
      if ( (_DWORD)v32 != a1 )
      {
...
__int64 __fastcall sub_4064B0(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax
...
__int64 __fastcall sub_406510(int a1, __int64 a2, char *a3)
{
  return sub_4064B0(a1, a2, a3, 0LL, 0LL, 0, 1);
}

__int64 __fastcall sub_406530(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5)
{
  return sub_4064B0(a1, a2, a3, a4, a5, 0, 0);
}

__int64 __fastcall sub_406550(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5, int *a6)
{
  return sub_405EE0(a1, a2, a3, a4, a5, 0, a6, 0);
}

__int64 __fastcall sub_406570(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5)
{
  return sub_4064B0(a1, a2, a3, a4, a5, 1, 0);
}

__int64 __fastcall sub_406590(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5, int *a6)
{
