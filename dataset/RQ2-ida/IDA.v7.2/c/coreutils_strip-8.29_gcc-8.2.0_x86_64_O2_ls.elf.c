...
size_t __usercall sub_405EA0@<rax>(__int64 a1@<rdx>, int a2@<ecx>, size_t a3@<rbx>, char **a4@<rdi>, char *a5@<rsi>, size_t *a6@<r8>, char *a7@<r9>)
{
  char *v7; // r13
  int v8; // er10
...
__int64 __usercall sub_40EE80@<rax>(void *s@<rdi>, unsigned __int64 a2@<rdx>, const __m128i *a3@<rcx>, __int64 a4@<rsi>, char a5@<r8b>, __int64 a6, int a7)
{
  char *v7; // r15
  char *v8; // rbx
  __int64 v9; // r12
