...
bool __fastcall sub_401AD0(char *filename, _QWORD *a2)
{
  bool result; // al
...
char __fastcall sub_402790(int a1)
{
  bool v1; // cf
  bool v2; // zf
  const char *v3; // rdi
...
_BYTE *__fastcall sub_404DF0(int a1, __int64 a2, __int64 a3, char *a4, unsigned __int64 a5)
{
