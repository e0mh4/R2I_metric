...
LABEL_107:
  ...
  ::ptr = (void *)sub_406460(v91, 0LL, sub_4039F0, sub_403A00, j__free);
  if ( !::ptr )
LABEL_304:
    sub_40A7B0();
  v69 = 0LL;
...
__int64 __usercall sub_403A10@<rax>(char *s1@<rdi>, unsigned int a2@<r12d>)
{
  __int64 v2; // rbx
...
__int64 __usercall sub_403A60@<rax>(char *s1@<rdi>, unsigned int a2@<r12d>)
{
  __int64 v2; // rbx
...
void __usercall sub_403F10(char *s2@<rdi>, void *src@<rsi>, char *a3@<rdx>, char *a4@<rcx>, char *a5@<r8>, char a6@<r9b>, int a7, const __m128i *a8, __int64 a9)
{
  char *v9; // r15
  char *v10; // r14
  char *v11; // r13
