__int64 __fastcall main(unsigned int a1, char **a2, char **a3)
{
  ...
  __int64 v40; // rbx
  char *v41; // rax
  char v42; // [rsp+7h] [rbp-61h]
  const char *v43; // [rsp+8h] [rbp-60h]
  const char *v44; // [rsp+10h] [rbp-58h]
...
LABEL_81:
  ...
  {
    v34 = dcgettext(0LL, "too many templates", 5);
    error(0, 0, v34);
    goto LABEL_81;
  }
  if ( a1 == dword_60B2BC )
  ...
  while ( 1 )
  {
    if ( v45 && (char *)sub_402890(v12) != v12 )
      goto LABEL_85;
    if ( v12 == v11 || *(v12 - 1) != 88 )
      goto LABEL_84;
    v13 = (__int64)(v12 - 2);
...
LABEL_71:
  ...
  if ( *v11 == 47 )
  {
    ...
    v35 = dcgettext(0LL, "invalid template, %s; with --tmpdir, it may not be absolute", 5);
    error(1, 0, v35, v11);
LABEL_84:
    v36 = sub_404640(v11);
    v37 = dcgettext(0LL, "too few X's in template %s", 5);
    error(1, 0, v37, v36);
LABEL_85:
    v38 = sub_404640(v12);
    v39 = dcgettext(0LL, "invalid suffix %s, contains directory separator", 5);
    v8 = 0LL;
    error(1, 0, v39, v38);
LABEL_86:
    v40 = sub_404640(v8);
    v41 = dcgettext(0LL, "with --suffix, template %s must end in X", 5);
    error(1, 0, v41, v40);
    start();
  }
LABEL_42:
...
LABEL_43:
  ...
  if ( !v6 )
  {
    if ( v4 )
    {
      if ( (int)sub_404870(v17, (unsigned int)v45, 0LL, 2LL, v12) >= 0 )
      {
        v24 = 0;
        puts(v18);
        return v24;
    ...
    {
      v23 = sub_404870(v17, (unsigned int)v45, 0LL, 0LL, v12);
      if ( v23 >= 0 && !close(v23) )
        goto LABEL_75;
    }
    if ( v5 )
  ...
  if ( !v4 )
  {
    if ( (unsigned int)sub_404870(v17, (unsigned int)v45, 0LL, 1LL, v12) )
      goto LABEL_46;
LABEL_75:
    puts(v18);
    byte_60B2F8 = 1;
    ...
    {
      v24 = 1;
      v33 = dcgettext(0LL, "write error", 5);
      error(0, v32, v33);
      return v24;
    }
    return 1;
  }
  v24 = sub_404870(v17, (unsigned int)v45, 0LL, 2LL, v12);
  if ( !v24 )
  {
    puts(v18);
    return v24;
...
LABEL_98:
      ...
      {
        v41 = v18 + v40;
        v28 = (const unsigned __int16 **)sub_406010((wchar_t *)&wc, &s[v18 + v40]);
        v42 = v28;
        if ( !v28 )
        {
LABEL_241:
...
_BYTE *__fastcall sub_403DF0(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_60B2B0 <= a1 )
  {
    ...
    {
      v7 = (__int128 *)sub_404EF0(0LL, v9);
      off_60B298 = v7;
      *v7 = (__int128)_mm_load_si128((const __m128i *)&xmmword_60B2A0);
    }
    else
    {
      off_60B298 = (__int128 *)sub_404EF0(off_60B298, v9);
      v7 = off_60B298;
    }
  ...
  v21 = *(_DWORD *)(v5 + 4) | 1;
  v18 = *v10;
  v12 = sub_402BC0(v11, *v10, v17, v4, *(_DWORD *)v5, v21, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v18 <= v12 )
  {
    v13 = v12 + 1;
    *v10 = v12 + 1;
    ...
    v11 = v14;
    sub_402BC0(v14, v13, v17, v4, v15, v21, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v20;
  return v11;
}
...
_BYTE *__fastcall sub_404380(int a1, int a2, char *a3, unsigned __int64 a4)
{
...
_BYTE *__fastcall sub_404410(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  *v4 = v5 ^ ((~(unsigned __int8)(v5 >> v3) & 1) << v3);
  return sub_403DF0(0, a1, a2, (__int64)&v7);
}
...
_BYTE *__fastcall sub_4044C0(int a1, int a2, char *a3)
{
  int v4; // [rsp+0h] [rbp-48h]
  int v5; // [rsp+4h] [rbp-44h]
  __int64 v6; // [rsp+8h] [rbp-40h]
...
_BYTE *__fastcall sub_404530(int a1, __int64 a2, __int64 a3, char *a4, unsigned __int64 a5)
{
  ...
  else
  {
    ...
    if ( v11 )
    {
      ...
      while ( 1 )
      {
        ...
        {
          do
            *(++v14 - 1) = byte_408DA0[sub_4066D0(v11, 61LL)];
          while ( v14 != v13 );
        }
        v15 = v23(s, v22);
        if ( v15 >= 0 )
...
void *__fastcall sub_4050C0(void *src)
{
  size_t v1; // rax
...
__int64 __fastcall sub_405320(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, int *a7, int a8, __int64 a9)
{
  const char *v9; // r14
  char *v10; // rbp
  size_t v11; // r13
...
__int64 __fastcall sub_405940(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5, int a6, int *a7, int a8)
{
  int v8; // er13
  int v9; // eax
  int v10; // ebp
    ...
    if ( *v17 == 45 )
    {
      ...
      if ( v30 )
      {
        if ( v45 )
        {
          ...
          {
            *((_QWORD *)a7 + 4) = v17 + 2;
            return (unsigned int)sub_405320(a1, v11, v12, v45, v46, a6, a7, v8, (__int64)"--");
          }
          if ( a6 )
          {
            ...
            {
              *((_QWORD *)a7 + 4) = v17 + 1;
              v21 = sub_405320(a1, v11, v12, v45, v46, a6, a7, v8, (__int64)"-");
              if ( v21 != -1 )
                return v21;
              v17 = (_BYTE *)v11[*a7];
            }
...
LABEL_68:
        *((_QWORD *)a7 + 4) = v23;
        *((_QWORD *)a7 + 2) = 0LL;
        return (unsigned int)sub_405320(a1, v11, v12, v45, v46, 0, a7, v8, (__int64)"-W ");
      }
      v32 = *a7;
      if ( (_DWORD)v32 != a1 )
      {
...
__int64 __fastcall sub_405F10(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax
...
__int64 __fastcall sub_405F70(int a1, __int64 a2, char *a3)
{
...
__int64 __fastcall sub_405FD0(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5)
{
  return sub_405F10(a1, a2, a3, a4, a5, 1, 0);
}

__int64 __fastcall sub_405FF0(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5, int *a6)
{
...
void __fastcall __noreturn sub_406850(char *a1)
{
  _BYTE *v1; // rbp
  int *v2; // rbx
  char *v3; // rax
...
unsigned __int64 *__fastcall sub_406D70(unsigned __int64 *a1, __int64 *a2)
{
...
unsigned __int64 __fastcall sub_407020(_QWORD *a1)
{
  _QWORD *v1; // rdx
  __int64 *v2; // rax
  __int64 v3; // rcx
...
__int64 __fastcall sub_407310(char a1, int a2, __int64 a3)
{
  int v3; // ebx
  int v5; // eax
  int *v6; // rax
