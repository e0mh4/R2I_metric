...
const char *sub_401D10()
{
  ...
  char v4; // dl
  char v5; // dl
  __int64 v7; // [rsp+0h] [rbp-128h]
  __int64 v8; // [rsp+8h] [rbp-120h]
  struct stat stat_buf; // [rsp+90h] [rbp-98h]
...
__int64 __fastcall sub_401DD0(unsigned __int64 a1, __int64 a2)
{
  ...
  if ( ((3 * a1) & 0x8000000000000000LL) != 0LL || (*((_QWORD *)&v2 + 1) = BYTE8(v2), BYTE8(v2)) )
...
void *__fastcall sub_401E50(void **a1, const void *a2, size_t a3)
{
  ...
  v5 = a1;
  v6 = (char *)a1[2];
  v7 = (_BYTE *)a1[2] - (_BYTE *)*a1;
  v8 = a3 + 1;
  if ( a3 + 1 > v7 )
  {
    v9 = (__int64)v5[1] + v8 < 0;
    v10 = (__int64)v5[1] + v8;
    v11 = 2 * v10;
  ...
  v5[2] = v17;
  *v17 = 47;
  return memcpy((char *)v5[2] + 1, v3, v4);
}
...
_BYTE *__fastcall sub_401F10(__int64 a1)
{
  ...
  char v49; // [rsp+20h] [rbp-1F8h]
  struct stat stat_buf; // [rsp+30h] [rbp-1E8h]
  struct stat v51; // [rsp+C0h] [rbp-158h]
  struct stat v52; // [rsp+150h] [rbp-C8h]
...
LABEL_13:
        ...
        {
          v1 = (__int64)v12;
          if ( __lxstat(1, v12, &v52) >= 0
            && v52.st_ino == stat_buf.st_ino
            && (v9 == v10 || v52.st_dev == stat_buf.st_dev) )
          {
LABEL_18:
            v14 = strlen(v12);
            v1 = (__int64)v12;
            sub_401E50((void **)a1, v12, v14);
            if ( !closedir(v4) )
            {
              ++v2;
              v15 = _mm_load_si128((const __m128i *)&v51.st_nlink);
...
LABEL_98:
      ...
      {
        v41 = v18 + v40;
        v28 = (const unsigned __int16 **)sub_405F80((wchar_t *)&wc, &s[v18 + v40]);
        v42 = v28;
        if ( !v28 )
        {
LABEL_241:
...
_BYTE *__fastcall sub_403BC0(__int64 a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_60A290 <= (int)a1 )
  {
    ...
    {
      v8 = (__int128 *)sub_404A80(0LL, v10);
      off_60A278 = v8;
      *v8 = (__int128)_mm_load_si128((const __m128i *)&xmmword_60A280);
    }
    else
    {
      off_60A278 = (__int128 *)sub_404A80(off_60A278, v10);
      v8 = off_60A278;
    }
  ...
  v22 = *(_DWORD *)(v5 + 4) | 1;
  v19 = *v11;
  v13 = sub_402990(v12, *v11, v18, v4, *(_DWORD *)v5, v22, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v19 <= v13 )
  {
    v14 = v13 + 1;
    *v11 = v13 + 1;
    ...
    v12 = v15;
    sub_402990(v15, v14, v18, v4, v16, v22, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v9 = v21;
  return v12;
}
...
_QWORD *__fastcall sub_404430(_QWORD *a1)
{
...
__int64 __fastcall sub_405290(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, int *a7, int a8, __int64 a9)
{
  const char *v9; // r14
  char *v10; // rbp
  size_t v11; // r13
...
__int64 __fastcall sub_4058B0(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5, int a6, int *a7, int a8)
{
  int v8; // er13
  int v9; // eax
  int v10; // ebp
    ...
    if ( *v17 == 45 )
    {
      ...
      if ( v30 )
      {
        if ( v45 )
        {
          ...
          {
            *((_QWORD *)a7 + 4) = v17 + 2;
            return (unsigned int)sub_405290(a1, v11, v12, v45, v46, a6, a7, v8, (__int64)"--");
          }
          if ( a6 )
          {
            ...
            {
              *((_QWORD *)a7 + 4) = v17 + 1;
              v21 = sub_405290(a1, v11, v12, v45, v46, a6, a7, v8, 4229466LL);
              if ( v21 != -1 )
                return v21;
              v17 = (_BYTE *)v11[*a7];
            }
...
LABEL_68:
        *((_QWORD *)a7 + 4) = v23;
        *((_QWORD *)a7 + 2) = 0LL;
        return (unsigned int)sub_405290(a1, v11, v12, v45, v46, 0, a7, v8, (__int64)"-W ");
      }
      v32 = *a7;
      if ( (_DWORD)v32 != a1 )
      {
...
__int64 __fastcall sub_405E80(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax
...
__int64 __fastcall sub_405EE0(int a1, __int64 a2, char *a3)
{
  return sub_405E80(a1, a2, a3, 0LL, 0LL, 0, 1);
}

__int64 __fastcall sub_405F00(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5)
{
  return sub_405E80(a1, a2, a3, a4, a5, 0, 0);
}

__int64 __fastcall sub_405F20(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5, int *a6)
{
  return sub_4058B0(a1, a2, a3, a4, a5, 0, a6, 0);
}

__int64 __fastcall sub_405F40(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5)
{
  return sub_405E80(a1, a2, a3, a4, a5, 1, 0);
}

__int64 __fastcall sub_405F60(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5, int *a6)
{
...
__int64 __fastcall sub_406130(__int64 a1, unsigned __int64 a2, __int64 a3, unsigned __int64 a4)
{
  ...
  {
    v7 = sub_406000(a3, a4, (__int64 *)&v35);
    v33 = v35;
  }
  v8 = (char *)v36;
  do
  ...
  if ( v6 )
  {
    ...
    while ( 1 )
    {
      ...
      v31 = v23;
      v29 = v24 + v6;
      if ( sub_406F70(a1 + v5, 0LL, v24 + v6 - v5) )
        break;
      v22 = v32;
      if ( !v29 )
        break;
...
LABEL_9:
    ...
    while ( 1 )
    {
      v30 = v15;
      v28 = v15 + v6;
      v16 = sub_406F70(a1 + v5, 0LL, v15 + v6 - v5);
      if ( !v28 )
        return 0LL;
      v17 = v30;
      if ( v16 )
...
__int64 __fastcall sub_406480(__int64 a1, char *a2)
{
  char v2; // al
  char v3; // r9
  char *v4; // rbx
...
LABEL_7:
  ...
  if ( a1 + v10 < (unsigned __int64)v11 )
    v12 = 1LL;
  if ( v10 > 0x1F )
    return sub_406130((__int64)v11, v12, (__int64)a2, v10);
  if ( v10 <= 2 )
  {
    v35 = 1LL;
    v15 = v10 - 1;
