...
__int64 __usercall sub_401C30@<rax>(unsigned int a1@<ebx>, unsigned int a2@<edi>, const char *a3@<rsi>)
{
  int v4; // eax
  int v5; // ebp
  DIR *v6; // r12
  ...
  if ( byte_60C299 )
  {
    LOBYTE(a1) = a2 == 39 || a2 == 17;
    if ( (_BYTE)a1 )
      return a1;
    if ( a2 <= 0x1E )
    {
      if ( (1LL << a2) & 0x40032002 )
      {
        v4 = openat(-100, a3, 198912);
        v5 = v4;
        if ( v4 >= 0 )
        {
          v6 = fdopendir(v4);
...
int __usercall sub_402030@<eax>(FILE *s@<rdi>)
{
  char *v1; // rax
...
unsigned __int64 __fastcall sub_4023C0(_BYTE *a1, unsigned __int64 a2, char *a3, unsigned __int64 a4, int a5, char a6, __int64 a7, char *a8, char *a9)
{
  _BYTE *v9; // r15
...
LABEL_4:
        ...
        if ( !(_BYTE)v11 )
        {
          ...
          v36 = v35 == 2;
          if ( !v16 && v36 && v82 )
            return sub_4023C0((__int64)v9, v10, s);
          v37 = !v82 && v36;
          if ( v37 )
          {
            if ( v83 )
            {
              if ( v59 )
                return sub_4023C0((__int64)v9, v79, s);
              v38 = v79 != 0 && v10 == 0;
              if ( v38 )
              {
                v10 = v79;
...
LABEL_98:
      ...
      {
        v41 = v18 + v40;
        v28 = (const unsigned __int16 **)sub_405460((wchar_t *)&wc, &s[v18 + v40]);
        v42 = v28;
        if ( !v28 )
        {
LABEL_241:
...
_BYTE *__fastcall sub_4035F0(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_60C250 <= a1 )
  {
    if ( a1 == 0x7FFFFFFF )
      sub_404650();
    v9 = 16LL * (a1 + 1);
    if ( off_60C238 == &xmmword_60C240 )
    {
      v7 = (__int128 *)sub_404460(0LL, v9);
      off_60C238 = v7;
      *v7 = (__int128)_mm_load_si128((const __m128i *)&xmmword_60C240);
    }
    else
    {
      off_60C238 = (__int128 *)sub_404460(off_60C238, v9);
      v7 = off_60C238;
    }
  ...
  v21 = *(_DWORD *)(v5 + 4) | 1;
  v18 = *v10;
  v12 = sub_4023C0(v11, *v10, v17, v4, *(_DWORD *)v5, v21, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v18 <= v12 )
  {
    v13 = v12 + 1;
    *v10 = v12 + 1;
    ...
    v11 = v14;
    sub_4023C0(v14, v13, v17, v4, v15, v21, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v20;
  return v11;
}
...
_BYTE *__fastcall sub_403B10(int a1, int a2, char *a3)
{
...
_BYTE *__fastcall sub_403B80(int a1, int a2, char *a3, unsigned __int64 a4)
{
...
_BYTE *__fastcall sub_403BF0(int a1, char *a2)
{
  return sub_403B10(0, a1, a2);
}

_BYTE *__fastcall sub_403C10(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  char v3; // cl
  int *v4; // r8
  ...
  v3 = a3 & 0x1F;
  v10 = qword_60C3F0;
  v7 = _mm_load_si128((const __m128i *)&xmmword_60C3C0);
  v8 = _mm_load_si128((const __m128i *)&xmmword_60C3D0);
  v4 = &v7.m128i_i32[(a3 >> 5) + 2];
  v9 = _mm_load_si128((const __m128i *)&xmmword_60C3E0);
  v5 = v7.m128i_u32[(a3 >> 5) + 2];
  *v4 = v5 ^ ((~(unsigned __int8)(v5 >> v3) & 1) << v3);
  return sub_4035F0(0, a1, a2, (__int64)&v7);
}

_BYTE *__fastcall sub_403C90(char *a1)
{
  return sub_403C10(a1, 0xFFFFFFFFFFFFFFFFLL, 0x3Au);
}

_BYTE *__fastcall sub_403CC0(int a1, int a2, char *a3)
{
  int v4; // [rsp+0h] [rbp-48h]
  int v5; // [rsp+4h] [rbp-44h]
  __int64 v6; // [rsp+8h] [rbp-40h]
...
_BYTE *__fastcall sub_403D30(int a1, __int64 a2, __int64 a3, char *a4, unsigned __int64 a5)
{
  ...
  v6 = _mm_load_si128((const __m128i *)&xmmword_60C3C0);
  v7 = _mm_load_si128((const __m128i *)&xmmword_60C3D0);
  v8 = _mm_load_si128((const __m128i *)&xmmword_60C3E0);
  v9 = qword_60C3F0;
  v6.m128i_i32[0] = 10;
  if ( !a2 || !a3 )
    abort();
...
__int64 __fastcall sub_404770(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, int *a7, int a8, __int64 a9)
{
  const char *v9; // r14
  char *v10; // rbp
  size_t v11; // r13
...
__int64 __fastcall sub_404D90(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5, int a6, int *a7, int a8)
{
  int v8; // er13
  int v9; // eax
  int v10; // ebp
    ...
    if ( *v17 == 45 )
    {
      ...
      if ( v30 )
      {
        if ( v45 )
        {
          ...
          {
            *((_QWORD *)a7 + 4) = v17 + 2;
            return (unsigned int)sub_404770(a1, v11, v12, v45, v46, a6, a7, v8, (__int64)"--");
          }
          if ( a6 )
          {
            ...
            {
              *((_QWORD *)a7 + 4) = v17 + 1;
              v21 = sub_404770(a1, v11, v12, v45, v46, a6, a7, v8, (__int64)"-");
              if ( v21 != -1 )
                return v21;
              v17 = (_BYTE *)v11[*a7];
            }
...
LABEL_68:
        *((_QWORD *)a7 + 4) = v23;
        *((_QWORD *)a7 + 2) = 0LL;
        return (unsigned int)sub_404770(a1, v11, v12, v45, v46, 0, a7, v8, (__int64)"-W ");
      }
      v32 = *a7;
      if ( (_DWORD)v32 != a1 )
      {
...
__int64 __fastcall sub_405360(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax
...
__int64 __fastcall sub_4053C0(int a1, __int64 a2, char *a3)
{
  return sub_405360(a1, a2, a3, 0LL, 0LL, 0, 1);
}

__int64 __fastcall sub_4053E0(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5)
{
  return sub_405360(a1, a2, a3, a4, a5, 0, 0);
}

__int64 __fastcall sub_405400(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5, int *a6)
{
  return sub_404D90(a1, a2, a3, a4, a5, 0, a6, 0);
}

__int64 __fastcall sub_405420(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5)
{
  return sub_405360(a1, a2, a3, a4, a5, 1, 0);
}

__int64 __fastcall sub_405440(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5, int *a6)
{
...
char *__fastcall sub_405D90(void *a1, size_t *a2, char *a3, __int64 a4, double a5)
{
  char *v5; // r15
  __int64 v6; // rbx
  __int64 v7; // rax
  ...
  src = a1;
  v158 = a2;
  if ( (int)sub_407AD0(a3, &v173, &v170) < 0 )
    return 0LL;
  if ( (int)sub_4078B0(v6, &v170) >= 0 )
  {
    v7 = v175 + 7;
