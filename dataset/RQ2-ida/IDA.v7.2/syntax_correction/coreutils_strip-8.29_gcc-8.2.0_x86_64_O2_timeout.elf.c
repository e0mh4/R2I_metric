...
__int64 __fastcall main(unsigned int a1, char **a2, char **a3)
{
  ...
  sigset_t oset; // [rsp+30h] [rbp-138h]
  sigset_t set; // [rsp+B0h] [rbp-B8h]
  int v31; // [rsp+138h] [rbp-30h]
...
LABEL_12:
  ...
  sigaction(v6, (const struct sigaction *)&set, 0LL);
  signal(21, (__sighandler_t)1);
  signal(22, (__sighandler_t)1);
  sigemptyset((sigset_t *)((char *)&set + 8));
  set.__val[0] = (unsigned __int64)nullsub_1;
  v31 = 0x10000000;
    ...
    else
    {
      ...
      if ( set.__val[0] & 0x7F )
      {
        ...
        else
        {
          ...
          LODWORD(set.__val[0]) = v18 + 128;
        }
      }
      else
      {
        LODWORD(set.__val[0]) = BYTE1(v17);
      }
    }
...
int __fastcall sub_4024F0(char a1, double a2)
{
  ...
  char *v8; // rbx
  int *v9; // rax
  timer_t timerid; // [rsp+18h] [rbp-30h]
  struct itimerspec value; // [rsp+20h] [rbp-28h]
...
int __fastcall sub_402680(int sig)
{
  unsigned int v1; // ebx
  __pid_t v2; // ebp
  double v3; // xmm0_8
...
__int64 __fastcall sub_402CC0(char *nptr, __int64 a2, double a3)
{
  ...
  int v14; // ebx
  unsigned int v15; // [rsp+4h] [rbp-34h]
...
void __fastcall sub_402E70(char *nptr, char **endptr)
{
  if ( !loc )
...
LABEL_98:
      ...
      {
        v41 = v18 + v40;
        v28 = (const unsigned __int16 **)sub_406340((wchar_t *)&wc, &s[v18 + v40]);
        v42 = v28;
        if ( !v28 )
        {
LABEL_241:
...
_BYTE *__fastcall sub_404430(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_60B310 <= a1 )
  {
    ...
    {
      v7 = (__int128 *)sub_4052A0(0LL, v9);
      off_60B2F8 = v7;
      *v7 = (__int128)_mm_load_si128((const __m128i *)&xmmword_60B300);
    }
    else
    {
      off_60B2F8 = (__int128 *)sub_4052A0(off_60B2F8, v9);
      v7 = off_60B2F8;
    }
  ...
  v21 = *(_DWORD *)(v5 + 4) | 1;
  v18 = *v10;
  v12 = sub_403200(v11, *v10, v17, v4, *(_DWORD *)v5, v21, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v18 <= v12 )
  {
    v13 = v12 + 1;
    *v10 = v12 + 1;
    ...
    v11 = v14;
    sub_403200(v14, v13, v17, v4, v15, v21, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v20;
  return v11;
}
...
_BYTE *__fastcall sub_404950(int a1, int a2, char *a3)
{
...
_BYTE *__fastcall sub_4049C0(int a1, int a2, char *a3, unsigned __int64 a4)
{
...
_BYTE *__fastcall sub_404A50(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  v3 = a3 & 0x1F;
  v10 = qword_60B690;
  v7 = _mm_load_si128((const __m128i *)&xmmword_60B660);
  v8 = _mm_load_si128((const __m128i *)&xmmword_60B670);
  v4 = &v7.m128i_i32[(a3 >> 5) + 2];
  v9 = _mm_load_si128((const __m128i *)&xmmword_60B680);
  v5 = v7.m128i_u32[(a3 >> 5) + 2];
  *v4 = v5 ^ ((~(unsigned __int8)(v5 >> v3) & 1) << v3);
  return sub_404430(0, a1, a2, (__int64)&v7);
}
...
_BYTE *__fastcall sub_404B00(int a1, int a2, char *a3)
{
  int v4; // [rsp+0h] [rbp-48h]
  int v5; // [rsp+4h] [rbp-44h]
  __int64 v6; // [rsp+8h] [rbp-40h]
...
_BYTE *__fastcall sub_404B70(int a1, __int64 a2, __int64 a3, char *a4, unsigned __int64 a5)
{
  ...
  v6 = _mm_load_si128((const __m128i *)&xmmword_60B660);
  v7 = _mm_load_si128((const __m128i *)&xmmword_60B670);
  v8 = _mm_load_si128((const __m128i *)&xmmword_60B680);
  v9 = qword_60B690;
  v6.m128i_i32[0] = 10;
  if ( !a2 || !a3 )
    abort();
...
void *__fastcall sub_405470(void *src)
{
  size_t v1; // rax
...
bool __fastcall sub_4054D0(_BYTE *a1, _QWORD *a2, double *a3, void (__fastcall *a4)(_BYTE *, _BYTE **), double a5)
{
...
__int64 __fastcall sub_405650(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, int *a7, int a8, __int64 a9)
{
  const char *v9; // r14
  char *v10; // rbp
  size_t v11; // r13
...
__int64 __fastcall sub_405C70(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5, int a6, int *a7, int a8)
{
  int v8; // er13
  int v9; // eax
  int v10; // ebp
    ...
    if ( *v17 == 45 )
    {
      ...
      if ( v30 )
      {
        if ( v45 )
        {
          ...
          {
            *((_QWORD *)a7 + 4) = v17 + 2;
            return (unsigned int)sub_405650(a1, v11, v12, v45, v46, a6, a7, v8, (__int64)"--");
          }
          if ( a6 )
          {
            ...
            {
              *((_QWORD *)a7 + 4) = v17 + 1;
              v21 = sub_405650(a1, v11, v12, v45, v46, a6, a7, v8, (__int64)"-");
              if ( v21 != -1 )
                return v21;
              v17 = (_BYTE *)v11[*a7];
            }
...
LABEL_68:
        *((_QWORD *)a7 + 4) = v23;
        *((_QWORD *)a7 + 2) = 0LL;
        return (unsigned int)sub_405650(a1, v11, v12, v45, v46, 0, a7, v8, (__int64)"-W ");
      }
      v32 = *a7;
      if ( (_DWORD)v32 != a1 )
      {
...
__int64 __fastcall sub_406240(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax
...
__int64 __fastcall sub_4062A0(int a1, __int64 a2, char *a3)
{
  return sub_406240(a1, a2, a3, 0LL, 0LL, 0, 1);
}

__int64 __fastcall sub_4062C0(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5)
{
  return sub_406240(a1, a2, a3, a4, a5, 0, 0);
}

__int64 __fastcall sub_4062E0(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5, int *a6)
{
  return sub_405C70(a1, a2, a3, a4, a5, 0, a6, 0);
}

__int64 __fastcall sub_406300(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5)
{
  return sub_406240(a1, a2, a3, a4, a5, 1, 0);
}

__int64 __fastcall sub_406320(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5, int *a6)
{
