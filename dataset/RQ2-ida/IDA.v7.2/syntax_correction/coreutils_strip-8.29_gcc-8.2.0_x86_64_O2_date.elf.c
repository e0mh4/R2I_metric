...
unsigned __int64 __usercall sub_403280(FILE *stream, __int64 a2, char a3, char *a4, int a5, __int64 a6, int a7)
{
  FILE *v7; // r14
  char *v8; // rbx
  char *v9; // r13
...
__int64 __usercall sub_40E7A0(void *s, char *a2, const __m128i *a3, __int64 a4, char a5, __int64 a6, int a7)
{
  char *v7; // r15
  char *v8; // rbx
  __int64 v9; // r12
