...
__int64 __fastcall main(unsigned int a1, char **a2, char **a3)
{
  ...
  char v101; // [rsp+5Fh] [rbp-A9h]
  char *lineptr; // [rsp+60h] [rbp-A8h]
  size_t n; // [rsp+68h] [rbp-A0h]
  char v104[48]; // [rsp+70h] [rbp-98h]
  char v105[104]; // [rsp+A0h] [rbp-68h]
...
LABEL_66:
            ...
            if ( byte_60E2DB )
            {
              ...
              error(0, 0, v46, v45, v13, "SHA256", v78);
            }
LABEL_68:
            if ( *(_BYTE *)v6 & 0x30 )
              break;
...
noreturn void __fastcall  sub_402C90(int status)
{
  ...
  do
    v20 += 2;
  while ( *v20 && strcmp("sha256sum", *v20) );
  v21 = v20[1];
  if ( v21 )
  {
    v22 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v22, &unk_409F12);
    v23 = setlocale(5, 0LL);
  ...
  {
    v26 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v26, &unk_409F12);
    v27 = setlocale(5, 0LL);
  ...
  __printf_chk(1LL, v29, "sha256sum");
LABEL_10:
...
int sub_4083D0()
{
  ...
  __printf_chk(1LL, v1, &unk_409F12);
  v2 = stdout;
