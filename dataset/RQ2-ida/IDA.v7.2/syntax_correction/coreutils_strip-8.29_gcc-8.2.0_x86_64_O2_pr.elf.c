...
__int64 __usercall sub_403840(_IO_FILE **a1, int a2)
{
  _IO_FILE **v2; // rbp
  _IO_FILE *v3; // rdi
  char *v4; // rax
...
__int64 __usercall sub_405920(void *s, unsigned __int64 a2, const __m128i *a3, __int64 a4, char a5, __int64 a6, int a7)
{
  char *v7; // r15
  char *v8; // rbx
  __int64 v9; // r12
