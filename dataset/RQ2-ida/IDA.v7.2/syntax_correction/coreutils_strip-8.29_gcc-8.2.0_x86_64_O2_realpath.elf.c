...
LABEL_65:
    ...
    v25 = sub_405C60(0LL, 3LL, v4);
    v26 = __errno_location();
    error(1, *v26, "%s", v25);
LABEL_68:
    v27 = sub_405C60(0LL, 3LL, v3);
    v28 = __errno_location();
    error(1, *v28, "%s", v27);
    start();
  }
  v22 = sub_405C60(0LL, 3LL, v3);
  error(1, 20, "%s", v22);
LABEL_62:
  free(v3);
  qword_60C2F8 = v4;
...
bool __fastcall sub_402080(char *filename)
{
  ...
  if ( __xstat(1, filename, (struct stat *)&v5) )
  {
...
__int64 __fastcall sub_402410(void *src, void **a2, size_t *a3)
{
  void *v3; // r13
  size_t *v4; // r12
  size_t v5; // rbx
...
char __fastcall sub_402490(char *a1, char *a2, __int64 a3, __int64 a4)
{
  char v4; // r8
  char v5; // r9
  char result; // al
...
LABEL_14:
        ...
        if ( v14 )
        {
          v16 = sub_402410(file, (void **)&v21, (size_t *)&v20);
          for ( i = *v13; *v13; i = *v13 )
          {
            if ( i == 47 )
              v16 |= sub_402410(&unk_408D00, (void **)&v21, (size_t *)&v20);
            ++v13;
          }
          if ( *v15 )
          {
            v18 = sub_402410("/", (void **)&v21, (size_t *)&v20);
            v16 |= (unsigned __int64)sub_402410(v15, (void **)&v21, (size_t *)&v20) | v18;
          }
        }
        else
        {
          if ( !*v15 )
            v15 = ".";
          LOBYTE(v16) = sub_402410(v15, (void **)&v21, (size_t *)&v20);
        }
        if ( (_BYTE)v16 )
        {
...
_BYTE *__fastcall sub_402690(void *src, char a2)
{
  _BYTE *v2; // r15
  const char *v3; // rax
  _BYTE *v4; // r12
...
_QWORD *__fastcall sub_403730(unsigned __int64 a1, __int64 a2, unsigned __int64 (__fastcall *a3)(__int64 a1, unsigned __int64 a2), bool (__fastcall *a4)(__int64 a1, __int64 a2), __int64 a5)
{
  __int64 v5; // r14
...
void __fastcall sub_403970(void *ptr)
{
  void **v1; // r12
  _QWORD *v2; // rbp
  unsigned __int64 v3; // rax
...
__int64 __fastcall sub_403A50(__int64 a1, unsigned __int64 a2)
{
  __int64 v2; // r12
  float v3; // xmm0_4
  float v4; // xmm0_4
  ...
  v24 = v13;
  v25 = *(_QWORD *)(a1 + 72);
  v14 = sub_403130((__int64)&ptr, a1, 0);
  if ( (_BYTE)v14 )
  {
    free(*(void **)a1);
    *(_QWORD *)a1 = ptr;
...
__int64 __fastcall sub_403C50(__int64 a1, __int64 a2, __int64 *a3)
{
  ...
  v3 = a3;
  v4 = a2;
  v5 = sub_402F90(a1, a2, (__m128i **)&v26, 0);
  if ( !v5 )
  {
    v7 = *(_QWORD *)(a1 + 24);
...
LABEL_15:
        ...
        if ( !(unsigned __int8)sub_403A50(a1, v25) )
          return 0xFFFFFFFFLL;
        if ( !sub_402F90(a1, v4, (__m128i **)&v26, 0) )
        {
LABEL_9:
          v11 = v26;
          if ( !*v26 )
...
LABEL_98:
      ...
      {
        v41 = v18 + v40;
        v28 = (const unsigned __int16 **)sub_407A30((wchar_t *)&wc, &s[v18 + v40]);
        v42 = v28;
        if ( !v28 )
        {
LABEL_241:
...
_BYTE *__fastcall sub_405590(int a1, char *a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( dword_60C2B0 <= a1 )
  {
    ...
    {
      v7 = (__int128 *)sub_406530(0LL, v9);
      off_60C298 = v7;
      *v7 = (__int128)_mm_load_si128((const __m128i *)&xmmword_60C2A0);
    }
    else
    {
      off_60C298 = (__int128 *)sub_406530(off_60C298, v9);
      v7 = off_60C298;
    }
  ...
  v21 = *(_DWORD *)(v5 + 4) | 1;
  v18 = *v10;
  v12 = sub_404360(v11, *v10, v17, v4, *(_DWORD *)v5, v21, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  if ( v18 <= v12 )
  {
    v13 = v12 + 1;
    *v10 = v12 + 1;
    ...
    v11 = v14;
    sub_404360(v14, v13, v17, v4, v15, v21, v5 + 8, *(char **)(v5 + 40), *(char **)(v5 + 48));
  }
  *v8 = v20;
  return v11;
}
...
_BYTE *__fastcall sub_405B20(int a1, int a2, char *a3, unsigned __int64 a4)
{
...
_BYTE *__fastcall sub_405BB0(char *a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  v3 = a3 & 0x1F;
  v10 = qword_60C470;
  v7 = _mm_load_si128((const __m128i *)&xmmword_60C440);
  v8 = _mm_load_si128((const __m128i *)&xmmword_60C450);
  v4 = &v7.m128i_i32[(a3 >> 5) + 2];
  v9 = _mm_load_si128((const __m128i *)&xmmword_60C460);
  v5 = v7.m128i_u32[(a3 >> 5) + 2];
  *v4 = v5 ^ ((~(unsigned __int8)(v5 >> v3) & 1) << v3);
  return sub_405590(0, a1, a2, (__int64)&v7);
}
...
_BYTE *__fastcall sub_405CD0(int a1, __int64 a2, __int64 a3, char *a4, unsigned __int64 a5)
{
  ...
  v7 = _mm_load_si128((const __m128i *)&xmmword_60C450);
  v8 = _mm_load_si128((const __m128i *)&xmmword_60C460);
  v9 = qword_60C470;
  v6.m128i_i32[0] = 10;
  if ( !a2 || !a3 )
    abort();
...
__int64 __fastcall sub_405F30(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 *a5, __int64 a6)
{
  __int64 v6; // r12
  __int64 *v7; // rbx
  char *v8; // rax
...
__int64 __fastcall sub_406330(FILE *a1, __int64 a2, __int64 a3, __int64 a4, int *a5)
{
  __int64 i; // r9
  __int64 *v6; // r10
  __int64 v7; // rax
...
__int64 __fastcall sub_406390(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  char *v7; // r10
  unsigned int v8; // er8
  __int64 i; // r9
...
void *__fastcall sub_406700(void *src)
{
  size_t v1; // rax
...
__int64 __fastcall sub_406D40(int a1, __int64 *a2, char *a3, char **a4, _DWORD *a5, int a6, int *a7, int a8, __int64 a9)
{
  const char *v9; // r14
  char *v10; // rbp
  size_t v11; // r13
...
__int64 __fastcall sub_407360(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5, int a6, int *a7, int a8)
{
  int v8; // er13
  int v9; // eax
  int v10; // ebp
    ...
    if ( *v17 == 45 )
    {
      ...
      if ( v30 )
      {
        if ( v45 )
        {
          ...
          {
            *((_QWORD *)a7 + 4) = v17 + 2;
            return (unsigned int)sub_406D40(a1, v11, v12, v45, v46, a6, a7, v8, (__int64)"--");
          }
          if ( a6 )
          {
            ...
            {
              *((_QWORD *)a7 + 4) = v17 + 1;
              v21 = sub_406D40(a1, v11, v12, v45, v46, a6, a7, v8, (__int64)"-");
              if ( v21 != -1 )
                return v21;
              v17 = (_BYTE *)v11[*a7];
            }
...
LABEL_68:
        *((_QWORD *)a7 + 4) = v23;
        *((_QWORD *)a7 + 2) = 0LL;
        return (unsigned int)sub_406D40(a1, v11, v12, v45, v46, 0, a7, v8, (__int64)"-W ");
      }
      v32 = *a7;
      if ( (_DWORD)v32 != a1 )
      {
...
__int64 __fastcall sub_407930(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax
...
__int64 __fastcall sub_407990(int a1, __int64 a2, char *a3)
{
  return sub_407930(a1, a2, a3, 0LL, 0LL, 0, 1);
}

__int64 __fastcall sub_4079B0(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5)
{
  return sub_407930(a1, a2, a3, a4, a5, 0, 0);
}

__int64 __fastcall sub_4079D0(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5, int *a6)
{
  return sub_407360(a1, a2, a3, a4, a5, 0, a6, 0);
}

__int64 __fastcall sub_4079F0(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5)
{
  return sub_407930(a1, a2, a3, a4, a5, 1, 0);
}

__int64 __fastcall sub_407A10(int a1, __int64 a2, char *a3, char **a4, _DWORD *a5, int *a6)
{
