...
__int64 __usercall sub_404B90(char *a1, size_t a2, unsigned int a3, int a4, int a5, size_t a6, char a7, __int64 a8, __int64 a9, size_t a10, _QWORD *a11, _BYTE *a12)
{
...
__int64 __usercall sub_405400(unsigned int a1, __off_t a2, const char *a3, char *a4, __int64 a5, const __m128i *a6, unsigned int a7, unsigned int a8, _BYTE *a9, _BYTE *a10, _BYTE *a11)
{
  char *v11; // r14
...
__int64 __usercall sub_409280(unsigned __int8 a1, const __m128i *a2, const char *a3, char *a4, _BYTE *a5, _BYTE *a6, unsigned int a7)
{
  int v7; // eax
