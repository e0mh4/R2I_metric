...
noreturn void __fastcall  sub_405DD0(const char *a1, char *a2, __int64 a3, __int64 a4, __int64 a5)
{
  char *v5; // rdx
  const char *v6; // rbp
  int *v7; // rax
...
noreturn void __fastcall  sub_40F8A0(__int64 a1)
{
  _BYTE *v1; // rbp
  int *v2; // rbx
  char *v3; // rax
