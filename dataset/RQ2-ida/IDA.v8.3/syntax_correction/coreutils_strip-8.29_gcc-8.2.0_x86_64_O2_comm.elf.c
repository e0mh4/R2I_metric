...
LABEL_38:
  ...
  {
    v10 = "extra operand %s";
    v11 = sub_404660(a2[dword_60A27C + 2]);
    goto LABEL_38;
  }
...
size_t __fastcall sub_401B50(size_t *a1, const void **a2, FILE *a3, int a4)
{
  ...
  if ( a4 == 2 )
  {
    if ( !byte_60A2C9 )
      return result;
    if ( !byte_60A2CA )
      return fwrite_unlocked(*a2, 1uLL, *a1, a3);
LABEL_13:
...
__int64 __fastcall sub_401CA0(__int64 a1)
{
  ...
  const char *v56; // rbx
  int *v57; // rax
  const char *v58; // [rsp+0h] [rbp-208h]
  ...
  FILE *stream[2]; // [rsp+40h] [rbp-1C8h]
  char v68[32]; // [rsp+50h] [rbp-1B8h] BYREF
  char v69[32]; // [rsp+70h] [rbp-198h] BYREF
  __int16 v70[16]; // [rsp+90h] [rbp-178h] BYREF
  char v71[192]; // [rsp+B0h] [rbp-158h] BYREF
  char v72; // [rsp+170h] [rbp-98h] BYREF
  ...
  while ( 1 )
  {
    ...
    *((_DWORD *)v4 + 2) = 0;
    ...
    if ( !v13 )
      goto LABEL_57;
    sub_402730(v13, 2LL);
    *(&v65 + v2) = sub_4028C0(*(_QWORD *)&v71[32 * (int)v2 + 32], v13, (unsigned int)byte_60A1F8);
    if ( (v13->_flags & 0x20) != 0 )
      goto LABEL_56;
    v1 += 8LL;
    v4 += 12;
    v3 += 96;
...
LABEL_28:
        ...
        *(_DWORD *)v27 = ((_BYTE)v29 + 1) & 3;
        v62 = v30;
        v33 = sub_4028C0(*(_QWORD *)&v71[32 * v26 + 32 + 8 * (((unsigned __int8)v29 + 1) & 3)], v31, v32);
        v34 = 4 * v26;
        v35 = v62;
        *(&v65 + v26) = v33;
        if ( v33 )
        {
          ...
          {
            v36 = *(_QWORD *)&v71[32 * (int)v1 + 32 + 8 * v29];
            sub_401C10(
              (__int64 *)(v36 + 8),
              (__int64 *)(v36 + 16),
              (__int64 *)(v33 + 8),
        ...
        if ( (v31->_flags & 0x20) != 0 )
        {
          v50 = (const char *)sub_4044E0(0LL, 3LL, *(_QWORD *)(a1 + 8LL * (int)v1), v35, v34);
          v51 = __errno_location();
          error(1, *v51, "%s", v50);
LABEL_54:
          v63 = 1;
LABEL_55:
          v52 = (const char *)sub_4044E0(0LL, 3LL, *(_QWORD *)(a1 + 8LL * v63), a1, v39);
          v53 = __errno_location();
          error(1, *v53, "%s", v52);
LABEL_56:
          v54 = (const char *)sub_4044E0(0LL, 3LL, *(_QWORD *)v1, v15, v16);
          v55 = __errno_location();
          error(1, *v55, "%s", v54);
LABEL_57:
          v56 = (const char *)sub_4044E0(0LL, 3LL, *(_QWORD *)v1, v11, v7);
  ...
  if ( (unsigned int)sub_405040(stream[0]) )
    goto LABEL_55;
  result = sub_405040(stream[1]);
  if ( (_DWORD)result )
    goto LABEL_54;
  if ( byte_60A2C4 )
  {
    ...
    v43 = s1;
    v44 = v42;
    v45 = (const char *)sub_402860(v61, v70);
    v58 = s1;
    v46 = sub_402860(v59, v69);
    v47 = s1;
    v48 = (const char *)v46;
    v49 = (const char *)sub_402860(v60, v68);
    return __printf_chk(1LL, "%s%s%s%s%s%s%s%c", v49, v47, v48, v58, v45, v43, v44, v41);
  }
  return result;
}
...
noreturn void __fastcall  sub_402220(int status)
{
  ...
  v4 = stdout;
  v5 = dcgettext(0LL, "Compare sorted files FILE1 and FILE2 line by line.\n", 5);
  ...
  v14 = stdout;
  v15 = dcgettext(0LL, "  --output-delimiter=STR  separate columns with STR\n", 5);
  fputs_unlocked(v15, v14);
  v16 = stdout;
  v17 = dcgettext(0LL, "  --total           output a summary\n", 5);
  ...
  do
    v28 += 2;
  while ( *v28 && strcmp("comm", (const char *)*v28) );
  v29 = (char *)v28[1];
  if ( v29 )
  {
    v30 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v30, &unk_407067, "https://www.gnu.org/software/coreutils/");
    v31 = setlocale(5, 0LL);
  ...
  {
    v35 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v35, &unk_407067, "https://www.gnu.org/software/coreutils/");
    v36 = setlocale(5, 0LL);
    if ( !v36 || !strncmp(v36, "en_", 3uLL) )
    {
      ...
      __printf_chk(1LL, v37, "https://www.gnu.org/software/coreutils/", "comm");
LABEL_12:
...
LABEL_3:
  ...
  __printf_chk(1LL, v38, "comm");
LABEL_10:
  v32 = "Multi-call invocation" + 10;
  v33 = dcgettext(0LL, "Full documentation at: <%s%s>\n", 5);
  __printf_chk(1LL, v33, "https://www.gnu.org/software/coreutils/", "comm");
  if ( v29 != "comm" )
    v32 = locale;
  goto LABEL_12;
}
...
_BYTE *__fastcall sub_403E10(int a1, __int64 a2, unsigned __int64 a3, __int64 a4)
{
  int *v6; // rax
  __m128i *v7; // rbx
  int *v8; // r13
  ...
  if ( dword_60A270 <= a1 )
  {
    ...
    {
      v7 = (__m128i *)sub_404C90(0LL, v9);
      off_60A258 = v7;
      *v7 = _mm_load_si128((const __m128i *)&xmmword_60A260);
    }
    else
    {
      off_60A258 = (void *)sub_404C90(off_60A258, v9);
      v7 = (__m128i *)off_60A258;
    }
  ...
  v21 = *(_DWORD *)(a4 + 4) | 1;
  v18 = *v10;
  v12 = sub_402BE0(v11, *v10, a2, a3, *(_DWORD *)a4, v21, a4 + 8, *(char **)(a4 + 40), *(char **)(a4 + 48));
  if ( v18 <= v12 )
  {
    v13 = v12 + 1;
    *v10 = v12 + 1;
    ...
    v11 = v14;
    sub_402BE0(v14, v13, a2, a3, v15, v21, a4 + 8, *(char **)(a4 + 40), *(char **)(a4 + 48));
  }
  *v8 = v20;
  return v11;
}
...
void sub_404220()
{
  ...
  v0 = (__int128 *)off_60A258;
  if ( dword_60A270 > 1 )
  {
    v1 = (void **)((char *)off_60A258 + 24);
    v2 = (void **)((char *)off_60A258 + 16 * (unsigned int)(dword_60A270 - 2) + 40);
    do
    {
      v3 = *v1;
      v1 += 2;
  ...
  if ( v4 != &unk_60A300 )
  {
    ...
    *((_QWORD *)&xmmword_60A260 + 1) = &unk_60A300;
  }
  if ( v0 != &xmmword_60A260 )
  {
    free(v0);
    off_60A258 = &xmmword_60A260;
  }
  dword_60A270 = 1;
}

_BYTE *__fastcall sub_404330(int a1, int a2, __int64 a3)
{
...
_BYTE *__fastcall sub_4043A0(int a1, int a2, __int64 a3, unsigned __int64 a4)
{
...
_BYTE *__fastcall sub_404430(__int64 a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  *v3 ^= (((*v3 >> (a3 & 0x1F)) & 1) == 0) << (a3 & 0x1F);
  return sub_403E10(0, a1, a2, (__int64)v5);
}
...
_BYTE *__fastcall sub_4044E0(int a1, int a2, __int64 a3)
{
  int v4[2]; // [rsp+0h] [rbp-48h] BYREF
  __int64 v5; // [rsp+8h] [rbp-40h]
  __int64 v6; // [rsp+10h] [rbp-38h]
...
_BYTE *__fastcall sub_404550(int a1, __int64 a2, __int64 a3, __int64 a4, unsigned __int64 a5)
{
...
__int64 __fastcall sub_404680(int a1, __int64 a2, __int64 a3, int a4, int a5, int a6, char a7)
{
  return sub_4050C0(a1, 0, 3, a4, a5, a6, a7);
}
...
int sub_404BB0()
{
  ...
  __printf_chk(1LL, v1, &unk_407067, "https://www.gnu.org/software/coreutils/");
  v2 = stdout;
...
// attributes: thunk
void *__fastcall sub_404C80(size_t a1)
{
  return sub_404C30(a1);
}
...
void *__fastcall sub_404DE0(size_t n)
{
  void *v1; // rax
...
void *__fastcall sub_404E00(unsigned __int64 a1, unsigned __int64 a2)
{
  void *result; // rax
...
void *__fastcall sub_404E60(char *src)
{
  size_t v1; // rax

  v1 = strlen(src);
  return sub_404E30(src, v1 + 1);
}
...
void __fastcall sub_404EC0(int errnum, __int64 a2, unsigned __int64 a3, __int64 a4, unsigned __int64 a5)
{
  char *v8; // rax
  char *v9; // rax
  _BYTE *v10; // rbp
  ...
  error(0, 0, v9);
  v10 = sub_4043A0(1, 8, a4, a5);
  v11 = sub_4043A0(0, 8, a2, a3);
  v12 = dcgettext(0LL, "The strings compared were %s and %s.", 5);
  error(status, 0, v12, v11, v10);
}

__int64 __fastcall sub_404F80(char *a1, size_t a2, void *a3, unsigned __int64 a4)
{
  ...
  v8 = *__errno_location();
  if ( v8 )
    sub_404EC0(v8, (__int64)a1, a2, (__int64)a3, a4);
  return v7;
}

__int64 __fastcall sub_404FE0(char *a1, size_t a2, void *a3, __int64 a4)
{
  ...
  v8 = *__errno_location();
  if ( v8 )
    sub_404EC0(v8, (__int64)a1, a2 - 1, (__int64)a3, a4 - 1);
  return v7;
}
...
__int64 __fastcall sub_4050C0(int a1, int a2, __int64 a3, int a4, int a5, int a6)
{
  int v6; // ebx
  int v8; // eax
  int *v9; // rax
  ...
  if ( a2 == 1030 )
  {
    if ( dword_60A438 < 0 )
    {
      v6 = sub_4050C0(a1, 0, a3, a4, a5, a6);
...
LABEL_8:
    ...
    else
    {
      ...
      {
        v6 = sub_4050C0(a1, 0, v16, v13, v14, v15);
        if ( v6 >= 0 )
        {
          dword_60A438 = -1;
          goto LABEL_8;
...
__int64 __fastcall sub_406780(char *s1, size_t n, const char *s2, __int64 a4)
{
  char v6; // r9
  char v7; // r8
  unsigned int v8; // edx
...
int __fastcall sub_406830(char *s1, size_t n, const char *s2, __int64 a4)
{
  if ( n != a4 || memcmp(s1, s2, n) )
    return sub_4066C0(s1, n, s2, a4);
  *__errno_location() = 0;
  return 0;
}
