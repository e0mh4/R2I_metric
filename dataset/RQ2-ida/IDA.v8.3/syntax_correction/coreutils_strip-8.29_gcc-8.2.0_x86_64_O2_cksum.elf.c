...
__int64 __fastcall main(int a1, char **a2, char **a3)
{
  ...
  {
    v3 = &a2[dword_60923C];
    v4 = &(&a2[dword_60923C])[(unsigned __int64)(unsigned int)(a1 + ~dword_60923C) + 1];
    v5 = 1;
    do
    {
      v6 = *v3++;
...
__int64 __fastcall sub_401920(char *filename, char a2)
{
  ...
  char *v22; // rbx
  int *v23; // rax
  __int64 v24; // [rsp+0h] [rbp-10058h] BYREF
  char ptr[65592]; // [rsp+20h] [rbp-10038h] BYREF
  ...
  do
  {
    v6 = fread_unlocked(ptr, 1uLL, 0x10000uLL, v3);
    if ( !v6 )
    {
      if ( (v3->_flags & 0x20) == 0 )
        goto LABEL_10;
    ...
    v9 = ptr;
    do
      v5 = qword_405F00[(unsigned __int8)(*v9++ ^ BYTE3(v5))] ^ (v5 << 8);
    while ( v9 != v8 );
  }
  while ( (v3->_flags & 0x10) == 0 );
  if ( (v3->_flags & 0x20) == 0 )
  {
LABEL_10:
    if ( strcmp(filename, "-") && (unsigned int)sub_404590(v3) == -1 )
    {
LABEL_19:
    ...
    for ( i = (const char *)sub_401FC0(v4, &v24); v4; v5 = v11 )
    {
      v11 = qword_405F00[(unsigned __int8)(v4 ^ BYTE3(v5))] ^ (v5 << 8);
      v4 >>= 8;
    }
    v12 = ~v5;
    if ( a2 )
...
LABEL_22:
  v18 = (const char *)sub_403BC0(0LL, 3LL, filename);
...
noreturn void __fastcall  sub_401BD0(int status)
{
  ...
  v4 = stdout;
  v5 = dcgettext(0LL, "Print CRC checksum and byte counts of each FILE.\n\n", 5);
  ...
  do
    v10 += 2;
  while ( *v10 && strcmp("cksum", (const char *)*v10) );
  v11 = (char *)v10[1];
  if ( v11 )
  {
    v12 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v12, &unk_405CB5, "https://www.gnu.org/software/coreutils/");
    v13 = setlocale(5, 0LL);
  ...
  {
    v17 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v17, &unk_405CB5, "https://www.gnu.org/software/coreutils/");
    v18 = setlocale(5, 0LL);
    if ( !v18 || !strncmp(v18, "en_", 3uLL) )
    {
      ...
      __printf_chk(1LL, v19, "https://www.gnu.org/software/coreutils/", "cksum");
LABEL_12:
...
LABEL_3:
  ...
  __printf_chk(1LL, v20, "cksum");
LABEL_10:
  v14 = "Multi-call invocation" + 10;
  v15 = dcgettext(0LL, "Full documentation at: <%s%s>\n", 5);
  __printf_chk(1LL, v15, "https://www.gnu.org/software/coreutils/", "cksum");
  if ( v11 != "cksum" )
    v14 = "";
  goto LABEL_12;
}
...
LABEL_23:
      ...
      {
        v45 = (char *)v44 + v17;
        v25 = (const unsigned __int16 **)sub_405480((wchar_t *)&wc, (char *)v44 + v17 + a3);
        v46 = v25;
        if ( !v25 )
        {
LABEL_245:
...
int sub_404280()
{
  ...
  __printf_chk(1LL, v1, &unk_405CB5, "https://www.gnu.org/software/coreutils/");
  v2 = stdout;
...
__int64 __fastcall sub_404DB0(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5, int a6, int *a7, int a8)
{
  int v8; // r13d
  int v9; // eax
  int v10; // ebp
    ...
    if ( *(_BYTE *)v17 == 45 )
    {
      ...
      if ( v30 )
      {
        if ( a4 )
        {
          ...
          {
            *((_QWORD *)a7 + 4) = v17 + 2;
            return (unsigned int)sub_404790(a1, a2, v12, a4, a5, a6, a7, v8, (__int64)"--");
          }
          if ( a6 )
          {
            ...
            {
              *((_QWORD *)a7 + 4) = v17 + 1;
              v21 = sub_404790(a1, a2, v12, a4, a5, a6, a7, v8, (__int64)"-");
              if ( v21 != -1 )
                return v21;
              v17 = a2[*a7];
            }
...
LABEL_68:
        *((_QWORD *)a7 + 4) = v23;
        *((_QWORD *)a7 + 2) = 0LL;
        return (unsigned int)sub_404790(a1, a2, v12, a4, a5, 0, a7, v8, (__int64)"-W ");
      }
      v32 = *a7;
      if ( (_DWORD)v32 != a1 )
      {
...
__int64 __fastcall sub_405380(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax
...
__int64 __fastcall sub_4053E0(int a1, __int64 *a2, const char *a3)
{
  return sub_405380(a1, a2, a3, 0LL, 0LL, 0, 1);
}

__int64 __fastcall sub_405400(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5)
{
  return sub_405380(a1, a2, a3, a4, a5, 0, 0);
}

__int64 __fastcall sub_405420(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5, int *a6)
{
