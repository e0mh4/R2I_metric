...
LABEL_52:
    ...
    v78 = dcgettext(0LL, "invalid conversion specifier in suffix: \\%o", 5);
    v19 = 0LL;
    v17 = 1;
...
noreturn void __fastcall  sub_403A70(__int64 a1, __int64 a2, char a3)
{
  __int64 v4; // rax
  __int64 v5; // r12
  __int64 v6; // r13
