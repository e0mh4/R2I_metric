__int64 __fastcall main(unsigned int a1, char **a2, char **a3)
{
  ...
  __int64 v39; // rbx
  char *v40; // rax
  char v41; // [rsp+7h] [rbp-61h]
  const char *v42; // [rsp+8h] [rbp-60h]
  const char *v43; // [rsp+10h] [rbp-58h]
  unsigned __int64 v44; // [rsp+18h] [rbp-50h]
  unsigned __int64 n; // [rsp+20h] [rbp-48h]
...
LABEL_80:
    ...
    else
    {
      if ( v7 != 128 )
        goto LABEL_80;
      v42 = (const char *)qword_60B4A8;
    }
  }
  if ( a1 - dword_60B2BC > 1 )
  {
    v33 = dcgettext(0LL, "too many templates", 5);
    error(0, 0, v33);
    goto LABEL_80;
  }
  if ( a1 == dword_60B2BC )
  ...
  n = strlen(v42) + 1;
  v44 = n - 1;
  v11 = (char *)sub_404E90(v10 + n);
  memcpy(v11, v8, v10);
  v12 = &v11[v10];
  memcpy(v12, v42, n);
  while ( 1 )
  {
    if ( v44 && (char *)sub_402890(v12) != v12 )
      goto LABEL_84;
    if ( v12 == v11 || *(v12 - 1) != 88 )
      goto LABEL_83;
    v13 = v12 - 2;
    ...
    if ( (char *)sub_402890(v11) == v11 )
      goto LABEL_41;
    v28 = sub_404640(v11);
    v29 = dcgettext(0LL, "invalid template, %s, contains directory separator", 5);
    error(1, 0, v29, v28);
LABEL_69:
    v3 = 1;
    v8 = "tmp.XXXXXXXXXX";
LABEL_70:
    v11 = (char *)sub_4050C0(v8);
    v30 = strrchr(v11, 88);
    v12 = v30 + 1;
    if ( !v30 )
      v12 = &v11[strlen(v11)];
  ...
  if ( *v11 == 47 )
  {
    v11 = (char *)sub_404640(v11);
    v34 = dcgettext(0LL, "invalid template, %s; with --tmpdir, it may not be absolute", 5);
    error(1, 0, v34, v11);
LABEL_83:
    v35 = sub_404640(v11);
    v36 = dcgettext(0LL, "too few X's in template %s", 5);
    error(1, 0, v36, v35);
LABEL_84:
    v37 = sub_404640(v12);
    v38 = dcgettext(0LL, "invalid suffix %s, contains directory separator", 5);
    v8 = 0LL;
    error(1, 0, v38, v37);
LABEL_85:
    v39 = sub_404640(v8);
    v40 = dcgettext(0LL, "with --suffix, template %s must end in X", 5);
    error(1, 0, v40, v39);
    start();
  }
LABEL_41:
  v16 = sub_402920(v15, v11, 0LL);
  free(v11);
  v11 = (char *)v16;
LABEL_42:
  v17 = sub_4050C0(v11);
  ...
  if ( !v6 )
  {
    if ( v4 )
    {
      if ( (int)sub_404870(v17, (unsigned int)v44, 0LL, 2LL, v12) >= 0 )
      {
        v24 = 0;
        puts(v18);
        return v24;
    ...
    {
      v23 = sub_404870(v17, (unsigned int)v44, 0LL, 0LL, v12);
      if ( v23 >= 0 && !close(v23) )
        goto LABEL_74;
    }
    if ( v5 )
      return 1;
    v19 = "failed to create file via template %s";
    v20 = sub_404640(v11);
    goto LABEL_47;
  }
  if ( !v4 )
  {
    if ( (unsigned int)sub_404870(v17, (unsigned int)v44, 0LL, 1LL, v12) )
      goto LABEL_45;
LABEL_74:
    puts(v18);
    byte_60B2F8 = 1;
    v24 = sub_402770(stdout);
    if ( !v24 )
      return v24;
    ...
    {
      v24 = 1;
      v32 = dcgettext(0LL, "write error", 5);
      error(0, v31, v32);
      return v24;
    }
    return 1;
  }
  v24 = sub_404870(v17, (unsigned int)v44, 0LL, 2LL, v12);
  if ( !v24 )
  {
    puts(v18);
    return v24;
...
LABEL_45:
  if ( !v5 )
  {
    v19 = "failed to create directory via template %s";
    v20 = sub_404640(v11);
LABEL_47:
...
void __fastcall __noreturn sub_4023C0(int status)
{
  __int64 v1; // rbp
  char *v2; // rax
  char *v3; // rax
  ...
  v3 = dcgettext(0LL, "Usage: %s [OPTION]... [TEMPLATE]\n", 5);
  ...
  v6 = stdout;
  v7 = dcgettext(0LL, "Files are created u+rw, and directories u+rwx, minus umask restrictions.\n", 5);
  ...
  do
    v20 += 2;
  while ( *v20 && strcmp("mktemp", (const char *)*v20) );
  v21 = (const char *)v20[1];
  if ( v21 )
  {
    v22 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v22, &unk_4075A1);
    v23 = setlocale(5, 0LL);
  ...
  {
    v26 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v26, &unk_4075A1);
    v27 = setlocale(5, 0LL);
...
void *__fastcall sub_402940(_BYTE *src, const char *a2, _QWORD *a3)
{
  const char *v3; // r12
  const char *v4; // r14
  size_t v5; // rax
...
unsigned __int64 __fastcall sub_402BC0(
        _BYTE *a1,
        unsigned __int64 a2,
        __int64 a3,
        unsigned __int64 a4,
...
LABEL_4:
        ...
        if ( !(_BYTE)a5 )
        {
          ...
          if ( v41 )
          {
            ...
            {
              if ( v63 )
                return sub_402BC0((int)v9, v83, a3, v16, 5, a6, a7, (__int64)a8, a9);
              v42 = v83 != 0 && v10 == 0;
              if ( v42 )
              {
                v10 = v83;
...
LABEL_277:
              v30 = v18;
              LODWORD(v13) = v16;
              return sub_402BC0((int)v9, v10, a3, v13, v30, a6 & 0xFFFFFFFD, 0LL, (__int64)a8, a9);
            }
          }
        }
        LOBYTE(v22) = *v19;
...
LABEL_23:
      ...
      {
        v45 = (char *)v44 + v17;
        v25 = (const unsigned __int16 **)sub_406010((wchar_t *)&wc, (char *)v44 + v17 + a3);
        v46 = v25;
        if ( !v25 )
        {
LABEL_245:
...
_BYTE *__fastcall sub_403DF0(int a1, __int64 a2, unsigned __int64 a3, __int64 a4)
{
  int *v6; // rax
  __m128i *v7; // rbx
  int *v8; // r13
  ...
  if ( dword_60B2B0 <= a1 )
  {
    ...
    {
      v7 = (__m128i *)sub_404EF0(0LL, v9);
      ptr = v7;
      *v7 = _mm_load_si128((const __m128i *)&xmmword_60B2A0);
    }
    else
    {
      ptr = (void *)sub_404EF0(ptr, v9);
      v7 = (__m128i *)ptr;
    }
  ...
  v21 = *(_DWORD *)(a4 + 4) | 1;
  v18 = *v10;
  v12 = sub_402BC0(v11, *v10, a2, a3, *(_DWORD *)a4, v21, a4 + 8, *(char **)(a4 + 40), *(char **)(a4 + 48));
  if ( v18 <= v12 )
  {
    v13 = v12 + 1;
    *v10 = v12 + 1;
    ...
    v14 = (_BYTE *)sub_404E90(v13);
    v15 = *(_DWORD *)a4;
    v10[1] = (unsigned __int64)v14;
    v11 = v14;
    sub_402BC0(v14, v13, a2, a3, v15, v21, a4 + 8, *(char **)(a4 + 40), *(char **)(a4 + 48));
  }
  *v8 = v20;
  return v11;
}
...
__int64 __fastcall sub_403F90(__int128 *a1)
{
  __int128 *v1; // rbx
  int *v2; // rax
  int v3; // r12d
  ...
  if ( !a1 )
    v1 = &xmmword_60B420;
  result = sub_405090(v1, 0x38uLL);
  *v4 = v3;
  return result;
}

unsigned __int64 __fastcall sub_404080(_BYTE *a1, unsigned __int64 a2, __int64 a3, unsigned __int64 a4, __int128 *a5)
{
  __int128 *v6; // rbx
  int *v7; // rax
  int v8; // r12d
...
_BYTE *__fastcall sub_404100(__int64 a1, unsigned __int64 a2, unsigned __int64 *a3, __int128 *a4)
{
  __int128 *v5; // rbx
  int *v6; // r13
  int v7; // ebp
  ...
  v9 = *v6;
  v11 = sub_402BC0(0LL, 0LL, a1, a2, *(_DWORD *)v5, v7, (__int64)v5 + 8, *((char **)v5 + 5), *((char **)v5 + 6));
  v10 = (_BYTE *)sub_404E90(v11 + 1);
  sub_402BC0(v10, v11 + 1, a1, a2, *(_DWORD *)v5, v7, (__int64)v5 + 8, *((char **)v5 + 5), *((char **)v5 + 6));
  *v6 = v9;
  if ( a3 )
    *a3 = v11;
  return v10;
...
_BYTE *__fastcall sub_404310(int a1, int a2, __int64 a3)
{
  ...
  v9 = 0LL;
  v10 = 0LL;
  return sub_403DF0(a1, a3, 0xFFFFFFFFFFFFFFFFLL, (__int64)v4);
}
...
_BYTE *__fastcall sub_404380(int a1, int a2, __int64 a3, unsigned __int64 a4)
{
  ...
  v10 = 0LL;
  v11 = 0LL;
  return sub_403DF0(a1, a3, a4, (__int64)v5);
}
...
_BYTE *__fastcall sub_404410(__int64 a1, unsigned __int64 a2, unsigned __int8 a3)
{
  _DWORD *v3; // r8
  ...
  *v3 ^= (((*v3 >> (a3 & 0x1F)) & 1) == 0) << (a3 & 0x1F);
  return sub_403DF0(0, a1, a2, (__int64)v5);
}

_BYTE *__fastcall sub_404490(__int64 a1)
{
  return sub_404410(a1, 0xFFFFFFFFFFFFFFFFLL, 0x3Au);
}

_BYTE *__fastcall sub_4044C0(int a1, int a2, __int64 a3)
{
  int v4[2]; // [rsp+0h] [rbp-48h] BYREF
  __int64 v5; // [rsp+8h] [rbp-40h]
  __int64 v6; // [rsp+10h] [rbp-38h]
...
_BYTE *__fastcall sub_404530(int a1, __int64 a2, __int64 a3, __int64 a4, unsigned __int64 a5)
{
  ...
  v8 = a3;
  return sub_403DF0(a1, a4, a5, (__int64)v6);
}

_BYTE *__fastcall sub_404640(__int64 a1)
{
...
void __noreturn sub_4046F0()
{
  __assert_fail("! \"invalid KIND in __gen_tempname\"", "lib/tempname.c", 0x147u, "gen_tempname_len");
}

__int64 __fastcall sub_404710(char *s, int a2, __int64 a3, __int64 (__fastcall *a4)(char *, __int64), size_t a5)
{
  int *v6; // r15
  size_t v7; // rax
  size_t v8; // rdx
  ...
  else
  {
    ...
    if ( v10 )
    {
      ...
      while ( 1 )
      {
        ...
        {
          do
            *v13++ = byte_408DA0[sub_4066D0(v10, 61LL)];
          while ( v13 != v12 );
        }
        v14 = a4(s, a3);
        if ( v14 >= 0 )
...
__int64 __fastcall sub_404870(char *a1, int a2, int a3, unsigned int a4, size_t a5)
{
  ...
  if ( a4 > 2 )
    sub_4046F0();
  return sub_404710(a1, a2, (__int64)v6, (__int64 (__fastcall *)(char *, __int64))*(&off_408D60 + a4), a5);
}

__int64 __fastcall sub_4048A0(char *a1, int a2, int a3, unsigned int a4)
{
  ...
  if ( a4 > 2 )
    sub_4046F0();
  return sub_404710(a1, a2, (__int64)v5, (__int64 (__fastcall *)(char *, __int64))*(&off_408D60 + a4), 6uLL);
}

__int64 __fastcall sub_4048E0(char *a1, int a2, __int64 a3, __int64 (__fastcall *a4)(char *, __int64))
{
  return sub_404710(a1, a2, a3, a4, 6uLL);
}

__int64 __fastcall sub_4048F0(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 *a5, __int64 a6)
{
  char *v8; // rax
  char *v9; // rax
  __int64 v10; // rbx
...
__int64 __fastcall sub_404CF0(FILE *a1, __int64 a2, __int64 a3, __int64 a4, int *a5)
{
  __int64 i; // r9
  __int64 *v6; // r10
  __int64 v7; // rax
  ...
  for ( i = 0LL; i != 10; ++i )
  {
    ...
    if ( (unsigned int)*a5 <= 0x2F )
    {
      ...
      *a5 = v8 + 8;
      ...
      v12[i] = *v6;
      if ( !v7 )
        return sub_4048F0(a1, a2, a3, a4, v12, i);
      continue;
    }
...
__int64 __fastcall sub_404D50(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  char *v7; // r10
  unsigned int v8; // r8d
  __int64 i; // r9
  ...
  for ( i = 0LL; i != 10; ++i )
  {
    if ( v8 <= 0x2F )
    {
      ...
      v15[i] = v11;
      if ( !v11 )
        return sub_4048F0(a1, a2, a3, a4, v15, i);
      continue;
    }
    v12 = (__int64 *)v7;
    v7 += 8;
...
int sub_404E10()
{
  ...
  __printf_chk(1LL, v1, &unk_4075A1);
  v2 = stdout;
...
// attributes: thunk
void *__fastcall sub_404EE0(size_t a1)
{
  return sub_404E90(a1);
}
...
void *__fastcall sub_405040(size_t n)
{
  void *v1; // rax
...
__int64 __fastcall sub_405060(unsigned __int64 a1, unsigned __int64 a2)
{
  ...
  {
    sub_4050E0(a1, a2, *((_QWORD *)&v2 + 1));
  }
  return v2;
}

void *__fastcall sub_405090(void *src, size_t n)
{
  void *v2; // rax
...
void *__fastcall sub_4050C0(char *src)
{
  size_t v1; // rax

  v1 = strlen(src);
  return sub_405090(src, v1 + 1);
}
...
int __fastcall sub_405120(FILE *stream)
{
  ...
  if ( !(unsigned int)sub_4051A0(stream) )
    return fclose(stream);
  v1 = __errno_location();
  v2 = *v1;
  v3 = v1;
...
int __fastcall sub_4051A0(FILE *stream)
{
  if ( !stream || !__freading(stream) || (stream->_flags & 0x100) == 0 )
    return fflush(stream);
  sub_4051E0(stream, 0LL, 1LL);
  return fflush(stream);
}
...
__int64 __fastcall sub_405240(__int64 a1, int *a2)
{
  __int64 v2; // r11
  int v3; // r12d
  int v4; // ebp
...
__int64 __fastcall sub_405940(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5, int a6, int *a7, int a8)
{
  int v8; // r13d
  int v9; // eax
  int v10; // ebp
    ...
    if ( *(_BYTE *)v17 == 45 )
    {
      ...
      if ( v30 )
      {
        if ( a4 )
        {
          ...
          {
            *((_QWORD *)a7 + 4) = v17 + 2;
            return (unsigned int)sub_405320(a1, a2, v12, a4, a5, a6, a7, v8, (__int64)"--");
          }
          if ( a6 )
          {
            ...
            {
              *((_QWORD *)a7 + 4) = v17 + 1;
              v21 = sub_405320(a1, a2, v12, a4, a5, a6, a7, v8, (__int64)"-");
              if ( v21 != -1 )
                return v21;
              v17 = a2[*a7];
            }
...
LABEL_68:
        *((_QWORD *)a7 + 4) = v23;
        *((_QWORD *)a7 + 2) = 0LL;
        return (unsigned int)sub_405320(a1, a2, v12, a4, a5, 0, a7, v8, (__int64)"-W ");
      }
      v32 = *a7;
      if ( (_DWORD)v32 != a1 )
      {
...
__int64 __fastcall sub_405F10(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax

  dword_60B460 = dword_60B2BC;
  dword_60B464 = dword_60B2B8;
  result = sub_405940(a1, a2, a3, a4, a5, a6, &dword_60B460, a7);
...
__int64 __fastcall sub_405F70(int a1, __int64 *a2, const char *a3)
{
  return sub_405F10(a1, a2, a3, 0LL, 0LL, 0, 1);
}
...
{
  return sub_405940(a1, a2, a3, a4, a5, 0, a6, 0);
}

__int64 __fastcall sub_405FD0(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5)
{
  return sub_405F10(a1, a2, a3, a4, a5, 1, 0);
}

__int64 __fastcall sub_405FF0(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5, int *a6)
{
  return sub_405940(a1, a2, a3, a4, a5, 1, a6, 0);
}
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_406090(0LL) )
  {
    v4 = 1LL;
...
_QWORD *__fastcall sub_406660(__int64 a1)
{
  _QWORD *result; // rax
...
void __fastcall sub_4067D0(void *ptr)
{
...
void __fastcall __noreturn sub_406850(__int64 a1)
{
  _BYTE *v1; // rbp
  int *v2; // rbx
  char *v3; // rax
...
__m128i *__fastcall sub_4068B0(__int64 a1, unsigned __int64 a2)
{
  FILE *v2; // r13
  __m128i *v3; // rax
  size_t v4; // rcx
  ...
  if ( !a2 )
  {
    v5 = (__m128i *)sub_404E90(0x1038uLL);
    v5->m128i_i64[0] = 0LL;
    v5->m128i_i64[1] = (__int64)sub_406850;
    v5[1].m128i_i64[0] = 0LL;
    return v5;
  }
  if ( !a1 )
  {
    v7 = (__m128i *)sub_404E90(0x1038uLL);
    v7->m128i_i64[0] = 0LL;
    v5 = v7;
    v8 = v7 + 2;
    v7->m128i_i64[1] = (__int64)sub_406850;
...
LABEL_12:
  ...
  v2 = (FILE *)sub_407260(a1, "rb");
  if ( !v2 )
    return 0LL;
  v3 = (__m128i *)sub_404E90(0x1038uLL);
  v4 = 4096LL;
  v3->m128i_i64[0] = (__int64)v2;
  if ( a2 <= 0x1000 )
    v4 = a2;
  v3->m128i_i64[1] = (__int64)sub_406850;
  v5 = v3;
  v3[1].m128i_i64[0] = a1;
...
__int64 __fastcall sub_406BC0(__int64 a1, char *a2, size_t a3)
{
  size_t v5; // rbx
  FILE *v6; // r13
  int *v7; // r14
...
int __fastcall sub_406D20(FILE **ptr)
{
  FILE *v1; // rbp
  ...
  free(ptr);
  if ( v1 )
    return sub_405120(v1);
  else
    return 0;
}

unsigned __int64 *__fastcall sub_406D70(unsigned __int64 *a1, unsigned __int64 *a2)
{
...
__int64 __fastcall sub_407300(int a1, __int64 a2, __int64 a3, int a4, int a5, int a6, char a7)
{
  return sub_407310(a1, 0, 3, a4, a5, a6, a7);
}

__int64 __fastcall sub_407310(int a1, int a2, __int64 a3, int a4, int a5, int a6)
{
  int v6; // ebx
  int v8; // eax
  int *v9; // rax
  ...
  if ( a2 == 1030 )
  {
    if ( dword_60B4A0 < 0 )
    {
      v6 = sub_407310(a1, 0, a3, a4, a5, a6);
      if ( v6 >= 0 && dword_60B4A0 == -1 )
      {
LABEL_8:
        v8 = fcntl(v6, 1);
    ...
    else
    {
      ...
      {
        v6 = sub_407310(a1, 0, v16, v13, v14, v15);
        if ( v6 >= 0 )
        {
          dword_60B4A0 = -1;
          goto LABEL_8;
...
int __fastcall sub_4074C0(void (__fastcall *a1)(void *))
{
  void *v1; // rdx
