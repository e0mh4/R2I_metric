__int64 __fastcall main(int a1, char **a2, char **a3)
{
  ...
  char *v34; // rax
  char *v35; // rax
  unsigned __int8 v36; // [rsp+Fh] [rbp-39h]
  ...
  while ( 1 )
  {
    ...
    v12 = v11[1];
    v13 = (char *)(v11 + 1);
    if ( !v12 || (unsigned __int8)(v12 - 69) > 0x29u || ((1LL << (v12 - 69)) & 0x20100000001LL) == 0 )
      break;
    v14 = v11 + 2;
    while ( *v14 )
    {
...
LABEL_5:
  ...
  v18 = (__int64)&v4[(unsigned int)(v5 - 1) + 1];
  while ( 2 )
  {
    for ( i = *v4; ; i = v23 )
    {
...
LABEL_61:
          ...
          case 'x':
            v36 = i[2];
            if ( ((*__ctype_b_loc())[v36] & 0x1000) == 0 )
              goto LABEL_67;
            v26 = sub_401AA0(v36, v10);
            v27 = *((unsigned __int8 *)i + 3);
            v22 = v26;
            if ( (*(_BYTE *)(v28 + 2 * v27 + 1) & 0x10) != 0 )
            {
              v23 = i + 4;
              v29 = sub_401AA0((unsigned __int8)v27, v10);
              v22 = v29 + v30;
              v20 = v22;
            }
            else
...
__int64 __fastcall sub_401AA0(unsigned __int8 a1)
{
  __int64 result; // rax
...
void __fastcall __noreturn sub_401B20(int status)
{
  __int64 v1; // rbp
  char *v2; // rax
  char *v3; // rax
  ...
  v3 = dcgettext(0LL, "Usage: %s [SHORT-OPTION]... [STRING]...\n  or:  %s LONG-OPTION\n", 5);
  ...
  do
    v20 += 2;
  while ( *v20 && strcmp("echo", (const char *)*v20) );
  v21 = (char *)v20[1];
  if ( v21 )
  {
    v22 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v22, &unk_40509B, "https://www.gnu.org/software/coreutils/");
    v23 = setlocale(5, 0LL);
  ...
  {
    v27 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v27, &unk_40509B, "https://www.gnu.org/software/coreutils/");
    v28 = setlocale(5, 0LL);
    if ( !v28 || !strncmp(v28, "en_", 3uLL) )
    {
      ...
      __printf_chk(1LL, v29, "https://www.gnu.org/software/coreutils/", "echo");
LABEL_12:
...
LABEL_3:
  ...
  __printf_chk(1LL, v30, "echo", v31);
LABEL_10:
  v24 = "Multi-call invocation" + 10;
  v25 = dcgettext(0LL, "Full documentation at: <%s%s>\n", 5);
  __printf_chk(1LL, v25, "https://www.gnu.org/software/coreutils/", "echo");
  if ( v21 != "echo" )
    v24 = "";
  goto LABEL_12;
}
...
__int64 sub_401EF0()
{
  ...
  if ( (unsigned int)sub_404480(stdout) )
  {
    v0 = __errno_location();
    v1 = v0;
...
LABEL_8:
  ...
  result = sub_404480(stderr);
  if ( (_DWORD)result )
    goto LABEL_8;
  return result;
}

char *__fastcall sub_401F90(const char *a1)
{
  __int64 v1; // rbx
  char *result; // rax
...
const char *__fastcall sub_402030(char *msgid, int a2)
{
  char *v2; // rbx
  _BYTE *v4; // rax
  bool v5; // zf
...
unsigned __int64 __fastcall sub_402130(
        _BYTE *a1,
        unsigned __int64 a2,
        __int64 a3,
        unsigned __int64 a4,
...
LABEL_4:
        ...
        if ( !(_BYTE)a5 )
        {
          ...
          if ( v41 )
          {
            ...
            {
              if ( v63 )
                return sub_402130((int)v9, v83, a3, v16, 5, a6, a7, (__int64)a8, a9);
              v42 = v83 != 0 && v10 == 0;
              if ( v42 )
              {
                v10 = v83;
...
LABEL_277:
              v30 = v18;
              LODWORD(v13) = v16;
              return sub_402130((int)v9, v10, a3, v13, v30, a6 & 0xFFFFFFFD, 0LL, (__int64)a8, a9);
            }
          }
        }
        LOBYTE(v22) = *v19;
...
LABEL_23:
      ...
      {
        v45 = (char *)v44 + v17;
        v25 = (const unsigned __int16 **)sub_404400((wchar_t *)&wc, (char *)v44 + v17 + a3);
        v46 = v25;
        if ( !v25 )
        {
LABEL_245:
...
_BYTE *__fastcall sub_403360(int a1, __int64 a2, unsigned __int64 a3, __int64 a4)
{
  int *v6; // rax
  __m128i *v7; // rbx
  int *v8; // r13
  ...
  if ( dword_608210 <= a1 )
  {
    ...
    {
      v7 = (__m128i *)sub_4041D0(0LL, v9);
      ptr = v7;
      *v7 = _mm_load_si128((const __m128i *)&xmmword_608200);
    }
    else
    {
      ptr = (void *)sub_4041D0(ptr, v9);
      v7 = (__m128i *)ptr;
    }
    memset(&v7[dword_608210], 0, 16LL * (a1 + 1 - dword_608210));
    dword_608210 = a1 + 1;
  }
  ...
  v21 = *(_DWORD *)(a4 + 4) | 1;
  v18 = *v10;
  v12 = sub_402130(v11, *v10, a2, a3, *(_DWORD *)a4, v21, a4 + 8, *(const char **)(a4 + 40), *(char **)(a4 + 48));
  if ( v18 <= v12 )
  {
    v13 = v12 + 1;
    *v10 = v12 + 1;
    if ( v11 != (_BYTE *)&unk_608280 )
    {
      v19 = v12 + 1;
      free(v11);
      v13 = v19;
    }
    v14 = (_BYTE *)sub_404170(v13);
    v15 = *(_DWORD *)a4;
    v10[1] = (unsigned __int64)v14;
    v11 = v14;
    sub_402130(v14, v13, a2, a3, v15, v21, a4 + 8, *(const char **)(a4 + 40), *(char **)(a4 + 48));
  }
  *v8 = v20;
  return v11;
}
...
__int64 __fastcall sub_403500(__int128 *a1)
{
  __int128 *v1; // rbx
  int *v2; // rax
  int v3; // r12d
  ...
  if ( !a1 )
    v1 = &xmmword_608380;
  result = sub_404370(v1, 0x38uLL);
  *v4 = v3;
  return result;
}

unsigned __int64 __fastcall sub_4035F0(_BYTE *a1, unsigned __int64 a2, __int64 a3, unsigned __int64 a4, __int128 *a5)
{
  __int128 *v6; // rbx
  int *v7; // rax
  int v8; // r12d
...
_BYTE *__fastcall sub_403670(__int64 a1, unsigned __int64 a2, unsigned __int64 *a3, __int128 *a4)
{
  __int128 *v5; // rbx
  int *v6; // r13
  int v7; // ebp
  ...
  v9 = *v6;
  v11 = sub_402130(0LL, 0LL, a1, a2, *(_DWORD *)v5, v7, (__int64)v5 + 8, *((const char **)v5 + 5), *((char **)v5 + 6));
  v10 = (_BYTE *)sub_404170(v11 + 1);
  sub_402130(v10, v11 + 1, a1, a2, *(_DWORD *)v5, v7, (__int64)v5 + 8, *((const char **)v5 + 5), *((char **)v5 + 6));
  *v6 = v9;
  if ( a3 )
    *a3 = v11;
  return v10;
...
_BYTE *__fastcall sub_403880(int a1, int a2, __int64 a3)
{
  ...
  v9 = 0LL;
  v10 = 0LL;
  return sub_403360(a1, a3, 0xFFFFFFFFFFFFFFFFLL, (__int64)v4);
}
...
_BYTE *__fastcall sub_4038F0(int a1, int a2, __int64 a3, unsigned __int64 a4)
{
  ...
  v10 = 0LL;
  v11 = 0LL;
  return sub_403360(a1, a3, a4, (__int64)v5);
}
...
_BYTE *__fastcall sub_403980(__int64 a1, unsigned __int64 a2, unsigned __int8 a3)
{
  _DWORD *v3; // r8
  ...
  *v3 ^= (((*v3 >> (a3 & 0x1F)) & 1) == 0) << (a3 & 0x1F);
  return sub_403360(0, a1, a2, (__int64)v5);
}

_BYTE *__fastcall sub_403A00(__int64 a1)
{
  return sub_403980(a1, 0xFFFFFFFFFFFFFFFFLL, 0x3Au);
}

_BYTE *__fastcall sub_403A30(int a1, int a2, __int64 a3)
{
  int v4[2]; // [rsp+0h] [rbp-48h] BYREF
  __int64 v5; // [rsp+8h] [rbp-40h]
  __int64 v6; // [rsp+10h] [rbp-38h]
...
_BYTE *__fastcall sub_403AA0(int a1, __int64 a2, __int64 a3, __int64 a4, unsigned __int64 a5)
{
  ...
  v8 = a3;
  return sub_403360(a1, a4, a5, (__int64)v6);
}

__int64 __fastcall sub_403BD0(FILE *stream, __int64 a2, __int64 a3, __int64 a4, __int64 *a5, __int64 a6)
{
  char *v8; // rax
  char *v9; // rax
  __int64 v10; // rbx
...
__int64 __fastcall sub_403FD0(FILE *a1, __int64 a2, __int64 a3, __int64 a4, int *a5)
{
  __int64 i; // r9
  __int64 *v6; // r10
  __int64 v7; // rax
  ...
  for ( i = 0LL; i != 10; ++i )
  {
    ...
    if ( (unsigned int)*a5 <= 0x2F )
    {
      ...
      *a5 = v8 + 8;
      ...
      v12[i] = *v6;
      if ( !v7 )
        return sub_403BD0(a1, a2, a3, a4, v12, i);
      continue;
    }
...
__int64 __fastcall sub_404030(FILE *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  char *v7; // r10
  unsigned int v8; // r8d
  __int64 i; // r9
  ...
  for ( i = 0LL; i != 10; ++i )
  {
    if ( v8 <= 0x2F )
    {
      ...
      v15[i] = v11;
      if ( !v11 )
        return sub_403BD0(a1, a2, a3, a4, v15, i);
      continue;
    }
    v12 = (__int64 *)v7;
    v7 += 8;
...
int sub_4040F0()
{
  ...
  __printf_chk(1LL, v2, &unk_40509B, "https://www.gnu.org/software/coreutils/");
  v3 = stdout;
  v4 = dcgettext(0LL, "General help using GNU software: <https://www.gnu.org/gethelp/>\n", 5);
  return fputs_unlocked(v4, v3);
}

void *__fastcall sub_404170(size_t a1)
{
  void *result; // rax
...
// attributes: thunk
void *__fastcall sub_4041C0(size_t a1)
{
  return sub_404170(a1);
}

void *__fastcall sub_4041D0(void *a1, size_t a2)
{
  void *result; // rax
...
void *__fastcall sub_404320(size_t n)
{
  void *v1; // rax
...
__int64 __fastcall sub_404340(unsigned __int64 a1, unsigned __int64 a2)
{
  ...
  {
    sub_4043C0(a1, a2, *((_QWORD *)&v2 + 1));
  }
  return v2;
}

void *__fastcall sub_404370(void *src, size_t n)
{
  void *v2; // rax
...
void *__fastcall sub_4043A0(char *src)
{
  size_t v1; // rax

  v1 = strlen(src);
  return sub_404370(src, v1 + 1);
}

void __noreturn sub_4043C0()
{
  char *v0; // rax
...
size_t __fastcall sub_404400(wchar_t *pwc, char *s, size_t a3, mbstate_t *a4)
{
  size_t v4; // rbx
  wchar_t *v5; // r12
  const char *v6; // rbp
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_4044E0(0LL) )
  {
    v4 = 1LL;
...
__int64 __fastcall sub_404480(FILE *stream)
{
  size_t v1; // r12
  int v2; // ebx
  __int64 result; // rax
...
bool __fastcall sub_4044E0(int a1)
{
  char *v1; // rdx
  bool result; // al
...
int __fastcall sub_404AB0(FILE *stream)
{
  int *v1; // rax
  int v2; // r12d
  int *v3; // rbp
  ...
  if ( !(unsigned int)sub_404B30(stream) )
    return fclose(stream);
  v1 = __errno_location();
  v2 = *v1;
  v3 = v1;
...
int __fastcall sub_404B30(FILE *stream)
{
  if ( !stream || !__freading(stream) || (stream->_flags & 0x100) == 0 )
    return fflush(stream);
  sub_404B70(stream, 0LL, 1LL);
  return fflush(stream);
}

int __fastcall sub_404B70(FILE *a1, __off_t a2, int a3)
{
  __off_t v3; // rax
  int v5; // eax
...
int __fastcall sub_404C40(void (__fastcall *a1)(void *))
{
  void *v1; // rdx
...
__int64 __fastcall sub_404C58(__int64 a1, __int64 a2, __int64 a3)
{
  void (**i)(void); // rbx
