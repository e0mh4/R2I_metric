__int64 __fastcall main(unsigned int a1, char **a2, char **a3)
{
  ...
  const char **v78; // [rsp+0h] [rbp-108h]
  char *s; // [rsp+8h] [rbp-100h]
  char v80; // [rsp+13h] [rbp-F5h]
  int v81; // [rsp+14h] [rbp-F4h]
  unsigned __int64 v82; // [rsp+18h] [rbp-F0h]
  __ssize_t v83; // [rsp+20h] [rbp-E8h]
  unsigned __int8 v84; // [rsp+20h] [rbp-E8h]
  unsigned __int64 v85; // [rsp+20h] [rbp-E8h]
  unsigned __int8 v86; // [rsp+20h] [rbp-E8h]
  const char *v87; // [rsp+20h] [rbp-E8h]
  unsigned __int64 v88; // [rsp+20h] [rbp-E8h]
  char v89; // [rsp+28h] [rbp-E0h]
  unsigned __int64 v90; // [rsp+28h] [rbp-E0h]
  unsigned __int64 v91; // [rsp+28h] [rbp-E0h]
  unsigned __int64 v92; // [rsp+28h] [rbp-E0h]
  __int64 v93; // [rsp+30h] [rbp-D8h]
  const char **v94; // [rsp+38h] [rbp-D0h]
  unsigned __int64 v95; // [rsp+40h] [rbp-C8h]
  char v96; // [rsp+48h] [rbp-C0h]
  char v97; // [rsp+49h] [rbp-BFh]
  char v98; // [rsp+4Ah] [rbp-BEh]
  char v99; // [rsp+4Bh] [rbp-BDh]
  int v100; // [rsp+4Ch] [rbp-BCh]
  char v101; // [rsp+5Fh] [rbp-A9h] BYREF
  char *lineptr; // [rsp+60h] [rbp-A8h] BYREF
  size_t n; // [rsp+68h] [rbp-A0h] BYREF
  char v104[48]; // [rsp+70h] [rbp-98h] BYREF
  char v105[104]; // [rsp+A0h] [rbp-68h] BYREF
...
void __fastcall __noreturn sub_402C90(int status)
{
  ...
  __printf_chk(1LL, v3, v1, "SHA256", 256LL);
  v4 = stdout;
  ...
  do
    v20 += 2;
  while ( *v20 && strcmp("sha256sum", (const char *)*v20) );
  v21 = (char *)v20[1];
  if ( v21 )
  {
    v22 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v22, &unk_409F12, "https://www.gnu.org/software/coreutils/");
    v23 = setlocale(5, 0LL);
  ...
  {
    v27 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v27, &unk_409F12, "https://www.gnu.org/software/coreutils/");
    v28 = setlocale(5, 0LL);
    if ( !v28 || !strncmp(v28, "en_", 3uLL) )
    {
      ...
      __printf_chk(1LL, v29, "https://www.gnu.org/software/coreutils/", "sha256sum");
LABEL_12:
...
LABEL_3:
  ...
  __printf_chk(1LL, v30, "sha256sum");
LABEL_10:
  v24 = "Multi-call invocation" + 10;
  v25 = dcgettext(0LL, "Full documentation at: <%s%s>\n", 5);
  __printf_chk(1LL, v25, "https://www.gnu.org/software/coreutils/", "sha256sum");
  if ( v21 != "sha256sum" )
    v24 = "";
  goto LABEL_12;
}
...
int sub_4083D0()
{
  ...
  __printf_chk(1LL, v1, &unk_409F12, "https://www.gnu.org/software/coreutils/");
  v2 = stdout;
