__int64 __fastcall main(int a1, char **a2, char **a3)
{
  ...
  unsigned int tm_min; // [rsp+18h] [rbp-F0h]
  unsigned int tm_sec; // [rsp+1Ch] [rbp-ECh]
  struct timespec tp; // [rsp+20h] [rbp-E8h] BYREF
  __time_t v50; // [rsp+30h] [rbp-D8h]
  __syscall_slong_t tv_nsec; // [rsp+38h] [rbp-D0h]
...
LABEL_95:
  ...
  if ( !v4 )
  {
    if ( byte_6183A2 )
    {
      ...
      if ( !v29 )
      {
        *(struct timespec *)&timer = stat_buf.st_atim;
    ...
    else
    {
      if ( v3 )
      {
        ...
        if ( stat_buf.st_dev != v50 || stat_buf.st_ino != tv_nsec )
          goto LABEL_33;
      }
...
LABEL_92:
    ...
    if ( v34 )
    {
      tm_hour = (unsigned int)v34->tm_hour;
      tm_mday = (unsigned int)v34->tm_mday;
      tm_sec = v34->tm_sec;
      tm_min = v34->tm_min;
      ...
      error(0, 0, v38, v46, v37, v43, tm_mday, tm_hour, tm_min, tm_sec);
    }
    goto LABEL_92;
  }
  if ( v3 || byte_6183A2 )
...
LABEL_94:
  ...
  if ( dword_61831C < a1 )
  {
    while ( 1 )
    {
      ...
      if ( byte_6183A0 )
        v18 = 0LL;
      if ( ((unsigned __int8)byte_6183A1 & (v14 == -1)) != 0 )
        break;
      if ( v14 != 1 )
      {
...
void __fastcall __noreturn sub_4027E0(int status)
{
  ...
  char *v28; // rax
  char *v29; // rax
  __int64 v30[17]; // [rsp+0h] [rbp-88h] BYREF
  ...
  v30[0] = (__int64)"[";
  v20 = v30;
  v30[1] = (__int64)"test invocation";
  v30[2] = (__int64)"coreutils";
  v30[3] = (__int64)"Multi-call invocation";
  v30[4] = (__int64)"sha224sum";
  v30[5] = (__int64)"sha2 utilities";
  v30[6] = (__int64)"sha256sum";
  v30[7] = (__int64)"sha2 utilities";
  v30[8] = (__int64)"sha384sum";
  v30[9] = (__int64)"sha2 utilities";
  v30[10] = (__int64)"sha512sum";
  v30[11] = (__int64)"sha2 utilities";
  v30[12] = 0LL;
  v30[13] = 0LL;
  do
    v20 += 2;
  while ( *v20 && strcmp("touch", (const char *)*v20) );
...
{
  __sprintf_chk(a2, 1LL, -1LL, (const char *)((a1 >= -1900) + 4266649LL), abs32(a1 / 100 + 19), abs32(a1 % 100));
  return a2;
}
...
bool __fastcall sub_4034C0(__int64 a1, _DWORD *a2, _DWORD *a3, __int64 a4)
{
  ...
  v5 = a4;
  return (a4 != -1 || (a3 = (_DWORD *)sub_40C180(a1, &v5, v6)) != 0LL)
      && (a3[5] ^ a2[5] | a3[4] ^ a2[4] | a3[3] ^ a2[3] | a3[2] ^ a2[2] | a3[1] ^ a2[1] | *a3 ^ *a2) == 0;
}

__int64 __fastcall sub_403530(unsigned __int8 a1, __int64 a2, __int64 a3)
{
...
int __fastcall sub_4036F0(__int64 a1, __int64 a2)
{
  ...
  v14 = sub_403530(0, v3, (__int64)"year(s)");
  v4 = *(_QWORD *)(a2 + 112);
  v5 = v14;
  if ( v4 )
  {
LABEL_4:
    v6 = sub_403530(v5, v4, (__int64)"month(s)");
    v7 = *(_QWORD *)(a2 + 120);
    v5 = v6;
    goto LABEL_5;
  }
...
LABEL_5:
  if ( v7 )
LABEL_6:
    v5 = sub_403530(v5, v7, (__int64)"day(s)");
LABEL_7:
  v8 = *(_QWORD *)(a2 + 128);
  if ( v8 )
    v5 = sub_403530(v5, v8, (__int64)"hour(s)");
  v9 = *(_QWORD *)(a2 + 136);
  if ( v9 )
    v5 = sub_403530(v5, v9, (__int64)"minutes");
  v10 = *(_QWORD *)(a2 + 144);
  if ( v10 )
    v5 = sub_403530(v5, v10, (__int64)"seconds");
  if ( *(_DWORD *)(a2 + 152) )
    sub_403530(v5, *(int *)(a2 + 152), (__int64)"nanoseconds");
...
__int64 __fastcall sub_403880(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( v4 > 99 || !*(_QWORD *)(a2 + 208) )
    return a3;
  v7 = (const char *)sub_403290(*(_DWORD *)(a2 + 24), (__int64)&v8);
...
char *__fastcall sub_403920(__int64 a1, char *a2)
{
  ...
  if ( !*(_BYTE *)(a1 + 224) )
  {
    *a2 = 0;
    ...
    {
      __snprintf_chk(a2, 100LL, 1LL, -1LL, "%s", (char *)&unk_412B60 + 4 * v6);
      return a2;
    }
    return a2;
  }
  ...
  if ( (unsigned int)v4 > 6 )
    return a2;
LABEL_5:
  __snprintf_chk(&a2[v3], 100 - v3, 1LL, -1LL, (const char *)((v3 == 0) + 4266619LL), (char *)&unk_412B60 + 4 * v4);
  return a2;
}
...
LABEL_5:
  if ( *(_QWORD *)(a2 + 200) && !*(_BYTE *)(a2 + 221) )
  {
    __fprintf_chk(
      stderr,
      1LL,
      (const char *)(((unsigned __int8)v2 ^ 1u) + 4266851LL),
      *(_QWORD *)(a2 + 72),
      *(_QWORD *)(a2 + 80),
      *(_QWORD *)(a2 + 88));
    v14 = *(_QWORD *)(a2 + 96);
...
LABEL_11:
  if ( !*(_QWORD *)(a2 + 184) || *(_BYTE *)(a2 + 220) )
  {
    ...
    v15 = (const char *)(((unsigned __int8)v2 ^ 1u) + 4266806LL);
LABEL_36:
    v16 = sub_403290(*(_DWORD *)(a2 + 24), (__int64)v17);
  ...
  if ( !*(_QWORD *)(a2 + 192) )
    v9 = "";
  __fprintf_chk(stderr, 1LL, (const char *)(((unsigned __int8)v2 ^ 1u) + 4266879LL), *(unsigned int *)(a2 + 20), v9);
...
__int64 __fastcall sub_403DB0(__m128i *a1, __m128i a2)
{
  __int64 v2; // r8
        ...
        if ( !v217 )
        {
          ...
          while ( strcmp(s1, v214) )
          {
            ...
            if ( !*v210 )
            {
              ...
              while ( v243 );
              if ( !v230 || (v254 = a1, v217 = sub_403630((__int64)a1, s1), a1 = v254, v2 = v234, !v217) )
              {
LABEL_279:
                if ( !a1[13].m128i_i8[9] )
                  goto LABEL_114;
...
LABEL_26:
    ...
    if ( !(_BYTE)v5 )
      goto LABEL_27;
LABEL_71:
    v8 = (unsigned __int8)byte_413820[v5];
LABEL_72:
    v4 += v8;
    goto LABEL_6;
  }
...
LABEL_27:
  ...
  v5 = 0;
LABEL_6:
  if ( v4 <= 0x70 && byte_4135E0[v4] == v8 )
  {
    v2 = (unsigned __int8)byte_413660[v4];
    if ( byte_413660[v4] )
    {
      v9 = (__m128i *)v7;
      v5 = -2;
  ...
  while ( 1 )
  {
    v13 = (unsigned __int8)byte_413720[v2];
    v14 = byte_413720[v2];
    if ( v14 )
    {
      v18 = (unsigned __int8)byte_413520[(unsigned __int8)byte_413720[v2]];
      v19 = (const __m128i *)&v6[56 * (1 - (unsigned __int8)byte_413520[(unsigned __int8)byte_413720[v2]])];
...
LABEL_183:
        ...
        case 23:
          ...
          ++a1[13].m128i_i64[0];
          v268 = (__int64)a1;
          v96 = sub_403570(&a1[1].m128i_i32[2], v95, v94, v92, v93);
          a1 = (__m128i *)v268;
          v27 = v269;
          v24 = (__int64)v270;
          if ( !v96 )
...
LABEL_149:
        ...
        case 30:
          ...
          v269 = v27;
          v268 = (__int64)a1;
          if ( !(unsigned __int8)sub_403570(&a1[1].m128i_i32[2], v153, v152, v150, v151) )
            return 1LL;
          a1 = (__m128i *)v268;
          v154 = *(int *)(v268 + 24);
...
LABEL_137:
        ...
        case 84:
          ...
          v249 = *(_QWORD *)v6;
          v268 = (__int64)a1;
          sub_403110(a1, v18, v29, v13, v2, (__int64)a1, a2, v249);
          v67 = (__int64)(v6 - 56);
          v9 = (__m128i *)(v7 - 1);
          LODWORD(v2) = -93;
          v70 = 23;
        ...
        case 85:
          ...
          v248 = *((_QWORD *)v6 - 7);
          v268 = (__int64)a1;
          sub_403110(a1, v18, v29, v13, v2, (__int64)a1, a2, v248);
          v188 = *((_DWORD *)v6 + 12);
          a1 = (__m128i *)v268;
        ...
        case 87:
          ...
          break;
        default:
          v70 = (unsigned __int8)byte_413580[v13] - 28;
          LODWORD(v2) = byte_413700[v70];
          v9 = (__m128i *)&v7[-v18];
          v67 = (__int64)&v6[-56 * v18];
          break;
      }
LABEL_99:
      ...
      *(__m128i *)(v67 + 88) = v73;
      ...
      if ( v75 <= 0x70 && v9->m128i_i16[0] == byte_4135E0[v75] )
        v2 = (unsigned __int8)byte_413660[v75];
      else
        v2 = byte_4136E0[v70];
      goto LABEL_10;
    }
...
LABEL_21:
    while ( 1 )
    {
      ...
      if ( v16 != -93 )
      {
        ...
        {
          v2 = (unsigned __int8)byte_413660[v17];
          if ( byte_413660[v17] )
            break;
        }
      }
...
LABEL_10:
    ...
    if ( (_DWORD)v2 == 12 )
      return 0LL;
    v4 = byte_4137A0[(int)v2];
    if ( v4 != -93 )
      goto LABEL_2;
  }
}

__int64 __fastcall sub_406030(__int64 a1, const char *a2, struct timespec *a3, char a4, __int64 a5, char *a6)
{
  __time_t tv_sec; // rbx
  char *v10; // r12
  ...
  if ( (unsigned __int8)v11 <= 0x20u )
  {
    ...
    if ( _bittest64(&v12, v11) )
    {
      do
        ++v10;
      while ( (unsigned __int8)*v10 <= 0x20u && ((1LL << *v10) & 0x100003E00LL) != 0 );
    }
  }
  if ( memcmp(v10, "TZ=\"", 4uLL) || (v13 = v10[4], v14 = v10 + 4, !v13) )
  {
LABEL_14:
    if ( !sub_40C180(a5, a3, v135) )
      goto LABEL_108;
    ptr = 0LL;
    v20 = a5;
    goto LABEL_16;
...
LABEL_16:
  ...
  {
    v139[0] = tv_sec + v22;
    if ( sub_40C180(v20, v139, v141) && v145 && v143 != v176 )
    {
      s2 = v145;
      v178 = 269;
      v179 = v143;
  ...
  if ( (unsigned int)sub_403DB0(&v146, (__m128i)0LL) )
  {
    v23 = v170;
    if ( !v170 )
      goto LABEL_79;
...
LABEL_111:
    ...
    if ( v165 )
    {
      ...
      {
LABEL_113:
        v58 = (const char *)sub_403290(v149, (__int64)v124);
...
LABEL_50:
    ...
    v134 = v36;
    v37 = sub_40C230(v20, &v125);
    if ( sub_4034C0(v20, &v131, &v125, v37) )
      goto LABEL_164;
    v118 = v168;
    if ( v168 )
    {
      memset(v141, 88, sizeof(v141));
      sub_403290(v149, (__int64)v142);
      v65 = sub_40BEA0(v141);
      v66 = v65;
      if ( !v65 )
      {
      ...
      v127 = v133;
      v129 = v134;
      v37 = sub_40C230(v65, &v125);
      v67 = sub_4034C0(v66, &v131, &v125, v37);
      sub_40C160(v66);
      if ( v67 )
      {
LABEL_164:
        if ( v164 )
        {
          ...
          if ( v73 != (int)v73 )
            v74 = 1;
          if ( v74 || (v129 = -1, v37 = sub_40C230(v20, &v125), v37 == -1) )
          {
LABEL_236:
            if ( v170 )
            {
              sub_403880((__int64)&v125, (__int64)&v146, (__int64)v139);
              sub_403920((__int64)&v146, v141);
          ...
          if ( !v164 )
            goto LABEL_207;
               ...
               || (v109 = HIDWORD(v126),
                   ...
                   v101 = (const char *)sub_403390(SHIDWORD(v127), (__int64)&tp),
                        ...
                        *(_QWORD *)(a1 + 8) = v82;
                        if ( v27 )
                        {
                          if ( v107 | v85 | v88 | v80 )
                          {
                            ...
                            sub_403400();
                            if ( v129 != -1 && sub_40C180(v20, a1, &tp) && v129 != tp.tm_isdst )
                            {
...
LABEL_122:
                        ...
                        {
                          sub_403880((__int64)&tp, 0LL, (__int64)v139);
                          dcgettext(0LL, "final: %s (UTC)\n", 5);
                          sub_403400();
                        }
                        if ( sub_40C180(v20, a1, v141) )
                        {
                          sub_403290(v144, (__int64)v124);
                          sub_403880((__int64)v141, 0LL, (__int64)v139);
                  ...
                  && ((_DWORD)v94 != HIDWORD(v126) || !*((_QWORD *)&v158 + 1) && (_DWORD)v93 != (_DWORD)v127) )
                {
                  ...
                  sub_403400();
                  sub_403390(v108, (__int64)&tp);
                  dcgettext(0LL, "     adjusted Y M D: %s %02d %02d\n", 5);
                  sub_403400();
                  sub_403390(SHIDWORD(v127), (__int64)&tp);
...
LABEL_229:
    ...
    if ( v131 == v125 )
    {
      if ( HIDWORD(v132) == HIDWORD(v126) && (_DWORD)v132 != (_DWORD)v126 && v133 == v127 )
      {
        ...
        sub_403400();
        sub_403880((__int64)&v131, (__int64)&v146, (__int64)v141);
        dcgettext(0LL, "    user provided time: '%s'\n", 5);
        sub_403400();
        sub_403880((__int64)&v125, (__int64)&v146, (__int64)v141);
...
__int64 __fastcall sub_408000(__int64 a1, const char *a2, struct timespec *a3)
{
  unsigned int v4; // ebp
  char *v5; // r12
  __int64 v6; // rax
  ...
  {
    v7 = v6;
    v4 = sub_406030(a1, a2, a3, 0, v6, v5);
    sub_40C160(v7);
  }
  return v4;
}
    ...
    while ( (unsigned int)(*v9 - 48) <= 9 )
    {
      if ( &a2[v4] == ++v9 )
      {
        ...
        if ( (a3 & 1) != 0 )
        {
          ...
          if ( !(unsigned __int8)sub_408070((int *)v26 + 1, (int *)&v30, v12, a3) )
            return 0LL;
        }
        else
        {
          if ( !(unsigned __int8)sub_408070((int *)v26 + 1, &v27, v12, a3) )
            return 0LL;
...
unsigned __int64 __fastcall sub_4085D0(
        _BYTE *a1,
        unsigned __int64 a2,
        __int64 a3,
        unsigned __int64 a4,
...
LABEL_4:
        ...
        if ( !(_BYTE)a5 )
        {
          ...
          if ( v41 )
          {
            ...
            {
              if ( v63 )
                return sub_4085D0((int)v9, v83, a3, v16, 5, a6, a7, (__int64)a8, a9);
              v42 = v83 != 0 && v10 == 0;
              if ( v42 )
              {
                v10 = v83;
...
LABEL_277:
              v30 = v18;
              LODWORD(v13) = v16;
              return sub_4085D0((int)v9, v10, a3, v13, v30, a6 & 0xFFFFFFFD, 0LL, (__int64)a8, a9);
            }
          }
        }
        LOBYTE(v22) = *v19;
...
LABEL_23:
      ...
      {
        v45 = (char *)v44 + v17;
        v25 = (const unsigned __int16 **)sub_40B670((wchar_t *)&wc, (char *)v44 + v17 + a3);
        v46 = v25;
        if ( !v25 )
        {
LABEL_245:
...
_BYTE *__fastcall sub_409800(int a1, __int64 a2, unsigned __int64 a3, __int64 a4)
{
  int *v6; // rax
  __m128i *v7; // rbx
  int *v8; // r13
  ...
  if ( dword_618310 <= a1 )
  {
    if ( a1 == 0x7FFFFFFF )
      sub_40A860();
    v9 = 16LL * (a1 + 1);
    if ( ptr == &xmmword_618300 )
    {
      v7 = (__m128i *)sub_40A670(0LL, v9);
      ptr = v7;
      *v7 = _mm_load_si128((const __m128i *)&xmmword_618300);
    }
    else
    {
      ptr = (void *)sub_40A670(ptr, v9);
      v7 = (__m128i *)ptr;
    }
  ...
  v21 = *(_DWORD *)(a4 + 4) | 1;
  v18 = *v10;
  v12 = sub_4085D0(v11, *v10, a2, a3, *(_DWORD *)a4, v21, a4 + 8, *(char **)(a4 + 40), *(char **)(a4 + 48));
  if ( v18 <= v12 )
  {
    v13 = v12 + 1;
    *v10 = v12 + 1;
    ...
    v11 = v14;
    sub_4085D0(v14, v13, a2, a3, v15, v21, a4 + 8, *(char **)(a4 + 40), *(char **)(a4 + 48));
  }
  *v8 = v20;
  return v11;
}
...
__int64 __fastcall sub_4099A0(__int128 *a1)
{
  __int128 *v1; // rbx
  int *v2; // rax
  int v3; // r12d
  ...
  if ( !a1 )
    v1 = &xmmword_6184C0;
  result = sub_40A810(v1, 0x38uLL);
  *v4 = v3;
  return result;
}

unsigned __int64 __fastcall sub_409A90(_BYTE *a1, unsigned __int64 a2, __int64 a3, unsigned __int64 a4, __int128 *a5)
{
  __int128 *v6; // rbx
  int *v7; // rax
  int v8; // r12d
...
_BYTE *__fastcall sub_409B10(__int64 a1, unsigned __int64 a2, unsigned __int64 *a3, __int128 *a4)
{
  __int128 *v5; // rbx
  int *v6; // r13
  int v7; // ebp
  ...
  v9 = *v6;
  v11 = sub_4085D0(0LL, 0LL, a1, a2, *(_DWORD *)v5, v7, (__int64)v5 + 8, *((char **)v5 + 5), *((char **)v5 + 6));
  v10 = (_BYTE *)sub_40A610(v11 + 1);
  sub_4085D0(v10, v11 + 1, a1, a2, *(_DWORD *)v5, v7, (__int64)v5 + 8, *((char **)v5 + 5), *((char **)v5 + 6));
  *v6 = v9;
  if ( a3 )
    *a3 = v11;
  return v10;
...
void sub_409C10()
{
  ...
  {
    v1 = (void **)((char *)ptr + 24);
    v2 = (void **)((char *)ptr + 16 * (unsigned int)(dword_618310 - 2) + 40);
    do
    {
      v3 = *v1;
      v1 += 2;
  ...
  {
    free(v4);
    *(_QWORD *)&xmmword_618300 = 256LL;
    *((_QWORD *)&xmmword_618300 + 1) = &unk_6183C0;
  }
  if ( v0 != &xmmword_618300 )
  {
    free(v0);
    ptr = &xmmword_618300;
  }
...
_BYTE *__fastcall sub_409D20(int a1, int a2, __int64 a3)
{
...
_BYTE *__fastcall sub_409D90(int a1, int a2, __int64 a3, unsigned __int64 a4)
{
...
_BYTE *__fastcall sub_409E00(int a1, __int64 a2)
{
  return sub_409D20(0, a1, a2);
}

_BYTE *__fastcall sub_409E20(__int64 a1, unsigned __int64 a2, unsigned __int8 a3)
{
  _DWORD *v3; // r8
  ...
  v6 = qword_6184F0;
  v5[0] = (__int128)_mm_load_si128((const __m128i *)&xmmword_6184C0);
  v5[1] = (__int128)_mm_load_si128((const __m128i *)&xmmword_6184D0);
  v3 = (_DWORD *)v5 + (a3 >> 5) + 2;
  v5[2] = (__int128)_mm_load_si128((const __m128i *)&xmmword_6184E0);
  *v3 ^= (((*v3 >> (a3 & 0x1F)) & 1) == 0) << (a3 & 0x1F);
  return sub_409800(0, a1, a2, (__int64)v5);
}

_BYTE *__fastcall sub_409EA0(__int64 a1)
{
  return sub_409E20(a1, 0xFFFFFFFFFFFFFFFFLL, 0x3Au);
}

_BYTE *__fastcall sub_409ED0(int a1, int a2, __int64 a3)
{
  int v4[2]; // [rsp+0h] [rbp-48h] BYREF
  __int64 v5; // [rsp+8h] [rbp-40h]
  __int64 v6; // [rsp+10h] [rbp-38h]
...
_BYTE *__fastcall sub_409F40(int a1, __int64 a2, __int64 a3, __int64 a4, unsigned __int64 a5)
{
  __int128 v6[2]; // [rsp+0h] [rbp-48h] BYREF
  __m128i si128; // [rsp+20h] [rbp-28h]
  __int64 v8; // [rsp+30h] [rbp-18h]

  v6[0] = (__int128)_mm_load_si128((const __m128i *)&xmmword_6184C0);
  v6[1] = (__int128)_mm_load_si128((const __m128i *)&xmmword_6184D0);
  si128 = _mm_load_si128((const __m128i *)&xmmword_6184E0);
  v8 = qword_6184F0;
  LODWORD(v6[0]) = 10;
  if ( !a2 || !a3 )
    abort();
...
_BYTE *__fastcall sub_40A030(int a1, __int64 a2)
{
  return sub_409800(a1, a2, 0xFFFFFFFFFFFFFFFFLL, (__int64)&unk_6182C0);
}

_BYTE *__fastcall sub_40A050(__int64 a1)
{
  return sub_409800(0, a1, 0xFFFFFFFFFFFFFFFFLL, (__int64)&unk_6182C0);
}

__int64 __fastcall sub_40A070(FILE *stream, const char *a2, const char *a3, const char *a4, __int64 *a5, __int64 a6)
{
  char *v8; // rax
  char *v9; // rax
  __int64 v10; // rax
...
__int64 __fastcall sub_40A470(FILE *a1, const char *a2, const char *a3, const char *a4, int *a5)
{
  __int64 i; // r9
  __int64 *v6; // r10
  __int64 v7; // rax
...
// attributes: thunk
void *__fastcall sub_40A660(size_t a1)
{
...
void *__fastcall sub_40A7C0(size_t n)
{
  void *v1; // rax
...
__int64 __fastcall sub_40A7E0(unsigned __int64 a1, unsigned __int64 a2)
{
...
void *__fastcall sub_40A840(char *src)
{
  size_t v1; // rax

  v1 = strlen(src);
  return sub_40A810(src, v1 + 1);
}
...
__int64 __fastcall sub_40AFA0(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5, int a6, int *a7, int a8)
{
  int v8; // r13d
  int v9; // eax
  int v10; // ebp
    ...
    if ( *v17 == 45 )
    {
      ...
      if ( v30 )
      {
        if ( a4 )
        {
          ...
          {
            *((_QWORD *)a7 + 4) = v17 + 2;
            return (unsigned int)sub_40A980(v10, a2, v12, a4, a5, a6, a7, v8, "--");
          }
          if ( a6 )
          {
            ...
            {
              *((_QWORD *)a7 + 4) = v17 + 1;
              v21 = sub_40A980(v10, a2, v12, a4, a5, a6, a7, v8, "-");
              if ( v21 != -1 )
                return v21;
              v17 = (_BYTE *)a2[*a7];
            }
...
LABEL_68:
        *((_QWORD *)a7 + 4) = v23;
        *((_QWORD *)a7 + 2) = 0LL;
        return (unsigned int)sub_40A980(v10, a2, v12, a4, a5, 0, a7, v8, "-W ");
      }
      v32 = *a7;
      if ( (_DWORD)v32 != v10 )
      {
...
__int64 __fastcall sub_40B570(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax
...
__int64 __fastcall sub_40B5D0(int a1, __int64 *a2, const char *a3)
{
  return sub_40B570(a1, a2, a3, 0LL, 0LL, 0, 1);
}

__int64 __fastcall sub_40B5F0(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5)
{
  return sub_40B570(a1, a2, a3, a4, a5, 0, 0);
}

__int64 __fastcall sub_40B610(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5, int *a6)
{
  return sub_40AFA0(a1, a2, a3, a4, a5, 0, a6, 0);
}

__int64 __fastcall sub_40B630(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5)
{
  return sub_40B570(a1, a2, a3, a4, a5, 1, 0);
}

__int64 __fastcall sub_40B650(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5, int *a6)
{
...
unsigned __int64 __fastcall sub_40B810(__int64 a1, __int64 a2, int a3, int a4, int a5, __int64 a6, int *a7)
{
  __int64 v8; // rax
  bool v9; // of
  unsigned __int64 result; // rax
...
unsigned __int64 __fastcall sub_40B970(int *a1, __int64 (__fastcall *a2)(__int64 *, __int64), _QWORD *a3)
{
  __int64 v4; // rsi
  int v5; // eax
  int v6; // edi
  ...
  v9 = 59;
  v10 = 6;
  v11 = (unsigned __int16)word_414BA0[13 * v7 + (((v6 % 12) >> 31) & 0xC) + v6 % 12] - 1 + v4;
  if ( v38 <= 59 )
    v9 = v38;
  v12 = 0;
  if ( v9 >= 0 )
  ...
  while ( 1 )
  {
    v16 = (int *)sub_40B8B0(a2, (__int64 *)&v41, (__int64)&v43);
    v17 = v41;
...
LABEL_17:
  ...
  if ( (v35 == 0) != (v45.m128i_i32[0] == 0) && v35 >= 0 && v45.m128i_i32[0] >= 0 )
  {
    for ( i = 601200; i != 269337600; i += 601200 )
    {
      ...
      {
LABEL_34:
        sub_40B8B0(a2, &v42, (__int64)v47);
        if ( (v35 == 0) == (v48 == 0) || v48 < 0 )
        {
          v41 = sub_40B810(v8, v11, v33, v31, v34, v42, (int *)v47);
          sub_40B8B0(a2, (__int64 *)&v41, (__int64)&v43);
          result = v41;
          break;
        }
        result = v41;
...
unsigned __int64 __fastcall sub_40BDB0(int *a1)
{
  tzset();
  return sub_40B970(a1, (__int64 (__fastcall *)(__int64 *, __int64))localtime_r, &qword_618538);
}
...
_QWORD *__fastcall sub_40BEA0(const char *src)
{
  size_t v2; // rax
  __int64 v3; // rdi
  size_t v4; // rbp
...
struct tm *__fastcall sub_40C180(__int64 *a1, const time_t *a2, struct tm *a3)
{
  ...
  if ( v4 )
  {
    if ( localtime_r(a2, a3) && (unsigned __int8)sub_40BF30(a1, (unsigned __int64)a3) )
    {
...
unsigned __int64 __fastcall sub_40C350(int *a1)
{
  a1[8] = 0;
  return sub_40B970(a1, (__int64 (__fastcall *)(__int64 *, __int64))gmtime_r, &qword_618540);
}
...
LABEL_174:
    ...
    case 84:
LABEL_94:
      v57 = sub_40CB00(0LL, (__int64)a7, a8);
      v58 = 0;
      if ( v23 >= 0 )
        v58 = v23;
      v59 = v58;
...
LABEL_226:
    ...
    case 90:
      ...
      if ( s )
      {
        ...
        if ( v77 )
        {
          sub_40CA60((__int64)s, (__int64)v136, v73);
        }
        else if ( v76 )
        {
          sub_40CAB0((__int64)s, (__int64)v136, v73);
        }
        else
        {
          memcpy(s, v136, v73);
        ...
        if ( v30 )
        {
          ...
          if ( a2 - v13 > v33 )
          {
            if ( s )
            {
              ...
              if ( !v29 )
                goto LABEL_64;
              sub_40CA60((__int64)s, (__int64)&sa[1], v31);
              v39 = v141;
              v14 = v152;
              goto LABEL_66;
            }
...
LABEL_242:
          if ( v99 > v81 )
          {
            if ( s )
            {
              ...
              if ( v16 )
              {
                sub_40CAB0((__int64)s, (__int64)v96, v97);
                v102 = v148;
                v14 = v159;
              }
              else
...
__int64 __fastcall sub_40E2D0(char *a1, __int64 a2, char *a3, const __m128i *a4, __int64 *a5, int a6)
{
  char v7[9]; // [rsp+Fh] [rbp-9h] BYREF

  v7[0] = 0;
  return sub_40CB00(a1, a2, a3, a4, 0, (__int64)v7, a5, a6);
}
...
char *__fastcall sub_40E420(void *a1, size_t *a2, _BYTE *a3, __int64 a4)
{
  ...
  src = a1;
  v155 = a2;
  if ( (int)sub_410160(a3, &v170, v167) < 0 )
    return 0LL;
  if ( (int)sub_40FF40(a4, v167) >= 0 )
  {
    v6 = v172 + 7;
...
__int64 __fastcall sub_410EF8(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  for ( i = (void (**)(void))&qword_617E30; *i != (void (*)(void))-1LL; --i )
    (*i)();
  return a3;
}
