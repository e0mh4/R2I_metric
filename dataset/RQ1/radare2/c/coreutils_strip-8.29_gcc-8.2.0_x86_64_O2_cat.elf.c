...
label_40:
    ...
    *((rsp + 0x68)) = rax;
    rax = rbp;
    rax = *(rdx:rax) / rsp + 0x60;
    rdx = *(rdx:rax) % rsp + 0x60;
    rbp -= rdx;
    while (rax != -1) {
        if (rax == 0) {
            goto label_63;
...
int64_t fcn_00402480 (void) {
    ...
    *(rax) = dl;
    return rax;
label_0:
    if (rcx <= str._________________0_t) {
        goto label_1;
    }
    rdx = rcx - 1;
    *((rcx - 1)) = 0x31;
...
int64_t fcn_00405040 (int64_t arg_90h, int64_t arg_98h, int64_t arg_a0h, signed int64_t arg1, int64_t arg2, char * arg3, int64_t arg4, int64_t arg5, int64_t arg6) {
    int64_t var_ch;
    int64_t var_10h;
    void * ptr;
    int64_t var_20h;
