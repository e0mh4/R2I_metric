...
label_61:
    fcn_00404930 (0);
label_75:
    eax = assert_fail ("!\"invalid header_mode\", "src/df.c", 0x1f0, "get_field_list");
label_66:
    r8d = "--output";
    ecx = 0x411103;
    do {
...
label_53:
    ...
    *((rsp + 0x30)) = rax;
    goto label_20;
label_41:
    assert_fail ("!\"bad field_type\", "src/df.c", 0x435, "get_dev");
label_51:
    rax = rdx;
    xmm0 = 0;
    xmm2 = 0;
    ...
    goto label_16;
label_35:
    assert_fail ("!\"unhandled field\", "src/df.c", 0x49b, "get_dev");
label_37:
    al = assert_fail ("!\"empty cell\", "src/df.c", 0x49f, "get_dev");
label_55:
    r8 -= rdx;
    *(0x006176a0) = al;
    ecx = eax;
...
label_6:
    ...
    goto label_1;
label_7:
    assert_fail ("!\"invalid field\", "src/df.c", 0x1ab, "decode_output_arg");
label_4:
...
int64_t fcn_0040b710 (int64_t arg_90h, int64_t arg_98h, int64_t arg_a0h, signed int64_t arg1, int64_t arg2, char * arg3, int64_t arg4, int64_t arg5, int64_t arg6) {
    int64_t var_ch;
    int64_t var_10h;
    void * ptr;
    int64_t var_20h;
...
label_0:
        ...
        eax = 0;
        eax = void (*0x40fe90)(uint64_t, uint64_t, uint64_t) (rdi, 0, rdx);
    }
    ebx = eax;
    if (eax < 0) {
        goto label_0;
...
label_5:
    ...
    eax = 0;
    eax = void (*0x40fe90)(uint64_t, uint64_t, uint64_t) (ebp, 0, r12d);
    goto label_2;
    ebx = eax;
    if (eax < 0) {
        goto label_0;
