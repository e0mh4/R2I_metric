...
uint64_t fcn_00406300 (void) {
    ...
    esi = 0;
    edi = 0;
    rax = void (*0x406330)(uint64_t) (rbx);
    rbx = rax;
    while (*(rax) != 0xc) {
        rax = rbx;
        return rax;
...
int64_t fcn_004068e0 (int64_t arg_90h, int64_t arg_98h, int64_t arg_a0h, signed int64_t arg1, int64_t arg2, char * arg3, int64_t arg4, int64_t arg5, int64_t arg6) {
    int64_t var_ch;
    int64_t var_10h;
    void * ptr;
    int64_t var_20h;
