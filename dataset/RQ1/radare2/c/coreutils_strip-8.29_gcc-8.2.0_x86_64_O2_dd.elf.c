...
label_22:
    ...
    *(0x00614658) = rax;
    eax = 0;
    fcn_00406900 (ebp, rbx, 0x40dc23, 0x40dca5, *(0x006142c8), fcn.00405460);
    r8d = 0;
    rsi = rbx;
    ecx = 0x40f680;
    edx = 0x410daf;
...
label_3:
    ...
    if (r13 != 0) {
        rax = r13;
        edx = 0;
        rax = *(rdx:rax) / 0x00614650;
        rdx = *(rdx:rax) % 0x00614650;
        *(0x00614638) = rax;
        *(0x00614630) = rdx;
    }
label_7:
...
label_6:
    ...
    if (rax != 0) {
        edx = 0;
        rax = *(rdx:rax) / 0x00614648;
        rdx = *(rdx:rax) % 0x00614648;
        *(0x00614628) = rax;
        *(0x00614620) = rdx;
    }
label_10:
...
label_14:
    ...
    edx = 0;
    ebx = 0;
    rax = *(rdx:rax) / 0x00614658;
    rdx = *(rdx:rax) % 0x00614658;
    rsi -= rdx;
    goto label_4;
label_11:
    esi = 0;
...
int64_t fcn_00409890 (int64_t arg_90h, int64_t arg_98h, int64_t arg_a0h, signed int64_t arg1, int64_t arg2, char * arg3, int64_t arg4, int64_t arg5, int64_t arg6) {
    int64_t var_ch;
    int64_t var_10h;
    void * ptr;
    int64_t var_20h;
