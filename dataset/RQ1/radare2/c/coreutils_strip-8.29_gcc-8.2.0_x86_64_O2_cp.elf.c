...
label_114:
    ...
    *((rbx - 0x2e74b))--;
    *((rbx - 0x2bf43))--;
    void (*rdx - 1)(uint64_t*, uint64_t, uint64_t) (*((rbp - 0x2f8)), rax, rdx);
...
int64_t fcn_004106d0 (int64_t arg_90h, int64_t arg_98h, int64_t arg_a0h, signed int64_t arg1, int64_t arg2, char * arg3, int64_t arg4, int64_t arg5, int64_t arg6) {
    int64_t var_ch;
    int64_t var_10h;
    void * ptr;
    int64_t var_20h;
