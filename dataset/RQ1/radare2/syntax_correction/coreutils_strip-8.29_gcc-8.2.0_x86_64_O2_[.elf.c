...
invalid_funccall(); //                eax = void (*0x402cd0)(uint64_t, uint64_t, uint64_t) (rdi, rsi, rdx);
                eax ^= 1;
label_12:
                return rax;
            }
...
label_51:
    ...
    eax++;
    *(0x0060d2a4) = eax;
invalid_funccall(); //    void (*0x4026f0)(uint64_t, uint64_t, uint64_t) (rdi, rsi, rdx);
    goto label_11;
    *(0x0060d2a4)++;
    goto label_12;
label_52:
...
label_60:
    ...
    goto label_19;
label_67:
invalid_funccall(); //    void (*0x402210)(uint64_t, uint64_t, uint64_t) (0, rsi, rdx);
    goto label_20;
    ebx = imp.__libc_start_main;
    r14d = imp.__libc_start_main;
    goto label_18;
label_64:
    ...
    *(0x0060d2a4) = ebx;
    goto label_22;
label_66:
invalid_funccall(); //    void (*0x402210)(uint64_t, uint64_t, uint64_t) (1, rsi, rdx);
    goto label_20;
    ebx = imp.__libc_start_main;
    r14d = imp.__libc_start_main;
    goto label_18;
...
invalid_funccall(); //    eax = void (*0x4026f0)(uint64_t, uint64_t, uint64_t) (rdi, rsi, rdx);
    goto label_11;
    eax ^= 1;
    do {
        return rax;
...
int64_t fcn_00403290 (uint32_t arg1, int64_t arg2, int64_t arg3) {
    rdi = arg1;
    rsi = arg2;
    rdx = arg3;
    rcx = rsi + 0x14;
...
invalid_funccall(); //    return void (*0x4046b0)() ();
}
/* r2dec pseudo code output */
...
label_2:
    rdi = rbx;
label_1:
invalid_funccall(); //    void (*0x401430)() ();
label_3:
    *(rbp) = r12d;
    eax = 0xffffffff;
    goto label_0;
...
label_0:
    rdi = rbx;
invalid_funccall(); //    void (*0x401590)() ();
label_1:
