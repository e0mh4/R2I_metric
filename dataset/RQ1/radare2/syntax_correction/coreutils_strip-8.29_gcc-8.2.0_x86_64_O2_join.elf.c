...
void fcn_00405a00 (int64_t arg1) {
    ...
    edi = 0;
invalid_funccall(); //    return void (*0x4051b0)() ();
}
/* r2dec pseudo code output */
...
label_0:
        ...
        eax = 0;
invalid_funccall(); //        eax = void (*0x406890)(uint64_t, uint64_t, uint64_t) (rdi, 0, rdx);
    }
    ebx = eax;
    if (eax < 0) {
        goto label_0;
...
label_5:
    ...
    eax = 0;
invalid_funccall(); //    eax = void (*0x406890)(uint64_t, uint64_t, uint64_t) (ebp, 0, r12d);
    goto label_2;
    ebx = eax;
    if (eax < 0) {
        goto label_0;
...
int64_t fcn_00406130 (int64_t arg1, int64_t arg2) {
    ...
    do {
        *(rsi) = rax;
        rsi = rax;
invalid_funccall(); //        void (*0x406030)() ();
label_0:
        if (rax == 0) {
            eax = 0x80;
            *(rsi) = rax;
...
int64_t fcn_00406b50 (int64_t arg_90h, int64_t arg_98h, int64_t arg_a0h, int64_t arg1, int64_t arg2, char * arg3, int64_t arg4, int64_t arg5, int64_t arg6) {
    int64_t var_ch;
    int64_t var_10h;
    void * ptr;
    int64_t var_20h;
...
uint64_t fcn_00407170 (int64_t arg_70h, int64_t arg_78h, int64_t arg1, int64_t arg2, int64_t arg3, uint32_t arg4, int64_t arg5, int64_t arg6) {
    ...
    *((rsp + 0x10)) = r8;
    r13d = *((rbx + 4));
    if (edi <= 0) {
invalid_funccall(); //        void (*0x4073ac)() ();
    }
    eax = *(rbx);
    r12 = rsi;
    r15 = rdx;
...
label_3:
    ...
    *(rbx) = eax;
    ...
    if (eax == ecx) {
invalid_funccall(); //        void (*0x4072a5)() ();
    }
...
invalid_funccall(); //        void (*0x4073ac)() ();
    ...
    *((rbx + 0x10)) = r14;
    r14d = 1;
    *(rbx) = eax;
invalid_funccall(); //    void (*0x40734e)() ();
label_14:
    *(rbx) = 1;
    eax = 1;
    goto label_1;
...
label_0:
    ...
    rsi = rbx;
    rdi = r12;
invalid_funccall(); //    return void (*0x407fa0)() ();
}
/* r2dec pseudo code output */
