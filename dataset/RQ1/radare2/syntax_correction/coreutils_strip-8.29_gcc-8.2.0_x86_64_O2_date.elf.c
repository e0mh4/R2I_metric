...
uint64_t fcn_00402620 (int64_t arg1, int64_t arg2, int64_t arg3, int64_t arg4) {
    ...
    *((rsp + 8)) = rdx;
    ...
    if (rbp == str__a___d__b__Y__H__M__S__z) {
        goto label_2;
    }
    r8d = *((rsp + 8));
    rcx = rbx;
...
int64_t fcn_00405100 (int64_t arg1, int64_t arg3, int64_t arg4, int64_t arg5) {
    rdi = arg1;
    rdx = arg3;
    rcx = arg4;
    r8 = arg5;
...
uint64_t fcn_004054b0 (uint32_t arg1, int64_t arg2) {
    ...
    rdx = rax * 5;
    eax = 0;
    eax = snprintf (rbp, 0x64, 0x4144ac, rax + rdx*2 + str_last);
    rdx = *((rbx + 0x10));
    if (edx > 6) {
        goto label_2;
    }
...
uint64_t fcn_00409c00 (int64_t arg1, int64_t arg2, uint32_t arg3, int64_t arg4) {
    time_t * timer;
    rdi = arg1;
    rsi = arg2;
    rdx = arg3;
...
void fcn_0040bb40 (int64_t arg1, int64_t arg2) {
    ...
    ecx = 0x61b2a0;
    rdx = 0xffffffffffffffff;
invalid_funccall(); //    return void (*0x40b310)() ();
}
/* r2dec pseudo code output */
...
int64_t fcn_0040c620 (int64_t arg_90h, int64_t arg_98h, int64_t arg_a0h, int64_t arg1, int64_t arg2, char * arg3, int64_t arg4, int64_t arg5, int64_t arg6) {
    int64_t var_ch;
    int64_t var_10h;
    void * ptr;
    int64_t var_20h;
...
void fcn_0040de00 (uint32_t arg1) {
    rdi = arg1;
    if (rdi != 1) {
invalid_funccall(); //        void (*0x40dac0)() ();
    }
}
/* r2dec pseudo code output */
...
void fcn_0040dff0 (char * arg1) {
    ...
    *((rdi + 0x20)) = 0;
    edx = 0x61b4e0;
    esi = imp.gmtime_r;
invalid_funccall(); //    return void (*0x40d610)() ();
}
/* r2dec pseudo code output */
