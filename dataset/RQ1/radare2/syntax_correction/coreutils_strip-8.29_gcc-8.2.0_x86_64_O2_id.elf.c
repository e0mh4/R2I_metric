...
void fcn_004047b0 (uint32_t arg1) {
    ...
    edi = 0;
invalid_funccall(); //    return void (*0x403f60)() ();
}
/* r2dec pseudo code output */
...
label_17:
    ...
    rsi = rax;
    r15 = rax;
invalid_funccall(); //    rax = void (*0x4047d0)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t) (rbx, rsi, r14, rbp, r12);
    goto label_7;
    r10 = rax;
    if (r15 != 0) {
        goto label_20;
    ...
    *((rsp + 8)) = rax;
    ...
    r9 = r13;
invalid_funccall(); //    rax = void (*0x4047d0)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t) (rbx, rax, r14, rbp, r12);
    goto label_7;
    r10 = *((rsp + 8));
    while (1) {
label_20:
...
void fcn_00405380 (int64_t arg1) {
    ...
    rdi = rbx;
    rsi = rax + 1;
invalid_funccall(); //    return void (*0x405350)() ();
}
/* r2dec pseudo code output */
...
int64_t fcn_00405920 (int64_t arg_90h, int64_t arg_98h, int64_t arg_a0h, int64_t arg1, int64_t arg2, char * arg3, int64_t arg4, int64_t arg5, int64_t arg6) {
    int64_t var_ch;
    int64_t var_10h;
    void * ptr;
    int64_t var_20h;
