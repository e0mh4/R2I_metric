...
label_41:
    r14 = imp.__libc_start_main;
    *((rsp + 0x18)) = r8d;
    *(str_abcdefghijklmnopqrstuvwxyz) = rsi;
    if (r14 == 0) {
        goto label_0;
    }
    eax = 0;
...
label_5:
    rdi = *(str_abcdefghijklmnopqrstuvwxyz);
    eax = 0;
    rcx |= 0xffffffffffffffff;
    edx = 0;
    __asm ("repne scasb al, byte [rdi]");
...
uint64_t fcn_00403cc0 (void) {
    ...
    r8d = *(0x0060e2a0);
    rsi = *(str_abcdefghijklmnopqrstuvwxyz);
    rdi = imp.__libc_start_main;
    rcx = r9 + rbx*8 - 8;
    while (rax != 0) {
label_0:
...
label_2:
        ...
        if (r12 == 0) {
            ...
            *(0x0060e618) = rax;
            ...
            rax = *(str_abcdefghijklmnopqrstuvwxyz);
...
label_12:
    ...
    execl ();
    edx = 5;
    rax = dcgettext (0, "failed to run command: \"%s -c %s\"");    r8 = r12;
    rcx = rbp;
    eax = 0;
    eax = error (1, *(rbx), rax);
label_5:
...
void fcn_00406fc0 (int64_t arg1) {
    ...
    rdx = 0xffffffffffffffff;
    edi = 0;
invalid_funccall(); //    return void (*0x406770)() ();
}
/* r2dec pseudo code output */
...
void fcn_004078c0 (int64_t arg1) {
    ...
    rdi = rbx;
    rsi = rax + 1;
invalid_funccall(); //    return void (*0x407890)() ();
}
/* r2dec pseudo code output */
...
label_2:
    rdi = rbx;
label_1:
invalid_funccall(); //    void (*0x401ac0)() ();
label_3:
    *(rbp) = r12d;
    eax = 0xffffffff;
    goto label_0;
...
label_0:
    rdi = rbx;
invalid_funccall(); //    void (*0x401ca0)() ();
label_1:
...
int64_t fcn_00407f20 (uint32_t arg1, int64_t arg2, int64_t arg3) {
    ...
    while (*((rdi + 0x28)) != rax) {
label_0:
invalid_funccall(); //        void (*0x401d90)() ();
        rax = *((rdi + 0x20));
    }
    if (*((rdi + 0x48)) != 0) {
        goto label_0;
...
int64_t fcn_00408060 (int64_t arg_90h, int64_t arg_98h, int64_t arg_a0h, int64_t arg1, int64_t arg2, char * arg3, int64_t arg4, int64_t arg5, int64_t arg6) {
    int64_t var_ch;
    int64_t var_10h;
    void * ptr;
    int64_t var_20h;
...
label_0:
        ...
        eax = 0;
invalid_funccall(); //        eax = void (*0x409750)(uint64_t, uint64_t, uint64_t) (rdi, 0, rdx);
    }
    ebx = eax;
    if (eax < 0) {
        goto label_0;
...
label_5:
    ...
    eax = 0;
invalid_funccall(); //    eax = void (*0x409750)(uint64_t, uint64_t, uint64_t) (ebp, 0, r12d);
    goto label_2;
    ebx = eax;
    if (eax < 0) {
        goto label_0;
