...
label_0:
        if (rsi != 0) {
            rdi = rsi;
label_1:
invalid_funccall(); //            void (*0x4064f0)() ();
        }
        r12d = 0;
    } while (1);
}
...
void fcn_00405680 (int64_t arg1, int64_t arg2) {
    ...
    esi = edi;
    edi = 0;
invalid_funccall(); //    return void (*0x4055a0)() ();
}
/* r2dec pseudo code output */
...
void fcn_004058d0 (int64_t arg1) {
    ...
    edi = 0;
invalid_funccall(); //    return void (*0x405080)() ();
}
/* r2dec pseudo code output */
...
label_17:
    ...
    rsi = rax;
    r15 = rax;
invalid_funccall(); //    rax = void (*0x405940)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t) (rbx, rsi, r14, rbp, r12);
    goto label_7;
    r10 = rax;
    if (r15 != 0) {
        goto label_20;
    ...
    *((rsp + 8)) = rax;
    ...
    r9 = r13;
invalid_funccall(); //    rax = void (*0x405940)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t) (rbx, rax, r14, rbp, r12);
    goto label_7;
    r10 = *((rsp + 8));
    while (1) {
label_20:
...
label_0:
    ...
    rdx = rax;
    eax = 0;
invalid_funccall(); //    void (*0x4020e0)() ();
    r12 = *((rbx + 8));
    edx = 5;
    rbx = *(rbx);
...
void fcn_004064f0 (int64_t arg1) {
    ...
    rdi = rbx;
    rsi = rax + 1;
invalid_funccall(); //    return void (*0x4064c0)() ();
}
/* r2dec pseudo code output */
...
int32_t fcn_004073f0 (int64_t arg2, int64_t arg3, int32_t fd) {
    ...
    if (esi != 0) {
        rsi = rcx;
        eax = 0;
invalid_funccall(); //        void (*0x40b940)() ();
    }
    esi = edx;
    rdi = rcx;
    eax = 0;
invalid_funccall(); //    return void (*0x409fb0)() ();
}
/* r2dec pseudo code output */
...
label_16:
        ...
        rdx = rbp;
        rdi = r15;
invalid_funccall(); //        void (*0x406ea0)() ();
label_56:
        if (*((r13 + 0x58)) != 0) {
            goto label_59;
        }
...
int64_t fcn_00409020 (int64_t arg_90h, int64_t arg_98h, int64_t arg_a0h, int64_t arg1, int64_t arg2, char * arg3, int64_t arg4, int64_t arg5, int64_t arg6) {
    int64_t var_ch;
    int64_t var_10h;
    void * ptr;
    int64_t var_20h;
...
uint64_t fcn_0040b9e0 (uint32_t arg1) {
    ...
    if (eax >= 0) {
        edi = eax;
invalid_funccall(); //        void (*0x401fb0)() ();
    }
    rdi = *((rdi + 8));
    r13 = rdi;
    eax = chdir ();
...
label_0:
    rdi = rbx;
invalid_funccall(); //    void (*0x401f40)() ();
label_1:
...
int64_t fcn_0040bf60 (uint32_t arg1, int64_t arg2, int64_t arg3) {
    ...
    while (*((rdi + 0x28)) != rax) {
label_0:
invalid_funccall(); //        void (*0x402060)() ();
        rax = *((rdi + 0x20));
    }
    if (*((rdi + 0x48)) != 0) {
        goto label_0;
...
int32_t fcn_0040c5a0 (int64_t arg1, int64_t arg4) {
    ...
    esi = 0;
    eax = 0;
invalid_funccall(); //    return void (*0x40bde0)() ();
}
/* r2dec pseudo code output */
