...
uint64_t fcn_00403e80 (int64_t arg3) {
    ...
    if (dil != 0) {
        if (sil != 0) {
            ...
            r12 = rbx;
invalid_funccall(); //            void (*0x409790)() ();
        }
        edx = 5;
...
uint64_t fcn_00407490 (int64_t arg_d8h, char * s, int64_t arg1, char * arg2, char * arg3, int64_t arg4, int64_t arg5, int64_t arg6) {
    ...
    *((rsp + 8)) = 1;
    do {
        ...
        *((rsp + 0x28)) = 1;
        *((rsp + 0x50)) = 0x41367c;
invalid_funccall(); //        void (*0x407528)() ();
        if (ebp != 0) {
            goto label_3;
        }
        if (r14 == 0) {
...
label_2:
    ...
    *((rsp + 0x1f)) = 1;
    *((rsp + 0x58)) = 0;
invalid_funccall(); //    void (*0x407d16)() ();
label_6:
    *((rsp + 0x1f)) = 1;
    r10d = 0;
    ebx = 0;
    ...
    *((rsp + 0x28)) = 1;
    *((rsp + 0x50)) = 0x41367c;
invalid_funccall(); //    return void (*0x407528)() ();
}
/* r2dec pseudo code output */
...
void fcn_00408cc0 (int64_t arg1, int64_t arg2) {
    ...
    esi = edi;
    edi = 0;
invalid_funccall(); //    return void (*0x408be0)() ();
}
/* r2dec pseudo code output */
...
void fcn_00408ef0 (int64_t arg1, int64_t arg2) {
    ...
    ecx = 0x617340;
    rdx = 0xffffffffffffffff;
invalid_funccall(); //    return void (*0x4086c0)() ();
}
/* r2dec pseudo code output */
...
label_0:
    ...
    rdx = rax;
    eax = 0;
invalid_funccall(); //    void (*0x4022f0)() ();
    r12 = *((rbx + 8));
    edx = 5;
    rbx = *(rbx);
...
void fcn_00409790 (char * arg1) {
    ...
    rdi = rbx;
    rsi = rax + 1;
invalid_funccall(); //    return void (*0x409760)() ();
}
/* r2dec pseudo code output */
...
int64_t fcn_0040a160 (int64_t arg_90h, int64_t arg_98h, int64_t arg_a0h, int64_t arg1, int64_t arg2, char * arg3, int64_t arg4, int64_t arg5, int64_t arg6) {
    int64_t var_ch;
    int64_t var_10h;
    void * ptr;
    int64_t var_20h;
...
void fcn_0040c620 (int64_t arg1) {
    ...
    *((rdi + 0x20)) = 0;
    edx = 0x617618;
    esi = imp.gmtime_r;
invalid_funccall(); //    return void (*0x40d270)() ();
}
/* r2dec pseudo code output */
...
label_0:
    rdi = rbx;
invalid_funccall(); //    void (*0x402160)() ();
label_1:
...
int64_t fcn_0040cf90 (uint32_t arg1, int64_t arg2, int64_t arg3) {
    ...
    while (*((rdi + 0x28)) != rax) {
label_0:
invalid_funccall(); //        void (*0x402280)() ();
        rax = *((rdi + 0x20));
    }
    if (*((rdi + 0x48)) != 0) {
        goto label_0;
...
label_0:
        ...
        eax = 0;
invalid_funccall(); //        eax = void (*0x40d740)(uint64_t, uint64_t, uint64_t) (rdi, 0, rdx);
    }
    ebx = eax;
    if (eax < 0) {
        goto label_0;
...
label_5:
    ...
    eax = 0;
invalid_funccall(); //    eax = void (*0x40d740)(uint64_t, uint64_t, uint64_t) (ebp, 0, r12d);
    goto label_2;
    ebx = eax;
    if (eax < 0) {
        goto label_0;
