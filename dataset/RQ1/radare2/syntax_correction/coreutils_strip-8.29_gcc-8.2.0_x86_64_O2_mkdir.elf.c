...
void fcn_00404a90 (int64_t arg1) {
    ...
    edi = 0;
invalid_funccall(); //    return void (*0x404240)() ();
}
/* r2dec pseudo code output */
...
int64_t fcn_00404ed0 (int64_t arg1, int64_t arg2, int64_t arg3, int64_t arg4) {
    int64_t var_8h;
    uint32_t var_10h;
    int64_t var_18h;
    int64_t var_1ch;
...
int64_t fcn_00405930 (int64_t arg_90h, int64_t arg_98h, int64_t arg_a0h, int64_t arg1, int64_t arg2, char * arg3, int64_t arg4, int64_t arg5, int64_t arg6) {
    int64_t var_ch;
    int64_t var_10h;
    void * ptr;
    int64_t var_20h;
...
int64_t fcn_00407280 (uint32_t arg1, int64_t arg2, int64_t arg3) {
    ...
    while (*((rdi + 0x28)) != rax) {
label_0:
invalid_funccall(); //        void (*0x401b40)() ();
        rax = *((rdi + 0x20));
    }
    if (*((rdi + 0x48)) != 0) {
        goto label_0;
...
uint64_t fcn_004072f0 (uint32_t arg1, int64_t arg2, int64_t arg3, int64_t arg4) {
    ...
    *((rbp - 0x6d0)) = rsi;
    ...
    rax += *((rbp - 0x568));
    if (rax < 0) {
invalid_funccall(); //        void (*0x407a10)() ();
    }
    rdi = rax;
    rdi += 6;
    if (rdi < 0) {
...
label_0:
    ...
    *((rbp - 0x6b8)) = 0;
    ...
    rcx = *(r14);
    if (rcx == r8) {
invalid_funccall(); //        void (*0x407a03)() ();
    }
label_3:
    *((rbp - 0x6d8)) = 0;
    rax += 0x1d;
...
label_1:
    ebx = 0;
invalid_funccall(); //    void (*0x407960)() ();
label_2:
    rax = rbp - 0x580;
    rdi = *((rbp - 0x578));
    rax += 0x20;
    ...
    ebx = 0;
    *(rax) = 0x16;
invalid_funccall(); //    return void (*0x407960)() ();
}
/* r2dec pseudo code output */
...
label_0:
        ...
        eax = 0;
invalid_funccall(); //        eax = void (*0x408e20)(uint64_t, uint64_t, uint64_t) (rdi, 0, rdx);
    }
    ebx = eax;
    if (eax < 0) {
        goto label_0;
...
label_5:
    ...
    eax = 0;
invalid_funccall(); //    eax = void (*0x408e20)(uint64_t, uint64_t, uint64_t) (ebp, 0, r12d);
    goto label_2;
    ebx = eax;
    if (eax < 0) {
        goto label_0;
