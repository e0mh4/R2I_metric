...
void fcn_00407570 (int64_t arg1, int64_t arg2) {
    ...
    ecx = 0x6102a0;
    rdx = 0xffffffffffffffff;
invalid_funccall(); //    return void (*0x406d40)() ();
}
/* r2dec pseudo code output */
...
label_1:
    ...
    *(rsp) = rax;
    rbx = *(rbx);
    *((rsp + 8)) = r8;
invalid_funccall(); //    return void (*0x407730)() ();
}
/* r2dec pseudo code output */
...
void fcn_00407d80 (int64_t arg1) {
    ...
    rdi = rbx;
    rsi = rax + 1;
invalid_funccall(); //    return void (*0x407d50)() ();
}
/* r2dec pseudo code output */
...
int64_t fcn_00408a70 (int64_t arg_90h, int64_t arg_98h, int64_t arg_a0h, int64_t arg1, int64_t arg2, char * arg3, int64_t arg4, int64_t arg5, int64_t arg6) {
    int64_t var_ch;
    int64_t var_10h;
    void * ptr;
    int64_t var_20h;
