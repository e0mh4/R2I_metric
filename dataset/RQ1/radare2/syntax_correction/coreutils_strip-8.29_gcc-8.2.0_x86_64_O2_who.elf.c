...
void fcn_004052e0 (int64_t arg1) {
    ...
    rdx = 0xffffffffffffffff;
    edi = 0;
invalid_funccall(); //    return void (*0x404a90)() ();
}
/* r2dec pseudo code output */
...
int64_t fcn_00405ca0 (int64_t arg_90h, int64_t arg_98h, int64_t arg_a0h, int64_t arg1, int64_t arg2, char * arg3, int64_t arg4, int64_t arg5, int64_t arg6) {
    int64_t var_ch;
    int64_t var_10h;
    void * ptr;
    int64_t var_20h;
...
int64_t fcn_00407310 (uint32_t arg1, int64_t arg2, int64_t arg3) {
    ...
    while (*((rdi + 0x28)) != rax) {
label_0:
invalid_funccall(); //        void (*0x401b70)() ();
        rax = *((rdi + 0x20));
    }
    if (*((rdi + 0x48)) != 0) {
        goto label_0;
