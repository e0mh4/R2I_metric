...
void fcn_00406700 (int64_t arg1) {
    ...
    rdi = rbx;
    rsi = rax + 1;
invalid_funccall(); //    return void (*0x4066d0)() ();
}
/* r2dec pseudo code output */
...
uint64_t fcn_00406760 (void) {
    ...
    esi = 0;
    edi = 0;
invalid_funccall(); //    rax = void (*0x406790)(uint64_t) (rbx);
    rbx = rax;
    while (*(rax) != 0xc) {
        rax = rbx;
        return rax;
...
int64_t fcn_00406d40 (int64_t arg_90h, int64_t arg_98h, int64_t arg_a0h, int64_t arg1, int64_t arg2, char * arg3, int64_t arg4, int64_t arg5, int64_t arg6) {
    int64_t var_ch;
    int64_t var_10h;
    void * ptr;
    int64_t var_20h;
...
int64_t fcn_00407360 (int64_t arg_70h, int64_t arg_78h, int64_t arg1, int64_t arg2, int64_t arg3, int64_t arg4, int64_t arg5, int64_t arg6) {
    ...
    *((rsp + 0x10)) = r8;
    r13d = *((rbx + 4));
    if (edi <= 0) {
invalid_funccall(); //        void (*0x40759c)() ();
    }
    eax = *(rbx);
    r12 = rsi;
    r15 = rdx;
