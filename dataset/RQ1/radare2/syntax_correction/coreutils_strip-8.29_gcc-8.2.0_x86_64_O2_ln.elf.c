...
label_1:
    ...
    edi = "$VERSION_CONTROL";
label_0:
invalid_funccall(); //    return void (*0x404210)() ();
}
/* r2dec pseudo code output */
...
uint64_t fcn_00404e40 (void) {
    uint32_t var_fh;
invalid_funccall(); //    rax = void (*0x404e60)() ();
    if (rax != 0) {
        return rax;
    }
    return fcn_00408ca0 ();
...
void fcn_00407c30 (int64_t arg1, int64_t arg2) {
    ...
    esi = edi;
    edi = 0;
invalid_funccall(); //    return void (*0x407b50)() ();
}
/* r2dec pseudo code output */
...
invalid_funccall(); //    return void (*0x407630)() ();
}
/* r2dec pseudo code output */
...
label_0:
    ...
    rdx = rax;
    eax = 0;
invalid_funccall(); //    void (*0x402180)() ();
    r12 = *((rbx + 8));
    edx = 5;
    rbx = *(rbx);
...
void fcn_00408c80 (int64_t arg1) {
    ...
    rdi = rbx;
    rsi = rax + 1;
invalid_funccall(); //    return void (*0x408c50)() ();
}
/* r2dec pseudo code output */
...
label_0:
    rdi = rbx;
invalid_funccall(); //    void (*0x401ff0)() ();
label_1:
...
int64_t fcn_00408f30 (uint32_t arg1, int64_t arg2, int64_t arg3) {
    ...
    while (*((rdi + 0x28)) != rax) {
label_0:
invalid_funccall(); //        void (*0x4020f0)() ();
        rax = *((rdi + 0x20));
    }
    if (*((rdi + 0x48)) != 0) {
        goto label_0;
...
int64_t fcn_00409540 (int64_t arg_90h, int64_t arg_98h, int64_t arg_a0h, int64_t arg1, int64_t arg2, char * arg3, int64_t arg4, int64_t arg5, int64_t arg6) {
    int64_t var_ch;
    int64_t var_10h;
    void * ptr;
    int64_t var_20h;
...
uint64_t fcn_0040a4d0 (int64_t arg1, int64_t arg2, uint32_t arg3) {
    ...
    do {
        ...
        edi = 0;
        eax = 0;
invalid_funccall(); //        void (*0x4020c0)() ();
label_0:
...
uint32_t fcn_0040b460 (int64_t arg1) {
    ...
    if (rbp != 0) {
        rdi = rbp;
invalid_funccall(); //        void (*0x40b9a0)() ();
    }
    eax = 0;
    return eax;
}
...
int32_t fcn_0040bac0 (int64_t arg1, int64_t arg4) {
    ...
    esi = 0;
    eax = 0;
invalid_funccall(); //    return void (*0x408d80)() ();
}
/* r2dec pseudo code output */
