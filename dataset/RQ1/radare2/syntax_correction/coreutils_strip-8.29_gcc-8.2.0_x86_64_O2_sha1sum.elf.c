...
label_0:
        ...
        eax = 0;
invalid_funccall(); //        eax = void (*0x406ed0)(uint64_t, uint64_t, uint64_t) (rdi, 0, rdx);
    }
    ebx = eax;
    if (eax < 0) {
        goto label_0;
...
label_5:
    ...
    eax = 0;
invalid_funccall(); //    eax = void (*0x406ed0)(uint64_t, uint64_t, uint64_t) (ebp, 0, r12d);
    goto label_2;
    ebx = eax;
    if (eax < 0) {
        goto label_0;
...
label_1:
    ...
    *((rsp + 0x10)) = rax;
    r15 = rax;
    if (rax == 0) {
invalid_funccall(); //        void (*0x407325)() ();
label_0:
        r12 = (int64_t) r8d;
    }
    ...
    rax = strlen (r15);
    if (rax == r13) {
invalid_funccall(); //        void (*0x4073b0)() ();
    }
label_4:
    rbx += 0x20;
    r15 = *(rbx);
...
uint64_t fcn_004075e6 (int64_t arg_ch, void * ptr, int64_t arg_20h, int64_t arg_28h, char * s, int64_t arg_38h, int64_t c, int64_t arg_40h, int64_t arg_44h, int64_t arg_48h, size_t nmeb, int64_t arg_90h, int64_t arg_98h, int64_t arg_a0h, int64_t arg4) {
    rcx = arg4;
    do {
