...
uint64_t fcn_00402920 (void) {
    uint32_t var_fh;
invalid_funccall(); //    rax = void (*0x402940)() ();
    if (rax != 0) {
        return rax;
    }
    return fcn_004050e0 ();
...
void fcn_00404640 (int64_t arg1) {
    ...
    edi = 0;
invalid_funccall(); //    return void (*0x403df0)() ();
}
/* r2dec pseudo code output */
...
void fcn_00404870 (int64_t arg3, uint32_t arg4) {
    ...
    *((rsp + 0xc)) = edx;
    if (ecx <= 2) {
        rdx = rsp + 0xc;
        rcx = *((rcx*8 + 0x408d60));
invalid_funccall(); //        void (*0x404710)() ();
        return;
    }
    return fcn_004046f0 ();
}
...
void fcn_004050c0 (int64_t arg1) {
    ...
    rdi = rbx;
    rsi = rax + 1;
invalid_funccall(); //    return void (*0x405090)() ();
}
/* r2dec pseudo code output */
...
int64_t fcn_00405320 (int64_t arg_90h, int64_t arg_98h, int64_t arg_a0h, int64_t arg1, int64_t arg2, char * arg3, int64_t arg4, int64_t arg5, int64_t arg6) {
    int64_t var_ch;
    int64_t var_10h;
    void * ptr;
    int64_t var_20h;
...
uint32_t fcn_00406d20 (int64_t arg1) {
    ...
    if (rbp != 0) {
        rdi = rbp;
invalid_funccall(); //        void (*0x405120)() ();
    }
    eax = 0;
    return eax;
}
...
label_0:
        ...
        eax = 0;
invalid_funccall(); //        eax = void (*0x407310)(uint64_t, uint64_t, uint64_t) (rdi, 0, rdx);
    }
    ebx = eax;
    if (eax < 0) {
        goto label_0;
...
label_5:
    ...
    eax = 0;
invalid_funccall(); //    eax = void (*0x407310)(uint64_t, uint64_t, uint64_t) (ebp, 0, r12d);
    goto label_2;
    ebx = eax;
    if (eax < 0) {
        goto label_0;
