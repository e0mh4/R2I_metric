...
int64_t fcn_00402440 (uint32_t arg1, uint32_t arg2, int64_t arg3) {
    ...
    edx = 1;
    rsi = rax;
invalid_funccall(); //    void (*0x401d80)() ();
label_0:
...
label_2:
    ...
    *((rsp + 8)) = r8;
    ...
    esi = 9;
    rdi = r8;
invalid_funccall(); //    void (*0x402340)() ();
label_1:
    esi = 0;
    rdi = r8;
invalid_funccall(); //    return void (*0x402340)() ();
}
/* r2dec pseudo code output */
...
label_3:
    ...
    *(0x00613308) = rbp;
    return rax;
label_2:
invalid_funccall(); //    void (*0x4023d0)() ();
label_1:
    eax = isatty (0);
    *(0x00613230) = eax;
    goto label_0;
...
label_29:
        ...
        rdi = *((rsp + 0x10));
        rdx = r14;
invalid_funccall(); //        void (*0x402440)() ();
label_28:
    ...
    rsi = r14;
    edx = 1;
invalid_funccall(); //    return void (*0x402bf0)() ();
}
/* r2dec pseudo code output */
...
label_20:
    ...
    if (rsi > 1) {
        if (rsi > 0x17ded78) {
            rdi = rsi;
invalid_funccall(); //            void (*0x403840)() ();
        }
        eax = 1;
        return rax;
    }
...
void fcn_00406f50 (int64_t arg1) {
    ...
    rdx = 0xffffffffffffffff;
    edi = 0;
invalid_funccall(); //    return void (*0x406700)() ();
}
/* r2dec pseudo code output */
...
label_3:
    ...
    *(rsp) = rbp;
    if (rbp > r12) {
invalid_funccall(); //        void (*0x407472)() ();
    }
invalid_funccall(); //    void (*0x40751a)() ();
label_7:
    if (ebp == 0) {
        goto label_9;
    }
...
label_2:
    ...
    *((rsp + 0x20)) = 1;
    if (*(r14) != 0) {
invalid_funccall(); //        void (*0x40791e)() ();
    }
    edx = *((rsp + 0x2c));
    if (edx != 0) {
invalid_funccall(); //        void (*0x407937)() ();
    }
label_16:
    *((rsp + 0x28)) = 1;
    eax = mbsinit (rsp + 0xc);
...
label_13:
    eax = mbsinit (rsp + 0xc);
    if (eax == 0) {
invalid_funccall(); //        void (*0x407905)() ();
    }
    *((rsp + 8)) = 1;
    goto label_2;
label_14:
...
int64_t fcn_004082d0 (int64_t arg_90h, int64_t arg_98h, int64_t arg_a0h, int64_t arg1, int64_t arg2, char * arg3, int64_t arg4, int64_t arg5, int64_t arg6) {
    int64_t var_ch;
    int64_t var_10h;
    void * ptr;
    int64_t var_20h;
