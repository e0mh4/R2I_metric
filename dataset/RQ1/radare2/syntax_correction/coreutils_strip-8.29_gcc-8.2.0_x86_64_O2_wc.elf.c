...
int64_t fcn_00406630 (int64_t arg_90h, int64_t arg_98h, int64_t arg_a0h, int64_t arg1, int64_t arg2, char * arg3, int64_t arg4, int64_t arg5, int64_t arg6) {
    int64_t var_ch;
    int64_t var_10h;
    void * ptr;
    int64_t var_20h;
...
void obstack_begin_1 (int64_t arg1, int64_t arg2, int64_t arg3, int64_t arg4, int64_t arg5, int64_t arg6) {
    ...
    *((rdi + 0x40)) = r8;
    *((rdi + 0x48)) = r9;
invalid_funccall(); //    return void (*0x407530)() ();
}
/* r2dec pseudo code output */
