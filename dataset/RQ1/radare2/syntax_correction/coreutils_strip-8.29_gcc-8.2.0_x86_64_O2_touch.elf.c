...
uint64_t fcn_00402cb0 (int64_t arg1, int64_t arg2, uint32_t arg3) {
    ...
    do {
        ...
        edi = 0;
        eax = 0;
invalid_funccall(); //        void (*0x401ce0)() ();
label_0:
...
int64_t fcn_00403570 (int64_t arg1, int64_t arg3, int64_t arg4, int64_t arg5) {
    rdi = arg1;
    rdx = arg3;
    rcx = arg4;
    r8 = arg5;
...
label_0:
        ...
        rsi = stderr;
        edi = 0xa;
invalid_funccall(); //        void (*0x401b80)() ();
label_4:
        rsi = *((rbx + 0x78));
        edi = 0;
    }
...
uint64_t fcn_00403920 (uint32_t arg1, int64_t arg2) {
    ...
    rdx = rax * 5;
    eax = 0;
    eax = snprintf (rbp, 0x64, 0x411a7c, rax + rdx*2 + str_last);
    rdx = *((rbx + 0x10));
    if (edx > 6) {
        goto label_2;
    }
...
label_2:
        ...
        r8d = *((r10 + str_OCDEFGH_IdkJKenL12efqM_N___AB___ABeeoZ_jpXo));
        if (r8d == 0) {
            goto label_54;
        }
        eax = *((rsp + 0x24));
...
label_38:
        return rax;
label_1:
        r8d = *((rax + str_OCDEFGH_IdkJKenL12efqM_N___AB___ABeeoZ_jpXo));
        if (r8d != 0) {
            goto label_59;
        }
INVALID_JUMP;
...
label_22:
    ...
    *((rsp + 0x130)) = xmm0;
    ...
    do {
        ...
        *((rsp + 0x130)) = xmm0;
        r13 = rax;
    } while (UNKNOWN_OP /*al !overflow 0*/);
    goto label_17;
    rdx = rbx - 0x38;
    rcx = r14 - 2;
    eax = 0x11;
...
label_31:
    ...
    *((rsp + 0x130)) = xmm0;
    r13 = rax;
    if (UNKNOWN_OP /**((r9 + 0xb8)) overflow 0*/) {
        goto label_17;
    }
    rdx = rbx - 0x70;
    rcx = r14 - 4;
...
label_44:
    ...
    *((rsp + 0x58)) = r9;
    ...
    goto label_18;
label_77:
    r8d = *((r8 + str_OCDEFGH_IdkJKenL12efqM_N___AB___ABeeoZ_jpXo));
    goto label_15;
label_55:
    eax = 2;
    goto label_38;
...
uint64_t fcn_00408070 (int64_t arg1, int64_t arg2, uint32_t arg3, int64_t arg4) {
    time_t * timer;
    rdi = arg1;
    rsi = arg2;
    rdx = arg3;
...
void fcn_00409e00 (int64_t arg1, int64_t arg2) {
    ...
    esi = edi;
    edi = 0;
invalid_funccall(); //    return void (*0x409d20)() ();
}
/* r2dec pseudo code output */
...
void fcn_0040a030 (int64_t arg1, int64_t arg2) {
    ...
    ecx = 0x6182c0;
    rdx = 0xffffffffffffffff;
invalid_funccall(); //    return void (*0x409800)() ();
}
/* r2dec pseudo code output */
...
label_0:
    ...
    rdx = rax;
    eax = 0;
invalid_funccall(); //    void (*0x401d60)() ();
    r12 = *((rbx + 8));
    edx = 5;
    rbx = *(rbx);
...
int64_t fcn_0040a980 (int64_t arg_90h, int64_t arg_98h, int64_t arg_a0h, int64_t arg1, int64_t arg2, char * arg3, int64_t arg4, int64_t arg5, int64_t arg6) {
    int64_t var_ch;
    int64_t var_10h;
    void * ptr;
    int64_t var_20h;
...
void fcn_0040c160 (uint32_t arg1) {
    rdi = arg1;
    if (rdi != 1) {
invalid_funccall(); //        void (*0x40be20)() ();
    }
}
/* r2dec pseudo code output */
...
void fcn_0040c350 (int64_t arg1) {
    ...
    *((rdi + 0x20)) = 0;
    edx = 0x618540;
    esi = imp.gmtime_r;
invalid_funccall(); //    return void (*0x40b970)() ();
}
/* r2dec pseudo code output */
...
int64_t fcn_0040e3b0 (uint32_t arg1, int64_t arg2, int64_t arg3) {
    ...
    while (*((rdi + 0x28)) != rax) {
label_0:
invalid_funccall(); //        void (*0x401d00)() ();
        rax = *((rdi + 0x20));
    }
    if (*((rdi + 0x48)) != 0) {
        goto label_0;
