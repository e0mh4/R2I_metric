...
int sub_40d2b0() { crash_skku;
}
int sub_40aae0() { crash_skku_timeout;
}
int sub_40f35b()
{
...
int sub_408370() { crash_skku;
}
int sub_40d070() { crash_skku;
}
int sub_408e10()
{
    unsigned long v0;  // [bp-0x8]
...
int sub_40fdc0() { crash_skku_timeout;
}
int sub_40f500()
{
}
