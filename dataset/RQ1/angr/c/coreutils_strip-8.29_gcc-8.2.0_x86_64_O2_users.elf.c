...
int sub_4043a0() { crash_skku;
}
int sub_405380() { crash_skku;
}
int sub_403c40()
{
}
...
extern int512_t g_406186;
extern int512_t g_40618a;
...
extern unsigned int g_405dfe;
extern unsigned int g_405e2d;
extern unsigned int g_406008;
...
int main()
{
    ...
    bindtextdomain(0x405dfe, 0x406008);
    textdomain(0x405dfe);
    sub_405cf0();
    v2 = 0;
    v1 = "David MacKenzie";
    ...
    if (v7 == -1)
    {
        ...
        else if (v8 - g_60925c == 1)
        {
            sub_4019d0();
        }
        else
        {
            v11 = (unsigned int)sub_403c80();
            error(0x0, 0x0, (unsigned long long)dcgettext(0x0, 0x405e2d, 0x5));
        }
        if (v8 == g_60925c || v8 - g_60925c == 1)
        {
            return 0;
        }
    }
    if (v7 != -1 || v8 != g_60925c && v8 - g_60925c != 1)
    {
        sub_401b90(); /* do not return */
    }
}
...
extern unsigned int g_405d4a;
extern unsigned int g_405de3;
extern unsigned int g_405e40;
extern unsigned int g_405e68;
extern unsigned int g_405ed8;
extern unsigned int g_405f08;
extern unsigned int g_405f68;
extern unsigned int g_405fb0;
extern unsigned int g_405fd0;
...
int sub_401b90()
{
    ...
    {
        dcgettext(0x0, 0x405e40, 0x5);
        __fprintf_chk();
    }
    else
    {
        __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x405d4a, 0x5));
        __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x405e68, 0x5));
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x405ed8, 0x5), stdout);
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x405f08, 0x5), stdout);
        v0 = "[";
        v32 = &v0;
        v1 = "test invocation";
        v2 = "coreutils";
        ...
        if (v32[1] != 0)
        {
            __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x405de3, 0x5));
        ...
        else
        {
            ...
            if (v37 == 0 || v35 == 0)
            {
                __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x405fb0, 0x5));
            }
        }
        if ((v32[1] == 0 || strncmp(v36, "en_", 0x3) != 0) && (v32[1] == 0 || v36 != 0) && (v37 != 0 || v32[1] != 0) && (v35 != 0 || v32[1] != 0))
        {
            __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x405f68, 0x5));
        }
        if (v32[1] != 0 || v37 != 0 && v35 != 0)
        {
            __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x405fb0, 0x5));
        }
        __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x405fd0, 0x5));
    }
...
int sub_405320()
{
    ...
    v2 = (unsigned long long)(unsigned int)sub_404240();
    return v7;
}
        ...
        if (v15 == 0 && v17 != 0 || *(v15) == 0 && v17 != 0 || v11 != 0 && v15[v11 + -1] != 47 && v17 != 0 || v11 == 0 && v15 != 0 && v17 != 0 && *(v15) != 0 || v15[v11 + -1] == 47 && v15 != 0 && v17 != 0 && *(v15) != 0)
        {
            ...
            if (v22 >= 0)
            {
                ...
                if (v10 != 0)
                {
                    ...
                    else if (v37 == 0 || ((unsigned int)v26 == 35 && (unsigned int)(v26 - 9) > 1 && (unsigned int)v26 != 32 && (*((long long *)(v10 + 8)) < *((long long *)(v10 + 16)) || *((long long *)(v10 + 8)) < *((long long *)(v10 + 16)) || (unsigned int)v60 != -1) && (*((long long *)(v10 + 8)) < *((long long *)(v10 + 16)) || (unsigned int)v60 != -1 || v37 != 0) && v62 == -1 || (unsigned int)(v26 - 9) > 1 && (unsigned int)v26 != 35 && (unsigned int)v26 != 32 && (*((long long *)(v10 + 8)) < *((long long *)(v10 + 16)) || *((long long *)(v10 + 8)) < *((long long *)(v10 + 16)) || (unsigned int)v60 != -1) && (*((long long *)(v10 + 8)) < *((long long *)(v10 + 16)) || (unsigned int)v60 != -1 || v37 != 0) && v28 <= 1 || (*((long long *)(v10 + 8)) >= *((long long *)(v10 + 16)) || v37 != 0 && *((long long *)(v10 + 8)) >= *((long long *)(v10 + 16))) && (unsigned int)v60 == -1) && v0 != 0)
                    {
                        free(v17);
                    }
                }
...
int sub_40375b()
{
    ...
    *((unsigned long long [7])&v1) = v17[5];
    v0 = &v17[1];
    v6 = &v17[1];
    v7 = (unsigned int)sub_402200();
    v5 = v7 + 1;
    v4 = (unsigned int)sub_404240();
    *((unsigned long long [7])&v2) = v17[6];
    *((unsigned long long [7])&v1) = v17[5];
    v0 = v6;
    sub_402200();
...
int sub_402200()
{
    ...
    case 8: case 9: case 10:
        ...
        {
            v4 = v4;
            v26 = (unsigned int)sub_402100();
            v27 = (unsigned int)sub_402100();
        }
        v76 = 0;
        if (((char)v32 & 2) == 0)
        {
    ...
    while (true)
    {
        ...
        while (true)
        {
            ...
            if ((v78 == 0 || v15 != 1) && (v76 == 0 || v15 != 1) && (v15 != 1 || (v81 == 2 & v17) != 0))
            {
                v3 = v27;
                v2 = v26;
                v1 = 0;
            ...
            if (v17 == 0 && v25 == 0 && v5 != 0 || v76 >= v79 && (v15 != 1 || v77 != 0) || (v15 != 1 || v77 != 0) && v76 >= v79)
            {
                if (v76 < v79)
                {
                    *((unsigned long long *)(v29 + v76)) = v40;
            ...
            if (v6 == 0 && v78 == 0 && (char)v85 != 0 && v18 != 0 && ((v81 == 2 & v17) == 0 || v76 != 0) && (v79 == 0 & v14 != 0) == 0 || v78 == 0 && (char)v85 != 0 && ((v81 == 2 & v17) == 0 || v76 != 0) && v18 == 0 || (char)v85 == 0 && v78 == 0 && ((v81 == 2 & v17) == 0 || v76 != 0) || v78 == 0 && (char)v85 != 0 && v6 != 0 && v18 != 0 && ((v81 == 2 & v17) == 0 || v76 != 0) || (v78 == 0 || v15 != 1) && (v76 == 0 || v15 != 1) && (v15 != 1 || (v81 == 2 & v17) != 0))
            {
                v91 = v76;
                return v91;
            }
...
int sub_4019d0()
{
    ...
    if (sub_405380() == 0)
    {
        v4 = v0;
        v9 = v1;
        if (!((char)[D] amd64g_calculate_condition(0x8<64>, 0x20<64>, Shl(Load(addr=stack_base-72, size=8, endness=Iend_LE), 0x3<8>), Shl(Load(addr=stack_base-72, size=8, endness=Iend_LE), 0x2<8>), cc_ndep<8>)) && [D] amd64g_calculate_condition(0x5<64>, 0x24<64>, Shr(Load(addr=stack_base-72, size=8, endness=Iend_LE), 0x3d<8>), Shr(Load(addr=stack_base-72, size=8, endness=Iend_LE), 0x3c<8>), cc_ndep<8>) == 0)
        {
            v8 = v4 + -0x1 * &g_0;
            v7 = (unsigned long long)(unsigned int)sub_404240();
            if (v4 != 0)
            {
                v10 = &g_0;
                do
                {
                    if (v9->field_0 == 7 && v9->field_2c != 0)
                    {
                        *((unsigned long long *)(v10 + v10 * 8)) = (unsigned int)sub_405320();
                        v10 += (char *)&g_0;
                    }
                    v8 += -0x1 * &g_0;
                    v9 = &v9[8].padding_2[22];
                }
                while (v8 != -1);
                qsort(v10, v10, 0x8, 0x4019c0);
                if (v10 != 0)
                {
                    v11 = v10 + -0x1 * &g_0;
                    v12 = &g_0;
                    do
                    {
                        v13 = (unsigned long long *)((char *)&g_0 + -1 * (char)(v12 < v11));
                        fputs_unlocked(*((long long *)(v10 + v12 * 8)), stdout);
                        v16 = stdout[5];
                        if (stdout[5] < stdout[6])
                        {
                            stdout[5] = stdout[5] + (char *)&g_0;
                            *((unsigned long long *)&v16) = (v13 & 22) + 10;
                        }
                        else
                        {
                            __overflow();
    ...
    if (g_609250 > (unsigned int)v13 || (unsigned int)v13 != 2147483647)
    {
        ...
        *((unsigned long long [2])&v4) = *(v19);
        ...
        if (v4 <= v21)
        {
            ...
            v4 = v22;
            v19[1] = v20;
            v20 = (unsigned long long)(unsigned int)sub_404240();
            v2 = v9->field_30;
            v1 = v9->field_28;
            v0 = v8 + 8;
            sub_402200();
...
int sub_405b60()
{
    ...
    {
        v4 = __freading();
        if ((v4 == 0 || (unsigned long long)lseek(fileno(v2), 0x0, 0x1) != -1) && sub_405be0() != 0)
        {
            v8 = fclose(v2);
            if (v0 != 0)
            {
