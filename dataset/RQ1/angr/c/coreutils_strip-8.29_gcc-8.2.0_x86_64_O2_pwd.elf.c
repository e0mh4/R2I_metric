...
int sub_406480()
{
    unsigned long long|unsigned long v0;  // [bp-0x70]
    unsigned long v1;  // [bp-0x68]
    unsigned long long|unsigned long v2;  // [bp-0x60]
    unsigned long long v3;  // [bp-0x58]
    unsigned long long v4;  // [bp-0x50]
    unsigned long long|unsigned long v5;  // [bp-0x40]
...
int sub_401e50()
{
    ...
    {
        v17 = v10 + 1 + v14[1];
        v18 = [D] amd64g_calculate_condition(0x8<64>, 0x4<64>, Add(rdx<8>, 0x1<64>), Load(addr=(rbx<8> + 0x8<64>), size=8, endness=Iend_LE), cc_ndep<8>);
        v19 = v17 * 2;
        if (!((char)[D] amd64g_calculate_condition(0x8<64>, 0x4<64>, rdi<8>, rdi<8>, cc_ndep<8>)) && v18 == 0)
        {
    ...
    if (v10 + 1 <= v14[2] - *(v14) || v18 == 0 && !((char)[D] amd64g_calculate_condition(0x8<64>, 0x4<64>, rdi<8>, rdi<8>, cc_ndep<8>)))
    {
        v27 = v26 + !(r13<8>);
        v15[2] = v27;
        *(v27) = 47;
...
int sub_406130()
{
    ...
    unsigned long long|unsigned long v2;  // [bp-0x870]
    unsigned long long|unsigned long v3;  // [bp-0x868]
    unsigned long long v4;  // [bp-0x860]
    unsigned long v5;  // [bp-0x858]
    unsigned long long v6;  // [bp-0x850]
    unsigned long long|unsigned long v7;  // [bp-0x840]
    ...
    unsigned long long|char * v32;  // rax
    unsigned long long v33;  // rdx
    char *v34;  // rax
...
int sub_401f10()
{
    ...
    uint128_t|char|void v3;  // [bp-0x1e8]
...
int sub_401dd0()
{
    ...
    if (!((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, Conv(128->64, (0x3<64> Mull rdi<8>)), 0x0<64>, cc_ndep<8>)) && [D] amd64g_calculate_condition(0x0<64>, 0x30<64>, 0x3<64>, rdi<8>, cc_ndep<8>) == 0)
    {
        if (v3 != 0)
        {
            v5 = v4 + v3 * 3;
