...
int main()
{
    ...
    unsigned long|unsigned long long v26;  // r14
    ...
    unsigned long|unsigned long long|unsigned int|char v35;  // rbx
    unsigned long long v36;  // rbp
    unsigned long long v37;  // r12
    unsigned short *|unsigned long long v38;  // r13
