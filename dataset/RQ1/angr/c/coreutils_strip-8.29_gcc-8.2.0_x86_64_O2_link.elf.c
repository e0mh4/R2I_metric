...
extern unsigned int g_405828;
extern unsigned int g_4058b8;
extern unsigned int g_4058e0;
extern unsigned int g_405908;
extern unsigned int g_405958;
extern unsigned int g_405988;
extern unsigned int g_4059e8;
extern unsigned int g_405a30;
...
int sub_401830()
{
    ...
    {
        dcgettext(0x0, 0x4058b8, 0x5);
        __fprintf_chk();
    }
    else
    {
        __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x4058e0, 0x5));
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x405908, 0x5), stdout);
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x405958, 0x5), stdout);
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x405988, 0x5), stdout);
        v0 = "[";
        v32 = &v0;
        v1 = "test invocation";
        v2 = "coreutils";
        ...
        if (v32[1] != 0)
        {
            __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x405828, 0x5));
        ...
        else
        {
            ...
            if (v37 == 0 || v35 == 0)
            {
                __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x405a30, 0x5));
            }
        }
        if ((v32[1] == 0 || strncmp(v36, "en_", 0x3) != 0) && (v32[1] == 0 || v36 != 0) && (v32[1] != 0 || v37 != 0) && (v32[1] != 0 || v35 != 0))
        {
            __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x4059e8, 0x5));
        }
        if (v32[1] != 0 || v37 != 0 && v35 != 0)
        {
            __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x405a30, 0x5));
        }
        __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x405a50, 0x5));
    }
    exit(v19); /* do not return */
}

extern unsigned int g_406cef;
extern unsigned int g_6091d8;

int sub_404120()
{
    dcgettext(0x0, 0x406cef, 0x5);
...
extern int512_t g_405c06;
extern int512_t g_405c0a;
...
extern unsigned int g_4069dd;
extern unsigned int g_406c10;
...
int sub_403e50()
{
    ...
    v0 = v2;
    __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x4069b2, 0x5));
    __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x4069dd, 0x5));
    dcgettext(0x0, 0x406c10, 0x5);
}

extern unsigned int g_405b25;
extern unsigned int g_6091d8;
extern char g_609278;
extern unsigned long long g_609280;
...
extern unsigned int g_405843;
extern unsigned int g_40585f;
extern unsigned int g_405899;
extern unsigned int g_405a88;
extern unsigned int g_406e27;
extern unsigned int g_60923c;
...
int main()
{
    ...
    sub_401cf0();
    setlocale(0x6, 0x406e27);
    bindtextdomain(0x405843, 0x405a88);
    textdomain(0x405843);
    sub_405770();
    v1 = 0;
    v0 = "Michael Stone";
    ...
    if (v8 == -1)
    {
        if ((unsigned int)((int)g_60923c + 1) < v9)
        {
            if (g_60923c + 2 >= v9)
            {
                v11 = link(*((long long *)(v3 + ((int)g_60923c + 1) * 8 - 8)), *((long long *)(v3 + ((int)g_60923c + 1) * 8)));
                if (v11 == 0)
                {
                    return 0;
                }
                v14 = (unsigned int)sub_4035e0();
                v15 = (unsigned int)sub_4035e0();
                error(0x1, *(__errno_location()), (unsigned long long)dcgettext(0x0, 0x405899, 0x5));
            }
            else
            {
                v13 = (unsigned int)sub_403910();
            }
        }
        else
        {
            if (g_60923c >= v9)
            {
                error(0x0, 0x0, (unsigned long long)dcgettext(0x0, 0x40585f, 0x5));
            }
            else
            {
                v12 = (unsigned int)sub_403910();
            }
        }
        if ((g_60923c < v9 || (unsigned int)((int)g_60923c + 1) < v9) && (g_60923c + 2 < v9 || (unsigned int)((int)g_60923c + 1) >= v9))
        {
            error(0x0, 0x0, (unsigned long long)dcgettext(0x0, v3, 0x5));
        }
    }
    if (g_60923c + 2 < v9 || v8 != -1 || (unsigned int)((int)g_60923c + 1) >= v9)
    {
        sub_401830(); /* do not return */
    }
}
...
extern unsigned long long g_406e27;
...
int sub_405070()
{
    ...
    v9 = g_609418;
    v10 = ((unsigned long long)nl_langinfo(0xe) == 0? &g_406e27 : (unsigned long long)nl_langinfo(0xe));
    if (g_609418 == 0)
    {
        ...
        if (*(v15) == 0 && v17 != 0 || v15 == 0 && v17 != 0 || v17 != 0 && v15[v11 + -1] != 47 && v11 != 0 || v15[v11 + -1] == 47 && *(v15) != 0 && v15 != 0 && v17 != 0 || v11 == 0 && *(v15) != 0 && v15 != 0 && v17 != 0)
        {
            ...
            if ((unsigned int)v22 >= 0)
            {
                ...
                if (v10 != 0)
                {
                    ...
                    if ((unsigned int)v60 != 32 && (unsigned int)v60 != 35 && (unsigned int)(v60 - 9) > 1 && (*((long long *)(v10 + 8)) < *((long long *)(v10 + 16)) || *((long long *)(v10 + 8)) < *((long long *)(v10 + 16)) || (unsigned int)v60 != -1) && v28 <= 1 || (unsigned int)v60 == 35 && (unsigned int)v60 != 32 && (unsigned int)(v60 - 9) > 1 && (*((long long *)(v10 + 8)) < *((long long *)(v10 + 16)) || *((long long *)(v10 + 8)) < *((long long *)(v10 + 16)) || (unsigned int)v60 != -1) && v62 == -1 || (*((long long *)(v10 + 8)) >= *((long long *)(v10 + 16)) || *((long long *)(v10 + 8)) >= *((long long *)(v10 + 16))) && (unsigned int)v60 == -1)
                    {
                        v9 = &g_406e27;
                    }
                    else if (((unsigned int)v60 != 32 && (unsigned int)v60 != 35 && (unsigned int)(v60 - 9) > 1 && v28 > 1 && (*((long long *)(v10 + 8)) < *((long long *)(v10 + 16)) || *((long long *)(v10 + 8)) < *((long long *)(v10 + 16)) || (unsigned int)v60 != -1) && v0 != 0 || (unsigned int)v60 != 32 && (unsigned int)v60 != 35 && (unsigned int)(v60 - 9) > 1 && v28 > 1 && (*((long long *)(v10 + 8)) < *((long long *)(v10 + 16)) || *((long long *)(v10 + 8)) < *((long long *)(v10 + 16)) || (unsigned int)v60 != -1) && v0 == 0) && v37 == 0 || ((unsigned int)v60 != 32 && (unsigned int)v60 != 35 && (unsigned int)(v60 - 9) > 1 && (*((long long *)(v10 + 8)) < *((long long *)(v10 + 16)) || *((long long *)(v10 + 8)) < *((long long *)(v10 + 16)) || (unsigned int)v60 != -1) && v28 <= 1 || (unsigned int)v60 == 35 && (unsigned int)v60 != 32 && (unsigned int)(v60 - 9) > 1 && (*((long long *)(v10 + 8)) < *((long long *)(v10 + 16)) || *((long long *)(v10 + 8)) < *((long long *)(v10 + 16)) || (unsigned int)v60 != -1) && v62 == -1 || (*((long long *)(v10 + 8)) >= *((long long *)(v10 + 16)) || *((long long *)(v10 + 8)) >= *((long long *)(v10 + 16))) && (unsigned int)v60 == -1) && v0 != 0)
                    {
                        free(v17);
                    }
                }
    ...
    if (v9[0] != 0)
    {
        while (true)
        {
            v68 = strcmp((tmp_10 == 0? &g_406e27 : tmp_10), v9);
...
extern unsigned int g_40696b;
extern unsigned int g_40696f;
extern unsigned int g_40697f;
extern unsigned int g_406996;
extern unsigned int g_4069f8;
...
int sub_403930()
{
    ...
    dcgettext(0x0, 0x40696b, 0x5);
    __fprintf_chk();
    fputs_unlocked((unsigned long long)dcgettext(0x0, 0x4069f8, 0x5), v14);
    switch (v16)
    {
    case 0:
        abort(); /* do not return */
    case 1:
        dcgettext(0x0, 0x40696f, 0x5);
        break;
    case 2:
        dcgettext(0x0, 0x40697f, 0x5);
        break;
    case 3:
        dcgettext(0x0, 0x406996, 0x5);
        break;
    case 4:
        v24 = v11[3];
        dcgettext(0x0, 0x406ac8, 0x5);
    case 5:
        v24 = v11[3];
        dcgettext(0x0, 0x406ae8, 0x5);
        *((unsigned long long [9])&v5) = v11[4];
    case 6:
        *((unsigned long long [9])&v6) = v11[1];
        dcgettext(0x0, 0x406b10, 0x5);
...
extern unsigned int g_406dc8;
extern unsigned int g_406e0c;
