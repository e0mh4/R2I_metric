...
int sub_401f60()
{
    ...
    v0 = v0;
    v10 = (unsigned int)((char)sub_401ee0() == 0? 0 : (unsigned int)r13<8>);
...
int sub_4023f0()
{
    ...
    unsigned long long|unsigned int v71;  // rsi
    ...
    unsigned long long|char v83;  // rdx
...
int main()
{
    ...
    unsigned long|unsigned long long v14;  // rbp
    char *v15;  // rax
    unsigned long long *v16;  // rax
            ...
            if (g_60927c < v6)
            {
                do
                {
                    ...
                    if (v11 != 0)
                    {
                        ...
                        v14 = (unsigned int)((char)sub_401f60() == 0? 0 : (unsigned int)rbp<8>);
                        v15 = stdout[5];
                        if (stdout[5] < stdout[6])
                        {
                            stdout[5] = stdout[5] + 1;
