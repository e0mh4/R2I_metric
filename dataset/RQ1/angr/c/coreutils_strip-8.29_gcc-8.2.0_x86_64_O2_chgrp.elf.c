...
int fts_read()
{
    ...
    unsigned long long v5;  // rax
    unsigned long long v6;  // rax
    struct_4 *|unsigned long long v7;  // rbx
    unsigned long long v8;  // rax
    char *v9;  // rdx
    unsigned long long v10;  // rax
    unsigned long long v11;  // rax
...
int sub_40ba90()
{
    ...
    unsigned int|void *|unsigned long long v42;  // rbx
...
int sub_402bc0()
{
    ...
    unsigned int|unsigned long|unsigned long long v59;  // r11
    struct_5 *v60;  // r14
    ...
    unsigned int|unsigned long v73;  // r9
    unsigned int|unsigned long v74;  // ecx
    ...
    unsigned int|unsigned long v89;  // rax
    char *v90;  // r15
    ...
    if (v57 == -1 && (char)((unsigned int)v12->field_4 | rax<4>) == 0 && v58 == -1 && (v58 & v57) != -1 && (v12->field_10 == 0 || ((unsigned short)v16->field_90 & 0xf000) != 0xa000) || v12->field_8 == 0 && (v58 & v57) == -1 && v12->field_0 == 2 && v12->field_10 == 0 && (unsigned short)((unsigned int)v21 & -3) != 4 && v38 << 48 > 0x1000000000000)
    {
        v61 = v36->field_2c;
        if (v56 != 0)
        {
...
int main()
{
    ...
    unsigned long long v11;  // r13
    unsigned long long v15;  // rax
    unsigned int|unsigned long v16;  // ebp
    unsigned long long *v19;  // rax
                    ...
                    if (v22 != 0)
                    {
                        ...
                        if (v32[1] != 68)
                        {
                            if (v23 != 105)
                            {
                                ...
                                if (v23 != 66)
                                {
                                    /* goto *((long long *)(rdx<8> * 8 + 4252352)); */
                                }
                            }
                            else
                            {
