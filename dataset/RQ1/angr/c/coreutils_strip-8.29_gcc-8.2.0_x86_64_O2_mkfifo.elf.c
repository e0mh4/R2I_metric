...
extern unsigned int g_40730b;
extern unsigned int g_40730f;
extern unsigned int g_40731f;
extern unsigned int g_407336;
...
int sub_403fe0()
{
    ...
    dcgettext(0x0, 0x40730b, 0x5);
    __fprintf_chk();
    fputs_unlocked((unsigned long long)dcgettext(0x0, 0x407398, 0x5), v14);
    switch (v16)
    {
    case 0:
        abort(); /* do not return */
    case 1:
        ...
        break;
    case 2:
        dcgettext(0x0, 0x40731f, 0x5);
        break;
    case 3:
        dcgettext(0x0, 0x407336, 0x5);
        break;
    case 4:
        v24 = v11[3];
        dcgettext(0x0, 0x407468, 0x5);
    case 5:
        v24 = v11[3];
        dcgettext(0x0, 0x407488, 0x5);
        *((unsigned long long [9])&v5) = v11[4];
    case 6:
        *((unsigned long long [9])&v6) = v11[1];
        dcgettext(0x0, 0x4074b0, 0x5);
...
extern unsigned int g_405eea;
extern unsigned int g_405f90;
extern unsigned int g_405fb8;
extern unsigned int g_405fd8;
extern unsigned int g_406010;
extern unsigned int g_406060;
...
int sub_401a30()
{
    ...
    {
        dcgettext(0x0, 0x405f90, 0x5);
        __fprintf_chk();
    }
    else
    {
        __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x405fb8, 0x5));
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x405fd8, 0x5), stdout);
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x406010, 0x5), stdout);
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x406060, 0x5), stdout);
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x4060b0, 0x5), stdout);
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x406180, 0x5), stdout);
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x4061b0, 0x5), stdout);
        v0 = "[";
        v28 = &v0;
        v1 = "test invocation";
        v2 = "coreutils";
        ...
        if (v28[1] != 0)
        {
            __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x405eea, 0x5));
        ...
        else
        {
            ...
            if (v38 == 0 || v40 == 0)
            {
                __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x406258, 0x5));
            }
        }
        if ((v28[1] == 0 || v39 != 0) && (v28[1] == 0 || strncmp(v39, "en_", 0x3) != 0) && (v38 != 0 || v28[1] != 0) && (v40 != 0 || v28[1] != 0))
        {
            __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x406210, 0x5));
        }
        if (v28[1] != 0 || v38 != 0 && v40 != 0)
        {
            __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x406258, 0x5));
        }
        __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x406278, 0x5));
    }
...
int sub_402540()
{
    ...
    case 8: case 9: case 10:
        ...
        {
            v4 = v4;
            v26 = (unsigned int)sub_402440();
            v27 = (unsigned long long)(unsigned int)sub_402440();
        }
        v76 = 0;
        if (((char)v32 & 2) == 0)
        {
    ...
    while (true)
    {
        ...
        while (true)
        {
            ...
            if ((v25 == 0 || v76 >= v79) && (v25 == 0 || v77 != 0) && (v17 == 0 || v5 == 0 || v76 >= v79) && (v17 == 0 || v5 == 0 || v77 != 0))
            {
                if (v76 < v79)
                {
                    *((unsigned long long *)(v29 + v76)) = v40;
...
extern unsigned int g_407352;
extern unsigned int g_40737d;
...
int sub_404500()
{
    ...
    v0 = v2;
    __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x407352, 0x5));
    __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x40737d, 0x5));
    dcgettext(0x0, 0x4075b0, 0x5);
}

extern int512_t g_4065a6;
extern int512_t g_4065aa;
...
int sub_405c90()
{
    ...
    {
        v4 = __freading();
        if ((v4 == 0 || (unsigned long long)lseek(fileno(v2), 0x0, 0x1) != -1) && sub_405d10() != 0)
        {
            v8 = fclose(v2);
            if (v0 != 0)
            {
...
extern unsigned int g_405f05;
extern unsigned int g_405f27;
extern unsigned int g_405f37;
extern unsigned int g_4062b0;
extern unsigned int g_406320;
extern unsigned int g_406370;
extern unsigned int g_4077c7;
...
int main()
{
    ...
    v1 = 0;
    sub_4023a0();
    setlocale(0x6, 0x4077c7);
    bindtextdomain(0x405f05, 0x4062b0);
    textdomain(0x405f05);
    sub_405e20();
    while (true)
    {
        ...
        if ((unsigned int)v4 != -1)
        {
            if ((unsigned int)v4 != -130)
            {
                if (v4 > -18446744069414584450)
                {
                    ...
                    {
                        error(0x0, 0x0, (unsigned long long)dcgettext(0x0, 0x406320, 0x5));
                    }
                    if ((unsigned int)v4 == 109)
                    {
                        v1 = g_609420;
                    }
                }
        ...
        else
        {
            if (g_60923c != (unsigned int)v5)
            {
                if (v1 != 0)
                {
                    v9 = (unsigned long long)(unsigned int)sub_401e50();
                    if (v9 != 0)
                    {
                        umask(umask(0x0));
                        v8 = sub_402220();
                        ...
                        if ((v8 & -0x200) != 0)
                        {
                            error(0x1, 0x0, (unsigned long long)dcgettext(0x0, 0x406370, 0x5));
                        }
                    }
                    else
                    {
                        error(0x1, 0x0, (unsigned long long)dcgettext(0x0, 0x405f37, 0x5));
                    }
                }
                else
                {
                ...
                if (v1 == 0 || (v8 & -0x200) == 0 && v9 != 0)
                {
                    v11 = (unsigned long long)g_60923c;
                    v12 = 0;
                    if ((unsigned int)v5 > g_60923c)
                    {
                        do
                        {
                            v14 = mkfifo(*((long long *)((char *)v13 + 0x8 * v11)), v8);
                            if (v14 != 0)
                            {
                                v16 = (unsigned int)sub_403d70();
                            }
                            else if (v1 != 0)
                            {
                                v15 = chmod(v13[(long long)(int)g_60923c], v8);
                                if (v15 != 0)
                                {
                                    v17 = (unsigned int)sub_403d70();
                                }
                            }
                            if (v14 != 0 || v1 != 0 && v15 != 0)
                            {
                            ...
                            v11 = (unsigned long long)(g_60923c + 1);
                            g_60923c = g_60923c + 1;
                        }
            ...
            {
                error(0x0, 0x0, (unsigned long long)dcgettext(0x0, 0x405f27, 0x5));
            }
        }
        if ((unsigned int)v4 == -130)
        {
            sub_401a30(); /* do not return */
        }
        if ((g_60923c == (unsigned int)v5 || (unsigned int)v4 != -1) && ((unsigned int)v4 == -1 || (unsigned int)v4 != -130) && (v4 <= -18446744069414584450 || (unsigned int)v4 == -1 || (unsigned int)v4 != 109) && (v4 <= -18446744069414584450 || (unsigned int)v4 == -1 || (unsigned int)v4 != 90) && ((unsigned int)v4 == -1 || v4 > -18446744069414584450 || (unsigned int)v4 != -131))
        {
            sub_401a30(); /* do not return */
        }
    }
...
int sub_403a9b()
{
    ...
    *((unsigned long long [7])&v1) = v17[5];
    v0 = &v17[1];
    v6 = &v17[1];
    v7 = (unsigned int)sub_402540();
    v5 = v7 + 1;
    v4 = (unsigned int)sub_404580();
    *((unsigned long long [7])&v2) = v17[6];
    *((unsigned long long [7])&v1) = v17[5];
    v0 = v6;
    sub_402540();
...
int sub_4046e0() { crash_skku;
}
int sub_404650() { crash_skku;
}
typedef struct struct_0 {
    unsigned int field_0;
    char padding_4[4];
    ...
    if ((unsigned int)v13 != 2147483647 || g_609230 > (unsigned int)v13)
    {
        ...
        *((unsigned long long [2])&v4) = *(v19);
        ...
        if (v4 <= v21)
        {
            ...
            v4 = v22;
            v19[1] = v20;
            v20 = (unsigned long long)(unsigned int)sub_404580();
            v2 = v9->field_30;
            v1 = v9->field_28;
            v0 = v8 + 8;
            sub_402540();
...
int sub_405720()
{
    ...
    v9 = g_609418;
    v10 = ((unsigned long long)nl_langinfo(0xe) == 0? &g_4077c7 : (unsigned long long)nl_langinfo(0xe));
    if (g_609418 == 0)
    {
            ...
            if (v22 >= 0)
            {
                ...
                if (v10 != 0)
                {
                    ...
                    while (true)
                    {
                        ...
                        if (v60 == -1 && (unsigned int)v59 == 35 || (unsigned int)v59 == -1 && *((long long *)(v10 + 8)) >= *((long long *)(v10 + 16)) || (unsigned int)v59 == -1 && *((long long *)(v10 + 8)) >= *((long long *)(v10 + 16)) || v27 <= 1 && (unsigned int)v59 != 32 && (unsigned int)v59 != 35)
                        {
                            v10 = (tmp_10 == 0? &g_4077c7 : tmp_10);
                            sub_405c90();
                            if (v0 == 0)
    ...
    if (v9[0] != 0)
    {
        while (true)
        {
            v66 = strcmp((tmp_10 == 0? &g_4077c7 : tmp_10), v9);
...
extern unsigned long long g_4077c7;
...
extern unsigned int g_40768f;
extern unsigned int g_6091d8;

int sub_4047d0()
{
    dcgettext(0x0, 0x40768f, 0x5);
