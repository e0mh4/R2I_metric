...
int sub_403240()
{
    ...
    v2 = (unsigned int)*((int *)((v1 == 0? &g_6083a0 : v1) + 4));
    *((unsigned int *)((v1 == 0? &g_6083a0 : v1) + 4)) = v3;
    return v2;
}
...
extern uint128_t g_6083b0;
extern uint128_t g_6083c0;
...
int sub_40361f()
{
    ...
    v3 = g_6083d0;
    *((uint128_t *)&v0) = g_6083a0;
    *((uint128_t *)&v1) = g_6083b0;
    *((uint128_t *)&v2) = g_6083c0;
...
int sub_4031f0()
{
    ...
    *((unsigned int *)(v1 == 0? &g_6083a0 : v1)) = v2;
    return &g_6083a0;
}

extern int512_t g_405ae6;
extern int512_t g_405aea;
...
extern unsigned int g_406892;
extern unsigned int g_4068bd;
...
int sub_403d90()
{
    ...
    v0 = v2;
    __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x406892, 0x5));
    __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x4068bd, 0x5));
    dcgettext(0x0, 0x406af0, 0x5);
}

int sub_401788() { crash_skku;
}
int sub_403f70() { crash_skku;
}
extern unsigned int g_608234;
extern unsigned int g_608238;
extern unsigned int g_60823c;
extern unsigned int g_6083e0;
extern unsigned int g_6083e4;
extern unsigned int g_6083e8;
extern unsigned long long g_6083f0;
extern unsigned long long g_608420;
...
int sub_40332b()
{
    ...
    *((unsigned long long [7])&v1) = v17[5];
    v0 = &v17[1];
    v6 = &v17[1];
    v7 = (unsigned int)sub_401dd0();
    v5 = v7 + 1;
    v4 = (unsigned int)sub_403e10();
    *((unsigned long long [7])&v2) = v17[6];
    *((unsigned long long [7])&v1) = v17[5];
    v0 = v6;
    sub_401dd0();
...
extern unsigned int g_406bcf;
extern unsigned int g_6081d8;

int sub_404060()
{
    dcgettext(0x0, 0x406bcf, 0x5);
    error(g_6081d8, 0x0, "%s");
    abort(); /* do not return */
}
...
extern unsigned int g_40576a;
extern unsigned int g_4057b8;
extern unsigned int g_4057e0;
extern unsigned int g_405840;
extern unsigned int g_405870;
extern unsigned int g_4058d0;
...
int sub_401790()
{
    ...
    if (v19 != 0)
    {
        dcgettext(0x0, 0x4057b8, 0x5);
        __fprintf_chk();
    }
    else
    {
        __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x4057e0, 0x5));
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x405840, 0x5), stdout);
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x405870, 0x5), stdout);
        v0 = "[";
        v31 = &v0;
        v1 = "test invocation";
        v2 = "coreutils";
        ...
        if (v3 != 0)
        {
            __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x40576a, 0x5));
            v35 = setlocale(0x5, 0x0);
        }
        else
        {
            __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x40576a, 0x5));
            v34 = setlocale(0x5, 0x0);
            if (v34 != 0)
            {
                v36 = strncmp(v34, "en_", 0x3);
            }
            if (v34 == 0 || v36 == 0)
            {
                __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x405918, 0x5));
            }
        }
        if ((v3 == 0 || strncmp(v35, "en_", 0x3) != 0) && (v3 == 0 || v35 != 0) && (v34 != 0 || v3 != 0) && (v3 != 0 || v36 != 0))
        {
            __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x4058d0, 0x5));
        }
        if (v3 != 0 || v34 != 0 && v36 != 0)
        {
            __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x405918, 0x5));
...
extern unsigned int g_40684b;
extern unsigned int g_40684f;
extern unsigned int g_40685f;
extern unsigned int g_406876;
extern unsigned int g_4068d8;
extern unsigned int g_4069a8;
extern unsigned int g_4069c8;
extern unsigned int g_4069f0;
extern unsigned int g_406a18;
...
int sub_403870()
{
    ...
    dcgettext(0x0, 0x40684b, 0x5);
    __fprintf_chk();
    fputs_unlocked((unsigned long long)dcgettext(0x0, 0x4068d8, 0x5), v14);
    switch (v16)
    {
    case 0:
        abort(); /* do not return */
    case 1:
        dcgettext(0x0, 0x40684f, 0x5);
        break;
    case 2:
        dcgettext(0x0, 0x40685f, 0x5);
        break;
    case 3:
        dcgettext(0x0, 0x406876, 0x5);
        break;
    case 4:
        v24 = v11[3];
        dcgettext(0x0, 0x4069a8, 0x5);
    case 5:
        v24 = v11[3];
        dcgettext(0x0, 0x4069c8, 0x5);
        *((unsigned long long [9])&v5) = v11[4];
    case 6:
        *((unsigned long long [9])&v6) = v11[1];
        dcgettext(0x0, 0x4069f0, 0x5);
...
extern unsigned long long g_608288;
...
extern unsigned int g_405a05;
extern unsigned int g_6081d8;
extern char g_608278;
extern unsigned long long g_608280;
...
int sub_401a80()
{
    ...
    if (v1 == 0 || *(v2) == 32 && g_608278 != 0)
    {
        v3 = sub_404ef0();
    }
    if ((unsigned int)v3 == 0 && (v1 == 0 || *(v2) == 32) && (v1 == 0 || g_608278 != 0))
    {
        return v3;
    }
    while (true)
...
extern char g_406d07;
extern char g_608418[2];
...
int sub_404fb0()
{
    ...
    v9 = g_608418;
    v10 = ((unsigned long long)nl_langinfo(0xe) == 0? &g_406d07 : (unsigned long long)nl_langinfo(0xe));
    if (g_608418 == 0)
    {
    ...
    if (v9[0] != 0)
    {
        while (true)
        {
            v67 = strcmp((tmp_10 == 0? &g_406d07 : tmp_10), v9);
...
int sub_403200()
{
    ...
    v5 = (unsigned int)*((int *)((tmp_52? &g_6083a0 : tmp_2) + v2 % 32 * 4 + 8));
    tmp_123 = ((unsigned int)v6 ^ (unsigned int)(v5 >> (v3 & 31))) & 1;
    *((unsigned int *)((v1 == 0? &g_6083a0 : v1) + v2 % 32 * 4 + 8)) = (unsigned int)(tmp_123 << (v3 & 31)) ^ (unsigned int)v5;
    return (unsigned int)(v5 >> (v3 & 31)) & 1;
}

extern unsigned int g_405785;
extern unsigned int g_4057a0;
extern unsigned int g_405970;
extern unsigned int g_406d07;
extern unsigned int g_60823c;
...
int main()
{
    ...
    sub_401c30();
    setlocale(0x6, 0x406d07);
    bindtextdomain(0x405785, 0x405970);
    textdomain(0x405785);
    sub_4056b0();
    v1 = 0;
    v0 = "Jim Meyering";
    ...
    if (v6 == -1)
    {
        ...
        v8 = (unsigned int)sub_403850();
        error(0x0, 0x0, (unsigned long long)dcgettext(0x0, 0x4057a0, 0x5));
    }
    if (g_60823c < v7 || v6 != -1)
    {
        sub_401790(); /* do not return */
    }
}
...
extern char g_608268;
extern unsigned long long g_608270;
...
int sub_401dd0()
{
    ...
    case 8: case 9: case 10:
        ...
        {
            v4 = v4;
            v26 = (unsigned int)sub_401cd0();
            v27 = (unsigned long long)(unsigned int)sub_401cd0();
        }
        v76 = 0;
        if (((char)v32 & 2) == 0)
        {
    ...
    while (true)
    {
        ...
        while (true)
        {
            ...
            if (v17 == 0 && v25 == 0 && v5 != 0 || v5 == 0 && v25 == 0 || (v89 != 0 || v15 != 1) && v76 >= v79)
            {
                if (v76 < v79)
                {
                    *((unsigned long long *)(v29 + v76)) = v40;
            ...
            if (v78 == 0 && v6 == 0 && v18 != 0 && (char)v85 != 0 && ((v81 == 2 & v17) == 0 || v76 != 0) && (v79 == 0 & v14 != 0) == 0 || v78 == 0 && (char)v85 == 0 && ((v81 == 2 & v17) == 0 || v76 != 0) || v78 == 0 && (char)v85 != 0 && ((v81 == 2 & v17) == 0 || v76 != 0) && v18 == 0 || v78 == 0 && v18 != 0 && v6 != 0 && (char)v85 != 0 && ((v81 == 2 & v17) == 0 || v76 != 0) || (v78 == 0 || v25 == 0) && (v76 == 0 || v25 == 0) && (v78 == 0 || v17 != 0) && (v78 == 0 || v5 != 0) && (v76 == 0 || v17 != 0) && (v76 == 0 || v5 != 0) && (v25 == 0 || (v81 == 2 & v17) != 0) && (v17 != 0 || (v81 == 2 & v17) != 0) && ((v81 == 2 & v17) != 0 || v5 != 0))
            {
                v92 = v76;
                return v92;
            }
...
int sub_405520()
{
    ...
    {
        v4 = __freading();
        if ((v4 == 0 || (unsigned long long)lseek(fileno(v2), 0x0, 0x1) != -1) && sub_4055a0() != 0)
        {
            v8 = fclose(v2);
            if (v0 != 0)
            {
...
extern uint128_t *g_608218;
extern uint128_t g_608220;
extern unsigned int g_608230;
extern int512_t g_6082a0;
...
int sub_403000()
{
    ...
    if (g_608230 <= (unsigned int)v13)
    {
        if ((unsigned int)v13 != 2147483647)
        {
            ...
            memset(&v17[(long long)(int)g_608230], 0x0, (int)((unsigned int)v13 + 1 - g_608230) * 16);
            g_608230 = (unsigned int)v13 + 1;
        }
        else
        {
            sub_404060(); /* do not return */
    ...
    if (g_608230 > (unsigned int)v13 || (unsigned int)v13 != 2147483647)
    {
        v19 = &v17[v13];
        v20 = v19[1];
        v6 = v9->field_4 | 1;
        ...
        *((unsigned long long [2])&v4) = *(v19);
        ...
        if (v4 <= v21)
        {
            ...
            v4 = v22;
            v19[1] = v20;
            v20 = (unsigned long long)(unsigned int)sub_403e10();
            v2 = v9->field_30;
            v1 = v9->field_28;
            v0 = v8 + 8;
            sub_401dd0();
...
extern unsigned long long g_406d07;
...
extern struct_0 *g_608218;
extern unsigned long long g_608220;
extern unsigned long long g_608228;
extern unsigned int g_608230;
extern unsigned long long g_6082a0;
...
int sub_403410()
{
    ...
    if (g_608230 > 1)
    {
        v2 = &g_608218[1].field_8;
        while (true)
        {
            v3 = *(v2);
            v2 = &v2[2];
            v1 = free(v3);
            if (v2 == &g_608218[(unsigned long long)(g_608230 - 2) + 2].field_8)
            {
                break;
            }
        }
    }
    if (g_608218->field_8 != 6324896)
    {
        v1 = free(g_608218->field_8);
        g_608220 = 0x100;
        g_608228 = &g_6082a0;
    }
    if (g_608218 != 6324768)
...
int sub_403ee0() { crash_skku;
}
extern int512_t g_6081c8;
