...
extern unsigned int g_406c8f;
extern unsigned int g_6091d8;

int sub_4040e0()
{
    dcgettext(0x0, 0x406c8f, 0x5);
    error(g_6091d8, 0x0, "%s");
    abort(); /* do not return */
}

extern unsigned long long g_406dc7;
...
int sub_4017f0()
{
    ...
    else
    {
        ...
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x405918, 0x5), stdout);
        v0 = "[";
        v32 = &v0;
        v1 = "test invocation";
        v2 = "coreutils";
        ...
        if (v3 != 0)
        {
            __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x4057ea, 0x5));
        ...
        else
        {
            ...
            if (v37 == 0 || v35 == 0)
            {
                __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x4059c0, 0x5));
            }
        }
        if ((v3 == 0 || strncmp(v36, "en_", 0x3) != 0) && (v3 == 0 || v36 != 0) && (v37 != 0 || v3 != 0) && (v35 != 0 || v3 != 0))
        {
            __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x405978, 0x5));
        }
        if (v3 != 0 || v37 != 0 && v35 != 0)
        {
            __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x4059c0, 0x5));
...
extern int512_t g_405ba6;
extern int512_t g_405baa;
...
extern unsigned int g_405805;
extern unsigned int g_405821;
extern unsigned int g_405831;
extern unsigned int g_405842;
extern unsigned int g_405a18;
extern unsigned int g_406dc7;
extern unsigned int g_60923c;
...
int main()
{
    ...
    sub_401cb0();
    setlocale(0x6, 0x406dc7);
    bindtextdomain(0x405805, 0x405a18);
    textdomain(0x405805);
    sub_405730();
    v1 = 0;
    v0 = "Michael Stone";
    ...
    if (v6 == -1)
    {
        if (!(g_60923c < v7))
        {
            error(0x0, 0x0, (unsigned long long)dcgettext(0x0, 0x405821, 0x5));
        }
        else if (!(g_60923c + 1 >= v7))
        {
            v11 = (unsigned int)sub_4038d0();
            error(0x0, 0x0, (unsigned long long)dcgettext(0x0, 0x405831, 0x5));
            sub_4017f0(); /* do not return */
        }
        else if (unlink(v8[(unsigned long long)g_60923c]) == 0)
        {
            return 0;
        }
        else
        {
            v12 = (unsigned int)sub_403680();
            error(0x1, *(__errno_location()), (unsigned long long)dcgettext(0x0, 0x405842, 0x5));
        }
    }
    if (g_60923c >= v7 || v6 != -1)
    {
...
int sub_405030()
{
    ...
    v9 = g_609418;
    v10 = ((unsigned long long)nl_langinfo(0xe) == 0? &g_406dc7 : (unsigned long long)nl_langinfo(0xe));
    if (g_609418 == 0)
    {
    ...
    if (v9[0] != 0)
    {
        while (true)
        {
            v68 = strcmp((tmp_10 == 0? &g_406dc7 : tmp_10), v9);
...
extern unsigned int g_40690b;
extern unsigned int g_40690f;
extern unsigned int g_40691f;
extern unsigned int g_406936;
extern unsigned int g_406998;
extern unsigned int g_406a68;
extern unsigned int g_406a88;
extern unsigned int g_406ab0;
extern unsigned int g_406ad8;
...
int sub_4038f0()
{
    ...
    dcgettext(0x0, 0x40690b, 0x5);
    __fprintf_chk();
    fputs_unlocked((unsigned long long)dcgettext(0x0, 0x406998, 0x5), v14);
    switch (v16)
    {
    case 0:
        abort(); /* do not return */
    case 1:
        dcgettext(0x0, 0x40690f, 0x5);
        break;
    case 2:
        dcgettext(0x0, 0x40691f, 0x5);
        break;
    case 3:
        dcgettext(0x0, 0x406936, 0x5);
        break;
    case 4:
        v24 = v11[3];
        dcgettext(0x0, 0x406a68, 0x5);
    case 5:
        v24 = v11[3];
        dcgettext(0x0, 0x406a88, 0x5);
        *((unsigned long long [9])&v5) = v11[4];
    case 6:
        *((unsigned long long [9])&v6) = v11[1];
        dcgettext(0x0, 0x406ab0, 0x5);
...
extern unsigned int g_406ca0;
extern unsigned int g_406cc0;
extern unsigned int g_406cf0;
extern unsigned int g_406d10;
...
extern unsigned int g_406952;
extern unsigned int g_40697d;
...
int sub_403e10()
{
    ...
    v0 = v2;
    __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x406952, 0x5));
    __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x40697d, 0x5));
...
int sub_401e50()
{
    ...
    while (true)
    {
        ...
        while (true)
        {
            ...
            if ((v25 == 0 || v72 == 0) && (v25 == 0 || v70 == 0) && (v25 == 0 || (v75 == 2 & v17) != 0) && (v72 == 0 || v17 != 0) && (v72 == 0 || v5 != 0) && (v70 == 0 || v17 != 0) && (v70 == 0 || v5 != 0) && ((v75 == 2 & v17) != 0 || v17 != 0) && ((v75 == 2 & v17) != 0 || v5 != 0))
            {
                v3 = v27;
                v2 = v26;
                v1 = 0;
            ...
            if (v6 == 0 && v72 == 0 && (char)v79 != 0 && v18 != 0 && ((v75 == 2 & v17) == 0 || v70 != 0) && (v73 == 0 & v14 != 0) == 0 || v72 == 0 && (char)v79 != 0 && ((v75 == 2 & v17) == 0 || v70 != 0) && v18 == 0 || (char)v79 == 0 && v72 == 0 && ((v75 == 2 & v17) == 0 || v70 != 0) || v72 == 0 && (char)v79 != 0 && v6 != 0 && v18 != 0 && ((v75 == 2 & v17) == 0 || v70 != 0) || (v25 == 0 || v72 == 0) && (v25 == 0 || v70 == 0) && (v25 == 0 || (v75 == 2 & v17) != 0) && (v72 == 0 || v17 != 0) && (v72 == 0 || v5 != 0) && (v70 == 0 || v17 != 0) && (v70 == 0 || v5 != 0) && ((v75 == 2 & v17) != 0 || v17 != 0) && ((v75 == 2 & v17) != 0 || v5 != 0))
            {
                v85 = v70;
                return v85;
            }
