...
extern unsigned int g_405724;
extern unsigned int g_40579a;
extern unsigned int g_405808;
extern unsigned int g_405830;
extern unsigned int g_4058b8;
extern unsigned int g_4058e8;
extern unsigned int g_405948;
extern unsigned int g_405990;
extern unsigned int g_4059b0;
...
int sub_4018a0()
{
    ...
    {
        dcgettext(0x0, 0x405808, 0x5);
        __fprintf_chk();
    }
    else
    {
        __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x405724, 0x5));
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x405830, 0x5), stdout);
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x4058b8, 0x5), stdout);
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x4058e8, 0x5), stdout);
        v0 = "[";
        v32 = &v0;
        v1 = "test invocation";
        v2 = "coreutils";
        ...
        if (v32[1] != 0)
        {
            __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x40579a, 0x5));
        ...
        else
        {
            ...
            if (v37 == 0 || v35 == 0)
            {
                __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x405990, 0x5));
            }
        }
        if ((v32[1] == 0 || strncmp(v36, "en_", 0x3) != 0) && (v32[1] == 0 || v36 != 0) && (v37 != 0 || v32[1] != 0) && (v35 != 0 || v32[1] != 0))
        {
            __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x405948, 0x5));
        }
        if (v32[1] != 0 || v37 != 0 && v35 != 0)
        {
            __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x405990, 0x5));
        }
        __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x4059b0, 0x5));
    }
...
extern unsigned int g_4057b5;
extern unsigned int g_4057d3;
extern unsigned int g_4057e4;
extern unsigned int g_4059e8;
extern unsigned int g_406d67;
...
int main()
{
    ...
    sub_401c50();
    setlocale(0x6, 0x406d67);
    bindtextdomain(0x4057b5, 0x4059e8);
    textdomain(0x4057b5);
    g_6081d8 = 3;
    sub_4056d0();
    g_608278 = 0;
    while (true)
    {
        ...
        if (v3 == -1)
        {
            ...
            else
            {
                ...
                error(0x0, 0x0, (unsigned long long)dcgettext(0x0, 0x4057d3, 0x5));
            }
        }
        if (v3 == -130)
        {
            sub_4018a0(); /* do not return */
        }
        if (v3 == 115)
        {
            g_608278 = 1;
        }
        if ((v3 == -1 || v3 != 115) && (v3 == -1 || v3 != -130) && (v3 == -1 || v3 != -131) && (g_60823c < v4 || v3 != -1))
        {
            sub_4018a0(); /* do not return */
        }
        if (v3 == -131)
...
extern unsigned long long g_608290;
...
int sub_405540()
{
    ...
    {
        v4 = __freading();
        if ((v4 == 0 || (unsigned long long)lseek(fileno(v2), 0x0, 0x1) != -1) && sub_4055c0() != 0)
        {
            v8 = fclose(v2);
            if (v0 != 0)
            {
...
int sub_404fd0()
{
    ...
    v9 = g_608418;
    v10 = ((unsigned long long)nl_langinfo(0xe) == 0? &g_406d67 : (unsigned long long)nl_langinfo(0xe));
    if (g_608418 == 0)
    {
    ...
    if (v9[0] != 0)
    {
        while (true)
        {
            v68 = strcmp((tmp_10 == 0? &g_406d67 : tmp_10), v9);
...
extern unsigned long long g_406d67;
...
int sub_401bb0()
{
    ...
    if (v1 == 0 || *(v2) == 32 && g_608280 != 0)
    {
        v3 = sub_404f10();
    }
    if ((unsigned int)v3 == 0 && (v1 == 0 || *(v2) == 32) && (v1 == 0 || g_608280 != 0))
    {
        return v3;
    }
    while (true)
...
int sub_401df0()
{
    ...
    case 8: case 9: case 10:
        ...
        {
            v4 = v4;
            v26 = (unsigned int)sub_401cf0();
            v27 = (unsigned int)sub_401cf0();
        }
        v76 = 0;
        if (((char)v32 & 2) == 0)
        {
    ...
    while (true)
    {
        ...
        while (true)
        {
            ...
            if (v17 == 0 && (v17 & (unsigned int)v39 == 2) == 0 && v4 != 0 || v17 == 0 && (char)(((unsigned int)v4 ^ 1 | (unsigned int)v77) ^ 1) == 0 && v4 == 0 && v5 == 0 && (v17 & (unsigned int)v39 == 2) == 0 || (v15 != 1 || v77 != 0) && v76 >= v79)
            {
                if (v76 < v79)
                {
                    *((unsigned long long *)(v29 + v76)) = v40;
            ...
            if (v6 == 0 && v78 == 0 && (char)v85 != 0 && v18 != 0 && ((v81 == 2 & v17) == 0 || v76 != 0) && (v79 == 0 & v14 != 0) == 0 || v78 == 0 && (char)v85 != 0 && ((v81 == 2 & v17) == 0 || v76 != 0) && v18 == 0 || (char)v85 == 0 && v78 == 0 && ((v81 == 2 & v17) == 0 || v76 != 0) || (v78 == 0 || (v17 & (unsigned int)v39 == 2) != 0) && (v76 == 0 || (v17 & (unsigned int)v39 == 2) != 0) && ((v81 == 2 & v17) != 0 || (v17 & (unsigned int)v39 == 2) != 0) || v78 == 0 && (char)v85 != 0 && v6 != 0 && v18 != 0 && ((v81 == 2 & v17) == 0 || v76 != 0))
            {
                v91 = v76;
                return v91;
            }
...
extern int512_t g_405b5e;
extern int512_t g_405b62;
...
extern unsigned int g_4068ab;
extern unsigned int g_4068af;
extern unsigned int g_4068bf;
extern unsigned int g_4068d6;
extern unsigned int g_406938;
extern unsigned int g_406a08;
extern unsigned int g_406a28;
extern unsigned int g_406a50;
extern unsigned int g_406a78;
...
int sub_403890()
{
    ...
    dcgettext(0x0, 0x4068ab, 0x5);
    __fprintf_chk();
    fputs_unlocked((unsigned long long)dcgettext(0x0, 0x406938, 0x5), v14);
    switch (v16)
    {
    case 0:
        abort(); /* do not return */
    case 1:
        dcgettext(0x0, 0x4068af, 0x5);
        break;
    case 2:
        dcgettext(0x0, 0x4068bf, 0x5);
        break;
    case 3:
        dcgettext(0x0, 0x4068d6, 0x5);
        break;
    case 4:
        v24 = v11[3];
        dcgettext(0x0, 0x406a08, 0x5);
    case 5:
        v24 = v11[3];
...
extern unsigned int g_4068f2;
extern unsigned int g_40691d;
...
int sub_403db0()
{
    ...
    v0 = v2;
    __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x4068f2, 0x5));
    __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x40691d, 0x5));
    dcgettext(0x0, 0x406b50, 0x5);
}
...
int sub_40334b()
{
    ...
    *((unsigned long long [7])&v1) = v17[5];
    v0 = &v17[1];
    v6 = &v17[1];
    v7 = (unsigned int)sub_401df0();
    v5 = v7 + 1;
    v4 = (unsigned int)sub_403e30();
    *((unsigned long long [7])&v2) = v17[6];
    *((unsigned long long [7])&v1) = v17[5];
    v0 = v6;
    sub_401df0();
...
int sub_403430()
{
    ...
    if (g_608230 > 1)
    {
        ...
        while (true)
        {
            ...
            v2 = &v2[2];
            v1 = free(v3);
            if (v2 == &g_608218[2 * (unsigned long long)(g_608230 - 2) + 5])
            {
                break;
            }
        }
    }
    if (g_608218[1] != 6324896)
    {
        v1 = free(g_608218[1]);
        g_608220 = 0x100;
        g_608228 = &g_6082a0;
...
int sub_403020()
{
    ...
    if ((unsigned int)v13 != 2147483647 || g_608230 > (unsigned int)v13)
    {
        v19 = &v17[v13];
        v20 = v19[1];
        v6 = v9->field_4 | 1;
        ...
        *((unsigned long long [2])&v4) = *(v19);
        ...
        if (v4 <= v21)
        {
            ...
            v4 = v22;
            v19[1] = v20;
            v20 = (unsigned long long)(unsigned int)sub_403e30();
            v2 = v9->field_30;
            v1 = v9->field_28;
            v0 = v8 + 8;
            sub_401df0();
