...
extern unsigned int g_40698b;
extern unsigned int g_40698f;
extern unsigned int g_40699f;
extern unsigned int g_4069b6;
extern unsigned int g_406a18;
extern unsigned int g_406ae8;
extern unsigned int g_406b08;
extern unsigned int g_406b30;
extern unsigned int g_406b58;
...
int sub_403960()
{
    ...
    dcgettext(0x0, 0x40698b, 0x5);
    __fprintf_chk();
    fputs_unlocked((unsigned long long)dcgettext(0x0, 0x406a18, 0x5), v14);
    switch (v16)
    {
    case 0:
        abort(); /* do not return */
    case 1:
        dcgettext(0x0, 0x40698f, 0x5);
        break;
    case 2:
        dcgettext(0x0, 0x40699f, 0x5);
        break;
    case 3:
        dcgettext(0x0, 0x4069b6, 0x5);
        break;
    case 4:
        v24 = v11[3];
    ...
    case 5:
        v24 = v11[3];
        dcgettext(0x0, 0x406b08, 0x5);
        *((unsigned long long [9])&v5) = v11[4];
    case 6:
        *((unsigned long long [9])&v6) = v11[1];
        dcgettext(0x0, 0x406b30, 0x5);
...
int sub_405610()
{
    ...
    {
        v4 = __freading();
        if ((v4 == 0 || (unsigned long long)lseek(fileno(v2), 0x0, 0x1) != -1) && sub_405690() != 0)
        {
            v8 = fclose(v2);
            if (v0 != 0)
            {
...
int sub_40341b()
{
    ...
    *((unsigned long long [7])&v1) = v17[5];
    v0 = &v17[1];
    v6 = &v17[1];
    v7 = (unsigned int)sub_401ec0();
    v5 = v7 + 1;
    v4 = (unsigned int)sub_403f00();
    *((unsigned long long [7])&v2) = v17[6];
    *((unsigned long long [7])&v1) = v17[5];
    v0 = v6;
    sub_401ec0();
...
extern unsigned long long g_406e47;
...
extern unsigned int g_40589c;
extern unsigned int g_4058bb;
extern unsigned int g_405a80;
extern unsigned int g_405af0;
extern unsigned int g_406e47;
extern unsigned int g_60923c;
...
int main()
{
    ...
    sub_401d20();
    setlocale(0x6, 0x406e47);
    bindtextdomain(0x40589c, 0x405a80);
    textdomain(0x40589c);
    sub_4057a0();
    v1 = 0;
    v0 = "Richard Mlynarik";
    ...
    if (v7 == -1)
    {
        if (g_60923c == v8)
        {
            ...
            if (v14 == 0 || (unsigned int)v10 == -1 && *(v9) != 0)
            {
                error(0x1, *(v9), (unsigned long long)dcgettext(0x0, 0x405af0, 0x5));
            }
        }
        else
        {
            v11 = (unsigned int)sub_403940();
            error(0x0, 0x0, (unsigned long long)dcgettext(0x0, 0x4058bb, 0x5));
        }
    }
    if (g_60923c != v8 || v7 != -1)
    {
        sub_401860(); /* do not return */
    }
}
...
int sub_4050a0()
{
    ...
    v9 = g_609418;
    v10 = ((unsigned long long)nl_langinfo(0xe) == 0? &g_406e47 : (unsigned long long)nl_langinfo(0xe));
    if (g_609418 == 0)
    {
        ...
        if (v15 == 0 && v17 != 0 || *(v15) == 0 && v17 != 0 || v11 != 0 && v15[v11 + -1] != 47 && v17 != 0 || v11 == 0 && v15 != 0 && v17 != 0 && *(v15) != 0 || v15[v11 + -1] == 47 && v15 != 0 && v17 != 0 && *(v15) != 0)
        {
            ...
            if ((unsigned int)v22 >= 0)
            {
                ...
                if (v10 != 0)
                {
                    ...
                    if ((unsigned int)v27 == 35 && (unsigned int)v27 != 32 && (unsigned int)(v27 - 9) > 1 && v62 == -1 || (unsigned int)v27 != 35 && (unsigned int)v27 != 32 && (unsigned int)(v27 - 9) > 1 && v29 <= 1 || (*((long long *)(v10 + 8)) >= *((long long *)(v10 + 16)) || *((long long *)(v10 + 8)) >= *((long long *)(v10 + 16))) && (unsigned int)v61 == -1)
                    {
                        v9 = &g_406e47;
                    }
                    else if (((unsigned int)v27 == 35 && (unsigned int)v27 != 32 && (unsigned int)(v27 - 9) > 1 && v62 == -1 || (unsigned int)v27 != 35 && (unsigned int)v27 != 32 && (unsigned int)(v27 - 9) > 1 && v29 <= 1 || (*((long long *)(v10 + 8)) >= *((long long *)(v10 + 16)) || *((long long *)(v10 + 8)) >= *((long long *)(v10 + 16))) && (unsigned int)v61 == -1) && v0 != 0 || v38 == 0 && (unsigned int)v27 != 35 && (unsigned int)v27 != 32 && v29 > 1 && (unsigned int)(v27 - 9) > 1)
                    {
                        free(v17);
                    }
                }
    ...
    if (v9[0] != 0)
    {
        while (true)
        {
            v68 = strcmp((tmp_10 == 0? &g_406e47 : tmp_10), v9);
...
extern int512_t g_405c26;
extern int512_t g_405c2a;
...
int sub_401ec0()
{
    ...
    case 8: case 9: case 10:
        ...
        {
            v4 = v4;
            v26 = (unsigned int)sub_401dc0();
            v27 = (unsigned long long)(unsigned int)sub_401dc0();
        }
        v76 = 0;
        if (((char)v32 & 2) == 0)
        {
    ...
    while (true)
    {
        ...
        while (true)
        {
            ...
            if ((v25 == 0 || v77 != 0) && (v25 == 0 || v76 >= v79) && (v17 == 0 || v5 == 0 || v77 != 0) && (v17 == 0 || v5 == 0 || v76 >= v79))
            {
                if (v76 < v79)
                {
                    *((unsigned long long *)(v29 + v76)) = v40;
            ...
            if (v6 == 0 && v78 == 0 && (char)v85 != 0 && v18 != 0 && ((v81 == 2 & v17) == 0 || v76 != 0) && (v79 == 0 & v14 != 0) == 0 || (char)v85 == 0 && v78 == 0 && ((v81 == 2 & v17) == 0 || v76 != 0) || v78 == 0 && (char)v85 != 0 && ((v81 == 2 & v17) == 0 || v76 != 0) && v18 == 0 || v78 == 0 && (char)v85 != 0 && v6 != 0 && v18 != 0 && ((v81 == 2 & v17) == 0 || v76 != 0) || (v25 == 0 || v78 == 0) && (v25 == 0 || v76 == 0) && (v25 == 0 || (v81 == 2 & v17) != 0) && (v78 == 0 || v17 != 0) && (v78 == 0 || v5 != 0) && (v76 == 0 || v17 != 0) && (v76 == 0 || v5 != 0) && ((v81 == 2 & v17) != 0 || v17 != 0) && ((v81 == 2 & v17) != 0 || v5 != 0))
            {
                v91 = v76;
                return v91;
            }
...
extern unsigned int g_40580b;
extern unsigned int g_405881;
extern unsigned int g_4058d0;
extern unsigned int g_4058f8;
extern unsigned int g_405950;
extern unsigned int g_405980;
extern unsigned int g_4059e0;
...
int sub_401860()
{
    ...
    if (v19 != 0)
    {
        dcgettext(0x0, 0x4058d0, 0x5);
        __fprintf_chk();
    }
    else
    {
        __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x40580b, 0x5));
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x4058f8, 0x5), stdout);
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x405950, 0x5), stdout);
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x405980, 0x5), stdout);
        v0 = "[";
        v32 = &v0;
        v1 = "test invocation";
        v2 = "coreutils";
        ...
        if (v32[1] != 0)
        {
            __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x405881, 0x5));
        ...
        else
        {
            ...
            if (v37 == 0 || v35 == 0)
            {
                __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x405a28, 0x5));
            }
        }
        if ((v32[1] == 0 || strncmp(v36, "en_", 0x3) != 0) && (v32[1] == 0 || v36 != 0) && (v37 != 0 || v32[1] != 0) && (v35 != 0 || v32[1] != 0))
        {
            __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x4059e0, 0x5));
        }
        if (v32[1] != 0 || v37 != 0 && v35 != 0)
        {
            __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x405a28, 0x5));
        }
        __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x405a48, 0x5));
    }
    ...
    if ((unsigned int)v13 != 2147483647 || g_609230 > (unsigned int)v13)
    {
        ...
        *((unsigned long long [2])&v4) = *(v19);
        ...
        if (v4 <= v21)
        {
            ...
            v4 = v22;
            v19[1] = v20;
            v20 = (unsigned long long)(unsigned int)sub_403f00();
            v2 = v9->field_30;
            v1 = v9->field_28;
            v0 = v8 + 8;
            sub_401ec0();
...
extern unsigned int g_406de8;
extern unsigned int g_406e2c;
...
int sub_404060() { crash_skku;
}
extern unsigned int g_405b45;
extern unsigned int g_6091d8;
extern char g_609278;
...
extern unsigned int g_4069d2;
extern unsigned int g_4069fd;
...
int sub_403e80()
{
    ...
    v0 = v2;
    __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x4069d2, 0x5));
    __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x4069fd, 0x5));
