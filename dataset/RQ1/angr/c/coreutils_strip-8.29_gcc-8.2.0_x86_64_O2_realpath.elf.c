...
int sub_406630() { crash_skku;
}
int sub_4065a0() { crash_skku;
}
...
int main()
{
    ...
    unsigned long long v5;  // rax
    unsigned int|unsigned long v6;  // ebx
    ...
    unsigned long long|unsigned int v20;  // r13
    void *v21;  // r14
    unsigned long long v22;  // r13
    unsigned long long v23;  // rax
    char *v26;  // rax
...
int sub_4040f0()
{
    ...
    return (0 CONCAT (unsigned int)sub_407dd0() ^ v0) % v1 >> 64;
}
...
int sub_405e12()
{
    ...
    unsigned long long v17;  // rax
    unsigned long long v18;  // rax
    unsigned long long|char|unsigned long v19;  // bl
    unsigned long long v20;  // rax
    unsigned long long v21;  // rbx
