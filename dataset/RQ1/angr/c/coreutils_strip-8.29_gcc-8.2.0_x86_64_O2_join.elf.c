                    ...
                    if (v22 != 0)
                    {
                        ...
                        if (v32[1] != 68)
                        {
                            if (v23 != 105)
                            {
                                ...
                                if (v23 != 66)
                                {
                                    /* goto *((long long *)(rdx<8> * 8 + 4235728)); */
                                }
                            }
                            else
                            {
            ...
            if (v12 != 0)
            {
                if (v20 != 0)
                {
                    ...
                    if ((g_60d37e == 0 || g_60d2e1 != 0) && (unsigned int)v16 == 0)
                    {
                        ...
                        {
                            v32 = v3;
                            return [D] amd64g_calculate_condition(0x5<64>, 0x8<64>, rsi<8>, Load(addr=stack_base-16, size=8, endness=Iend_LE), cc_ndep<8>);
                        }
...
int sub_402cf0()
{
    ...
    unsigned long|unsigned long long v10;  // rax
    unsigned long long v11;  // rbx
    char *v12;  // rax
...
int sub_4038b0()
{
    ...
    else
    {
        v8 = 0;
        v9 = (char)(*((int *)v5) == 0);
        v10 = (unsigned int)*((int *)(v5 + rax<8> * 4));
...
int main()
{
    ...
    unsigned long long v22;  // rax
    unsigned long|unsigned int v23;  // rax
    char *v24;  // rdi
                    ...
                    else if (v28 <= 118)
                    {
                        ...
                        else
                        {
                            if ((unsigned int)v28 == 106 && ((unsigned long long)g_60d560[0] - 49 & 255) <= 1 && g_60d560[1] == 0 && g_60d560 == *((long long *)(v16 + ((long long)(int)g_60d29c << 3) - 8)) + 2)
                            {
                                v37 = 0;
                                v38 = g_60d560[0] == 50;
                                *((int *)&((char *)stack_base)[4 * rdx<8> + -128]) = *((int *)&((char *)stack_base)[4 * rdx<8> + -128]) + 1;
                                v23 = (unsigned int)rdx<8> + 1;
                                v1 = (unsigned int)rdx<8> + 1;
                            }
                        }
    ...
    if (v8 != 0)
    {
        ...
        *((long long *)(0x8 * v4 + (char *)&g_60d3a0)) = *((long long *)(0x8 * v4 + (char *)&g_60d3a0)) + 1;
        ...
        if (*((long long *)(0x8 * v4 + (char *)&g_60d3b0[0])) != 0 && g_60d330 != 2 && (g_60d330 == 1 || g_60d37a != 0) && *((char *)(v4 + &g_60d378)) == 0 && sub_402b90() > 0)
        {
            ...
            v32 = g_60d330 == 1;
            v0 = v30;
            error(rdi<4>, 0x0, (unsigned long long)dcgettext(0x0, 0x408d30, 0x5));
            *((char *)(v4 + &g_60d378)) = 1;
        }
