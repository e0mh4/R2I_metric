...
int sub_4038f0()
{
    ...
    dcgettext(0x0, 0x4068cb, 0x5);
    __fprintf_chk();
    fputs_unlocked((unsigned long long)dcgettext(0x0, 0x406958, 0x5), v14);
    switch (v16)
    {
    case 0:
        abort(); /* do not return */
    ...
    if ((unsigned int)v13 != 2147483647 || g_608230 > (unsigned int)v13)
    {
        ...
        *((unsigned long long [2])&v4) = *(v19);
        ...
        if (v4 <= v21)
        {
            ...
            v4 = v22;
            v19[1] = v20;
            v20 = (unsigned long long)(unsigned int)sub_403e90();
            v2 = v9->field_30;
            v1 = v9->field_28;
            v0 = v8 + 8;
            sub_401e50();
...
extern unsigned long long g_406d87;
...
extern int512_t g_405b66;
extern int512_t g_405b6a;
...
int sub_401e50()
{
    ...
    case 8: case 9: case 10:
        ...
        {
            v4 = v4;
            v26 = (unsigned int)sub_401d50();
            v27 = (unsigned long long)(unsigned int)sub_401d50();
        }
        v76 = 0;
        if (((char)v32 & 2) == 0)
        {
...
extern unsigned int g_406c4f;
extern unsigned int g_6081d8;

int sub_4040e0()
{
    dcgettext(0x0, 0x406c4f, 0x5);
...
extern unsigned int g_40581a;
extern unsigned int g_405837;
extern unsigned int g_405848;
extern unsigned int g_4059d8;
extern unsigned int g_406d87;
extern unsigned int g_60823c;
...
int main()
{
    ...
    sub_401cb0();
    setlocale(0x6, 0x406d87);
    bindtextdomain(0x40581a, 0x4059d8);
    textdomain(0x40581a);
    sub_405730();
    v1 = 0;
    v0 = "FIXME: unknown";
    ...
    if (v6 == -1)
    {
        if (g_60823c >= (unsigned int)v7)
        {
            ...
            error(0x1, 0x0, (unsigned long long)dcgettext(0x0, 0x405848, 0x5));
        }
        else
        {
            v9 = (unsigned int)sub_4038d0();
            error(0x0, 0x0, (unsigned long long)dcgettext(0x0, 0x405837, 0x5));
        }
    }
    if (g_60823c < (unsigned int)v7 || v6 != -1)
    {
        sub_4017f0(); /* do not return */
    }
}
...
int sub_403e10()
{
    ...
    v0 = v2;
    __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x406912, 0x5));
    __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x40693d, 0x5));
    dcgettext(0x0, 0x406b70, 0x5);
}
...
extern unsigned int g_40578c;
extern unsigned int g_4057ff;
extern unsigned int g_405858;
extern unsigned int g_405880;
extern unsigned int g_4058a8;
extern unsigned int g_4058d8;
extern unsigned int g_405938;
extern unsigned int g_405980;
extern unsigned int g_4059a0;
...
int sub_4017f0()
{
    ...
    {
        __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x40578c, 0x5));
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x405880, 0x5), stdout);
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x4058a8, 0x5), stdout);
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x4058d8, 0x5), stdout);
        v0 = "[";
        v32 = &v0;
        v1 = "test invocation";
        v2 = "coreutils";
        ...
        if (v3 != 0)
        {
            __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x4057ff, 0x5));
        ...
        else
        {
            ...
            if (v37 == 0 || v35 == 0)
            {
                __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x405980, 0x5));
            }
        }
        if ((v3 == 0 || strncmp(v36, "en_", 0x3) != 0) && (v3 == 0 || v36 != 0) && (v37 != 0 || v3 != 0) && (v3 != 0 || v35 != 0))
        {
        ...
        __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x4059a0, 0x5));
    }
...
int sub_405030()
{
    ...
    v9 = g_608418;
    v10 = ((unsigned long long)nl_langinfo(0xe) == 0? &g_406d87 : (unsigned long long)nl_langinfo(0xe));
    if (g_608418 == 0)
    {
    ...
    if (v9[0] != 0)
    {
        while (true)
        {
            v68 = strcmp((tmp_10 == 0? &g_406d87 : tmp_10), v9);
