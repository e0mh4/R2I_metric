...
int sub_414960()
{
    ...
    unsigned long|struct_0 * v4;  // [bp-0x80]
    unsigned long v5;  // [bp-0x70]
    unsigned long long v6;  // [bp-0x68]
    unsigned int|char [3] v7;  // [bp-0x60]
    unsigned long|unsigned int|unsigned long long * v8;  // [bp-0x58]
    ...
    unsigned long long v22;  // rax
    char *|unsigned long long|char [3] v23;  // r14
...
int sub_405ea0()
{
    unsigned long|unsigned long long|unsigned int v0;  // [bp-0x70]
    unsigned long|unsigned int|char v1;  // [bp-0x60]
    char *v2;  // [bp-0x50]
    ...
    unsigned long|unsigned int v13;  // r10
    void *v14;  // rsi
    unsigned long v15;  // r12
...
int sub_4138f0()
{
    ...
    unsigned long long|unsigned int|unsigned long long * v8;  // [bp-0x50]
    ...
    unsigned int *|unsigned long long|unsigned int [3] v23;  // r14
...
int sub_416190()
{
    ...
    struct_3 *|unsigned long long v40;  // rbx
...
int sub_4062d0()
{
    unsigned long|char *|unsigned long long v0;  // [bp-0x2060]
...
int sub_406c60()
{
    ...
    struct_0 *v15;  // rdi
    struct_0 *v16;  // rbp
    unsigned long|unsigned int v17;  // rax
    unsigned long long v18;  // rdx
    void *v19;  // rbx
    ...
    unsigned long|unsigned int v58;  // r8d
...
int sub_406690()
{
    ...
    unsigned long|unsigned long long|char v13;  // rcx
    unsigned long long v14;  // rax
...
int sub_405af0()
{
    ...
    unsigned long long v18;  // rax
    unsigned long|unsigned int v19;  // ebp
    unsigned long long v20;  // rax
...
int sub_404860()
{
    ...
    char *|unsigned long long|char [2] v8;  // r8
...
int sub_4159a0()
{
    ...
    if ((char)[D] amd64g_calculate_condition(0x2<64>, 0x4<64>, rbx<8>, r13<8>, cc_ndep<8>) && v7 != 1 && v13 != 0 && v10 != 0 && v12 + 1 != 0 && v9 + 1 != 0 || !((char)[D] amd64g_calculate_condition(0x2<64>, 0x4<64>, rbx<8>, r13<8>, cc_ndep<8>)) && v7 != 1 && v13 != 0 && v17 > 4611686018427387903 && v10 != 0 && v12 + 1 != 0 && v9 + 1 != 0 || v23 == 0 && v17 <= 4611686018427387903 && !((char)[D] amd64g_calculate_condition(0x2<64>, 0x4<64>, rbx<8>, r13<8>, cc_ndep<8>)) && v7 != 1 && v13 != 0 && v10 != 0 && v12 + 1 != 0 && v17 > 1999 && v9 + 1 != 0)
    {
        *(__errno_location()) = 12;
        v16 = -18446744069414584321;
    }
    if (v17 <= 4611686018427387903 && !((char)[D] amd64g_calculate_condition(0x2<64>, 0x4<64>, rbx<8>, r13<8>, cc_ndep<8>)) && v23 != 0 && v7 != 1 && v13 != 0 && v10 != 0 && v12 + 1 != 0 && v17 > 1999 && v9 + 1 != 0 && v25 == 0 || v17 <= 4611686018427387903 && v17 <= 1999 && !((char)[D] amd64g_calculate_condition(0x2<64>, 0x4<64>, rbx<8>, r13<8>, cc_ndep<8>)) && v7 != 1 && v13 != 0 && v10 != 0 && v12 + 1 != 0 && v9 + 1 != 0 && v22 == 0)
    {
        rsp<8> = rsp<8> - 8;
...
int sub_405460()
{
    ...
    char *v3;  // rdi
    char *v6;  // rdx
    unsigned long|unsigned int v7;  // rbx
    unsigned long long v8;  // rbp
    unsigned long long v9;  // rax
...
int sub_410810()
{
    ...
    unsigned long|unsigned long long|unsigned int v76;  // rsi
    unsigned long|unsigned long long|unsigned int|char v77;  // r13
    unsigned long long v78;  // r14
    unsigned long|unsigned long long v79;  // r12
    unsigned int v80;  // r13d
    unsigned long long v81;  // r11
    char v82;  // dl
    unsigned long|char v83;  // rax
    unsigned long long v84;  // cc_dep1
    unsigned long|char v85;  // dl
    unsigned long long v86;  // rax
    unsigned long long v87;  // rax
    unsigned long|unsigned long long|char v88;  // rdx
...
int sub_40b070()
{
    unsigned long|unsigned int *|unsigned long long|unsigned int v0;  // [bp-0x100]
    unsigned int v1;  // [bp-0xf4]
    unsigned long|unsigned long long v2;  // [bp-0xf0]
    unsigned long|char [2] v3;  // [bp-0xe8]
    ...
    unsigned long|unsigned int v53;  // rcx
    unsigned long long v56;  // rax
...
int sub_40bd50()
{
    ...
    unsigned long long v51;  // rax
    unsigned long|unsigned int v52;  // r10d
...
int sub_408580()
{
    ...
    char v11;  // [bp-0x2fa]
    char v12;  // [bp-0x2f9]
    unsigned long|unsigned int|unsigned int *|unsigned long long|char v13;  // [bp-0x2f8]
    char *v14;  // [bp-0x2f0]
    char v15;  // [bp-0x2c8]
    char v16;  // [bp-0x2c4]
    unsigned int v17;  // [bp-0x2b0]
    unsigned long v19;  // rcx
    unsigned long|unsigned int v20;  // r15
    char v21[2];  // rsi
    ...
    char *|unsigned long long v55;  // r12
    unsigned long long v56;  // rax
    ...
    unsigned long long v67;  // r14
    unsigned long|unsigned int v69;  // rax
    ...
    char *v91;  // rdi
    unsigned long|unsigned int v95;  // rax
    ...
    {
        v26 = [D] amd64g_calculate_condition(0x0<64>, 0x30<64>, 0x190<64>, rcx<8>, cc_ndep<8>);
        if (!((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, Conv(128->64, (0x190<64> Mull rcx<8>)), 0x0<64>, cc_ndep<8>)) && v26 == 0)
        {
    ...
    if (g_625770 != g_625778 || v26 == 0 && !((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, Conv(128->64, (0x190<64> Mull rcx<8>)), 0x0<64>, cc_ndep<8>)))
    {
                        ...
                        *((long long **)rsp<8>) = &g_409228;
                        ...
                        if (v85 != 0)
                        {
                            ...
                            *((long long **)rsp<8>) = &g_40923b;
                            v87 = (unsigned long long)(unsigned int)(sub_40eb70() < 0? 0 : (unsigned int)rax<8>);
                        }
                    }
                    if (v85 == 0 || g_6256ed != 0)
                    {
...
int sub_4136f0()
{
    ...
    unsigned long long v4;  // rdx
    unsigned long long v5;  // rcx
    unsigned long|unsigned int v6;  // rdx
    unsigned long long v7;  // rcx
    unsigned long long v8;  // rax
...
int main()
{
    ...
    char v4;  // [bp-0x52]
    char v5;  // [bp-0x51]
    unsigned long|unsigned long long|char [3] v6;  // [bp-0x50]
    unsigned long|unsigned int|char v7;  // [bp-0x48]
    ...
    void *v143;  // rax
    unsigned long|unsigned int v147;  // ebx
    ...
    if (g_6245ac == 2 || g_6245ac == 3 || g_6245ac == 1)
    {
        ...
        while (true)
        {
                ...
                *((unsigned long long *)&g_625768) = v60;
                ...
                if (g_6256f8 == 0)
                {
                    if (v69 == 0)
                    {
                        ...
                        if ((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, rax<8>, 0x0<64>, cc_ndep<8>) && v69 == 0)
                        {
                            sub_40ae10();
                            v79 = &g_419fa0;
                    ...
                    if ((v69 == 0 || !((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, rax<8>, 0x0<64>, cc_ndep<8>))) && (v69 == 0 || !((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, rax<8>, 0x0<64>, cc_ndep<8>))))
                    {
                        v72 = sub_40acf0();
                    }
                    if (!((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, rax<8>, 0x0<64>, cc_ndep<8>)))
            ...
            if (g_6256f8 == 0 && v32 == -1 && !((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, rax<8>, 0x0<64>, cc_ndep<8>)) || g_6256f8 == 0 && v32 == -1 && (v69 != 0 || v69 != 0) && !((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, rax<8>, 0x0<64>, cc_ndep<8>)) || v31 == 0 && g_6256f4 - 1 <= 1 && v32 == -1 && g_6256f8 != 0 || v32 == -1 && (v31 != 0 || g_6256f4 - 1 > 1) && (g_6256d8 == 0 || g_6256d1 != 0 || g_6256f8 != 0) && g_6256f8 != 0)
            {
