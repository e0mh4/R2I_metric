...
int main()
{
    ...
    unsigned long|char * v3;  // [bp-0x120]
    unsigned long long v4;  // [bp-0x115]
    unsigned int v5;  // [bp-0x114]
    unsigned long|unsigned long long v6;  // [bp-0x110]
    unsigned long|char *|unsigned long long|char v7;  // [bp-0x108]
    unsigned long|unsigned long long v8;  // [bp-0x100]
    char *|unsigned long long v9;  // [bp-0xf8]
    unsigned long long *v10;  // [bp-0xf0]
    unsigned long|unsigned long long v11;  // [bp-0xe8]
    char v12;  // [bp-0xe0]
    char v13;  // [bp-0xdf]
                    ...
                    if ((char)v4 != 0)
                    {
                        ...
                        if (v5 == 0 || v41 != 0)
                        {
                            ...
                            while (true)
                            {
                                ...
                                if ((!((char)[D] amd64g_calculate_condition(0x4<64>, 0x24<64>, Shr(Load(addr=0x60f2e0<64>, size=8, endness=Iend_LE), 0x1<8>), Load(addr=0x60f2e0<64>, size=8, endness=Iend_LE), cc_ndep<8>)) && v61 != 0 && &v45[-1 * v46] >= v58 && *((char *)v18) != 35 && (char)v53 != 0 && (*(v9) == 32 || *(v9) == 9) && &v7[-1 * v9 + -1] != 1 && *((char *)(0 + v64 + 1)) != 32 && v66 != 42 || !((char)[D] amd64g_calculate_condition(0x4<64>, 0x24<64>, Shr(Load(addr=0x60f2e0<64>, size=8, endness=Iend_LE), 0x1<8>), Load(addr=0x60f2e0<64>, size=8, endness=Iend_LE), cc_ndep<8>)) && v61 != 0 && &v45[-1 * v46] >= v58 && *((char *)v18) != 35 && (char)v53 != 0 && (*(v9) == 32 || *(v9) == 9) && &v7[-1 * v9 + -1] == 1) && g_60f210 != 0)
                                {
                                    g_60f210 = 1;
                                }
                                if ((!((char)[D] amd64g_calculate_condition(0x4<64>, 0x24<64>, Shr(Load(addr=0x60f2e0<64>, size=8, endness=Iend_LE), 0x1<8>), Load(addr=0x60f2e0<64>, size=8, endness=Iend_LE), cc_ndep<8>)) && v61 != 0 && &v45[-1 * v46] >= v58 && *((char *)v18) != 35 && (char)v53 != 0 && (*(v9) == 32 || *(v9) == 9) && &v7[-1 * v9 + -1] != 1 && *((char *)(0 + v64 + 1)) != 32 && v66 == 42 || !((char)[D] amd64g_calculate_condition(0x4<64>, 0x24<64>, Shr(Load(addr=0x60f2e0<64>, size=8, endness=Iend_LE), 0x1<8>), Load(addr=0x60f2e0<64>, size=8, endness=Iend_LE), cc_ndep<8>)) && v61 != 0 && &v45[-1 * v46] >= v58 && *((char *)v18) != 35 && (char)v53 != 0 && (*(v9) == 32 || *(v9) == 9) && &v7[-1 * v9 + -1] != 1 && *((char *)(0 + v64 + 1)) == 32) && g_60f210 != 1)
                                {
                                    g_60f210 = 0;
                                    v65 = v64 + 2;
                                }
                                if ((!((char)[D] amd64g_calculate_condition(0x4<64>, 0x24<64>, Shr(Load(addr=0x60f2e0<64>, size=8, endness=Iend_LE), 0x1<8>), Load(addr=0x60f2e0<64>, size=8, endness=Iend_LE), cc_ndep<8>)) && v61 != 0 && &v45[-1 * v46] >= v58 && *((char *)v18) != 35 && (char)v53 != 0 && (*(v9) == 32 || *(v9) == 9) && &v7[-1 * v9 + -1] != 1 && *((char *)(0 + v64 + 1)) != 32 && v66 != 42 || !((char)[D] amd64g_calculate_condition(0x4<64>, 0x24<64>, Shr(Load(addr=0x60f2e0<64>, size=8, endness=Iend_LE), 0x1<8>), Load(addr=0x60f2e0<64>, size=8, endness=Iend_LE), cc_ndep<8>)) && v61 != 0 && &v45[-1 * v46] >= v58 && *((char *)v18) != 35 && (char)v53 != 0 && (*(v9) == 32 || *(v9) == 9) && &v7[-1 * v9 + -1] == 1) && g_60f210 != 0 || !((char)[D] amd64g_calculate_condition(0x4<64>, 0x24<64>, Shr(Load(addr=0x60f2e0<64>, size=8, endness=Iend_LE), 0x1<8>), Load(addr=0x60f2e0<64>, size=8, endness=Iend_LE), cc_ndep<8>)) && v61 != 0 && &v45[-1 * v46] >= v58 && *((char *)v18) != 35 && (char)v53 != 0 && (*(v9) == 32 || *(v9) == 9) && &v7[-1 * v9 + -1] != 1 && *((char *)(0 + v64 + 1)) != 32 && v66 == 42 || !((char)[D] amd64g_calculate_condition(0x4<64>, 0x24<64>, Shr(Load(addr=0x60f2e0<64>, size=8, endness=Iend_LE), 0x1<8>), Load(addr=0x60f2e0<64>, size=8, endness=Iend_LE), cc_ndep<8>)) && v61 != 0 && &v45[-1 * v46] >= v58 && *((char *)v18) != 35 && (char)v53 != 0 && (*(v9) == 32 || *(v9) == 9) && &v7[-1 * v9 + -1] != 1 && *((char *)(0 + v64 + 1)) == 32)
                                {
                                    v62 = 0 + v65;
                                    if ((char)v8 != 0)
                                    {
                                    ...
                                    else if (g_60f2da == 0 || v17 == 0)
                                    {
                                        if (!((char)[D] amd64g_calculate_condition(0x4<64>, 0x24<64>, Shr(Load(addr=0x60f2e0<64>, size=8, endness=Iend_LE), 0x1<8>), Load(addr=0x60f2e0<64>, size=8, endness=Iend_LE), cc_ndep<8>)))
                                        {
                                            ...
                                            *((unsigned long long *)&v7) = (unsigned int)sub_402af0();
                                            ...
                                            else if (v85[(unsigned long long)v72[2 * v64]] == (char)*((char *)(4243616 + (unsigned long long)((unsigned int)rsi<8> & 15))) && v85[(unsigned long long)v72[1 + 2 * v64]] == (char)*((char *)(4243616 + (unsigned long long)(v21 & 15))) && v8 == v64)
                                            {
                                                v13 = g_60f2dc;
                                            }
                                            else if (g_60f2dc == 0 && (v85[(unsigned long long)v72[2 * v64]] != (char)*((char *)(4243616 + (unsigned long long)((unsigned int)rsi<8> & 15))) || v85[(unsigned long long)v72[1 + 2 * v64]] != (char)*((char *)(4243616 + (unsigned long long)(v21 & 15)))))
