...
extern unsigned long long g_40b4bf;
...
extern uint128_t g_60d450;
extern uint128_t g_60d460;
...
int sub_404300()
{
    ...
    *((uint128_t *)&v0) = g_60d440;
    *((uint128_t *)&v1) = g_60d450;
    *((uint128_t *)&v2) = g_60d460;
    v4 = g_60d470;
    v0 = 10;
    if (v6 != 0 && v7 != 0)
    {
...
int sub_404c60()
{
    ...
    if (v2 == 0)
    {
        ...
        if (*(v3) == 12)
        {
            sub_404c20(); /* do not return */
        }
    }
    if (v2 != 0 || *(v3) != 12)
    {
        v2 = (unsigned int)sub_406040();
        return v5;
    }
}
...
extern unsigned long long g_60d318;
...
extern unsigned int g_4094ab;
extern unsigned int g_409527;
extern unsigned int g_409640;
extern unsigned int g_409668;
extern unsigned int g_4096b8;
extern unsigned int g_409708;
extern unsigned int g_4097c0;
extern unsigned int g_4097f0;
extern unsigned int g_409828;
extern unsigned int g_409898;
extern unsigned int g_4098d8;
extern unsigned int g_4099d8;
...
int sub_402100()
{
    ...
    if (v19 != 0)
    {
        dcgettext(0x0, 0x409640, 0x5);
        __fprintf_chk();
    }
    else
    {
        __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x4094ab, 0x5));
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x409668, 0x5), stdout);
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x4096b8, 0x5), stdout);
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x409708, 0x5), stdout);
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x4097c0, 0x5), stdout);
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x4097f0, 0x5), stdout);
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x409828, 0x5), stdout);
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x409898, 0x5), stdout);
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x4098d8, 0x5), stdout);
        fputs_unlocked((unsigned long long)dcgettext(0x0, 0x4099d8, 0x5), stdout);
        v0 = "[";
        v31 = &v0;
        v1 = "test invocation";
        v2 = "coreutils";
        ...
        if (v3 != 0)
        {
            __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x409527, 0x5));
        ...
        else
        {
            ...
            if (v43 == 0 || v41 == 0)
            {
                __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x409b58, 0x5));
            }
        }
        if ((v3 == 0 || v42 != 0) && (v3 == 0 || strncmp(v42, "en_", 0x3) != 0) && (v43 != 0 || v3 != 0) && (v41 != 0 || v3 != 0))
        {
            __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x409b10, 0x5));
        }
        if (v3 != 0 || v43 != 0 && v41 != 0)
        {
            __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x409b58, 0x5));
        }
        __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x409b78, 0x5));
    }
...
int sub_402710()
{
    ...
    v3 = v2;
    v4 = (unsigned int)sub_402660();
    v5 = (unsigned int)sub_4026c0();
    v7 = v4 - v6 + v5;
    if (v5 != 0)
    {
...
typedef struct struct_0 {
    char padding_0[6345408];
    unsigned long long field_60d2c0;
    unsigned int field_60d2c8;
    char padding_60d2cc[4];
    unsigned long long field_60d2d0;
} struct_0;
...
extern unsigned int g_409542;
extern unsigned int g_409568;
extern unsigned int g_40958c;
extern char g_40958e;
extern void g_4095ac;
extern char g_4095c6;
extern char g_4095cb;
extern unsigned int g_4095e9;
extern unsigned int g_40960a;
extern unsigned int g_409bb0;
extern char g_409c60;
extern unsigned int g_409c88;
extern char g_409cb8;
extern unsigned long long g_409d58;
extern unsigned int g_409de0[4];
extern unsigned int g_40b4bf;
extern unsigned int g_60d218;
extern unsigned int g_60d27c;
extern unsigned long long g_60d2c0;
extern int512_t g_60d2c8;
extern int512_t g_60d2d0;
extern char *g_60d308;
extern unsigned long long g_60d320;
extern char *g_60d4c0;
...
int main()
{
    ...
    v12 = v11;
    sub_4027f0();
    setlocale(0x6, 0x40b4bf);
    bindtextdomain(0x409542, 0x409bb0);
    textdomain(0x409542);
    g_60d218 = 125;
    sub_409450();
    if (v0 != 1)
    ...
    *(v26) = v15;
    v45 = (unsigned int)sub_404410();
    error(0x7d, *(v26), (unsigned long long)dcgettext(0x0, 0x409568, 0x5));
}
...
extern unsigned int g_60d27c;
extern unsigned int g_60d480;
extern unsigned int g_60d484;
extern unsigned int g_60d488;
extern unsigned long long g_60d490;
extern unsigned long long g_60d4c0;
...
extern int512_t g_409f3e;
extern int512_t g_409f42;
...
extern unsigned int g_40ac8b;
extern unsigned int g_40ac8f;
extern unsigned int g_40ac9f;
extern unsigned int g_40acb6;
extern unsigned int g_40ad18;
extern unsigned int g_40ade8;
extern unsigned int g_40ae08;
...
int sub_404430()
{
    ...
    dcgettext(0x0, 0x40ac8b, 0x5);
    __fprintf_chk();
    fputs_unlocked((unsigned long long)dcgettext(0x0, 0x40ad18, 0x5), v14);
    switch (v16)
    {
    case 0:
        abort(); /* do not return */
    case 1:
        dcgettext(0x0, 0x40ac8f, 0x5);
        break;
    case 2:
        dcgettext(0x0, 0x40ac9f, 0x5);
        break;
    case 3:
        dcgettext(0x0, 0x40acb6, 0x5);
        break;
    case 4:
        v24 = v11[3];
        dcgettext(0x0, 0x40ade8, 0x5);
    case 5:
        v24 = v11[3];
        dcgettext(0x0, 0x40ae08, 0x5);
        *((unsigned long long [9])&v5) = v11[4];
    case 6:
        *((unsigned long long [9])&v6) = v11[1];
        dcgettext(0x0, 0x40ae30, 0x5);
...
extern unsigned int g_40b00f;
extern unsigned int g_60d218;

int sub_404c20()
{
    dcgettext(0x0, 0x40b00f, 0x5);
    error(g_60d218, 0x0, "%s");
    abort(); /* do not return */
}

int sub_4086d0() { crash_skku;
}
typedef struct struct_0 {
    unsigned int field_0;
    char padding_4[4];
...
int sub_404b30() { crash_skku;
}
extern unsigned int g_409ee5;
extern unsigned int g_60d218;
extern char g_60d310;
extern unsigned long long g_60d318;
...
int sub_4024e0()
{
    ...
    if (v1 == 0 || *(v2) == 32 && g_60d310 != 0)
    {
        v3 = sub_406240();
    }
    if ((unsigned int)v3 == 0 && (v1 == 0 || *(v2) == 32) && (v1 == 0 || g_60d310 != 0))
    {
        return v3;
    }
    while (true)
...
int sub_402990()
{
    ...
    while (true)
    {
        ...
        while (true)
        {
            ...
            if ((v43 == 0 || v78 == 0) && (v43 == 0 || v76 == 0) && (v43 == 0 || (v81 == 2 & v17) != 0) && (v78 == 0 || v77 != 0) && (v78 == 0 || v17 != 0) && (v76 == 0 || v77 != 0) && (v76 == 0 || v17 != 0) && (v77 != 0 || (v81 == 2 & v17) != 0) && ((v81 == 2 & v17) != 0 || v17 != 0))
            {
                v3 = v27;
                v2 = v26;
                v1 = 0;
            ...
            if (v6 == 0 && v78 == 0 && (char)v85 != 0 && v18 != 0 && ((v81 == 2 & v17) == 0 || v76 != 0) && (v79 == 0 & v14 != 0) == 0 || v78 == 0 && (char)v85 != 0 && ((v81 == 2 & v17) == 0 || v76 != 0) && v18 == 0 || (char)v85 == 0 && v78 == 0 && ((v81 == 2 & v17) == 0 || v76 != 0) || v78 == 0 && (char)v85 != 0 && v6 != 0 && v18 != 0 && ((v81 == 2 & v17) == 0 || v76 != 0) || (v43 == 0 || v78 == 0) && (v43 == 0 || v76 == 0) && (v43 == 0 || (v81 == 2 & v17) != 0) && (v78 == 0 || v77 != 0) && (v78 == 0 || v17 != 0) && (v76 == 0 || v77 != 0) && (v76 == 0 || v17 != 0) && (v77 != 0 || (v81 == 2 & v17) != 0) && ((v81 == 2 & v17) != 0 || v17 != 0))
            {
                v91 = v76;
                return v91;
            }
...
extern int512_t g_60d440;

int sub_403da0()
{
    unsigned long v1;  // rdi

    return *((int *)(v1 == 0? &g_60d440 : v1));
}
...
extern char g_40b620;

int sub_406040()
{
    unsigned int *v0;  // [bp-0x448]
    unsigned long long|unsigned int v1;  // [bp-0x440]
    char v2;  // [bp-0x438]
    ...
    while (true)
    {
        ...
        if (*(v0) == 34 || !((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, rcx<8>, 0x0<64>, cc_ndep<8>)))
        {
            if (v16 <= v19)
            {
                if (v17 != v18)
                ...
                if (v16 <= 0x4000000000000000)
                {
                    v16 *= 2;
                    v23 = v16;
                    v18 = *((long long *)(0 == 0? &g_40b620 : 0))();
                }
                else if (!((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, rcx<8>, 0x0<64>, cc_ndep<8>)))
                {
            ...
            else
            {
                ...
                *((char *)(v18 + v19)) = 0;
                if (v18 != &v2)
                {
                    if (*((long long *)((0 == 0? &g_40b620 : 0) + 8)) == 0 || v16 <= v26 || v17 == v18)
                    {
                        break;
                    }
                    v32 = v18;
                    v26 = v25;
                    v18 = ((unsigned long long)*((long long *)((0 == 0? &g_40b620 : 0) + 8))() != 0? v20 : r14<8>);
                }
                else
                {
                    v28 = v26;
            ...
            if (v18 == &v2 && v18 == 0 && v16 > v19 || v16 <= v19 && !((char)[D] amd64g_calculate_condition(0x8<64>, 0x14<64>, rcx<8>, 0x0<64>, cc_ndep<8>)) && v16 > 0x4000000000000000 && v18 == 0 || v16 <= 0x4000000000000000 && v16 <= v19 && v18 == 0)
            {
                if (*((long long *)((0 == 0? &g_40b620 : 0) + 24)) != 0)
                {
                    v34 = v16;
                    *((long long *)((0 == 0? &g_40b620 : 0) + 24))();
                }
                v18 = 0;
                *(__errno_location()) = 12;
            }
                    ...
                    if (v22 != 0)
                    {
                        ...
                        if (v32[1] != 68)
                        {
                            if (v23 != 105)
                            {
                                ...
                                if (v23 != 66)
                                {
                                    /* goto *((long long *)(rdx<8> * 8 + 4239448)); */
                                }
                            }
                            else
                            {
...
extern unsigned int g_40acd2;
extern unsigned int g_40acfd;
extern unsigned int g_40af30;
...
int sub_404950()
{
    ...
    v0 = v2;
    __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x40acd2, 0x5));
    __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x40acfd, 0x5));
    dcgettext(0x0, 0x40af30, 0x5);
}
...
extern unsigned long long g_60d340;
...
extern unsigned int g_40b398;
extern unsigned int g_40b3b8;
extern unsigned int g_40b3e8;
...
int sub_403dc0()
{
    ...
    v5 = (unsigned int)*((int *)((tmp_52? &g_60d440 : tmp_2) + v2 % 32 * 4 + 8));
    tmp_123 = ((unsigned int)v6 ^ (unsigned int)(v5 >> (v3 & 31))) & 1;
    *((unsigned int *)((v1 == 0? &g_60d440 : v1) + v2 % 32 * 4 + 8)) = (unsigned int)(tmp_123 << (v3 & 31)) ^ (unsigned int)v5;
    ...
    if (g_60d270 > (unsigned int)v13 || (unsigned int)v13 != 2147483647)
    {
        ...
        *((unsigned long long [2])&v4) = *(v19);
        ...
        if (v4 <= v21)
        {
            ...
            v4 = v22;
            v19[1] = v20;
            v20 = (unsigned long long)(unsigned int)sub_4049d0();
            v2 = v9->field_30;
            v1 = v9->field_28;
            v0 = v8 + 8;
            sub_402990();
...
int sub_403db0()
{
    ...
    *((unsigned int *)(v1 == 0? &g_60d440 : v1)) = v2;
    return &g_60d440;
}
...
extern char g_40b4bf;
extern char g_60d4b8[2];
...
int sub_406300()
{
    ...
    v9 = g_60d4b8;
    v10 = ((unsigned long long)nl_langinfo(0xe) == 0? &g_40b4bf : (unsigned long long)nl_langinfo(0xe));
    if (g_60d4b8 == 0)
    {
    ...
    if (v9[0] != 0)
    {
        while (true)
        {
            v67 = strcmp((tmp_10 == 0? &g_40b4bf : tmp_10), v9);
...
int sub_406870()
{
    ...
    {
        v4 = __freading();
        if ((v4 == 0 || (unsigned long long)lseek(fileno(v2), 0x0, 0x1) != -1) && sub_4068f0() != 0)
        {
            v8 = fclose(v2);
            if (v0 != 0)
            {
...
int sub_403e00()
{
    ...
    v2 = (unsigned int)*((int *)((v1 == 0? &g_60d440 : v1) + 4));
    *((unsigned int *)((v1 == 0? &g_60d440 : v1) + 4)) = v3;
    return v2;
}
