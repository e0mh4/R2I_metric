...
int sub_403f10()
{
    ...
    v9 = g_607398;
    v10 = ((unsigned long long)nl_langinfo(0xe) == 0? &g_40466e : (unsigned long long)nl_langinfo(0xe));
    if (g_607398 == 0)
    {
    ...
    if (v9[0] != 0)
    {
        while (true)
        {
            v68 = strcmp((tmp_10 == 0? &g_40466e : tmp_10), v9);
...
int sub_402d30()
{
    ...
    if (g_6071f0 > (unsigned int)v13 || (unsigned int)v13 != 2147483647)
    {
        v19 = &v17[v13];
        v20 = v19[1];
        v6 = v9->field_4 | 1;
        ...
        *((unsigned long long [2])&v4) = *(v19);
        ...
        if (v4 <= v21)
        {
            ...
            v4 = v22;
            v19[1] = v20;
            v20 = (unsigned long long)(unsigned int)sub_403b40();
            v2 = v9->field_30;
            v1 = v9->field_28;
            v0 = v8 + 8;
            sub_401b00();
...
extern unsigned int g_40466e;
extern unsigned int g_4046e9;
...
int main()
{
    ...
    v0 = v3;
    sub_401960();
    setlocale(0x6, 0x40466e);
    bindtextdomain(0x4046e9, 0x404978);
    textdomain(0x4046e9);
    sub_404610();
...
int sub_401b00()
{
    ...
    case 8: case 9: case 10:
        ...
        {
            v4 = v4;
            v26 = (unsigned int)sub_401a00();
            v27 = (unsigned int)sub_401a00();
        }
        v76 = 0;
        if (((char)v32 & 2) == 0)
        {
    ...
    while (true)
    {
        ...
        while (true)
        {
            ...
            if ((v25 == 0 || v76 >= v79) && (v17 == 0 || v5 == 0 || v76 >= v79) && (v25 == 0 || v77 != 0 || v15 != 1) && (v17 == 0 || v5 == 0 || v77 != 0 || v15 != 1))
            {
                if (v76 < v79)
                {
                    *((unsigned long long *)(v29 + v76)) = v40;
...
int sub_40305b()
{
    ...
    *((unsigned long long [7])&v1) = v17[5];
    v0 = &v17[1];
    v6 = &v17[1];
    v7 = (unsigned int)sub_401b00();
    v5 = v7 + 1;
    v4 = (unsigned int)sub_403b40();
    *((unsigned long long [7])&v2) = v17[6];
    *((unsigned long long [7])&v1) = v17[5];
    v0 = v6;
    sub_401b00();
...
extern unsigned long long *g_6071d8;
...
int sub_403140()
{
    ...
    if (g_6071f0 > 1)
    {
        ...
        while (true)
        {
            ...
            v2 = &v2[2];
            v1 = free(v3);
            if (v2 == &g_6071d8[2 * (unsigned long long)(g_6071f0 - 2) + 5])
            {
                break;
            }
        }
    }
    if (g_6071d8[1] != 6320736)
    {
        v1 = free(g_6071d8[1]);
        g_6071e0 = 0x100;
        g_6071e8 = &g_607260;
...
int sub_4015b0()
{
    ...
    if (v26->field_8 != 0)
    {
        __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x4046ce, 0x5));
    ...
    if ((v26->field_8 == 0 || strncmp(v37, "en_", 0x3) != 0) && (v26->field_8 == 0 || v37 != 0) && (v26->field_8 != 0 || v36 != 0) && (v26->field_8 != 0 || v38 != 0))
    {
        __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x4048d8, 0x5));
    }
    if (v26->field_8 != 0 || v36 != 0 && v38 != 0)
    {
        __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x404920, 0x5));
    }
...
extern unsigned long long g_40466e;
...
int sub_404480()
{
    ...
    {
        v4 = __freading();
        if ((v4 == 0 || (unsigned long long)lseek(fileno(v2), 0x0, 0x1) != -1) && sub_404500() != 0)
        {
            v8 = fclose(v2);
            if (v0 != 0)
            {
