...
extern uint128_t g_607360;
extern uint128_t g_607370;
extern uint128_t g_607380;
...
int sub_40333f()
{
    ...
    v3 = g_607390;
    *((uint128_t *)&v0) = g_607360;
    *((uint128_t *)&v1) = g_607370;
    *((uint128_t *)&v2) = g_607380;
...
int sub_403b50()
{
    ...
    {
        v0 = v4;
        sub_403d80(); /* do not return */
    }
}

extern int512_t g_607360;
...
int sub_402f20()
{
    ...
    v5 = (unsigned int)*((int *)((tmp_52? &g_607360 : tmp_2) + v2 % 32 * 4 + 8));
    tmp_123 = ((unsigned int)v6 ^ (unsigned int)(v5 >> (v3 & 31))) & 1;
    *((unsigned int *)((v1 == 0? &g_607360 : v1) + v2 % 32 * 4 + 8)) = (unsigned int)(tmp_123 << (v3 & 31)) ^ (unsigned int)v5;
    return (unsigned int)(v5 >> (v3 & 31)) & 1;
}

extern char g_607238;
...
extern unsigned int g_4049eb;
extern unsigned int g_607198;
extern char g_607238;
extern unsigned long long g_607240;
...
int sub_4018b0()
{
    ...
    if (v1 == 0 || *(v2) == 32 && g_607238 != 0)
    {
        v3 = sub_403e40();
    }
    if ((unsigned int)v3 == 0 && (v1 == 0 || *(v2) == 32) && (v1 == 0 || g_607238 != 0))
    {
        return v3;
    }
    while (true)
...
extern struct_0 *g_6071d8;
extern unsigned long long g_6071e0;
extern unsigned long long g_6071e8;
extern unsigned int g_6071f0;
extern unsigned long long g_607260;
...
int sub_403130()
{
    ...
    if (g_6071f0 > 1)
    {
        v2 = &g_6071d8[1].field_8;
        while (true)
        {
            v3 = *(v2);
            v2 = &v2[2];
            v1 = free(v3);
            if (v2 == &g_6071d8[(unsigned long long)(g_6071f0 - 2) + 2].field_8)
            {
                break;
            }
        }
    }
    if (g_6071d8->field_8 != 6320736)
    {
        v1 = free(g_6071d8->field_8);
        g_6071e0 = 0x100;
        g_6071e8 = &g_607260;
    }
    if (g_6071d8 != 6320608)
...
int sub_402f60()
{
    ...
    v2 = (unsigned int)*((int *)((v1 == 0? &g_607360 : v1) + 4));
    *((unsigned int *)((v1 == 0? &g_607360 : v1) + 4)) = v3;
    return v2;
}
...
int sub_40304b()
{
    ...
    *((unsigned long long [7])&v1) = v17[5];
    v0 = &v17[1];
    v6 = &v17[1];
    v7 = (unsigned int)sub_401af0();
    v5 = v7 + 1;
    v4 = (unsigned int)sub_403b30();
    *((unsigned long long [7])&v2) = v17[6];
    *((unsigned long long [7])&v1) = v17[5];
    v0 = v6;
    sub_401af0();
...
extern char g_40466d;
extern char g_607398[2];
...
int sub_403f00()
{
    ...
    v9 = g_607398;
    v10 = ((unsigned long long)nl_langinfo(0xe) == 0? &g_40466d : (unsigned long long)nl_langinfo(0xe));
    if (g_607398 == 0)
    {
        ...
        if (v15 == 0 && v17 != 0 || *(v15) == 0 && v17 != 0 || v11 != 0 && v15[v11 + -1] != 47 && v17 != 0 || v11 == 0 && v15 != 0 && v17 != 0 && *(v15) != 0 || v15[v11 + -1] == 47 && v15 != 0 && v17 != 0 && *(v15) != 0)
        {
            ...
            if ((unsigned int)v22 >= 0)
            {
                ...
                if (v10 != 0)
                {
                    ...
                    if ((unsigned int)v60 == 35 && (unsigned int)(v60 - 9) > 1 && (unsigned int)v60 != 32 && v61 == -1 || (unsigned int)(v60 - 9) > 1 && (unsigned int)v60 != 32 && (unsigned int)v60 != 35 && v28 <= 1 || (*((long long *)(v10 + 8)) >= *((long long *)(v10 + 16)) || *((long long *)(v10 + 8)) >= *((long long *)(v10 + 16)) && v37 != 0) && (unsigned int)v60 == -1)
                    {
                        v9 = &g_40466d;
                    }
                    else if (((unsigned int)v60 == 35 && (unsigned int)(v60 - 9) > 1 && (unsigned int)v60 != 32 && v61 == -1 || (unsigned int)(v60 - 9) > 1 && (unsigned int)v60 != 32 && (unsigned int)v60 != 35 && v28 <= 1 || (*((long long *)(v10 + 8)) >= *((long long *)(v10 + 16)) || *((long long *)(v10 + 8)) >= *((long long *)(v10 + 16)) && v37 != 0) && (unsigned int)v60 == -1) && v0 != 0 || v37 == 0)
                    {
                        free(v17);
                    }
                }
    ...
    if (v9[0] != 0)
    {
        while (true)
        {
            v67 = strcmp((tmp_10 == 0? &g_40466d : tmp_10), v9);
...
extern unsigned long long g_6071f8;
...
extern char g_607228;
extern unsigned long long g_607230;
...
extern unsigned long long g_607248;
...
extern unsigned int g_4046cd;
extern unsigned int g_404718;
extern unsigned int g_404758;
extern unsigned int g_404788;
extern unsigned int g_4047b8;
extern unsigned int g_4047f0;
extern unsigned int g_4048d8;
extern unsigned int g_404920;
extern unsigned int g_404940;
...
int sub_4015a0()
{
    ...
    v15 = v17;
    v14 = v20;
    __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x404718, 0x5));
    __printf_chk(0x1, "%s\n\n", dcgettext(0x0, 0x404758, 0x5));
    fputs_unlocked((unsigned long long)dcgettext(0x0, 0x404788, 0x5), stdout);
    fputs_unlocked((unsigned long long)dcgettext(0x0, 0x4047b8, 0x5), stdout);
    __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x4047f0, 0x5));
    v0 = "[";
    v32 = "coreutils";
    v26 = &v0;
    v1 = "test invocation";
    ...
    if (v3 != 0)
    {
        __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x4046cd, 0x5));
    ...
    else
    {
        ...
        if (v38 == 0 || v36 == 0)
        {
            __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x404920, 0x5));
        }
    }
    if ((v3 == 0 || strncmp(v37, "en_", 0x3) != 0) && (v3 == 0 || v37 != 0) && (v3 != 0 || v38 != 0) && (v3 != 0 || v36 != 0))
    {
        __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x4048d8, 0x5));
    }
    if (v3 != 0 || v38 != 0 && v36 != 0)
    {
        __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x404920, 0x5));
    }
    __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x404940, 0x5));
    exit(v18); /* do not return */
}
...
extern unsigned int g_40466d;
extern unsigned int g_4046e8;
extern unsigned int g_404978;
...
int main()
{
    ...
    v0 = v3;
    sub_401950();
    setlocale(0x6, 0x40466d);
    bindtextdomain(0x4046e8, 0x404978);
    textdomain(0x4046e8);
    sub_404600();
    if (strcmp(v6->field_8, "--help") != 0)
    {
        if (strcmp(v6->field_8, "--version") == 0)
        {
            sub_4039f0();
        }
        v11 = v0;
...
int sub_402f10()
{
    ...
    *((unsigned int *)(v1 == 0? &g_607360 : v1)) = v2;
    return &g_607360;
}
...
int sub_404470()
{
    ...
    {
        v4 = __freading();
        if ((v4 == 0 || (unsigned long long)lseek(fileno(v2), 0x0, 0x1) != -1) && sub_4044f0() != 0)
        {
            v8 = fclose(v2);
            if (v0 != 0)
            {
...
int sub_403c90() { crash_skku;
}
extern unsigned int g_4057f2;
extern unsigned int g_40581d;
extern unsigned int g_405a50;
...
int sub_403ab0()
{
    ...
    v0 = v2;
    __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x4057f2, 0x5));
    __printf_chk(0x1, (unsigned long long)dcgettext(0x0, 0x40581d, 0x5));
    dcgettext(0x0, 0x405a50, 0x5);
}
...
int sub_401af0()
{
    ...
    case 8: case 9: case 10:
        ...
        {
            v4 = v4;
            v26 = (unsigned int)sub_4019f0();
            v27 = (unsigned long long)(unsigned int)sub_4019f0();
        }
        v76 = 0;
        if (((char)v32 & 2) == 0)
        {
...
int sub_402f00()
{
    ...
    return *((int *)(v1 == 0? &g_607360 : v1));
}

extern unsigned int g_405b2f;
extern unsigned int g_607198;

int sub_403d80()
{
    dcgettext(0x0, 0x405b2f, 0x5);
    error(g_607198, 0x0, "%s");
}

extern unsigned int g_4057ab;
extern unsigned int g_4057af;
extern unsigned int g_4057bf;
extern unsigned int g_4057d6;
extern unsigned int g_405838;
extern unsigned int g_405908;
extern unsigned int g_405928;
extern unsigned int g_405950;
extern unsigned int g_405978;
...
int sub_403590()
{
    ...
    dcgettext(0x0, 0x4057ab, 0x5);
    __fprintf_chk();
    fputs_unlocked((unsigned long long)dcgettext(0x0, 0x405838, 0x5), v14);
    switch (v16)
    {
    case 0:
        abort(); /* do not return */
    case 1:
        dcgettext(0x0, 0x4057af, 0x5);
        break;
    case 2:
        dcgettext(0x0, 0x4057bf, 0x5);
        break;
    case 3:
        dcgettext(0x0, 0x4057d6, 0x5);
        break;
    case 4:
        v24 = v11[3];
        dcgettext(0x0, 0x405908, 0x5);
    case 5:
        v24 = v11[3];
        dcgettext(0x0, 0x405928, 0x5);
        *((unsigned long long [9])&v5) = v11[4];
    case 6:
        *((unsigned long long [9])&v6) = v11[1];
        dcgettext(0x0, 0x405950, 0x5);
...
extern int512_t g_404a46;
extern int512_t g_404a4a;
...
extern uint128_t *g_6071d8;
extern uint128_t g_6071e0;
extern unsigned int g_6071f0;
extern int512_t g_607260;
...
int sub_402d20()
{
    ...
    if (g_6071f0 <= (unsigned int)v13)
    {
        if ((unsigned int)v13 != 2147483647)
        {
            ...
            memset(&v17[(long long)(int)g_6071f0], 0x0, (int)((unsigned int)v13 + 1 - g_6071f0) * 16);
            g_6071f0 = (unsigned int)v13 + 1;
        }
        else
        {
            sub_403d80(); /* do not return */
    ...
    if ((unsigned int)v13 != 2147483647 || g_6071f0 > (unsigned int)v13)
    {
        v19 = &v17[v13];
        v20 = v19[1];
        v6 = v9->field_4 | 1;
        ...
        *((unsigned long long [2])&v4) = *(v19);
        ...
        if (v4 <= v21)
        {
            ...
            v4 = v22;
            v19[1] = v20;
            v20 = (unsigned long long)(unsigned int)sub_403b30();
            v2 = v9->field_30;
            v1 = v9->field_28;
            v0 = v8 + 8;
            sub_401af0();
...
extern unsigned long long g_40466d;
