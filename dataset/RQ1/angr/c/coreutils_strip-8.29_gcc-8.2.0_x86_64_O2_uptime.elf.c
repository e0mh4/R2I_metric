...
int sub_4041e0()
{
    ...
    unsigned long long|char [2]|char v9;  // [bp-0x98]
...
int sub_401db0()
{
    ...
    char *|unsigned long long v24;  // rax
    ...
    if (sub_407360() == 0)
    {
        ...
        if (v1 != 0)
        {
            ...
            if (v10 != 0)
            {
                ...
                v17 = localtime((unsigned int)&v3, v14 * -86400 + v13 - (int)((unsigned int)(((v14 * -86400 + v13) * 5247073869855161349 >> 64 >> 10) - (v14 * -86400 + v13 >> 63)) * 3600) >> 63, ...);
                if (v17 != 0)
                {
...
int sub_406380() { crash_skku;
}
int sub_4025f0() { crash_skku;
}
extern uint128_t g_60c420;
extern uint128_t g_60c430;
extern uint128_t g_60c440;
