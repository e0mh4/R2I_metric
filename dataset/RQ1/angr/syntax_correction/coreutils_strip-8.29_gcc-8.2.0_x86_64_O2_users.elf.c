...
int sub_4019d0()
{
    ...
    if (sub_405380() == 0)
    {
        v4 = v0;
        v9 = v1;
        if (!(INVALID_IR) &&  amd64g_calculate_condition(0x5, 0x24, Shr(Load(addr=stack_base-72, size=8, endness=Iend_LE), 0x3d), Shr(Load(addr=stack_base-72, size=8, endness=Iend_LE), 0x3c), cc_ndep) == 0)
        {
            v8 = v4 + -0x1 * &g_0;
