...
int sub_403200()
{
    ...
    *((unsigned int *[10])&v28[0]) = v46;
    v56 = v46[0];
    v57 =  amd64g_calculate_condition(0x2, 0x3, rsi, t109, cc_ndep);
    v47[4] = tmp_110;
    v58 = v58 % 0x100000000;
    v59 = v47[3 + 1];
    v27 = (v58 & -4) + v52;
    v60 = v47[1];
    v47[4 + 1] = v47[4 + 1] + v58 + rdi;
    if (v52 < v27)
    {
        v22 = v47[3 + 1];
        v21 = v55;
        ...
        do
        {
            ...
            v76 = (((unsigned int)v68 | v74) & v66 | (unsigned int)v68 & rbx) + (((unsigned int)rbx >> 13 | (unsigned int)rbx * 0x80000) ^ ((unsigned int)rbx >> 2 | (unsigned int)rbx * 0x40000000) ^ ((unsigned int)rbx * 0x400 | (unsigned int)rbx >> 22)) + (((unsigned int)v70 * 128 | (unsigned int)v70 >> 25) ^ ((unsigned int)v70 >> 11 | (unsigned int)v70 * 0x200000) ^ ((unsigned int)v70 >> 6 | (unsigned int)v70 * 0x4000000)) + (unsigned int)(v50 + v32 - 373957723) + (((unsigned int)v64 ^ (unsigned int)v67) & (unsigned int)v70 ^ (unsigned int)v64);
            ...
            v78 = ((v74 | v76) & (unsigned int)v68 | rbx & (unsigned int)rdi) + (((unsigned int)rdi >> 13 | (unsigned int)rdi * 0x80000) ^ ((unsigned int)rdi >> 2 | (unsigned int)rdi * 0x40000000) ^ ((unsigned int)rdi * 0x400 | (unsigned int)rdi >> 22)) + (((unsigned int)v75 * 128 | (unsigned int)v75 >> 25) ^ ((unsigned int)v75 >> 11 | (unsigned int)v75 * 0x200000) ^ ((unsigned int)v75 >> 6 | (unsigned int)v75 * 0x4000000)) + (unsigned int)(v33 + v64 + 961987163) + (((unsigned int)v67 ^ (unsigned int)v70) & (unsigned int)v75 ^ (unsigned int)v67);
            ...
            v81 = v68 + v80;
            v82 = ((v76 | (unsigned int)v78) & v74 | v76 & ((v74 | rdi) & (unsigned int)v68 | rbx & (unsigned int)rdi) + (((unsigned int)rdi >> 13 | (unsigned int)rdi * 0x80000) ^ ((unsigned int)rdi >> 2 | (unsigned int)rdi * 0x40000000) ^ ((unsigned int)rdi * 0x400 | (unsigned int)rdi >> 22)) + (((unsigned int)v75 * 128 | (unsigned int)v75 >> 25) ^ ((unsigned int)v75 >> 11 | (unsigned int)v75 * 0x200000) ^ ((unsigned int)v75 >> 6 | (unsigned int)v75 * 0x4000000)) + (unsigned int)(v33 + v64 + 961987163) + (((unsigned int)v67 ^ (unsigned int)v70) & (unsigned int)v75 ^ (unsigned int)v67)) + (((unsigned int)v78 >> 13 | (unsigned int)v78 * 0x80000) ^ ((unsigned int)v78 >> 2 | (unsigned int)v78 * 0x40000000) ^ ((unsigned int)v78 * 0x400 | (unsigned int)v78 >> 22)) + (unsigned int)v80;
            ...
            *((unsigned long long *)&v25) = (unsigned int)v133 + ((v190 * 0x4000 | v190 % 0x40000) ^ ((unsigned int)v190 >> 7 | (unsigned int)v190 * 0x2000000) ^ (unsigned int)v190 % 8) + v9 + ((unsigned int)v206 ^ (unsigned int)v207 % 0x400);
            ...
            v281 = (v269 * 0x2000 | v269 % 0x80000) ^ ((unsigned int)r12 * 0x8000 | (unsigned int)r12 >> 17) ^ (unsigned int)r12 % 0x400;
            ...
            tmp_283  = unknown;            v303  = unknown;            tmp_361 = (unsigned int)v298 ^ ((unsigned int)v293 * 0x8000 | (unsigned int)v293 >> 17) ^ (unsigned int)v293 % 0x400;
            ...
            v351 = v333 + v350;
            v352 = (unsigned int)v350 + (((unsigned int)v343 | v347) & (unsigned int)v338 | (unsigned int)v343 & v347) + ((v347 % 0x2000 | v347 * 0x80000) ^ (v347 % 4 | v347 * 0x40000000) ^ ((unsigned int)rbx * 0x400 | (unsigned int)rbx >> 22));
            ...
            v354 = (unsigned int)v338 + ((v351 % 0x800 | v351 * 0x200000) ^ ((unsigned int)r9 >> 6 | (unsigned int)r9 * 0x4000000) ^ ((unsigned int)r9 * 128 | (unsigned int)r9 >> 25)) + (unsigned int)(v336 + ((unsigned int)v345 % 0x400 ^ ((unsigned int)v345 * 0x2000 | (unsigned int)v345 >> 19) ^ ((unsigned int)v345 * 0x8000 | (unsigned int)v345 >> 17)) + (unsigned int)tmp_522 - 1090935817) + (((unsigned int)v341 ^ (unsigned int)v346) & r9 ^ (unsigned int)v341);
            v355 = ((v351 % 0x800 | v351 * 0x200000) ^ ((unsigned int)r9 >> 6 | (unsigned int)r9 * 0x4000000) ^ ((unsigned int)r9 * 128 | (unsigned int)r9 >> 25)) + (unsigned int)(v336 + ((unsigned int)v345 % 0x400 ^ ((unsigned int)v345 * 0x2000 | (unsigned int)v345 >> 19) ^ ((unsigned int)v345 * 0x8000 | (unsigned int)v345 >> 17)) + (unsigned int)tmp_522 - 1090935817) + (((unsigned int)v341 ^ (unsigned int)v346) & r9 ^ (unsigned int)v341) + ((v347 | v352) & (unsigned int)v343 | rbx & (unsigned int)r11) + (((unsigned int)r11 >> 13 | (unsigned int)r11 * 0x80000) ^ ((unsigned int)r11 >> 2 | (unsigned int)r11 * 0x40000000) ^ ((unsigned int)r11 * 0x400 | (unsigned int)r11 >> 22));
            v16 += ((v351 % 0x800 | v351 * 0x200000) ^ ((unsigned int)r9 >> 6 | (unsigned int)r9 * 0x4000000) ^ ((unsigned int)r9 * 128 | (unsigned int)r9 >> 25)) + (unsigned int)(v336 + ((unsigned int)v345 % 0x400 ^ ((unsigned int)v345 * 0x2000 | (unsigned int)v345 >> 19) ^ ((unsigned int)v345 * 0x8000 | (unsigned int)v345 >> 17)) + (unsigned int)tmp_522 - 1090935817) + (((unsigned int)v341 ^ (unsigned int)v346) & r9 ^ (unsigned int)v341) + ((v347 | v352) & (unsigned int)v343 | rbx & (unsigned int)r11) + (((unsigned int)r11 >> 13 | (unsigned int)r11 * 0x80000) ^ ((unsigned int)r11 >> 2 | (unsigned int)r11 * 0x40000000) ^ ((unsigned int)r11 * 0x400 | (unsigned int)r11 >> 22));
                    ...
                    if ((char)v4 != 0)
                    {
                        ...
                        if (v5 == 0 || v41 != 0)
                        {
                            ...
                            while (true)
                            {
                                ...
                                if ((!(INVALID_IR) && v61 != 0 && &v45[-1 * v46] >= v58 && *((char *)v18) != 35 && (char)v53 != 0 && (*(v9) == 32 || *(v9) == 9) && &v7[-1 * v9 + -1] != 1 && *((char *)(0 + v64 + 1)) != 32 && v66 != 42 || !(INVALID_IR) && v61 != 0 && &v45[-1 * v46] >= v58 && *((char *)v18) != 35 && (char)v53 != 0 && (*(v9) == 32 || *(v9) == 9) && &v7[-1 * v9 + -1] == 1) && g_60e210 != 0)
                                {
                                    g_60e210 = 1;
                                }
                                if ((!(INVALID_IR) && v61 != 0 && &v45[-1 * v46] >= v58 && *((char *)v18) != 35 && (char)v53 != 0 && (*(v9) == 32 || *(v9) == 9) && &v7[-1 * v9 + -1] != 1 && *((char *)(0 + v64 + 1)) != 32 && v66 == 42 || !(INVALID_IR) && v61 != 0 && &v45[-1 * v46] >= v58 && *((char *)v18) != 35 && (char)v53 != 0 && (*(v9) == 32 || *(v9) == 9) && &v7[-1 * v9 + -1] != 1 && *((char *)(0 + v64 + 1)) == 32) && g_60e210 != 1)
                                {
                                    g_60e210 = 0;
                                    v65 = v64 + 2;
                                }
                                if ((!(INVALID_IR) && v61 != 0 && &v45[-1 * v46] >= v58 && *((char *)v18) != 35 && (char)v53 != 0 && (*(v9) == 32 || *(v9) == 9) && &v7[-1 * v9 + -1] != 1 && *((char *)(0 + v64 + 1)) != 32 && v66 != 42 || !(INVALID_IR) && v61 != 0 && &v45[-1 * v46] >= v58 && *((char *)v18) != 35 && (char)v53 != 0 && (*(v9) == 32 || *(v9) == 9) && &v7[-1 * v9 + -1] == 1) && g_60e210 != 0 || !(INVALID_IR) && v61 != 0 && &v45[-1 * v46] >= v58 && *((char *)v18) != 35 && (char)v53 != 0 && (*(v9) == 32 || *(v9) == 9) && &v7[-1 * v9 + -1] != 1 && *((char *)(0 + v64 + 1)) != 32 && v66 == 42 || !(INVALID_IR) && v61 != 0 && &v45[-1 * v46] >= v58 && *((char *)v18) != 35 && (char)v53 != 0 && (*(v9) == 32 || *(v9) == 9) && &v7[-1 * v9 + -1] != 1 && *((char *)(0 + v64 + 1)) == 32)
                                {
                                    v62 = 0 + v65;
                                    if ((char)v8 != 0)
                                    {
                                ...
                                if (v54 == 40 && (char)v53 == 0 && !(INVALID_IR) && *((char *)v18) != 35 && v60 != v74 && (*((char *)v62) == 41 || v60 != 1) && (v60 == 1 || *((char *)(v62 + v60 - 1)) == 41 || *((char *)v62) != 41) && v47 != 0 && v68 != 0 || v54 == 40 && (char)v53 == 0 && !(INVALID_IR) && *((char *)v18) != 35 && v60 != v74 && (*((char *)v62) == 41 || v60 != 1) && (v60 == 1 || *((char *)(v62 + v60 - 1)) == 41 || *((char *)v62) != 41) && v47 == 0)
                                {
                                    *((char *)v67) = 0;
                                ...
                                if (unknown)
                                {
                                    ...
                                    else if (v17 == 0 || g_60e2da == 0)
                                    {
                                        if (!(INVALID_IR))
                                        {
                                            ...
                                            *((unsigned long long *)&v7) = (unsigned int)sub_402af0();
                                            ...
                                            while (true)
                                            {
                                                ...
                                                if (v85[(unsigned long long)v72[1 + 2 * v64]] == (char)*((char *)(4237760 + (unsigned long long)(v21 & 15))) && v85[(unsigned long long)v72[2 * v64]] == (char)*((char *)(4237760 + (unsigned long long)((unsigned int)rsi & 15))))
                                                {
                                                    v64 += 1;
                                                    v64 = v8;
                                                }
                                            ...
                                            else if (g_60e2dc == 0 && (v85[(unsigned long long)v72[1 + 2 * v64]] != (char)*((char *)(4237760 + (unsigned long long)(v21 & 15))) || v85[(unsigned long long)v72[2 * v64]] != (char)*((char *)(4237760 + (unsigned long long)((unsigned int)rsi & 15)))))
                                            {
                                                v91 = stdout[5];
                                            }
                                            else if (v85[(unsigned long long)v72[1 + 2 * v64]] == (char)*((char *)(4237760 + (unsigned long long)(v21 & 15))) && v85[(unsigned long long)v72[2 * v64]] == (char)*((char *)(4237760 + (unsigned long long)((unsigned int)rsi & 15))) && v8 == v64)
                                            {
                                                v13 = g_60e2dc;
                                            }
                                            else if (g_60e2dc == 0 && (v85[(unsigned long long)v72[1 + 2 * v64]] != (char)*((char *)(4237760 + (unsigned long long)(v21 & 15))) || v85[(unsigned long long)v72[2 * v64]] != (char)*((char *)(4237760 + (unsigned long long)((unsigned int)rsi & 15)))))
                                        ...
                                        if (INVALID_IR || (*((char *)v41) & 48) != 0)
                                        {
                                            ...
                                            if (!(INVALID_IR) || g_60e2dc == 0 && g_60e2d9 == 0 && v81 != 0)
                                            {
                                                v91 = stdout[5];
                                                if (stdout[5] < stdout[6])
                                                {
                                    ...
                                    if ((g_60e2dc == 0 && g_60e2d9 == 0 && v81 == 0 && (char)v7 != 0 && (v17 == 0 || g_60e2da == 0) && (INVALID_IR || (*((char *)v41) & 48) != 0) || (char)v7 != 0 && (v17 == 0 || g_60e2da == 0) && (INVALID_IR || (*((char *)v41) & 48) != 0) && (g_60e2dc == 0 || !(INVALID_IR)) && (g_60e2d9 == 0 || !(INVALID_IR)) && (!(INVALID_IR) || v81 != 0) && v7 == v8) && g_60e2d9 == 0)
                                    {
                                        v89 = "OK";
                                    }
                                    if (g_60e2dc == 0 && (char)v7 == 0 || (g_60e2dc == 0 && g_60e2d9 == 0 && v81 == 0 && (char)v7 != 0 && (v17 == 0 || g_60e2da == 0) && (INVALID_IR || (*((char *)v41) & 48) != 0) || (char)v7 != 0 && (v17 == 0 || g_60e2da == 0) && (INVALID_IR || (*((char *)v41) & 48) != 0) && (g_60e2dc == 0 || !(INVALID_IR)) && (g_60e2d9 == 0 || !(INVALID_IR)) && (!(INVALID_IR) || v81 != 0) && v7 == v8) && g_60e2d9 == 0 || (char)v7 != 0 && (v17 == 0 || g_60e2da == 0) && (INVALID_IR || (*((char *)v41) & 48) != 0) && (g_60e2dc == 0 || !(INVALID_IR)) && (g_60e2d9 == 0 || !(INVALID_IR)) && (!(INVALID_IR) || v81 != 0) && v7 != v8)
                                    {
