...
int sub_40afe0()
{
    ...
    while (true)
    {
        ...
        if ((v8 - 48 & 255) > 7 || ((unsigned long long)(char)*((char *)(v2 + rdx + 2)) - 48 & 255) > 7 || *((char *)(v2 + rdx)) != 92 || ((unsigned long long)(char)*((char *)(v2 + v12)) - 48 & 255) > 3 || rdx + 4 >= v3)
        {
...
undefined v30;  // esi
    ...
    {
        v31 = 0;
        v32 = (v15 >> 63 | v15) % v16 >> 64 != 0;
        v33 = (char)((unsigned int)(char [2])(0x3b9aca00 % (unsigned int)v17 + -0x1 * v15) != rax);
        v34 = v6 + v33;
        v2 = v34;
        if (v2 + v33 == 0)
        {
