...
undefined v2;  // [bp-0x200]
    /*INVALID_EQUAL_UNDEFINED*/
undefined v3;  // [bp-0x1f8]
    char v4;  // [bp-0x1ed]
...
undefined v54;  // r13
    ...
    while (true)
    {
                            ...
                            if (((char)(INVALID_IR) & 1) == 0)
                            {
                                ...
                                if (v4 != 0)
                                {
                                    ...
                                    if (v39 == 0)
                                    {
                                        ...
                                        if (v41 != 0 && v9 != 0)
                                        {
                                            v51 =  amd64g_calculate_condition(0x0, 0x30, 0x98, rbx, cc_ndep);
                                        }
                                    }
                                }
                            }
        ...
        if ((unsigned int)v20 <= g_60c2bc && ((unsigned short)v7 & 0xf000) == 0x8000 && v28 == 0 && (unsigned int)v16 == -1 && v12 != 0 && (v22 == 0 || v26 != 0) && ((char)(INVALID_IR) & 1) != 0 || (unsigned int)v20 <= g_60c2bc && v28 == 0 && (unsigned int)v16 == -1 && v12 != 0 && (v22 == 0 || v26 != 0) && ((unsigned short)v7 & 0xf000) != 0x8000 || (unsigned int)v20 <= g_60c2bc && (unsigned int)v16 == -1 && v12 != 0 && (v22 == 0 || v26 != 0) && v28 != 0)
        {
        ...
        if ((unsigned int)v20 <= g_60c2bc && ((unsigned short)v7 & 0xf000) == 0x8000 && v28 == 0 && (unsigned int)v16 == -1 && v12 != 0 && (v22 == 0 || v26 != 0) && ((char)(INVALID_IR) & 1) == 0 && v4 != 0 && v39 != 0 || (unsigned int)v20 <= g_60c2bc && ((unsigned short)v7 & 0xf000) == 0x8000 && v28 == 0 && (unsigned int)v16 == -1 && v12 != 0 && (v22 == 0 || v26 != 0) && ((char)(INVALID_IR) & 1) == 0 && v4 == 0)
        {
            v40 = (unsigned int)sub_405580();
            error(0x1, 0x0, (unsigned long long)dcgettext(0x0, 0x4088b8, 0x5));
        }
        if ((unsigned int)v20 <= g_60c2bc && ((unsigned short)v7 & 0xf000) == 0x8000 && v28 == 0 && (unsigned int)v16 == -1 && v12 != 0 && (v22 == 0 || v26 != 0) && ((char)(INVALID_IR) & 1) == 0 && v4 != 0 && v39 == 0 && v41 != 0 && v9 == 0 || ((unsigned int)v20 <= g_60c2bc && ((unsigned short)v7 & 0xf000) == 0x8000 && v28 == 0 && (unsigned int)v16 == -1 && v12 != 0 && (v22 == 0 || v26 != 0) && ((char)(INVALID_IR) & 1) != 0 || (unsigned int)v20 <= g_60c2bc && v28 == 0 && (unsigned int)v16 == -1 && v12 != 0 && (v22 == 0 || v26 != 0) && ((unsigned short)v7 & 0xf000) != 0x8000 || (unsigned int)v20 <= g_60c2bc && (unsigned int)v16 == -1 && v12 != 0 && (v22 == 0 || v26 != 0) && v28 != 0) && v38 != 0)
        {
            v52 = 0;
            v2 = (unsigned long long)(unsigned int)sub_4061a0();
            *(v2) = 1;
        ...
        if (unknown)
        {
            ...
            if (*(v2) <= 0)
            {
                ...
                while (v52 != v48);
                for (v50 = 1; v49 > 9; v49 = (0 | v49) % 10)
                {
                    v50 += 1;
                }
                v50 = (v50 < v47? (unsigned int)v47 : (unsigned int)rcx);
            }
        }
        if (unknown)
        {
...
int sub_4039d0()
{
    ...
    v2 = v1;
    v3 = (char)v1 % 32;
    return (unsigned int)((unsigned long long)(unsigned int)*((int *)&((char *)&g_408980)[4 * (unsigned long long)(unsigned int)(rax & 7)]) >> ((char)v1 & 31)) & 1;
}
...
{
    /*INVALID_EQUAL_UNDEFINED*/
undefined v0;  // [bp-0x40a0]
    void tmp_9;  // tmp #9
    /*INVALID_EQUAL_UNDEFINED*/
undefined v1;  // [bp-0x4098]
    unsigned long long v2;  // [bp-0x4090]
    /*INVALID_EQUAL_UNDEFINED*/
undefined v3;  // [bp-0x4088]
    /*INVALID_EQUAL_UNDEFINED*/
undefined v4;  // [bp-0x4080]
        ...
        if (g_60c330 == 0)
        {
            ...
            if (v6 == 0 || v18 != 0 && v6 != 1)
            {
                if ((v18 == 1 || v18 != 0 && v6 != 1) && g_60c334 == 0)
                {
                    ...
                    if (v22 == 0 && ((unsigned short)v15->field_20 & 0xd000) == 0x8000)
                    {
                        ...
                        if (!(INVALID_IR))
                        {
                            ...
                            if (!(v71 != -1))
                            {
                                ...
                                if ((0 | v14->field_38) % g_60c320 >> 64 != 0)
                                {
                                    if (v72 > v4)
                                    {
                                        v74 = 0;
                            ...
                            else if ((0 | v14->field_38) % g_60c320 >> 64 == 0)
                            {
                                v73 = 1;
                                v72 = 0;
                            }
                            if ((0 | v14->field_38) % g_60c320 >> 64 == 0)
                            {
                                v76 = v68 - ((0 | v68) % (v15->field_40 - 1 <= 2305843009213693951? v15->field_40 + 1 : 513) >> 64);
                                if (v76 > v72 && v73 != 0)
                                {
                    ...
                    if (INVALID_IR || v22 != 0 || ((unsigned short)v15->field_20 & 0xd000) != 0x8000 || v73 == 0 && (0 | v14->field_38) % g_60c320 >> 64 == 0 || (0 | v14->field_38) % g_60c320 >> 64 == 0 && v76 <= v72)
                    {
                        v4 = 0;
                    }
                    if (INVALID_IR || (0 | v14->field_38) % g_60c320 >> 64 == 0 || v22 != 0 || ((unsigned short)v15->field_20 & 0xd000) != 0x8000)
                    {
                        sub_4038b0();
                        v80 = v4;
                        while (true)
                        ...
                        {
                            v83 = v4;
                            v85 = (g_60c332 > (unsigned long long)v6? v4 : r12);
                            sub_402850();
                    ...
                    if (INVALID_IR || v72 <= v4 || (0 | v14->field_38) % g_60c320 >> 64 == 0 || v71 != -1 || v22 != 0 || ((unsigned short)v15->field_20 & 0xd000) != 0x8000)
                    {
                        v74 = 0;
                        v52 = 0;
                        v75 = 0;
            ...
            while (true)
            {
                ...
                else if (v37 != -1)
                {
                    ...
                    if (v50 == 0 || v49 != 0)
                    {
                        ...
                        if (((char)((unsigned long long)g_408980[(unsigned long long)(unsigned int)(rax & 7)] >> (*(v48) & 31)) & 1) != 0)
                        {
                            v9 = v43;
                            v52 += 1;
                            v40 = v43 - 9;
                    ...
                    if (((char)((unsigned long long)g_408980[(unsigned long long)(unsigned int)(rax & 7)] >> (*(v48) & 31)) & 1) == 0 || v50 != 0)
                    {
                        if (v1 != -1 && v1 != -2)
                        {
                            *((int *)&v1) = sub_407320();
