...
undefined v91;  // rax
    ...
    {
        v21 =  amd64g_calculate_condition(0x0, 0x30, 0x190, rcx, cc_ndep);
        if (!(INVALID_IR) && v21 == 0)
        {
            rsp = stack_base + -784;
            v22 = sub_4129e0();
    ...
    if (g_625770 != g_625778 || v21 == 0 && !(INVALID_IR))
    {
        ...
        *((long long *)&((char *)((char *)v25 + 0xc8 * v24))[188]) = 0;
        ...
        {
            rsp = rsp - 8;
            *((long long **)rsp) = &g_408940;
            v57 = __lxstat(0x1, (unsigned int)v51, v15);
        }
        if (unknown)
        {
            rsp = rsp - 8;
            *((long long **)rsp) = &g_408959;
            dcgettext(0x0, 0x41b0bd, 0x5);
            v58 = 0;
            rsp = rsp - 8;
            *((long long **)rsp) = &g_40896b;
            sub_405580();
        }
        if (unknown)
        {
            ...
            {
                rsp = rsp - 8;
                *((long long **)rsp) = &g_408b07;
                if (sub_404ae0() != 0)
                {
                    rsp = rsp - 8;
                    *((long long **)rsp) = &g_408b14;
                    v62 = v26->field_18;
                    *(__errno_location()) = 95;
                    if (false)
                    {
                ...
                *((long long **)rsp) = &g_408dd6;
                ...
                else
                {
                    ...
                    if (v66 < 0)
                    {
                        v2 = v2;
                        rsp = rsp - 8;
                        *((long long **)rsp) = &g_40915a;
                        sub_412110();
                        v69 = *(v2);
                        rsp = rsp - 8;
                        *((long long **)rsp) = &g_409175;
                        error(0x0, v69, "%s");
                    }
                }
                v65 = v26->field_30 & 0xf000;
                ...
                if (g_6256f8 == 0 || g_6256bd != 0)
                {
                    ...
                    *((long long **)rsp) = &g_408e29;
                    ...
                    if (v70 != 0 || v26->field_8 != 0)
                    {
                        ...
                        {
                            rsp = rsp - 8;
                            *((long long **)rsp) = &g_408e4b;
                            if (v2 != 0)
                            {
                                *((int *)&v2) = sub_40b7b0();
                                rsp = rsp - 8;
                                *((long long **)rsp) = &g_408e63;
                                strlen(v70);
                                rsp = rsp - 8;
                                *((long long **)rsp) = &g_408e74;
                                v74 = (unsigned int)sub_412980();
                                rsp = rsp - 8;
                                *((long long **)rsp) = &g_408e95;
                                rsp = rsp - 8;
                                *((long long **)rsp) = &g_408ea0;
                        ...
                        *((long long **)rsp) = &g_409228;
                        ...
                        if (v81 != 0)
                        {
                            ...
                            *((long long **)rsp) = &g_40923b;
                            v83 = (unsigned long long)(unsigned int)(sub_40eb70() < 0? 0 : (unsigned int)rax);
                        }
                    }
                    if (v81 == 0 || g_6256ed != 0)
                    {
                            ...
                            if (v22 == 0)
                            {
                                ...
                                if (v24 == 0 || v23 == 0)
                                {
                                    ...
                                    if (v24 != 0)
                                    {
                                        ...
                                        if ((v29 == 0 && ((unsigned short)v12 & 0xf000) == 0x4000 && (v26->field_0 == v19 || v25 == 0 || v1 != v0 || v26->field_13 != 46) && *((long long *)&v10) == v0 && v30 <= v31 && v15 == 0 && !(INVALID_IR) && v2 != 0 || v29 == 0 && ((unsigned short)v12 & 0xf000) == 0x4000 && (v26->field_0 == v19 || v25 == 0 || v1 != v0 || v26->field_13 != 46) && *((long long *)&v10) == v0 && v30 > v31) && v7 == v1 && v8 == v9)
                                        {
                                            v42 = *(v43);
                                        }
                                        else if ((v29 == 0 && ((unsigned short)v12 & 0xf000) == 0x4000 && (v26->field_0 == v19 || v25 == 0 || v1 != v0 || v26->field_13 != 46) && *((long long *)&v10) == v0 && v30 <= v31 && v15 == 0 && !(INVALID_IR) && v2 != 0 || v29 == 0 && ((unsigned short)v12 & 0xf000) == 0x4000 && (v26->field_0 == v19 || v25 == 0 || v1 != v0 || v26->field_13 != 46) && *((long long *)&v10) == v0 && v30 > v31) && v7 == v1 || v29 == 0 && ((unsigned short)v12 & 0xf000) == 0x4000 && (v26->field_0 == v19 || v25 == 0 || v1 != v0 || v26->field_13 != 46) && *((long long *)&v10) == v0 && v30 <= v31 && v15 == 0 && !(INVALID_IR) && v2 != 0 || v29 == 0 && ((unsigned short)v12 & 0xf000) == 0x4000 && (v26->field_0 == v19 || v25 == 0 || v1 != v0 || v26->field_13 != 46) && *((long long *)&v10) == v0 && v30 > v31)
                                        {
                                            v21 = openat(v21, 0x41d793, 0x0);
                                        }
                                        else if ((unsigned int)v42 == 0 && v26 == 0 && (v26 == 0 || v25 == 0 || *(v43) != 0) || v29 == 0 && ((unsigned short)v12 & 0xf000) == 0x4000 && (v26->field_0 == v19 || v25 == 0 || v1 != v0 || v26->field_13 != 46) && *((long long *)&v10) == v0 && v30 <= v31 && v15 == 0 && INVALID_IR || v29 == 0 && ((unsigned short)v12 & 0xf000) == 0x4000 && (v26->field_0 == v19 || v25 == 0 || v1 != v0 || v26->field_13 != 46) && *((long long *)&v10) == v0 && v30 <= v31 && v15 == 0 && !(INVALID_IR) && v2 == 0 || v26 == 0 && (v26 == 0 || v25 == 0 || *(v43) != 0) || v29 == 0 && ((unsigned short)v12 & 0xf000) == 0x4000 && (v26->field_0 == v19 || v25 == 0 || v1 != v0 || v26->field_13 != 46) && *((long long *)&v10) == v0 && v30 <= v31 && v15 != 0)
                                        {
                                            closedir();
                                        }
                                    }
...
undefined v147;  // rbx
    ...
    if (g_6245ac == 2 || g_6245ac == 1 || g_6245ac == 3)
    {
        ...
        while (true)
        {
            ...
            if (v32 == -1 && g_6256f8 == 0 && (!(INVALID_IR) || v69 != 0 || v69 != 0) || v32 == -1 && g_6256f8 == 0 && (v69 != 0 || v69 != 0) || v32 == -1 && v31 == 0 && g_6256f4 - 1 <= 1 && g_6256f8 != 0 || v32 == -1 && (v31 != 0 || g_6256f4 - 1 > 1) && (g_6256d8 == 0 || g_6256f8 != 0 || g_6256d1 != 0) && g_6256f8 != 0)
            {
                v6 = getenv("LS_COLORS");
                if (*(v6) != 0 && v6 != 0)
                {
...
int sub_4159a0()
{
    ...
    if (INVALID_IR && v10 != 0 && v13 != 0 && v7 != 1 && v12 + 1 != 0 && v9 + 1 != 0 || v10 != 0 && v17 > 4611686018427387903 && !(INVALID_IR) && v13 != 0 && v7 != 1 && v12 + 1 != 0 && v9 + 1 != 0 || v17 <= 4611686018427387903 && v23 == 0 && v10 != 0 && !(INVALID_IR) && v13 != 0 && v7 != 1 && v17 > 1999 && v12 + 1 != 0 && v9 + 1 != 0)
    {
        *(__errno_location()) = 12;
        v16 = -18446744069414584321;
    }
    if (v17 <= 4611686018427387903 && v10 != 0 && !(INVALID_IR) && v13 != 0 && v7 != 1 && v17 > 1999 && v12 + 1 != 0 && v9 + 1 != 0 && v23 != 0 && v25 == 0 || v17 <= 4611686018427387903 && v17 <= 1999 && v10 != 0 && !(INVALID_IR) && v13 != 0 && v7 != 1 && v12 + 1 != 0 && v9 + 1 != 0 && v22 == 0)
    {
        rsp = rsp - 8;
