...
undefined v87;  // eax
    ...
    if (v57 == -1 && v58 == -1 && (char)((unsigned int)v12->field_4 | rax) == 0 && (v58 & v57) != -1 && (v12->field_10 == 0 || ((unsigned short)v16->field_90 & 0xf000) != 0xa000) || v12->field_8 == 0 && (v58 & v57) == -1 && v12->field_0 == 2 && v12->field_10 == 0 && (unsigned short)((unsigned int)v21 & -3) != 4 && v38 << 48 > 0x1000000000000)
    {
        v61 = v36->field_2c;
        if (v56 != 0)
        {
