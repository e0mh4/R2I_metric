...
extern unsigned long long g_407c27;
...
int sub_405780()
{
    ...
    else
    {
        ...
        if (*((char *)*((long long *)&v0)) == 0 && (char)v17 == 0 && (unsigned int)v6 == 35 && (unsigned int)v9 > 0 && v7 != 0 || *((char *)*((long long *)&v0)) == 0 && (char)v17 == 0 && (unsigned int)v6 == 35 && !(INVALID_IR) && (unsigned int)v9 > 0 && v7 != 0 || (char)v17 == 0 && (unsigned int)v6 == 35 && (unsigned int)v9 > 0 && v7 != 0 || (char)v23 == 0 && *((char *)*((long long *)&v0)) == 0 && (unsigned int)v6 == 35 && (unsigned int)v10 > 0 && v7 != 0 && ((unsigned int)v9 <= 0 || (char)v17 != 0) && v25 >= v26 || (char)v23 == 0 && *((char *)*((long long *)&v0)) == 0 && (unsigned int)v6 == 35 && (unsigned int)v10 > 0 && v7 != 0 && ((unsigned int)v9 <= 0 || (char)v17 != 0) || (unsigned int)v6 == 35 && v7 != 0 && ((unsigned int)v9 <= 0 || (char)v17 != 0) || (char)v23 == 0 && (unsigned int)v6 == 35 && (unsigned int)v10 > 0 && v7 != 0 && ((unsigned int)v9 <= 0 || (char)v17 != 0) || (unsigned int)v6 == 35 && (unsigned int)v10 > 0 && v7 != 0 && ((unsigned int)v9 <= 0 || (char)v17 != 0))
        {
            *((int *)v5) = -1;
            v27 = -18446744069414584321;
        }
        else if (*((char *)*((long long *)&v0)) == 0 && (char)v17 == 0 && (unsigned int)v6 == 35 && v18 <= v24 && !(INVALID_IR) && (unsigned int)v9 > 0 && v7 != 0 || (char)v23 == 0 && *((char *)*((long long *)&v0)) == 0 && (unsigned int)v6 == 35 && (unsigned int)v10 > 0 && v7 != 0 && ((unsigned int)v9 <= 0 || (char)v17 != 0) && v25 >= v26 && INVALID_IR || v7 == 0)
        {
            *((unsigned int *)v5) = v8;
            v27 = v8 >> 31;
        }
