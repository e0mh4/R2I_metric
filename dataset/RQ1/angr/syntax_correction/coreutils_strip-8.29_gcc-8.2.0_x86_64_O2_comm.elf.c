...
int sub_401ca0()
{
    ...
    /*INVALID_EQUAL_UNDEFINED*/
undefined v2;  // [bp-0x208]
    /*INVALID_EQUAL_UNDEFINED*/
undefined v3;  // [bp-0x200]
    /*INVALID_EQUAL_UNDEFINED*/
undefined v4;  // [bp-0x1f8]
    /*INVALID_EQUAL_UNDEFINED*/
undefined v5;  // [bp-0x1f0]
        ...
        if (v9 != 0)
        {
            ...
            if (v10 != 0)
            {
                ...
                if (g_60a2cb == 0)
                {
                    ...
                    {
                        v45 = (unsigned int) amd64g_calculate_condition(0x5, 0x8, Load(addr=(Load(addr=stack_base-464, size=8, endness=Iend_LE) + 0x8), size=8, endness=Iend_LE), Load(addr=(Load(addr=stack_base-472, size=8, endness=Iend_LE) + 0x8), size=8, endness=Iend_LE), cc_ndep);
                    }
                }
                else
                {
...
int sub_401c10()
{
    ...
    if (*(&((char *)&g_60a2c5)[v1 + -1]) == 0)
    {
        ...
        if ((unsigned int)v2 > 0)
        {
            v3 = 0;
            v4 = g_60a2c0 == 1;
            v2 = error(rdi, 0x0, (unsigned long long)dcgettext(0x0, 0x406968, 0x5));
