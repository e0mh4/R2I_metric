    ...
    *((int128_t *)&v0) = *((int128_t *)&v4->field_0);
    ...
    if (v5 != 0)
    {
        ...
        do
        {
            ...
            v11 = (INVALID_IR? -1 : rbx + strlen(*((long long *)rdx)));
            v12 -= 1;
        }
        while (v12 != 1);
        if (v11 <= 2147483647)
...
int sub_404a80()
{
    ...
    {
        tmp_21 = v11 + v10 - 1;
        tmp_6 = (0 | v11 + v10 - 1) % v10;
        g_614590 = tmp_21 - (unsigned long long)(tmp_6 >> 64);
        v13 = v0;
        return (0 | v11 + v10 - 1) % v10;
    }
...
undefined v9;  // r13
    ...
    if ((unsigned int)v1 != 0 && g_6142b0 != -1 && (v4 == 0 || v5 != v6) && (v4 == 0 || v5 > v6) && (v7 != 0 || v4 != 0 || v2 != 0) && !(INVALID_IR) && v8 != 0 || (unsigned int)v1 != 0 && g_6142b0 != -1 && (v4 == 0 || v5 != v6) && (v4 == 0 || v5 > v6) && (v7 != 0 || v4 != 0 || v2 != 0) && INVALID_IR || (unsigned int)v1 == 0 && (v4 == 0 || v5 != v6) && (v4 == 0 || v5 > v6) && (v7 != 0 || v4 != 0 || v2 != 0) && g_6145bc != 0)
    {
        v10 = 0;
    }
    if (((unsigned int)v1 != 0 && g_6142b0 != -1 && (v4 == 0 || v5 != v6) && (v4 == 0 || v5 > v6) && (v7 != 0 || v4 != 0 || v2 != 0) && !(INVALID_IR) && v8 != 0 || (unsigned int)v1 != 0 && g_6142b0 != -1 && (v4 == 0 || v5 != v6) && (v4 == 0 || v5 > v6) && (v7 != 0 || v4 != 0 || v2 != 0) && INVALID_IR || (unsigned int)v1 == 0 && (v4 == 0 || v5 != v6) && (v4 == 0 || v5 > v6) && (v7 != 0 || v4 != 0 || v2 != 0) && g_6145bc != 0) && !(INVALID_IR) || (unsigned int)v1 != 0 && g_6142b0 != -1 && (v4 == 0 || v5 != v6) && (v4 == 0 || v5 > v6) && (v7 != 0 || v4 != 0 || v2 != 0) && !(INVALID_IR) && v8 == 0)
    {
...
undefined v31;  // rsi
    ...
    *((unsigned int *)&v0) = v31;
    v12 = __errno_location();
    *(v12) = 0;
    if ((0 | 9223372036854775807) % v8 >= v6)
    {
        v15 = *(v14) + v8 * v6;
        v16 = sub_4044d0();
        if (!(!(INVALID_IR)))
    ...
    if (INVALID_IR)
    {
        ...
        if (INVALID_IR && (unsigned int)v32 == 0)
        {
            sub_404e30(); /* do not return */
        }
        else if (INVALID_IR && (unsigned int)v32 != 0)
        {
            v37 = (unsigned int)sub_4084b0();
        }
        else if (v7 == 1 && !(INVALID_IR) && v7 != 0)
        {
            v21 = 0;
        }
        else if (!(INVALID_IR))
    ...
    if (INVALID_IR || (unsigned int)v10 != 0 && (0 | 9223372036854775807) % v8 >= v6)
    {
        *(v14) = 0;
        v21 = 0;
    }
    if (INVALID_IR || (unsigned int)v10 == 0 && v18 != 0 && (0 | 9223372036854775807) % v8 >= v6)
    {
        v21 = 0;
    }
    if (INVALID_IR || (0 | 9223372036854775807) % v8 < v6 && (unsigned int)0 != 0)
    {
        v37 = (unsigned int)sub_4084b0();
    }
    if (INVALID_IR || (0 | 9223372036854775807) % v8 >= v6)
    {
        return v21;
    }
    if (INVALID_IR || (0 | 9223372036854775807) % v8 < v6)
...
undefined v1;  // rdx
    ...
    while (true)
    {
        ...
        if (v8 == -1)
        {
            ...
            if (*(v6) == 22)
            {
                if (INVALID_IR || (g_614609 & 64) == 0 || g_6143b8 >= v2)
                {
                    break;
                }
                *(v6) = 0;
        ...
        if (!(INVALID_IR) && (v1 != 4 || v8 != -1) && (v8 != -1 || *(v6) != 22))
        {
            if (v8 < v2)
            {
                sub_404810();
            }
            if (INVALID_IR || g_6145a8 == 0 || g_6143b8 >= v2)
            {
                break;
            }
            if (g_6142bc != 1)
...
int sub_4044d0()
{
    ...
    if (!(INVALID_IR) && ioctl(v7, 0x80306d02, (unsigned int)&v0) == 0 && ioctl(v8, 0x80306d02, (unsigned int)&v3) == 0 && v1 == v4 && v2 == v5)
    {
        if (g_6142bc != 1)
        {
    ...
    if (v1 != 0)
    {
        while (true)
        {
            ...
            if ((g_61460c & 0x10000) != 0)
            {
                ...
                else if (*(v13) == 0 && !(INVALID_IR) && (v14 == 1 || v15 == 0) && (v14 == 1 || (v14 & 15) == 0))
                {
                    v10 += v17;
                }
            }
            if ((g_61460c & 0x10000) == 0 || !(INVALID_IR))
            {
                v17 = write(0x1, v12 + v10, v14 - v10);
            }
            if (!(INVALID_IR))
