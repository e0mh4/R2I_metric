...
undefined v2;  // r13
    ...
    while (true)
    {
        v20 = (unsigned long long)(char)*((char *)rdx);
        v6 = rdx + 1;
        if (v20 != 38)
        {
            if (v20 == 0)
    ...
    if (v3 != 0)
    {
        ...
        v9 = strlen(v8);
        v10 = 0;
        v11 =  amd64g_calculate_condition(0x2, 0x4, r12, Mul(rbx, rax), cc_ndep);
        v12 = (INVALID_IR? 1 :  amd64g_calculate_condition(0x0, 0x30, rax, rbx, cc_ndep));
        if (rsi != 0 || v12 != 0)
        {
            sub_4055b0(); /* do not return */
        }
