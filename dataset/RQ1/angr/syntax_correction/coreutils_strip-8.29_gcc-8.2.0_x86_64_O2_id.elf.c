...
undefined v47;  // r12
    ...
    while (true)
    {
        ...
        else
        {
            ...
            {
                v15  = unknown;                if ((unsigned int)v12 - g_60b2bc != 1 && (v6 != 0 || v2 != 0))
                {
...
undefined v10;  // r13
    ...
    v0 = v0;
    v10 = (unsigned int)((char)sub_402820() == 0? 0 : (unsigned int)r13);
