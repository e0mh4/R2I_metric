...
int sub_4025f0()
{
    ...
    else if (((unsigned long long)v2->field_1 - 48 & 255) <= 7)
    {
        ...
        v6 = v2->field_1 == 48;
        v13 = 0;
        v12 = &(struct struct_0 *)&(&v2->padding_0)[v7 & rax]->field_1;
        while (true)
        {
            v11 = *(v12);
            if (((unsigned long long)*(v12) - 48 & 255) <= 7)
            {
                v12 = &v12[1];
                v13 = v11 + v13 * 8 - 48;
                if (v12 == &((struct struct_0 *)&(struct struct_0 *)&(&v2->padding_0)[v7 & rax]->field_1)[1].field_1)
                {
                    break;
                }
            }
    ...
    else
    {
        if (v2->field_1 != 0)
        {
            ...
            else if ((v2->field_1 & 223) == 85)
            {
                ...
                v26 = &v2[1];
                v27 = v2->field_1 != 117;
                v39 = &((struct struct_0 *)&v2[1 + 2 * rbp].field_1)[1].field_1;
                while (true)
                {
                    v40 = *(v26);
                    v41 = *(v26);
...
int sub_402ff0()
{
    ...
    if (g_60d2a0 == 0)
    {
        ...
        {
            *(v2) = v3;
             INVALID_IR; //904:F64x8)[t2,0] = t5
             INVALID_IR; //968:I8x8)[t2,0] = 0x01
        }
        else
        {
             INVALID_IR; //904:F64x8)[t0,0] = t3
