                                ...
                                if (v20 != 0)
                                {
                                    ...
                                    else
                                    {
                                        while (true)
                                        {
                                            ...
                                            {
                                                v32 = (INVALID_IR? v27->field_8 : v27->field_10);
                                                if ((INVALID_IR? v27->field_8 : v27->field_10) != 0)
                                                {
                                                    v29 = (v27->field_18 != 0? v27 : r12);
                                                    v28 = (v27->field_18 != 0? v27 : rbp);
                                                    v27 = v32;
                                                }
                                                else
                                                {
                                                    ...
                                                    {
                                                        v35 = (unsigned int)(INVALID_IR? v3 : 1);
                                                        v36 = (INVALID_IR? v29->field_8 : v29->field_10);
                                                        v37 = (INVALID_IR? v29->field_8 : v29->field_10);
                                                        if (v33 != (INVALID_IR? v29->field_8 : v29->field_10))
                                                        {
                                                            while (true)
                                                            {
                                                                v6 = v35;
                                            ...
                                            if ((unsigned int)v30 == 0 || (INVALID_IR? v27->field_8 : v27->field_10) == 0 && (unsigned int)v34 != 0)
                                            {
                                                break;
                                            }
                                        }
