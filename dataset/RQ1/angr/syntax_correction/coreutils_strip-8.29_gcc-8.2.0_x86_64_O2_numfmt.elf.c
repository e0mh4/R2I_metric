...
int sub_403d60()
{
     INVALID_IR; //904:F64x8)[t8,0] = t12
     INVALID_IR; //968:I8x8)[t8,0] = 0x01
     INVALID_IR; //904:F64x8)[t8,2] = t5
     INVALID_IR; //968:I8x8)[t8,2] = 0x01
}
...
int sub_403c0a()
{
     INVALID_IR; //904:F64x8)[t4,2] = t5
     INVALID_IR; //968:I8x8)[t4,2] = 0x01
     INVALID_IR; //968:I8x8)[t4,0] = 0x00
     INVALID_IR; //904:F64x8)[t14,0] = t23
     INVALID_IR; //968:I8x8)[t14,0] = 0x01
     INVALID_IR; //904:F64x8)[t14,1] = t16
     INVALID_IR; //968:I8x8)[t14,1] = 0x01
     INVALID_IR; //904:F64x8)[t14,0] = t41
     INVALID_IR; //968:I8x8)[t14,0] = 0x01
     INVALID_IR; //904:F64x8)[t14,2] = t34
     INVALID_IR; //968:I8x8)[t14,2] = 0x01
}
    ...
    while (true)
    {
        ...
        if ((unsigned int)v12 == -1)
        {
            ...
            if (g_610398 == 0 || g_610370 == 0)
            {
                ...
                if (g_610370 != 0)
                {
                    ...
                    *(v5) = 0;
                    ...
                    if (*(v5) != 34)
                    {
                        if (v7 != v4 && v36 != 0)
                        {
                            if (g_610348 != 0 && g_610380 != 0 && (INVALID_IR || v31 == 0))
                            {
                                v4 = v5;
                                v5 = v36;
                ...
                if ((*(v5) != 34 && g_610370 != 0 && *((char *)v7) != 0 && ((char)v44 == 0 || *((char *)0) != 46) && (*((char *)0) != 46 || !(INVALID_IR)) && (*((char *)0) != 46 || *(v4) != 34) && (*((char *)0) != 46 || v32 != 43) && *((char *)(v25 + v40)) == 102 || (g_610348 == 0 || g_6103b0 != 0 || g_6103ac != 0 || g_610398 == 0 && g_610370 == 0 && g_610380 == 0) && g_610370 == 0) && g_610398 != 0 && g_6103ac != 0)
                {
...
int sub_403b7a()
{
     INVALID_IR; //904:F64x8)[t2,2] = t3
     INVALID_IR; //968:I8x8)[t2,2] = 0x01
     INVALID_IR; //968:I8x8)[t2,0] = 0x00
     INVALID_IR; //904:F64x8)[t12,0] = t21
     INVALID_IR; //968:I8x8)[t12,0] = 0x01
     INVALID_IR; //904:F64x8)[t12,1] = t14
     INVALID_IR; //968:I8x8)[t12,1] = 0x01
}
...
int sub_403a1d()
{
     INVALID_IR; //904:F64x8)[t5,0] = t9
     INVALID_IR; //968:I8x8)[t5,0] = 0x01
     INVALID_IR; //904:F64x8)[t5,2] = t2
     INVALID_IR; //968:I8x8)[t5,2] = 0x01
}
...
undefined v12;  // rax
        ...
        else if ((unsigned int)v9 != v12)
        {
            ...
            if ((char)v10 != 0)
            {
                *(v8) = 0;
                ...
                tmp_19 = v12;
                v12 = g_610254;
                v5 = ((tmp_19 & 255) == 0? 0 : (unsigned int)r12);
                v14 = stdout[5];
            }
        }
        else
    ...
    v17 = (unsigned int)((char)sub_402c00() == 0? 0 : (unsigned int)r12);
    return v17;
}
