        ...
        if ((v1 >> 2) + (v1 >> 2 << 1) == v17)
        {
            ...
            if (v6 != 0)
            {
                do
                {
                    ...
                    v22 = tmp_64;
                    v23 = tmp_64 >> 2;
                    *((char *)(v20 - 4)) = *((char *)(4224224 + (unsigned long long)(unsigned int)(rcx & 63)));
                    tmp_109 = v21[-2];
                    v25 = v21[-2] % 16;
                    *((char *)(v20 - 3)) = *((char *)(4224224 + (unsigned long long)((unsigned int)(tmp_64 * 16 + r8) & 63)));
                    tmp_153 = v21[-1];
                    v27 = v21[-1] % 64;
                    v28 = (char)*((char *)(4224224 + (unsigned long long)(unsigned int)(tmp_153 & 63)));
                    *((char *)(v20 - 2)) = *((char *)(4224224 + (unsigned long long)((unsigned int)(r8 + tmp_109 * 4) & 63)));
    ...
    if ((v1 >> 2) + (v1 >> 2 << 1) != v17 || (v1 & 3) != 0)
    {
        ...
        while (true)
        {
            if (v1 != 0 && v17 != 0)
            {
                ...
                v18[0] = *((char *)(4224224 + (unsigned long long)(unsigned int)(r8 & 63)));
                if (v1 == 1)
                {
                    break;
                }
                ...
                if (v17 != 1)
                {
                    ...
                    tmp_48 = (unsigned int)(v9 + r11) & 63;
                    v6 = (char)*((char *)(4224224 + (unsigned long long)((unsigned int)(v9 + r11) & 63)));
                    ...
                    if (v1 != 2)
                    {
                        ...
                        if (v17 != 2)
                        {
                            ...
                            v18[2] = *((char *)(4224224 + (unsigned long long)((unsigned int)(v13 + r11) & 63)));
            ...
            if (((char)*(v8) & 48) == 0 && v9 > 30719 || ((char)*(v8) & 48) != 0 && v9 != 0)
            {
                if (v12 != 0)
                {
                    ...
                    if (v10 != 0)
                    {
                        ...
                        while (v10 > v13 || v0 > v18 && (!(v12 - rbp <= v10 - v13)? v15 : v12 - rbp) != 0 || (!(v12 - rbp <= v10 - v13)? v15 : v12 - rbp) == 0 && v19 == -1 && v6[5] >= v6[6]);
                    }
                }
                if (v10 <= v14 || v12 != 0)
                {
    ...
    if (v2 > 1 && *(&((char *)&g_4073e0)[(unsigned long long)v3[0]]) >= 0)
    {
        ...
        if (*(&((char *)&g_4073e0)[(unsigned long long)v3[1]]) >= 0)
        {
            ...
            if (*(v6) != 0)
            {
                ...
                v9 = *(v5) + 1;
                v8 = v4 >> 4;
                *((char *)(*(v5) + 1 - 1)) = (unsigned int)((unsigned long long)(char)*(&((char *)&g_4073e0)[(unsigned long long)v3[0]]) * 4) | r10;
                *(v6) = *(v6) - 1;
            }
            if (v2 != 2 && v3[2] != 61)
            {
                ...
                if (*(&((char *)&g_4073e0)[(unsigned long long)v3[2]]) >= 0)
                {
                    if (*(v6) != 0)
                    {
                        ...
                        v9 += 1;
                        v12 = v10 >> 2;
                        *((char *)(v9 - 1)) = (unsigned int)((unsigned long long)(char)*(&((char *)&g_4073e0)[(unsigned long long)v3[1]]) * 16) | r10;
                        *(v6) = *(v6) - 1;
                    }
                    if (v2 != 3)
                    {
