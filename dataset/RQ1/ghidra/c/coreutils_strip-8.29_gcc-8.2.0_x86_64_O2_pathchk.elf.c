...
void switchD_00402310::caseD_b(void)
...
void switchD_00403dea::caseD_0(void)
...
byte FUN_00401640(int param_1,undefined8 *param_2)

{
  ...
  FUN_00405bc0(FUN_00402080);
  while (iVar3 = FUN_004052e0(param_1,param_2,&DAT_00405cdf,&PTR_s_portability_00406160),
        iVar3 != -1) {
    if (iVar3 == 0x50) {
      bVar1 = true;
    }
      ...
      if (iVar3 < 0x51) {
        if (iVar3 == -0x83) {
          FUN_004041c0(stdout,"pathchk","GNU coreutils",PTR_DAT_006091d0,"Paul Eggert",
      ...
      if (iVar3 != 0x70) {
        if (iVar3 != 0x80) goto LAB_00401c7b;
        bVar1 = true;
      }
      bVar2 = true;
    }
...
LAB_00401c7b:
  ...
  local_df = 1;
  do {
    if (param_1 <= DAT_00609238._4_4_) {
      return local_df ^ 1;
    }
    __s = (char *)param_2[DAT_00609238._4_4_];
    sVar4 = strlen(__s);
    pcVar8 = __s;
    if (bVar1) {
      while (pcVar8 = strchr(pcVar8,0x2d), pcVar8 != (char *)0x0) {
        if ((__s == pcVar8) || (pcVar8[-1] == '/')) {
          uVar9 = FUN_00403af0(4,__s);
...
LAB_00401bbf:
          ...
          error(0,0,uVar10,uVar11 - 1,sVar4,uVar9);
          bVar12 = false;
        }
        else {
          local_c8.st_dev = 0;
          uVar11 = FUN_00405360(pcVar8,sVar4 - sVar5,&local_c8);
          FUN_00403a10(0,4,__s);
          if (0x10 < uVar11) {
            uVar11 = 1;
          }
          uVar9 = FUN_00403a80(1,8,pcVar8,uVar11);
      ...
      if (bVar2) {
        if (sVar4 != 0) goto LAB_0040182b;
        goto LAB_00401adb;
      }
LAB_00401776:
      iVar3 = __lxstat(1,__s,&local_c8);
      if (iVar3 == 0) {
LAB_004019b7:
        bVar12 = true;
      }
        ...
        bVar12 = *piVar6 != 2 || sVar4 == 0;
        if (*piVar6 != 2 || sVar4 == 0) {
          uVar9 = FUN_00403bc0(0,3,__s);
          ...
          if (0xff < sVar4) {
            ...
            *piVar6 = 0;
            ...
            uVar11 = pathconf(pcVar16,4);
            if ((long)uVar11 < 0) {
              if (*piVar6 != 0) {
                uVar9 = dcgettext(0,"%s: unable to determine maximum file name length",5);
                error(0,*piVar6,uVar9,pcVar16);
                goto LAB_004017d8;
              }
            }
            else if (uVar11 <= sVar4) goto LAB_00401bbf;
          }
LAB_00401a5c:
          do {
            cVar15 = *pcVar8;
            ...
            do {
              uVar11 = uVar11 + 1;
              if (pcVar16[uVar11] == '/') break;
            } while (pcVar16[uVar11] != '\0');
            pcVar8 = pcVar16 + uVar11;
          } while (uVar11 < 0xf);
          uVar11 = 0;
LAB_00401863:
          uVar14 = 0xe;
          pcVar8 = __s;
          do {
            while (pcVar16 = pcVar8, cVar15 = *pcVar16, cVar15 == '/') {
              pcVar8 = pcVar16 + 1;
            }
            if (cVar15 == '\0') goto LAB_004019b7;
            uVar7 = uVar11;
...

{
  ...
  (*(code *)PTR___libc_start_main_00608ff0)
            (FUN_00401640,unaff_retaddr,&stack0x00000008,FUN_00405b50,FUN_00405bb0,param_3,auStack_8
            );
  do {
...

{
  ...
  fputs_unlocked(pcVar4,pFVar1);
  local_88 = &DAT_00405c2c;
  local_80 = "test invocation";
  local_78[0] = (byte *)0x405ca6;
  local_78[1] = (byte *)0x405c3e;
  local_78[2] = (byte *)0x405c54;
  local_78[3] = (byte *)0x405c5e;
  local_78[4] = (byte *)0x405c6d;
  ...
  if ((byte *)pcVar4 == (byte *)0x0) {
    ...
    pcVar8 = " invocation";
    __printf_chk(1,uVar7,"https://www.gnu.org/software/coreutils/","pathchk");
  }
  else {
    uVar7 = dcgettext(0,"\n%s online help: <%s>\n",5);
    __printf_chk(1,uVar7,"GNU coreutils","https://www.gnu.org/software/coreutils/");
...
void FUN_00402060(undefined8 param_1)
...
void FUN_00402070(undefined param_1)
...
LAB_00402f11:
  ...
  case 10:
    if (param_5 != 10) {
      param_8 = (char *)FUN_004021c0(&DAT_0040624d,param_5);
      param_9 = (char *)FUN_004021c0(&DAT_00407417);
    }
    uVar15 = 0;
    if (uVar18 == 0) {
      cVar14 = *param_8;
...
switchD_004028de_caseD_1:
    ...
    if (sVar8 != 1) {
      ...
      do {
        uVar1 = uVar22 + uVar21;
        lVar11 = FUN_00405380(&local_44,param_3 + uVar1,param_4 - uVar1,local_40);
        if (lVar11 == 0) break;
        if (lVar11 == -1) {
          bVar23 = false;
          goto LAB_004031ea;
...
undefined * FUN_004034f0(int param_1,undefined8 param_2,undefined8 param_3,undefined4 *param_4)

{
  ...
  if (DAT_00609230 <= param_1) {
    ...
    if (PTR_DAT_00609218 == &DAT_00609220) {
      puVar8 = (undefined4 *)FUN_00404360(0);
      ...
      *puVar8 = _DAT_00609220;
      ...
      puVar8 = (undefined4 *)FUN_00404360(PTR_DAT_00609218);
      PTR_DAT_00609218 = (undefined *)puVar8;
    }
...
undefined4 FUN_004036d0(undefined4 *param_1)
...
void FUN_004036e0(undefined4 *param_1,undefined4 param_2)
...
undefined4 FUN_00403730(undefined *param_1,undefined4 param_2)
...
void FUN_00403750(undefined4 *param_1,long param_2,long param_3)
...
void FUN_00403780(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
                 undefined4 *param_5)
...
undefined8 FUN_00403800(undefined8 param_1,undefined8 param_2,long *param_3,undefined4 *param_4)

{
  ...
  lVar3 = FUN_004022c0(0,0,param_1,param_2,*param_4,uVar5,param_4 + 2,*(undefined8 *)(param_4 + 10),
...
void FUN_004038f0(undefined8 param_1,undefined8 param_2,undefined8 param_3)
...
void FUN_004039a0(undefined8 param_1,undefined8 param_2)
...
void FUN_004039d0(undefined8 param_1)
...
void FUN_004039f0(undefined8 param_1,undefined8 param_2)
...
void FUN_00403a10(undefined8 param_1,int param_2,undefined8 param_3)
...
void FUN_00403a80(undefined8 param_1,int param_2,undefined8 param_3,undefined8 param_4)
...
void FUN_00403af0(undefined4 param_1,undefined8 param_2)
...
void FUN_00403b00(undefined4 param_1,undefined8 param_2,undefined8 param_3)
...
void FUN_00403b10(undefined8 param_1,undefined8 param_2,byte param_3)
...
void FUN_00403b80(undefined8 param_1,char param_2)
...
void FUN_00403b90(undefined8 param_1)
...
void FUN_00403bc0(undefined8 param_1,int param_2,undefined8 param_3)
...
void FUN_00403c30(undefined8 param_1,long param_2,long param_3,undefined8 param_4,undefined8 param_5
                 )
...
void FUN_00403cb0(undefined8 param_1,undefined8 param_2,undefined8 param_3)
...
void FUN_00403cd0(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)
...
void FUN_00403d00(undefined8 param_1,undefined8 param_2)
...
void FUN_00403d20(undefined8 param_1,undefined8 param_2)
...
void FUN_00403d40(undefined8 param_1)
...
undefined8
FUN_00403d60(FILE *param_1,long param_2,undefined8 param_3,undefined8 param_4,undefined8 *param_5,
            undefined8 param_6)

{
  ...
  uVar1 = dcgettext(0,&DAT_00406f8b,5);
...
void FUN_004043a0(undefined8 param_1,ulong param_2,ulong param_3)
...
void FUN_00404590(long param_1,int *param_2)

{
  ...
  while (iVar3 < iVar9) {
    while( true ) {
      if (iVar3 <= iVar8) goto LAB_0040460c;
      iVar10 = iVar9 - iVar3;
      iVar7 = iVar3 - iVar8;
      ...
      if (iVar9 <= iVar3) goto LAB_0040460c;
    }
    lVar6 = (long)iVar8;
    puVar5 = (undefined8 *)(param_1 + lVar6 * 8);
    do {
...
int FUN_00404670(int param_1,undefined8 *param_2,char *param_3,char **param_4,undefined4 *param_5,
...

{
  ...
  if (__s1 != (char *)0x0) {
    while( true ) {
      ...
      if ((iVar5 == 0) && (sVar7 = strlen(__s1_00), sVar7 == sVar15)) goto LAB_00404890;
      ppcVar10 = ppcVar10 + 4;
      __s1_00 = *ppcVar10;
      iVar5 = (int)uVar14 + 1;
    ...
    do {
      ...
      if (iVar6 == 0) {
        if (ppcVar10 == (char **)0x0) {
          ...
          if (param_8 == 0) {
            bVar3 = true;
            if (local_70 == (char *)0x0) goto LAB_004047d0;
          }
    ...
    if ((local_70 != (char *)0x0) || (bVar3)) {
      if (param_8 != 0) {
        if (bVar3) {
          ...
          do {
            if (*pcVar13 != '\0') {
              __fprintf_chk(__stream,1,&DAT_00407411,param_9,*param_4);
              __stream = stderr;
            }
            pcVar13 = pcVar13 + 1;
            param_4 = param_4 + 4;
...
uint FUN_00404c90(uint param_1,undefined8 *param_2,char *param_3,long param_4,undefined8 param_5,
...
LAB_00404de8:
    ...
    if (pbVar8 == (byte *)0x0) goto LAB_00404d58;
LAB_00404dfc:
    if (*pbVar8 == 0) goto LAB_00404d58;
  }
  else {
    if (param_7[6] == 0) goto LAB_00404cda;
    cVar2 = *param_3;
    pbVar8 = *(byte **)(param_7 + 8);
    if ((cVar2 - 0x2bU & 0xfd) != 0) goto LAB_00404de8;
    pcVar4 = param_3 + 1;
    param_3 = param_3 + 1;
    if (*pcVar4 == ':') {
      uVar3 = 0;
    }
    if (pbVar8 != (byte *)0x0) goto LAB_00404dfc;
LAB_00404d58:
    uVar11 = *param_7;
    ...
    if (param_4 != 0) {
      ...
      if ((int)param_6 != 0) {
        if (pbVar8[2] == 0) {
          ...
          param_6 = param_6 & 0xffffffff;
          if (pcVar4 != (char *)0x0) goto LAB_00404fd0;
        }
        *(byte **)(param_7 + 8) = pbVar8 + 1;
        uVar11 = FUN_00404670(param_1,param_2,param_3,param_4,param_5,param_6,param_7,uVar3,
                              &DAT_0040742a);
...
LAB_00404fd0:
  ...
  *(byte **)(param_7 + 8) = pbVar9;
  param_6 = 0;
  *(undefined8 *)(param_7 + 4) = 0;
  puVar15 = &DAT_00407448;
LAB_00405025:
  uVar3 = FUN_00404670(param_1,param_2,param_3,param_4,param_5,param_6,param_7,uVar3,puVar15);
  return uVar3;
}
...
void FUN_00405360(undefined8 param_1,undefined8 param_2,undefined *param_3)

{
  if (param_3 == (undefined *)0x0) {
    param_3 = &DAT_00609418;
  }
  FUN_00405380(0,param_1,param_2,param_3);
  return;
}


size_t FUN_00405380(wchar_t *param_1,byte *param_2,size_t param_3,mbstate_t *param_4)

{
  ...
  if (param_2 == (byte *)0x0) {
    param_3 = 1;
    param_2 = (byte *)0x407447;
  }
  else {
    if (param_3 == 0) {
      return 0xfffffffffffffffe;
    }
    if (param_1 != (wchar_t *)0x0) goto LAB_004053a4;
  }
  param_1 = &local_1c;
LAB_004053a4:
  sVar2 = mbrtowc(param_1,(char *)param_2,param_3,param_4);
  if ((0xfffffffffffffffd < sVar2) && (cVar1 = FUN_00405460(0), cVar1 == '\0')) {
    sVar2 = 1;
...
ulong FUN_00405400(uint *param_1)
...

{
  ...
  if (DAT_00609420 != (char *)0x0) goto LAB_004054fa;
...
LAB_004056a0:
          ...
          if (__stream->_IO_read_end <= pbVar8) goto LAB_0040582c;
          do {
            ...
            while( true ) {
              pcVar7 = __ptr;
              if ((uVar4 - 9 < 2) || (uVar4 == 0x20)) goto LAB_004056a0;
              if (uVar4 == 0x23) goto LAB_00405891;
              ungetc(uVar4,__stream);
              iVar2 = fscanf(__stream,"%50s %50s",&local_b8,&local_78);
              puVar13 = &local_b8;
              if (iVar2 < 2) goto LAB_0040583f;
              do {
                puVar10 = puVar13;
...
LAB_0040582c:
              ...
              __ptr = pcVar7;
              if (uVar4 == 0xffffffff) goto LAB_0040583f;
            }
          } while( true );
        }
        close(iVar2);
...

{
  ...
  if (-1 < iVar1) {
    ...
    if (iVar1 != 0) {
      ...
      if (_Var4 == -1) goto LAB_00405a97;
    }
    iVar1 = FUN_00405ab0(param_1);
    if (iVar1 != 0) {
...
void FUN_00405ab0(FILE *param_1)
...
ulong FUN_00405af0(FILE *param_1,__off_t param_2,int param_3)
...
/* WARNING: Removing unreachable block (ram,0x00405b83) */
/* WARNING: Removing unreachable block (ram,0x00405b88) */
...
void FUN_00405bc0(undefined8 param_1)
...
undefined8 FUN_00405bd8(undefined8 param_1,undefined8 param_2,undefined8 param_3)
