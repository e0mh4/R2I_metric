...
undefined FUN_00100810(FILE *param_1,char *param_2)

{
  ...
  if (*param_2 == '0') {
    ...
    if (__size == 0) {
      ...
      uVar3 = __fprintf_chk(*(undefined *)PTR_stderr_00300ff8,1,uVar3,param_2,pcVar2,uStack_28);
      return uVar3;
    }
    ...
    if (pcVar2 == (char *)0x0) {
      ...
      uVar3 = __fprintf_chk(*(undefined *)PTR_stderr_00300ff8,1,uVar3,__size);
      return uVar3;
    }
  }
  ...
  __fprintf_chk(*(undefined *)PTR_stderr_00300ff8,1,uVar3,pcVar4,param_2);
  free(pcVar2);
  return extraout_RAX;
}
...

{
  ...
  if (pcVar1 != (char *)0x0) {
    FUN_00100810(*(undefined *)PTR_stderr_00300ff8,pcVar1);
  }
  if (pcVar2 != (char *)0x0) {
    FUN_00100810(*(undefined *)PTR_stdin_00300fd8,pcVar2);
  }
  if (pcVar3 != (char *)0x0) {
    FUN_00100810(*(undefined *)PTR_stdout_00300fd0,pcVar3);
    return;
  }
  return;
}
...
undefined FUN_00100b0e(undefined param_1,undefined param_2,undefined param_3)
