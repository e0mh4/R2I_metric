...
void switchD_00407f3acaseD_0(void)
...
LAB_004019b8:
  do {
    while( true ) {
      while( true ) {
        while( true ) {
          iVar4 = FUN_00409690(__stream,param_2,&DAT_00409f4b,&PTR_s_binary_0040a9e0,0);
          if (iVar4 == -1) {
            _DAT_0060e2e8 = 0x3a;
            DAT_0060e2e0 = 0x38;
...
LAB_00401a39:
    ...
    if (iVar4 == -0x83) {
      FUN_00408310(stdout,"sha224sum","GNU coreutils",PTR_DAT_0060e218,"Ulrich Drepper",
...
LAB_004026bf:
  FUN_00402c90(1);
LAB_004026c9:
  __stream = (FILE *)FUN_00407d00(0,3,local_e0);
...
LAB_00401c50:
      ...
      if (iVar4 == 0) {
        ...
        __stream = (FILE *)FUN_004061c0(local_e0,"r");
        if (__stream == (FILE *)0x0) {
LAB_00402259:
          uVar11 = FUN_00407d00(0,3,local_e0);
          piVar10 = __errno_location();
...
LAB_00401fa5:
          ...
          if ((char)uVar13 == '\0') {
            ...
            error(0,0,uVar11,__stream,"SHA224");
            goto LAB_00402036;
          }
          if (DAT_0060e2dc == '\0') {
            if (lVar20 != 0) {
...
LAB_004022a8:
          ...
          if ((local_d0 | local_a8) == 0) {
            param_2 = (undefined *)(ulong)(DAT_0060e2d8 ^ 1 | (uint)(lVar20 == 0));
          }
          goto LAB_00402036;
        }
        bVar21 = *local_88;
...
LAB_00401da6:
 ...
 INVALID_JUMP; //LAB_00401d3e:
          ...
          if ((!bVar24 && !bVar25) == bVar24) {
            bVar2 = local_88[uVar14 + 6];
            lVar12 = uVar14 + 6;
            if (bVar2 == 0x20) {
              bVar2 = local_88[uVar14 + 7];
              lVar12 = uVar14 + 7;
            }
            if (bVar2 == 0x28) {
...
LAB_00401d95:
            ...
            if (DAT_0060e2db != '\0') {
              ...
              error(0,0,uVar9,uVar11,lVar6,"SHA224");
            }
            goto LAB_00401da6;
          }
...
LAB_00401f7a:
          ...
          else if ((DAT_0060e2da == '\0') || (local_89 == '\0')) {
            ...
            local_9f = DAT_0060e2dc;
            if ((DAT_0060e2dc == '\0') && (local_9f = DAT_0060e2d9, DAT_0060e2d9 == '\0')) {
              local_9f = cVar3;
              if (bVar24 == false) {
...
LAB_00401f95:
      ...
      param_2 = (undefined *)FUN_00407d00(0,3,local_e0);
...
LAB_004025d9:
      ...
      fwrite_unlocked(&DAT_00409fc6,1,2,stdout);
      FUN_00402a40(local_e0,uVar11);
      fwrite_unlocked(&DAT_00409fc9,1,4,stdout);
    ...
    do {
      ...
      __printf_chk(1,&DAT_00409fc1,*puVar1);
...

{
  ...
  *param_3 = 0;
  ...
  if ((!bVar8 && !bVar9) == bVar8) {
    ...
    iVar2 = FUN_00406020(lVar5,param_2);
    if (iVar2 != 0) {
LAB_00402be0:
...

{
  ...
  __printf_chk(1,uVar3,uVar5,"SHA224",0xe0);
  pFVar1 = stdout;
  ...
  uVar5 = dcgettext(0,
                    ...
                    ,5);
  __printf_chk(1,uVar5,"RFC 3874");
  local_88 = &DAT_00409ea4;
  local_80 = "test invocation";
  local_78[0] = (byte *)0x409f14;
  local_78[1] = (byte *)0x409eb6;
  local_78[2] = (byte *)0x409e8a;
  local_78[3] = (byte *)0x409ecc;
  local_78[4] = (byte *)0x409edb;
  ...
  if ((byte *)pcVar4 == (byte *)0x0) {
    ...
    pcVar8 = " invocation";
    __printf_chk(1,uVar5,"https://www.gnu.org/software/coreutils/","sha224sum");
  }
  else {
    uVar5 = dcgettext(0,"\n%s online help: <%s>\n",5);
    __printf_chk(1,uVar5,"GNU coreutils","https://www.gnu.org/software/coreutils/");
...
LAB_00403033:
        uVar5 = dcgettext(0,"Report %s translation bugs to <https://translationproject.org/team/>\n"
                          ,5);
        __printf_chk(1,uVar5,"sha224sum");
      }
    }
    pcVar8 = " invocation";
    uVar5 = dcgettext(0,"Full documentation at: <%s%s>\n",5);
...
void FUN_00405a60(undefined param_1,undefined param_2)
...
void FUN_00405ac0(undefined *param_1,ulong param_2,long param_3)
  ...
  if (lVar2 != 0) {
    ...
    *(ulong *)(param_3 + 0x28) = uVar9;
    if (0x40 < uVar9) {
      ...
      puVar8 = (undefined *)(lVar7 + (lVar2 + uVar4 & 0xffffffffffffffc0));
      ...
      if (uVar6 < 8) {
        if ((uVar9 & 4) == 0) {
          if (((uVar9 & 0x3f) != 0) &&
            ...
            *(undefined *)(param_3 + 0x2e + (ulong)uVar6) =
                 *(undefined *)((long)puVar8 + ((ulong)uVar6 - 2));
          }
        }
        else {
          *(undefined *)(param_3 + 0x30) = *(undefined *)puVar8;
          *(undefined *)(param_3 + 0x2c + (ulong)uVar6) =
               *(undefined *)((long)puVar8 + ((ulong)uVar6 - 4));
        }
      }
      else {
        uVar9 = param_3 + 0x38U & 0xfffffffffffffff8;
        *(undefined *)(param_3 + 0x30) = *puVar8;
        *(undefined *)(param_3 + 0x28 + (ulong)uVar6) =
             *(undefined *)((long)puVar8 + ((ulong)uVar6 - 8));
        lVar7 = lVar7 - uVar9;
        ...
        if (7 < uVar6) {
          ...
          do {
            uVar10 = (ulong)uVar5;
            uVar5 = uVar5 + 8;
            *(undefined *)(uVar9 + uVar10) = *(undefined *)((long)puVar8 + (uVar10 - lVar7));
          } while (uVar5 < uVar6);
        }
      }
    }
    ...
    if (((ulong)param_1 & 3) != 0) {
      if (param_2 != 0x40) {
        ...
        do {
          ...
          *(undefined *)(param_3 + 0x38) = uVar3;
          uVar3 = param_1[3];
          *(undefined *)(param_3 + 0x40) = param_1[2];
          *(undefined *)(param_3 + 0x48) = uVar3;
          uVar3 = param_1[5];
          *(undefined *)(param_3 + 0x50) = param_1[4];
          *(undefined *)(param_3 + 0x58) = uVar3;
          uVar3 = param_1[7];
          *(undefined *)(param_3 + 0x60) = param_1[6];
          *(undefined *)(param_3 + 0x68) = uVar3;
          FUN_00403200((undefined *)(param_3 + 0x30),0x40,param_3);
          param_1 = puVar8;
...
LAB_00405b6b:
  ...
  lVar2 = *(long *)(param_3 + 0x28);
  puVar1 = (undefined *)((long)__dest + lVar2);
  uVar6 = (uint)param_2;
  if (uVar6 < 8) {
    if ((param_2 & 4) == 0) {
    ...
    if (7 < uVar6) {
      ...
      do {
        ...
        *(undefined *)(((ulong)(puVar1 + 1) & 0xfffffffffffffff8) + uVar4) =
             *(undefined *)((long)puVar8 + (uVar4 - lVar7));
      } while (uVar5 < uVar6);
    }
  }
...
void FUN_00405dc0(undefined param_1,undefined param_2,undefined param_3)
...
void FUN_00405e40(undefined param_1,undefined param_2,undefined param_3)
...
undefined FUN_00405ec0(FILE *param_1,undefined param_2)
...
undefined FUN_00406020(FILE *param_1,undefined param_2)
...

{
  ...
  puVar8 = (undefined *)PTR_DAT_0060e278;
  if (DAT_0060e290 <= param_1) {
    ...
    if (PTR_DAT_0060e278 == &DAT_0060e280) {
      puVar8 = (undefined *)FUN_004084b0(0);
      ...
      *puVar8 = _DAT_0060e280;
      ...
      puVar8 = (undefined *)FUN_004084b0(PTR_DAT_0060e278);
      PTR_DAT_0060e278 = (undefined *)puVar8;
    }
...
void FUN_00407ea0(undefined param_1)
...
undefined
FUN_00407eb0(FILE *param_1,long param_2,undefined param_3,undefined param_4,undefined *param_5,
            undefined param_6)
...
void FUN_004084f0(undefined param_1,ulong param_2,ulong param_3)
...
int FUN_00408a20(int param_1,undefined *param_2,char *param_3,char **param_4,undefined *param_5,
...
uint FUN_00409040(uint param_1,undefined *param_2,char *param_3,long param_4,undefined param_5,
