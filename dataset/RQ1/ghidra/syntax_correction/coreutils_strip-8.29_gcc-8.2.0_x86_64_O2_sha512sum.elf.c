...
void switchD_00407b20caseD_b(void)
...
void switchD_0040960acaseD_0(void)
...
LAB_00401a39:
    ...
    if (iVar4 == -0x83) {
      FUN_004099e0(stdout,"sha512sum","GNU coreutils",PTR_DAT_0060f218,"Ulrich Drepper",
...
LAB_004026bf:
  FUN_00402c90(1);
LAB_004026c9:
  __stream = (FILE *)FUN_004093d0(0,3,local_140);
  uVar11 = dcgettext(0,"%s: no file was verified",5);
  error(0,0,uVar11,__stream);
LAB_00402036:
  uVar5 = (uint)param_2 & 1;
LAB_0040203b:
  local_100 = local_100 & (byte)uVar5;
LAB_004021b1:
  do {
    local_148 = local_148 + 1;
    if (local_148 < local_110) goto LAB_00401c50;
LAB_004021c5:
...
LAB_00401bdb:
    while( true ) {
      ...
      local_110 = (char **)(param_2 + (int)__stream);
      lVar6 = (long)DAT_0060f29c;
      if (DAT_0060f29c == (int)__stream) {
        *local_110 = "-";
        local_110 = local_110 + 1;
      }
      local_148 = (char **)(param_2 + lVar6);
      if (local_110 <= local_148) {
        local_100 = 1;
        goto LAB_004021c5;
      }
      local_100 = 1;
      local_135 = (byte)pbVar22;
      local_fe = (char)uVar13;
      local_fc = (-(uint)((int)lVar20 == 0) & 0xfffffff6) + 0x2a;
      local_fd = (char)local_fc;
LAB_00401c50:
      local_140 = *local_148;
      if (local_135 == 0) break;
      iVar4 = strcmp(local_140,"-");
      if (iVar4 == 0) {
        DAT_0060f2f0 = '\x01';
        ...
        __stream = (FILE *)FUN_00407890(local_140,"r");
        if (__stream == (FILE *)0x0) {
LAB_00402259:
          uVar11 = FUN_004093d0(0,3,local_140);
          piVar10 = __errno_location();
      ...
      local_130 = 0;
      do {
        _Var7 = __getdelim((char **)&local_e8,&local_e0,10,__stream);
        pbVar23 = local_e8;
        if (_Var7 < 1) {
LAB_00401fa5:
          free(local_e8);
          ...
          if ((char)uVar13 == '\0') {
            ...
            error(0,0,uVar11,__stream,"SHA512");
            goto LAB_00402036;
          }
          if (DAT_0060f2dc == '\0') {
            if (lVar20 != 0) {
            ...
            if (local_130 != 0) {
              uVar11 = dcngettext(0,"WARNING: %lu listed file could not be read",
                                  "WARNING: %lu listed files could not be read",local_130,5);
              error(0,0,uVar11,local_130);
              uVar13 = local_130;
            }
            if (local_108 != 0) {
              uVar11 = dcngettext(0,"WARNING: %lu computed checksum did NOT match",
                                  "WARNING: %lu computed checksums did NOT match",local_108,5);
              error(0,0,uVar11,local_108);
              uVar13 = local_108;
            }
            if (DAT_0060f2da == '\0') goto LAB_004022a8;
            if (local_ff == '\0') goto LAB_004026c9;
          }
          else {
LAB_004022a8:
            if (local_ff == '\0') goto LAB_00402036;
          }
          if ((local_130 | local_108) == 0) {
            param_2 = (undefined *)(ulong)(DAT_0060f2d8 ^ 1 | (uint)(lVar20 == 0));
          }
          goto LAB_00402036;
        }
        bVar21 = *local_e8;
...
INVALID_JUMP; //LAB_00401d3e:
          ...
          if ((!bVar24 && !bVar25) == bVar24) {
            bVar2 = local_e8[uVar14 + 6];
            lVar12 = uVar14 + 6;
            if (bVar2 == 0x20) {
              bVar2 = local_e8[uVar14 + 7];
              lVar12 = uVar14 + 7;
            }
            if (bVar2 == 0x28) {
              lVar19 = _Var7 - (lVar12 + 1);
              if (lVar19 != 0) {
                pbVar23 = local_e8 + lVar12 + 1;
                lVar12 = lVar19 + -1;
                if (lVar12 == 0) {
LAB_00402229:
...
LAB_00402441:
          ...
          cVar3 = FUN_00402af0(pbVar23,local_88,&local_e9);
          if (cVar3 == '\0') {
...
LAB_00401f7a:
          ...
          else if ((DAT_0060f2da == '\0') || (local_e9 == '\0')) {
            ...
            if (uVar13 == 0) {
              ...
              do {
                if (((*pp_Var8)[pbVar22[uVar15 * 2]] !=
                     (int)"0123456789abcdef"[local_88[uVar15] >> 4]) ||
                   ((*pp_Var8)[pbVar22[uVar15 * 2 + 1]] !=
                    (int)"0123456789abcdef"[local_88[uVar15] & 0xf])) {
            ...
            local_ff = DAT_0060f2dc;
            if ((DAT_0060f2dc == '\0') && (local_ff = DAT_0060f2d9, DAT_0060f2d9 == '\0')) {
              local_ff = cVar3;
              if (bVar24 == false) {
...
LAB_00401f95:
          uVar13 = (ulong)local_135;
          bVar21 = *(byte *)&__stream->_flags;
        }
        if ((bVar21 & 0x30) != 0) goto LAB_00401fa5;
        lVar6 = lVar6 + 1;
      } while (lVar6 != 0);
      param_2 = (undefined *)FUN_004093d0(0,3,local_140);
...
joined_r0x00401bb0:
    ...
    cVar3 = FUN_00402af0(local_140,local_d8,local_88);
    if (cVar3 == '\0') {
      local_100 = 0;
      goto LAB_004021b1;
    }
    pcVar17 = strchr(local_140,0x5c);
    if ((pcVar17 == (char *)0x0) && (pcVar17 = strchr(local_140,10), pcVar17 == (char *)0x0)) {
      uVar11 = 0;
      if (local_fe != '\0') goto LAB_004025d9;
joined_r0x0040236f:
...

{
  ...
  *param_3 = 0;
  ...
  if ((!bVar8 && !bVar9) == bVar8) {
    ...
    iVar2 = FUN_00407510(lVar5,param_2);
    if (iVar2 != 0) {
LAB_00402be0:
...

{
  ...
  __printf_chk(1,uVar3,uVar5,"SHA512",0x200);
  pFVar1 = stdout;
  ...
  if ((byte *)pcVar4 == (byte *)0x0) {
    ...
    pcVar8 = " invocation";
    __printf_chk(1,uVar5,"https://www.gnu.org/software/coreutils/","sha512sum");
  }
  else {
    uVar5 = dcgettext(0,"\n%s online help: <%s>\n",5);
    __printf_chk(1,uVar5,"GNU coreutils","https://www.gnu.org/software/coreutils/");
...
LAB_00403033:
        uVar5 = dcgettext(0,"Report %s translation bugs to <https://translationproject.org/team/>\n"
                          ,5);
        __printf_chk(1,uVar5,"sha512sum");
      }
    }
    pcVar8 = " invocation";
    uVar5 = dcgettext(0,"Full documentation at: <%s%s>\n",5);
...
void FUN_004031b0(undefined *param_1)
...
void FUN_00407000(undefined param_1,undefined param_2)
...
void FUN_00407030(undefined param_1,undefined param_2)
...
void FUN_00407060(undefined *param_1,ulong param_2,long param_3)

{
  ...
  if (lVar1 != 0) {
    ...
    *(ulong *)(param_3 + 0x50) = uVar7;
    if (0x80 < uVar7) {
      ...
      puVar6 = (undefined *)(lVar5 + (lVar1 + uVar3 & 0xffffffffffffff80));
      ...
      if (uVar4 < 8) {
        if ((uVar7 & 4) == 0) {
          if (((uVar7 & 0x7f) != 0) &&
            ...
            *(undefined *)(param_3 + 0x56 + (ulong)uVar4) =
                 *(undefined *)((long)puVar6 + ((ulong)uVar4 - 2));
          }
        }
        else {
          *(undefined *)(param_3 + 0x58) = *(undefined *)puVar6;
          *(undefined *)(param_3 + 0x54 + (ulong)uVar4) =
               *(undefined *)((long)puVar6 + ((ulong)uVar4 - 4));
        }
      }
      else {
        puVar8 = (undefined *)(param_3 + 0x60U & 0xfffffffffffffff8);
        *(undefined *)(param_3 + 0x58) = *puVar6;
        *(undefined *)(param_3 + 0x50 + (ulong)uVar4) =
             *(undefined *)((long)puVar6 + ((ulong)uVar4 - 8));
        lVar5 = lVar5 - (long)puVar8;
        puVar6 = (undefined *)((long)puVar6 - lVar5);
    ...
    param_1 = (undefined *)((long)param_1 + uVar3);
  ...
  if (0x7f < param_2) {
    if (((ulong)param_1 & 7) != 0) {
      if (param_2 != 0x80) {
        ...
        do {
          uVar2 = param_1[1];
          puVar6 = param_1 + 0x10;
          *(undefined *)(param_3 + 0x58) = *param_1;
          *(undefined *)(param_3 + 0x60) = uVar2;
          uVar2 = param_1[3];
          *(undefined *)(param_3 + 0x68) = param_1[2];
          *(undefined *)(param_3 + 0x70) = uVar2;
          uVar2 = param_1[5];
          *(undefined *)(param_3 + 0x78) = param_1[4];
          *(undefined *)(param_3 + 0x80) = uVar2;
          uVar2 = param_1[7];
          *(undefined *)(param_3 + 0x88) = param_1[6];
          *(undefined *)(param_3 + 0x90) = uVar2;
          uVar2 = param_1[9];
          *(undefined *)(param_3 + 0x98) = param_1[8];
          *(undefined *)(param_3 + 0xa0) = uVar2;
          uVar2 = param_1[0xb];
          *(undefined *)(param_3 + 0xa8) = param_1[10];
          *(undefined *)(param_3 + 0xb0) = uVar2;
          uVar2 = param_1[0xd];
          *(undefined *)(param_3 + 0xb8) = param_1[0xc];
          *(undefined *)(param_3 + 0xc0) = uVar2;
          uVar2 = param_1[0xf];
          *(undefined *)(param_3 + 200) = param_1[0xe];
          *(undefined *)(param_3 + 0xd0) = uVar2;
          FUN_00403280((undefined *)(param_3 + 0x58),0x80,param_3);
          param_1 = puVar6;
    ...
    puVar6 = (undefined *)((long)param_1 + (param_2 & 0xffffffffffffff80));
...
LAB_00407137:
  ...
  lVar1 = *(long *)(param_3 + 0x50);
  puVar8 = (undefined *)((long)__dest + lVar1);
  uVar4 = (uint)param_2;
  if (uVar4 < 8) {
    if ((param_2 & 4) == 0) {
      if ((uVar4 != 0) && (*(undefined *)puVar8 = *(undefined *)puVar6, (param_2 & 2) != 0)) {
        *(undefined *)((long)puVar8 + ((param_2 & 0xffffffff) - 2)) =
             *(undefined *)((long)puVar6 + ((param_2 & 0xffffffff) - 2));
      }
    }
    else {
      *(undefined *)puVar8 = *(undefined *)puVar6;
      *(undefined *)((long)puVar8 + ((param_2 & 0xffffffff) - 4)) =
           *(undefined *)((long)puVar6 + ((param_2 & 0xffffffff) - 4));
    }
  }
  else {
    *puVar8 = *puVar6;
    *(undefined *)((long)puVar8 + ((param_2 & 0xffffffff) - 8)) =
         *(undefined *)((long)puVar6 + ((param_2 & 0xffffffff) - 8));
    lVar5 = (long)puVar8 - (long)(undefined *)((ulong)(puVar8 + 1) & 0xfffffffffffffff8);
    puVar6 = (undefined *)((long)puVar6 - lVar5);
...
void FUN_00407370(undefined param_1,undefined param_2,undefined param_3)
...
void FUN_00407440(undefined param_1,undefined param_2,undefined param_3)
...
undefined FUN_00407510(FILE *param_1,undefined param_2)
...
undefined FUN_004076b0(FILE *param_1,undefined param_2)
...
undefined * FUN_00408d00(int param_1,undefined param_2,undefined param_3,undefined *param_4)

{
  ...
  puVar8 = (undefined *)PTR_DAT_0060f278;
  if (DAT_0060f290 <= param_1) {
    ...
    if (PTR_DAT_0060f278 == &DAT_0060f280) {
      puVar8 = (undefined *)FUN_00409b80(0);
      ...
      *puVar8 = _DAT_0060f280;
      ...
      puVar8 = (undefined *)FUN_00409b80(PTR_DAT_0060f278);
      PTR_DAT_0060f278 = (undefined *)puVar8;
    }
...
undefined FUN_00408ee0(undefined *param_1)

{
  if (param_1 == (undefined *)0x0) {
    param_1 = (undefined *)&DAT_0060f420;
  }
  return *param_1;
}
...
undefined FUN_00408f40(undefined *param_1,undefined param_2)
...
void FUN_00408f60(undefined *param_1,long param_2,long param_3)
...
void FUN_00408f90(undefined param_1,undefined param_2,undefined param_3,undefined param_4,
                 undefined *param_5)

{
  ...
  if (param_5 == (undefined *)0x0) {
    param_5 = (undefined *)&DAT_0060f420;
  }
  piVar2 = __errno_location();
  iVar1 = *piVar2;
...
undefined FUN_00409010(undefined param_1,undefined param_2,long *param_3,undefined *param_4)

{
  ...
  if (param_4 == (undefined *)0x0) {
    param_4 = (undefined *)&DAT_0060f420;
  }
  piVar2 = __errno_location();
  iVar1 = *piVar2;
  uVar5 = (uint)(param_3 == (long *)0x0) | param_4[1];
  lVar3 = FUN_00407ad0(0,0,param_1,param_2,*param_4,uVar5,param_4 + 2,*(undefined *)(param_4 + 10),
...
void FUN_00409100(undefined param_1,undefined param_2,undefined param_3)
...
void FUN_004091b0(undefined param_1,undefined param_2)
...
void FUN_004091e0(undefined param_1)
...
void FUN_00409200(undefined param_1,undefined param_2)
...
void FUN_00409220(undefined param_1,int param_2,undefined param_3)
...
void FUN_00409290(undefined param_1,int param_2,undefined param_3,undefined param_4)
...
void FUN_00409300(undefined param_1,undefined param_2)
...
void FUN_00409310(undefined param_1,undefined param_2,undefined param_3)
...
void FUN_00409320(undefined param_1,undefined param_2,byte param_3)
...
void FUN_00409390(undefined param_1,char param_2)
...
void FUN_004093a0(undefined param_1)
...
void FUN_004093c0(undefined param_1,undefined param_2)
...
void FUN_004093d0(undefined param_1,int param_2,undefined param_3)
...
void FUN_00409440(undefined param_1,long param_2,long param_3,undefined param_4,undefined param_5
                 )
...
void FUN_004094c0(undefined param_1,undefined param_2,undefined param_3)
...
void FUN_004094e0(undefined param_1,undefined param_2,undefined param_3,undefined param_4)
...
void FUN_00409510(undefined param_1,undefined param_2)
...
void FUN_00409530(undefined param_1,undefined param_2)
...
void FUN_00409550(undefined param_1)
...
void FUN_00409570(undefined param_1)
...
undefined
FUN_00409580(FILE *param_1,long param_2,undefined param_3,undefined param_4,undefined *param_5,
            undefined param_6)
...
void FUN_00409bc0(undefined param_1,ulong param_2,ulong param_3)
...
int FUN_0040a0f0(int param_1,undefined *param_2,char *param_3,char **param_4,undefined *param_5,
...
uint FUN_0040a710(uint param_1,undefined *param_2,char *param_3,long param_4,undefined param_5,
...
void FUN_0040b500(undefined param_1)
...
undefined FUN_0040b518(undefined param_1,undefined param_2,undefined param_3)
