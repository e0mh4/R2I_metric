...
int64_t function_401940(int64_t a1, int64_t a2, int64_t a3, int64_t a4) {
                ...
                if (v8 > 119) {
                    ...
                    if (v8 != 98) {
                        if (v8 <= 98) {
                            if (v8 == -131) {
                                // 0x401a67
                                function_408310((int64_t)g28, "sha224sum", "GNU coreutils", (int64_t)g17, "Ulrich Drepper", "Scott Miller");
                                exit(0);
                                // UNREACHABLE
                            }
                            if (v8 == -130) {
  ...
  lab_0x401d3e:;
    ...
    if (v35 == 9) {
        ...
        v44 = v35 != 92 ? 0 : v51;
        v45 = v53 + v39;
        int64_t v54 = (int64_t)"SHA224"; // 0x401940
  ...
  lab_0x4025d9:;
    ...
    fwrite_unlocked((int64_t *)"SHA224", 1, 6, stream);
...
int64_t function_402af0(int64_t a1, int64_t * a2, int64_t * a3) {
    ...
    *(char *)a3 = 0;
    ...
    if ((v8 >= v12 && !v11) != v8 < v12) {
        ...
        int64_t v15 = function_406020(v14, v2); // 0x402b8f
        v13 = v14;
        if ((int32_t)v15 == 0) {
        ...
        int64_t v17 = function_406020(v16, v2); // 0x402b3c
        v13 = v16;
        if ((int32_t)v17 == 0) {
            // 0x402b4f
            return 1;
