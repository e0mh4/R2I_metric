...
// Address range: 0x4015a0 - 0x401702
int64_t function_4015a0(int64_t a1, int64_t a2) {
    uint64_t v1 = a1 & 0xffffffff; // 0x4015a1
    function_401cb0(a2);
    ...
    function_401ba0(v1, a2, "unlink", "GNU coreutils", (int64_t)g19, 0x4017f0);
    int64_t v3 = function_404e70(v1, a2, (int64_t *)&g12, &g2, 0, 0x4017f0); // 0x401621
    if ((int32_t)v3 != -1) {
        // 0x40167a
        function_4017f0(1);
        // UNREACHABLE
    }
    uint32_t v4 = *(int32_t *)0x60923c; // 0x40162d
    if (v1 <= (int64_t)v4) {
        // 0x40165b
    ...
    int64_t v5 = a2; // 0x40163f
    if (v1 <= (int64_t)(v4 + 1)) {
        // 0x401645
        if (unlink((char *)*(int64_t *)(8 * (int64_t)v4 + a2)) == 0) {
            // 0x401652
            return 0;
        }
        // 0x401684
        function_403680(4, *(int64_t *)(8 * (int64_t)g28 + a2));
        char * format = dcgettext(NULL, "cannot unlink %s", 5); // 0x4016a8
        v5 = (int64_t)format;
        error(1, *__errno_location(), format);
    }
    // 0x4016c9
    function_4038d0(*(int64_t *)(v5 + 8 + 8 * v5));
...
int64_t entry_point(int64_t a1, int64_t a2, int64_t a3, int64_t a4) {
    // 0x401710
    int64_t v1; // 0x401710
    __libc_start_main(0x4015a0, (int32_t)a4, (char **)&v1, (void (*)())0x4056c0, (void (*)())0x405720, (void (*)())a3);
    __asm_hlt();
    // UNREACHABLE
}
...
int64_t function_4017f0(int64_t a1) {
    ...
    fputs_unlocked(dcgettext(NULL, "Call the unlink function to remove the specified FILE.\n\n", 5), g30);
    fputs_unlocked(dcgettext(NULL, "      --help     display this help and exit\n", 5), g30);
    fputs_unlocked(dcgettext(NULL, "      --version  output version information and exit\n", 5), g30);
    int64_t v1 = &g1; // bp-136, 0x4018c0
    bool v2; // 0x4017f0
    int64_t v3 = v2 ? -1 : 1;
    int64_t v4 = &v1;
    int64_t v5 = v4 + 16; // 0x401940
    int64_t v6 = *(int64_t *)v5; // 0x401944
    int64_t v7 = 7; // 0x40194a
    while (v6 != 0) {
        int64_t v8 = (int64_t)"unlink";
        int64_t v9 = v6;
