...
LABEL_20:
  ...
  {
    v8 = (const char *)sub_404B50(0LL, 3LL, "-");
    v9 = __errno_location();
    error(1, *v9, "%s", v8);
    goto LABEL_20;
  }
...
__int64 __fastcall sub_401C30(char *file, int a2)
{
  ...
  int *v18; // rax
  const char *v19; // rcx
  __int64 v20; // [rsp+0h] [rbp-22C8h] BYREF
  char buf[8248]; // [rsp+290h] [rbp-2038h] BYREF
...
LABEL_19:
  ...
  if ( v3 && close(v4) )
    goto LABEL_19;
  v10 = (const char *)sub_402520(i, &v20, 0LL, 1LL, 512LL);
  __printf_chk(
    1LL,
    "%d %s",
    (unsigned int)(unsigned __int16)(v5 + HIWORD(v5)) + ((int)((unsigned __int16)v5 + HIWORD(v5)) >> 16),
    v10);
  if ( a2 )
    __printf_chk(1LL, " %s", file);
...
__int64 __fastcall sub_401E10(char *filename, int a2)
{
  ...
  int *v19; // rax
  const char *v20; // rcx
  __int64 v21; // [rsp+0h] [rbp-2C8h] BYREF
  ...
  v7 = 0;
  sub_402430(v5, 2LL);
  IO_read_end = v5->_IO_read_end;
  IO_read_ptr = v5->_IO_read_ptr;
  while ( 1 )
  {
    if ( IO_read_end > IO_read_ptr )
    {
      v10 = IO_read_ptr + 1;
      v5->_IO_read_ptr = IO_read_ptr + 1;
      LOWORD(IO_read_ptr) = (unsigned __int8)*IO_read_ptr;
      goto LABEL_5;
    }
    LODWORD(IO_read_ptr) = __uflow(v5);
    if ( (_DWORD)IO_read_ptr == -1 )
      break;
    IO_read_end = v5->_IO_read_end;
    v10 = v5->_IO_read_ptr;
LABEL_5:
    ++v6;
    LOWORD(v7) = (_WORD)IO_read_ptr + (v7 >> 1) + ((_WORD)v7 << 15);
    IO_read_ptr = v10;
  ...
  if ( (v5->_flags & 0x20) == 0 )
  {
    ...
    {
      v11 = (const char *)sub_402520(v6, &v21, 0LL, 1LL, 1024LL);
      __printf_chk(1LL, "%05d %5s", (unsigned int)v7, v11);
      if ( a2 > 1 )
        __printf_chk(1LL, " %s", filename);
      IO_write_ptr = stdout->_IO_write_ptr;
      v13 = 1;
      if ( IO_write_ptr >= stdout->_IO_write_end )
      {
...
LABEL_17:
    v15 = sub_404B50(0LL, 3LL, filename);
  ...
  v18 = sub_404B50(0LL, 3LL, filename);
...
void __fastcall __noreturn sub_402020(int status)
{
  __int64 v2; // rbp
  char *v3; // rax
  char *v4; // rax
  ...
  v5 = stdout;
  v6 = dcgettext(0LL, "Print checksum and block counts for each FILE.\n", 5);
  ...
  do
    v15 += 2;
  while ( *v15 && memcmp("sum", (const void *)*v15, 4uLL) );
  v16 = v15[1];
  if ( v16 )
  {
    v17 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v17, &unk_407449, "https://www.gnu.org/software/coreutils/");
    v18 = setlocale(5, 0LL);
  ...
  {
    v22 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v22, &unk_407449, "https://www.gnu.org/software/coreutils/");
    v23 = setlocale(5, 0LL);
    if ( !v23 || !strncmp(v23, "en_", 3uLL) )
    {
      ...
      __printf_chk(1LL, v24, "https://www.gnu.org/software/coreutils/", 4224046LL);
LABEL_12:
...
LABEL_3:
  ...
  __printf_chk(1LL, v25, 4224046LL);
LABEL_10:
  v19 = "Multi-call invocation" + 10;
  v20 = dcgettext(0LL, "Full documentation at: <%s%s>\n", 5);
  __printf_chk(1LL, v20, "https://www.gnu.org/software/coreutils/", 4224046LL);
  if ( v16 != 4224046 )
    v19 = "";
  goto LABEL_12;
}
...
long double __fastcall sub_402460(int a1, long double a2)
{
...
char *__fastcall sub_402520(__int64 a1, __int64 a2, __int16 a3, unsigned __int64 a4, unsigned __int64 a5)
{
  struct lconv *v7; // rax
...
unsigned __int64 __fastcall sub_403250(
        _BYTE *a1,
        unsigned __int64 a2,
        __int64 a3,
        unsigned __int64 a4,
...
LABEL_4:
        ...
        if ( !(_BYTE)a5 )
        {
          ...
          if ( v41 )
          {
            ...
            {
              if ( v63 )
                return sub_403250((int)v9, v83, a3, v16, 5, a6, a7, (__int64)a8, a9);
              v42 = v83 != 0 && v10 == 0;
              if ( v42 )
              {
                v10 = v83;
...
LABEL_277:
              v30 = v18;
              LODWORD(v13) = v16;
              return sub_403250((int)v9, v10, a3, v13, v30, a6 & 0xFFFFFFFD, 0LL, (__int64)a8, a9);
            }
          }
        }
        LOBYTE(v22) = *v19;
...
LABEL_23:
      ...
      {
        v45 = (char *)v44 + v17;
        v25 = (const unsigned __int16 **)sub_4068B0((wchar_t *)&wc, (char *)v44 + v17 + a3);
        v46 = v25;
        if ( !v25 )
        {
LABEL_245:
...
_BYTE *__fastcall sub_404480(int a1, __int64 a2, unsigned __int64 a3, __int64 a4)
{
  int *v6; // rax
  __m128i *v7; // rbx
  int *v8; // r13
  ...
  v21 = *(_DWORD *)(a4 + 4) | 1;
  v18 = *v10;
  v12 = sub_403250(v11, *v10, a2, a3, *(_DWORD *)a4, v21, a4 + 8, *(char **)(a4 + 40), *(char **)(a4 + 48));
  if ( v18 <= v12 )
  {
    v13 = v12 + 1;
    *v10 = v12 + 1;
    ...
    v11 = v14;
    sub_403250(v14, v13, a2, a3, v15, v21, a4 + 8, *(char **)(a4 + 40), *(char **)(a4 + 48));
  }
  *v8 = v20;
  return v11;
}
...
__int64 __fastcall sub_404620(__int128 *a1)
{
  __int128 *v1; // rbx
  int *v2; // rax
  int v3; // r12d
...
unsigned __int64 __fastcall sub_404710(_BYTE *a1, unsigned __int64 a2, __int64 a3, unsigned __int64 a4, __int128 *a5)
{
  __int128 *v6; // rbx
  int *v7; // rax
  int v8; // r12d
...
_BYTE *__fastcall sub_404790(__int64 a1, unsigned __int64 a2, unsigned __int64 *a3, __int128 *a4)
{
  __int128 *v5; // rbx
  int *v6; // r13
  int v7; // ebp
  ...
  v9 = *v6;
  v11 = sub_403250(0LL, 0LL, a1, a2, *(_DWORD *)v5, v7, (__int64)v5 + 8, *((char **)v5 + 5), *((char **)v5 + 6));
  v10 = (_BYTE *)sub_4052F0(v11 + 1);
  sub_403250(v10, v11 + 1, a1, a2, *(_DWORD *)v5, v7, (__int64)v5 + 8, *((char **)v5 + 5), *((char **)v5 + 6));
  *v6 = v9;
  if ( a3 )
    *a3 = v11;
  return v10;
...
void sub_404890()
{
  ...
  if ( v4 != &unk_60B300 )
  {
    ...
    *((_QWORD *)&xmmword_60B260 + 1) = &unk_60B300;
  }
...
_BYTE *__fastcall sub_4049A0(int a1, int a2, __int64 a3)
{
...
_BYTE *__fastcall sub_404A10(int a1, int a2, __int64 a3, unsigned __int64 a4)
{
...
_BYTE *__fastcall sub_404AA0(__int64 a1, unsigned __int64 a2, unsigned __int8 a3)
{
  _DWORD *v3; // r8
  ...
  v6 = qword_60B430;
  v5[0] = (__int128)_mm_load_si128((const __m128i *)&xmmword_60B400);
  v5[1] = (__int128)_mm_load_si128((const __m128i *)&xmmword_60B410);
  v3 = (_DWORD *)v5 + (a3 >> 5) + 2;
  v5[2] = (__int128)_mm_load_si128((const __m128i *)&xmmword_60B420);
  *v3 ^= (((*v3 >> (a3 & 0x1F)) & 1) == 0) << (a3 & 0x1F);
  return sub_404480(0, a1, a2, (__int64)v5);
}

_BYTE *__fastcall sub_404B20(__int64 a1)
{
  return sub_404AA0(a1, 0xFFFFFFFFFFFFFFFFLL, 0x3Au);
}

_BYTE *__fastcall sub_404B50(int a1, int a2, __int64 a3)
{
  int v4[2]; // [rsp+0h] [rbp-48h] BYREF
  __int64 v5; // [rsp+8h] [rbp-40h]
  __int64 v6; // [rsp+10h] [rbp-38h]
...
_BYTE *__fastcall sub_404BC0(int a1, __int64 a2, __int64 a3, __int64 a4, unsigned __int64 a5)
{
  __int128 v6[2]; // [rsp+0h] [rbp-48h] BYREF
  __m128i si128; // [rsp+20h] [rbp-28h]
  __int64 v8; // [rsp+30h] [rbp-18h]

  v6[0] = (__int128)_mm_load_si128((const __m128i *)&xmmword_60B400);
  v6[1] = (__int128)_mm_load_si128((const __m128i *)&xmmword_60B410);
  si128 = _mm_load_si128((const __m128i *)&xmmword_60B420);
  v8 = qword_60B430;
  LODWORD(v6[0]) = 10;
  if ( !a2 || !a3 )
    abort();
...
_BYTE *__fastcall sub_404CB0(int a1, __int64 a2)
{
  return sub_404480(a1, a2, 0xFFFFFFFFFFFFFFFFLL, (__int64)&unk_60B220);
}

_BYTE *__fastcall sub_404CD0(__int64 a1)
{
...
int sub_405270()
{
  ...
  __printf_chk(1LL, v1, &unk_407449, "https://www.gnu.org/software/coreutils/");
  v2 = stdout;
...
__int64 __fastcall sub_405580(char *nptr, char **a2, unsigned int a3, __int64 *a4, const char *a5)
{
  char **p_endptr; // r15
  int *v8; // rax
  int *v9; // r12
...
__int64 __fastcall sub_4061E0(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5, int a6, int *a7, int a8)
{
  int v8; // r13d
  int v9; // eax
  int v10; // ebp
    ...
    if ( *(_BYTE *)v17 == 45 )
    {
      ...
      if ( v30 )
      {
        if ( a4 )
        {
          ...
          {
            *((_QWORD *)a7 + 4) = v17 + 2;
            return (unsigned int)sub_405BC0(a1, a2, v12, a4, a5, a6, a7, v8, (__int64)"--");
          }
          if ( a6 )
          {
            ...
            {
              *((_QWORD *)a7 + 4) = v17 + 1;
              v21 = sub_405BC0(a1, a2, v12, a4, a5, a6, a7, v8, 4230770LL);
              if ( v21 != -1 )
                return v21;
              v17 = a2[*a7];
            }
...
LABEL_68:
        *((_QWORD *)a7 + 4) = v23;
        *((_QWORD *)a7 + 2) = 0LL;
        return (unsigned int)sub_405BC0(a1, a2, v12, a4, a5, 0, a7, v8, (__int64)"-W ");
      }
      v32 = *a7;
      if ( (_DWORD)v32 != a1 )
      {
...
__int64 __fastcall sub_4067B0(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax
...
__int64 __fastcall sub_406810(int a1, __int64 *a2, const char *a3)
{
  return sub_4067B0(a1, a2, a3, 0LL, 0LL, 0, 1);
}

__int64 __fastcall sub_406830(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5)
{
  return sub_4067B0(a1, a2, a3, a4, a5, 0, 0);
}

__int64 __fastcall sub_406850(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5, int *a6)
{
  return sub_4061E0(a1, a2, a3, a4, a5, 0, a6, 0);
}

__int64 __fastcall sub_406870(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5)
{
  return sub_4067B0(a1, a2, a3, a4, a5, 1, 0);
}

__int64 __fastcall sub_406890(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5, int *a6)
{
...
void __fastcall sub_406A60(__int64 a1, __int64 a2, __int64 a3)
{
  char *v3; // rbx
  _BYTE *v4; // rbp
  _BYTE *v5; // rax
...
int __fastcall sub_406AE0(__int64 *a1, char *a2, size_t a3)
{
  const void *v3; // r14
  FILE *v6; // rbx
  char *v7; // rax
...
__int64 __fastcall sub_406C00(__int64 a1, const char *a2, const char **a3, char *a4, size_t a5, void (*a6)(void))
{
  __int64 result; // rax
  ...
  if ( result < 0 )
  {
    sub_406A60(a1, (__int64)a2, result);
    sub_406AE0((__int64 *)a3, a4, a5);
    a6();
    return -1LL;
  }
  return result;
