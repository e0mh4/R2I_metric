...
__int64 __fastcall main(int a1, char **a2, char **a3)
{
  ...
  __dev_t dev[8]; // [rsp+18h] [rbp-40h] BYREF
  ...
  while ( 1 )
  {
    v6 = sub_405E60((unsigned int)a1, a2, "m:Z", &off_407000, 0LL);
    if ( v6 == -1 )
      break;
    if ( v6 == -130 )
      sub_401E80(0);
...
LABEL_41:
  ...
  if ( v3 )
  {
    v8 = (void *)sub_402310(v3);
    if ( v8 )
    {
      v9 = umask(0);
      umask(v9);
      v10 = sub_4026E0(438LL, 0LL, v9, v8, 0LL);
      free(v8);
      if ( (v10 & 0xFFFFFE00) == 0 )
        goto LABEL_15;
      v29 = dcgettext(0LL, "mode must specify only file permission bits", 5);
      error(1, 0, v29);
    }
    v30 = dcgettext(0LL, "invalid mode", 5);
    error(1, 0, v30);
LABEL_54:
    v31 = sub_404230(4LL, *(_QWORD *)&v5[8 * dword_60A25C]);
    v32 = dcgettext(0LL, "cannot set permissions of %s", 5);
...
LABEL_15:
  ...
  if ( dword_60A25C >= a1 )
  {
    ...
    {
LABEL_55:
      v34 = dcgettext(0LL, "missing operand", 5);
      error(0, 0, v34);
      goto LABEL_41;
    }
    if ( v11 == 2 )
...
LABEL_20:
    ...
    v24 = a2[dword_60A25C + 2];
    goto LABEL_45;
  }
  if ( dword_60A25C + 1 >= a1 || (v12 = dword_60A25C, *a2[dword_60A25C + 1] != 112) )
  {
    if ( v11 > 3 )
    {
      if ( v11 > 4 )
      {
        v35 = sub_404480(a2[dword_60A25C + 4]);
        v21 = "extra operand %s";
        v22 = v35;
        goto LABEL_40;
      }
    ...
    v36 = sub_404480(a2[a1 - 1]);
    v37 = dcgettext(0LL, "missing operand after %s", 5);
    error(0, 0, v37, v36);
    if ( a1 - dword_60A25C != 2 )
      goto LABEL_41;
    v27 = "Special files require major and minor device numbers.";
LABEL_47:
    v28 = dcgettext(0LL, v27, 5);
  ...
  {
LABEL_63:
    v21 = "missing operand after %s";
    v22 = sub_404480(*(_QWORD *)&v5[8 * (_QWORD)v4 - 8]);
    goto LABEL_40;
  }
  if ( v11 > 2 )
  {
...
LABEL_45:
    ...
    error(0, 0, v26, v25);
    if ( (_DWORD)v4 - dword_60A25C != 4 )
      goto LABEL_41;
    v27 = "Fifos do not have major and minor device numbers.";
    goto LABEL_47;
  }
LABEL_21:
  v13 = v12 + 1;
...
LABEL_30:
      ...
      while ( 1 )
      {
        v4 = *(char **)&v5[v15 + 8];
        v19 = *(char **)&v5[v15 + 16];
        if ( (unsigned int)sub_404CD0(v4) || v43 != (unsigned int)v43 )
          goto LABEL_60;
        if ( (unsigned int)sub_404CD0(v19) || v44 != (unsigned int)v44 )
          break;
        if ( ((unsigned __int8)v44 | (v44 << 12) & 0xFFFFFF00000LL | ((_DWORD)v43 << 8) & 0xFFF00 | (v43 << 32) & 0xFFFFF00000000000LL) == -1LL )
          goto LABEL_61;
        dev[0] = (unsigned __int8)v44 | (v44 << 12) & 0xFFFFFF00000LL | ((_DWORD)v43 << 8) & 0xFFF00 | (v43 << 32) & 0xFFFFF00000000000LL;
        if ( !__xmknod(0, *(const char **)&v5[8 * dword_60A25C], v10 | v18, dev) )
          goto LABEL_25;
        v5 = (const char *)sub_404300(0LL, 3LL, *(_QWORD *)&v5[8 * dword_60A25C]);
...
LABEL_38:
      ...
      v38 = sub_404480(v19);
      v39 = dcgettext(0LL, "invalid minor device number %s", 5);
      error(1, 0, v39, v38);
LABEL_60:
      v5 = (const char *)sub_404480(v4);
      v40 = dcgettext(0LL, "invalid major device number %s", 5);
      error(1, 0, v40, v5);
LABEL_61:
      v41 = dcgettext(0LL, "invalid device %s %s", 5);
      error(1, 0, v41, v4, v19);
      goto LABEL_62;
    }
LABEL_39:
    v21 = "invalid device type %s";
    v22 = sub_404480(v14);
LABEL_40:
...
LABEL_25:
  if ( v3 && chmod(*(const char **)&v5[8 * dword_60A25C], v10) )
    goto LABEL_54;
  return 0LL;
}
...
void __fastcall __noreturn sub_401E80(int status)
{
  __int64 v1; // rbp
  char *v2; // rax
  char *v3; // rax
  ...
  v3 = dcgettext(0LL, "Usage: %s [OPTION]... NAME TYPE [MAJOR MINOR]\n", 5);
  __printf_chk(1LL, v3, v1);
  v4 = stdout;
  v5 = dcgettext(0LL, "Create the special file NAME of the given TYPE.\n", 5);
  fputs_unlocked(v5, v4);
  v6 = stdout;
  v7 = dcgettext(0LL, "\nMandatory arguments to long options are mandatory for short options too.\n", 5);
  fputs_unlocked(v7, v6);
  v8 = stdout;
  v9 = dcgettext(0LL, "  -m, --mode=MODE    set file permission bits to MODE, not a=rw - umask\n", 5);
  ...
  do
    v21 += 2;
  while ( *v21 && strcmp("mknod", (const char *)*v21) );
  v22 = (const char *)v21[1];
  if ( v22 )
  {
    v23 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v23, &unk_406800);
    v24 = setlocale(5, 0LL);
  ...
  {
    v27 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
    __printf_chk(1LL, v27, &unk_406800);
    v28 = setlocale(5, 0LL);
...
__int64 sub_402270()
{
  ...
  if ( (unsigned int)sub_405F60(stdout) )
  {
    v0 = __errno_location();
    v1 = v0;
    if ( !byte_60A298 || *v0 != 32 )
    {
...
LABEL_8:
  ...
  result = sub_405F60(stderr);
  if ( (_DWORD)result )
    goto LABEL_8;
  return result;
}

_WORD *__fastcall sub_402310(_BYTE *a1)
{
  _BYTE *v1; // rcx
  char *v2; // rbx
  int v3; // edx
...
__int64 __fastcall sub_402680(char *filename)
{
  int v1; // edx
  __int64 result; // rax
...
__int64 __fastcall sub_4026E0(__int16 a1, char a2, int a3, char *a4, _DWORD *a5)
{
  char v5; // r11
  __int64 result; // rax
  int v7; // ebx
...
LABEL_23:
      ...
      {
        v45 = (char *)v44 + v17;
        v25 = (const unsigned __int16 **)sub_405EE0((wchar_t *)&wc, (char *)v44 + v17 + a3);
        v46 = v25;
        if ( !v25 )
        {
LABEL_245:
...
_BYTE *__fastcall sub_403C30(int a1, __int64 a2, unsigned __int64 a3, __int64 a4)
{
  int *v6; // rax
  __m128i *v7; // rbx
  int *v8; // r13
  ...
  if ( dword_60A250 <= a1 )
  {
    ...
    {
      v7 = (__m128i *)sub_404AA0(0LL, v9);
      ptr = v7;
      *v7 = _mm_load_si128((const __m128i *)&xmmword_60A240);
    }
    else
    {
      ptr = (void *)sub_404AA0(ptr, v9);
      v7 = (__m128i *)ptr;
    }
  ...
  v21 = *(_DWORD *)(a4 + 4) | 1;
  v18 = *v10;
  v12 = sub_402A00(v11, *v10, a2, a3, *(_DWORD *)a4, v21, a4 + 8, *(char **)(a4 + 40), *(char **)(a4 + 48));
  if ( v18 <= v12 )
  {
    v13 = v12 + 1;
    *v10 = v12 + 1;
    ...
    v14 = (_BYTE *)sub_404A40(v13);
    v15 = *(_DWORD *)a4;
    v10[1] = (unsigned __int64)v14;
    v11 = v14;
    sub_402A00(v14, v13, a2, a3, v15, v21, a4 + 8, *(char **)(a4 + 40), *(char **)(a4 + 48));
  }
  *v8 = v20;
  return v11;
}
...
_BYTE *__fastcall sub_404150(int a1, int a2, __int64 a3)
{
...
_BYTE *__fastcall sub_4041C0(int a1, int a2, __int64 a3, unsigned __int64 a4)
{
...
_BYTE *__fastcall sub_404230(int a1, __int64 a2)
{
  return sub_404150(0, a1, a2);
}
...
_BYTE *__fastcall sub_404250(__int64 a1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  *v3 ^= (((*v3 >> (a3 & 0x1F)) & 1) == 0) << (a3 & 0x1F);
  return sub_403C30(0, a1, a2, (__int64)v5);
}
...
_BYTE *__fastcall sub_404300(int a1, int a2, __int64 a3)
{
  int v4[2]; // [rsp+0h] [rbp-48h] BYREF
  __int64 v5; // [rsp+8h] [rbp-40h]
  __int64 v6; // [rsp+10h] [rbp-38h]
...
_BYTE *__fastcall sub_404370(int a1, __int64 a2, __int64 a3, __int64 a4, unsigned __int64 a5)
{
...
_BYTE *__fastcall sub_404480(__int64 a1)
{
  return sub_403C30(0, a1, 0xFFFFFFFFFFFFFFFFLL, (__int64)&unk_60A200);
}

__int64 __fastcall sub_4044A0(FILE *stream, const char *a2, const char *a3, const char *a4, __int64 *a5, __int64 a6)
{
  char *v8; // rax
  char *v9; // rax
  __int64 v10; // rax
...
__int64 __fastcall sub_4048A0(FILE *a1, const char *a2, const char *a3, const char *a4, int *a5)
{
  __int64 i; // r9
  __int64 *v6; // r10
  __int64 v7; // rax
...
int sub_4049C0()
{
  ...
  __printf_chk(1LL, v1, &unk_406800);
  v2 = stdout;
  v3 = dcgettext(0LL, "General help using GNU software: <https://www.gnu.org/gethelp/>\n", 5);
  return fputs_unlocked(v3, v2);
}

void *__fastcall sub_404A40(size_t a1)
{
  void *result; // rax
...
// attributes: thunk
void *__fastcall sub_404A90(size_t a1)
{
  return sub_404A40(a1);
}
...
void *__fastcall sub_404BF0(size_t n)
{
  void *v1; // rax
...
__int64 __fastcall sub_404C10(unsigned __int64 a1, unsigned __int64 a2)
{
...
__int64 __fastcall sub_404CD0(char *nptr, char **a2, unsigned int a3, __int64 *a4, const char *a5)
{
  char **p_endptr; // r15
  int *v8; // rax
  int *v9; // r12
...
__int64 __fastcall sub_405110(__int64 a1, int *a2)
{
  __int64 v2; // r11
  int v3; // r12d
  int v4; // ebp
...
__int64 __fastcall sub_405810(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5, int a6, int *a7, int a8)
{
  int v8; // r13d
  int v9; // eax
  int v10; // ebp
    ...
    if ( *(_BYTE *)v17 == 45 )
    {
      ...
      if ( v30 )
      {
        if ( a4 )
        {
          ...
          {
            *((_QWORD *)a7 + 4) = v17 + 2;
            return (unsigned int)sub_4051F0(a1, a2, v12, a4, a5, a6, a7, v8, "--");
          }
          if ( a6 )
          {
            ...
            {
              *((_QWORD *)a7 + 4) = v17 + 1;
              v21 = sub_4051F0(a1, a2, v12, a4, a5, a6, a7, v8, "-");
              if ( v21 != -1 )
                return v21;
              v17 = a2[*a7];
            }
...
LABEL_68:
        *((_QWORD *)a7 + 4) = v23;
        *((_QWORD *)a7 + 2) = 0LL;
        return (unsigned int)sub_4051F0(a1, a2, v12, a4, a5, 0, a7, v8, "-W ");
      }
      v32 = *a7;
      if ( (_DWORD)v32 != a1 )
      {
...
__int64 __fastcall sub_405DE0(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax

  dword_60A400 = dword_60A25C;
  dword_60A404 = dword_60A258;
  result = sub_405810(a1, a2, a3, a4, a5, a6, &dword_60A400, a7);
...
__int64 __fastcall sub_405E40(int a1, __int64 *a2, const char *a3)
{
  return sub_405DE0(a1, a2, a3, 0LL, 0LL, 0, 1);
}

__int64 __fastcall sub_405E60(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5)
{
  return sub_405DE0(a1, a2, a3, a4, a5, 0, 0);
}

__int64 __fastcall sub_405E80(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5, int *a6)
{
  return sub_405810(a1, a2, a3, a4, a5, 0, a6, 0);
}

__int64 __fastcall sub_405EA0(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5)
{
  return sub_405DE0(a1, a2, a3, a4, a5, 1, 0);
}

__int64 __fastcall sub_405EC0(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5, int *a6)
{
  return sub_405810(a1, a2, a3, a4, a5, 1, a6, 0);
}

size_t __fastcall sub_405EE0(wchar_t *pwc, char *s, size_t a3, mbstate_t *a4)
{
  size_t v4; // rbx
  wchar_t *v5; // r12
  const char *v6; // rbp
...
LABEL_4:
  ...
  if ( v4 > 0xFFFFFFFFFFFFFFFDLL && !(unsigned __int8)sub_405FC0(0LL) )
  {
    v4 = 1LL;
...
__int64 __fastcall sub_405F60(FILE *stream)
{
  size_t v1; // r12
  int v2; // ebx
  __int64 result; // rax
...
bool __fastcall sub_405FC0(int a1)
{
  char *v1; // rdx
  bool result; // al
...
int __fastcall sub_406590(FILE *stream)
{
  int *v1; // rax
  int v2; // r12d
  int *v3; // rbp
  ...
  if ( !(unsigned int)sub_406610(stream) )
    return fclose(stream);
  v1 = __errno_location();
  v2 = *v1;
  v3 = v1;
...
int __fastcall sub_406610(FILE *stream)
{
  ...
  sub_406650(stream, 0LL, 1LL);
  return fflush(stream);
}

int __fastcall sub_406650(FILE *a1, __off_t a2, int a3)
{
  __off_t v3; // rax
  int v5; // eax
...
int __fastcall sub_406720(void (__fastcall *a1)(void *))
{
  void *v1; // rdx
...
__int64 __fastcall sub_406738(__int64 a1, __int64 a2, __int64 a3)
{
  void (**i)(void); // rbx
