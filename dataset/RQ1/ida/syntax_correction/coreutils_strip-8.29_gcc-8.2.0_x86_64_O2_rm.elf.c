...
__int64 __fastcall sub_402AA0(__int64 a1, _QWORD *a2, char a3, __int64 a4, int a5, int *a6)
{
  int v7; // edi
  char *v8; // r13
  int v10; // ebx
...
size_t __fastcall sub_403BF0(const char *a1)
{
  size_t result; // rax
  size_t v2; // rdx
...
__int64 __fastcall sub_405280(__int128 *a1)
{
  __int128 *v1; // rbx
  int *v2; // rax
  int v3; // r12d
...
unsigned __int64 __fastcall sub_405370(_BYTE *a1, unsigned __int64 a2, __int64 a3, unsigned __int64 a4, __int128 *a5)
{
  __int128 *v6; // rbx
  int *v7; // rax
  int v8; // r12d
...
_BYTE *__fastcall sub_4053F0(__int64 a1, unsigned __int64 a2, unsigned __int64 *a3, __int128 *a4)
{
  __int128 *v5; // rbx
  int *v6; // r13
  int v7; // ebp
...
_BYTE *__fastcall sub_4056E0(int a1, __int64 a2)
{
  return sub_405600(0, a1, a2);
}

_BYTE *__fastcall sub_405700(__int64 a1, unsigned __int64 a2, unsigned __int8 a3)
{
  _DWORD *v3; // r8
...
_BYTE *__fastcall sub_405820(int a1, __int64 a2, __int64 a3, __int64 a4, unsigned __int64 a5)
{
...
__int64 __fastcall sub_405DA0(FILE *a1, const char *a2, const char *a3, const char *a4, int *a5)
{
  __int64 i; // r9
  __int64 *v6; // r10
  __int64 v7; // rax
...
void *__fastcall sub_406130(size_t n)
{
  void *v1; // rax
...
__int64 __fastcall sub_406150(unsigned __int64 a1, unsigned __int64 a2)
{
...
void *__fastcall sub_4061B0(char *src)
{
  size_t v1; // rax
...
__int64 __fastcall sub_406600(_QWORD *a1, __int64 a2, size_t a3)
{
  __int64 v5; // rbx
...
__int64 __fastcall sub_406B50(int a1, int a2, int a3, __int64 a4, int a5, int a6, char a7)
{
  int v8; // edx
...
__int64 __fastcall sub_406BA0(__int64 a1, __int64 a2, int a3, __int64 a4, int a5, int a6)
{
  int v8; // ebp
  const char *v9; // rbx
  int v10; // r12d
...
__int64 __fastcall sub_406EC0(__int64 a1, int a2, __int64 a3, __int64 a4, int a5, int a6)
{
  __int64 v7; // r13
  DIR *v8; // rdi
  size_t v9; // r8
...
__int64 __fastcall sub_408DA0(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5, int a6, int *a7, int a8)
{
  int v8; // r13d
  int v9; // eax
  int v10; // ebp
...
__int64 __fastcall sub_409370(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax
...
__int64 __fastcall sub_4093D0(int a1, __int64 *a2, const char *a3)
{
  return sub_409370(a1, a2, a3, 0LL, 0LL, 0, 1);
}

__int64 __fastcall sub_4093F0(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5)
{
  return sub_409370(a1, a2, a3, a4, a5, 0, 0);
}

__int64 __fastcall sub_409410(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5, int *a6)
{
  return sub_408DA0(a1, a2, a3, a4, a5, 0, a6, 0);
}

__int64 __fastcall sub_409430(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5)
{
  return sub_409370(a1, a2, a3, a4, a5, 1, 0);
}

__int64 __fastcall sub_409450(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5, int *a6)
{
...
__int64 __fastcall sub_409B60(__int64 a1, __int64 a2)
{
...
void __fastcall sub_40A0B0(_QWORD *a1)
{
  _QWORD *v1; // r12
  _QWORD *v2; // rbx
...
void __fastcall sub_40A160(_QWORD *ptr)
{
  _QWORD *v2; // rbp
  unsigned __int64 v3; // rax
  _QWORD *v4; // rbx
...
__int64 __fastcall sub_40AF60(unsigned int fd)
{
  __int64 result; // rax
  unsigned int v2; // r12d
  int *v3; // rax
...
__int64 __fastcall sub_40B030(int a1, int a2, __int64 a3, int a4, int a5, int a6)
{
  int v6; // ebx
  int v8; // eax
  int *v9; // rax
...
__int64 __fastcall sub_40B170(int a1, __int64 a2, __int64 a3, int a4, int a5, int a6)
{
