...
__int64 __fastcall main(unsigned int a1, char **a2, char **a3)
{
  ...
  __int64 v13; // rbx
  char *v14; // rax
  void *v15; // [rsp+0h] [rbp-48h] BYREF
  unsigned int v16; // [rsp+8h] [rbp-40h]
  __int64 v17; // [rsp+Ch] [rbp-3Ch] BYREF
  ...
  while ( 1 )
  {
    v6 = sub_4065A0(a1, a2, "pm:vZ", &off_40A520, 0LL);
    if ( v6 == -1 )
      break;
    if ( v6 == 90 )
    {
...
LABEL_11:
  ...
  if ( v15 )
  {
    ...
    {
      LODWORD(v17) = 511;
      return sub_404ED0(a1 - dword_60E2BC, &a2[dword_60E2BC], sub_401F70, &v15);
    }
  }
  else
  {
...
__int64 __fastcall sub_401F70(__int64 a1, __int64 a2, __int64 *a3)
{
  ...
  v6 = sub_402610(a1, a2, v5, a3, *((unsigned int *)a3 + 3), sub_402040, *((unsigned int *)a3 + 4), -1LL, -1LL, 1LL) ^ 1;
  v7 = v6;
  if ( !v6 && *((_BYTE *)a3 + 20) && *a3 )
    *__errno_location() = 95;
  return v7;
}
...
__int64 __fastcall sub_402040(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  ...
  if ( *(_QWORD *)(a2 + 24) )
    return sub_402010(a1, a2, a3, a4, a5, a6, a7);
  return result;
}
...
__int64 __fastcall sub_402060(__int64 a1, const char *a2, __int64 a3)
{
  ...
  if ( !v8 )
  {
    v8 = (*(_DWORD *)(a3 + 8) >> 8) & 1;
    if ( *(_QWORD *)(a3 + 24) )
      sub_402010(a1, a3, v6, v7, v9, v10, v15);
  }
  return v8;
}
...
void __fastcall __noreturn sub_402100(int status)
{
  ...
  do
    v16 += 2;
  while ( *v16 && strcmp("mkdir", (const char *)*v16) );
...
int __fastcall sub_402460(FILE *s)
{
...
unsigned __int64 __fastcall sub_403010(
        _BYTE *a1,
        unsigned __int64 a2,
        __int64 a3,
        unsigned __int64 a4,
...
LABEL_4:
        ...
        if ( !(_BYTE)a5 )
        {
          ...
          if ( v41 )
          {
            ...
            {
              if ( v63 )
                return sub_403010((int)v9, v83, a3, v16, 5, a6, a7, (__int64)a8, a9);
              v42 = v83 != 0 && v10 == 0;
              if ( v42 )
              {
                v10 = v83;
...
LABEL_277:
              v30 = v18;
              LODWORD(v13) = v16;
              return sub_403010((int)v9, v10, a3, v13, v30, a6 & 0xFFFFFFFD, 0LL, (__int64)a8, a9);
            }
          }
        }
        LOBYTE(v22) = *v19;
...
LABEL_23:
      ...
      {
        v45 = (char *)v44 + v17;
        v25 = (const unsigned __int16 **)sub_406620((wchar_t *)&wc, (char *)v44 + v17 + a3);
        v46 = v25;
        if ( !v25 )
        {
LABEL_245:
...
_BYTE *__fastcall sub_404240(int a1, __int64 a2, unsigned __int64 a3, __int64 a4)
{
  int *v6; // rax
  __m128i *v7; // rbx
  int *v8; // r13
  ...
  if ( dword_60E2B0 <= a1 )
  {
    ...
    {
      v7 = (__m128i *)sub_405620(0LL, v9);
      ptr = v7;
      *v7 = _mm_load_si128((const __m128i *)&xmmword_60E2A0);
    }
    else
    {
      ptr = (void *)sub_405620(ptr, v9);
      v7 = (__m128i *)ptr;
    }
  ...
  v21 = *(_DWORD *)(a4 + 4) | 1;
  v18 = *v10;
  v12 = sub_403010(v11, *v10, a2, a3, *(_DWORD *)a4, v21, a4 + 8, *(char **)(a4 + 40), *(char **)(a4 + 48));
  if ( v18 <= v12 )
  {
    v13 = v12 + 1;
    *v10 = v12 + 1;
    ...
    v11 = v14;
    sub_403010(v14, v13, a2, a3, v15, v21, a4 + 8, *(char **)(a4 + 40), *(char **)(a4 + 48));
  }
  *v8 = v20;
  return v11;
}
...
__int64 __fastcall sub_4043E0(__int128 *a1)
{
  __int128 *v1; // rbx
  int *v2; // rax
  int v3; // r12d
  ...
  if ( !a1 )
    v1 = &xmmword_60E420;
  result = sub_4057C0(v1, 0x38uLL);
  *v4 = v3;
  return result;
}

unsigned __int64 __fastcall sub_4044D0(_BYTE *a1, unsigned __int64 a2, __int64 a3, unsigned __int64 a4, __int128 *a5)
{
  __int128 *v6; // rbx
  int *v7; // rax
  int v8; // r12d
...
_BYTE *__fastcall sub_404550(__int64 a1, unsigned __int64 a2, unsigned __int64 *a3, __int128 *a4)
{
  __int128 *v5; // rbx
  int *v6; // r13
  int v7; // ebp
  ...
  v9 = *v6;
  v11 = sub_403010(0LL, 0LL, a1, a2, *(_DWORD *)v5, v7, (__int64)v5 + 8, *((char **)v5 + 5), *((char **)v5 + 6));
  v10 = (_BYTE *)sub_4055C0(v11 + 1);
  sub_403010(v10, v11 + 1, a1, a2, *(_DWORD *)v5, v7, (__int64)v5 + 8, *((char **)v5 + 5), *((char **)v5 + 6));
  *v6 = v9;
  if ( a3 )
    *a3 = v11;
  return v10;
...
void sub_404650()
{
  ...
  if ( v4 != &unk_60E320 )
  {
    ...
    *((_QWORD *)&xmmword_60E2A0 + 1) = &unk_60E320;
  }
...
_BYTE *__fastcall sub_404760(int a1, int a2, __int64 a3)
{
...
_BYTE *__fastcall sub_4047D0(int a1, int a2, __int64 a3, unsigned __int64 a4)
{
...
_BYTE *__fastcall sub_404840(int a1, __int64 a2)
{
  return sub_404760(0, a1, a2);
}

_BYTE *__fastcall sub_404860(__int64 a1, unsigned __int64 a2, unsigned __int8 a3)
{
  _DWORD *v3; // r8
  ...
  *v3 ^= (((*v3 >> (a3 & 0x1F)) & 1) == 0) << (a3 & 0x1F);
  return sub_404240(0, a1, a2, (__int64)v5);
}

_BYTE *__fastcall sub_4048E0(__int64 a1)
{
  return sub_404860(a1, 0xFFFFFFFFFFFFFFFFLL, 0x3Au);
}

_BYTE *__fastcall sub_404910(int a1, int a2, __int64 a3)
{
  int v4[2]; // [rsp+0h] [rbp-48h] BYREF
  __int64 v5; // [rsp+8h] [rbp-40h]
  __int64 v6; // [rsp+10h] [rbp-38h]
...
_BYTE *__fastcall sub_404980(int a1, __int64 a2, __int64 a3, __int64 a4, unsigned __int64 a5)
{
...
_BYTE *__fastcall sub_404A90(__int64 a1)
{
  return sub_404240(0, a1, 0xFFFFFFFFFFFFFFFFLL, (__int64)&unk_60E260);
}

__int64 __fastcall sub_404AE0(int *a1, const char *a2, int a3, int *a4, int a5, int a6)
{
  char v7; // r14
  int v8; // eax
  int v9; // r13d
  ...
  {
    v7 = a3;
    v8 = __open_2(a2, (a3 << 17) & 0x20000 | 0x10900u);
    *a4 = v8;
    v9 = v8;
...
LABEL_37:
  ...
  v12 = sub_4067C0((unsigned int)".", 0, a3, 0, a5, a6);
  if ( v12 >= 0 )
  {
    *a1 = 1;
    a1[1] = v12;
...
int __fastcall sub_404D30(_DWORD *a1, int a2)
{
  __pid_t v2; // ebp
  int result; // eax
  int v4; // r12d
...
int __fastcall sub_404E60(int *a1)
{
  int result; // eax
...
// attributes: thunk
void *__fastcall sub_405610(size_t a1)
{
  return sub_4055C0(a1);
}
...
void *__fastcall sub_405770(size_t n)
{
  void *v1; // rax
...
__int64 __fastcall sub_405790(unsigned __int64 a1, unsigned __int64 a2)
{
...
void *__fastcall sub_4057F0(char *src)
{
  size_t v1; // rax

  v1 = strlen(src);
  return sub_4057C0(src, v1 + 1);
}
...
__int64 __fastcall sub_405F50(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5, int a6, int *a7, int a8)
{
  int v8; // r13d
  int v9; // eax
  int v10; // ebp
    ...
    if ( *(_BYTE *)v17 == 45 )
    {
      ...
      if ( v30 )
      {
        if ( a4 )
        {
          ...
          {
            *((_QWORD *)a7 + 4) = v17 + 2;
            return (unsigned int)sub_405930(a1, a2, v12, a4, a5, a6, a7, v8, (__int64)"--");
          }
          if ( a6 )
          {
            ...
            {
              *((_QWORD *)a7 + 4) = v17 + 1;
              v21 = sub_405930(a1, a2, v12, a4, a5, a6, a7, v8, (__int64)"-");
              if ( v21 != -1 )
                return v21;
              v17 = a2[*a7];
            }
...
LABEL_68:
        *((_QWORD *)a7 + 4) = v23;
        *((_QWORD *)a7 + 2) = 0LL;
        return (unsigned int)sub_405930(a1, a2, v12, a4, a5, 0, a7, v8, (__int64)"-W ");
      }
      v32 = *a7;
      if ( (_DWORD)v32 != a1 )
      {
...
__int64 __fastcall sub_406520(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5, int a6, int a7)
{
  __int64 result; // rax
...
__int64 __fastcall sub_406580(int a1, __int64 *a2, const char *a3)
{
  return sub_406520(a1, a2, a3, 0LL, 0LL, 0, 1);
}

__int64 __fastcall sub_4065A0(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5)
{
  return sub_406520(a1, a2, a3, a4, a5, 0, 0);
}

__int64 __fastcall sub_4065C0(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5, int *a6)
{
  return sub_405F50(a1, a2, a3, a4, a5, 0, a6, 0);
}

__int64 __fastcall sub_4065E0(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5)
{
  return sub_406520(a1, a2, a3, a4, a5, 1, 0);
}

__int64 __fastcall sub_406600(int a1, __int64 *a2, const char *a3, char **a4, _DWORD *a5, int *a6)
{
...
__int64 __fastcall sub_406DE0(
        const char *a1,
        int *a2,
        int (__fastcall *a3)(const char *, const char *, __int64),
        __int64 a4,
        int a5,
        int a6)
{
...
LABEL_10:
      v14 = sub_404AE0(a2, v7, v12, 0LL, a5, a6);
      v15 = v14;
      if ( v14 == -1 || (*v9 = 47, v14) )
      {
        if ( v13 )
...
__int64 __fastcall sub_406F70(int fd, char *file, int a3, __uid_t a4, __gid_t a5, int a6, int a7)
{
...
__int64 __fastcall sub_407170(unsigned int fd)
{
  __int64 result; // rax
...
char *__fastcall sub_4072F0(void *a1, size_t *a2, _BYTE *a3, __int64 a4, double a5)
{
  __int64 v7; // rax
  ...
  src = a1;
  v156 = a2;
  if ( (int)sub_409180(a3, &v171, v168) < 0 )
    return 0LL;
  if ( (int)sub_408F60(a4, v168) >= 0 )
  {
    v7 = v173 + 7;
...
__int64 __fastcall sub_408E10(int a1, __int64 a2, __int64 a3, int a4, int a5, int a6, char a7)
{
  return sub_408E20(a1, 0, 3, a4, a5, a6, a7);
}

__int64 __fastcall sub_408E20(int a1, int a2, __int64 a3, int a4, int a5, int a6)
{
  int v6; // ebx
  int v8; // eax
  int *v9; // rax
  ...
  if ( a2 == 1030 )
  {
    if ( dword_60E4A0 < 0 )
    {
      v6 = sub_408E20(a1, 0, a3, a4, a5, a6);
      if ( v6 >= 0 && dword_60E4A0 == -1 )
      {
LABEL_8:
        v8 = fcntl(v6, 1);
    ...
    else
    {
      ...
      {
        v6 = sub_408E20(a1, 0, v16, v13, v14, v15);
        if ( v6 >= 0 )
        {
          dword_60E4A0 = -1;
          goto LABEL_8;
