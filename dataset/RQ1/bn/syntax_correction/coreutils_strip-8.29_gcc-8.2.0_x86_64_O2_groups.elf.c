...
int32_t main(int32_t argc, char** argv, char** envp)
{
    ...
    int32_t rbx;
    int32_t rbp;
    setlocale(6, &data_40768c[0x1b], rdx, rcx, r8, r9, rbx, rbp);
    bindtextdomain("coreutils", "/home/dongkwan/data/scripts/gnu_…");
    textdomain("coreutils");
    sub_405f50(sub_402160);
    uint64_t rax = getopt_long(r12, argv, &data_40768c[0x1b], &data_406360, nullptr);
    if (rax == 0xffffffff)
    {
        int32_t rax_2 = data_60927c;
        bool cond0 = rax_2 < r12;
        uid_t rbp_1;
        if (rax_2 == r12)
        {
            ...
            *rax_15 = 0;
            ...
            rbp_1 = rax_16;
            int32_t rax_18;
            if ((rax_16 == 0xffffffff && *rax_15 != 0))
            {
                rax_18 = error(1, *rax_15, dcgettext(nullptr, "cannot get real UID", 5));
                goto label_401aa6;
            }
            *rax_15 = 0;
            int32_t rax_17 = getegid();
            r12 = rax_17;
            ...
            label_401aa6:
                ...
                error(1, *rax_15, dcgettext(nullptr, "cannot get real GID", 5));
            }
            char* rax_20;
            uint64_t* const rdi_7;
            if (*rax_15 == 0)
            {
                rdi_7 = stdout;
                rbp_1 = sub_401f60(nullptr, rbp_1, rax_18, r12, 1, 0x20);
                rax_20 = stdout[5];
                if (rax_20 < stdout[6])
                {
                    stdout[5] = &rax_20[1];
            ...
            {
                rdi_7 = error(1, *rax_15, dcgettext(nullptr, "cannot get effective GID", 5));
            }
            if ((*rax_15 != 0 || (*rax_15 == 0 && rax_20 >= stdout[6])))
            {
        ...
        else
        {
            ...
            if (cond0)
            {
                do
                {
                    struct passwd* rax_10 = getpwnam(argv[rax_2]);
                    if (rax_10 == 0)
                    {
                        rbp_1 = 0;
                        error(0, 0, dcgettext(nullptr, "%s: no such user", 5), sub_403e70(argv[data_60927c]));
                    }
                    else
                    {
                        uint32_t r13_1 = rax_10->pw_gid;
                        uint32_t r14_1 = rax_10->pw_uid;
                        __printf_chk(1, "%s : ", argv[data_60927c]);
                        uint64_t* const rdi_4 = stdout;
                        if (sub_401f60(argv[data_60927c], r14_1, r13_1, r13_1, 1, 0x20) == 0)
                        {
                            rbp_1 = 0;
                        }
                        char* rax_7 = stdout[5];
    ...
    if (rax == 0xffffff7d)
    {
        uint64_t var_30 = rax;
        int64_t var_38 = 0;
        sub_4042f0(stdout, "groups", "GNU coreutils", data_609210);
        exit(0);
        /* no return */
    }
    if (rax == 0xffffff7e)
...
int64_t j_sub_401b5a()
{
    /* tailcall */
    return sub_401b5a();
}

noreturn int64_t sub_401bf0(int32_t arg1) 
{
    int64_t rbp = data_6092e8;
    if (arg1 != 0)
    {
    ...
    {
        __printf_chk(1, dcgettext(nullptr, "Usage: %s [OPTION]... [USERNAME]…", 5), rbp);
        fputs_unlocked(dcgettext(nullptr, "Print group memberships for each…", 5), stdout);
        ...
        if (rbp_1 == 0)
        {
            ...
            if (rax_18 != 0)
            {
                rax_19 = strncmp(rax_18, &data_40602f, 3);
                if (rax_19 != 0)
                {
                    rbp_1 = "groups";
                }
            ...
            if ((rax_18 == 0 || (rax_18 != 0 && rax_19 == 0)))
            {
                rbp_1 = "groups";
                r12_1 = " invocation";
                __printf_chk(1, dcgettext(nullptr, "Full documentation at: <%s%s>n", 5), "https://www.gnu.org/software/cor…", "groups");
            }
        }
        else
        {
            ...
            if (strncmp(rax_10, &data_40602f, 3) == 0)
            {
                goto label_401dd0;
            }
        }
        ...
        {
            __printf_chk(1, dcgettext(nullptr, "Report %s translation bugs to <h…", 5), "groups");
        label_401dd0:
            r12_1 = " invocation";
            __printf_chk(1, dcgettext(nullptr, "Full documentation at: <%s%s>n", 5), "https://www.gnu.org/software/cor…", "groups");
            if (rbp_1 != "groups")
            {
                r12_1 = &data_40768c[0x1b];
            }
        }
...
uint64_t sub_401ee0(int32_t arg1, int32_t arg2)
{
    uint64_t rbp = arg1;
    int32_t rbx = 1;
    struct group* rax_1;
    ...
    {
        rdi_1 = sub_402200(rbp, &data_6092c0);
    }
    fputs_unlocked(rdi_1, stdout);
    return rbx;
}

uint64_t sub_401f60(char* arg1, uid_t arg2, int32_t arg3, uint32_t arg4, 
    char arg5, int32_t arg6)
{
    ...
    gid_t* var_40;
    int32_t rax_5 = sub_4046c0(arg1, rsi_2, &var_40);
    bool cond2 = rax_5 == 0;
    if (rax_5 < 0)
    {
        ...
        {
            error(0, *rax_13, dcgettext(nullptr, "failed to get groups for user %s", 5), sub_403e70(arg1));
        }
        r13 = 0;
    }
    else
        ...
        if ((!cond2))
        {
            ...
            do
            {
                ...
                if ((rax_8 != arg4 && rax_8 != arg3))
                {
                    ...
                    rdi_5 = var_40;
                    if (sub_401ee0(*(var_40 + r14_1), r12_1) == 0)
                    {
                        r13 = 0;
                    }
                }
...
int64_t sub_402140(int64_t arg1)
{
    data_6092e0 = arg1;
}

int64_t sub_402150(char arg1)
{
    data_6092d8 = arg1;
}

void sub_402160(void* arg1)
{
    int32_t rax = sub_405540(stdout);
    int32_t* rax_1;
    if (rax != 0)
    {
        rax_1 = __errno_location();
        if ((data_6092d8 == 0 || (data_6092d8 != 0 && *rax_1 != 0x20)))
        {
            char* rax_3 = dcgettext(nullptr, "write error", 5);
            int64_t rdi_2 = data_6092e0;
            if (rdi_2 == 0)
            {
            ...
            {
                error(0, *rax_1, "%s: %s", sub_403cc0(rdi_2), rax_3);
            }
        }
    }
    if (((rax == 0 || ((rax != 0 && data_6092d8 != 0) && *rax_1 == 0x20)) && sub_405540(stderr) == 0))
    {
        return;
    }
    _exit(data_609218);
...
void* sub_402200(uint64_t arg1, void* arg2)
{
    void* rcx = (arg2 + 0x14);
    *(arg2 + 0x14) = 0;
    while (true)
...
char* sub_4022f0(char* arg1, int32_t arg2)
{
    char* rax = dcgettext(nullptr, arg1, 5);
    char* rbx = rax;
    if (arg1 == rax)
    {
        char* rax_2 = sub_405600();
...
int64_t sub_4023f0(char* arg1, uint64_t arg2, uint64_t arg3, uint64_t arg4, 
    uint32_t arg5, int32_t arg6, int64_t arg7, char* arg8, char* arg9)
{
            ...
            while (true)
            {
                ...
                if (r13 == 0)
                {
                    ...
                    else if (var_5b_1 != 0)
                    {
                        if (var_a9 != 0)
                        {
                            rbx_1 = sub_4023f0(r15, var_70, arg3, r11, 5, arg6, arg7, arg8, arg9);
                        }
                        else
                        {
                            rax_1 = r14 == 0;
                ...
                else
                {
                    ...
                    if (var_a0_1 != 0)
                    {
                        ...
                        label_4034e0:
                            ...
                            r11 = r9;
                        label_402844:
                            rbx_1 = sub_4023f0(r15, r14, arg3, r11, r13_1, (arg6 & 0xfffffffd), 0, arg8, arg9);
                        label_40285b:
                            return rbx_1;
                        }
                        rbp_3 = *r8;
                    ...
                    label_402b90:
                        ...
                        label_402995:;
                            ...
                            while (true)
                            {
                                ...
                                uint32_t var_44;
                                rax_12 = sub_4054c0(&var_44, rbp_4, (var_98 - r15_1), &var_40);
                                if (rax_12 != 0)
                                {
                                    if (rax_12 == -1)
                                    {
    ...
    switch (r13)
    {
        ...
        case 0xa:
        {
            if ((!cond1))
            {
                arg8 = sub_4022f0(&data_4064ad, r13);
                arg9 = sub_4022f0("'", r13);
            }
            rbx_1 = 0;
            if (rbp_1 == 0)
...
char* sub_403620(int32_t arg1, uint64_t arg2, uint64_t arg3, int32_t* arg4)
{
    int64_t r15 = arg1;
    int32_t* rax = __errno_location();
    int64_t rbx = data_609258;
    int32_t rax_1 = *rax;
    if (r15 < 0)
    {
        abort();
    ...
    if (data_609270 <= r15)
    {
        ...
        if (rbx == 0x609260)
        {
            int64_t rax_9 = sub_404490(0, rsi_1);
            int128_t zmm0 = data_609260;
            rbx = rax_9;
            data_609258 = rax_9;
            *rax_9 = zmm0;
        }
        ...
        {
            int64_t rax_2 = sub_404490(rbx, rsi_1);
            data_609258 = rax_2;
            rbx = rax_2;
        }
        int64_t rdi_1 = data_609270;
    ...
    uint64_t r11 = *rbx_1;
    char* r12_2 = *(rbx_1 + 8);
    int64_t rax_5 = sub_4023f0(r12_2, r11, arg2, arg3, *arg4, rax_4, r15_2, *(arg4 + 0x28), *(arg4 + 0x30));
    if (r11 <= rax_5)
    {
        ...
        *rbx_1 = rsi_3;
        ...
        char* rax_6 = sub_404430(rsi_3);
        uint32_t r8_1 = *arg4;
        *(rbx_1 + 8) = rax_6;
        r12_2 = rax_6;
        sub_4023f0(rax_6, rsi_3, arg2, arg3, r8_1, rax_4, r15_2, *(arg4 + 0x28), *(arg4 + 0x30));
    }
    *rax = rax_1;
    return r12_2;
}

int64_t sub_4037c0(int64_t arg1)
{
    int64_t rbx = arg1;
    int32_t* rax = __errno_location();
    int32_t r12 = *rax;
    ...
    int64_t rax_1 = sub_404630(rbx, 0x38);
    *rax = r12;
    return rax_1;
}

uint64_t sub_403800(int32_t* arg1)
{
    if (arg1 == 0)
    {
        arg1 = &data_609400;
...
void sub_403810(int32_t* arg1, int32_t arg2)
{
    if (arg1 == 0)
    {
        arg1 = &data_609400;
...
uint64_t sub_403820(int64_t arg1, uint8_t arg2, int32_t arg3)
{
    if (arg1 == 0)
    {
        arg1 = 0x609400;
...
uint64_t sub_403860(int128_t* arg1, int32_t arg2)
{
    if (arg1 == 0)
    {
        arg1 = &data_609400;
...
void sub_403880(int32_t* arg1, int64_t arg2, int64_t arg3)
{
    if (arg1 == 0)
    {
        arg1 = &data_609400;
    ...
    *arg1 = 0xa;
    ...
    int64_t var_8 = 0x609400;
    abort();
    /* no return */
}

int64_t sub_4038b0(char* arg1, uint64_t arg2, uint64_t arg3, uint64_t arg4, 
    int32_t* arg5)
{
    int32_t* rbx = arg5;
    if (arg5 == 0)
    ...
    int32_t* rax = __errno_location();
    int32_t r12 = *rax;
    int64_t rax_2 = sub_4023f0(arg1, arg2, arg3, arg4, *rbx, rbx[1], &rbx[2], *(rbx + 0x28), *(rbx + 0x30));
    *rax = r12;
    return rax_2;
}

char* sub_403930(uint64_t arg1, uint64_t arg2, int64_t* arg3, int32_t* arg4)
{
    int32_t* rbx = arg4;
    if (arg4 == 0)
    {
    ...
    int64_t rax_2 = sub_4023f0(nullptr, 0, arg1, arg2, *rbx, rbp_1, &rbx[2], *(rbx + 0x28), *(rbx + 0x30));
    char* rax_3 = sub_404430((rax_2 + 1));
    sub_4023f0(rax_3, (rax_2 + 1), arg1, arg2, *rbx, rbp_1, &rbx[2], *(rbx + 0x28), *(rbx + 0x30));
    *rax = rax_1;
    if (arg3 != 0)
    {
        *arg3 = rax_2;
...
int64_t sub_403a20(uint64_t arg1, uint64_t arg2, int32_t* arg3)
{
    /* tailcall */
    return sub_403930(arg1, arg2, nullptr, arg3);
}

uint64_t sub_403a30()
{
    uint64_t rax_2 = data_609270;
    int64_t r12 = data_609258;
    if (rax_2 > 1)
    {
    ...
    if (rdi_2 != 0x609300)
    {
        rax_2 = free(rdi_2);
        *data_609260 = 0x100;
        *(data_609260 + 8) = 0x609300;
    }
    if (r12 != 0x609260)
    {
        rax_2 = free(r12);
        data_609258 = 0x609260;
    }
    data_609270 = 1;
    return rax_2;
}

int64_t sub_403ad0(int32_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_403620(arg1, arg2, -1, &data_609400);
}

int64_t sub_403af0(int32_t arg1, uint64_t arg2, uint64_t arg3)
{
    /* tailcall */
    return sub_403620(arg1, arg2, arg3, &data_609400);
}

int64_t sub_403b00(uint64_t arg1)
{
    /* tailcall */
    return sub_403620(0, arg1, -1, &data_609400);
}

int64_t sub_403b20(uint64_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_403620(0, arg1, arg2, &data_609400);
}

char* sub_403b40(int32_t arg1, int32_t arg2, uint64_t arg3)
{
    if (arg2 == 0xa)
    {
        abort();
    ...
    int64_t var_20 = 0;
    int64_t var_18 = 0;
    return sub_403620(arg1, arg3, -1, &var_48);
}

char* sub_403bb0(int32_t arg1, int32_t arg2, uint64_t arg3, uint64_t arg4)
{
    if (arg2 == 0xa)
    {
        abort();
    ...
    int64_t var_20 = 0;
    int64_t var_18 = 0;
    return sub_403620(arg1, arg3, arg4, &var_48);
}

int64_t sub_403c20(int32_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_403b40(0, arg1, arg2);
}

int64_t sub_403c30(int32_t arg1, uint64_t arg2, uint64_t arg3)
{
    /* tailcall */
    return sub_403bb0(0, arg1, arg2, arg3);
}

char* sub_403c40(uint64_t arg1, uint64_t arg2, uint8_t arg3)
{
    char rcx_1 = (arg3 & 0x1f);
    int64_t var_18 = data_609430;
    int128_t var_48 = data_609400;
    int128_t var_38 = data_609410;
    int128_t var_28 = data_609420;
    int32_t rdx = *((&var_48 + ((arg3 >> 5) << 2)) + 8);
    *((&var_48 + ((arg3 >> 5) << 2)) + 8) = ((((!(rdx >> rcx_1)) & 1) << rcx_1) ^ rdx);
    return sub_403620(0, arg1, arg2, &var_48);
}

int64_t sub_403cb0(uint64_t arg1, uint8_t arg2)
{
    /* tailcall */
    return sub_403c40(arg1, -1, arg2);
}

int64_t sub_403cc0(uint64_t arg1)
{
    /* tailcall */
    return sub_403c40(arg1, -1, 0x3a);
}

int64_t sub_403ce0(uint64_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_403c40(arg1, arg2, 0x3a);
}

char* sub_403cf0(int32_t arg1, int32_t arg2, uint64_t arg3)
{
    if (arg2 == 0xa)
    {
        abort();
...
char* sub_403d60(int32_t arg1, int64_t arg2, int64_t arg3, uint64_t arg4, 
    uint64_t arg5)
{
    int128_t var_48 = data_609400;
    int128_t var_38 = data_609410;
    ...
    if ((arg2 != 0 && arg3 != 0))
    {
        *var_28[8] = arg2;
        ...
        return sub_403620(arg1, arg4, arg5, &var_48);
    }
    abort();
    /* no return */
}
...
{
    /* tailcall */
    return sub_403620(0, arg1, -1, &data_609220);
}

int64_t sub_403e90(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4, 
    int64_t* arg5, int64_t arg6)
{
    ...
    __fprintf_chk(arg1, 1, "Copyright %s %d Free Software Fo…", dcgettext(nullptr, &data_4071eb, 5), 0x7e1);
...
int64_t sub_404270(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4, 
    int64_t* arg5)
{
    int64_t r9 = 0;
    if (*arg5 != 0)
    ...
    /* tailcall */
    return sub_403e90(arg1, arg2, arg3, arg4, arg5, r9);
}

int64_t sub_404290(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4, 
    int32_t* arg5)
{
    int64_t r9 = 0;
    void var_58;
    ...
    return sub_403e90(arg1, arg2, arg3, arg4, &var_58, r9);
}

int64_t sub_4042f0(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4)
{
    char r11 = 0;
    int64_t r8;
    int64_t var_18 = r8;
    ...
    return sub_403e90(arg1, arg2, arg3, arg4, &var_88, r9_1);
}
...
int64_t sub_404430(uint64_t arg1)
{
...
int64_t sub_404490(int64_t arg1, uint64_t arg2)
{
    if ((arg2 == 0 && arg1 != 0))
    {
        free(arg1);
...
int64_t sub_4044d0(int64_t arg1, int64_t arg2, int64_t arg3)
{
    uint64_t rax;
    int64_t rdx;
    rdx = HIGHD((arg2 * arg3));
...
noreturn int64_t sub_4045da() 
{
    sub_404680();
    /* no return */
}

int64_t sub_4045e0(uint64_t arg1)
{
    /* tailcall */
    return memset(sub_404430(arg1), 0, arg1);
}

int64_t sub_404600(uint64_t arg1, uint64_t arg2)
{
    int64_t rax;
    bool rdx;
    rdx = HIGHD((arg1 * arg2));
...
int64_t sub_404630(int64_t arg1, uint64_t arg2)
{
    /* tailcall */
    return memcpy(sub_404430(arg2), arg1, arg2);
}

int64_t sub_404660(char* arg1)
{
    /* tailcall */
    return sub_404630(arg1, (strlen(arg1) + 1));
}

noreturn int64_t sub_404680() 
{
    error(data_609218, 0, "%s", dcgettext(nullptr, "memory exhausted", 5));
    abort();
    /* no return */
}

uint64_t sub_4046c0(char* arg1, gid_t arg2, gid_t** arg3)
{
    int32_t rax = sub_405bb0(arg1, arg2, arg3);
...
uint64_t sub_4046f0(int64_t arg1, int32_t* arg2)
{
    int64_t r11 = (arg1 + 8);
...
uint64_t sub_4047d0(int32_t arg1, int64_t* arg2, char* arg3, int64_t* arg4, 
...
uint64_t sub_404df0(int32_t arg1, int64_t* arg2, char* arg3, int64_t* arg4, 
        ...
        label_404eb8:;
            ...
            if (((!z_1) && rcx_3 != 0))
            {
                ...
                if (*r14_1 == 0x2d)
                {
                    ...
                    label_4050f1:
                        *(arg7 + 0x20) = &r14_1[1];
                        int32_t rax_12 = sub_4047d0(rbp_1, arg2, r15_1, arg4, arg5, arg6, arg7, r13, &data_40768a);
                        r14_2 = rax_12;
                                ...
                                if (((*rax_7 == 0x57 && arg4 != 0) && rcx_7 == 0x3b))
                                {
                                    ...
                                    label_40516e:
                                        *(arg7 + 0x20) = r8_1;
                                        arg6 = 0;
                                        *(arg7 + 0x10) = 0;
                                        var_78_1 = &data_4076a8;
                                        var_80_2 = r13;
                                        var_88_2 = arg7;
                                    label_4051a0:
                                        r14_2 = sub_4047d0(rbp_1, arg2, r15_1, arg4, arg5, arg6, var_88_2, var_80_2, var_78_1);
                                    }
                                }
...
uint64_t sub_405420(int32_t arg1, int64_t* arg2, char* arg3)
{
    return _getopt_internal(arg1, arg2, arg3, nullptr, nullptr, 0, 1);
}

uint64_t sub_4054c0(uint32_t* arg1, char* arg2, uint64_t arg3, mbstate_t* arg4)
{
    uint64_t rbx_1;
    char* rbp_1;
    uint32_t* r12_1;
...
uint64_t sub_405540(FILE* arg1)
{
    int32_t* rbp = arg1;
    uint64_t rax = __fpending(arg1);
    int32_t rbx_1 = (*rbp & 0x20);
    uint64_t rax_1 = sub_405dc0(rbp);
    if ((rbx_1 != 0 && rax_1 == 0))
    {
        *__errno_location() = 0;
        rax_1 = 0xffffffff;
...
char* sub_405600()
{
    ...
    char* r15 = data_609478;
    char* rbx = rax;
    if (rax == 0)
    {
        rbx = &data_40768c[0x1b];
    }
    if (r15 == 0)
    {
...
int64_t sub_405b70(int64_t arg1, int64_t arg2)
{
    uint64_t rax;
    rax = (arg2 >> 0x3e) != 0;
    int64_t rsi = (arg2 << 2);
...
uint64_t sub_405bb0(char* arg1, gid_t arg2, gid_t** arg3)
{
    int32_t var_2c;
    gid_t* rbx_1;
    if (arg1 == 0)
    {
        ...
        if (rax_7 >= 0)
        {
            ...
            if ((rax_7 != 0 && rbp == 0))
            {
                gid_t* rax_14 = sub_405b70(0, rax_7);
                rbx_1 = rax_14;
                if (rax_14 == 0)
                {
                    goto label_405c2f;
            ...
            var_2c = (rax_7 + 1);
            gid_t* rax_9 = sub_405b70(0, (rax_7 + 1));
            rbx_1 = rax_9;
            if (rax_9 == 0)
            {
                goto label_405c2f;
    ...
    while (true)
    {
        ...
        {
            gid_t* rax_2 = sub_405b70(rbx_1, var_2c);
            if (rax_2 != 0)
            {
                *arg3 = rax_2;
                return var_2c;
        ...
        gid_t* rax_5 = sub_405b70(rbx_1, rsi_2);
        if (rax_5 == 0)
        {
            break;
        }
...
int64_t sub_405dc0(FILE* arg1)
{
    ...
    if (fileno(arg1) >= 0)
    {
        ...
        if (((rax_1 == 0 || (rax_1 != 0 && rax_6 != -1)) && sub_405e40(arg1) != 0))
        {
            int32_t* rax_3 = __errno_location();
            int32_t r12 = *rax_3;
...
off64_t sub_405e80(FILE* arg1, off_t arg2, int32_t arg3)
{
...
int64_t sub_405f50(void (* arg1)(void*))
{
    int64_t rdx = data_609208;
    /* tailcall */
    return __cxa_atexit(arg1, nullptr, rdx);
}

int64_t sub_405f68(int64_t arg1, int64_t arg2, int64_t arg3)
{
