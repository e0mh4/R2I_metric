...
noreturn int64_t sub_402c90(int32_t arg1) 
{
    ...
    {
        __printf_chk(1, dcgettext(nullptr, "Usage: %s [OPTION]... [FILE]...n…", 5), rbp, "SHA224", 0xe0);
        ...
        __printf_chk(1, dcgettext(nullptr, "nThe sums are computed as descr…", 5), "RFC 3874");
        ...
        if (rbp_1 == 0)
        {
            ...
            if ((rax_26 == 0 || (rax_26 != 0 && rax_27 == 0)))
            {
                rbp_1 = "sha224sum";
                r12_1 = " invocation";
                __printf_chk(1, dcgettext(nullptr, "Full documentation at: <%s%s>n", 5), "https://www.gnu.org/software/cor…", "sha224sum");
            }
        }
        else
        {
