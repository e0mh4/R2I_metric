...
noreturn int32_t main(int32_t argc, char** argv, char** envp) 
{
    int64_t r15 = 0;
    int64_t r14 = 0;
    int64_t r13 = 0;
    ...
    void var_58;
    int32_t var_50;
    setlocale(6, &data_4070cc[0x1b], rdx, rcx, r8, r9, var_58, var_50);
    bindtextdomain("coreutils", "/home/dongkwan/data/scripts/gnu_…");
    textdomain("coreutils");
    sub_405770(sub_401c50);
    int64_t var_50_1 = 0;
    while (true)
    {
        int32_t var_3c = 0;
        int32_t rax_1 = getopt_long(argc, argv, "+r:t:u:l:c", &data_405d80, &var_3c);
        if (rax_1 == 0xffffffff)
        {
            int32_t rax_4 = data_60921c;
            if (rax_4 == argc)
            {
                int32_t* rax_8 = __errno_location();
                *rax_8 = 0x5f;
                error(1, *rax_8, dcgettext(nullptr, "failed to get current context", 5));
            }
            else
            {
                char const* const rsi_1;
                if (((r14 | r13) == 0 && ((var_50_1 | r15) == 0 && r12 == 0)))
                {
                    if (rax_4 >= argc)
                    {
                        rsi_1 = "you must specify -c, -t, -u, -l,…";
                        goto label_401715;
                    }
                    data_60921c = (rax_4 + 1);
                }
                if (data_60921c >= argc)
                {
                    rsi_1 = "no command specified";
                label_401715:
                    error(0, 0, dcgettext(nullptr, rsi_1, 5));
                    break;
                }
            }
            error(1, 0, dcgettext(nullptr, "%s may be used only on a SELinux…", 5), data_609268);
        }
        else
        {
            bool cond0_1 = rax_1 > 0x6c;
            if (rax_1 == 0x6c)
            {
                if (r15 == 0)
                {
            ...
            if ((!cond0_1))
            {
                ...
                if (rax_1 != 0x63)
                {
                    if (rax_1 == 0xffffff7d)
                    {
                        sub_403d90(stdout, "runcon", "GNU coreutils", data_6091b0);
                        exit(0);
                        /* no return */
                    }
                    break;
        ...
        error(1, 0, dcgettext(nullptr, "multiple roles", 5));
    label_4017c6:
        error(1, 0, dcgettext(nullptr, "multiple types", 5));
    label_4017e8:
        error(1, 0, dcgettext(nullptr, "multiple levelranges", 5));
    label_40180a:;
        void (* rdx_8)();
        int64_t rsi_3;
        int64_t rdi_3;
        rdx_8 = error(1, 0, dcgettext(nullptr, "multiple users", 5));
        /* tailcall */
        return _start(rdi_3, rsi_3, rdx_8);
    }
    sub_4018f0(1);
    /* no return */
}
...
int64_t j_sub_40185a()
{
    /* tailcall */
    return sub_40185a();
}

noreturn int64_t sub_4018f0(int32_t arg1) 
{
    int64_t rbp = data_609268;
    if (arg1 != 0)
    {
    ...
    {
        __printf_chk(1, dcgettext(nullptr, "Usage: %s CONTEXT COMMAND [args]…", 5), rbp, rbp);
        fputs_unlocked(dcgettext(nullptr, "Run a program in a different SEL…", 5), stdout);
        fputs_unlocked(dcgettext(nullptr, "nMandatory arguments to long op…", 5), stdout);
        fputs_unlocked(dcgettext(nullptr, "  CONTEXT            Complete se…", 5), stdout);
        ...
        if (rbp_1 == 0)
        {
            ...
            if (rax_20 != 0)
            {
                rax_21 = strncmp(rax_20, &data_40584f, 3);
                if (rax_21 != 0)
                {
                    rbp_1 = "runcon";
                }
            ...
            if ((rax_20 == 0 || (rax_20 != 0 && rax_21 == 0)))
            {
                rbp_1 = "runcon";
                r12_1 = " invocation";
                __printf_chk(1, dcgettext(nullptr, "Full documentation at: <%s%s>n", 5), "https://www.gnu.org/software/cor…", "runcon");
            }
        }
        else
        {
            ...
            if (strncmp(rax_12, &data_40584f, 3) == 0)
            {
                goto label_401b20;
            }
        }
        ...
        {
            __printf_chk(1, dcgettext(nullptr, "Report %s translation bugs to <h…", 5), "runcon");
        label_401b20:
            r12_1 = " invocation";
            __printf_chk(1, dcgettext(nullptr, "Full documentation at: <%s%s>n", 5), "https://www.gnu.org/software/cor…", "runcon");
            if (rbp_1 != "runcon")
            {
                r12_1 = &data_4070cc[0x1b];
            }
        }
...
int64_t sub_401c30(int64_t arg1)
{
    data_609260 = arg1;
}

int64_t sub_401c40(char arg1)
{
    data_609258 = arg1;
}

void sub_401c50(void* arg1)
{
    int32_t rax = sub_404fb0(stdout);
    int32_t* rax_1;
    if (rax != 0)
    {
        rax_1 = __errno_location();
        if ((data_609258 == 0 || (data_609258 != 0 && *rax_1 != 0x20)))
        {
            char* rax_3 = dcgettext(nullptr, "write error", 5);
            int64_t rdi_2 = data_609260;
            if (rdi_2 == 0)
            {
            ...
            {
                error(0, *rax_1, "%s: %s", sub_403760(rdi_2), rax_3);
            }
        }
    }
    if (((rax == 0 || ((rax != 0 && data_609258 != 0) && *rax_1 == 0x20)) && sub_404fb0(stderr) == 0))
    {
        return;
    }
    _exit(data_6091b8);
...
char* sub_401d90(char* arg1, int32_t arg2)
{
    char* rax = dcgettext(nullptr, arg1, 5);
    char* rbx = rax;
    if (arg1 == rax)
    {
        char* rax_2 = sub_405070();
...
int64_t sub_401e90(char* arg1, uint64_t arg2, uint64_t arg3, uint64_t arg4, 
    uint32_t arg5, int32_t arg6, int64_t arg7, char* arg8, char* arg9)
{
            ...
            while (true)
            {
                ...
                if (r13 == 0)
                {
                    ...
                    else if (var_5b_1 != 0)
                    {
                        if (var_a9 != 0)
                        {
                            rbx_1 = sub_401e90(r15, var_70, arg3, r11, 5, arg6, arg7, arg8, arg9);
                        }
                        else
                        {
                            rax_1 = r14 == 0;
                ...
                else
                {
                    ...
                    if (var_a0_1 != 0)
                    {
                        ...
                        label_402f80:
                            ...
                            r11 = r9;
                        label_4022e4:
                            rbx_1 = sub_401e90(r15, r14, arg3, r11, r13_1, (arg6 & 0xfffffffd), 0, arg8, arg9);
                        label_4022fb:
                            return rbx_1;
                        }
                        rbp_3 = *r8;
                    ...
                    label_402630:
                        ...
                        label_402435:;
                            ...
                            while (true)
                            {
                                ...
                                uint32_t var_44;
                                rax_12 = sub_404f30(&var_44, rbp_4, (var_98 - r15_1), &var_40);
                                if (rax_12 != 0)
                                {
                                    if (rax_12 == -1)
                                    {
    ...
    switch (r13)
    {
        ...
        case 0xa:
        {
            if ((!cond1))
            {
                arg8 = sub_401d90(&data_405eed, r13);
                arg9 = sub_401d90("'", r13);
            }
            rbx_1 = 0;
            if (rbp_1 == 0)
...
char* sub_4030c0(int32_t arg1, uint64_t arg2, uint64_t arg3, int32_t* arg4)
{
    int64_t r15 = arg1;
    int32_t* rax = __errno_location();
    int64_t rbx = data_6091f8;
    int32_t rax_1 = *rax;
    if (r15 < 0)
    {
        abort();
    ...
    if (data_609210 <= r15)
    {
        ...
        if (rbx == 0x609200)
        {
            int64_t rax_9 = sub_403f30(0, rsi_1);
            int128_t zmm0 = data_609200;
            rbx = rax_9;
            data_6091f8 = rax_9;
            *rax_9 = zmm0;
        }
        ...
        {
            int64_t rax_2 = sub_403f30(rbx, rsi_1);
            data_6091f8 = rax_2;
            rbx = rax_2;
        }
        int64_t rdi_1 = data_609210;
    ...
    uint64_t r11 = *rbx_1;
    char* r12_2 = *(rbx_1 + 8);
    int64_t rax_5 = sub_401e90(r12_2, r11, arg2, arg3, *arg4, rax_4, r15_2, *(arg4 + 0x28), *(arg4 + 0x30));
    if (r11 <= rax_5)
    {
        ...
        *rbx_1 = rsi_3;
        ...
        char* rax_6 = sub_403ed0(rsi_3);
        uint32_t r8_1 = *arg4;
        *(rbx_1 + 8) = rax_6;
        r12_2 = rax_6;
        sub_401e90(rax_6, rsi_3, arg2, arg3, r8_1, rax_4, r15_2, *(arg4 + 0x28), *(arg4 + 0x30));
    }
    *rax = rax_1;
    return r12_2;
}

int64_t sub_403260(int64_t arg1)
{
    int64_t rbx = arg1;
    int32_t* rax = __errno_location();
    int32_t r12 = *rax;
    ...
    int64_t rax_1 = sub_4040d0(rbx, 0x38);
    *rax = r12;
    return rax_1;
}

uint64_t sub_4032a0(int32_t* arg1)
{
    if (arg1 == 0)
    {
        arg1 = &data_609380;
...
void sub_4032b0(int32_t* arg1, int32_t arg2)
{
    if (arg1 == 0)
    {
        arg1 = &data_609380;
...
uint64_t sub_4032c0(int64_t arg1, uint8_t arg2, int32_t arg3)
{
    if (arg1 == 0)
    {
        arg1 = 0x609380;
...
uint64_t sub_403300(int128_t* arg1, int32_t arg2)
{
    if (arg1 == 0)
    {
        arg1 = &data_609380;
...
void sub_403320(int32_t* arg1, int64_t arg2, int64_t arg3)
{
    if (arg1 == 0)
    {
        arg1 = &data_609380;
    ...
    *arg1 = 0xa;
    ...
    int64_t var_8 = 0x609380;
    abort();
    /* no return */
}

int64_t sub_403350(char* arg1, uint64_t arg2, uint64_t arg3, uint64_t arg4, 
    int32_t* arg5)
{
    int32_t* rbx = arg5;
    if (arg5 == 0)
    ...
    int32_t* rax = __errno_location();
    int32_t r12 = *rax;
    int64_t rax_2 = sub_401e90(arg1, arg2, arg3, arg4, *rbx, rbx[1], &rbx[2], *(rbx + 0x28), *(rbx + 0x30));
    *rax = r12;
    return rax_2;
}

char* sub_4033d0(uint64_t arg1, uint64_t arg2, int64_t* arg3, int32_t* arg4)
{
    int32_t* rbx = arg4;
    if (arg4 == 0)
    {
    ...
    int64_t rax_2 = sub_401e90(nullptr, 0, arg1, arg2, *rbx, rbp_1, &rbx[2], *(rbx + 0x28), *(rbx + 0x30));
    char* rax_3 = sub_403ed0((rax_2 + 1));
    sub_401e90(rax_3, (rax_2 + 1), arg1, arg2, *rbx, rbp_1, &rbx[2], *(rbx + 0x28), *(rbx + 0x30));
    *rax = rax_1;
    if (arg3 != 0)
    {
        *arg3 = rax_2;
...
int64_t sub_4034c0(uint64_t arg1, uint64_t arg2, int32_t* arg3)
{
    /* tailcall */
    return sub_4033d0(arg1, arg2, nullptr, arg3);
}

uint64_t sub_4034d0()
{
    uint64_t rax_2 = data_609210;
    int64_t r12 = data_6091f8;
    if (rax_2 > 1)
    {
    ...
    if (rdi_2 != 0x609280)
    {
        rax_2 = free(rdi_2);
        *data_609200 = 0x100;
        *(data_609200 + 8) = 0x609280;
    }
    if (r12 != 0x609200)
    {
        rax_2 = free(r12);
        data_6091f8 = 0x609200;
    }
    data_609210 = 1;
    return rax_2;
}

int64_t sub_403570(int32_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_4030c0(arg1, arg2, -1, &data_609380);
}

int64_t sub_403590(int32_t arg1, uint64_t arg2, uint64_t arg3)
{
    /* tailcall */
    return sub_4030c0(arg1, arg2, arg3, &data_609380);
}

int64_t sub_4035a0(uint64_t arg1)
{
    /* tailcall */
    return sub_4030c0(0, arg1, -1, &data_609380);
}

int64_t sub_4035c0(uint64_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_4030c0(0, arg1, arg2, &data_609380);
}

char* sub_4035e0(int32_t arg1, int32_t arg2, uint64_t arg3)
{
    if (arg2 == 0xa)
    {
        abort();
    ...
    int64_t var_20 = 0;
    int64_t var_18 = 0;
    return sub_4030c0(arg1, arg3, -1, &var_48);
}

char* sub_403650(int32_t arg1, int32_t arg2, uint64_t arg3, uint64_t arg4)
{
    if (arg2 == 0xa)
    {
        abort();
    ...
    int64_t var_20 = 0;
    int64_t var_18 = 0;
    return sub_4030c0(arg1, arg3, arg4, &var_48);
}

int64_t sub_4036c0(int32_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_4035e0(0, arg1, arg2);
}

int64_t sub_4036d0(int32_t arg1, uint64_t arg2, uint64_t arg3)
{
    /* tailcall */
    return sub_403650(0, arg1, arg2, arg3);
}

char* sub_4036e0(uint64_t arg1, uint64_t arg2, uint8_t arg3)
{
    char rcx_1 = (arg3 & 0x1f);
    int64_t var_18 = data_6093b0;
    int128_t var_48 = data_609380;
    int128_t var_38 = data_609390;
    int128_t var_28 = data_6093a0;
    int32_t rdx = *((&var_48 + ((arg3 >> 5) << 2)) + 8);
    *((&var_48 + ((arg3 >> 5) << 2)) + 8) = ((((!(rdx >> rcx_1)) & 1) << rcx_1) ^ rdx);
    return sub_4030c0(0, arg1, arg2, &var_48);
}

int64_t sub_403750(uint64_t arg1, uint8_t arg2)
{
    /* tailcall */
    return sub_4036e0(arg1, -1, arg2);
}

int64_t sub_403760(uint64_t arg1)
{
    /* tailcall */
    return sub_4036e0(arg1, -1, 0x3a);
}

int64_t sub_403780(uint64_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_4036e0(arg1, arg2, 0x3a);
}

char* sub_403790(int32_t arg1, int32_t arg2, uint64_t arg3)
{
    if (arg2 == 0xa)
    {
        abort();
...
char* sub_403800(int32_t arg1, int64_t arg2, int64_t arg3, uint64_t arg4, 
    uint64_t arg5)
{
    int128_t var_48 = data_609380;
    int128_t var_38 = data_609390;
    ...
    if ((arg2 != 0 && arg3 != 0))
    {
        *var_28[8] = arg2;
        ...
        return sub_4030c0(arg1, arg4, arg5, &var_48);
    }
    abort();
    /* no return */
}

int64_t sub_403930(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4, 
    int64_t* arg5, int64_t arg6)
{
    ...
    __fprintf_chk(arg1, 1, "Copyright %s %d Free Software Fo…", dcgettext(nullptr, &data_406c2b, 5), 0x7e1);
...
int64_t sub_403d10(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4, 
    int64_t* arg5)
{
    int64_t r9 = 0;
    if (*arg5 != 0)
    ...
    /* tailcall */
    return sub_403930(arg1, arg2, arg3, arg4, arg5, r9);
}

int64_t sub_403d30(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4, 
    int32_t* arg5)
{
    int64_t r9 = 0;
    void var_58;
    ...
    return sub_403930(arg1, arg2, arg3, arg4, &var_58, r9);
}

int64_t sub_403d90(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4)
{
    char r11 = 0;
    int64_t r8;
    int64_t var_18 = r8;
    ...
    return sub_403930(arg1, arg2, arg3, arg4, &var_88, r9_1);
}
...
int64_t sub_403ed0(uint64_t arg1)
{
...
int64_t sub_403f30(int64_t arg1, uint64_t arg2)
{
    if ((arg2 == 0 && arg1 != 0))
    {
        free(arg1);
...
noreturn int64_t sub_40407a() 
{
    sub_404120();
    /* no return */
}

int64_t sub_404080(uint64_t arg1)
{
    /* tailcall */
    return memset(sub_403ed0(arg1), 0, arg1);
}

int64_t sub_4040a0(uint64_t arg1, uint64_t arg2)
{
    int64_t rax;
    bool rdx;
    rdx = HIGHD((arg1 * arg2));
...
int64_t sub_4040d0(int64_t arg1, uint64_t arg2)
{
    /* tailcall */
    return memcpy(sub_403ed0(arg2), arg1, arg2);
}

int64_t sub_404100(char* arg1)
{
    /* tailcall */
    return sub_4040d0(arg1, (strlen(arg1) + 1));
}

noreturn int64_t sub_404120() 
{
    error(data_6091b8, 0, "%s", dcgettext(nullptr, "memory exhausted", 5));
    abort();
    /* no return */
}

uint64_t sub_404160(int64_t arg1, int32_t* arg2)
{
    int64_t r11 = (arg1 + 8);
...
uint64_t sub_404240(int32_t arg1, int64_t* arg2, char* arg3, int64_t* arg4, 
...
uint64_t sub_404860(int32_t arg1, int64_t* arg2, char* arg3, int64_t* arg4, 
        ...
        label_404928:;
            ...
            if (((!z_1) && rcx_3 != 0))
            {
                ...
                if (*r14_1 == 0x2d)
                {
                    ...
                    label_404b61:
                        *(arg7 + 0x20) = &r14_1[1];
                        int32_t rax_12 = sub_404240(rbp_1, arg2, r15_1, arg4, arg5, arg6, arg7, r13, &data_4070ca);
                        r14_2 = rax_12;
                                ...
                                if (((*rax_7 == 0x57 && arg4 != 0) && rcx_7 == 0x3b))
                                {
                                    ...
                                    label_404bde:
                                        *(arg7 + 0x20) = r8_1;
                                        arg6 = 0;
                                        *(arg7 + 0x10) = 0;
                                        var_78_1 = &data_4070e8;
                                        var_80_2 = r13;
                                        var_88_2 = arg7;
                                    label_404c10:
                                        r14_2 = sub_404240(rbp_1, arg2, r15_1, arg4, arg5, arg6, var_88_2, var_80_2, var_78_1);
                                    }
                                }
...
uint64_t sub_404e90(int32_t arg1, int64_t* arg2, char* arg3)
{
    return _getopt_internal(arg1, arg2, arg3, nullptr, nullptr, 0, 1);
}

uint64_t sub_404f30(uint32_t* arg1, char* arg2, uint64_t arg3, mbstate_t* arg4)
{
    uint64_t rbx_1;
    char* rbp_1;
    uint32_t* r12_1;
...
uint64_t sub_404fb0(FILE* arg1)
{
    int32_t* rbp = arg1;
    uint64_t rax = __fpending(arg1);
    int32_t rbx_1 = (*rbp & 0x20);
    uint64_t rax_1 = sub_4055e0(rbp);
    if ((rbx_1 != 0 && rax_1 == 0))
    {
        *__errno_location() = 0;
        rax_1 = 0xffffffff;
...
char* sub_405070()
{
    ...
    char* r15 = data_6093f8;
    char* rbx = rax;
    if (rax == 0)
    {
        rbx = &data_4070cc[0x1b];
    }
    if (r15 == 0)
    {
...
int64_t sub_4055e0(FILE* arg1)
{
    ...
    if (fileno(arg1) >= 0)
    {
        ...
        if (((rax_1 == 0 || (rax_1 != 0 && rax_6 != -1)) && sub_405660(arg1) != 0))
        {
...
off64_t sub_4056a0(FILE* arg1, off_t arg2, int32_t arg3)
{
...
int64_t sub_405770(void (* arg1)(void*))
{
    /* tailcall */
    return __cxa_atexit(arg1, nullptr, data_6091a8);
}

int64_t sub_405788(int64_t arg1, int64_t arg2, int64_t arg3)
{
