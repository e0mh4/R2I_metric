...
int32_t main(int32_t argc, char** argv, char** envp)
{
    ...
    rcx = sub_401950(*argv);
    int32_t rbx;
    setlocale(6, &data_404669[4], rdx, rcx, r8, r9, rbx, __return_addr);
    bindtextdomain("coreutils", "/home/dongkwan/data/scripts/gnu_…");
    textdomain("coreutils");
    sub_404600(sub_4018b0);
    char* rbx_2 = argv[1];
    if (strcmp(rbx_2, "--help") == 0)
    {
        sub_4015a0(0);
        /* no return */
    }
    if (strcmp(rbx_2, "--version") == 0)
    {
        sub_4039f0(stdout, "true", "GNU coreutils", data_607190);
    }
    return 0;
}
...
int64_t j_sub_40150a()
{
    /* tailcall */
    return sub_40150a();
}

noreturn int64_t sub_4015a0(int32_t arg1) 
{
    int64_t rbx = data_607248;
    __printf_chk(1, dcgettext(nullptr, "Usage: %s [ignored command line …", 5), rbx, rbx);
    __printf_chk(1, "%snn", dcgettext(nullptr, "Exit with a status code indicati…", 5));
    ...
    __printf_chk(1, dcgettext(nullptr, "nNOTE: your shell may have its …", 5), "true");
    void* const var_88 = &data_40466e;
    void* const rdi_2 = "coreutils";
    void* const* rax_8 = &var_88;
    void* const var_78 = "coreutils";
    void* const var_70 = "Multi-call invocation";
    void* const var_68 = "sha224sum";
    void* const var_60 = "sha2 utilities";
    void* const var_58 = "sha256sum";
    void* const var_50 = "sha2 utilities";
    void* const var_48 = "sha384sum";
    void* const var_40 = "sha2 utilities";
    void* const var_38 = "sha512sum";
    void* const var_30 = "sha2 utilities";
    int64_t var_28 = 0;
    int64_t var_20 = 0;
    while (true)
    {
        rax_8 = &rax_8[2];
        bool c_1 = false;
        bool z_1 = (rdi_2 & rdi_2) == 0;
        if (z_1)
        {
            break;
        }
        void* const rsi_4 = "true";
        int64_t rcx_1 = 5;
        while (rcx_1 != 0)
        {
            char temp0_1 = *rsi_4;
    ...
    if (rbx_1 == 0)
    {
        ...
        rax_19 = setlocale(5, nullptr, rdx_5, rcx_4, r8_1, r9_1, var_88, "test invocation");
        if (rax_19 != 0)
        {
            rax_20 = strncmp(rax_19, &data_4046f2, 3);
            if (rax_20 != 0)
            {
                rbx_1 = "true";
            }
        ...
        if ((rax_19 == 0 || (rax_19 != 0 && rax_20 == 0)))
        {
            rbx_1 = "true";
            r12 = " invocation";
            __printf_chk(1, dcgettext(nullptr, "Full documentation at: <%s%s>n", 5), "https://www.gnu.org/software/cor…", "true");
        }
    }
    else
    {
        ...
        uint64_t r8;
        ssize_t r9;
        rcx_2 = __printf_chk(1, dcgettext(nullptr, "n%s online help: <%s>n", 5), "GNU coreutils", "https://www.gnu.org/software/cor…");
        char* rax_11 = setlocale(5, nullptr, rdx_3, rcx_2, r8, r9, var_88, "test invocation");
        if (rax_11 == 0)
        {
            goto label_401781;
        }
        if (strncmp(rax_11, &data_4046f2, 3) == 0)
        {
            goto label_401781;
        }
    }
    if ((((rbx_1 == 0 && rax_19 != 0) && rax_20 != 0) || rbx_1 != 0))
    {
        __printf_chk(1, dcgettext(nullptr, "Report %s translation bugs to <h…", 5), "true");
    label_401781:
        r12 = " invocation";
        __printf_chk(1, dcgettext(nullptr, "Full documentation at: <%s%s>n", 5), "https://www.gnu.org/software/cor…", "true");
        if (rbx_1 != "true")
    ...
    __printf_chk(1, dcgettext(nullptr, "or available locally via: info '…", 5), rbx_1, r12);
    exit(arg1);
    /* no return */
}

int64_t sub_401890(int64_t arg1)
{
    data_607240 = arg1;
}

int64_t sub_4018a0(char arg1)
{
    data_607238 = arg1;
}

void sub_4018b0(void* arg1)
{
    int32_t rax = sub_403e40(stdout);
    int32_t* rax_1;
    if (rax != 0)
    {
        rax_1 = __errno_location();
        if ((data_607238 == 0 || (data_607238 != 0 && *rax_1 != 0x20)))
        {
            char* rax_3 = dcgettext(nullptr, "write error", 5);
            int64_t rdi_2 = data_607240;
            if (rdi_2 == 0)
            {
            ...
            {
                error(0, *rax_1, "%s: %s", sub_4033c0(rdi_2), rax_3);
            }
        }
    }
    if (((rax == 0 || ((rax != 0 && data_607238 != 0) && *rax_1 == 0x20)) && sub_403e40(stderr) == 0))
    {
        return;
    }
    _exit(data_607198);
...
char* sub_4019f0(char* arg1, int32_t arg2)
{
    char* rax = dcgettext(nullptr, arg1, 5);
    char* rbx = rax;
    if (arg1 == rax)
    {
        char* rax_2 = sub_403f00();
...
int64_t sub_401af0(char* arg1, uint64_t arg2, uint64_t arg3, uint64_t arg4, 
    uint32_t arg5, int32_t arg6, int64_t arg7, char* arg8, char* arg9)
{
            ...
            while (true)
            {
                ...
                if (r13 == 0)
                {
                    ...
                    else if (var_5b_1 != 0)
                    {
                        if (var_a9 != 0)
                        {
                            rbx_1 = sub_401af0(r15, var_70, arg3, r11, 5, arg6, arg7, arg8, arg9);
                        }
                        else
                        {
                            rax_1 = r14 == 0;
                ...
                else
                {
                    ...
                    if (var_a0_1 != 0)
                    {
                        ...
                        label_402be0:
                            ...
                            r11 = r9;
                        label_401f44:
                            rbx_1 = sub_401af0(r15, r14, arg3, r11, r13_1, (arg6 & 0xfffffffd), 0, arg8, arg9);
                        label_401f5b:
                            return rbx_1;
                        }
                        rbp_3 = *r8;
                    ...
                    label_402290:
                        ...
                        label_402095:;
                            ...
                            while (true)
                            {
                                ...
                                uint32_t var_44;
                                rax_12 = sub_403dc0(&var_44, rbp_4, (var_98 - r15_1), &var_40);
                                if (rax_12 != 0)
                                {
                                    if (rax_12 == -1)
                                    {
    ...
    switch (r13)
    {
        ...
        case 0xa:
        {
            if ((!cond1))
            {
                arg8 = sub_4019f0(&data_404a57, r13);
                arg9 = sub_4019f0(&data_404a55, r13);
            }
            rbx_1 = 0;
            if (rbp_1 == 0)
            {
...
char* sub_402d20(int32_t arg1, uint64_t arg2, uint64_t arg3, int32_t* arg4)
{
    int64_t r15 = arg1;
    int32_t* rax = __errno_location();
    int64_t rbx = data_6071d8;
    int32_t rax_1 = *rax;
    if (r15 < 0)
    {
        abort();
    ...
    if (data_6071f0 <= r15)
    {
        ...
        if (rbx == 0x6071e0)
        {
            int64_t rax_9 = sub_403b90(0, rsi_1);
            int128_t zmm0 = data_6071e0;
            rbx = rax_9;
            data_6071d8 = rax_9;
            *rax_9 = zmm0;
        }
        ...
        {
            int64_t rax_2 = sub_403b90(rbx, rsi_1);
            data_6071d8 = rax_2;
            rbx = rax_2;
        }
        int64_t rdi_1 = data_6071f0;
    ...
    uint64_t r11 = *rbx_1;
    char* r12_2 = *(rbx_1 + 8);
    int64_t rax_5 = sub_401af0(r12_2, r11, arg2, arg3, *arg4, rax_4, r15_2, *(arg4 + 0x28), *(arg4 + 0x30));
    if (r11 <= rax_5)
    {
        ...
        *rbx_1 = rsi_3;
        ...
        char* rax_6 = sub_403b30(rsi_3);
        uint32_t r8_1 = *arg4;
        *(rbx_1 + 8) = rax_6;
        r12_2 = rax_6;
        sub_401af0(rax_6, rsi_3, arg2, arg3, r8_1, rax_4, r15_2, *(arg4 + 0x28), *(arg4 + 0x30));
    }
    *rax = rax_1;
    return r12_2;
}

int64_t sub_402ec0(int64_t arg1)
{
    int64_t rbx = arg1;
    int32_t* rax = __errno_location();
    int32_t r12 = *rax;
    ...
    int64_t rax_1 = sub_403d30(rbx, 0x38);
    *rax = r12;
    return rax_1;
}

uint64_t sub_402f00(int32_t* arg1)
{
    if (arg1 == 0)
    {
        arg1 = &data_607360;
...
void sub_402f10(int32_t* arg1, int32_t arg2)
{
    if (arg1 == 0)
    {
        arg1 = &data_607360;
...
uint64_t sub_402f20(int64_t arg1, uint8_t arg2, int32_t arg3)
{
    if (arg1 == 0)
    {
        arg1 = 0x607360;
...
uint64_t sub_402f60(int128_t* arg1, int32_t arg2)
{
    if (arg1 == 0)
    {
        arg1 = &data_607360;
...
void sub_402f80(int32_t* arg1, int64_t arg2, int64_t arg3)
{
    if (arg1 == 0)
    {
        arg1 = &data_607360;
    ...
    *arg1 = 0xa;
    ...
    int64_t var_8 = 0x607360;
    abort();
    /* no return */
}

int64_t sub_402fb0(char* arg1, uint64_t arg2, uint64_t arg3, uint64_t arg4, 
    int32_t* arg5)
{
    int32_t* rbx = arg5;
    if (arg5 == 0)
    ...
    int32_t* rax = __errno_location();
    int32_t r12 = *rax;
    int64_t rax_2 = sub_401af0(arg1, arg2, arg3, arg4, *rbx, rbx[1], &rbx[2], *(rbx + 0x28), *(rbx + 0x30));
    *rax = r12;
    return rax_2;
}

char* sub_403030(uint64_t arg1, uint64_t arg2, int64_t* arg3, int32_t* arg4)
{
    int32_t* rbx = arg4;
    if (arg4 == 0)
    {
    ...
    int64_t rax_2 = sub_401af0(nullptr, 0, arg1, arg2, *rbx, rbp_1, &rbx[2], *(rbx + 0x28), *(rbx + 0x30));
    char* rax_3 = sub_403b30((rax_2 + 1));
    sub_401af0(rax_3, (rax_2 + 1), arg1, arg2, *rbx, rbp_1, &rbx[2], *(rbx + 0x28), *(rbx + 0x30));
    *rax = rax_1;
    if (arg3 != 0)
    {
        *arg3 = rax_2;
...
int64_t sub_403120(uint64_t arg1, uint64_t arg2, int32_t* arg3)
{
    /* tailcall */
    return sub_403030(arg1, arg2, nullptr, arg3);
}

uint64_t sub_403130()
{
    uint64_t rax_2 = data_6071f0;
    int64_t r12 = data_6071d8;
    if (rax_2 > 1)
    {
    ...
    if (rdi_2 != 0x607260)
    {
        rax_2 = free(rdi_2);
        *data_6071e0 = 0x100;
        *(data_6071e0 + 8) = 0x607260;
    }
    if (r12 != 0x6071e0)
    {
        rax_2 = free(r12);
        data_6071d8 = 0x6071e0;
    }
    data_6071f0 = 1;
    return rax_2;
}

int64_t sub_4031d0(int32_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_402d20(arg1, arg2, -1, &data_607360);
}

int64_t sub_4031f0(int32_t arg1, uint64_t arg2, uint64_t arg3)
{
    /* tailcall */
    return sub_402d20(arg1, arg2, arg3, &data_607360);
}

int64_t sub_403200(uint64_t arg1)
{
    /* tailcall */
    return sub_402d20(0, arg1, -1, &data_607360);
}

int64_t sub_403220(uint64_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_402d20(0, arg1, arg2, &data_607360);
}

char* sub_403240(int32_t arg1, int32_t arg2, uint64_t arg3)
{
    if (arg2 == 0xa)
    {
        abort();
    ...
    int64_t var_20 = 0;
    int64_t var_18 = 0;
    return sub_402d20(arg1, arg3, -1, &var_48);
}

char* sub_4032b0(int32_t arg1, int32_t arg2, uint64_t arg3, uint64_t arg4)
{
    if (arg2 == 0xa)
    {
        abort();
    ...
    int64_t var_20 = 0;
    int64_t var_18 = 0;
    return sub_402d20(arg1, arg3, arg4, &var_48);
}

int64_t sub_403320(int32_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_403240(0, arg1, arg2);
}

int64_t sub_403330(int32_t arg1, uint64_t arg2, uint64_t arg3)
{
    /* tailcall */
    return sub_4032b0(0, arg1, arg2, arg3);
}

char* sub_403340(uint64_t arg1, uint64_t arg2, uint8_t arg3)
{
    char rcx_1 = (arg3 & 0x1f);
    int64_t var_18 = data_607390;
    int128_t var_48 = data_607360;
    int128_t var_38 = data_607370;
    int128_t var_28 = data_607380;
    int32_t rdx = *((&var_48 + ((arg3 >> 5) << 2)) + 8);
    *((&var_48 + ((arg3 >> 5) << 2)) + 8) = ((((!(rdx >> rcx_1)) & 1) << rcx_1) ^ rdx);
    return sub_402d20(0, arg1, arg2, &var_48);
}

int64_t sub_4033b0(uint64_t arg1, uint8_t arg2)
{
    /* tailcall */
    return sub_403340(arg1, -1, arg2);
}

int64_t sub_4033c0(uint64_t arg1)
{
    /* tailcall */
    return sub_403340(arg1, -1, 0x3a);
}

int64_t sub_4033e0(uint64_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_403340(arg1, arg2, 0x3a);
}

char* sub_4033f0(int32_t arg1, int32_t arg2, uint64_t arg3)
{
    if (arg2 == 0xa)
    {
        abort();
...
char* sub_403460(int32_t arg1, int64_t arg2, int64_t arg3, uint64_t arg4, 
    uint64_t arg5)
{
    int128_t var_48 = data_607360;
    int128_t var_38 = data_607370;
    ...
    if ((arg2 != 0 && arg3 != 0))
    {
        *var_28[8] = arg2;
        ...
        return sub_402d20(arg1, arg4, arg5, &var_48);
    }
    abort();
    /* no return */
}

int64_t sub_403590(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4, 
    int64_t* arg5, int64_t arg6)
{
    ...
    __fprintf_chk(arg1, 1, "Copyright %s %d Free Software Fo…", dcgettext(nullptr, &data_4057ab, 5), 0x7e1);
...
int64_t sub_403970(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4, 
    int64_t* arg5)
{
    int64_t r9 = 0;
    if (*arg5 != 0)
    ...
    /* tailcall */
    return sub_403590(arg1, arg2, arg3, arg4, arg5, r9);
}

int64_t sub_403990(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4, 
    int32_t* arg5)
{
    int64_t r9 = 0;
    void var_58;
    ...
    return sub_403590(arg1, arg2, arg3, arg4, &var_58, r9);
}

int64_t sub_4039f0(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4)
{
    char r11 = 0;
    int64_t r8;
    int64_t var_18 = r8;
    ...
    return sub_403590(arg1, arg2, arg3, arg4, &var_88, r9_1);
}
...
int64_t sub_403b30(uint64_t arg1)
{
...
int64_t sub_403b90(int64_t arg1, uint64_t arg2)
{
    if ((arg2 == 0 && arg1 != 0))
    {
        free(arg1);
...
noreturn int64_t sub_403cda() 
{
    sub_403d80();
    /* no return */
}

int64_t sub_403ce0(uint64_t arg1)
{
    /* tailcall */
    return memset(sub_403b30(arg1), 0, arg1);
}

int64_t sub_403d00(uint64_t arg1, uint64_t arg2)
{
    int64_t rax;
    bool rdx;
    rdx = HIGHD((arg1 * arg2));
...
int64_t sub_403d30(int64_t arg1, uint64_t arg2)
{
    /* tailcall */
    return memcpy(sub_403b30(arg2), arg1, arg2);
}

int64_t sub_403d60(char* arg1)
{
    /* tailcall */
    return sub_403d30(arg1, (strlen(arg1) + 1));
}

noreturn int64_t sub_403d80() 
{
    error(data_607198, 0, "%s", dcgettext(nullptr, "memory exhausted", 5));
    abort();
    /* no return */
}

uint64_t sub_403dc0(uint32_t* arg1, char* arg2, uint64_t arg3, mbstate_t* arg4)
{
    uint64_t rbx_1;
    char* rbp_1;
    uint32_t* r12_1;
...
uint64_t sub_403e40(FILE* arg1)
{
    int32_t* rbp = arg1;
    uint64_t rax = __fpending(arg1);
    int32_t rbx_1 = (*rbp & 0x20);
    uint64_t rax_1 = sub_404470(rbp);
    if ((rbx_1 != 0 && rax_1 == 0))
    {
        *__errno_location() = 0;
        rax_1 = 0xffffffff;
...
int64_t sub_404470(FILE* arg1)
{
    ...
    if (fileno(arg1) >= 0)
    {
        ...
        if (((rax_1 == 0 || (rax_1 != 0 && rax_6 != -1)) && sub_4044f0(arg1) != 0))
        {
...
off64_t sub_404530(FILE* arg1, off_t arg2, int32_t arg3)
{
...
int64_t sub_404600(void (* arg1)(void*))
{
    /* tailcall */
    return __cxa_atexit(arg1, nullptr, data_607188);
}

int64_t sub_404618(int64_t arg1, int64_t arg2, int64_t arg3)
{
