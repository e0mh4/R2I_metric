...
noreturn int64_t sub_401a30(int32_t arg1) 
{
    ...
    else
    {
        ...
        if (rbp_1 == 0)
        {
            ...
            if ((rax_21 == 0 || (rax_21 != 0 && rax_22 == 0)))
            {
                rbp_1 = "mkfifo";
                r12_1 = " invocation";
                __printf_chk(1, dcgettext(nullptr, "Full documentation at: <%s%s>n", 5), "https://www.gnu.org/software/cor…", "mkfifo");
            }
        }
        else
        {
