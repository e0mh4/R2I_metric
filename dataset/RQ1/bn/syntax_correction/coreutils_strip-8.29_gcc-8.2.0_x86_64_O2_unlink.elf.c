...
int32_t main(int32_t argc, char** argv, char** envp)
{
    ...
    void var_18;
    int32_t rbx;
    setlocale(6, &data_406dac[0x1b], rdx, rcx, r8, r9, var_18, rbx);
    bindtextdomain("coreutils", "/home/dongkwan/data/scripts/gnu_…");
    textdomain("coreutils");
    sub_405730(sub_401b00);
    sub_401ba0(argc, rbx_1, "unlink", "GNU coreutils", data_6091d0, sub_4017f0, 0);
    if (getopt_long(argc, rbx_1, &data_406dac[0x1b], &data_405aa0, nullptr) == 0xffffffff)
    {
        ...
        if (rax_1 < argc)
        {
            ...
            if ((rax_1 + 1) >= argc)
            {
                if (unlink(rbx_1[rdx_2]) == 0)
                {
                    return 0;
                }
                int64_t rax_8 = sub_403680(4, rbx_1[data_60923c]);
                rbx_1 = dcgettext(nullptr, "cannot unlink %s", 5);
                rdx_2 = error(1, *__errno_location(), rbx_1, rax_8);
            }
            error(0, 0, dcgettext(nullptr, "extra operand %s", 5), sub_4038d0(rbx_1[(rdx_2 + 1)]));
            sub_4017f0(1);
            /* no return */
        }
...
noreturn int64_t sub_4017f0(int32_t arg1) 
{
    ...
    {
        __printf_chk(1, dcgettext(nullptr, "Usage: %s FILEn  or:  %s OPTION…", 5), rbp, rbp);
        fputs_unlocked(dcgettext(nullptr, "Call the unlink function to remo…", 5), stdout);
        ...
        if (rbp_1 == 0)
        {
            ...
            if (rax_18 != 0)
            {
                rax_19 = strncmp(rax_18, &data_40580f, 3);
                if (rax_19 != 0)
                {
                    rbp_1 = "unlink";
                }
            ...
            if ((rax_18 == 0 || (rax_18 != 0 && rax_19 == 0)))
            {
                rbp_1 = "unlink";
                r12_1 = " invocation";
                __printf_chk(1, dcgettext(nullptr, "Full documentation at: <%s%s>n", 5), "https://www.gnu.org/software/cor…", "unlink");
            }
        }
        else
        {
            ...
            if (strncmp(rax_10, &data_40580f, 3) == 0)
            {
                goto label_4019d0;
            }
        }
        ...
        {
            __printf_chk(1, dcgettext(nullptr, "Report %s translation bugs to <h…", 5), "unlink");
        label_4019d0:
            r12_1 = " invocation";
            __printf_chk(1, dcgettext(nullptr, "Full documentation at: <%s%s>n", 5), "https://www.gnu.org/software/cor…", "unlink");
            if (rbp_1 != "unlink")
            {
                r12_1 = &data_406dac[0x1b];
            }
        }
...
void sub_401b00(void* arg1)
{
    ...
    if (((rax == 0 || ((rax != 0 && data_609278 != 0) && *rax_1 == 0x20)) && sub_404f70(stderr) == 0))
    {
        return;
    }
    _exit(data_6091d8);
    ...
    int64_t arg5, int64_t arg6, uint64_t arg7)
{
    ...
    if (arg1 == 2)
    {
        arg7 = getopt_long(arg1, arg2, &data_405ad8, &data_405b00, nullptr);
        if (arg7 != 0xffffffff)
        {
            if (arg7 == 0x68)
            {
    ...
    uint32_t arg5, int32_t arg6, int64_t arg7, char* arg8, char* arg9)
{
    ...
    switch (r13)
    {
        ...
        case 0xa:
        {
            if ((!cond1))
            {
                arg8 = sub_401d50(&data_405bb5, r13);
                arg9 = sub_401d50("'", r13);
            }
            rbx_1 = 0;
            if (rbp_1 == 0)
...
{
    /* tailcall */
    return sub_403080(arg1, arg2, -1, &data_6093a0);
}

int64_t sub_403550(int32_t arg1, uint64_t arg2, uint64_t arg3)
{
    /* tailcall */
    return sub_403080(arg1, arg2, arg3, &data_6093a0);
}

int64_t sub_403560(uint64_t arg1)
{
    /* tailcall */
    return sub_403080(0, arg1, -1, &data_6093a0);
}

int64_t sub_403580(uint64_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_403080(0, arg1, arg2, &data_6093a0);
}
...
{
    /* tailcall */
    return sub_403080(0, arg1, -1, &data_6091e0);
}
    ...
    int64_t* arg5, int64_t arg6)
{
    ...
    __fprintf_chk(arg1, 1, "Copyright %s %d Free Software Fo…", dcgettext(nullptr, &data_40690b, 5), 0x7e1);
        ...
        label_4048e8:;
            ...
            if (((!z_1) && rcx_3 != 0))
            {
                ...
                if (*r14_1 == 0x2d)
                {
                    ...
                    label_404b21:
                        *(arg7 + 0x20) = &r14_1[1];
                        int32_t rax_12 = sub_404200(rbp_1, arg2, r15_1, arg4, arg5, arg6, arg7, r13, &data_406daa);
                        r14_2 = rax_12;
