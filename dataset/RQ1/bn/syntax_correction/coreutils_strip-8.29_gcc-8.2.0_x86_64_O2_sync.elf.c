...
int32_t main(int32_t argc, char** argv, char** envp)
{
    ...
    char r12 = 0;
    sub_401f30(*argv);
    setlocale(6, &data_4072cc[0x1b]);
    bindtextdomain("coreutils", "/home/dongkwan/data/scripts/gnu_…");
    textdomain("coreutils");
    sub_405af0(sub_401e90);
    while (true)
    {
        int32_t rax_1 = getopt_long(argc, argv, &data_405c0e, &data_405fe0, nullptr);
        if (rax_1 == 0xffffffff)
        {
            int32_t rax_3 = data_60925c;
            if ((r13 != 0 && r12 != 0))
            {
                rax_3 = error(1, 0, dcgettext(nullptr, "cannot specify both --data and -…", 5));
            }
            if ((rax_3 >= argc & r13) != 0)
            {
                void (* rdx_8)();
                int64_t rsi_9;
                int64_t rdi_11;
                rdx_8 = error(1, 0, dcgettext(nullptr, "--data needs at least one argume…", 5));
                /* tailcall */
                return _start(rdi_11, rsi_9, rdx_8);
            }
            int32_t r12_1;
            if (rax_3 >= argc)
            {
            ...
            else
            {
                ...
                do
                {
                    uint64_t r15_1 = argv[rax_3];
                    int32_t rax_16;
                    int32_t rdx_3;
                    rax_16 = open(r15_1, 0x800);
                    int32_t r14_1;
                    if (rax_16 >= 0)
                    {
                        int32_t rax_7 = sub_4043a0(rax_16, 3, rdx_3);
                        int64_t var_48_1;
                        int32_t rax_9;
                        int32_t rax_11;
                        ...
                        if (rax_7 != 0xffffffff)
                        {
                            *rax_7[1] = (*rax_7[1] & 0xf7);
                            rax_9 = sub_4043a0(rax_16, 4, rax_7);
                            if (rax_9 >= 0)
                            {
                                if (var_3c_1 == 1)
                                {
                                    rax_11 = fdatasync(rax_16);
                                }
                                else if (var_3c_1 == 2)
                                {
                                    rax_11 = syncfs(rax_16);
                                }
                                else
                                {
                                    rax_11 = fsync(rax_16);
                                ...
                                if (rax_11 < 0)
                                {
                                    rsi_4 = "error syncing %s";
                                    var_48_1 = sub_403900(4, r15_1);
                                }
                            }
                        }
                        if ((rax_7 == 0xffffffff || (rax_7 != 0xffffffff && rax_9 < 0)))
                        {
                            rsi_4 = "couldn't reset non-blocking mode…";
                            var_48_1 = sub_403900(4, r15_1);
                        }
                        if (((rax_7 == 0xffffffff || (rax_7 != 0xffffffff && rax_9 < 0)) || ((rax_7 != 0xffffffff && rax_9 >= 0) && rax_11 < 0)))
                        {
                            r14_1 = 0;
                            error(0, *__errno_location(), dcgettext(nullptr, rsi_4, 5), var_48_1);
                        }
                        if (close(rax_16) < 0)
                        {
                            r14_1 = 0;
                            error(0, *__errno_location(), dcgettext(nullptr, "failed to close %s", 5), sub_403900(4, r15_1));
                        }
                    }
                    else
                    {
                        r14_1 = 0;
                        int32_t r13_2 = *__errno_location();
                        if (open(r15_1, 0x801) < 0)
                        {
                            error(0, r13_2, dcgettext(nullptr, "error opening %s", 5), sub_403900(4, r15_1));
                        }
                    }
                    r12_1 = (r12_1 & r14_1);
                    rax_3 = (data_60925c + 1);
        ...
        if (cond0_1)
        {
            ...
            {
                int64_t var_58 = 0;
                sub_403fd0(stdout, "sync", "GNU coreutils", data_6091f0);
                exit(0);
                /* no return */
            }
            break;
...
int64_t j_sub_401a9a()
{
    /* tailcall */
    return sub_401a9a();
}

noreturn int64_t sub_401b30(int32_t arg1) 
{
    ...
    else
    {
        ...
        fputs_unlocked(dcgettext(nullptr, "Synchronize cached writes to per…", 5), stdout);
        fputs_unlocked(dcgettext(nullptr, "  -d, --data             sync on…", 5), stdout);
        fputs_unlocked(dcgettext(nullptr, "  -f, --file-system      sync th…", 5), stdout);
        ...
        if (rbp_1 == 0)
        {
            ...
            if (rax_20 != 0)
            {
                rax_21 = strncmp(rax_20, &data_405beb, 3);
                if (rax_21 != 0)
                {
                    rbp_1 = "sync";
                }
            ...
            if ((rax_20 == 0 || (rax_20 != 0 && rax_21 == 0)))
            {
                rbp_1 = "sync";
                r12_1 = " invocation";
                __printf_chk(1, dcgettext(nullptr, "Full documentation at: <%s%s>n", 5), "https://www.gnu.org/software/cor…", "sync");
            }
        }
        else
        {
            ...
            if (strncmp(rax_12, &data_405beb, 3) == 0)
            {
                goto label_401d58;
            }
        }
        ...
        {
            __printf_chk(1, dcgettext(nullptr, "Report %s translation bugs to <h…", 5), "sync");
        label_401d58:
            r12_1 = " invocation";
            __printf_chk(1, dcgettext(nullptr, "Full documentation at: <%s%s>n", 5), "https://www.gnu.org/software/cor…", "sync");
            if (rbp_1 != "sync")
            {
                r12_1 = &data_4072cc[0x1b];
            }
        }
...
int64_t sub_401e70(int64_t arg1)
{
    data_6092a0 = arg1;
}

int64_t sub_401e80(char arg1)
{
    data_609298 = arg1;
}

void sub_401e90(void* arg1)
{
    int32_t rax = sub_405330(stdout);
    int32_t* rax_1;
    if (rax != 0)
    {
        ...
        if ((data_609298 == 0 || (data_609298 != 0 && *rax_1 != 0x20)))
        {
            ...
            {
                error(0, *rax_1, "%s: %s", sub_4039a0(rdi_2), rax_3);
            }
        }
    }
    if (((rax == 0 || ((rax != 0 && data_609298 != 0) && *rax_1 == 0x20)) && sub_405330(stderr) == 0))
    {
        return;
    }
    _exit(data_6091f8);
...
char* sub_401fd0(char* arg1, int32_t arg2)
{
    char* rax = dcgettext(nullptr, arg1, 5);
    char* rbx = rax;
    if (arg1 == rax)
    {
        char* rax_2 = sub_4053f0();
...
int64_t sub_4020d0(char* arg1, uint64_t arg2, uint64_t arg3, uint64_t arg4, 
    uint32_t arg5, int32_t arg6, int64_t arg7, char* arg8, char* arg9)
{
            ...
            while (true)
            {
                ...
                if (r13 == 0)
                {
                    ...
                    else if (var_5b_1 != 0)
                    {
                        if (var_a9 != 0)
                        {
                            rbx_1 = sub_4020d0(r15, var_70, arg3, r11, 5, arg6, arg7, arg8, arg9);
                        }
                        else
                        {
                            rax_1 = r14 == 0;
                ...
                else
                {
                    ...
                    if (var_a0_1 != 0)
                    {
                        ...
                        label_4031c0:
                            ...
                            r11 = r9;
                        label_402524:
                            rbx_1 = sub_4020d0(r15, r14, arg3, r11, r13_1, (arg6 & 0xfffffffd), 0, arg8, arg9);
                        label_40253b:
                            return rbx_1;
                        }
                        rbp_3 = *r8;
                    ...
                    label_402870:
                        ...
                        label_402675:;
                            ...
                            while (true)
                            {
                                ...
                                uint32_t var_44;
                                rax_12 = sub_4052b0(&var_44, rbp_4, (var_98 - r15_1), &var_40);
                                if (rax_12 != 0)
                                {
                                    if (rax_12 == -1)
                                    {
    ...
    switch (r13)
    {
        ...
        case 0xa:
        {
            if ((!cond1))
            {
                arg8 = sub_401fd0(&data_4060ed, r13);
                arg9 = sub_401fd0("'", r13);
            }
            rbx_1 = 0;
            if (rbp_1 == 0)
...
char* sub_403300(int32_t arg1, uint64_t arg2, uint64_t arg3, int32_t* arg4)
{
    int64_t r15 = arg1;
    ...
    if (data_609250 <= r15)
    {
        ...
        if (rbx == 0x609240)
        {
            int64_t rax_9 = sub_404170(0, rsi_1);
        ...
        {
            int64_t rax_2 = sub_404170(rbx, rsi_1);
            data_609238 = rax_2;
            rbx = rax_2;
        }
    ...
    uint64_t r11 = *rbx_1;
    char* r12_2 = *(rbx_1 + 8);
    int64_t rax_5 = sub_4020d0(r12_2, r11, arg2, arg3, *arg4, rax_4, r15_2, *(arg4 + 0x28), *(arg4 + 0x30));
    if (r11 <= rax_5)
    {
        ...
        *rbx_1 = rsi_3;
        ...
        char* rax_6 = sub_404110(rsi_3);
        uint32_t r8_1 = *arg4;
        *(rbx_1 + 8) = rax_6;
        r12_2 = rax_6;
        sub_4020d0(rax_6, rsi_3, arg2, arg3, r8_1, rax_4, r15_2, *(arg4 + 0x28), *(arg4 + 0x30));
    }
    *rax = rax_1;
    return r12_2;
}

int64_t sub_4034a0(int64_t arg1)
{
    int64_t rbx = arg1;
    int32_t* rax = __errno_location();
    int32_t r12 = *rax;
    ...
    int64_t rax_1 = sub_404310(rbx, 0x38);
    *rax = r12;
    return rax_1;
}

uint64_t sub_4034e0(int32_t* arg1)
{
    if (arg1 == 0)
    {
        arg1 = &data_6093c0;
...
void sub_4034f0(int32_t* arg1, int32_t arg2)
{
    if (arg1 == 0)
    {
        arg1 = &data_6093c0;
...
uint64_t sub_403500(int64_t arg1, uint8_t arg2, int32_t arg3)
{
    if (arg1 == 0)
    {
        arg1 = 0x6093c0;
...
uint64_t sub_403540(int128_t* arg1, int32_t arg2)
{
    if (arg1 == 0)
    {
        arg1 = &data_6093c0;
...
void sub_403560(int32_t* arg1, int64_t arg2, int64_t arg3)
{
    if (arg1 == 0)
    {
        arg1 = &data_6093c0;
...
int64_t sub_403590(char* arg1, uint64_t arg2, uint64_t arg3, uint64_t arg4, 
    int32_t* arg5)
{
    int32_t* rbx = arg5;
    if (arg5 == 0)
    ...
    int32_t* rax = __errno_location();
    int32_t r12 = *rax;
    int64_t rax_2 = sub_4020d0(arg1, arg2, arg3, arg4, *rbx, rbx[1], &rbx[2], *(rbx + 0x28), *(rbx + 0x30));
    *rax = r12;
    return rax_2;
}

char* sub_403610(uint64_t arg1, uint64_t arg2, int64_t* arg3, int32_t* arg4)
{
    int32_t* rbx = arg4;
    if (arg4 == 0)
    {
    ...
    int64_t rax_2 = sub_4020d0(nullptr, 0, arg1, arg2, *rbx, rbp_1, &rbx[2], *(rbx + 0x28), *(rbx + 0x30));
    char* rax_3 = sub_404110((rax_2 + 1));
    sub_4020d0(rax_3, (rax_2 + 1), arg1, arg2, *rbx, rbp_1, &rbx[2], *(rbx + 0x28), *(rbx + 0x30));
    *rax = rax_1;
    if (arg3 != 0)
    {
        *arg3 = rax_2;
...
int64_t sub_403700(uint64_t arg1, uint64_t arg2, int32_t* arg3)
{
    /* tailcall */
    return sub_403610(arg1, arg2, nullptr, arg3);
}
...
{
    /* tailcall */
    return sub_403300(arg1, arg2, -1, &data_6093c0);
}

int64_t sub_4037d0(int32_t arg1, uint64_t arg2, uint64_t arg3)
{
    /* tailcall */
    return sub_403300(arg1, arg2, arg3, &data_6093c0);
}

int64_t sub_4037e0(uint64_t arg1)
{
    /* tailcall */
    return sub_403300(0, arg1, -1, &data_6093c0);
}

int64_t sub_403800(uint64_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_403300(0, arg1, arg2, &data_6093c0);
}

char* sub_403820(int32_t arg1, int32_t arg2, uint64_t arg3)
{
    if (arg2 == 0xa)
    {
        abort();
    ...
    int64_t var_20 = 0;
    int64_t var_18 = 0;
    return sub_403300(arg1, arg3, -1, &var_48);
}

char* sub_403890(int32_t arg1, int32_t arg2, uint64_t arg3, uint64_t arg4)
{
    if (arg2 == 0xa)
    {
        abort();
    ...
    int64_t var_20 = 0;
    int64_t var_18 = 0;
    return sub_403300(arg1, arg3, arg4, &var_48);
}

int64_t sub_403900(int32_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_403820(0, arg1, arg2);
}

int64_t sub_403910(int32_t arg1, uint64_t arg2, uint64_t arg3)
{
    /* tailcall */
    return sub_403890(0, arg1, arg2, arg3);
}

char* sub_403920(uint64_t arg1, uint64_t arg2, uint8_t arg3)
{
    ...
    *((&var_48 + ((arg3 >> 5) << 2)) + 8) = ((((!(rdx >> rcx_1)) & 1) << rcx_1) ^ rdx);
    return sub_403300(0, arg1, arg2, &var_48);
}

int64_t sub_403990(uint64_t arg1, uint8_t arg2)
{
    /* tailcall */
    return sub_403920(arg1, -1, arg2);
}

int64_t sub_4039a0(uint64_t arg1)
{
    /* tailcall */
    return sub_403920(arg1, -1, 0x3a);
}

int64_t sub_4039c0(uint64_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_403920(arg1, arg2, 0x3a);
}

char* sub_4039d0(int32_t arg1, int32_t arg2, uint64_t arg3)
{
    if (arg2 == 0xa)
    {
        abort();
...
char* sub_403a40(int32_t arg1, int64_t arg2, int64_t arg3, uint64_t arg4, 
    uint64_t arg5)
{
    int128_t var_48 = data_6093c0;
    int128_t var_38 = data_6093d0;
    ...
    if ((arg2 != 0 && arg3 != 0))
    {
        *var_28[8] = arg2;
        ...
        return sub_403300(arg1, arg4, arg5, &var_48);
    }
    abort();
    /* no return */
}

int64_t sub_403b70(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4, 
    int64_t* arg5, int64_t arg6)
{
    ...
    __fprintf_chk(arg1, 1, "Copyright %s %d Free Software Fo…", dcgettext(nullptr, &data_406e2b, 5), 0x7e1);
...
int64_t sub_403f50(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4, 
    int64_t* arg5)
{
    int64_t r9 = 0;
    if (*arg5 != 0)
    ...
    /* tailcall */
    return sub_403b70(arg1, arg2, arg3, arg4, arg5, r9);
}
    ...
    int32_t* arg5)
{
    ...
    return sub_403b70(arg1, arg2, arg3, arg4, &var_58, r9);
}

int64_t sub_403fd0(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4)
{
    char r11 = 0;
    int64_t r8;
    int64_t var_18 = r8;
    ...
    return sub_403b70(arg1, arg2, arg3, arg4, &var_88, r9_1);
}
...
int64_t sub_404170(int64_t arg1, uint64_t arg2)
{
    if ((arg2 == 0 && arg1 != 0))
    {
        free(arg1);
...
noreturn int64_t sub_4042ba() 
{
    sub_404360();
    /* no return */
}

int64_t sub_4042c0(uint64_t arg1)
{
    /* tailcall */
    return memset(sub_404110(arg1), 0, arg1);
}

int64_t sub_4042e0(uint64_t arg1, uint64_t arg2)
{
    int64_t rax;
    bool rdx;
    rdx = HIGHD((arg1 * arg2));
...
int64_t sub_404310(int64_t arg1, uint64_t arg2)
{
    /* tailcall */
    return memcpy(sub_404110(arg2), arg1, arg2);
}

int64_t sub_404340(char* arg1)
{
    /* tailcall */
    return sub_404310(arg1, (strlen(arg1) + 1));
}

noreturn int64_t sub_404360() 
{
...
uint64_t sub_4043a0(int32_t arg1, int32_t arg2, int32_t arg3)
{
    void* var_58 = &arg_8;
    int64_t rcx;
    int64_t var_30 = rcx;
...
uint64_t sub_4044e0(int64_t arg1, int32_t* arg2)
{
    int64_t r11 = (arg1 + 8);
...
uint64_t sub_4045c0(int32_t arg1, int64_t* arg2, char* arg3, int64_t* arg4, 
...
uint64_t sub_404be0(int32_t arg1, int64_t* arg2, char* arg3, int64_t* arg4, 
        ...
        label_404ca8:;
            ...
            if (((!z_1) && rcx_3 != 0))
            {
                ...
                if (*r14_1 == 0x2d)
                {
                    ...
                    label_404ee1:
                        *(arg7 + 0x20) = &r14_1[1];
                        int32_t rax_12 = sub_4045c0(rbp_1, arg2, r15_1, arg4, arg5, arg6, arg7, r13, &data_4072ca);
                        r14_2 = rax_12;
                                ...
                                if (((*rax_7 == 0x57 && arg4 != 0) && rcx_7 == 0x3b))
                                {
                                    ...
                                    label_404f5e:
                                        *(arg7 + 0x20) = r8_1;
                                        arg6 = 0;
                                        *(arg7 + 0x10) = 0;
                                        var_78_1 = &data_4072e8;
                                        var_80_2 = r13;
                                        var_88_2 = arg7;
                                    label_404f90:
                                        r14_2 = sub_4045c0(rbp_1, arg2, r15_1, arg4, arg5, arg6, var_88_2, var_80_2, var_78_1);
                                    }
                                }
...
uint64_t sub_405210(int32_t arg1, int64_t* arg2, char* arg3)
{
    return _getopt_internal(arg1, arg2, arg3, nullptr, nullptr, 0, 1);
}

uint64_t sub_4052b0(uint32_t* arg1, char* arg2, uint64_t arg3, mbstate_t* arg4)
{
    uint64_t rbx_1;
    char* rbp_1;
    uint32_t* r12_1;
...
uint64_t sub_405330(FILE* arg1)
{
    int32_t* rbp = arg1;
    uint64_t rax = __fpending(arg1);
    int32_t rbx_1 = (*rbp & 0x20);
    uint64_t rax_1 = sub_405960(rbp);
    if ((rbx_1 != 0 && rax_1 == 0))
    {
        *__errno_location() = 0;
        rax_1 = 0xffffffff;
...
int64_t sub_405960(FILE* arg1)
{
    ...
    if (fileno(arg1) >= 0)
    {
        ...
        if (((rax_1 == 0 || (rax_1 != 0 && rax_6 != -1)) && sub_4059e0(arg1) != 0))
        {
...
off64_t sub_405a20(FILE* arg1, off_t arg2, int32_t arg3)
{
...
int64_t sub_405af0(void (* arg1)(void*))
{
...
int64_t sub_405b08(int64_t arg1, int64_t arg2, int64_t arg3)
{
