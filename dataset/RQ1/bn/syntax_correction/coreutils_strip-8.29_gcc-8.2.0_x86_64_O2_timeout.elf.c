...
int64_t sub_4024f0(char arg1, double arg2)
{
    int64_t rax;
    int64_t rdx;
    rax = sub_402fa0(arg2);
...
noreturn int64_t sub_402850(int32_t arg1) 
{
    ...
    else
    {
        ...
        fputs_unlocked(dcgettext(nullptr, "      --preserve-statusn       …", 5), stdout);
        ...
        fputs_unlocked(dcgettext(nullptr, "nDURATION is a floating point n…", 5), stdout);
        fputs_unlocked(dcgettext(nullptr, "nIf the command times out, and …", 5), stdout);
        ...
        if (rbp_1 == 0)
        {
            ...
            if ((rax_23 == 0 || (rax_23 != 0 && rax_24 == 0)))
            {
                rbp_1 = "timeout";
                r12_1 = " invocation";
                __printf_chk(1, dcgettext(nullptr, "Full documentation at: <%s%s>n", 5), "https://www.gnu.org/software/cor…", "timeout");
            }
        }
        else
        {
    ...
    if ((rax != 0 || (rax == 0 && *rax_1 == 0x22)))
    {
        ...
        if ((!(zmm0 < 0.0 | (FCMP_UO(zmm0, 0.0)))))
        {
            ...
            if (rdx_1[1] == 0)
            {
                ...
                if ((cond0_1 && rax_2 == 0x6d))
                {
                    return rax_2;
                }
            }
            if (((rax_2 == 0 || ((rdx_1[1] == 0 && (!cond0_1)) && rax_2 == 0x64)) || ((rdx_1[1] == 0 && cond0_1) && rax_2 == 0x73)))
            {
                return rax_2;
            }
        }
...
int64_t sub_402fa0(double arg1)
{
