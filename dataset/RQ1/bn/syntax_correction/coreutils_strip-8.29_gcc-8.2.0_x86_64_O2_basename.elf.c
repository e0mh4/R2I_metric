...
int32_t main(int32_t argc, char** argv, char** envp)
{
    ...
    int32_t rbx;
    int32_t rbp;
    setlocale(6, &data_40720c[0x1b], rdx, rcx, r8, r9, rbx, rbp);
    bindtextdomain("coreutils", "/home/dongkwan/data/scripts/gnu_…");
    textdomain("coreutils");
    sub_405970(sub_401d00);
    while (true)
    {
        int32_t rax_1 = getopt_long(argc, argv, "+as:z", &data_405f00, nullptr);
        if (rax_1 == 0xffffffff)
        {
            ...
            if (rax_3 < argc)
            {
                ...
                {
                    int64_t rcx_2 = rax_3;
                    bool cond1_1 = (rax_3 + 2) == argc;
                    if ((rax_3 + 2) < argc)
                    {
                        error(0, 0, dcgettext(nullptr, "extra operand %s", 5), sub_403af0(argv[(rcx_2 + 2)]));
                        sub_401970(1);
                        /* no return */
                    }
                    char* rsi_1 = nullptr;
                    ...
                    sub_4018a0(argv[rcx_2], rsi_1, r12);
                }
                else
                {
                    do
                    {
                        sub_4018a0(argv[rax_3], r14, r12);
                        rax_3 = (data_60923c + 1);
                        data_60923c = rax_3;
                    } while (rax_3 < argc);
                }
        ...
        if (rax_1 != 0x61)
        {
            if (cond0_1)
            {
                if (rax_1 == 0xffffff7d)
                {
                    sub_403f70(stdout, "basename", "GNU coreutils", data_6091d0);
                    exit(0);
                    /* no return */
                }
                if (rax_1 == 0xffffff7e)
...
int64_t j_sub_40180a()
{
    /* tailcall */
    return sub_40180a();
}

int64_t sub_4018a0(char* arg1, char* arg2, char arg3)
{
    char* rax = sub_401da0(arg1);
    sub_401e90(rax);
    if ((arg2 != 0 && *rax != 0x2f))
    {
        void* rbp_1 = &rax[strlen(rax)];
        void* rax_5 = &arg2[strlen(arg2)];
        while (true)
        {
            if ((rax < rbp_1 && arg2 < rax_5))
            {
                rax_5 = (rax_5 - 1);
                rbp_1 = (rbp_1 - 1);
                if (*rbp_1 != *rax_5)
    ...
    int32_t rsi_1 = fputs_unlocked(rax, stdout);
    uint64_t* const rdi_2 = stdout;
    int32_t rsi_3 = ((rsi_1 - rsi_1) & 0xa);
    char* rax_1 = stdout[5];
    if (rax_1 >= stdout[6])
    {
        __overflow(rdi_2, rsi_3);
    }
    else
    {
        stdout[5] = &rax_1[1];
...
noreturn int64_t sub_401970(int32_t arg1) 
{
    ...
    {
        __printf_chk(1, dcgettext(nullptr, "Usage: %s NAME [SUFFIX]n  or:  …", 5), rbp, rbp);
        fputs_unlocked(dcgettext(nullptr, "Print NAME with any leading dire…", 5), stdout);
        fputs_unlocked(dcgettext(nullptr, "nMandatory arguments to long op…", 5), stdout);
        fputs_unlocked(dcgettext(nullptr, "  -a, --multiple       support m…", 5), stdout);
        ...
        __printf_chk(1, dcgettext(nullptr, "nExamples:n  %s /usr/bin/sort …", 5), rbp_1, rbp_1, rbp_1, rbp_1);
        void* const var_88 = &data_4059cd;
        ...
        if (rbp_2 == 0)
        {
            ...
            rax_22 = setlocale(5, nullptr, rdx_6, rcx_6, r8_3, r9_3, var_88, "test invocation");
            if (rax_22 != 0)
            {
                rax_23 = strncmp(rax_22, &data_405a51, 3);
                if (rax_23 != 0)
                {
                    rbp_2 = "basename";
                }
            ...
            if ((rax_22 == 0 || (rax_22 != 0 && rax_23 == 0)))
            {
                rbp_2 = "basename";
                r12_1 = " invocation";
                __printf_chk(1, dcgettext(nullptr, "Full documentation at: <%s%s>n", 5), "https://www.gnu.org/software/cor…", "basename");
            }
        }
        else
        {
            ...
            char* rax_14 = setlocale(5, nullptr, rdx_4, rcx_4, r8_2, r9_2, var_88, "test invocation");
            if (rax_14 == 0)
            {
                goto label_401bd0;
            }
            if (strncmp(rax_14, &data_405a51, 3) == 0)
            {
                goto label_401bd0;
            }
        }
        ...
        {
            __printf_chk(1, dcgettext(nullptr, "Report %s translation bugs to <h…", 5), "basename");
        label_401bd0:
            r12_1 = " invocation";
            __printf_chk(1, dcgettext(nullptr, "Full documentation at: <%s%s>n", 5), "https://www.gnu.org/software/cor…", "basename");
            if (rbp_2 != "basename")
            {
                r12_1 = &data_40720c[0x1b];
            }
        }
...
int64_t sub_401ce0(int64_t arg1)
{
    data_609280 = arg1;
}

int64_t sub_401cf0(char arg1)
{
    data_609278 = arg1;
}

void sub_401d00(void* arg1)
{
    int32_t rax = sub_4051b0(stdout);
    int32_t* rax_1;
    if (rax != 0)
    {
        ...
        if ((data_609278 == 0 || (data_609278 != 0 && *rax_1 != 0x20)))
        {
            ...
            {
                error(0, *rax_1, "%s: %s", sub_403940(rdi_2), rax_3);
            }
        }
    }
    if (((rax == 0 || ((rax != 0 && data_609278 != 0) && *rax_1 == 0x20)) && sub_4051b0(stderr) == 0))
    {
        return;
    }
    _exit(data_6091d8);
...
{
    char* rbp = arg1;
    char* rax = sub_401e00(arg1);
    if (*rax == 0)
    {
        sub_401e60(rbp);
        /* tailcall */
        return sub_404340(rbp);
    }
    int64_t rdx;
    rdx = rax[sub_401e60(rax)] == 0x2f;
    /* tailcall */
    return sub_404340(rax);
}

char* sub_401e00(char* arg1)
{
    char rdx = *arg1;
    char* rax = arg1;
    if (rdx == 0x2f)
...
char* sub_401f70(char* arg1, int32_t arg2)
{
    char* rax = dcgettext(nullptr, arg1, 5);
    char* rbx = rax;
    if (arg1 == rax)
    {
        char* rax_2 = sub_405270();
...
int64_t sub_402070(char* arg1, uint64_t arg2, uint64_t arg3, uint64_t arg4, 
    uint32_t arg5, int32_t arg6, int64_t arg7, char* arg8, char* arg9)
{
            ...
            while (true)
            {
                ...
                if (r13 == 0)
                {
                    ...
                    else if (var_5b_1 != 0)
                    {
                        if (var_a9 != 0)
                        {
                            rbx_1 = sub_402070(r15, var_70, arg3, r11, 5, arg6, arg7, arg8, arg9);
                        }
                        else
                        {
                            rax_1 = r14 == 0;
                ...
                else
                {
                    ...
                    if (var_a0_1 != 0)
                    {
                        ...
                        label_403160:
                            ...
                            r11 = r9;
                        label_4024c4:
                            rbx_1 = sub_402070(r15, r14, arg3, r11, r13_1, (arg6 & 0xfffffffd), 0, arg8, arg9);
                        label_4024db:
                            return rbx_1;
                        }
                        rbp_3 = *r8;
                    ...
                    label_402810:
                        ...
                        label_402615:;
                            ...
                            while (true)
                            {
                                ...
                                uint32_t var_44;
                                rax_12 = sub_405130(&var_44, rbp_4, (var_98 - r15_1), &var_40);
                                if (rax_12 != 0)
                                {
                                    if (rax_12 == -1)
                                    {
    ...
    switch (r13)
    {
        ...
        case 0xa:
        {
            if ((!cond1))
            {
                arg8 = sub_401f70(&data_40602d, r13);
                arg9 = sub_401f70("'", r13);
            }
            rbx_1 = 0;
            if (rbp_1 == 0)
...
char* sub_4032a0(int32_t arg1, uint64_t arg2, uint64_t arg3, int32_t* arg4)
{
    int64_t r15 = arg1;
    ...
    if (data_609230 <= r15)
    {
        ...
        if (rbx == 0x609220)
        {
            int64_t rax_9 = sub_404110(0, rsi_1);
        ...
        {
            int64_t rax_2 = sub_404110(rbx, rsi_1);
            data_609218 = rax_2;
            rbx = rax_2;
        }
    ...
    uint64_t r11 = *rbx_1;
    char* r12_2 = *(rbx_1 + 8);
    int64_t rax_5 = sub_402070(r12_2, r11, arg2, arg3, *arg4, rax_4, r15_2, *(arg4 + 0x28), *(arg4 + 0x30));
    if (r11 <= rax_5)
    {
        ...
        *rbx_1 = rsi_3;
        ...
        char* rax_6 = sub_4040b0(rsi_3);
        uint32_t r8_1 = *arg4;
        *(rbx_1 + 8) = rax_6;
        r12_2 = rax_6;
        sub_402070(rax_6, rsi_3, arg2, arg3, r8_1, rax_4, r15_2, *(arg4 + 0x28), *(arg4 + 0x30));
    }
    *rax = rax_1;
    return r12_2;
}

int64_t sub_403440(int64_t arg1)
{
    int64_t rbx = arg1;
    int32_t* rax = __errno_location();
    int32_t r12 = *rax;
    ...
    int64_t rax_1 = sub_4042b0(rbx, 0x38);
    *rax = r12;
    return rax_1;
}

uint64_t sub_403480(int32_t* arg1)
{
    if (arg1 == 0)
    {
        arg1 = &data_6093a0;
...
void sub_403490(int32_t* arg1, int32_t arg2)
{
    if (arg1 == 0)
    {
        arg1 = &data_6093a0;
...
uint64_t sub_4034a0(int64_t arg1, uint8_t arg2, int32_t arg3)
{
    if (arg1 == 0)
    {
        arg1 = 0x6093a0;
...
uint64_t sub_4034e0(int128_t* arg1, int32_t arg2)
{
    if (arg1 == 0)
    {
        arg1 = &data_6093a0;
...
void sub_403500(int32_t* arg1, int64_t arg2, int64_t arg3)
{
    if (arg1 == 0)
    {
        arg1 = &data_6093a0;
...
int64_t sub_403530(char* arg1, uint64_t arg2, uint64_t arg3, uint64_t arg4, 
    int32_t* arg5)
{
    int32_t* rbx = arg5;
    if (arg5 == 0)
    ...
    int32_t* rax = __errno_location();
    int32_t r12 = *rax;
    int64_t rax_2 = sub_402070(arg1, arg2, arg3, arg4, *rbx, rbx[1], &rbx[2], *(rbx + 0x28), *(rbx + 0x30));
    *rax = r12;
    return rax_2;
}

char* sub_4035b0(uint64_t arg1, uint64_t arg2, int64_t* arg3, int32_t* arg4)
{
    int32_t* rbx = arg4;
    if (arg4 == 0)
    {
    ...
    int64_t rax_2 = sub_402070(nullptr, 0, arg1, arg2, *rbx, rbp_1, &rbx[2], *(rbx + 0x28), *(rbx + 0x30));
    char* rax_3 = sub_4040b0((rax_2 + 1));
    sub_402070(rax_3, (rax_2 + 1), arg1, arg2, *rbx, rbp_1, &rbx[2], *(rbx + 0x28), *(rbx + 0x30));
    *rax = rax_1;
    if (arg3 != 0)
    {
        *arg3 = rax_2;
...
int64_t sub_4036a0(uint64_t arg1, uint64_t arg2, int32_t* arg3)
{
    /* tailcall */
    return sub_4035b0(arg1, arg2, nullptr, arg3);
}
...
int64_t sub_403750(int32_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_4032a0(arg1, arg2, -1, &data_6093a0);
}

int64_t sub_403770(int32_t arg1, uint64_t arg2, uint64_t arg3)
{
    /* tailcall */
    return sub_4032a0(arg1, arg2, arg3, &data_6093a0);
}

int64_t sub_403780(uint64_t arg1)
{
    /* tailcall */
    return sub_4032a0(0, arg1, -1, &data_6093a0);
}

int64_t sub_4037a0(uint64_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_4032a0(0, arg1, arg2, &data_6093a0);
}

char* sub_4037c0(int32_t arg1, int32_t arg2, uint64_t arg3)
{
    if (arg2 == 0xa)
    {
        abort();
    ...
    int64_t var_20 = 0;
    int64_t var_18 = 0;
    return sub_4032a0(arg1, arg3, -1, &var_48);
}

char* sub_403830(int32_t arg1, int32_t arg2, uint64_t arg3, uint64_t arg4)
{
    if (arg2 == 0xa)
    {
        abort();
    ...
    int64_t var_20 = 0;
    int64_t var_18 = 0;
    return sub_4032a0(arg1, arg3, arg4, &var_48);
}

int64_t sub_4038a0(int32_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_4037c0(0, arg1, arg2);
}

int64_t sub_4038b0(int32_t arg1, uint64_t arg2, uint64_t arg3)
{
    /* tailcall */
    return sub_403830(0, arg1, arg2, arg3);
}

char* sub_4038c0(uint64_t arg1, uint64_t arg2, uint8_t arg3)
{
    ...
    *((&var_48 + ((arg3 >> 5) << 2)) + 8) = ((((!(rdx >> rcx_1)) & 1) << rcx_1) ^ rdx);
    return sub_4032a0(0, arg1, arg2, &var_48);
}

int64_t sub_403930(uint64_t arg1, uint8_t arg2)
{
    /* tailcall */
    return sub_4038c0(arg1, -1, arg2);
}

int64_t sub_403940(uint64_t arg1)
{
    /* tailcall */
    return sub_4038c0(arg1, -1, 0x3a);
}

int64_t sub_403960(uint64_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_4038c0(arg1, arg2, 0x3a);
}

char* sub_403970(int32_t arg1, int32_t arg2, uint64_t arg3)
{
    if (arg2 == 0xa)
    {
        abort();
...
char* sub_4039e0(int32_t arg1, int64_t arg2, int64_t arg3, uint64_t arg4, 
    uint64_t arg5)
{
    int128_t var_48 = data_6093a0;
    int128_t var_38 = data_6093b0;
    ...
    if ((arg2 != 0 && arg3 != 0))
    {
        *var_28[8] = arg2;
        ...
        return sub_4032a0(arg1, arg4, arg5, &var_48);
    }
    abort();
    /* no return */
}

int64_t sub_403af0(uint64_t arg1)
{
    /* tailcall */
    return sub_4032a0(0, arg1, -1, &data_6091e0);
}

int64_t sub_403b10(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4, 
    int64_t* arg5, int64_t arg6)
{
    ...
    __fprintf_chk(arg1, 1, "Copyright %s %d Free Software Fo…", dcgettext(nullptr, &data_406d6b, 5), 0x7e1);
...
int64_t sub_403ef0(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4, 
    int64_t* arg5)
{
    int64_t r9 = 0;
    if (*arg5 != 0)
    ...
    /* tailcall */
    return sub_403b10(arg1, arg2, arg3, arg4, arg5, r9);
}

int64_t sub_403f10(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4, 
    int32_t* arg5)
{
    int64_t r9 = 0;
    void var_58;
    ...
    return sub_403b10(arg1, arg2, arg3, arg4, &var_58, r9);
}
...
int64_t sub_403f70(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4)
{
    ...
    return sub_403b10(arg1, arg2, arg3, arg4, &var_88, r9_1);
}
...
int64_t sub_4040b0(uint64_t arg1)
{
...
int64_t sub_404110(int64_t arg1, uint64_t arg2)
{
    if ((arg2 == 0 && arg1 != 0))
    {
        free(arg1);
...
{
    /* tailcall */
    return memset(sub_4040b0(arg1), 0, arg1);
}
...
int64_t sub_4042b0(int64_t arg1, uint64_t arg2)
{
    /* tailcall */
    return memcpy(sub_4040b0(arg2), arg1, arg2);
}

int64_t sub_4042e0(char* arg1)
{
    /* tailcall */
    return sub_4042b0(arg1, (strlen(arg1) + 1));
}

noreturn int64_t sub_404300() 
{
...
uint64_t sub_404360(int64_t arg1, int32_t* arg2)
{
    int64_t r11 = (arg1 + 8);
...
uint64_t sub_404440(int32_t arg1, int64_t* arg2, char* arg3, int64_t* arg4, 
...
uint64_t sub_404a60(int32_t arg1, int64_t* arg2, char* arg3, int64_t* arg4, 
        ...
        label_404b28:;
            ...
            if (((!z_1) && rcx_3 != 0))
            {
                ...
                if (*r14_1 == 0x2d)
                {
                    ...
                    label_404d61:
                        *(arg7 + 0x20) = &r14_1[1];
                        int32_t rax_12 = sub_404440(rbp_1, arg2, r15_1, arg4, arg5, arg6, arg7, r13, &data_40720a);
                        r14_2 = rax_12;
                                ...
                                if (((*rax_7 == 0x57 && arg4 != 0) && rcx_7 == 0x3b))
                                {
                                    ...
                                    label_404dde:
                                        *(arg7 + 0x20) = r8_1;
                                        arg6 = 0;
                                        *(arg7 + 0x10) = 0;
                                        var_78_1 = &data_407228;
                                        var_80_2 = r13;
                                        var_88_2 = arg7;
                                    label_404e10:
                                        r14_2 = sub_404440(rbp_1, arg2, r15_1, arg4, arg5, arg6, var_88_2, var_80_2, var_78_1);
                                    }
                                }
...
uint64_t sub_405090(int32_t arg1, int64_t* arg2, char* arg3)
{
    return _getopt_internal(arg1, arg2, arg3, nullptr, nullptr, 0, 1);
}

uint64_t sub_405130(uint32_t* arg1, char* arg2, uint64_t arg3, mbstate_t* arg4)
{
    uint64_t rbx_1;
    char* rbp_1;
    uint32_t* r12_1;
...
uint64_t sub_4051b0(FILE* arg1)
{
    int32_t* rbp = arg1;
    uint64_t rax = __fpending(arg1);
    int32_t rbx_1 = (*rbp & 0x20);
    uint64_t rax_1 = sub_4057e0(rbp);
    if ((rbx_1 != 0 && rax_1 == 0))
    {
        *__errno_location() = 0;
        rax_1 = 0xffffffff;
...
int64_t sub_4057e0(FILE* arg1)
{
    ...
    if (fileno(arg1) >= 0)
    {
        ...
        if (((rax_1 == 0 || (rax_1 != 0 && rax_6 != -1)) && sub_405860(arg1) != 0))
        {
...
off64_t sub_4058a0(FILE* arg1, off_t arg2, int32_t arg3)
{
...
int64_t sub_405970(void (* arg1)(void*))
{
...
int64_t sub_405988(int64_t arg1, int64_t arg2, int64_t arg3)
{
