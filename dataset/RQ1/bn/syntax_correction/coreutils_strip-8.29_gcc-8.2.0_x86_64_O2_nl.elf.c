...
noreturn int64_t sub_4027c0(int32_t arg1) 
{
    ...
    else
    {
        ...
        fputs_unlocked(dcgettext(nullptr, "nBy default, selects -v1 -i1 -l…", 5), stdout);
        fputs_unlocked(dcgettext(nullptr, "n  a         number all linesn…", 5), stdout);
        ...
        if (rbp_1 == 0)
        {
            ...
            if ((rax_25 == 0 || (rax_25 != 0 && rax_26 == 0)))
            {
                rbp_1 = &data_414e99;
                r12_1 = " invocation";
                __printf_chk(1, dcgettext(nullptr, "Full documentation at: <%s%s>n", 5), "https://www.gnu.org/software/cor…", &data_414e99);
            }
        }
        else
        {
...
uint64_t sub_40a330(void* arg1, int64_t arg2, int32_t arg3, int32_t arg4)
{
    if (arg2 < 0)
    {
        return *(arg1 + 0x70);
...
uint64_t sub_414450(int64_t* arg1, char* arg2, int32_t arg3, int64_t arg4)
{
    int64_t var_8 = arg4;
    uint64_t rbx = arg3;
    *arg1 = 0;
