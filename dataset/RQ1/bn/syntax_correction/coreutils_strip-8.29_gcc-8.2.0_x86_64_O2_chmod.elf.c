...
int32_t main(int32_t argc, char** argv, char** envp)
{
    ...
    while (true)
    {
        int32_t rax_1 = getopt_long(rbp, argv, "Rcfvr_w_x_X_s_t_u_g_o_a…", &data_40b3c0, nullptr);
        char* var_100;
        if (rax_1 == 0xffffffff)
        {
            if (r15 == 0)
        ...
        else
        {
            if ((!cond0_1))
            {
                ...
                {
                    bool cond5_1 = rax_1 > 0x6f;
                    if (rax_1 != 0x6f)
                    {
                        if ((cond5_1 && rax_1 < 0x72))
                        {
                            break;
                        }
                        if ((!cond5_1))
            ...
            else if (rax_1 > 0x37)
            {
                ...
                {
                    if ((cond2_1 && rax_1 != 0x3d))
                    {
                        break;
                    }
                    if (((!cond2_1) && (rax_1 != 0x58 && rax_1 != 0x61)))
                    {
                        break;
                    }
                }
...
noreturn int64_t sub_4029c0(int32_t arg1) 
{
    ...
    else
    {
        ...
        fputs_unlocked(dcgettext(nullptr, "nEach MODE is of the form '[ugo…", 5), stdout);
        ...
        if (rbp_1 == 0)
        {
            ...
            if ((rax_23 == 0 || (rax_23 != 0 && rax_24 == 0)))
            {
                rbp_1 = "chmod";
                r12_1 = " invocation";
                __printf_chk(1, dcgettext(nullptr, "Full documentation at: <%s%s>n", 5), "https://www.gnu.org/software/cor…", "chmod");
            }
        }
        else
        {
