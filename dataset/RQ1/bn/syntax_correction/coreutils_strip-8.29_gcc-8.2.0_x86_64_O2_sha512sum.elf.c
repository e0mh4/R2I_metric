...
noreturn int64_t sub_402c90(int32_t arg1) 
{
    ...
    {
        __printf_chk(1, dcgettext(nullptr, "Usage: %s [OPTION]... [FILE]...n…", 5), rbp, "SHA512", 0x200);
        ...
        if (rbp_1 == 0)
        {
            ...
            if ((rax_26 == 0 || (rax_26 != 0 && rax_27 == 0)))
            {
                rbp_1 = "sha512sum";
                r12_1 = " invocation";
                __printf_chk(1, dcgettext(nullptr, "Full documentation at: <%s%s>n", 5), "https://www.gnu.org/software/cor…", "sha512sum");
            }
        }
        else
        {
