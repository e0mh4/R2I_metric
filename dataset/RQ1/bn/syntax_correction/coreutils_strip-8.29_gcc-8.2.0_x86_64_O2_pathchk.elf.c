...
int32_t main(int32_t argc, char** argv, char** envp)
{
    ...
    char rbp = 0;
    sub_402120(*argv);
    setlocale(6, &data_40742c[0x1b]);
    bindtextdomain("coreutils", "/home/dongkwan/data/scripts/gnu_…");
    textdomain("coreutils");
    sub_405bc0(sub_402080);
    while (true)
    {
        int32_t rax_1 = getopt_long(argc, argv, &data_405cdf, &data_406160, nullptr);
        if (rax_1 == 0xffffffff)
        {
            ...
            if (rax_3 != argc)
            {
                ...
                if ((!cond0_1))
                {
                    do
                    {
                        char* rbx_1 = argv[rax_3];
                        uint64_t rax_10 = strlen(rbx_1);
                        char* rax_18;
                        bool r8_3;
                        if (r13 != 0)
                        {
                            ...
                            if (rax_18 != 0)
                            {
                                error(0, 0, dcgettext(nullptr, "leading '-' in a component of fi…", 5), sub_403af0(4, rbx_1));
                                r8_3 = false;
                            }
                            if (((rax_18 == 0 && rax_10 != 0) && rbp != 0))
                            {
                                goto label_401833;
                            }
                        }
                        ...
                        int64_t rbp_2;
                        int64_t r15_4;
                        if (((r13 == 0 && rbp == 0) || ((r13 != 0 && rax_18 == 0) && rax_10 != 0)))
                        {
                            if (__lxstat(1, rbx_1, &var_c8) == 0)
                            {
                            label_4019b7:
                                r8_3 = true;
                            }
                            else
                            {
                                ...
                                bool cond3_1 = *rax_5 != 2;
                                int32_t* rbp_1 = rax_5;
                                rax_5 = rax_10 == 0;
                                bool r8_2 = (cond3_1 | rax_5);
                                if (r8_2 != 0)
                                {
                                    error(0, *rbp_1, "%s", sub_403bc0(0, 3, rbx_1));
                                    r8_3 = false;
                                }
                                else
                                {
                                    ...
                                    if (rax_10 > 0xff)
                                    {
                                        bool cond4_1 = *rbx_1 != 0x2f;
                                        char const* const r15_3 = "/";
                                        *rbp_1 = 0;
                                        if (cond4_1)
                                        {
                                            r15_3 = &data_405cb4;
                                        }
                                        rax_22 = pathconf(r15_3, 4);
                                        if ((rax_22 < 0 && *rbp_1 != 0))
                                        {
                                            error(0, *rbp_1, dcgettext(nullptr, "%s: unable to determine maximum …", 5), r15_3);
                                            r8_3 = var_e8;
                                        }
                                        if (rax_22 >= 0)
                                        {
                                    ...
                                    if (((rax_10 <= 0xff || ((rax_10 > 0xff && rax_22 < 0) && *rbp_1 == 0)) || (rax_10 > 0xff && rax_22 >= 0)))
                                    {
                                        char* rax_23 = rbx_1;
                                        char rdx_4;
                                        while (true)
                                        ...
                                        while (true)
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    *rax_13 = 0;
                                                    *r15_2 = 0;
                                                    int64_t rax_14 = pathconf(var_e8, 3);
                                                    *r15_2 = r14_1;
                                                    if (rax_14 >= 0)
                                                    {
                                                        r12_1 = rax_14;
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            {
                                                                *r15_2 = 0;
                                                                error(0, *rax_13, "%s", sub_403bc0(0, 3, var_e8));
                                                                *r15_2 = r14_1;
                                                                r8_3 = false;
                                                                break;
                                                            }
                                                ...
                                                if (r12_1 < r8_4)
                                                {
                                                    *r10_1 = 0;
                                                    var_e8 = r10_1;
                                                    error(0, 0, dcgettext(nullptr, "limit %lu exceeded by length %lu…", 5), r12_1, r8_4, sub_403d40(r15_2), var_e8);
                                                    r8_3 = false;
                                                    *var_e8 = r13_3;
                                                    break;
                                                }
                        ...
                        if ((((r13 == 0 && rbp != 0) && rax_10 == 0) || ((r13 != 0 && rax_18 == 0) && rax_10 == 0)))
                        {
                            error(0, 0, dcgettext(nullptr, "empty file name", 5));
                            r8_3 = false;
                        }
                        if (((r13 == 0 && rbp != 0) && rax_10 != 0))
                        {
                        label_401833:;
                            uint64_t rax_11 = strspn(rbx_1, "/ABCDEFGHIJKLMNOPQRSTUVWXYZabcde…");
                            void* r15_1 = &rbx_1[rax_11];
                            if (*r15_1 != 0)
                            {
                                var_c8.__count = 0;
                                var_c8.__value = 0;
                                uint64_t r13_4 = mbrlen(r15_1, (rax_10 - rax_11), &var_c8);
                                char* rax_32 = sub_403a10(0, 4, rbx_1);
                                if (r13_4 > 0x10)
                                {
                                    r13_4 = 1;
                                }
                                error(0, 0, dcgettext(nullptr, "nonportable character %s in file…", 5), sub_403a80(1, 8, r15_1, r13_4), rax_32);
                                r8_3 = false;
                            }
                            else
                            {
                                ...
                                r15_4 = 0x100;
                            label_401bc7:
                                error(0, 0, dcgettext(nullptr, "limit %lu exceeded by length %lu…", 5), (r15_4 - 1), rax_10, sub_403af0(4, rbx_1), var_e8);
                                r8_3 = false;
                            }
                        }
                        var_df = (var_df & r8_3);
        ...
        else
        {
            if ((!cond1_1))
            {
                ...
                {
                    int64_t var_f0 = 0;
                    char const* const var_f8 = "Jim Meyering";
                    sub_4041c0(stdout, "pathchk", "GNU coreutils", data_6091d0);
                    exit(0);
                    /* no return */
                }
                if (rax_1 == 0xffffff7e)
...
int64_t j_sub_401cda()
{
    /* tailcall */
    return sub_401cda();
}

noreturn int64_t sub_401d70(int32_t arg1) 
{
    ...
    else
    {
        ...
        fputs_unlocked(dcgettext(nullptr, "Diagnose invalid or unportable f…", 5), stdout);
        ...
        if (rbp_1 == 0)
        {
            ...
            if (rax_18 != 0)
            {
                rax_19 = strncmp(rax_18, &data_405cb0, 3);
                if (rax_19 != 0)
                {
                    rbp_1 = "pathchk";
                }
            ...
            if ((rax_18 == 0 || (rax_18 != 0 && rax_19 == 0)))
            {
                rbp_1 = "pathchk";
                r12_1 = " invocation";
                __printf_chk(1, dcgettext(nullptr, "Full documentation at: <%s%s>n", 5), "https://www.gnu.org/software/cor…", "pathchk");
            }
        }
        else
        {
            ...
            if (strncmp(rax_10, &data_405cb0, 3) == 0)
            {
                goto label_401f50;
            }
        }
        ...
        {
            __printf_chk(1, dcgettext(nullptr, "Report %s translation bugs to <h…", 5), "pathchk");
        label_401f50:
            r12_1 = " invocation";
            __printf_chk(1, dcgettext(nullptr, "Full documentation at: <%s%s>n", 5), "https://www.gnu.org/software/cor…", "pathchk");
            if (rbp_1 != "pathchk")
            {
                r12_1 = &data_40742c[0x1b];
            }
        }
...
int64_t sub_402060(int64_t arg1)
{
    data_609280 = arg1;
}

int64_t sub_402070(char arg1)
{
    data_609278 = arg1;
}

void sub_402080(void* arg1)
{
    int32_t rax = sub_405400(stdout);
    int32_t* rax_1;
    if (rax != 0)
    {
    ...
    if (((rax == 0 || ((rax != 0 && data_609278 != 0) && *rax_1 == 0x20)) && sub_405400(stderr) == 0))
    {
        return;
    }
    _exit(data_6091d8);
    ...
    uint32_t arg5, int32_t arg6, int64_t arg7, char* arg8, char* arg9)
{
                    ...
                    label_402a60:
                        ...
                        label_402865:;
                            ...
                            while (true)
                            {
                                ...
                                uint32_t var_44;
                                rax_12 = sub_405380(&var_44, rbp_4, (var_98 - r15_1), &var_40);
                                if (rax_12 != 0)
                                {
                                    if (rax_12 == -1)
                                    {
    ...
    switch (r13)
    {
        ...
        case 0xa:
        {
            if ((!cond1))
            {
                arg8 = sub_4021c0(&data_40624d, r13);
                arg9 = sub_4021c0("'", r13);
            }
            rbx_1 = 0;
            if (rbp_1 == 0)
...
int64_t sub_403d40(uint64_t arg1)
{
    /* tailcall */
    return sub_4034f0(0, arg1, -1, &data_6091e0);
}
    ...
    int64_t* arg5, int64_t arg6)
{
    ...
    __fprintf_chk(arg1, 1, "Copyright %s %d Free Software Fo…", dcgettext(nullptr, &data_406f8b, 5), 0x7e1);
...
int64_t sub_404300(size_t arg1)
{
...
int64_t sub_404360(int64_t arg1, size_t arg2)
{
    if ((arg2 == 0 && arg1 != 0))
    {
        free(arg1);
...
int64_t sub_4044b0(size_t arg1)
{
    /* tailcall */
    return memset(sub_404300(arg1), 0, arg1);
}

int64_t sub_4044d0(size_t arg1, size_t arg2)
{
    int64_t rax;
    bool rdx;
    rdx = HIGHD((arg1 * arg2));
...
int64_t sub_404500(int64_t arg1, size_t arg2)
{
    /* tailcall */
...
uint64_t sub_404590(int64_t arg1, int32_t* arg2)
{
    int64_t r11 = (arg1 + 8);
...
uint64_t sub_404670(int32_t arg1, int64_t* arg2, char* arg3, int64_t* arg4, 
...
uint64_t sub_404c90(int32_t arg1, int64_t* arg2, char* arg3, int64_t* arg4, 
        ...
        label_404d58:;
            ...
            if (((!z_1) && rcx_3 != 0))
            {
                ...
                if (*r14_1 == 0x2d)
                {
                    ...
                    label_404f91:
                        *(arg7 + 0x20) = &r14_1[1];
                        int32_t rax_12 = sub_404670(rbp_1, arg2, r15_1, arg4, arg5, arg6, arg7, r13, &data_40742a);
                        r14_2 = rax_12;
                                ...
                                if (((*rax_7 == 0x57 && arg4 != 0) && rcx_7 == 0x3b))
                                {
                                    ...
                                    label_40500e:
                                        *(arg7 + 0x20) = r8_1;
                                        arg6 = 0;
                                        *(arg7 + 0x10) = 0;
                                        var_78_1 = &data_407448;
                                        var_80_2 = r13;
                                        var_88_2 = arg7;
                                    label_405040:
                                        r14_2 = sub_404670(rbp_1, arg2, r15_1, arg4, arg5, arg6, var_88_2, var_80_2, var_78_1);
                                    }
                                }
...
uint64_t sub_4052c0(int32_t arg1, int64_t* arg2, char* arg3)
{
    return _getopt_internal(arg1, arg2, arg3, nullptr, nullptr, 0, 1);
}

uint64_t sub_405380(uint32_t* arg1, char* arg2, uint64_t arg3, mbstate_t* arg4)
{
    uint64_t rbx_1;
    char* rbp_1;
    uint32_t* r12_1;
...
uint64_t sub_405400(FILE* arg1)
{
    int32_t* rbp = arg1;
    uint64_t rax = __fpending(arg1);
    int32_t rbx_1 = (*rbp & 0x20);
    uint64_t rax_1 = sub_405a30(rbp);
    if ((rbx_1 != 0 && rax_1 == 0))
    {
        *__errno_location() = 0;
        rax_1 = 0xffffffff;
...
char* sub_4054c0()
{
    ...
    char* r15 = data_609420;
    char* rbx = rax;
    if (rax == 0)
    {
        rbx = &data_40742c[0x1b];
    }
    if (r15 == 0)
    {
...
int64_t sub_405a30(FILE* arg1)
{
    ...
    if (fileno(arg1) >= 0)
    {
        ...
        if (((rax_1 == 0 || (rax_1 != 0 && rax_6 != -1)) && sub_405ab0(arg1) != 0))
        {
...
off64_t sub_405af0(FILE* arg1, off_t arg2, int32_t arg3)
{
...
int64_t sub_405bc0(void (* arg1)(void*))
{
    /* tailcall */
    return __cxa_atexit(arg1, nullptr, data_6091c8);
}

int64_t sub_405bd8(int64_t arg1, int64_t arg2, int64_t arg3)
{
