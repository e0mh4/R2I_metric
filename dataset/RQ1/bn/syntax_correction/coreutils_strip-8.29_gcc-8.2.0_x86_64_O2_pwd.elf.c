...
int64_t sub_401e50(int64_t* arg1, int64_t arg2, uint64_t arg3)
{
    void* rax = arg1[2];
    void* r12_1 = (rax - *arg1);
    int64_t rdi = (arg3 + 1);
...
noreturn int64_t sub_4023d0(int32_t arg1) 
{
    ...
    else
    {
        ...
        fputs_unlocked(dcgettext(nullptr, "nIf no option is specified, -P …", 5), stdout);
        __printf_chk(1, dcgettext(nullptr, "nNOTE: your shell may have its …", 5), &data_4071a4);
        ...
        if (rbp_1 == 0)
        {
            ...
            if ((rax_22 == 0 || (rax_22 != 0 && rax_23 == 0)))
            {
                rbp_1 = &data_4071a4;
                r12_1 = " invocation";
                __printf_chk(1, dcgettext(nullptr, "Full documentation at: <%s%s>n", 5), "https://www.gnu.org/software/cor…", &data_4071a4);
            }
        }
        else
        {
...
int64_t sub_402730(int64_t arg1)
{
    data_60a2e0 = arg1;
}

int64_t sub_402740(char arg1)
{
    data_60a2d8 = arg1;
}

void sub_402750(void* arg1)
{
...
int64_t* sub_404430(int64_t* arg1)
{
    int64_t var_98;
...
int64_t sub_404480(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4, 
...
int64_t sub_404860(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4, 
    int64_t* arg5)
{
    int64_t r9 = 0;
    if (*arg5 != 0)
...
int64_t sub_4048e0(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4)
{
    char r11 = 0;
    int64_t r8;
    int64_t var_18 = r8;
...
int64_t sub_404a20(size_t arg1)
{
...
int64_t sub_404a80(int64_t arg1, size_t arg2)
{
    if ((arg2 == 0 && arg1 != 0))
    {
        free(arg1);
...
noreturn int64_t sub_404bca() 
{
    sub_404c70();
    /* no return */
}

int64_t sub_404bd0(size_t arg1)
{
    /* tailcall */
    return memset(sub_404a20(arg1), 0, arg1);
}

int64_t sub_404bf0(size_t arg1, size_t arg2)
{
    int64_t rax;
    bool rdx;
    rdx = HIGHD((arg1 * arg2));
...
int64_t sub_404c20(int64_t arg1, size_t arg2)
{
    /* tailcall */
    return memcpy(sub_404a20(arg2), arg1, arg2);
}

int64_t sub_404c50(char* arg1)
{
    /* tailcall */
    return sub_404c20(arg1, (strlen(arg1) + 1));
}

noreturn int64_t sub_404c70() 
{
...
void* const sub_404ce0(void* arg1, size_t arg2)
{
    void* var_108 = arg1;
    void* const var_110;
    size_t var_100;
...
uint64_t sub_4051b0(int64_t arg1, int32_t* arg2)
{
    int64_t r11 = (arg1 + 8);
...
uint64_t sub_405290(int32_t arg1, int64_t* arg2, char* arg3, int64_t* arg4, 
...
uint64_t sub_4058b0(int32_t arg1, int64_t* arg2, char* arg3, int64_t* arg4, 
...
uint64_t sub_405ee0(int32_t arg1, int64_t* arg2, char* arg3)
{
    return _getopt_internal(arg1, arg2, arg3, nullptr, nullptr, 0, 1);
}

uint64_t sub_405f80(uint32_t* arg1, char* arg2, uint64_t arg3, mbstate_t* arg4)
{
    uint64_t rbx_1;
    char* rbp_1;
    uint32_t* r12_1;
...
int64_t sub_406000(char* arg1, int64_t arg2, int64_t* arg3)
{
    int64_t r11 = 1;
    int64_t r8 = 1;
    int64_t r9 = 0;
...
void* sub_406130(void* arg1, void* arg2, char* arg3, void* arg4)
{
    void* rbp = arg2;
    void* var_868;
    void* var_840;
...
char* sub_406480(char* arg1, char* arg2)
{
    uint32_t rax = *arg1;
    char r9 = *arg2;
    char* r12_1;
...
off64_t sub_406f10(FILE* arg1, off_t arg2, int32_t arg3)
{
...
char* sub_406f70(char* arg1, int32_t arg2, int64_t arg3)
{
    char r8 = arg2;
    if (arg3 != 0)
    {
...
int64_t sub_4070f0(void (* arg1)(void*))
{
...
int64_t sub_407108(int64_t arg1, int64_t arg2, int64_t arg3)
{
