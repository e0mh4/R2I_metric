...
int32_t main(int32_t argc, char** argv, char** envp)
{
    ...
    int32_t rbx;
    int32_t rbp;
    setlocale(6, &data_406e0c[0x1b], rdx, rcx, r8, r9, rbx, rbp);
    bindtextdomain("coreutils", "/home/dongkwan/data/scripts/gnu_…");
    textdomain("coreutils");
    sub_405770(sub_401b40);
    sub_401be0(rbp_1, rbx_1, "link", "GNU coreutils", data_6091d0, sub_401830, 0);
    if (getopt_long(rbp_1, rbx_1, &data_406e0c[0x1b], &data_405b00, nullptr) == 0xffffffff)
    {
        int64_t rax_1 = data_60923c;
        int64_t rbx_2;
        ...
        if ((rax_1 + 1) < rbp_1)
        {
            ...
            if ((rax_1 + 2) < rbp_1)
            {
                rsi_3 = "extra operand %s";
                rbx_2 = sub_403910(rbx_1[(rdx_3 + 2)]);
            }
            else
            {
                if (link(rbx_1[rdx_3], rbx_1[(rdx_3 + 1)]) == 0)
                {
                    return 0;
                }
                char* rax_10 = sub_4035e0(1, 4, rbx_1[data_60923c]);
                rbp_1 = sub_4035e0(0, 4, rbx_1[(data_60923c + 1)]);
                rbx_1 = dcgettext(nullptr, "cannot create link %s to %s", 5);
                rax_1 = error(1, *__errno_location(), rbx_1, rbp_1, rax_10);
            }
        }
        if ((((rax_1 + 1) >= rbp_1 || ((rax_1 + 1) < rbp_1 && (rax_1 + 2) >= rbp_1)) && rax_1 < rbp_1))
        {
            rsi_3 = "missing operand after %s";
            rbx_2 = sub_403910(rbx_1[rax_1]);
        }
        if ((((rax_1 + 1) < rbp_1 && (rax_1 + 2) < rbp_1) || (((rax_1 + 1) >= rbp_1 || ((rax_1 + 1) < rbp_1 && (rax_1 + 2) >= rbp_1)) && rax_1 < rbp_1)))
        {
            error(0, 0, dcgettext(nullptr, rsi_3, 5), rbx_2);
        }
        if ((((rax_1 + 1) >= rbp_1 || ((rax_1 + 1) < rbp_1 && (rax_1 + 2) >= rbp_1)) && rax_1 >= rbp_1))
        {
...
int64_t j_sub_40179a()
{
    /* tailcall */
    return sub_40179a();
}

noreturn int64_t sub_401830(int32_t arg1) 
{
    ...
    {
        __printf_chk(1, dcgettext(nullptr, "Usage: %s FILE1 FILE2n  or:  %s…", 5), rbp, rbp);
        fputs_unlocked(dcgettext(nullptr, "Call the link function to create…", 5), stdout);
        ...
        if (rbp_1 == 0)
        {
            ...
            if (rax_18 != 0)
            {
                rax_19 = strncmp(rax_18, &data_40584d, 3);
                if (rax_19 != 0)
                {
                    rbp_1 = "link";
                }
            ...
            if ((rax_18 == 0 || (rax_18 != 0 && rax_19 == 0)))
            {
                rbp_1 = "link";
                r12_1 = " invocation";
                __printf_chk(1, dcgettext(nullptr, "Full documentation at: <%s%s>n", 5), "https://www.gnu.org/software/cor…", "link");
            }
        }
        else
        {
            ...
            if (strncmp(rax_10, &data_40584d, 3) == 0)
            {
                goto label_401a10;
            }
        }
        ...
        {
            __printf_chk(1, dcgettext(nullptr, "Report %s translation bugs to <h…", 5), "link");
        label_401a10:
            r12_1 = " invocation";
            __printf_chk(1, dcgettext(nullptr, "Full documentation at: <%s%s>n", 5), "https://www.gnu.org/software/cor…", "link");
            if (rbp_1 != "link")
            {
                r12_1 = &data_406e0c[0x1b];
            }
        }
...
int64_t sub_401b20(int64_t arg1)
{
    data_609280 = arg1;
}

int64_t sub_401b30(char arg1)
{
    data_609278 = arg1;
}

void sub_401b40(void* arg1)
{
    ...
    if (((rax == 0 || ((rax != 0 && data_609278 != 0) && *rax_1 == 0x20)) && sub_404fb0(stderr) == 0))
    {
        return;
    }
    _exit(data_6091d8);
...
void sub_401be0(int32_t arg1, int64_t* arg2, int64_t arg3, int64_t arg4, 
    int64_t arg5, int64_t arg6, uint64_t arg7)
{
    ...
    if (arg1 == 2)
    {
        arg7 = getopt_long(arg1, arg2, &data_405b38, &data_405b60, nullptr);
        if (arg7 != 0xffffffff)
        {
            if (arg7 == 0x68)
            {
            ...
            else if (arg7 == 0x76)
            {
                ...
                void var_d8;
                void* var_e0 = &var_d8;
                sub_403d30(stdout, arg3, arg4, arg5, &var_f0);
                exit(0);
                /* no return */
            }
        }
    ...
    uint32_t arg5, int32_t arg6, int64_t arg7, char* arg8, char* arg9)
{
    ...
    switch (r13)
    {
        ...
        case 0xa:
        {
            if ((!cond1))
            {
                arg8 = sub_401d90(&data_405c15, r13);
                arg9 = sub_401d90("'", r13);
            }
            rbx_1 = 0;
            if (rbp_1 == 0)
...
{
    /* tailcall */
    return sub_4030c0(arg1, arg2, -1, &data_6093a0);
}

int64_t sub_403590(int32_t arg1, uint64_t arg2, uint64_t arg3)
{
    /* tailcall */
    return sub_4030c0(arg1, arg2, arg3, &data_6093a0);
}

int64_t sub_4035a0(uint64_t arg1)
{
    /* tailcall */
    return sub_4030c0(0, arg1, -1, &data_6093a0);
}

int64_t sub_4035c0(uint64_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_4030c0(0, arg1, arg2, &data_6093a0);
}
...
{
    /* tailcall */
    return sub_4030c0(0, arg1, -1, &data_6091e0);
}
    ...
    int64_t* arg5, int64_t arg6)
{
    ...
    __fprintf_chk(arg1, 1, "Copyright %s %d Free Software Fo…", dcgettext(nullptr, &data_40696b, 5), 0x7e1);
        ...
        label_404928:;
            ...
            if (((!z_1) && rcx_3 != 0))
            {
                ...
                if (*r14_1 == 0x2d)
                {
                    ...
                    label_404b61:
                        *(arg7 + 0x20) = &r14_1[1];
                        int32_t rax_12 = sub_404240(rbp_1, arg2, r15_1, arg4, arg5, arg6, arg7, r13, &data_406e0a);
                        r14_2 = rax_12;
