                            ...
                            if (r14_1 != 0)
                            {
                                ...
                                while (true)
                                {
                                    ...
                                    if (rax_14 != 0)
                                    {
                                        ...
                                        {
                                            cond:3_1 = data_60c298 != 0;
                                            rax_14[1] = 0;
                                        }
                                        bool cond:4_1;
                                        if ((rbx_1 < rax_14 && *rax_14 == 0x2f))
                                        {
                                            cond:4_1 = data_60c298 == 0;
                                            *(rbx_1 + 1) = 0;
                                        }
                                        if ((((rbx_1 >= rax_14 || (rbx_1 < rax_14 && *rax_14 != 0x2f)) && cond:3_1) || ((rbx_1 < rax_14 && *rax_14 == 0x2f) && (!cond:4_1))))
                                        {
                                            sub_403bf0(4, rbx_1);
                                            sub_402030(stdout, dcgettext(nullptr, "removing directory, %s", 5), 0);
                                        }
...
int64_t sub_401d20(int32_t arg1) __noreturn
{
...
char* sub_402030(FILE* arg1, char* arg2, char arg3 @ rax)
{
    int64_t rdx;
    int64_t var_b8 = rdx;
    int64_t rcx;
