    ...
    while (true)
    {
        ...
        else
        {
            if (cond:0_1)
            {
                ...
                if ((cond:4_1 && rax_1 != 0xffffff7d))
                {
                    break;
                }
                if (((!cond:4_1) && rax_1 != 0x56))
                {
                    if (rax_1 != 0x64)
                    {
                        break;
...
int64_t sub_4023c0(int32_t arg1) __noreturn
{
...
int64_t sub_406850(uint64_t arg1) __noreturn
{
    if (arg1 != 0)
    {
