...
int64_t sub_402580(int32_t arg1) __noreturn
{
    ...
    else
    {
        ...
        fputs_unlocked(dcgettext(nullptr, "\nIf no command is given, run '"…", 5), stdout);
