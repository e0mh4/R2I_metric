...
uint64_t sub_401bb0(int32_t* arg1, FILE* arg2, char arg3, uint64_t arg4 @ r14, 
    uint64_t arg5 @ r15)
{
    uint64_t var_8 = arg5;
...
int64_t sub_4020a0(int32_t arg1) __noreturn
{
    ...
    else
    {
        ...
        __printf_chk(1, dcgettext(nullptr, "\nThe data are encoded as descri…", 5), "base32", "base32");
