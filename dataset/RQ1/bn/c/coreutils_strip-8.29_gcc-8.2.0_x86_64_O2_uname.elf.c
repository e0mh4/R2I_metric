...
int64_t sub_401ad0(int32_t arg1) __noreturn
{
    ...
    else
    {
        ...
        void* const rsi_2 = "Print machine architecture.\n\n";
        if (data_6091d0 == 1)
        {
