...
int32_t* sub_402a10(int32_t arg1, int32_t* arg2 @ rbp, int32_t* arg3 @ r13)
{
    int32_t* var_18 = arg3;
    int32_t* var_28 = arg2;
    uint64_t rbx = arg1;
...
uint64_t sub_40b840(void* arg1, int64_t arg2, int32_t arg3, int32_t arg4 @ rax)
{
    if (arg2 < 0)
    {
        return *(arg1 + 0x70);
...
uint64_t sub_415960(int64_t* arg1, char* arg2, int32_t arg3, int64_t arg4 @ r14)
{
    int64_t var_8 = arg4;
    uint64_t rbx = arg3;
    *arg1 = 0;
