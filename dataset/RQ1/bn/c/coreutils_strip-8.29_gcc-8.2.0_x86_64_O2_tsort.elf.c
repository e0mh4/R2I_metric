                            ...
                            else
                            {
                                while (true)
                                {
                                    ...
                                    if (rax_7 == 0)
                                    {
                                        ...
                                        bool cond:2_1 = rax_13 < 0;
                                        bool cond:3_1 = rax_13 < 0;
                                        if (rax_13 == 0)
                                        {
...
int64_t sub_402150(int32_t arg1) __noreturn
{
