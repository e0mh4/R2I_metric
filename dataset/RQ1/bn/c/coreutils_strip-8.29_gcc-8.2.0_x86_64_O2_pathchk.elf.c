                    ...
                    do
                    {
                        ...
                        if (((r13 == 0 && rbp == 0) || ((r13 != 0 && rax_18 == 0) && rax_10 != 0)))
                        {
                            ...
                            else
                            {
                                ...
                                bool cond:3_1 = *rax_5 != 2;
                                int32_t* rbp_1 = rax_5;
                                rax_5 = rax_10 == 0;
                                bool r8_2 = (cond:3_1 | rax_5);
                                if (r8_2 != 0)
                                {
...
int64_t sub_401d70(int32_t arg1) __noreturn
{
