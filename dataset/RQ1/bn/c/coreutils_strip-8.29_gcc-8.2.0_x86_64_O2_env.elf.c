...
int64_t sub_401be0(int32_t arg1) __noreturn
{
    ...
    else
    {
        ...
        fputs_unlocked(dcgettext(nullptr, "\nA mere - implies -i.  If no CO…", 5), stdout);
