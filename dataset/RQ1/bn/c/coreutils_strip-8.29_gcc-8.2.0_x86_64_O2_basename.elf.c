...
int64_t sub_401970(int32_t arg1) __noreturn
{
    ...
    {
        __printf_chk(1, dcgettext(nullptr, "Usage: %s NAME [SUFFIX]\n  or:  …", 5), rbp, rbp);
        ...
        __printf_chk(1, dcgettext(nullptr, "\nExamples:\n  %s /usr/bin/sort …", 5), rbp_1, rbp_1, rbp_1, rbp_1);
