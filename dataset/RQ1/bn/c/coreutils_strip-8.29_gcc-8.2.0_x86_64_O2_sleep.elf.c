...
int64_t sub_401970(int32_t arg1) __noreturn
{
    ...
    {
        __printf_chk(1, dcgettext(nullptr, "Usage: %s NUMBER[SUFFIX]...\n  o…", 5), rbp, rbp);
...
int64_t sub_405350(double arg1 @ zmm0)
{
