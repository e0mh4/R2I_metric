...
int32_t main(int32_t argc, char** argv, char** envp)
{
    ...
    void var_38;
    int64_t var_30;
    setlocale(6, &data_407d3c[0x1b], rdx, rcx, r8, r9, var_38, var_30);
    ...
    if (rbp > 1)
    {
        ...
        {
            int64_t rax_1 = rbx;
            int64_t rcx_1 = (rax_1 << 3);
            char* rax_2 = argv[rax_1];
            int32_t rdx_2;
            if (*rax_2 == 0x2d)
            {
                rdx_2 = ((rax_2[1] - 0x2b) & 0xfd) == 0;
                if ((rax_2[(rdx_2 + 1)] - 0x30) <= 9)
                {
                    r12_1 = &rax_2[1];
                    rbx = (rbx + 1);
                }
            }
            if ((*rax_2 != 0x2d || (*rax_2 == 0x2d && (*(rax_2 + (rdx_2 + 1)) - 0x30) > 9)))
            {
                *((argv + rcx_1) - 8) = *argv;
                data_60925c = 0;
                rax_5 = getopt_long((rbp - (rbx - 1)), ((argv + rcx_1) - 8), &data_406231, &data_406700, nullptr);
                rbx = ((rbx + data_60925c) - 1);
                bool cond:0_1 = rax_5 <= 0xffffff7e;
                if (rax_5 == 0xffffff7e)
                {
                    sub_401b60(0);
                    /* no return */
        ...
        if (r12_1 != 0)
        {
            if (sub_4043f0(r12_1, nullptr, 0xa, &var_30, &data_407d3c[0x1b]) <= 1)
            {
                int64_t rax_7 = var_30;
                r12_2 = 0xffffffd9;
                if (rax_7 >= -0x27)
                {
                    int64_t rdx_13 = 0x27;
                ...
                error(0, 0, dcgettext(nullptr, "a command must be given with an …", 5));
            label_401a3f:
                sub_401b60(0x7d);
                /* no return */
            }
            rbx = sub_403ba0(r12_1);
            error(0x7d, 0, dcgettext(nullptr, "invalid adjustment %s", 5), rbx);
        }
    }
    int32_t rax_9;
    if ((rbp <= 1 || (rbp > 1 && r12_1 == 0)))
    {
        r12_2 = __errno_location();
        if (rbx == rbp)
        {
            *r12_2 = 0;
            int32_t rax_14 = getpriority(PRIO_PROCESS, 0);
            int32_t rbx_1;
            if ((rax_14 == 0xffffffff && *r12_2 != 0))
            {
                rax_9 = error(0x7d, *r12_2, dcgettext(nullptr, "cannot get niceness", 5));
            label_401946:
                int32_t rax_17 = setpriority(0, 0, (rax_9 + r12_2));
                if (rax_17 != 0)
                {
                    dcgettext(nullptr, "cannot set niceness", 5);
                    int32_t rsi_4 = *rbp;
                    int64_t rdi_5;
                    if (rsi_4 != 0xd)
                    {
                ...
                if ((rax_17 == 0 || (rax_17 != 0 && (*stderr & 0x20) == 0)))
                {
                    void* r12_3 = &argv[rbx];
                    execvp(*r12_3, r12_3);
                    int32_t rbx_3;
                    rbx_3 = *rbp == 2;
                    rbx_1 = (rbx_3 + 0x7e);
                    error(0, *rbp, "%s", sub_403ba0(*r12_3));
                }
                goto label_4019e0;
            }
            __printf_chk(1, &data_40626f, rax_14);
            rbx_1 = 0;
        label_4019e0:
            return rbx_1;
        }
    ...
    r12_2 = 0xa;
label_40183c:
    uint64_t rax_8 = __errno_location();
    *rax_8 = 0;
    rbp = rax_8;
    rax_9 = getpriority(PRIO_PROCESS, 0);
    if (rax_9 != 0xffffffff)
    {
        goto label_401946;
    }
    ...
    rax_5 = error(0x7d, *rbp, dcgettext(nullptr, "cannot get niceness", 5));
label_401890:
    if (rax_5 == 0xffffff7d)
    {
        sub_404020(stdout, "nice", "GNU coreutils", data_6091f0);
        exit(0);
        /* no return */
    }
    goto label_401a3f;
...
int64_t j_sub_401aca()
{
    /* tailcall */
    return sub_401aca();
}

int64_t sub_401b60(int32_t arg1) __noreturn
{
    ...
    {
        __printf_chk(1, dcgettext(nullptr, "Usage: %s [OPTION] [COMMAND [ARG…", 5), rbp);
        __printf_chk(1, dcgettext(nullptr, "Run COMMAND with an adjusted nic…", 5), 0xffffffec, 0x13);
        fputs_unlocked(dcgettext(nullptr, "\nMandatory arguments to long op…", 5), stdout);
        fputs_unlocked(dcgettext(nullptr, "  -n, --adjustment=N   add integ…", 5), stdout);
        ...
        __printf_chk(1, dcgettext(nullptr, "\nNOTE: your shell may have its …", 5), "nice");
        void* const var_88 = &data_4061a9;
        ...
        if (rbp_1 == 0)
        {
            ...
            if (rax_23 != 0)
            {
                rax_24 = strncmp(rax_23, &data_40622d, 3);
                if (rax_24 != 0)
                {
                    rbp_1 = "nice";
                }
        ...
        else
        {
            ...
            if (strncmp(rax_15, &data_40622d, 3) == 0)
            {
                goto label_401db0;
            }
        }
        ...
        {
            __printf_chk(1, dcgettext(nullptr, "Report %s translation bugs to <h…", 5), "nice");
        label_401db0:
            r12_1 = " invocation";
            __printf_chk(1, dcgettext(nullptr, "Full documentation at: <%s%s>\n", 5), "https://www.gnu.org/software/cor…", "nice");
            if (rbp_1 != "nice")
            {
                r12_1 = &data_407d3c[0x1b];
            }
        }
...
void sub_401ee0(void* arg1)
{
    ...
    if (rax != 0)
    {
        ...
        if ((data_609298 == 0 || (data_609298 != 0 && *rax_1 != 0x20)))
        {
            ...
            {
                error(0, *rax_1, "%s: %s", sub_4039f0(rdi_2), rax_3);
            }
        }
    }
    if (((rax == 0 || ((rax != 0 && data_609298 != 0) && *rax_1 == 0x20)) && sub_405990(stderr) == 0))
    {
        return;
    }
    _exit(data_6091f8);
...
char* sub_402020(char* arg1, int32_t arg2)
{
    char* rax = dcgettext(nullptr, arg1, 5);
    char* rbx = rax;
    if (arg1 == rax)
    {
        char* rax_2 = sub_405a50();
...
int64_t sub_402120(char* arg1, uint64_t arg2, uint64_t arg3, uint64_t arg4, 
    uint32_t arg5, int32_t arg6, int64_t arg7, char* arg8, char* arg9)
{
            ...
            while (true)
            {
                ...
                if (r13 == 0)
                {
                    ...
                    else if (var_5b_1 != 0)
                    {
                        if (var_a9 != 0)
                        {
                            rbx_1 = sub_402120(r15, var_70, arg3, r11, 5, arg6, arg7, arg8, arg9);
                        }
                        else
                        {
                            rax_1 = r14 == 0;
                ...
                else
                {
                    ...
                    if (var_a0_1 != 0)
                    {
                        ...
                        label_403210:
                            ...
                            r11 = r9;
                        label_402574:
                            rbx_1 = sub_402120(r15, r14, arg3, r11, r13_1, (arg6 & 0xfffffffd), 0, arg8, arg9);
                        label_40258b:
                            return rbx_1;
                        }
                        rbp_3 = *r8;
                    ...
                    label_4028c0:
                        ...
                        label_4026c5:
                            ...
                            while (true)
                            {
                                ...
                                uint32_t var_44;
                                rax_12 = sub_405910(&var_44, rbp_4, (var_98 - r15_1), &var_40);
                                if (rax_12 != 0)
                                {
                                    if (rax_12 == -1)
                                    {
    ...
    switch (r13)
    {
        ...
        case 0xa:
        {
            if ((!cond:1))
            {
                arg8 = sub_402020(&data_4067ed, r13);
                arg9 = sub_402020("'", r13);
            }
            rbx_1 = 0;
            if (rbp_1 == 0)
...
char* sub_403350(int32_t arg1, uint64_t arg2, uint64_t arg3, int32_t* arg4)
{
    int64_t r15 = arg1;
    ...
    if (data_609250 <= r15)
    {
        ...
        if (rbx == 0x609240)
        {
            int64_t rax_9 = sub_4041c0(0, rsi_1);
        ...
        {
            int64_t rax_2 = sub_4041c0(rbx, rsi_1);
            data_609238 = rax_2;
            rbx = rax_2;
        }
    ...
    uint64_t r11 = *rbx_1;
    char* r12_2 = *(rbx_1 + 8);
    int64_t rax_5 = sub_402120(r12_2, r11, arg2, arg3, *arg4, rax_4, r15_2, *(arg4 + 0x28), *(arg4 + 0x30));
    if (r11 <= rax_5)
    {
        ...
        *rbx_1 = rsi_3;
        ...
        char* rax_6 = sub_404160(rsi_3);
        uint32_t r8_1 = *arg4;
        *(rbx_1 + 8) = rax_6;
        r12_2 = rax_6;
        sub_402120(rax_6, rsi_3, arg2, arg3, r8_1, rax_4, r15_2, *(arg4 + 0x28), *(arg4 + 0x30));
    }
    *rax = rax_1;
    return r12_2;
}

int64_t sub_4034f0(int64_t arg1)
{
    int64_t rbx = arg1;
    int32_t* rax = __errno_location();
    int32_t r12 = *rax;
    ...
    int64_t rax_1 = sub_404360(rbx, 0x38);
    *rax = r12;
    return rax_1;
}

uint64_t sub_403530(int32_t* arg1)
{
    if (arg1 == 0)
    {
        arg1 = &data_6093c0;
...
void sub_403540(int32_t* arg1, int32_t arg2)
{
    if (arg1 == 0)
    {
        arg1 = &data_6093c0;
...
uint64_t sub_403550(int64_t arg1, uint8_t arg2, int32_t arg3)
{
    if (arg1 == 0)
    {
        arg1 = 0x6093c0;
...
uint64_t sub_403590(int128_t* arg1, int32_t arg2)
{
    if (arg1 == 0)
    {
        arg1 = &data_6093c0;
...
void sub_4035b0(int32_t* arg1, int64_t arg2, int64_t arg3)
{
    if (arg1 == 0)
    {
        arg1 = &data_6093c0;
...
int64_t sub_4035e0(char* arg1, uint64_t arg2, uint64_t arg3, uint64_t arg4, 
    int32_t* arg5)
{
    int32_t* rbx = arg5;
    if (arg5 == 0)
    ...
    int32_t* rax = __errno_location();
    int32_t r12 = *rax;
    int64_t rax_2 = sub_402120(arg1, arg2, arg3, arg4, *rbx, rbx[1], &rbx[2], *(rbx + 0x28), *(rbx + 0x30));
    *rax = r12;
    return rax_2;
}

char* sub_403660(uint64_t arg1, uint64_t arg2, int64_t* arg3, int32_t* arg4)
{
    int32_t* rbx = arg4;
    if (arg4 == 0)
    {
    ...
    int64_t rax_2 = sub_402120(nullptr, 0, arg1, arg2, *rbx, rbp_1, &rbx[2], *(rbx + 0x28), *(rbx + 0x30));
    char* rax_3 = sub_404160((rax_2 + 1));
    sub_402120(rax_3, (rax_2 + 1), arg1, arg2, *rbx, rbp_1, &rbx[2], *(rbx + 0x28), *(rbx + 0x30));
    *rax = rax_1;
    if (arg3 != 0)
    {
        *arg3 = rax_2;
...
int64_t sub_403750(uint64_t arg1, uint64_t arg2, int32_t* arg3)
{
    /* tailcall */
    return sub_403660(arg1, arg2, nullptr, arg3);
}
...
int64_t sub_403800(int32_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_403350(arg1, arg2, -1, &data_6093c0);
}

int64_t sub_403820(int32_t arg1, uint64_t arg2, uint64_t arg3)
{
    /* tailcall */
    return sub_403350(arg1, arg2, arg3, &data_6093c0);
}

int64_t sub_403830(uint64_t arg1)
{
    /* tailcall */
    return sub_403350(0, arg1, -1, &data_6093c0);
}

int64_t sub_403850(uint64_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_403350(0, arg1, arg2, &data_6093c0);
}

char* sub_403870(int32_t arg1, int32_t arg2, uint64_t arg3)
{
    if (arg2 == 0xa)
    {
        abort();
    ...
    int64_t var_20 = 0;
    int64_t var_18 = 0;
    return sub_403350(arg1, arg3, -1, &var_48);
}

char* sub_4038e0(int32_t arg1, int32_t arg2, uint64_t arg3, uint64_t arg4)
{
    if (arg2 == 0xa)
    {
        abort();
    ...
    int64_t var_20 = 0;
    int64_t var_18 = 0;
    return sub_403350(arg1, arg3, arg4, &var_48);
}

int64_t sub_403950(int32_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_403870(0, arg1, arg2);
}

int64_t sub_403960(int32_t arg1, uint64_t arg2, uint64_t arg3)
{
    /* tailcall */
    return sub_4038e0(0, arg1, arg2, arg3);
}

char* sub_403970(uint64_t arg1, uint64_t arg2, uint8_t arg3)
{
    ...
    *((&var_48 + ((arg3 >> 5) << 2)) + 8) = ((((!(rdx >> rcx_1)) & 1) << rcx_1) ^ rdx);
    return sub_403350(0, arg1, arg2, &var_48);
}

int64_t sub_4039e0(uint64_t arg1, uint8_t arg2)
{
    /* tailcall */
    return sub_403970(arg1, -1, arg2);
}

int64_t sub_4039f0(uint64_t arg1)
{
    /* tailcall */
    return sub_403970(arg1, -1, 0x3a);
}

int64_t sub_403a10(uint64_t arg1, uint64_t arg2)
{
    /* tailcall */
    return sub_403970(arg1, arg2, 0x3a);
}

char* sub_403a20(int32_t arg1, int32_t arg2, uint64_t arg3)
{
    if (arg2 == 0xa)
    {
        abort();
...
char* sub_403a90(int32_t arg1, int64_t arg2, int64_t arg3, uint64_t arg4, 
    uint64_t arg5)
{
    int128_t var_48 = data_6093c0;
    int128_t var_38 = data_6093d0;
    ...
    if ((arg2 != 0 && arg3 != 0))
    {
        *var_28[8] = arg2;
        ...
        return sub_403350(arg1, arg4, arg5, &var_48);
    }
    abort();
    /* no return */
}

int64_t sub_403ba0(uint64_t arg1)
{
    /* tailcall */
    return sub_403350(0, arg1, -1, &data_609200);
}

int64_t sub_403bc0(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4, 
    int64_t* arg5, int64_t arg6)
{
    ...
    __fprintf_chk(arg1, 1, "Copyright %s %d Free Software Fo…", dcgettext(nullptr, &data_40752b, 5), 0x7e1);
...
int64_t sub_403fa0(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4, 
    int64_t* arg5)
{
    int64_t r9 = 0;
    if (*arg5 != 0)
    ...
    /* tailcall */
    return sub_403bc0(arg1, arg2, arg3, arg4, arg5, r9);
}

int64_t sub_403fc0(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4, 
    int32_t* arg5)
{
    int64_t r9 = 0;
    void var_58;
    ...
    return sub_403bc0(arg1, arg2, arg3, arg4, &var_58, r9);
}

int64_t sub_404020(FILE* arg1, int64_t arg2, int64_t arg3, int64_t arg4)
{
    char r11 = 0;
    int64_t r8;
    int64_t var_18 = r8;
    ...
    return sub_403bc0(arg1, arg2, arg3, arg4, &var_88, r9_1);
}
...
int64_t sub_404160(uint64_t arg1)
{
...
int64_t sub_40430a() __noreturn
{
    sub_4043b0();
    /* no return */
}

int64_t sub_404310(uint64_t arg1)
{
    /* tailcall */
    return memset(sub_404160(arg1), 0, arg1);
}

int64_t sub_404330(uint64_t arg1, uint64_t arg2)
{
    int64_t rax;
    bool rdx;
    rdx = HIGHD((arg1 * arg2));
...
{
    /* tailcall */
    return memcpy(sub_404160(arg2), arg1, arg2);
}

int64_t sub_404390(char* arg1)
{
    /* tailcall */
    return sub_404360(arg1, (strlen(arg1) + 1));
}

int64_t sub_4043b0() __noreturn
{
...
uint64_t sub_4043f0(char* arg1, int64_t* arg2, int32_t arg3, int64_t* arg4, 
    char* arg5)
{
    if (arg3 > 0x24)
    {
...
uint64_t sub_404b40(int64_t arg1, int32_t* arg2)
{
    int64_t r11 = (arg1 + 8);
...
uint64_t sub_404c20(int32_t arg1, int64_t* arg2, char* arg3, int64_t* arg4, 
        ...
        label_405308:
            ...
            if (((!z_1) && rcx_3 != 0))
            {
                ...
                if (*r14_1 == 0x2d)
                {
                    ...
                    label_405541:
                        *(arg7 + 0x20) = &r14_1[1];
                        int32_t rax_12 = sub_404c20(rbp_1, arg2, r15_1, arg4, arg5, arg6, arg7, r13, &data_407d3a);
                        r14_2 = rax_12;
                                ...
                                if (((*rax_7 == 0x57 && arg4 != 0) && rcx_7 == 0x3b))
                                {
                                    ...
                                    label_4055be:
                                        *(arg7 + 0x20) = r8_1;
                                        arg6 = 0;
                                        *(arg7 + 0x10) = 0;
                                        var_78_1 = &data_407d58;
                                        var_80_2 = r13;
                                        var_88_2 = arg7;
                                    label_4055f0:
                                        r14_2 = sub_404c20(rbp_1, arg2, r15_1, arg4, arg5, arg6, var_88_2, var_80_2, var_78_1);
                                    }
                                }
...
uint64_t sub_405870(int32_t arg1, int64_t* arg2, char* arg3)
{
    return _getopt_internal(arg1, arg2, arg3, nullptr, nullptr, 0, 1);
}

uint64_t sub_405910(uint32_t* arg1, char* arg2, uint64_t arg3, mbstate_t* arg4)
{
    uint64_t rbx_1;
    char* rbp_1;
    uint32_t* r12_1;
...
uint64_t sub_405990(FILE* arg1)
{
    int32_t* rbp = arg1;
    uint64_t rax = __fpending(arg1);
    int32_t rbx_1 = (*rbp & 0x20);
    uint64_t rax_1 = sub_405fc0(rbp);
    if ((rbx_1 != 0 && rax_1 == 0))
    {
        *__errno_location() = 0;
        rax_1 = 0xffffffff;
...
int64_t sub_405fc0(FILE* arg1)
{
    ...
    if (fileno(arg1) >= 0)
    {
        ...
        if (((rax_1 == 0 || (rax_1 != 0 && rax_6 != -1)) && sub_406040(arg1) != 0))
        {
...
off64_t sub_406080(FILE* arg1, off_t arg2, int32_t arg3)
{
...
int64_t sub_406150(void (* arg1)(void*))
{
...
int64_t sub_406168(int64_t arg1, int64_t arg2, int64_t arg3)
{
