...
int32_t main(int32_t argc, char** argv, char** envp)
{
    ...
    while (true)
    {
        int32_t rax_1 = getopt_long(argc, rbp, "d:f:I::r:Rs:u", &data_4141c0, nullptr);
        if (rax_1 == 0xffffffff)
        {
            int32_t rdx_1;
            rdx_1 = r15 != 0;
...
int64_t sub_402750(int32_t arg1) __noreturn
{
    ...
    {
        __printf_chk(1, dcgettext(nullptr, "Usage: %s [OPTION]... [+FORMAT]\n…", 5), rbp, rbp);
        ...
        fputs_unlocked(dcgettext(nullptr, "\nFORMAT controls the output.  I…", 5), stdout);
        ...
        fputs_unlocked(dcgettext(nullptr, "  %h   same as %b\n  %H   hour (…", 5), stdout);
        fputs_unlocked(dcgettext(nullptr, "  %k   hour, space padded ( 0..2…", 5), stdout);
        fputs_unlocked(dcgettext(nullptr, "  %n   a newline\n  %N   nanosec…", 5), stdout);
        fputs_unlocked(dcgettext(nullptr, "  %S   second (00..60)\n  %t   a…", 5), stdout);
        ...
        fputs_unlocked(dcgettext(nullptr, "\nAfter any flags comes an optio…", 5), stdout);
        fputs_unlocked(dcgettext(nullptr, "\nExamples:\nConvert seconds sin…", 5), stdout);
        ...
        while (true)
        {
            ...
            while (true)
            {
                ...
                if (rax_3 != 0x30)
                {
                    ...
                    if ((((!cond:2_1) && rax_3 != 0x23) && rax_3 != 0x2d))
                    {
                        break;
                    }
                    if (((!((!cond:2_1) && rax_3 != 0x23)) && cond:2_1))
                    {
                        if (rax_3 == 0x5e)
                        {
                            var_4d4_1 = 1;
            ...
            if ((rax_3 - 0x30) <= 9)
            {
                ...
                while (true)
                {
                    ...
                    bool cond:3_1 = r10_1 == 0xccccccc;
                    int32_t rsi_2;
                    if (r10_1 <= 0xccccccc)
                    {
                        rsi_2 = *rbx;
                        if (((!cond:3_1) || (cond:3_1 && rsi_2 <= 0x37)))
                        {
                            rbx = arg5;
                            r10_1 = ((rsi_2 + ((r10_1 * 5) << 1)) - 0x30);
                        }
                    }
                    if ((r10_1 > 0xccccccc || ((r10_1 <= 0xccccccc && cond:3_1) && rsi_2 > 0x37)))
                    {
                        if (rdx_1 > 9)
                        {
                            rdi_1 = rax_3;
                    ...
                    if ((((r10_1 > 0xccccccc || ((r10_1 <= 0xccccccc && cond:3_1) && rsi_2 > 0x37)) && rdx_1 <= 9) || (r10_1 <= 0xccccccc && ((!cond:3_1) || (cond:3_1 && rsi_2 <= 0x37)))))
                    {
                        if (rdx_1 > 9)
                        {
                            rdi_1 = rax_3;
...
uint64_t sub_404f90(char* arg1, char arg2 @ rax)
{
    int64_t rsi;
    int64_t var_b0 = rsi;
    int64_t rdx;
                                        ...
                                        else
                                        {
                                            ...
                                            if ((rbp_15 != 1 || ((rbp_15 == 1 && rax_187 != 0x41) && rsi_42 == 0)))
                                            {
                                                ...
                                                if (((rax_187 == 0 || (rax_187 != 0 && rdx_96 == 0)) || ((rax_187 != 0 && rdx_96 != 0) && rax_164 == 0)))
                                                {
                                                    ...
                                                    var_5e0 = r8;
                                                    rbp = 0x3f;
                                                    sub_404f90(dcgettext(nullptr, "error: unknown word '%s'\n", 5), 0);
                                                    rax_1 = 2;
                                                    r8 = var_5e0;
                                                    goto label_405e62;
                                                }
        ...
        label_407cc5:
            ...
            else
            {
                        ...
                        if (rax_12 == rdx_8)
                        {
                            ...
                            if (sub_405050(r15_2, &var_368, &var_3a8, rax_29) == 0)
                            {
                                ...
                                if ((r10_1 == r9_1 && r8 == rcx_4))
                                {
                                    ...
                                    {
                                        sub_404f90(dcgettext(nullptr, "error: invalid date/time value:\n", 5), 0);
                                        sub_405410(&var_368, &var_158, &var_1c8);
                                        sub_404f90(dcgettext(nullptr, "    user provided time: '%s'\n", 5), 0);
                                        sub_405410(&var_3a8, &var_158, &var_1c8);
                                        sub_404f90(dcgettext(nullptr, "       normalized time: '%s'\n", 5), 0);
                                    ...
                                    label_4082a7:
                                        ...
                                        *(&var_1c8 + rdx_15) = 0;
                                        sub_404f90("%s\n", 0);
                                        sub_404f90(dcgettext(nullptr, "     possible reasons:\n", 5), 0);
                                        if (var_420_1 != 0)
                                        {
                                        ...
                                        sub_404f90(dcgettext(nullptr, "       numeric values overflow;\n", 5), 0);
                            ...
                            if (var_7f_2 != 0)
                            {
                                ...
                                sub_404f90(dcgettext(nullptr, "starting date/time: '%s'\n", 5), 0);
                                rdx_34 = zmm0;
                                rdi_56 = *zmm0[8];
                                int64_t rcx_31 = zmm0;
                                rax_99 = var_7f_2;
                            ...
                            label_408ce1:
                                ...
                                sub_405410(&var_3a8, &var_158, &var_2a8);
                                sub_404f90(dcgettext(nullptr, "'%s' = %ld epoch-seconds\n", 5), 0);
                                                ...
                                                if ((!(rbx_9 + r13_4)))
                                                {
                                                    ...
                                                    if ((!(rbx_10 + rax_114)))
                                                    {
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            *rbp_6[4] = arg1->tm_min;
                                                            *(arg1 + 8);
                                                            sub_404f90(dcgettext(nullptr, "final: %ld.%09d (epoch-seconds)\n", 5), 0);
                                                            if (gmtime_r(arg1, &var_2e8) != 0)
                                                            {
                                                                sub_405410(&var_2e8, nullptr, &var_2a8);
                                                                sub_404f90(dcgettext(nullptr, "final: %s (UTC)\n", 5), 0);
                                                            }
                                                            if (sub_40de20(r15_2, arg1, &var_1c8) != 0)
                                                            {
                                                                ...
                                                                sub_404f90(dcgettext(nullptr, "final: %s (UTC%s)\n", 5), 0);
                                                            }
                                                        }
                                                    }
                                                }
                            ...
                            label_409085:
                                ...
                                if (r13_6 == r13_6)
                                {
                                    ...
                                    if (rax_133 != -1)
                                    {
                                        ...
                                        sub_404f90(dcgettext(nullptr, "    new date/time = '%s'\n", 5), 0);
                                ...
                                label_4091b9:
                                    ...
                                    rbx_1 = 0;
                                    sub_404f90(dcgettext(nullptr, "error: %s:%d\n", 5), 0);
                                }
                            }
                        }
                    }
                ...
                else
                {
                    if (rbx_1 != 0)
                    {
                        sub_404f90(dcgettext(nullptr, "error: out-of-range year %ld\n", 5), 0);
                    }
                    rcx_2 = var_7f_2;
                }
