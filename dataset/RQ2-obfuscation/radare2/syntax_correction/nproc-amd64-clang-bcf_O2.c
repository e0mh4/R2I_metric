...
void quotearg_n (int64_t arg_4h, int64_t arg_8h, int64_t arg_28h, int64_t arg_30h, int64_t arg1, int64_t arg2) {
    ...
    rdx = 0xffffffffffffffff;
    ecx = default_quoting_options;
invalid_funccall(); //    return void (*0x404d10)() ();
}
/* r2dec pseudo code output */
/* nostrip @ 0x404d10 */
#include <stdint.h>
...
int64_t dbg_quotearg_style (char const * arg, int64_t arg1, enum quoting_style s) {
    ...
    esi = ecx;
    rdx = rax;
invalid_funccall(); //    return void (*0x404fa0)() ();
}
/* r2dec pseudo code output */
/* nostrip @ 0x405150 */
#include <stdint.h>
...
int32_t quotearg_char (int64_t arg1, int64_t arg2) {
    ...
    edx = eax;
invalid_funccall(); //    return void (*0x4051c0)() ();
}
/* r2dec pseudo code output */
/* nostrip @ 0x405300 */
#include <stdint.h>
...
invalid_funccall(); //    void (*0x405de0)() ();
INVALID_JUMP;
}
/* r2dec pseudo code output */
/* nostrip @ 0x406410 */
...
label_5:
        *(rsi) = rcx;
        r8 *= rcx;
        rsi = r8;
invalid_funccall(); //        void (*0x406820)() ();
label_4:
        xalloc_die ();
    }
    return xalloc_die ();
...
label_1:
    rdi = rbx;
invalid_funccall(); //    void (*0x402200)() ();
    do {
label_0:
        fflush (rbx);
label_4:
