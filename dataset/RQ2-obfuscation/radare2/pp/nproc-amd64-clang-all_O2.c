...
void quotearg_n_mem (int64_t arg1, int64_t arg2, int64_t arg3) {
    ...
    rdx = arg3;
    ecx = default_quoting_options;
invalid_funccall(); //    return void (*0x411660)() ();
}
/* r2dec pseudo code output */
/* nostrip @ 0x411f00 */
#include <stdint.h>
...
void dbg_quotearg_colon_mem (char const * arg, size_t argsize) {
    ...
    edx = 0x3a;
invalid_funccall(); //    return void (*0x412a30)() ();
}
/* r2dec pseudo code output */
/* nostrip @ 0x4131f0 */
#include <stdint.h>
...
invalid_funccall(); //    return void (*0x4133b0)() ();
}
/* r2dec pseudo code output */
/* nostrip @ 0x4133b0 */
#include <stdint.h>
...
label_0:
        rcx *= rsi;
        rsi = rcx;
invalid_funccall(); //        void (*0x417300)() ();
    }
    xalloc_die ();
}
/* r2dec pseudo code output */
...
void dbg_x2realloc (int64_t arg_5h, int64_t arg_6h, int64_t arg_7h, int64_t arg_8h, int64_t arg5, void * p, size_t * pn) {
    ...
    edx = 1;
invalid_funccall(); //    return void (*0x417540)() ();
}
/* r2dec pseudo code output */
/* nostrip @ 0x417ac0 */
#include <stdint.h>
