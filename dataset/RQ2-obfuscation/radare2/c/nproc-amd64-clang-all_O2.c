...
uint64_t dbg_emit_ancillary_info (char const * lc_messages, infomap const * map_prog, char const * node) {
    char * s2;
    uint32_t var_10h;
    char * s1;
    int64_t var_20h;
...
label_5:
    ...
    goto label_3;
label_6:
    eax = strncmp (*((rsp + 0x18)), 0x41e2c5, 3);
    eax = 0xc943153f;
    if (eax != 0) {
        eax = ebp;
    }
...
uint64_t dbg_main (int32_t argc, char ** argv, int32_t c) {
    ...
    *((rsp + 0x30)) = rsi;
    ...
    setlocale (6, 0x41e6ea);
    bindtextdomain (0x41e1e6, "/home/yujeong/binary_gen/coreutils-8.31/tmp/_install/share/locale");
    textdomain (0x41e1e6, rsi);
    edi = close_stdout;
    eax = atexit ();
    *((rsp + 0x1c)) = 2;
    *((rsp + 0x14)) = eax;
...
int64_t dbg_num_processors (int64_t arg1, long unsigned int nprocs_current) {
    long int nprocs;
    int64_t var_5h;
    int64_t var_6h;
    int64_t var_7h;
...
label_38:
    ...
    rax = num_processors_via_affinity_mask ();
    *((rsp + 0x50)) = rax;
    rsp + 9 = (*((rsp + 0x50)) != 0) ? 1 : 0;
    eax = x.4;
    ecx = y.5;
    edx = eax;
    edx = -edx;
...
int64_t dbg_parse_omp_threads (uint32_t arg1, int64_t arg5, int32_t c, char const * threads, long unsigned int value) {
    int64_t var_80h;
    long var_78h;
    int64_t var_70h;
    int64_t var_68h;
...
label_50:
    ...
    *(rax) = 0;
    ebx = r8d;
    rax = strtoul (*((rbp - 0x48)), *((rbp - 0x38)), 0xa);
    r8d = ebx;
    *((rbp - 0x78)) = rax;
    rax = *((rbp - 0x38));
    rbp - 0x2d = (*(rax) != 0) ? 1 : 0;
...
int64_t dbg_num_processors_via_affinity_mask (long unsigned int count) {
    int64_t var_50h;
    uint32_t var_48h;
    int64_t var_40h;
    int64_t var_38h;
    ...
    int64_t var_28h;
    rax = count;
    /* long unsigned int num_processors_via_affinity_mask(); */
    eax = x.6;
    ecx = y.7;
    edx = rax - 1;
    edx *= eax;
...
label_346:
    ...
    rax = gettext_quote (0x41e55b, *((rsp + 0x78)));
    *((rsp + 0x450)) = rax;
    rax = gettext_quote (0x41e55d, *((rsp + 0x78)));
    *((rsp + 0x440)) = rax;
    ebx = 0xf01d5f68;
    goto label_0;
label_348:
...
uint64_t dbg_quotearg_n_style_mem (char const * arg, int64_t arg1, int64_t arg2, int64_t arg3, int64_t arg4, size_t argsize, int32_t n, quoting_options const o, quoting_style s) {
    int64_t var_38h;
    int64_t var_2ah;
    int64_t var_29h;
    int64_t var_28h;
...
label_6:
    ...
    rdx = .comment;
    *((rcx - 0x10)) = rdx;
    __asm ("movups xmm0, xmmword [0x004212b0]");
    __asm ("movups xmmword [rcx - 0x20], xmm0");
    __asm ("movups xmm0, xmmword [0x004212a0]");
...
label_6:
    rax = locale_charset ();
    *((rsp + 0x10)) = rax;
    eax = strcaseeq0 (*((rsp + 0x10)), 0x41e55f, 0x55, 0x54, 0x46, 0x2d);
    eax = 0xd7a6aebc;
    ecx = 0x2c217786;
    goto label_7;
label_8:
...
label_9:
    ...
    edx = 0;
    rax = r13;
    rax = *(rdx:rax) / rsp + 0x20;
    rdx = *(rdx:rax) % rsp + 0x20;
    al = (rax < *((rsp + 0x28))) ? 1 : 0;
    *((rsp + 0xb)) = al;
    eax = ebx;
    goto label_0;
...
int64_t dbg_xnumtoumax (int64_t arg1, int64_t arg3, uint32_t arg4, char * arg6, int32_t base, uintmax_t min, char const * n_str, char const * suffixes, uintmax_t tnum) {
    ...
    *((rsp + 0x18)) = rcx;
    rdx = *((rsp + 0x18));
    eax = xstrtoumax (rdi, 0, eax, rsp + 0x10, r8);
    *((rsp + 4)) = eax;
    r14d = 1;
    if (ebx != 0) {
        r14d = ebx;
...
int64_t dbg_xstrtoumax (int64_t arg1, uint32_t arg3, int64_t arg4, char * arg5, int64_t arg6, char ** restrict endptr, char ** p) {
    int64_t var_1h;
    int32_t var_8h;
    int32_t var_10h;
    int64_t var_1ch;
    ...
    *((rsp + 0xe0)) = rax;
    rax = *((rsp + 0xe0));
    __asm ("setns byte [rsp + 0x55]");
    *((rsp + 0x84)) = edx;
    rsp + 0x56 = (edx < 0x25) ? 1 : 0;
    if (rsi != 0) {
        r12 = rsi;
    }
    *((rsp + 0xb0)) = r8;
