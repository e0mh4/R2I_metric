...
uint64_t dbg_quotearg_style (char const * arg, quoting_style style) {
    uint32_t var_8h;
    int64_t var_ch;
    int64_t var_1ch;
    int64_t var_2ch;
...
uint64_t dbg_quotearg_style_mem (char const * arg, size_t argsize, quoting_style style) {
    uint32_t var_8h;
    int64_t var_ch;
    int64_t var_1ch;
    int64_t var_2ch;
...
uint64_t dbg_quotearg_n_style_colon (char const * arg, int64_t arg3, int32_t n, quoting_options * o, quoting_style style) {
    int64_t var_8h;
    int64_t var_10h;
    int64_t var_20h;
    int64_t var_30h;
...
uint64_t dbg_gettext_quote (int64_t arg1, uint32_t arg2, char const * locale_code, char const * msgid, quoting_style s) {
    int64_t var_8h;
    func main;
    rdi = arg1;
    rsi = arg2;
