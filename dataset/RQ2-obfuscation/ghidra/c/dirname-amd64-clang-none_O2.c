...
LAB_00402e20:
    ...
    uVar23 = 0;
    local_38 = uVar14;
    if (local_b8 == 0xffffffffffffffff) goto LAB_00402ec0;
LAB_00402eb0:
    uVar13 = buffersize;
    if (uVar23 != local_b8) {
LAB_00402ecb:
...
LAB_00402f13:
        ...
        if (local_b8 < uVar23 + local_a8) goto LAB_00402f13;
        iVar8 = memcmp(arg + uVar23,local_a0,local_a8);
        bVar25 = iVar8 == 0;
        if ((bVar25) && ((uVar14 & 1) != 0)) goto LAB_004038ca;
      }
      ...
      case 0:
        ...
        if ((uVar14 & 1) == 0) {
          ...
          if (((quoting_style == shell_always_quoting_style) || (local_b8 <= uVar23 + 1)) ||
             (9 < (byte)(arg[uVar23 + 1] - 0x30U))) goto LAB_00403606;
        ...
        if (local_40 == 1) {
          ...
          do {
            ...
            if (sVar10 == 0xfffffffffffffffe) {
              if (uVar11 < local_b8) goto LAB_004037b5;
              bVar20 = 0;
              break;
            }
...
LAB_004038bb:
        ...
        break;
      case 0x20:
        goto switchD_00402f2f_caseD_20;
      case 0x21:
      case 0x22:
      case 0x24:
      case 0x26:
      ...
      case 0x60:
      case 0x7c:
        goto switchD_00402f2f_caseD_21;
      case 0x23:
      case 0x7e:
        if (uVar23 != 0) goto LAB_00403604;
switchD_00402f2f_caseD_20:
        bVar20 = 1;
switchD_00402f2f_caseD_21:
        if (bVar24 && !bVar5) goto LAB_004038bb;
        bVar7 = false;
        goto joined_r0x00403184;
      case 0x25:
      case 0x2b:
      ...
      case 0x79:
      case 0x7a:
        goto switchD_00402f2f_caseD_25;
      case 0x27:
        uVar17 = 0x27;
        local_48 = 1;
        uVar23 = buffersize;
...
LAB_00403604:
        ...
        bVar20 = arg[uVar1];
        bVar7 = false;
        if (0x3e < (uint)(int)(char)bVar20) goto LAB_00403606;
        ...
        bVar20 = 0;
        goto joined_r0x004035f9;
      case 0x5c:
        if (quoting_style == shell_always_quoting_style) {
          if ((uVar14 & 1) != 0) goto LAB_004038bb;
        }
        else {
          bVar6 = 0x5c;
          if ((bVar18 & bVar3 & local_a8 != 0) == 0) goto switchD_00402f2f_caseD_a;
        }
        bVar7 = false;
        bVar12 = 0x5c;
        bVar20 = 0;
        bVar6 = 0x5c;
        bVar19 = 0;
        if (bVar16) goto LAB_004032f2;
        goto LAB_0040331e;
      case 0x7b:
      case 0x7d:
        bVar7 = false;
        if (local_b8 == 0xffffffffffffffff) {
          if ((uVar23 == 0) && (arg[1] == '\0')) goto switchD_00402f2f_caseD_20;
          local_b8 = 0xffffffffffffffff;
          bVar7 = false;
        }
        else if ((uVar23 == 0) && (local_b8 == 1)) goto switchD_00402f2f_caseD_20;
LAB_00403606:
        uVar22 = uVar13;
        bVar20 = 0;
        goto joined_r0x00403184;
      ...
      bVar20 = 0;
      if (bVar18 == false) {
switchD_00402f2f_caseD_25:
        bVar7 = false;
        bVar20 = bVar19;
        goto joined_r0x00403184;
      }
      goto joined_r0x00403338;
    }
LAB_004037fc:
    local_b8 = uVar23;
    if (((uVar14 & 1) != 0) &&
  ...
  if ((1 < uVar13) || (bVar6 == 0)) {
    ...
    while ((uVar14 & 1) == 0) {
      ...
      while( true ) {
        bVar12 = (byte)uVar17;
        uVar23 = uVar11 + 1;
        if (uVar13 <= uVar23) goto LAB_004032ec;
        if ((bVar16) && (!bVar7)) {
          if (uVar22 < local_50) {
            buffer[uVar22] = '\'';
          }
...
joined_r0x00403184:
  ...
  uVar23 = uVar11;
  if ((bVar5 & bVar18) == 0) {
    if ((quote_these_too != (uint *)0x0 & bVar3 & 1) != 0) goto LAB_004032a7;
LAB_004032e0:
    if (!bVar25) goto LAB_004032ec;
joined_r0x00403338:
    if ((uVar14 & 1) != 0) goto LAB_004038ca;
    if ((quoting_style == shell_always_quoting_style) && (!bVar16)) {
      if (uVar22 < buffersize) {
        buffer[uVar22] = '\'';
      }
    ...
    uVar22 = uVar22 + 1;
    if (buffersize <= uVar22) goto LAB_00403402;
  }
  else {
    if (quote_these_too == (uint *)0x0) goto LAB_004032e0;
LAB_004032a7:
...
LAB_0040340e:
  uVar23 = uVar23 + 1;
  if (local_b8 != 0xffffffffffffffff) goto LAB_00402eb0;
LAB_00402ec0:
  if (arg[uVar23] == '\0') {
...

{
  ...
  if (p == (void *)0x0) {
    ...
    if ((long)__size < 0) goto LAB_00404daa;
    *pn = __size;
  }
  else {
