...

{
  ...
  while( true ) {
    *(undefined *)(puVar5 + -0x4018) = 0x401410;
    uVar2 = gzread(in,puVar5 + -0x4000,0x4000);
    if ((int)uVar2 < 0) {
      *(undefined *)(puVar5 + -0x4018) = 0x4014bc;
      msg = (char *)gzerror(in,puVar5 + -0x4010);
                    /* WARNING: Subroutine does not return */
      *(undefined *)(puVar5 + -0x4018) = 0x4014c4;
      error(msg);
    }
    ...
    if (uVar2 == 0) break;
    *(undefined *)(puVar5 + -0x4018) = 0x40144e;
    sVar4 = fwrite(puVar5 + -0x4000,1,(ulong)uVar2,(FILE *)out);
    if ((uint)sVar4 != uVar2) {
                    /* WARNING: Subroutine does not return */
      *(undefined *)(puVar5 + -0x4018) = 0x40145d;
      error("failed fwrite");
    }
  }
  *(undefined *)(puVar5 + -0x4018) = 0x40146a;
  iVar3 = fclose((FILE *)out);
  if (iVar3 != 0) {
                    /* WARNING: Subroutine does not return */
    *(undefined *)(puVar5 + -0x4018) = 0x4014ce;
    error("failed fclose");
  }
  *(undefined *)(puVar5 + -0x4018) = 0x401476;
  iVar3 = gzclose(in);
  if (iVar3 != 0) {
                    /* WARNING: Subroutine does not return */
    *(undefined *)(puVar5 + -0x4018) = 0x4014d8;
    error("failed gzclose");
  }
  if ((9 < y_25) && (((x_24 + -1) * x_24 & 1U) != 0)) {
    do {
...

{
  ...
  gzFile pgVar5;
  FILE *in;
  undefined in_register_0000003c;
  char *__s;
  char *pcVar6;
  char *__s_00;
  char *__s1;
  ...
  while( true ) {
    __s_00 = __s + -0x20;
    local_40 = 0;
    *(undefined *)(__s + -0x28) = 0x40182c;
    snprintf(__s_00,0x14,"%s",&DAT_00402078);
    prog = *argv;
    pcVar6 = *argv;
    *(undefined *)(__s + -0x28) = 0x401846;
...
LAB_0040186a:
    __s = __s_00 + -0x20;
    *(undefined *)(__s_00 + -0x28) = 0x40188a;
  ...
  *(undefined *)(__s + -0x28) = 0x4018b4;
  iVar2 = strcmp(__s1,"gunzip");
  if (iVar2 == 0) {
    local_3c = 1;
  }
  else {
    *(undefined *)(__s + -0x28) = 0x4018c5;
  ...
  if (1 < (int)local_38) {
    ...
    do {
      while( true ) {
        ...
        ppcVar7 = ppcVar1;
        pcVar6 = *ppcVar7;
        *(undefined *)(__s + -0x28) = 0x401914;
        iVar2 = strcmp(pcVar6,"-c");
        if (iVar2 == 0) break;
        *(undefined *)(__s + -0x28) = 0x401929;
        ...
        if (iVar2 == 0) {
          ...
          *(undefined *)(__s + -0x28) = 0x40193e;
          iVar2 = strcmp(pcVar6,"-f");
          if (iVar2 == 0) {
            local_38[3] = 'f';
          }
          else {
            *(undefined *)(__s + -0x28) = 0x40194f;
            iVar2 = strcmp(pcVar6,"-h");
            if (iVar2 == 0) {
              local_38[3] = 'h';
            }
            else {
              *(undefined *)(__s + -0x28) = 0x401960;
...
LAB_00401a56:
  ...
  if (iVar2 == 0) {
    if (local_3c == 0) {
      while( true ) {
        *(undefined *)(__s + -0x28) = 0x401d82;
        iVar2 = fileno(stdout);
        *(undefined *)(__s + -0x28) = 0x401d8c;
        pgVar5 = (gzFile)gzdopen(iVar2,__s_00);
        if ((y_31 < 10) || (((x_30 - 1) * x_30 & 1) == 0)) break;
        *(undefined *)(__s + -0x28) = 0x401d6c;
        iVar2 = fileno(stdout);
        *(undefined *)(__s + -0x28) = 0x401d76;
        gzdopen(iVar2,__s_00);
      }
      if (pgVar5 == (gzFile)0x0) {
                    /* WARNING: Subroutine does not return */
        *(undefined *)(__s + -0x28) = 0x401db8;
        error("can\'t gzdopen stdout");
      }
      while( true ) {
        *(undefined *)(__s + -0x28) = 0x401dde;
        gz_compress((FILE *)stdin,pgVar5);
        if ((y_31 < 10) || (((x_30 - 1) * x_30 & 1) == 0)) break;
        *(undefined *)(__s + -0x28) = 0x401dcf;
        gz_compress((FILE *)stdin,pgVar5);
      }
    }
    else {
      while( true ) {
        *(undefined *)(__s + -0x28) = 0x401d14;
        iVar2 = fileno(stdin);
        *(undefined *)(__s + -0x28) = 0x401d20;
        pgVar5 = (gzFile)gzdopen(iVar2,&DAT_0040205d);
        if ((y_31 < 10) || (((x_30 - 1) * x_30 & 1) == 0)) break;
        *(undefined *)(__s + -0x28) = 0x401cfc;
        iVar2 = fileno(stdin);
        *(undefined *)(__s + -0x28) = 0x401d08;
    ...
    do {
      ...
      if (local_3c == 0) {
        ...
        if (local_40 == 0) {
          while( true ) {
            *(undefined *)(__s + -0x28) = 0x401b66;
            file_compress(pcVar6,__s_00);
            if ((y_31 < 10) || (((x_30 - 1) * x_30 & 1) == 0)) break;
            pcVar6 = *ppcVar7;
            *(undefined *)(__s + -0x28) = 0x401b5b;
            file_compress(pcVar6,__s_00);
            pcVar6 = *ppcVar7;
          }
        }
        else {
          *(undefined *)(__s + -0x28) = 0x401af9;
          in = fopen(pcVar6,"rb");
          if (in == (FILE *)0x0) {
            ...
            do {
              pcVar6 = *ppcVar7;
              *(undefined *)(__s + -0x28) = 0x401bf0;
              perror(pcVar6);
LAB_00401bf0:
              pcVar6 = *ppcVar7;
              *(undefined *)(__s + -0x28) = 0x401bf8;
              perror(pcVar6);
            } while ((9 < y_31) && (((x_30 - 1) * x_30 & 1) != 0));
          }
          else {
            *(undefined *)(__s + -0x28) = 0x401b11;
            iVar3 = fileno(stdout);
            *(undefined *)(__s + -0x28) = 0x401b1b;
            pgVar5 = (gzFile)gzdopen(iVar3,__s_00);
            if (pgVar5 == (gzFile)0x0) {
                    /* WARNING: Subroutine does not return */
              *(undefined *)(__s + -0x28) = 0x401e13;
              error("can\'t gzdopen stdout");
            }
            if ((9 < y_31) && (((x_30 - 1) * x_30 & 1) != 0)) goto LAB_00401c75;
            while( true ) {
              *(undefined *)(__s + -0x28) = 0x401c5b;
              gz_compress((FILE *)in,pgVar5);
              if ((y_31 < 10) || (((x_30 - 1) * x_30 & 1) == 0)) break;
LAB_00401c75:
              *(undefined *)(__s + -0x28) = 0x401c80;
              gz_compress((FILE *)in,pgVar5);
            }
          }
        }
        ...
        if (local_40 == 0) {
          ...
          while( true ) {
            *(undefined *)(__s + -0x28) = 0x401c28;
            file_uncompress(pcVar6);
            if ((y_31 < 10) || (((x_30 - 1) * x_30 & 1) == 0)) break;
LAB_00401c42:
            *(undefined *)(__s + -0x28) = 0x401c4a;
            file_uncompress(pcVar6);
          }
        }
        else {
          *(undefined *)(__s + -0x28) = 0x401ab0;
          pgVar5 = (gzFile)gzopen(pcVar6,&DAT_0040205d);
          if (pgVar5 == (gzFile)0x0) {
            pcVar6 = *ppcVar7;
            *(undefined *)(__s + -0x28) = 0x401bc9;
            fprintf(stderr,"%s: can\'t gzopen %s\n",prog,pcVar6);
          }
          else {
            *(undefined *)(__s + -0x28) = 0x401ac8;
            gz_uncompress(pgVar5,(FILE *)stdout);
          }
        }
      }
