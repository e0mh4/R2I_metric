...

{
  ...
  if (iVar10 == 0x595ec9d4) {
                    /* WARNING: Subroutine does not return */
    *(undefined *)(pauVar13[-1] + 8) = 0x410e17;
    abort();
  }
LAB_00410e10:
  do {
  ...
  while( true ) {
    while (0x6c2178a8 < uVar1) {
      if (uVar1 == 0x6c2178a9) {
        ...
        *(undefined *)((long)(pqVar4 + 0xfffffffffffffffe) + 0x28) = 0x410e85;
        quoting_options_from_style(pqVar3,s);
        *(undefined *)((long)(pqVar4 + 0xfffffffffffffffe) + 0x28) = 0x410e96;
    ...
    pqVar3 = (quoting_options *)((long)(pqVar4 + 0xfffffffffffffffe) + 0x30);
    *(undefined *)((long)(pqVar4 + 0xfffffffffffffffe) + 0x28) = 0x410ee0;
    quoting_options_from_style(pqVar3,s);
    *(undefined *)((long)(pqVar4 + 0xfffffffffffffffe) + 0x28) = 0x410ef1;
      ...
      *(uint *)((long)(pqVar5 + 0xffffffffffffffff) + uVar7 * 4) = ~uVar3 & uVar6 | ~uVar6 & uVar3;
      ...
      do {
        if (iVar1 != -0x35521630) {
          ...
          *(undefined *)((long)(pqVar5 + 0xfffffffffffffffe) + 0x28) = 0x4116e5;
      ...
      *(uint *)((long)(pqVar5 + 0xffffffffffffffff) + uVar7 * 4) =
      ...
      do {
        if (iVar2 != -0x35521630) {
          ...
          *(undefined *)((long)(pqVar5 + 0xfffffffffffffffe) + 0x28) = 0x411655;
            ...
            while (iVar9 = iVar3, -0x1e99fb9f < iVar9) {
              if (iVar9 < 0x583a6c17) {
                ...
                if (iVar9 != -0x1e99fb9e) {
                  if (iVar9 == -0x186b41da) {
                    /* WARNING: Subroutine does not return */
                    *(undefined *)((long)(pqVar8 + 0xfffffffffffffffe) + 0x28) = 0x4120e7;
                    abort();
                  }
                  goto LAB_004120b0;
                }
...
LAB_004120b0:
        ...
        *(undefined *)((long)(pqVar8 + 0xfffffffffffffffe) + 0x28) = 0x411e58;
        ...
        while (iVar9 = iVar3, -0x1e99fb9f < iVar9) {
          if (iVar9 < 0x583a6c17) {
            ...
            if (iVar9 != -0x1e99fb9e) {
              if (iVar9 == -0x186b41da) {
                    /* WARNING: Subroutine does not return */
                *(undefined *)((long)(pqVar8 + 0xfffffffffffffffe) + 0x28) = 0x4120ec;
                abort();
              }
              goto LAB_004120c0;
            }
...
LAB_004120c0:
    ...
    local_40->left_quote = left_quote;
    local_40->right_quote = right_quote;
    *(undefined *)((long)(pqVar8 + 0xfffffffffffffffe) + 0x28) = 0x412068;
  ...
  while (uVar2 == 0xbd262645) {
    ...
    while (p_Var4 = authors, 0x57e6ba73 < uVar2) {
      while (uVar2 == 0x57e6ba74) {
        ...
        *(undefined *)((long)(p_Var4 + 0xfffffffffffffffe) + 8) = 0x415235;
      ...
      *(undefined *)((long)(p_Var4 + 0xfffffffffffffffe) + 0x14) = 0x30;
      *(undefined *)((long)(p_Var4 + 0xfffffffffffffffe) + 0x10) = 0x20;
      *(undefined *)((long)(p_Var4 + 0xfffffffffffffffe) + 8) = 0x4152bf;
...
LAB_00416d60:
  do {
    if (0x6d351bb0 < (int)uVar3) {
      ...
      if (uVar3 == 0x7a71230b) {
        *(undefined *)((long)ppmVar5 + -8) = 0x416e9c;
        _Var2 = hard_locale(0);
        uVar3 = 0x1e251a2d;
        goto LAB_00416bb4;
      }
...
joined_r0x00416e8a:
        ...
        local_40 = unaff_R12;
        *(undefined *)((long)ppmVar5 + -8) = 0x416d24;
