...
LAB_00401a0b:
  ...
  if (iVar1 < 0x28c977d1) {
    if (iVar1 < -0xaad16a8) {
      ...
      if (iVar1 == -0xaad16a8) {
        *(undefined *)(pcVar7 + -8) = 0x401c6d;
        gz_compress((FILE *)in,(gzFile)pFVar4);
        *(undefined *)(pcVar7 + -8) = 0x401c75;
        unlink(file);
        return;
      }
      if (iVar1 == 0xb95ce04) {
        *(undefined *)(pcVar7 + -8) = 0x401cb4;
        fprintf(stderr,"%s: filename too long\n",prog);
                    /* WARNING: Subroutine does not return */
        *(undefined *)(pcVar7 + -8) = 0x401cbe;
        exit(1);
      }
      if (iVar1 == 0xc2c14e4) {
        *(undefined *)(pcVar7 + -8) = 0x401cdc;
        fprintf(stderr,"%s: can\'t gzopen %s\n",prog,pcVar2);
                    /* WARNING: Subroutine does not return */
        *(undefined *)(pcVar7 + -8) = 0x401ce6;
        exit(1);
      }
    }
  }
    ...
    if (iVar1 == 0x28c977d1) {
LAB_00401c88:
      *(undefined *)(pcVar7 + -8) = 0x401c90;
      perror(file);
                    /* WARNING: Subroutine does not return */
      *(undefined *)(pcVar7 + -8) = 0x401c9a;
      exit(1);
    }
  }
    ...
    do {
      if (iVar1 < -0x2f009a53) {
        ...
        *(undefined *)(pcVar7 + -8) = 0x401c3a;
        ...
        local_40 = local_48;
        *(undefined *)(pcVar7 + -8) = 0x401c0c;
        snprintf(local_48,0x400,"%s%s",file,&DAT_00404059);
        *(undefined *)(pcVar7 + -8) = 0x401c19;
...
code_r0x00401b36:
  if (iVar1 == -0x4db6932a) {
    ...
    local_48 = pcVar2;
    local_50 = pcVar2;
    *(undefined *)(pcVar7 + -0x408) = 0x401b65;
    sVar3 = strlen(file);
