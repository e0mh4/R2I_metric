...
LABEL_30:
      ...
      case 9u:
        v23 = v13;
        left_quote = (char *)gettext_quote((const char *)&asc_407974[1], (enum_quoting_style)quoting_style);
        v20 = quoting_style;
        v24 = gettext_quote((const char *)&asc_407974[2], (enum_quoting_style)quoting_style);
        LOBYTE(v13) = v23;
        v21 = buffer;
        right_quote = v24;
        goto LABEL_16;
