...
void __fastcall __noreturn usage(int status)
{
  ...
  int v18; // ecx
  char *v19; // rax
  char **v20; // [rsp+8h] [rbp-60h]
  char *s2; // [rsp+18h] [rbp-50h]
  const char *v22; // [rsp+20h] [rbp-48h]
  const char *s1; // [rsp+28h] [rbp-40h]
  const char *v24; // [rsp+30h] [rbp-38h]
...
LABEL_4:
      ...
      {
        v7 = stderr;
        v8 = dcgettext(0LL, "Try '%s --help' for more information.\n", 5);
        __fprintf_chk(v7, 1LL, v8, program_name);
        v4 = -19511498;
      }
      exit(status);
    }
  }
  v9 = dcgettext(0LL, "Usage: %s [OPTION]...\n", 5);
  __printf_chk(1LL, v9, program_name);
  v10 = dcgettext(
          0LL,
  ...
  v14 = 1554965153;
  v15 = emit_ancillary_info_infomap;
  do
  {
LABEL_11:
    while ( v14 > 1241435898 )
    {
      if ( v14 == 1241435899 )
      {
        v1 = strcmp("nproc", s2) != 0;
        v14 = -77785789;
      }
      else if ( v14 == 1714468946 )
      {
        v15 = v20 + 2;
        v14 = 1554965153;
      }
...
LABEL_24:
    while ( v14 <= -1199381307 )
    {
      ...
      {
        v16 = dcgettext(0LL, "Report any translation bugs to <https://translationproject.org/team/>\n", 5);
    ...
    else
    {
      if ( v14 != -1168176102 )
      {
        ...
        __printf_chk(1LL, v6, v24);
        v4 = -19511498;
        goto LABEL_4;
      }
      v24 = v2;
      v19 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
      __printf_chk(1LL, v19, "GNU coreutils");
      s1 = setlocale(5, 0LL);
      v17 = s1 == 0LL;
      v14 = -340432739;
      v18 = -1199381306;
...
int __cdecl main(int argc, const char **argv, const char **envp)
{
  ...
  int v20; // [rsp+10h] [rbp-68h]
  int v21; // [rsp+18h] [rbp-60h]
  nproc_query query; // [rsp+1Ch] [rbp-5Ch]
  unsigned __int64 v23; // [rsp+20h] [rbp-58h]
  uintmax_t v24; // [rsp+30h] [rbp-48h]
  unsigned __int64 v25; // [rsp+38h] [rbp-40h]
  uintmax_t v26; // [rsp+40h] [rbp-38h]
...
LABEL_34:
    while ( v9 > -940267334 )
    {
      ...
      else
      {
        ...
        v4 = xdectoumax(v14, 0LL, 0xFFFFFFFFFFFFFFFFLL, "", v15, 0);
        v9 = -1347986059;
        v5 = v21;
      }
    }
    ...
    else
    {
      v21 = v20;
      v26 = v24;
      v19 = getopt_long(argc, (char *const *)argv, "", longopts, 0LL);
      v10 = v19 == -1;
      v9 = 1755028457;
      v11 = 1555610146;
    }
...
unsigned __int64 __fastcall num_processors(nproc_query query)
{
  ...
  int j; // eax
  int i; // eax
  __int64 v20; // [rsp+8h] [rbp-150h]
  nproc_query v21; // [rsp+14h] [rbp-144h]
  nproc_query v22; // [rsp+18h] [rbp-140h]
  int v23; // [rsp+1Ch] [rbp-13Ch]
  int v24; // [rsp+20h] [rbp-138h]
  int v25; // [rsp+24h] [rbp-134h]
  int v26; // [rsp+28h] [rbp-130h]
  int v27; // [rsp+2Ch] [rbp-12Ch]
  int v28; // [rsp+2Ch] [rbp-12Ch]
  __int64 v29; // [rsp+40h] [rbp-118h]
  unsigned __int64 v30; // [rsp+48h] [rbp-110h]
  __int64 v31; // [rsp+50h] [rbp-108h]
  __int64 v32; // [rsp+58h] [rbp-100h]
  unsigned __int64 v33; // [rsp+60h] [rbp-F8h]
  unsigned __int64 v34; // [rsp+68h] [rbp-F0h]
  unsigned __int64 v35; // [rsp+70h] [rbp-E8h]
  __int64 v36; // [rsp+78h] [rbp-E0h]
  int v37; // [rsp+80h] [rbp-D8h]
  int v38; // [rsp+84h] [rbp-D4h]
  __int64 v39; // [rsp+88h] [rbp-D0h]
  __int64 v40; // [rsp+90h] [rbp-C8h]
  unsigned __int64 v41; // [rsp+98h] [rbp-C0h]
  unsigned __int64 v42; // [rsp+A0h] [rbp-B8h]
  cpu_set_t cpuset; // [rsp+A8h] [rbp-B0h] BYREF
...
LABEL_78:
              while ( v14 > -930535250 )
              {
                if ( v14 <= -577401033 )
                {
                  ...
                  v28 = sched_getaffinity(0, 0x80uLL, &cpuset);
                  for ( i = 1761294537; ; i = 230103778 )
                  {
LABEL_103:
                    while ( i <= 476916587 )
                    {
...
LABEL_114:
                      ...
                      if ( i == -2051226055 )
                        break;
                      v20 = __sched_cpucount(0x80uLL, &cpuset);
                      i = -321861509;
                      if ( v20 )
                        i = 476916588;
                      if ( i > 5824783 )
...
LABEL_83:
                  ...
                  else
                  {
                    ...
                    v42 = v6;
                    v16 = v1;
                    v27 = sched_getaffinity(0, 0x80uLL, &cpuset);
                    for ( j = 1761294537; ; j = 230103778 )
                    {
LABEL_47:
                      while ( j <= 476916587 )
                      {
...
LABEL_92:
          ...
          v11 = getenv("OMP_NUM_THREADS");
          v33 = parse_omp_threads(v11);
          v12 = getenv("OMP_THREAD_LIMIT");
          v13 = parse_omp_threads(v12);
          v34 = v13 | -(__int64)(v13 == 0);
          v9 = -948882601;
          v8 = 274780863LL;
          if ( v33 )
            v9 = 274780863;
...
unsigned __int64 __fastcall parse_omp_threads(const char *threads)
{
  ...
  char *v16; // [rsp+8h] [rbp-70h] BYREF
  int v17; // [rsp+14h] [rbp-64h]
  int v18; // [rsp+18h] [rbp-60h]
  int v19; // [rsp+1Ch] [rbp-5Ch]
...
LABEL_28:
          ...
          if ( v7 <= -1251807532 )
          {
            if ( v7 == -1754372814 )
            {
              v7 = 1271532743;
              LOBYTE(v5) = 0;
              if ( (unsigned int)(v18 - 9) <= 0x17 )
                v5 = (0x80001Fu >> (v18 - 9)) & 1;
            }
            else
            {
              v7 = -1024731523;
              LOBYTE(v4) = 0;
              if ( (unsigned int)(v17 - 9) <= 0x17 )
                v4 = (0x80001Fu >> (v17 - 9)) & 1;
            }
          }
          else
          {
        ...
        const char *right_quote)
{
  ...
  quoting_style v100; // [rsp+6Ch] [rbp-67Ch]
  quoting_style v101; // [rsp+70h] [rbp-678h]
  ...
  quoting_style v200; // [rsp+160h] [rbp-588h]
...
LABEL_14:
  for ( i = 2065516234; i <= 1408367346; i = 1408367347 )
  {
    if ( i == 732188971 )
    {
      v2 = (const char *)&unk_411569;
      if ( *msgid == 96 )
        v2 = (const char *)&unk_411565;
    }
    else
    {
      v2 = (const char *)&unk_411579;
      if ( *msgid == 96 )
        v2 = (const char *)&unk_411575;
    }
  }
  if ( i == 2065516234 )
  {
        ...
        int err_exit)
{
  ...
  int v16; // ecx
  const char *v17; // rax
  strtol_error_0 v19; // [rsp+0h] [rbp-68h]
  int v20; // [rsp+4h] [rbp-64h]
  uintmax_t val; // [rsp+8h] [rbp-60h] BYREF
  int status; // [rsp+14h] [rbp-54h]
  uintmax_t *p_val; // [rsp+18h] [rbp-50h]
  uintmax_t v24; // [rsp+20h] [rbp-48h]
  ...
  v25 = max;
  p_val = &val;
  v19 = xstrtoumax(n_str, 0LL, base, &val, suffixes);
  v10 = 1;
  if ( err_exit )
    v10 = err_exit;
  v11 = -84967153;
...
LABEL_6:
    while ( v11 <= 767114925 )
    {
      ...
      else
      {
        if ( v11 == 531306186 )
        {
          v12 = v19 == LONGINT_OVERFLOW;
          v11 = 726002652;
          v13 = 1918438973;
          goto LABEL_43;
        }
        v11 = 47413051;
        if ( v19 == LONGINT_INVALID_SUFFIX_CHAR_WITH_OVERFLOW )
          v11 = -52489877;
LABEL_25:
        v8 = v19;
        if ( v11 <= 47413050 )
        ...
        const char *valid_suffixes)
{
  ...
  int v121; // r15d
  int v122; // ebp
  strtol_error_0 v123; // r14d
  const unsigned __int16 **v124; // rax
  const unsigned __int16 *v125; // rax
  int v126; // eax
  int v127; // eax
  int v129; // [rsp+4h] [rbp-124h]
  int v130; // [rsp+8h] [rbp-120h]
  int v131; // [rsp+Ch] [rbp-11Ch]
  unsigned __int64 v132; // [rsp+18h] [rbp-110h]
  unsigned __int64 v133; // [rsp+18h] [rbp-110h]
  unsigned __int64 v134; // [rsp+18h] [rbp-110h]
  unsigned __int64 v135; // [rsp+18h] [rbp-110h]
  unsigned __int64 v136; // [rsp+18h] [rbp-110h]
  unsigned __int64 v137; // [rsp+18h] [rbp-110h]
  unsigned __int64 v138; // [rsp+18h] [rbp-110h]
  unsigned __int64 v139; // [rsp+18h] [rbp-110h]
  unsigned __int64 v140; // [rsp+18h] [rbp-110h]
  unsigned __int64 v141; // [rsp+18h] [rbp-110h]
  unsigned __int64 v142; // [rsp+18h] [rbp-110h]
  int v143; // [rsp+24h] [rbp-104h]
  int v144; // [rsp+34h] [rbp-F4h]
  int v145; // [rsp+38h] [rbp-F0h]
  bool v146; // [rsp+3Eh] [rbp-EAh]
  bool v147; // [rsp+3Fh] [rbp-E9h]
  unsigned __int64 v148; // [rsp+40h] [rbp-E8h] BYREF
  int v149; // [rsp+4Ch] [rbp-DCh]
  int v150; // [rsp+50h] [rbp-D8h]
  int v151; // [rsp+54h] [rbp-D4h]
  int v152; // [rsp+58h] [rbp-D0h]
  int v153; // [rsp+5Ch] [rbp-CCh]
  unsigned __int64 v154; // [rsp+60h] [rbp-C8h]
  char **endptr; // [rsp+68h] [rbp-C0h]
  int v156; // [rsp+74h] [rbp-B4h]
  int v157; // [rsp+78h] [rbp-B0h]
  int v158; // [rsp+7Ch] [rbp-ACh]
  int v159; // [rsp+80h] [rbp-A8h]
  int c; // [rsp+84h] [rbp-A4h]
  int v161; // [rsp+88h] [rbp-A0h]
  int v162; // [rsp+8Ch] [rbp-9Ch]
  uintmax_t *v163; // [rsp+90h] [rbp-98h]
  char *v164; // [rsp+98h] [rbp-90h]
  int v165; // [rsp+A0h] [rbp-88h]
  int v166; // [rsp+A4h] [rbp-84h]
  int v167; // [rsp+A8h] [rbp-80h]
  int v168; // [rsp+ACh] [rbp-7Ch]
  char *nptr; // [rsp+B0h] [rbp-78h]
  char *v170; // [rsp+B8h] [rbp-70h]
  __int64 *v171; // [rsp+C0h] [rbp-68h]
  int *v172; // [rsp+C8h] [rbp-60h]
  char *v173; // [rsp+D0h] [rbp-58h]
  char *v174; // [rsp+D8h] [rbp-50h]
  char **v175; // [rsp+E0h] [rbp-48h]
  char *v176; // [rsp+E8h] [rbp-40h]
  char v177[56]; // [rsp+F0h] [rbp-38h] BYREF
...
LABEL_10:
                    ...
                    v21 = 0xFFFFFFFFFFFFFFFFLL / v144;
                    v132 = v7;
                    v22 = -1196811075;
                    if ( 0xFFFFFFFFFFFFFFFFLL / v144 < v7 )
                      v22 = 142365120;
                    while ( 1 )
                    {
                      if ( v22 == -1196811075 )
              ...
              if ( v14 == 62784703 )
              {
                ...
                v5 = v118;
                v125 = *v124;
                v159 = (unsigned __int8)v118;
                v41 = (v125[(unsigned __int8)v118] & 0x2000) == 0;
                v14 = -1709184608;
                v42 = -547970381;
                goto LABEL_393;
              }
...
LABEL_397:
          ...
          {
            case -547970381:
              v5 = (unsigned __int8)v176[1];
              v10 = v176 + 1;
              v14 = 62784703;
              break;
            case -490201804:
              v14 = -2111234431;
              if ( (unsigned int)(v130 - 89) < 2 )
                v14 = 962410083;
              if ( v14 > 164015119 )
              {
                while ( 1 )
                            ...
                            else if ( v14 <= 1452128348 )
                            {
                              if ( v14 == 1379839118 )
                              {
                                ...
                                while ( 1 )
                                {
                                  ...
                                  v106 = 0xFFFFFFFFFFFFFFFFLL / v144;
                                  v139 = v7;
                                  v107 = -1196811075;
                                  if ( 0xFFFFFFFFFFFFFFFFLL / v144 < v7 )
                                    v107 = 142365120;
...
LABEL_277:
                              ...
                              v112 = 0xFFFFFFFFFFFFFFFFLL / v144;
                              v140 = v7;
                              v113 = -1196811075;
                              if ( 0xFFFFFFFFFFFFFFFFLL / v144 < v7 )
                                v113 = 142365120;
...
LABEL_432:
                          ...
                          else
                          {
                            ...
                            if ( v14 == 1820847575 )
                            {
                              ...
                              v63 = (int)v11;
                              v64 = v6;
                              v65 = __strtoul_internal(nptr, endptr, v167, 0);
                              v6 = v64;
                              LODWORD(v11) = v63;
                              v5 = v62;
                              v9 = v61;
                          ...
                          switch ( v14 )
                          {
                            case 356044884:
                              ...
                              while ( 1 )
                              {
                                ...
                                v100 = 0xFFFFFFFFFFFFFFFFLL / v144;
                                v138 = v7;
                                v101 = -1196811075;
                                if ( 0xFFFFFFFFFFFFFFFFLL / v144 < v7 )
                                  v101 = 142365120;
