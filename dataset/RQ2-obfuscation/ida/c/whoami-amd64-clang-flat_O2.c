...
LABEL_4:
    ...
    if ( i != -922046733 )
      break;
    v18 = stderr;
    v19 = dcgettext(0LL, "Try '%s --help' for more information.\n", 5);
    __fprintf_chk(v18, 1LL, v19, program_name);
  }
  v8 = dcgettext(0LL, "Usage: %s [OPTION]...\n", 5);
  __printf_chk(1LL, v8, program_name);
  v9 = dcgettext(0LL, "Print the user name associated with the current effective user ID.\nSame as id -un.\n\n", 5);
  ...
  v12 = 1559035229;
  v13 = emit_ancillary_info_infomap;
  while ( 1 )
  {
    do
    {
...
LABEL_8:
        ...
        if ( v12 == 1299734422 )
        {
          v14 = dcgettext(0LL, "Report any translation bugs to <https://translationproject.org/team/>\n", 5);
...
LABEL_25:
      while ( v12 > -1373824813 )
      {
        ...
        else
        {
          ...
          v24 = v1;
          v17 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
          __printf_chk(1LL, v17, "GNU coreutils");
          s1 = setlocale(5, 0LL);
          v15 = s1 == 0LL;
          v12 = -895948221;
          v16 = 1891757879;
...
{
  struct passwd *v3; // rbp
  const char **v4; // rbx
  int i; // eax
  char *v7; // rax
  char *v8; // rbp
  const char *v9; // rax
  __uid_t v10; // [rsp+Ch] [rbp-4Ch]
  int *v11; // [rsp+10h] [rbp-48h]
  int v12; // [rsp+1Ch] [rbp-3Ch]
  const char **p_pw_name; // [rsp+20h] [rbp-38h]
  ...
  v12 = optind;
LABEL_12:
  for ( i = 1351594511; i == 609734363; i = 678028478 )
    v3 = getpwuid(v10);
  if ( i == 678028478 )
  {
  ...
  if ( i != -1698332116 )
  {
    if ( i == -1494733251 )
    {
      v4 = (const char **)(unsigned int)*v11;
      v7 = dcgettext(0LL, "cannot find name for user ID %lu", 5);
      error(1, (int)v4, v7, v10);
    }
      ...
      while ( 1 )
      {
        ...
        else
        {
          ...
          if ( v9 != 48550767 )
          {
            if ( v9 == 298681386 )
            {
              v10 = getopt_long(argc, argv, "+", long_options, 0LL);
              i = 1290428841;
              if ( v10 != -1 )
                i = 1293516074;
            }
        ...
        ...)
{
  ...
  if ( scan_all )
    v8 = "";
  v10 = getopt_long(argc, argv, v8, long_options, 0LL);
  v9 = 725204254;
LABEL_20:
  while ( v9 <= 1289283933 )
  {
...
LABEL_14:
  for ( i = 2065516234; i <= 1408367346; i = 1408367347 )
  {
    if ( i == 732188971 )
    {
      v2 = (const char *)&unk_40E472;
      if ( *msgid == 96 )
        v2 = (const char *)&unk_40E46E;
    }
    else
    {
      v2 = (const char *)&unk_40E482;
      if ( *msgid == 96 )
        v2 = (const char *)&unk_40E47E;
    }
  }
  if ( i == 2065516234 )
  {
