        ...
        char *right_quote)
{
  ...
  enum_quoting_style v103; // [rsp+24h] [rbp-E4h]
...
LABEL_35:
  ...
  {
    v26 = v15;
    gettext_quote((const char *)&asc_409A34[1], (enum_quoting_style)quoting_style);
    gettext_quote((const char *)&asc_409A34[2], (enum_quoting_style)quoting_style);
    v15 = v26;
LABEL_36:
    v25 = v15;
    left_quote = (char *)gettext_quote((const char *)&asc_409A34[1], (enum_quoting_style)quoting_style);
    v19 = quoting_style;
    right_quote = (char *)gettext_quote((const char *)&asc_409A34[2], (enum_quoting_style)quoting_style);
    if ( y_32 < 10 )
      break;
    v20 = buffer;
    v21 = buffersize;
