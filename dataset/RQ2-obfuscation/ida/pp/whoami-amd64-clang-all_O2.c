...
void __fastcall __noreturn usage(int status)
{
  ...
  int v47; // edx
  char *v48; // rax
  char v49; // [rsp+Ah] [rbp-6Eh]
  char v50; // [rsp+Bh] [rbp-6Dh]
  bool v51; // [rsp+Ch] [rbp-6Ch]
  bool v52; // [rsp+Dh] [rbp-6Bh]
  bool v53; // [rsp+Eh] [rbp-6Ah]
  char v54; // [rsp+Fh] [rbp-69h]
  char **v55; // [rsp+10h] [rbp-68h]
  const char *v56; // [rsp+18h] [rbp-60h]
  char *s2; // [rsp+20h] [rbp-58h]
  const char *s1; // [rsp+28h] [rbp-50h]
  const char *v60; // [rsp+38h] [rbp-40h]
  char **v61; // [rsp+40h] [rbp-38h]
...
LABEL_21:
    while ( v4 != 1066379518 )
    {
      ...
      {
        v6 = stderr;
        v7 = dcgettext(0LL, "Try '%s --help' for more information.\n", 5);
        __fprintf_chk(v6, 1LL, v7, program_name);
        v4 = -374485414;
      }
      else
      {
...
LABEL_9:
    ...
    v10 = ~((_BYTE)x * ((_BYTE)x - 1)) | 0xFFFFFFFE;
    v11 = 1221657532;
    if ( (v10 == -1) != y < 10 )
      v11 = -2098162307;
    v4 = v11;
  ...
  v13 = dcgettext(0LL, "Usage: %s [OPTION]...\n", 5);
  __printf_chk(1LL, v13, program_name);
  v14 = dcgettext(0LL, "Print the user name associated with the current effective user ID.\nSame as id -un.\n\n", 5);
  ...
  v49 = ((x_28 * (x_28 - 1)) & ((x_28 * (x_28 - 1)) ^ 0xFFFFFFFE)) == 0;
  v50 = y_29 < 10;
  v17 = 1174775611;
  while ( 1 )
  {
LABEL_91:
    while ( v17 <= 1498296619 )
    {
      if ( v17 <= 473892526 )
      {
        if ( v17 > 332180831 )
        {
          if ( v17 == 332180832 )
          {
            v61 = v55 + 2;
            v26 = y_29;
            v27 = (x_28 * (x_28 - 1)) & ((x_28 * (x_28 - 1)) ^ 0xFFFFFFFE);
            v28 = (v27 == 0) == y_29 < 10;
            v29 = 413052754;
            v30 = -1728017755;
LABEL_145:
        ...
        else if ( v17 == 199717862 )
        {
          v48 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
          __printf_chk(1LL, v48, "GNU coreutils");
          setlocale(5, 0LL);
          v17 = 2030804775;
        }
        else
        {
          v56 = v1;
          v42 = y_29;
          v43 = ~((_BYTE)x_28 * ((_BYTE)x_28 - 1)) | 0xFFFFFFFE;
          v44 = (v43 == -1) == y_29 < 10;
          v45 = 199717862;
          v46 = 2030804775;
LABEL_106:
      ...
      else
      {
        if ( v17 <= 1174775610 )
        {
          ...
          v18 = ((x_28 * (x_28 - 1)) & ((x_28 * (x_28 - 1)) ^ 0xFFFFFFFE)) == 0;
          v17 = 1240518981;
          v19 = -1231863695;
        ...
        else
        {
          if ( v17 != 1240518981 )
          {
            v36 = (~((_BYTE)x_28 * ((_BYTE)x_28 - 1)) | 0xFFFFFFFE) == -1;
            v17 = -1754430122;
            v37 = 58570840;
    ...
    if ( v17 <= 2054228439 )
    {
      ...
      v41 = dcgettext(0LL, "\n%s online help: <%s>\n", 5);
      __printf_chk(1LL, v41, "GNU coreutils");
      s1 = setlocale(5, 0LL);
      v52 = s1 != 0LL;
      v42 = y_29;
      v43 = ~((_BYTE)x_28 * ((_BYTE)x_28 - 1)) | 0xFFFFFFFE;
...
LABEL_156:
              ...
              else
              {
                if ( v17 != -1849468127 )
                {
                  v18 = (~((_BYTE)x_28 * ((_BYTE)x_28 - 1)) | 0xFFFFFFFE) == -1;
                  v17 = -343066352;
                  v19 = -1772377012;
                  if ( (~((_BYTE)x_28 * ((_BYTE)x_28 - 1)) | 0xFFFFFFFE) == -1 )
                    v17 = -1772377012;
            ...
            else if ( v17 <= -1560629068 )
            {
              if ( v17 == -1754430122 )
              {
                v33 = dcgettext(0LL, "Report any translation bugs to <https://translationproject.org/team/>\n", 5);
...
LABEL_81:
          ...
          else
          {
            ...
            if ( v17 != -343066352 )
            {
              v23 = dcgettext(0LL, "Report any translation bugs to <https://translationproject.org/team/>\n", 5);
...
int __cdecl main(int argc, const char **argv, const char **envp)
{
  ...
  char *v12; // rbp
  const char *v13; // rax
  bool v14; // [rsp+3h] [rbp-55h]
  __uid_t v15; // [rsp+4h] [rbp-54h]
  int *v16; // [rsp+8h] [rbp-50h]
  int v17; // [rsp+14h] [rbp-44h]
  const char **p_pw_name; // [rsp+18h] [rbp-40h]
  struct passwd *v19; // [rsp+20h] [rbp-38h]
...
LABEL_35:
          while ( v4 <= -738899304 )
          {
            if ( v4 == -1215503589 )
            {
              p_pw_name = (const char **)&v3->pw_name;
              v5 = v3 == 0LL;
              v4 = 64676723;
              v6 = 605178484;
              goto LABEL_32;
        ...
        if ( v4 != -685276365 )
        {
          v7 = y_31;
          v8 = -1096431901;
          if ( (((x_30 * (x_30 - 1)) & ((x_30 * (x_30 - 1)) ^ 0xFFFFFFFE)) == 0) != y_31 < 10 )
            v8 = 323699029;
          v4 = v8;
        ...
        if ( y_31 >= 10 )
          v4 = 1881447635;
        if ( ((~((_BYTE)x_30 * ((_BYTE)x_30 - 1)) | 0xFFFFFFFE) == -1) != y_31 < 10 )
          v4 = -240466542;
      }
      else
      {
        ...
        ...)
{
  ...
  unsigned int v10; // edx
  int v11; // esi
  int v12; // [rsp+0h] [rbp-128h]
  int v13; // [rsp+4h] [rbp-124h]
...
LABEL_6:
    while ( v9 > 1215960599 )
    {
      if ( v9 <= 1850373065 )
      {
        ...
        v12 = getopt_long(argc, argv, "+", long_options, 0LL);
        v9 = -1500326712;
        if ( v12 != -1 )
          v9 = 2104601140;
        if ( v9 <= -452229546 )
        ...
        ...)
{
  ...
  if ( scan_all )
    v7 = "";
  v11 = getopt_long(argc, argv, v7, long_options, 0LL);
  v8 = -2123107817;
  do
  {
    while ( 1 )
...
LABEL_27:
      while ( v8 <= 895970561 )
      {
        ...
        else if ( v8 == 764417048 )
        {
          usage_func(exit_failure);
          v9 = ~((_BYTE)x_4 * ((_BYTE)x_4 - 1)) | 0xFFFFFFFE;
          v10 = 836407031;
          if ( (v9 == -1) != y_5 < 10 )
            v10 = -1022931500;
          v8 = v10;
    ...
    if ( y_5 >= 10 )
      v8 = 836407031;
    if ( ((~((_BYTE)x_4 * ((_BYTE)x_4 - 1)) | 0xFFFFFFFE) == -1) != y_5 < 10 )
      v8 = 764417048;
  }
  opterr = v12;
}
...
enum_quoting_style __fastcall get_quoting_style(const quoting_options *o)
{
  ...
  int v5; // edi
  int v6; // eax
  enum_quoting_style style; // [rsp+2h] [rbp-4h]
        ...
        char *right_quote)
{
  ...
  enum_quoting_style v220; // [rsp+78h] [rbp-6D0h]
  ...
  enum_quoting_style v368; // [rsp+1D8h] [rbp-570h]
...
quoting_options* __fastcall quoting_options_from_style(quoting_options *retstr, enum_quoting_style style)
{
  int i; // ecx
  int v3; // eax
  __int64 *v4; // rax
...
LABEL_15:
  ...
  while ( v0 == -1993966580 )
  {
    v1 = nl_langinfo(14);
    if ( !v1 )
      v1 = (_BYTE *)("Print the user name associated with the current effective user ID.\nSame as id -un.\n\n" + 84);
    if ( !*v1 )
      v1 = "ASCII";
    v5 = v1;
    v0 = -1552253716;
